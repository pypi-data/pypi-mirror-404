...
T = TypeVar("T", bound="PostPublicEnvelopeListResponse200EnvelopesItemMetrics")



@_attrs_define
class PostPublicEnvelopeListResponse200EnvelopesItemMetrics:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_public_envelope_list_response_200_envelopes_item_metrics = cls(
        ...
        return post_public_envelope_list_response_200_envelopes_item_metrics
