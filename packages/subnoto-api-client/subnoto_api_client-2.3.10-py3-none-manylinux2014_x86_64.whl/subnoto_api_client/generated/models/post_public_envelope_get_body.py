...
T = TypeVar("T", bound="PostPublicEnvelopeGetBody")



@_attrs_define
class PostPublicEnvelopeGetBody:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_public_envelope_get_body = cls(
            workspace_uuid=workspace_uuid,
            envelope_uuid=envelope_uuid,
        )


        post_public_envelope_get_body.additional_properties = d
        return post_public_envelope_get_body
