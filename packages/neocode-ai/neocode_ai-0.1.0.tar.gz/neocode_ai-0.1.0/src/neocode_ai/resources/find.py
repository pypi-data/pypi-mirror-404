...
class FindResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> FindResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/neopilot-ai/neocode-sdk-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> FindResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/neopilot-ai/neocode-sdk-python#with_streaming_response
        """
