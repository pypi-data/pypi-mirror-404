...
class Neocode(SyncAPIClient):
    ...
    tui: tui.TuiResource
    with_raw_response: NeocodeWithRawResponse
    with_streaming_response: NeocodeWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        self.with_raw_response = NeocodeWithRawResponse(self)
        self.with_streaming_response = NeocodeWithStreamedResponse(self)
...
class AsyncNeocode(AsyncAPIClient):
    ...
    with_raw_response: AsyncNeocodeWithRawResponse
    with_streaming_response: AsyncNeocodeWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        self.with_raw_response = AsyncNeocodeWithRawResponse(self)
        self.with_streaming_response = AsyncNeocodeWithStreamedResponse(self)
