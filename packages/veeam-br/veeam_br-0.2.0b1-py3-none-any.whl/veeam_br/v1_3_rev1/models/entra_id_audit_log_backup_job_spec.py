...
class EntraIDAuditLogBackupJobSpec:
    ...
    Attributes:
        ...
        storage (EntraIDAuditLogBackupJobStorageModel): Storage settings.
    ...
    storage: EntraIDAuditLogBackupJobStorageModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        storage = EntraIDAuditLogBackupJobStorageModel.from_dict(d.pop("storage"))
