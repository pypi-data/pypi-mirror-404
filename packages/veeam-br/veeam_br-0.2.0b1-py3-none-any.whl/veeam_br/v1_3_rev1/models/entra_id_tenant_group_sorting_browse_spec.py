...
from ..models.e_entra_id_tenant_group_sorting_property import EEntraIdTenantGroupSortingProperty
from ..models.e_sort_expression_direction_type import ESortExpressionDirectionType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntraIdTenantGroupSortingBrowseSpec")


@_attrs_define
class EntraIdTenantGroupSortingBrowseSpec:
    """Sorting options.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_tenant_group_sorting_browse_spec = cls(
            property_=property_,
            direction=direction,
        )

        entra_id_tenant_group_sorting_browse_spec.additional_properties = d
        return entra_id_tenant_group_sorting_browse_spec
