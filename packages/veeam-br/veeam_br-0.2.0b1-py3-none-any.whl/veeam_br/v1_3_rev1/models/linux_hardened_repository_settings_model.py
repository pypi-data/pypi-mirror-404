...
T = TypeVar("T", bound="LinuxHardenedRepositorySettingsModel")


@_attrs_define
class LinuxHardenedRepositorySettingsModel:
    """Repository settings.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if make_recent_backups_immutable_days is not UNSET:
            field_dict["makeRecentBackupsImmutableDays"] = make_recent_backups_immutable_days
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_hardened_repository_settings_model = cls(
            path=path,
            ...
            make_recent_backups_immutable_days=make_recent_backups_immutable_days,
            advanced_settings=advanced_settings,
        )

        linux_hardened_repository_settings_model.additional_properties = d
        return linux_hardened_repository_settings_model
