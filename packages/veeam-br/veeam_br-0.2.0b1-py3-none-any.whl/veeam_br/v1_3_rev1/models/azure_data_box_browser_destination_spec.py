...
class AzureDataBoxBrowserDestinationSpec:
    """Settings for creating a new folder in Microsoft Azure Data Box storage.
    ...
    Attributes:
        ...
        service_point (str): Service endpoint address of the Microsoft Azure Data Box device.
