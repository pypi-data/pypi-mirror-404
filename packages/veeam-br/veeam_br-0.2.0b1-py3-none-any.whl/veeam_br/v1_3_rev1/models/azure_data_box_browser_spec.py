...
T = TypeVar("T", bound="AzureDataBoxBrowserSpec")


@_attrs_define
class AzureDataBoxBrowserSpec:
    """Settings for Microsoft Azure Data Box storage.
    ...
    Attributes:
        ...
        service_point (str | Unset): Service endpoint used to connect to the Microsoft Azure Data Box object storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        azure_data_box_browser_spec = cls(
        ...
        azure_data_box_browser_spec.additional_properties = d
        return azure_data_box_browser_spec
