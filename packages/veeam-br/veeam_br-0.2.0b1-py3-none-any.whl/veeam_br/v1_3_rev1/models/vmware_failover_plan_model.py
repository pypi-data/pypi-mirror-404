...
T = TypeVar("T", bound="VmwareFailoverPlanModel")


@_attrs_define
class VmwareFailoverPlanModel:
    """Failover plan of VMware vSphere servers.

    Attributes:
        type_ (EFailoverPlanType): Type of failover plan.
        id (UUID | Unset): Failover plan ID.
        name (str | Unset): Failover plan name.
        description (str | Unset): Failover plan description.
        pre_failover_script (FailoverPlanScriptModel | Unset): Pre-failover or post-failover plan script.
        post_failover_script (FailoverPlanScriptModel | Unset): Pre-failover or post-failover plan script.
        virtual_machines (list[VmwareFailoverPlanVirtualMachineModel] | Unset): Array of VMware vSphere VMs added to the
            failover plan.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vmware_failover_plan_model = cls(
            type_=type_,
            id=id,
            name=name,
        ...
        vmware_failover_plan_model.additional_properties = d
        return vmware_failover_plan_model
