...
T = TypeVar("T", bound="TenantBackupStatisticsResponse")


@_attrs_define
class TenantBackupStatisticsResponse:
    """Tenant backup statistics.
    ...
    Attributes:
        ...
        device_configurations (int): Number of backed up device configurations.
        device_compliance_policies (int): Number of backed up device compliance policies.
        device_management_configuration_policies (int): Number of backed up device management configuration policies.
        device_management_compliance_policies (int): Number of backed up device management compliance policies.
        org_contacts (int): Number of backed up organizational contacts.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tenant_backup_statistics_response = cls(
            users=users,
        ...
        tenant_backup_statistics_response.additional_properties = d
        return tenant_backup_statistics_response
