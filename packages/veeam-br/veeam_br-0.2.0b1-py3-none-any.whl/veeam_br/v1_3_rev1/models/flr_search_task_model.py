...
T = TypeVar("T", bound="FlrSearchTaskModel")


@_attrs_define
class FlrSearchTaskModel:
    """File restore search task.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flr_search_task_model.additional_properties = d
        return flr_search_task_model
