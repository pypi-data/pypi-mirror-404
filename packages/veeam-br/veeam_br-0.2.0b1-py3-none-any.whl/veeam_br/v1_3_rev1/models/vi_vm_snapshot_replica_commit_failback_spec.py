...
class ViVMSnapshotReplicaCommitFailbackSpec:
    """Settings for performing failback of snapshot replicas of VMware vSphere VMs.

    Attributes:
        replica_point_ids (list[UUID] | Unset): Array of replica restore points for which you want to perform failback.
    """
