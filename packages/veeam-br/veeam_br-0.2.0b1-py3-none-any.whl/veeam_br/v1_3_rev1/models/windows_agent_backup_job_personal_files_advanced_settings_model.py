...
T = TypeVar("T", bound="WindowsAgentBackupJobPersonalFilesAdvancedSettingsModel")


@_attrs_define
class WindowsAgentBackupJobPersonalFilesAdvancedSettingsModel:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        exclude_one_drive = self.exclude_one_drive
        ...
        if exclude_one_drive is not UNSET:
            field_dict["excludeOneDrive"] = exclude_one_drive
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        exclude_one_drive = d.pop("excludeOneDrive", UNSET)

        windows_agent_backup_job_personal_files_advanced_settings_model = cls(
            include_masks=include_masks,
            exclude_masks=exclude_masks,
            exclude_one_drive=exclude_one_drive,
        )

        windows_agent_backup_job_personal_files_advanced_settings_model.additional_properties = d
        return windows_agent_backup_job_personal_files_advanced_settings_model
