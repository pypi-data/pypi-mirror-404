...
T = TypeVar("T", bound="EntireHvVMOriginalLocationRestoreSpec")


@_attrs_define
class EntireHvVMOriginalLocationRestoreSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entire_hv_vm_original_location_restore_spec = cls(
        ...
        entire_hv_vm_original_location_restore_spec.additional_properties = d
        return entire_hv_vm_original_location_restore_spec
