...
class AzureComputeBrowserFilters:
    """Microsoft Azure compute hierarchy filters. Using the filters reduces not only the number of records in the response
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        show_all_instance_sizes = self.show_all_instance_sizes
        ...
        if show_all_instance_sizes is not UNSET:
            field_dict["showAllInstanceSizes"] = show_all_instance_sizes
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        show_all_instance_sizes = d.pop("showAllInstanceSizes", UNSET)
        ...
        azure_compute_browser_filters = cls(
            ...
            show_all_instance_sizes=show_all_instance_sizes,
        )
