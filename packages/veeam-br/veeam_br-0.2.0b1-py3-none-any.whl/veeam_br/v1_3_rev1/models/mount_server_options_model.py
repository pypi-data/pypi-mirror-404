...
T = TypeVar("T", bound="MountServerOptionsModel")


@_attrs_define
class MountServerOptionsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mount_server_options_model = cls(
        ...
        mount_server_options_model.additional_properties = d
        return mount_server_options_model
