...
T = TypeVar("T", bound="FullBackupMaintenanceDefragmentAndCompactModel")


@_attrs_define
class FullBackupMaintenanceDefragmentAndCompactModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        full_backup_maintenance_defragment_and_compact_model = cls(
            is_enabled=is_enabled,
            weekly=weekly,
            monthly=monthly,
        )

        full_backup_maintenance_defragment_and_compact_model.additional_properties = d
        return full_backup_maintenance_defragment_and_compact_model
