...
T = TypeVar("T", bound="GoogleCloudCredentialsImportSpec")


@_attrs_define
class GoogleCloudCredentialsImportSpec:
    """Settings for importing Google Cloud credentials.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        google_cloud_credentials_import_spec = cls(
            type_=type_,
            unique_id=unique_id,
        ...
        google_cloud_credentials_import_spec.additional_properties = d
        return google_cloud_credentials_import_spec
