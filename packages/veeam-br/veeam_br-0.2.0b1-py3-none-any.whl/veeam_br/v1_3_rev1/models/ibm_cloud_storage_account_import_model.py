...
T = TypeVar("T", bound="IBMCloudStorageAccountImportModel")


@_attrs_define
class IBMCloudStorageAccountImportModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ibm_cloud_storage_account_import_model = cls(
        ...
        ibm_cloud_storage_account_import_model.additional_properties = d
        return ibm_cloud_storage_account_import_model
