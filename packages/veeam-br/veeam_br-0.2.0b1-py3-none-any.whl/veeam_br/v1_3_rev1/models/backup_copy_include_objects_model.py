...
class BackupCopyIncludeObjectsModel:
    ...
    Attributes:
        ...
        backups (list[BackupObjectModel] | Unset): Array of backups processed by the job.
    """

    jobs: list[JobObjectModel] | Unset = UNSET
    repositories: list[RepositoryObjectModel] | Unset = UNSET
    backups: list[BackupObjectModel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _backups is not UNSET:
            ...
            for backups_item_data in _backups:
                backups_item = BackupObjectModel.from_dict(backups_item_data)
