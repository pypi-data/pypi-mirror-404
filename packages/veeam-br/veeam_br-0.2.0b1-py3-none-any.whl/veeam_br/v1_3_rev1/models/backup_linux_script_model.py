...
T = TypeVar("T", bound="BackupLinuxScriptModel")


@_attrs_define
class BackupLinuxScriptModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_linux_script_model = cls(
            pre_freeze_script=pre_freeze_script,
            post_thaw_script=post_thaw_script,
        )

        backup_linux_script_model.additional_properties = d
        return backup_linux_script_model
