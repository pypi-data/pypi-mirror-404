...
T = TypeVar("T", bound="ViVMSnapshotReplicaOriginalLocationFailbackSpec")


@_attrs_define
class ViVMSnapshotReplicaOriginalLocationFailbackSpec:
    """Settings for failback to the original VM in the original location.
    ...
    Attributes:
        ...
        quick_rollback (bool | Unset): If `true`, quick rollback is enabled (for VMware vSphere prior to version 7.0).
    ...
    quick_rollback: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        quick_rollback = self.quick_rollback
        ...
        if quick_rollback is not UNSET:
            field_dict["quickRollback"] = quick_rollback
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quick_rollback = d.pop("quickRollback", UNSET)
        ...
        vi_vm_snapshot_replica_original_location_failback_spec = cls(
            type_=type_,
        ...
        vi_vm_snapshot_replica_original_location_failback_spec.additional_properties = d
        return vi_vm_snapshot_replica_original_location_failback_spec
