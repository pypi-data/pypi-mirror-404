...
class EntraIdTenantRestoreDeviceCodeStateSpec:
    """User code state settings.

    Attributes:
        session_id (UUID): Mount session ID.
        user_code (str): User code. To get the code, run the [Get User Code for Delegated Restore of Microsoft Entra ID
            Items](Restore#operation/GetEntraIdTenantRestoreDeviceCode) request.
    """
