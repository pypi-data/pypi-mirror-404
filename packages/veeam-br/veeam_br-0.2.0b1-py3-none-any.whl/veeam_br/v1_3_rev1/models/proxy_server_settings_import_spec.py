...
T = TypeVar("T", bound="ProxyServerSettingsImportSpec")


@_attrs_define
class ProxyServerSettingsImportSpec:
    """Settings of the server that is used as a backup proxy.

    Attributes:
        host_name (str): Name of the server.
        host_unique_id (str | Unset): Host unique ID assigned to the server.
        ...
        failover_to_network (bool | Unset): (For the Direct storage access and Virtual appliance transport modes) If
            `true`, Veeam Backup & Replication fails over to the network transport mode in case the primary mode fails or is
            unavailable.
    ...
    host_name: str
    host_unique_id: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if host_unique_id is not UNSET:
            field_dict["hostUniqueId"] = host_unique_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        host_unique_id = d.pop("hostUniqueId", UNSET)
        ...
        proxy_server_settings_import_spec = cls(
            host_name=host_name,
        ...
        proxy_server_settings_import_spec.additional_properties = d
        return proxy_server_settings_import_spec
