...
def sync_detailed(
    *,
    ...
    """Register Backup Server on My Account Portal
     ...
     The HTTP POST request to the `/api/v1/registerVbr` path allows you to register the backup server on
    the My Account portal. <p>**Available to**&#58; Veeam Backup Administrator.</p>
