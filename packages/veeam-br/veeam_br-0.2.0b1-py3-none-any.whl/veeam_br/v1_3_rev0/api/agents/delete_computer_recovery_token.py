...
def sync_detailed(
    ...
    *,
    ...
    """Delete Recovery Token
     ...
     The HTTP DELETE request to the `/api/v1/agents/recoveryTokens/{id}` path allows you to delete a
    recovery token that has the specified `id`.<p>**Available to**&#58; Veeam Backup Administrator.</p>
