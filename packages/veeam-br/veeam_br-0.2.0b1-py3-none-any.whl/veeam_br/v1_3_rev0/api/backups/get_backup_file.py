...
def sync_detailed(
    ...
    *,
    ...
    """Get Backup File
     ...
     The HTTP GET request to the `/api/v1/backups/{id}/backupFiles/{backupFileId}` path allows you to get
    a backup file with the specified `id`.<p>**Available to**&#58; Veeam Backup Administrator, Veeam
