...
def sync_detailed(
    *,
    ...
    """Log Out
     ...
     The HTTP POST request to the `/api/oauth2/logout` path allows you to perform the logout operation.
    After you log out, your access and refresh tokens are expired.<p>**Available to**&#58; All user
    roles.</p>
