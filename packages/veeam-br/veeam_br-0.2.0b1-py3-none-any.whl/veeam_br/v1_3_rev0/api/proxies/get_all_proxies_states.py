...
def sync_detailed(
    *,
    ...
    """Get All Proxy States
     ...
     The HTTP GET request to the `/api/v1/backupInfrastructure/proxies/states` path allows you to get an
    array of proxy states.<p>**Available to**&#58; Veeam Backup Administrator, Veeam Backup Operator,
