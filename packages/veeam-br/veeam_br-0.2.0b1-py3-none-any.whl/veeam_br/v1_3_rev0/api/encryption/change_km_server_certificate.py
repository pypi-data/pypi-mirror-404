...
def sync_detailed(
    ...
    *,
    ...
    certificate of a KMS server that has the specified `id`.<p>**Available to**&#58; Veeam Backup
    Administrator, Veeam Security Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.3-rev0'.
        body (KMSServerChangeCertificateSpec): Settings for changing certificate of a KMS server.
