...
def sync_detailed(
    ...
    *,
    ...
    """Search for Files and Folders
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/flr/{sessionId}/search` path allows you to
    create a search task to find required file system items (drives, folders, files and links) available
    in a restore session that has the specified `sessionId`. <p>To get the search results, use the
    [Browse Search Results](Backup-Browsers#operation/FlrBrowseSearchResult) request. <p>**Available
