...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupBrowser/entraIdTenant/{backupId}/uploadConditionalAccessPolicy` path  allows you to
    upload a CSV file and get an array of conditional access policies, which is ready to be specified in
    the body of the restore request. The CSV file must contain a list of IDs of Microsoft Entra ID
    Conditional Access policies.<p>**Available to**&#58; Veeam Backup Administrator, Veeam Restore
    Operator.</p>
