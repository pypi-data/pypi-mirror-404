...
def sync_detailed(
    ...
    *,
    ...
    """Get Mount Point for Instant Recovery to Azure
     ...
     The HTTP GET request to the `/api/v1/restore/instantRecovery/azure/vm/{mountId}` path allows you to
    get a mount point that has the specified `mountID`.<p>**Available to**&#58; Veeam Backup
