...
def sync_detailed(
    ...
    *,
    ...
    """Unmount File System
     ...
     The HTTP POST request to the `/api/v1/restore/flr/{sessionId}/unmount` path allows you to unmount
    the file system from a mount point and stop a file restore session that has the specified
