...
def sync_detailed(
    *,
    ...
    Instant Recovery of a Linux or Windows machine to Azure. <div
    ...
    Points#operation/GetObjectRestorePointDisks) request to get the `diskUid` property value.</li> <li>
    Run the [Get All Cloud Credentials](Credentials#operation/GetAllCloudCreds) request to get the
    `subscriptionId` property value.</li> <li> Run the [Get Cloud Hierarchy](Cloud-
    ...
    Args:
        ...
        body (AzureInstantVMRecoverySpec): Settings for Instant Recovery to Azure.
