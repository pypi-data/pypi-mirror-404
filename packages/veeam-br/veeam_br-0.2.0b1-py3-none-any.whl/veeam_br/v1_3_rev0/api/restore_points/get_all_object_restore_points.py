...
def sync_detailed(
    *,
    ...
    """Get All Restore Points
     ...
     The HTTP GET request to the `/api/v1/restorePoints` path allows you to get an array of all restore
    points created on the backup server.<p>**Available to**&#58; Veeam Backup Administrator, Veeam
