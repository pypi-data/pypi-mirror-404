...
def sync_detailed(
    *,
    ...
    r"""Get All Protection Groups
     ...
     The HTTP POST request to the `/api/v1/inventory/physical` path allows you to get an array of
    computers added to protection groups. <div class=\"attention\"> <strong>NOTE</strong> <br> This
    request is only used to get protected computers in order to add them to a backup job. For more
    information on how to get, add and manage protection groups, see the [Protection
    Groups](#/Protection-Groups/) section.</div> <p>**Available to**&#58; Veeam Backup
    Administrator.</p>
