...
def sync_detailed(
    ...
    *,
    ...
    """Disable Protection Group
     ...
     The HTTP POST request to the `/api/v1/agents/protectionGroups/{id}/disable` path allows you to
    disable a protection group. <p>**Available to**&#58; Veeam Backup Administrator.</p>
