...
T = TypeVar("T", bound="IBMCloudStorageAccountModel")


@_attrs_define
class IBMCloudStorageAccountModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ibm_cloud_storage_account_model = cls(
        ...
        ibm_cloud_storage_account_model.additional_properties = d
        return ibm_cloud_storage_account_model
