...
T = TypeVar("T", bound="WasabiCloudStorageBrowserSpec")


@_attrs_define
class WasabiCloudStorageBrowserSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wasabi_cloud_storage_browser_spec = cls(
        ...
        wasabi_cloud_storage_browser_spec.additional_properties = d
        return wasabi_cloud_storage_browser_spec
