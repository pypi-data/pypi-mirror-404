...
T = TypeVar("T", bound="MountServerSettingsImportSpec")


@_attrs_define
class MountServerSettingsImportSpec:
    """Import settings for mount server.

    Attributes:
        mount_server_name (str): Name of the mount server.
    ...
    def to_dict(self) -> dict[str, Any]:
        mount_server_name = self.mount_server_name
        ...
        field_dict.update(
            {
                "mountServerName": mount_server_name,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        mount_server_name = d.pop("mountServerName")
        ...
        mount_server_settings_import_spec = cls(
            mount_server_name=mount_server_name,
        ...
        mount_server_settings_import_spec.additional_properties = d
        return mount_server_settings_import_spec
