...
T = TypeVar("T", bound="BackupJobExclusionsSpec")


@_attrs_define
class BackupJobExclusionsSpec:
    """Objects excluded from the job.

    Attributes:
        vms (list[InventoryObjectModel] | Unset): Array of VMs. To get a VM object, use the [Get Inventory
            Objects](Inventory-Browser#operation/GetInventoryObjects) request.
        disks (list[VmwareObjectDiskModel] | Unset): Array of disks.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_job_exclusions_spec = cls(
            vms=vms,
            disks=disks,
            templates=templates,
        )

        backup_job_exclusions_spec.additional_properties = d
        return backup_job_exclusions_spec
