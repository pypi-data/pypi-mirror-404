...
class BackupApplicationSettingsModel:
    ...
    Attributes:
        ...
        sql (BackupSQLSettingsModel | Unset): Microsoft SQL Server transaction log settings.
        oracle (BackupOracleSettingsModel | Unset): Oracle archived log settings.
        postgre_sql (BackupPostgreSQLSettingsModel | Unset): PostgreSQL WAL files settings.
    ...
    sql: BackupSQLSettingsModel | Unset = UNSET
    oracle: BackupOracleSettingsModel | Unset = UNSET
    postgre_sql: BackupPostgreSQLSettingsModel | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sql: BackupSQLSettingsModel | Unset
        ...
        oracle: BackupOracleSettingsModel | Unset
        ...
        postgre_sql: BackupPostgreSQLSettingsModel | Unset
