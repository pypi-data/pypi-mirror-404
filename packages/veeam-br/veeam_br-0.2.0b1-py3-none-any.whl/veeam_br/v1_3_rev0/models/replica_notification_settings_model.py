...
T = TypeVar("T", bound="ReplicaNotificationSettingsModel")


@_attrs_define
class ReplicaNotificationSettingsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replica_notification_settings_model = cls(
            send_snmp_notifications=send_snmp_notifications,
            email_notifications=email_notifications,
        )

        replica_notification_settings_model.additional_properties = d
        return replica_notification_settings_model
