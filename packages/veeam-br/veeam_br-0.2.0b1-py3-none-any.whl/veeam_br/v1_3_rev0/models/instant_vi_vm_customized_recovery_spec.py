...
class InstantViVMCustomizedRecoverySpec:
    ...
    Attributes:
        ...
        datastore (InstantViVMCustomizedRecoveryDatastoreSpec): Datastore that keeps redo logs with changes that take
            place while a VM is running from a backup. To get a datastore object, use the [Get Inventory Objects](Inventory-
        ...
        destination (InstantViVMCustomizedRecoveryDestinationSpec | Unset): Destination where the recovered VM resides.
            To get objects of the destination host, folder and resource pool, use the [Get Inventory Objects](Inventory-
            Browser#operation/GetInventoryObjects) request.
    """
