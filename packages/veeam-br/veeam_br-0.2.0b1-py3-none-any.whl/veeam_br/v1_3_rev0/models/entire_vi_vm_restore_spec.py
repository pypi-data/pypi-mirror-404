...
T = TypeVar("T", bound="EntireViVMRestoreSpec")


@_attrs_define
class EntireViVMRestoreSpec:
    """Entire VM restore settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entire_vi_vm_restore_spec.additional_properties = d
        return entire_vi_vm_restore_spec
