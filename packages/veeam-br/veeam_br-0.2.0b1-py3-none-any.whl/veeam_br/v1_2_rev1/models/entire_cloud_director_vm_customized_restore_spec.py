...
class EntireCloudDirectorVMCustomizedRestoreSpec:
    ...
    Attributes:
        ...
        location (EntireCloudDirectorVMRestoreLocationModel): Target location settings. To get a vApp object, use the
            [Get Inventory Objects](#tag/Inventory-Browser/operation/GetInventoryObjects) request.
        ...
        network (RestoreTargetNetworkSpec | Unset): Network that the restored VM will be connected to. To get a network
        ...
        datastore (CloudDirectorRestoreTargetDatastoreSpec | Unset): Datastore and storage for the recovered VM. To get
            datastore and storage policy objects, use the [Get Inventory Objects](#tag/Inventory-
