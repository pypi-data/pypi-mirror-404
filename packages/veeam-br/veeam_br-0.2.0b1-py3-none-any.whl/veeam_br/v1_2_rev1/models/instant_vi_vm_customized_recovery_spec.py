...
class InstantViVMCustomizedRecoverySpec:
    ...
    Attributes:
        ...
        datastore (InstantViVMCustomizedRecoveryDatastoreSpec): Datastore that keeps redo logs with changes that take
            place while a VM is running from a backup. To get a datastore object, use the [Get Inventory
        ...
        destination (InstantViVMCustomizedRecoveryDestinationSpec | Unset): Destination where the recovered VM resides.
            To get objects of the destination host, folder and resource pool, use the [Get Inventory
            Objects](#tag/Inventory-Browser/operation/GetInventoryObjects) request.
        overwrite (bool | Unset): If `true`, Veeam Backup & Replication overwrites the existing VM that has the same
            name.
    """
