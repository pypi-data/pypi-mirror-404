...
T = TypeVar("T", bound="ViVMSnapshotReplicaUndoFailbackSpec")


@_attrs_define
class ViVMSnapshotReplicaUndoFailbackSpec:
    """
    Attributes:
        replica_point_ids (list[UUID] | Unset): Array of replica restore points that you want to undo failback for.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vi_vm_snapshot_replica_undo_failback_spec.additional_properties = d
        return vi_vm_snapshot_replica_undo_failback_spec
