...
T = TypeVar("T", bound="NfsRepositoryShareSettingsSpec")


@_attrs_define
class NfsRepositoryShareSettingsSpec:
    """
    Attributes:
        share_path (str): Path to the shared folder that is used as a backup repository.
        gateway_server (RepositoryShareGatewayImportSpec | Unset): Settings for the gateway server.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nfs_repository_share_settings_spec = cls(
            share_path=share_path,
            gateway_server=gateway_server,
        )

        nfs_repository_share_settings_spec.additional_properties = d
        return nfs_repository_share_settings_spec
