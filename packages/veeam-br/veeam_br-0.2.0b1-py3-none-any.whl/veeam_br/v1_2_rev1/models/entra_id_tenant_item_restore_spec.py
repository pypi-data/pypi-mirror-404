...
class EntraIdTenantItemRestoreSpec:
    ...
    Attributes:
        credentials_id (UUID | Unset): ID of the credentials record used for connection to the target tenant. The
            ...
            User Code for Microsoft Entra ID Item Restore](#tag/Restore/operation/GetEntraIdTenantRestoreDeviceCode).</li>
            <li>Use the user code to get the credentials ID&#58; [Get Credentials for Microsoft Entra ID Item
            Restore](#tag/Restore/operation/GetEntraIdTenantRestoreDeviceCodeState).</li></ol>
        ...
        users_passwords (list[EntraIdTenantRestoreUserPasswordSpec] | Unset): Array of custom user passwords. To
            generate the passwords, use the [Generate Microsoft Entra ID User
            Passwords](#tag/BackupBrowsers/operation/GenerateEntraIdTenantPassword) request.
