...
T = TypeVar("T", bound="EntraIdTenantBrowseModel")


@_attrs_define
class EntraIdTenantBrowseModel:
    """
    Attributes:
        id (UUID): Item ID.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_tenant_browse_model = cls(
            id=id,
        ...
        entra_id_tenant_browse_model.additional_properties = d
        return entra_id_tenant_browse_model
