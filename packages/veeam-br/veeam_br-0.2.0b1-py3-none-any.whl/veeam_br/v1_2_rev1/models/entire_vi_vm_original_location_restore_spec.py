...
T = TypeVar("T", bound="EntireViVMOriginalLocationRestoreSpec")


@_attrs_define
class EntireViVMOriginalLocationRestoreSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entire_vi_vm_original_location_restore_spec = cls(
        ...
        entire_vi_vm_original_location_restore_spec.additional_properties = d
        return entire_vi_vm_original_location_restore_spec
