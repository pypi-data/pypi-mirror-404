...
T = TypeVar("T", bound="SocketLicenseWorkloadResult")


@_attrs_define
class SocketLicenseWorkloadResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = SocketLicenseWorkloadModel.from_dict(data_item_data)

            data.append(data_item)

        pagination = PaginationResult.from_dict(d.pop("pagination"))

        socket_license_workload_result = cls(
            data=data,
            pagination=pagination,
        )

        socket_license_workload_result.additional_properties = d
        return socket_license_workload_result
