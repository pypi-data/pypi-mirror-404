...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupBrowser/entraIdTenant/restoreSessions/{restoreSessionId}` path allows you to get a
    restore session that has the specified `restoreSessionId`.<p>**Available to**&#58; Veeam Backup
