...
def sync_detailed(
    *,
    ...
    """Get All Unstructured Data Mount Points
     ...
     The HTTP GET request to the `/api/v1/backupBrowser/flr/unstructuredData` path allows you to get an
    array of all active unstructured data mount points.<p>**Available to**&#58; Veeam Backup
