...
def sync_detailed(
    *,
    ...
    """Get All Protected Linux Computers
     ...
     The HTTP GET request to the `/api/v1/agents/protectedComputers` path allows you to get an array of
    all protected Linux computers. <p>**Available to**&#58; Veeam Backup Administrator, Veeam Restore
    Operator.</p>
