...
def sync_detailed(
    ...
    *,
    ...
    """Edit Scale-Out Backup Repository
     ...
     The HTTP PUT request to the `/api/v1/backupInfrastructure/scaleOutRepositories/{id}` path allows you
    to edit a scale-out backup repository that has the specified `id`.<p> **Available to**&#58; Veeam
