...
def sync_detailed(
    ...
    *,
    ...
    """Assign Instance License
     ...
     The HTTP POST request to the `/api/v1/license/instances/{instanceId}/assign` path allows you to set
    the product edition for a standalone Veeam Agent with the specified `instanceId`.<p>**Available
