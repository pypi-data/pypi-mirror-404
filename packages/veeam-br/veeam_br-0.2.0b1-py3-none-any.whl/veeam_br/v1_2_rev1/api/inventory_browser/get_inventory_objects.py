...
def sync_detailed(
    ...
    *,
    ...
    """Get Inventory Objects
     ...
     The HTTP POST request to the `/api/v1/inventory/{hostname}` path allows you to get an array of
    inventory objects of a virtualization server (or host) that has the specified
    `hostname`.<p>**Available to**&#58; Veeam Backup Administrator.</p>
