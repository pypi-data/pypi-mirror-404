...
def sync_detailed(
    *,
    ...
    Verification Code](#tag/Credentials/operation/RequestAppRegistrationByDeviceCode) request.</li>
    <li>To register the new application, use the [Register Microsoft Entra ID
    Application](#tag/Credentials/operation/FinishAppRegistrationByDeviceCode) request.</li></ol></p>
