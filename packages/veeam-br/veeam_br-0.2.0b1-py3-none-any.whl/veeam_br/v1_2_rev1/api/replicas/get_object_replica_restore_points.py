...
def sync_detailed(
    ...
    *,
    ...
    """Get All Replica Restore Points
     ...
     The HTTP GET request to the `/api/v1/replicas/{id}/replicaPoints` path allows you to get an array of
    all replica restore points for a replica that has the specified `id`.<p>**Available to**&#58; Veeam
