...
def sync_detailed(
    ...
    *,
    ...
    """Get All Restore Sessions of Microsoft Entra ID Tenant
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/entraIdTenant/{sessionId}/restoreSessions` path
    allows you to get an array of restore sessions that were started for a Microsoft Entra ID tenant
    mount point with the specified `sessionId`.<p>**Available to**&#58; Veeam Backup Administrator,
