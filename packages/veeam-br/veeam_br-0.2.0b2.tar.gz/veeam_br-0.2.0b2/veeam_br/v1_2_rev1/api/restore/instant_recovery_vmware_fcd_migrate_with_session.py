...
def sync_detailed(
    ...
    *,
    ...
    """Start FCD Migration
     ...
     The HTTP POST request to the `/api/v1/restore/instantRecovery/vSphere/fcd/{mountId}/migrate` path
    allows you to start migration of FCDs from the specified mount point.<p>In the request body specify
    FCD migration configuration:<ul> <li>Disks for migration</li> <li>Target datastore</li> <li>Storage
    policy that will be applied to the migrated disks</li></ul> For details on how to get models of the
    datastore and storage policy, see [Get Inventory Objects](#tag/Inventory-
