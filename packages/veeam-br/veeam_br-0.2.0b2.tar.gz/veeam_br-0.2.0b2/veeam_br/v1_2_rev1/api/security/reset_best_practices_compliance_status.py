...
def sync_detailed(
    ...
    *,
    ...
    """Reset Security & Compliance Analyzer Status
     ...
     The HTTP POST request to the `/api/v1/securityAnalyzer/bestPractices/{id}/reset` path allows you to
    reset the compliance status of a Security & Compliance Analyzer best practice that has the specified
