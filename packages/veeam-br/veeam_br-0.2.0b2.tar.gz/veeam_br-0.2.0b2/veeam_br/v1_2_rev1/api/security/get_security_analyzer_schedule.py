...
def sync_detailed(
    *,
    ...
    """Get Security & Compliance Analyzer Schedule
     ...
     The HTTP GET request to the `/api/v1/securityAnalyzer/schedule` path allows you to get the Security
    & Compliance Analyzer schedule. <p>**Available to**&#58; Veeam Backup Administrator, Veeam Security
    Administrator.</p>
