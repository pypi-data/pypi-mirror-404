...
def sync_detailed(
    ...
    *,
    ...
    """Get Microsoft Entra ID Tenant
     ...
     The HTTP GET request to the `/api/v1/entraId/tenants/{id}` path allows you to get a Microsoft Entra
    ID tenant that has the specified `id`.<p>**Available to**&#58; Veeam Backup Administrator, Veeam
    Backup Operator, Veeam Restore Operator, Veeam Tape Operator, Veeam Backup Viewer.</p>
