...
class GeneralOptionsSyslogEventFilteringModel:
    """
    Attributes:
        event_id (str): Event ID. For a complete list of Veeam Backup & Replication events, see [Event
            Reference](https://helpcenter.veeam.com/docs/backup/events/overview.html?ver=120).
