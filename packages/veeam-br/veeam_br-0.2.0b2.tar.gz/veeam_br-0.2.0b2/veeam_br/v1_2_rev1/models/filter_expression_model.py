...
T = TypeVar("T", bound="FilterExpressionModel")


@_attrs_define
class FilterExpressionModel:
    """Filter settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filter_expression_model = cls(
            type_=type_,
        )

        filter_expression_model.additional_properties = d
        return filter_expression_model
