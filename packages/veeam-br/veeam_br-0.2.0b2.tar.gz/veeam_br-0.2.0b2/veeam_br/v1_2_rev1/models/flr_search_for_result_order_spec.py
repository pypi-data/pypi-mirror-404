...
from ..models.e_flr_search_for_result_order_type import EFlrSearchForResultOrderType
...
class FlrSearchForResultOrderSpec:
    ...
    Attributes:
        order_column (EFlrSearchForResultOrderType): Sorts items by one of the following parameters.
        order_asc (bool | Unset): If `true`, sorts items in the ascending order by the `orderColumn` parameter.
    """

    order_column: EFlrSearchForResultOrderType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        order_column = EFlrSearchForResultOrderType(d.pop("orderColumn"))
