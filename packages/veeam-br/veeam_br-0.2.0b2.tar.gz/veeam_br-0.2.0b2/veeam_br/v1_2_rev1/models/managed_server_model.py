...
T = TypeVar("T", bound="ManagedServerModel")


@_attrs_define
class ManagedServerModel:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        managed_server_model.additional_properties = d
        return managed_server_model
