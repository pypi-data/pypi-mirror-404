...
if TYPE_CHECKING:
    from ..models.entra_id_audit_log_backup_job_advanced_settings_model import (
        EntraIDAuditLogBackupJobAdvancedSettingsModel,
    )
    from ..models.entra_id_audit_log_retention_policy_settings_model import EntraIDAuditLogRetentionPolicySettingsModel


T = TypeVar("T", bound="EntraIDAuditLogBackupJobStorageModel")


@_attrs_define
class EntraIDAuditLogBackupJobStorageModel:
    """Storage settings.
    ...
    Attributes:
        ...
        advanced_settings (EntraIDAuditLogBackupJobAdvancedSettingsModel | Unset): Advanced backup job settings.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.entra_id_audit_log_retention_policy_settings_model import (
        ...
        if isinstance(_advanced_settings, Unset):
            ...
            advanced_settings = EntraIDAuditLogBackupJobAdvancedSettingsModel.from_dict(_advanced_settings)

        entra_id_audit_log_backup_job_storage_model = cls(
        ...
        entra_id_audit_log_backup_job_storage_model.additional_properties = d
        return entra_id_audit_log_backup_job_storage_model
