...
T = TypeVar("T", bound="AzureArchiveStorageAccountImportModel")


@_attrs_define
class AzureArchiveStorageAccountImportModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        azure_archive_storage_account_import_model = cls(
            credentials=credentials,
            region_type=region_type,
            connection_settings=connection_settings,
        )

        azure_archive_storage_account_import_model.additional_properties = d
        return azure_archive_storage_account_import_model
