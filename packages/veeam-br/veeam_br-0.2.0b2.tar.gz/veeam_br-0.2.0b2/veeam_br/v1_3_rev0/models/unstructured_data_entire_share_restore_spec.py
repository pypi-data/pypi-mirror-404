...
class UnstructuredDataEntireShareRestoreSpec:
    """Settings for restoring entire unstructured data share.

    Attributes:
        restore_point_id (UUID): Restore point ID.
        destination (UnstructuredDataShareRestoreDestinationModel | Unset): Destination for restoring entire
            unstructured data share.
        restore_options (UnstructuredDataShareRestoreOptionsModel | Unset): Unstructured data restore options.
    """
