...
class WindowsHostModel:
    ...
    Attributes:
        ...
        is_backup_server (bool | Unset): If `true`, the Windows server is a backup server.
        is_default_mount_server (bool | Unset): If `true`, the Windows server is the default mount server for Windows
            machines.
