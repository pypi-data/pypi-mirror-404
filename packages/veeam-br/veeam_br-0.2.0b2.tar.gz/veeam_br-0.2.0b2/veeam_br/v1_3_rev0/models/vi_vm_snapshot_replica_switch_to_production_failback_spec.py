...
T = TypeVar("T", bound="ViVMSnapshotReplicaSwitchToProductionFailbackSpec")


@_attrs_define
class ViVMSnapshotReplicaSwitchToProductionFailbackSpec:
    """Settings for switching over from a snapshot replica to production.

    Attributes:
        replica_point_ids (list[UUID] | Unset): Array of replica restore points from which you want to switch over.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vi_vm_snapshot_replica_switch_to_production_failback_spec = cls(
            replica_point_ids=replica_point_ids,
        )

        vi_vm_snapshot_replica_switch_to_production_failback_spec.additional_properties = d
        return vi_vm_snapshot_replica_switch_to_production_failback_spec
