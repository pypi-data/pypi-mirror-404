...
T = TypeVar("T", bound="CloudCredentialsResult")


@_attrs_define
class CloudCredentialsResult:
    """Details on cloud credentials.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_credentials_result = cls(
            data=data,
            pagination=pagination,
        )

        cloud_credentials_result.additional_properties = d
        return cloud_credentials_result
