...
T = TypeVar("T", bound="ManagedHostPortsModel")


@_attrs_define
class ManagedHostPortsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        managed_host_ports_model.additional_properties = d
        return managed_host_ports_model
