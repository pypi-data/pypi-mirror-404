...
if TYPE_CHECKING:
    from ..models.google_cloud_storage_browser_filters import GoogleCloudStorageBrowserFilters


T = TypeVar("T", bound="GoogleCloudStorageBrowserSpec")


@_attrs_define
class GoogleCloudStorageBrowserSpec:
    ...
    Attributes:
        ...
        gateway_server_id (UUID | Unset): ID of a gateway server you want to use to connect to the object storage.
            ...
            server ID is used.
        filters (GoogleCloudStorageBrowserFilters | Unset): Google Cloud hierarchy filters. Using the filters reduces
            not only the number of records in the response body but also the response time.
    """

    credentials_id: UUID
    service_type: ECloudServiceType
    gateway_server_id: UUID | Unset = UNSET
    filters: GoogleCloudStorageBrowserFilters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filters: GoogleCloudStorageBrowserFilters | Unset
        if isinstance(_filters, Unset):
            filters = UNSET
        else:
            filters = GoogleCloudStorageBrowserFilters.from_dict(_filters)

        google_cloud_storage_browser_spec = cls(
        ...
        google_cloud_storage_browser_spec.additional_properties = d
        return google_cloud_storage_browser_spec
