...
T = TypeVar("T", bound="SureBackupJobNotificationSettingsModel")


@_attrs_define
class SureBackupJobNotificationSettingsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sure_backup_job_notification_settings_model = cls(
            send_snmp_notifications=send_snmp_notifications,
            email_notifications=email_notifications,
        )

        sure_backup_job_notification_settings_model.additional_properties = d
        return sure_backup_job_notification_settings_model
