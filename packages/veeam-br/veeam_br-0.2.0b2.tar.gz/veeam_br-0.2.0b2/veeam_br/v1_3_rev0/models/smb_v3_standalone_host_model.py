...
T = TypeVar("T", bound="SmbV3StandaloneHostModel")


@_attrs_define
class SmbV3StandaloneHostModel:
    """Standalone SMBv3 host.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        smb_v3_standalone_host_model = cls(
            id=id,
            name=name,
            description=description,
            type_=type_,
        ...
        smb_v3_standalone_host_model.additional_properties = d
        return smb_v3_standalone_host_model
