...
T = TypeVar("T", bound="S3CompatibleBrowserSpec")


@_attrs_define
class S3CompatibleBrowserSpec:
    """Settings for S3 compatible storage.
    ...
    Attributes:
        ...
        region_id (str | Unset): Region where the S3 compatible storage is located.
        service_point (str | Unset): Service point address of the S3 compatible storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        s3_compatible_browser_spec = cls(
        ...
        s3_compatible_browser_spec.additional_properties = d
        return s3_compatible_browser_spec
