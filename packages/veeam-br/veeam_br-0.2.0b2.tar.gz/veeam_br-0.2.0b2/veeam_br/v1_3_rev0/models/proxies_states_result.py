...
if TYPE_CHECKING:
    ...
    from ..models.proxy_state_model import ProxyStateModel


T = TypeVar("T", bound="ProxiesStatesResult")


@_attrs_define
class ProxiesStatesResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ProxyStateModel.from_dict(data_item_data)

            data.append(data_item)

        pagination = PaginationResult.from_dict(d.pop("pagination"))

        proxies_states_result = cls(
            data=data,
            pagination=pagination,
        )

        proxies_states_result.additional_properties = d
        return proxies_states_result
