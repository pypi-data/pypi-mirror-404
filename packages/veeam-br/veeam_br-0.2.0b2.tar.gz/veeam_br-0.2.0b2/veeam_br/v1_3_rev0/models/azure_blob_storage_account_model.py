...
T = TypeVar("T", bound="AzureBlobStorageAccountModel")


@_attrs_define
class AzureBlobStorageAccountModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        azure_blob_storage_account_model = cls(
            credentials_id=credentials_id,
            region_type=region_type,
            connection_settings=connection_settings,
        )

        azure_blob_storage_account_model.additional_properties = d
        return azure_blob_storage_account_model
