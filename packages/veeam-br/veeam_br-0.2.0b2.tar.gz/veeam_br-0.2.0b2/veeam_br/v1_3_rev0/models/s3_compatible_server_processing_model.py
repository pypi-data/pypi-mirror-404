...
T = TypeVar("T", bound="S3CompatibleServerProcessingModel")


@_attrs_define
class S3CompatibleServerProcessingModel:
    """Processing settings for S3 compatible object storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        s3_compatible_server_processing_model = cls(
            backup_proxies=backup_proxies,
            cache_repository_id=cache_repository_id,
            backup_io_control_level=backup_io_control_level,
        )

        s3_compatible_server_processing_model.additional_properties = d
        return s3_compatible_server_processing_model
