...
def sync_detailed(
    *,
    ...
    """Start Disk Publishing
     ...
     The HTTP POST request to the `/api/v1/dataIntegration/publish` path allows you to start a disk
    publishing session.<p>**Available to**&#58; Veeam Backup Administrator, Veeam Restore Operator.</p>
