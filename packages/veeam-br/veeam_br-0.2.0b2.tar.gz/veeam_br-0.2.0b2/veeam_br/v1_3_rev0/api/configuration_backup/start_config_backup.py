...
def sync_detailed(
    *,
    ...
    """Start Configuration Backup
     ...
     The HTTP POST request to the `/api/v1/configBackup/backup` path allows you to start a configuration
    backup.<p>**Available to**&#58; Veeam Backup Administrator, Veeam Backup Operator.</p>
