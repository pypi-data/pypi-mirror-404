...
def sync_detailed(
    ...
    *,
    ...
    """Edit Protection Group
     ...
     The HTTP PUT request to the `/api/v1/agents/protectionGroups/{id}` path allows you to edit the
    settings of a protection group that has the specified `id`. <p>**Available to**&#58; Veeam Backup
    Administrator.</p>
