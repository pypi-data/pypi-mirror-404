...
def sync_detailed(
    *,
    ...
    """Get Security & Compliance Analyzer Results
     ...
     The HTTP GET request to the `/api/v1/securityAnalyzer/bestPractices` path allows you to get best
    practices compliance result from the Backup server.<p>**Available to**&#58; Veeam Backup
