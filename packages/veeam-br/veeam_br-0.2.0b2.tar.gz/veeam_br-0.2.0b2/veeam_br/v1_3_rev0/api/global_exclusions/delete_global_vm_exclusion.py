...
def sync_detailed(
    ...
    *,
    ...
    """Remove Global VM Exclusion
     ...
     The HTTP DELETE request to the `/api/v1/globalExclusions/vm/{id}` path allows you to remove a global
    VM exclusion that has the specified `id`.<p> **Available to**&#58; Veeam Backup Administrator.</p>
