...
def sync_detailed(
    ...
    *,
    ...
    """Remove Active Directory Domain
     ...
     The HTTP DELETE request to the `/api/v1/adDomains/{id}` path allows you to remove Active Directory
    domain that has the specified `id` from the backup server. <p>**Available to**&#58; Veeam Backup
    Administrator.</p>
