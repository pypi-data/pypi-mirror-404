...
def sync_detailed(
    *,
    ...
    """Rescan All Managed Servers
     ...
     The HTTP POST request to the `/api/v1/backupInfrastructure/managedServers/rescan` path allows you to
    rescan all managed servers. <p>**Available to**&#58; Veeam Backup Administrator.</p>
