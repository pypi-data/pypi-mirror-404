...
def sync_detailed(
    *,
    ...
    """Get All Mount Points for Instant Recovery to Azure
     ...
     The HTTP GET request to the `/api/v1/restore/instantRecovery/azure/vm` path allows you to get an
    array of Instant Recovery mount points of Microsoft Azure VMs. <p>**Available to**&#58; Veeam Backup
