...
def sync_detailed(
    ...
    *,
    ...
    """Start Switchover to Azure
     ...
     The HTTP POST request to the `/api/v1/restore/instantRecovery/azure/vm/{mountId}/switchover` path
    allows you to start switchover for a mount point that has the specified `mountID`.<p>**Available
