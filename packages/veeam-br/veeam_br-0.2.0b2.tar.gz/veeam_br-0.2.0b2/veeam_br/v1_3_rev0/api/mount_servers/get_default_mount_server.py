...
def sync_detailed(
    *,
    ...
    """Get Default Mount Server
     ...
     The HTTP GET request to the `/api/v1/backupInfrastructure/mountServers/default` path allows you to
    get default mount servers.<p>**Available to**&#58; Veeam Backup Administrator.</p>
