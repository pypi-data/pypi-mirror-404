...
def sync_detailed(
    ...
    *,
    ...
    """Get Active Directory Objects from Domain
     ...
     The HTTP GET request to the `/api/v1/inventory/activeDirectory/domains/{id}` path allows you to get
    an array of objects from the Active Directory domain that has the specified `id`. <p>**Available
