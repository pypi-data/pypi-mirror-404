...
def sync_detailed(
    *,
    ...
    """Create Deployment Kit
     ...
     The HTTP POST request to the `/api/v1/deployment/generateKit` endpoint generates a deployment kit
    which can be used for adding Microsoft Windows machines as managed servers.<p>**Available to**&#58;
