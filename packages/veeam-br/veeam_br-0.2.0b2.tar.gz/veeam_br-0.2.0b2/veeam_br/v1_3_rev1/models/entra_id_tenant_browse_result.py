...
class EntraIdTenantBrowseResult:
    ...
    Attributes:
        data (list[EntraIdTenantBrowseModel]): Array of Microsoft Entra ID items. To get the IDs, run the [Get Microsoft
            Entra ID Items](Backup-Browsers#operation/BrowseEntraIdTenantBackupRestorePoints)
