...
class AzureComputeBrowserSpec:
    ...
    Attributes:
        ...
        filters (AzureComputeBrowserFilters | Unset): Microsoft Azure compute hierarchy filters. Using the filters
            reduces not only the number of records in the response body but also the response time.
    """
