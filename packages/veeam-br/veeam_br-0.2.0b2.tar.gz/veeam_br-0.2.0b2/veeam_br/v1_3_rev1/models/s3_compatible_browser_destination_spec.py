...
T = TypeVar("T", bound="S3CompatibleBrowserDestinationSpec")


@_attrs_define
class S3CompatibleBrowserDestinationSpec:
    """Settings for creating a new folder in S3 compatible storage.
    ...
    Attributes:
        ...
        connection_point (str): Endpoint address and port number of the S3 compatible storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        s3_compatible_browser_destination_spec = cls(
        ...
        s3_compatible_browser_destination_spec.additional_properties = d
        return s3_compatible_browser_destination_spec
