...
if TYPE_CHECKING:
    from ..models.performance_extent_model import PerformanceExtentModel
    from ..models.performance_tier_advanced_settings_model import PerformanceTierAdvancedSettingsModel


T = TypeVar("T", bound="PerformanceTierModel")


@_attrs_define
class PerformanceTierModel:
    """Performance tier.

    Attributes:
        performance_extents (list[PerformanceExtentModel]): Array of performance extents.
        advanced_settings (PerformanceTierAdvancedSettingsModel | Unset): Advanced settings of the performance tier.
    """

    performance_extents: list[PerformanceExtentModel]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for performance_extents_item_data in _performance_extents:
            performance_extents_item = PerformanceExtentModel.from_dict(performance_extents_item_data)
        ...
        performance_tier_model = cls(
            performance_extents=performance_extents,
            advanced_settings=advanced_settings,
        )

        performance_tier_model.additional_properties = d
        return performance_tier_model
