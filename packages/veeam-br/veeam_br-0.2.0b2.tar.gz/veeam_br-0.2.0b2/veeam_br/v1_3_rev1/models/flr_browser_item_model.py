...
T = TypeVar("T", bound="FlrBrowserItemModel")


@_attrs_define
class FlrBrowserItemModel:
    """File restore item.

    Attributes:
        display_name (str): Display name of the item.
        ...
        owner (str | Unset): Owner of the item.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flr_browser_item_model.additional_properties = d
        return flr_browser_item_model
