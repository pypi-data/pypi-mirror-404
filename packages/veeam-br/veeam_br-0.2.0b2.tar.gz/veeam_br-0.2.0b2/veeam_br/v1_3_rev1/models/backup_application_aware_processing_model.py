...
if TYPE_CHECKING:
    from ..models.backup_application_settings_model import BackupApplicationSettingsModel


T = TypeVar("T", bound="BackupApplicationAwareProcessingModel")


@_attrs_define
class BackupApplicationAwareProcessingModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_application_aware_processing_model.additional_properties = d
        return backup_application_aware_processing_model
