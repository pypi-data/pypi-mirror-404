...
T = TypeVar("T", bound="AgentBackupObjectIndexingModel")


@_attrs_define
class AgentBackupObjectIndexingModel:
    """Guest OS indexing options for the physical machine.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_backup_object_indexing_model = cls(
            guest_fs_indexing_mode=guest_fs_indexing_mode,
            indexing_list=indexing_list,
        )

        agent_backup_object_indexing_model.additional_properties = d
        return agent_backup_object_indexing_model
