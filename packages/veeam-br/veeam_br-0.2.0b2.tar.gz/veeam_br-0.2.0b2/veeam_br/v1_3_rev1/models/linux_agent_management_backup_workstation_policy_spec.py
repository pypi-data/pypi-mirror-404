...
T = TypeVar("T", bound="LinuxAgentManagementBackupWorkstationPolicySpec")


@_attrs_define
class LinuxAgentManagementBackupWorkstationPolicySpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_agent_management_backup_workstation_policy_spec = cls(
            name=name,
            type_=type_,
            description=description,
        ...
        linux_agent_management_backup_workstation_policy_spec.additional_properties = d
        return linux_agent_management_backup_workstation_policy_spec
