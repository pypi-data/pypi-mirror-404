...
T = TypeVar("T", bound="FlrBrowseOrderSpec")


@_attrs_define
class FlrBrowseOrderSpec:
    """Sorting settings.

    Attributes:
        order_column (EFlrBrowseOrderType): Sorts items by one of the following parameters.
        order_asc (bool | Unset): If `true`, sorts items in ascending order by the `orderColumn` parameter.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flr_browse_order_spec = cls(
            order_column=order_column,
            order_asc=order_asc,
        )

        flr_browse_order_spec.additional_properties = d
        return flr_browse_order_spec
