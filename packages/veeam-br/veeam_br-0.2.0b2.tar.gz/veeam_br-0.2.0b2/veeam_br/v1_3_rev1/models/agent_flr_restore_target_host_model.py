...
class AgentFlrRestoreTargetHostModel:
    """Target machine for file-level restore.

    Attributes:
        type_ (EFlrPlatformType): Platform type.
        protected_computer_id (UUID): Protected computer ID. To get the ID, run the [Get Discovered
            Entities](Agents#operation/GetDiscoveredEntities) request.
    """
