...
if TYPE_CHECKING:
    from ..models.backup_indexing_settings_model import BackupIndexingSettingsModel


T = TypeVar("T", bound="GuestFileSystemIndexingModel")


@_attrs_define
class GuestFileSystemIndexingModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        guest_file_system_indexing_model.additional_properties = d
        return guest_file_system_indexing_model
