...
T = TypeVar("T", bound="WANAcceleratorsResult")


@_attrs_define
class WANAcceleratorsResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = WANAcceleratorModel.from_dict(data_item_data)

            data.append(data_item)

        pagination = PaginationResult.from_dict(d.pop("pagination"))

        wan_accelerators_result = cls(
            data=data,
            pagination=pagination,
        )

        wan_accelerators_result.additional_properties = d
        return wan_accelerators_result
