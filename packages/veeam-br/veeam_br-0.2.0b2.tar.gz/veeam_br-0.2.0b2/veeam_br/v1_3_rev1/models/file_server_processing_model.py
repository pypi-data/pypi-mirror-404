...
T = TypeVar("T", bound="FileServerProcessingModel")


@_attrs_define
class FileServerProcessingModel:
    """File server processing settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file_server_processing_model = cls(
            cache_repository_id=cache_repository_id,
            backup_io_control_level=backup_io_control_level,
        )

        file_server_processing_model.additional_properties = d
        return file_server_processing_model
