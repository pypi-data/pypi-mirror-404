...
T = TypeVar("T", bound="HierarchyRescanTaskModel")


@_attrs_define
class HierarchyRescanTaskModel:
    """Hierarchy rescan task.
    ...
    Attributes:
        ...
        server_name (str | Unset): Name of the rescanned server.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hierarchy_rescan_task_model = cls(
            id=id,
            type_=type_,
            name=name,
            state=state,
        ...
        hierarchy_rescan_task_model.additional_properties = d
        return hierarchy_rescan_task_model
