...
T = TypeVar("T", bound="IBMCloudStorageBrowserDestinationSpec")


@_attrs_define
class IBMCloudStorageBrowserDestinationSpec:
    """Settings for creating a new folder in IBM Cloud storage.
    ...
    Attributes:
        ...
        connection_point (str): Endpoint address and port number of the IBM Cloud object storage.
        region_id (str): Region where the bucket is located.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ibm_cloud_storage_browser_destination_spec = cls(
        ...
        ibm_cloud_storage_browser_destination_spec.additional_properties = d
        return ibm_cloud_storage_browser_destination_spec
