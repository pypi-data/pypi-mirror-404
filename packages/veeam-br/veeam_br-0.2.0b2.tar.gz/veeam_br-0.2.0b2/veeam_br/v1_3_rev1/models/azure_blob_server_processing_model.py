...
T = TypeVar("T", bound="AzureBlobServerProcessingModel")


@_attrs_define
class AzureBlobServerProcessingModel:
    """Processing settings for Microsoft Azure Blob storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        azure_blob_server_processing_model = cls(
            backup_proxies=backup_proxies,
            cache_repository_id=cache_repository_id,
            backup_io_control_level=backup_io_control_level,
        )

        azure_blob_server_processing_model.additional_properties = d
        return azure_blob_server_processing_model
