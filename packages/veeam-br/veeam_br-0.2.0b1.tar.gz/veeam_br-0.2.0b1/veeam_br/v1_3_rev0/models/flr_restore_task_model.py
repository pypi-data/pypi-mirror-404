...
T = TypeVar("T", bound="FlrRestoreTaskModel")


@_attrs_define
class FlrRestoreTaskModel:
    """File restore task.
    ...
    Attributes:
        ...
        logs (SessionLogResult): Log of the session.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        logs = SessionLogResult.from_dict(d.pop("logs"))
        ...
        flr_restore_task_model.additional_properties = d
        return flr_restore_task_model
