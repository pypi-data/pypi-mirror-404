...
class VSphereReplicaJobDataTransferModel:
    ...
    Attributes:
        source_proxies (BackupProxiesSettingsModel): VMware vSphere backup proxy settings.
        target_proxies (BackupProxiesSettingsModel): VMware vSphere backup proxy settings.
