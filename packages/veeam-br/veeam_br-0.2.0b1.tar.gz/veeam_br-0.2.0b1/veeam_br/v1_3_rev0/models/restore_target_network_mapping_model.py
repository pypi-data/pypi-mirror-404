...
T = TypeVar("T", bound="RestoreTargetNetworkMappingModel")


@_attrs_define
class RestoreTargetNetworkMappingModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_target_network_mapping_model = cls(
            source_network=source_network,
            target_network=target_network,
        )

        restore_target_network_mapping_model.additional_properties = d
        return restore_target_network_mapping_model
