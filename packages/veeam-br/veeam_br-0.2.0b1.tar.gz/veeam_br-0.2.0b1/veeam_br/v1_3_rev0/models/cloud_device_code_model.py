...
T = TypeVar("T", bound="CloudDeviceCodeModel")


@_attrs_define
class CloudDeviceCodeModel:
    """Verification code.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_device_code_model = cls(
            type_=type_,
        )

        cloud_device_code_model.additional_properties = d
        return cloud_device_code_model
