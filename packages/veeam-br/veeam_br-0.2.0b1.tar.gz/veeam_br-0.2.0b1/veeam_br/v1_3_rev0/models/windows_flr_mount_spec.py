...
class WindowsFlrMountSpec:
    ...
    Attributes:
        ...
        mount_server (WindowsFlrMountServerSettings | Unset): Mount server settings for file restore from Windows
            machines. Specify these mount server settings if the `mountMode` property is set to `Manual`.
    """
