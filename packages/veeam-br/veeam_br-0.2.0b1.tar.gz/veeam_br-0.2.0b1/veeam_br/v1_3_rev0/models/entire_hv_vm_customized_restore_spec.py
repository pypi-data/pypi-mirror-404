...
T = TypeVar("T", bound="EntireHvVMCustomizedRestoreSpec")


@_attrs_define
class EntireHvVMCustomizedRestoreSpec:
    """Restore to a new location or with different settings. To get the inventory objects, use the [Get All
    ...
    Browser#operation/GetInventoryObjects) requests.
        ...
        Attributes:
            ...
            network (HvRestoreTargetNetworkSpec | Unset): Network to which the restored VM will be connected. To get
                information about source and target network objects, use the [Get Inventory Objects](Inventory-
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entire_hv_vm_customized_restore_spec = cls(
        ...
        entire_hv_vm_customized_restore_spec.additional_properties = d
        return entire_hv_vm_customized_restore_spec
