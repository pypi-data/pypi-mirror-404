...
T = TypeVar("T", bound="SMBShareServerProcessingModel")


@_attrs_define
class SMBShareServerProcessingModel:
    """SMB share processing options.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        smb_share_server_processing_model = cls(
            backup_proxies=backup_proxies,
            cache_repository_id=cache_repository_id,
            backup_io_control_level=backup_io_control_level,
        )

        smb_share_server_processing_model.additional_properties = d
        return smb_share_server_processing_model
