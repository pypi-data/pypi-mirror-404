...
if TYPE_CHECKING:
    from ..models.cloud_director_vi_host_spec import CloudDirectorViHostSpec


T = TypeVar("T", bound="CloudDirectorHostSpec")


@_attrs_define
class CloudDirectorHostSpec:
    """Settings for VMware Cloud Director server.
    ...
    Attributes:
        ...
        vi_servers (list[CloudDirectorViHostSpec]): Array of vCenter Servers added to VMware Cloud Director.
    ...
    credentials_id: UUID
    vi_servers: list[CloudDirectorViHostSpec]
    url: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for vi_servers_item_data in _vi_servers:
            vi_servers_item = CloudDirectorViHostSpec.from_dict(vi_servers_item_data)
        ...
        cloud_director_host_spec.additional_properties = d
        return cloud_director_host_spec
