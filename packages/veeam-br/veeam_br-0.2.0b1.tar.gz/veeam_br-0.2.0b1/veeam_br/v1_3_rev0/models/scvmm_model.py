...
class SCVMMModel:
    ...
    Attributes:
        ...
        add_all_servers (bool | Unset): If `true`, all Microsoft Hyper-V hosts and clusters managed by the SCVMM server
            will be added to the backup infrastructure.
        ...
        child_servers (list[HvHostDiscoveryModel] | Unset): Array of Microsoft Hyper-V servers.
    """
    ...
    credentials_id: UUID
    add_all_servers: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        add_all_servers = self.add_all_servers
        ...
        if add_all_servers is not UNSET:
            field_dict["addAllServers"] = add_all_servers
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_all_servers = d.pop("addAllServers", UNSET)
        ...
        scvmm_model = cls(
            ...
            add_all_servers=add_all_servers,
            network_settings=network_settings,
            child_servers=child_servers,
        )

        scvmm_model.additional_properties = d
        return scvmm_model
