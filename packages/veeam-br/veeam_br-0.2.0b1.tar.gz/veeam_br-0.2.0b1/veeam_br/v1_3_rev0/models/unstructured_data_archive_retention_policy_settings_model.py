...
class UnstructuredDataArchiveRetentionPolicySettingsModel:
    ...
    Attributes:
        type_ (EUnstructuredDataArchiveRetentionPolicyType | Unset): Type of retention policy.
        quantity (int | Unset): Number of days or months that you want to keep the backup in the archive repository.
    """

    type_: EUnstructuredDataArchiveRetentionPolicyType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: EUnstructuredDataArchiveRetentionPolicyType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = EUnstructuredDataArchiveRetentionPolicyType(_type_)
