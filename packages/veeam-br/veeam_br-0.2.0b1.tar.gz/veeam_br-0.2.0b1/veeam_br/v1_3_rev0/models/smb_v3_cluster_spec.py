...
T = TypeVar("T", bound="SmbV3ClusterSpec")


@_attrs_define
class SmbV3ClusterSpec:
    """SMBv3 cluster settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        smb_v3_cluster_spec.additional_properties = d
        return smb_v3_cluster_spec
