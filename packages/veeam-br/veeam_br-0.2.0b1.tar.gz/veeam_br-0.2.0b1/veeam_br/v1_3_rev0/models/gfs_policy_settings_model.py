...
T = TypeVar("T", bound="GFSPolicySettingsModel")


@_attrs_define
class GFSPolicySettingsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gfs_policy_settings_model.additional_properties = d
        return gfs_policy_settings_model
