...
from ..models.e_entra_id_tenant_device_configuration_sorting_property import (
...
T = TypeVar("T", bound="EntraIdTenantDeviceConfigurationSortingBrowseSpec")


@_attrs_define
class EntraIdTenantDeviceConfigurationSortingBrowseSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_tenant_device_configuration_sorting_browse_spec = cls(
            property_=property_,
            direction=direction,
        )

        entra_id_tenant_device_configuration_sorting_browse_spec.additional_properties = d
        return entra_id_tenant_device_configuration_sorting_browse_spec
