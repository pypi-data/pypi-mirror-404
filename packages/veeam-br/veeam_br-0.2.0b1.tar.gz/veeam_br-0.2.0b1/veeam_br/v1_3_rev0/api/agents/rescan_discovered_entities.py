...
def sync_detailed(
    ...
    *,
    ...
    """Rescan Discovered Entities
     ...
     The HTTP POST request to the `/api/v1/agents/protectionGroups/{id}/discoveredEntities/rescan` path
    allows you to start rescan jobs which can install/upgrade agents on a subset of discovered entities
    in the protection group specified by `id`. <p>**Available to**&#58; Veeam Backup Administrator.</p>
