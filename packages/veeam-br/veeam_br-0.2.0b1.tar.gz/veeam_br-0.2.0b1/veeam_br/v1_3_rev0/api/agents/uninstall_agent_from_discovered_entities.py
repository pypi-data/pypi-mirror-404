...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/agents/protectionGroups/{id}/discoveredEntities/uninstallAgent` path allows you to
    uninstall agent from discovered entities in the protection group specified by `id`. <p>**Available
