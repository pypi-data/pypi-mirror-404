...
def sync_detailed(
    ...
    *,
    ...
    """Remove Protection Group
     ...
     The HTTP DELETE request to the `/api/v1/agents/protectionGroups/{id}` path allows you to remove a
    protection group that has the specified `id` from the physical infrastructure. <p>**Available
