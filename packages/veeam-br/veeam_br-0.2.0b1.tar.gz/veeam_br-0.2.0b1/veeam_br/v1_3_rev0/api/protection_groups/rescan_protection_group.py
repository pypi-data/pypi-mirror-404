...
def sync_detailed(
    ...
    *,
    ...
    """Rescan Protection Group
     ...
     The HTTP POST request to the `/api/v1/agents/protectionGroups/{id}/rescan` path allows you to rescan
    a protection group. <p>**Available to**&#58; Veeam Backup Administrator.</p>
