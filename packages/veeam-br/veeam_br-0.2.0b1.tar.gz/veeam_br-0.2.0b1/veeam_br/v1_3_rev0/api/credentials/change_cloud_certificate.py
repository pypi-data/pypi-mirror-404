...
def sync_detailed(
    ...
    *,
    ...
    change a certificate used for authentication in your Microsoft Entra ID application associated with
    an Azure compute account that has the specified `id`.<p>**Available to**&#58; Veeam Backup
