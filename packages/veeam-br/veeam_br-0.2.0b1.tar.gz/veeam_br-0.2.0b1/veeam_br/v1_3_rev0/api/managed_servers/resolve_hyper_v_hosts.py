...
def sync_detailed(
    *,
    ...
    """Get Hyper-V Servers Managed by Hyper-V Cluster or SCVMM Server
     ...
     The HTTP POST request to the `/api/v1/backupInfrastructure/managedServers/hyperVHosts` path allows
    you to get an array of Microsoft Hyper-V Servers managed by a specific Microsoft Hyper-V cluster or
    an SCVMM server. <p>Before you discover the hosts of your SCVMM server, you must add the SCVMM
    server to the Veeam Backup & Replication infrastructure.</p><p> **Available to**&#58; Veeam Backup
    Administrator.</p>
