...
def sync_detailed(
    ...
    *,
    ...
    """Get Volumes for Hyper-V Standalone Server
     ...
     The HTTP GET request to the `/api/v1/backupInfrastructure/managedServers/{id}/volumes` path allows
    you to get volumes on managed server that has the specified `id`. Applicable only for Microsoft
    Hyper-V standalone server<p>**Available to**&#58; Veeam Backup Administrator.</p>
