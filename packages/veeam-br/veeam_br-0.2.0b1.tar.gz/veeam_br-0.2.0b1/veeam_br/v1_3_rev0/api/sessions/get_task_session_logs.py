...
def sync_detailed(
    ...
    *,
    ...
    """Get Task Session Logs
     ...
     The HTTP GET request to the `/api/v1/taskSessions/{id}/logs` path allows you to get logs for a task
    session that has the specified `id`.<p>**Available to**&#58; Veeam Backup Administrator, Veeam
