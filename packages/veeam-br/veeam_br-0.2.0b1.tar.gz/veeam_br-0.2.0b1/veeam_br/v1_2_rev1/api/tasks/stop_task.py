...
def sync_detailed(
    ...
    *,
    ...
    """Stop Task
     ...
     The HTTP POST request to the `/api/v1/tasks/{id}/stop` path allows you to stop a restore task that
    has the specified `id`.<p>**Available to**&#58; Veeam Backup Administrator.</p>
