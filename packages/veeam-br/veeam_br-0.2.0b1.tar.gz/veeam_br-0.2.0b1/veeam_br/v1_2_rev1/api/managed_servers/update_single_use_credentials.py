...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupInfrastructure/managedServers/{id}/updateSingleUseCredentials` path allows you to
    change from persistent to single-use credentials used to access a Linux server that has the
    ...
    Args:
        ...
        body (LinuxCredentialsSpec): Single-use credentials.
