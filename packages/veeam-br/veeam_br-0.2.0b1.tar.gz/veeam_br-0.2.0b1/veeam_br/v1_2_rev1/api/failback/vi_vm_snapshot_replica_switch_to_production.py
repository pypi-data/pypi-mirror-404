...
def sync_detailed(
    *,
    ...
    """Switch over to Production
     ...
     The HTTP POST request to the `/api/v1/failback/switchToProduction/vSphere/snapshot` path allows you
    to manually switch over from snapshot replicas to production VMware vSphere VMs.<p>**Available
