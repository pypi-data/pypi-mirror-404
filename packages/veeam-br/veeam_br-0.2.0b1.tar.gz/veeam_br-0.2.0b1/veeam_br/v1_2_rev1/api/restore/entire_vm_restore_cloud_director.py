...
def sync_detailed(
    *,
    ...
    """Restore Entire VMware Cloud Director VM
     ...
     The HTTP POST request to the `/api/v1/restore/vmRestore/cloudDirector` path allows you to perform
    entire VM restore of a VMware Cloud Director VM to VMware Cloud Director. You can restore a VM from
    the specified restore point to the original location with initial VM settings, or to any location
    but with different settings.<p>**Available to**&#58; Veeam Backup Administrator, Veeam Restore
    Operator.</p>
