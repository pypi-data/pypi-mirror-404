...
def sync_detailed(
    ...
    *,
    ...
    """Remove KMS Server
     ...
     The HTTP DELETE request to the `/api/v1/kmsServers/{id}` path allows you to remove a KMS server that
    has the specified `id`.<p>**Available to**&#58; Veeam Backup Administrator, Veeam Security
    Administrator.</p>
