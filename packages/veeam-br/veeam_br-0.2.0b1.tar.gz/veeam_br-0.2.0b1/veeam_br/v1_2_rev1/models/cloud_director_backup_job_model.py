...
class CloudDirectorBackupJobModel:
    ...
    Attributes:
        ...
        is_high_priority (bool | Unset): If `true`, the resource scheduler will prioritize this job higher than other
            similar jobs and allocate resources to it in the first place.
        storage (BackupJobStorageModel | Unset): Backup storage settings.
