...
T = TypeVar("T", bound="EntraIDAuditLogNotificationSettingsModel")


@_attrs_define
class EntraIDAuditLogNotificationSettingsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_audit_log_notification_settings_model = cls(
            send_snmp_notifications=send_snmp_notifications,
            email_notifications=email_notifications,
        )

        entra_id_audit_log_notification_settings_model.additional_properties = d
        return entra_id_audit_log_notification_settings_model
