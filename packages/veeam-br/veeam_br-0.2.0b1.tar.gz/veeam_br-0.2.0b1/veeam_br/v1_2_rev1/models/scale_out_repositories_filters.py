...
T = TypeVar("T", bound="ScaleOutRepositoriesFilters")
...
class ScaleOutRepositoriesFilters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_order_column, Unset):
            ...
            order_column = EScaleOutRepositoryFiltersOrderColumn(_order_column)

        order_asc = d.pop("orderAsc", UNSET)

        name_filter = d.pop("nameFilter", UNSET)

        scale_out_repositories_filters = cls(
            skip=skip,
            limit=limit,
        ...
        scale_out_repositories_filters.additional_properties = d
        return scale_out_repositories_filters
