...
T = TypeVar("T", bound="UnstructuredDataFlrSearchForResultModel")


@_attrs_define
class UnstructuredDataFlrSearchForResultModel:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unstructured_data_flr_search_for_result_model = cls(
        ...
        unstructured_data_flr_search_for_result_model.additional_properties = d
        return unstructured_data_flr_search_for_result_model
