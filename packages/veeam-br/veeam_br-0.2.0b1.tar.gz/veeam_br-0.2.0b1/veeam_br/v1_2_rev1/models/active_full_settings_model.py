...
T = TypeVar("T", bound="ActiveFullSettingsModel")


@_attrs_define
class ActiveFullSettingsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        active_full_settings_model = cls(
            is_enabled=is_enabled,
            weekly=weekly,
            monthly=monthly,
        )

        active_full_settings_model.additional_properties = d
        return active_full_settings_model
