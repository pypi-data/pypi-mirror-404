...
T = TypeVar("T", bound="AmazonS3GlacierStorageSpec")


@_attrs_define
class AmazonS3GlacierStorageSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        amazon_s3_glacier_storage_spec = cls(
            name=name,
            description=description,
            type_=type_,
            account=account,
        ...
        amazon_s3_glacier_storage_spec.additional_properties = d
        return amazon_s3_glacier_storage_spec
