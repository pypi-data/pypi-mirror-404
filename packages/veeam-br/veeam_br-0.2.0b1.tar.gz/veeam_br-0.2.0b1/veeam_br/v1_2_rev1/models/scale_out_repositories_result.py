...
T = TypeVar("T", bound="ScaleOutRepositoriesResult")


@_attrs_define
class ScaleOutRepositoriesResult:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ScaleOutRepositoryModel.from_dict(data_item_data)

            data.append(data_item)

        pagination = PaginationResult.from_dict(d.pop("pagination"))

        scale_out_repositories_result = cls(
            data=data,
            pagination=pagination,
        )

        scale_out_repositories_result.additional_properties = d
        return scale_out_repositories_result
