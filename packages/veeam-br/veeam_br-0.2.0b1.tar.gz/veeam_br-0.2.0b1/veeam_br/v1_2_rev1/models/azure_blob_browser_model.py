...
if TYPE_CHECKING:
    from ..models.azure_blob_container_browser_model import AzureBlobContainerBrowserModel


T = TypeVar("T", bound="AzureBlobBrowserModel")


@_attrs_define
class AzureBlobBrowserModel:
    """
    Attributes:
        ...
        containers (list[AzureBlobContainerBrowserModel] | Unset): Array of containers that reside in the Azure storage
            account.
    """
    ...
    containers: list[AzureBlobContainerBrowserModel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _containers is not UNSET:
            ...
            for containers_item_data in _containers:
                containers_item = AzureBlobContainerBrowserModel.from_dict(containers_item_data)

                containers.append(containers_item)

        azure_blob_browser_model = cls(
        ...
        azure_blob_browser_model.additional_properties = d
        return azure_blob_browser_model
