...
@_attrs_define
class VSphereReplicaJobVirtualMachinesModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v_sphere_replica_job_virtual_machines_model = cls(
            includes=includes,
            excludes=excludes,
            source_repositories=source_repositories,
        )

        v_sphere_replica_job_virtual_machines_model.additional_properties = d
        return v_sphere_replica_job_virtual_machines_model
