...
class VmwareLinuxFlrHelperApplianceResourceModel:
    """VMware vSphere settings&#58; ESXi host where the helper appliance must be registered, resouce pool the helper
    appliance must be placed, and network the helper appliance must be connected to. To get the inventory objects, use
    the [Get All Servers](#tag/Inventory-Browser/operation/GetAllInventoryHosts) and [Get Inventory
    Objects](#tag/Inventory-Browser/operation/GetInventoryObjects) requests.
