...
from ..models.e_hyper_v_proxy_type import EHyperVProxyType
...
class HyperVBackupProxiesSettingsModel:
    ...
    Attributes:
        proxy_type (EHyperVProxyType): Microsoft Hyper-V backup proxy mode.
        off_host_settings (OffHostBackupProxyModel | Unset): Off-host backup proxy settings.
    """

    proxy_type: EHyperVProxyType
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        proxy_type = EHyperVProxyType(d.pop("proxyType"))
