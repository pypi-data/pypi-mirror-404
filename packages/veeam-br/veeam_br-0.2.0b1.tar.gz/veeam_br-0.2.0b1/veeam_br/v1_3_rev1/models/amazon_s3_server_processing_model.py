...
T = TypeVar("T", bound="AmazonS3ServerProcessingModel")


@_attrs_define
class AmazonS3ServerProcessingModel:
    """Processing settings for Amazon S3 object storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        amazon_s3_server_processing_model = cls(
            backup_proxies=backup_proxies,
            cache_repository_id=cache_repository_id,
            backup_io_control_level=backup_io_control_level,
        )

        amazon_s3_server_processing_model.additional_properties = d
        return amazon_s3_server_processing_model
