...
T = TypeVar("T", bound="BackupSQLSettingsImportModel")


@_attrs_define
class BackupSQLSettingsImportModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_sql_settings_import_model = cls(
        ...
        backup_sql_settings_import_model.additional_properties = d
        return backup_sql_settings_import_model
