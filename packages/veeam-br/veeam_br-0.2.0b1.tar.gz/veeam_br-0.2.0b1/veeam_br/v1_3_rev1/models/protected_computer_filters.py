...
T = TypeVar("T", bound="ProtectedComputerFilters")
...
class ProtectedComputerFilters:
    ...
    Attributes:
        ...
        order_asc (bool | Unset): If `true`, sorts protected computers in ascending order by the `orderColumn`
            parameter.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_order_column, Unset):
            ...
            order_column = EProtectedComputerFiltersOrderColumn(_order_column)
        ...
        if isinstance(_type_filter, Unset):
            ...
            type_filter = EProtectedComputerType(_type_filter)

        protected_computer_filters = cls(
            skip=skip,
            limit=limit,
        ...
        protected_computer_filters.additional_properties = d
        return protected_computer_filters
