...
T = TypeVar("T", bound="CloudBrowserVirtualMachinesSpec")


@_attrs_define
class CloudBrowserVirtualMachinesSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_browser_virtual_machines_spec = cls(
            service_type=service_type,
        )

        cloud_browser_virtual_machines_spec.additional_properties = d
        return cloud_browser_virtual_machines_spec
