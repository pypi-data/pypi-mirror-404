...
class AzureInstantVMRecoverySpec:
    """Settings for Instant Recovery to Microsoft Azure.
    ...
    Attributes:
        ...
        subscription (AzureComputeSubscriptionModel): Microsoft Azure compute subscription.
        ...
        appliance (AzureInstantVMRecoveryApplianceModel): Helper appliance for Instant Recovery to Microsoft Azure.
        name (AzureComputeNameModel | Unset): Name of Microsoft Azure VM.
        reason (str | Unset): Reason for performing Instant Recovery to Microsoft Azure.
