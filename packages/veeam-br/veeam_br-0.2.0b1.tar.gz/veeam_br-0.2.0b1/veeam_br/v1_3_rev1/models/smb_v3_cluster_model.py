...
T = TypeVar("T", bound="SmbV3ClusterModel")


@_attrs_define
class SmbV3ClusterModel:
    """SMBv3 cluster.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        smb_v3_cluster_model.additional_properties = d
        return smb_v3_cluster_model
