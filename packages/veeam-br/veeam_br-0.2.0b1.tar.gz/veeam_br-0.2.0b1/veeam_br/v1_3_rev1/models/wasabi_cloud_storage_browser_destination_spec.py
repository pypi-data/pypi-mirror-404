...
T = TypeVar("T", bound="WasabiCloudStorageBrowserDestinationSpec")


@_attrs_define
class WasabiCloudStorageBrowserDestinationSpec:
    """Settings for creating a new folder in Wasabi Cloud storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wasabi_cloud_storage_browser_destination_spec = cls(
        ...
        wasabi_cloud_storage_browser_destination_spec.additional_properties = d
        return wasabi_cloud_storage_browser_destination_spec
