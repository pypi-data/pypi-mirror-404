...
class LoadCalculatorConfigurationResponse:
    ...
    Attributes:
        ...
        avg_device_configurations_per_minute_backup_count (int): Average number of device configurations backed up in a
            minute.
        avg_device_compliance_policies_per_minute_backup_count (int): Average number of device compliance policies
            backed up in a minute.
        avg_device_management_configuration_policies_per_minute_backup_count (int): Average number of device management
            configuration policies backed up in a minute.
        avg_device_management_compliance_policies_per_minute_backup_count (int): Average number of device management
            compliance policies backed up in a minute.
        avg_org_contacts_per_minute_backup_count (int): Average number of organizational contacts backed up in a minute.
        ...
        avg_ram_consumption_mb (int): Average RAM consumption in MB.
    ...
    avg_device_configurations_per_minute_backup_count: int
    avg_device_compliance_policies_per_minute_backup_count: int
    avg_device_management_configuration_policies_per_minute_backup_count: int
    avg_device_management_compliance_policies_per_minute_backup_count: int
    avg_org_contacts_per_minute_backup_count: int
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        avg_device_configurations_per_minute_backup_count = self.avg_device_configurations_per_minute_backup_count

        avg_device_compliance_policies_per_minute_backup_count = (
            self.avg_device_compliance_policies_per_minute_backup_count
        )

        avg_device_management_configuration_policies_per_minute_backup_count = (
            self.avg_device_management_configuration_policies_per_minute_backup_count
        )

        avg_device_management_compliance_policies_per_minute_backup_count = (
            self.avg_device_management_compliance_policies_per_minute_backup_count
        )

        avg_org_contacts_per_minute_backup_count = self.avg_org_contacts_per_minute_backup_count
        ...
        field_dict.update(
            {
                ...
                "avgDeviceConfigurationsPerMinuteBackupCount": avg_device_configurations_per_minute_backup_count,
                "avgDeviceCompliancePoliciesPerMinuteBackupCount": avg_device_compliance_policies_per_minute_backup_count,
                "avgDeviceManagementConfigurationPoliciesPerMinuteBackupCount": avg_device_management_configuration_policies_per_minute_backup_count,
                "avgDeviceManagementCompliancePoliciesPerMinuteBackupCount": avg_device_management_compliance_policies_per_minute_backup_count,
                "avgOrgContactsPerMinuteBackupCount": avg_org_contacts_per_minute_backup_count,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        avg_device_configurations_per_minute_backup_count = d.pop("avgDeviceConfigurationsPerMinuteBackupCount")

        avg_device_compliance_policies_per_minute_backup_count = d.pop(
            "avgDeviceCompliancePoliciesPerMinuteBackupCount"
        )

        avg_device_management_configuration_policies_per_minute_backup_count = d.pop(
            "avgDeviceManagementConfigurationPoliciesPerMinuteBackupCount"
        )

        avg_device_management_compliance_policies_per_minute_backup_count = d.pop(
            "avgDeviceManagementCompliancePoliciesPerMinuteBackupCount"
        )

        avg_org_contacts_per_minute_backup_count = d.pop("avgOrgContactsPerMinuteBackupCount")
        ...
        load_calculator_configuration_response = cls(
            ...
            avg_device_configurations_per_minute_backup_count=avg_device_configurations_per_minute_backup_count,
            avg_device_compliance_policies_per_minute_backup_count=avg_device_compliance_policies_per_minute_backup_count,
            avg_device_management_configuration_policies_per_minute_backup_count=avg_device_management_configuration_policies_per_minute_backup_count,
            avg_device_management_compliance_policies_per_minute_backup_count=avg_device_management_compliance_policies_per_minute_backup_count,
            avg_org_contacts_per_minute_backup_count=avg_org_contacts_per_minute_backup_count,
