...
T = TypeVar("T", bound="CloudDeviceCodeSpec")


@_attrs_define
class CloudDeviceCodeSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_device_code_spec = cls(
            type_=type_,
        )

        cloud_device_code_spec.additional_properties = d
        return cloud_device_code_spec
