...
class ViVMSnapshotReplicaCustomizedFailbackSpec:
    """Settings for failback to another location.
    ...
    Attributes:
        ...
        destinationhost (list[ViVMSnapshotReplicaFailbackTargetHostSpec] | Unset): Array of restore points and target
            hosts (or clusters) where the replicas will be registered. To get the inventory objects, run the [Get All
        ...
        resource_pool (list[ViVMSnapshotReplicaFailbackTargetResourcePoolSpec] | Unset): Array of restore points and
            target resource pools. To get a resource pool object, run the [Get Inventory Objects](Inventory-
        ...
        datastore (list[ViVMSnapshotReplicaFailbackTargetDatastoreSpec] | Unset): Array of datastores where
            configuration files and disk files of recovered VMs will be stored. To get a datastore object, run the [Get
