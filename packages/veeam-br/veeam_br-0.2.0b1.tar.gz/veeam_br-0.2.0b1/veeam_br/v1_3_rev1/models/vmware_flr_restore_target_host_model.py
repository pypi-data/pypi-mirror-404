...
class VmwareFlrRestoreTargetHostModel:
    """Target VMware vSphere VM for file-level restore.

    Attributes:
        type_ (EFlrPlatformType): Platform type.
        vm_object (VmwareObjectModel): VMware vSphere object.
    """

    type_: EFlrPlatformType
    vm_object: VmwareObjectModel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vm_object = VmwareObjectModel.from_dict(d.pop("vmObject"))
