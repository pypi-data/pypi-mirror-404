...
class VSphereReplicaJobDestinationModel:
    ...
    rules.
        ...
        Attributes:
            ...
            mapping_rules (list[VSphereReplicaJobDestinationMappingModel] | Unset): Mapping rules that define file location
                and disk provisioning types for replica VMs.<ul><li>`vmObject` — VM for which you customize the file
