...
T = TypeVar("T", bound="TenantReservationRequest")


@_attrs_define
class TenantReservationRequest:
    """Tenant reservations settings.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tenant_reservation_request = cls(
            azure_tenant_id=azure_tenant_id,
            application_id=application_id,
        )

        tenant_reservation_request.additional_properties = d
        return tenant_reservation_request
