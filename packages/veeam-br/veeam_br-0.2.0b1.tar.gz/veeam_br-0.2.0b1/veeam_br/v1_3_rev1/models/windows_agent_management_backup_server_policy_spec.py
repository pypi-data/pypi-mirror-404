...
T = TypeVar("T", bound="WindowsAgentManagementBackupServerPolicySpec")


@_attrs_define
class WindowsAgentManagementBackupServerPolicySpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        windows_agent_management_backup_server_policy_spec = cls(
            name=name,
            type_=type_,
            description=description,
        ...
        windows_agent_management_backup_server_policy_spec.additional_properties = d
        return windows_agent_management_backup_server_policy_spec
