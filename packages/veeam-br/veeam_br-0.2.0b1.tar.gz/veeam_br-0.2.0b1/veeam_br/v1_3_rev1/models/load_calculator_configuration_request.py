...
class LoadCalculatorConfigurationRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if avg_device_configurations_per_minute_backup_count is not UNSET:
            field_dict["avgDeviceConfigurationsPerMinuteBackupCount"] = (
                avg_device_configurations_per_minute_backup_count
            )
        if avg_device_compliance_policies_per_minute_backup_count is not UNSET:
            field_dict["avgDeviceCompliancePoliciesPerMinuteBackupCount"] = (
                avg_device_compliance_policies_per_minute_backup_count
            )
        if avg_device_management_configuration_policies_per_minute_backup_count is not UNSET:
            field_dict["avgDeviceManagementConfigurationPoliciesPerMinuteBackupCount"] = (
                avg_device_management_configuration_policies_per_minute_backup_count
            )
        if avg_device_management_compliance_policies_per_minute_backup_count is not UNSET:
            field_dict["avgDeviceManagementCompliancePoliciesPerMinuteBackupCount"] = (
                avg_device_management_compliance_policies_per_minute_backup_count
            )
        if avg_org_contacts_per_minute_backup_count is not UNSET:
            field_dict["avgOrgContactsPerMinuteBackupCount"] = avg_org_contacts_per_minute_backup_count
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        avg_device_configurations_per_minute_backup_count = d.pop("avgDeviceConfigurationsPerMinuteBackupCount", UNSET)

        avg_device_compliance_policies_per_minute_backup_count = d.pop(
            "avgDeviceCompliancePoliciesPerMinuteBackupCount", UNSET
        )

        avg_device_management_configuration_policies_per_minute_backup_count = d.pop(
            "avgDeviceManagementConfigurationPoliciesPerMinuteBackupCount", UNSET
        )

        avg_device_management_compliance_policies_per_minute_backup_count = d.pop(
            "avgDeviceManagementCompliancePoliciesPerMinuteBackupCount", UNSET
        )

        avg_org_contacts_per_minute_backup_count = d.pop("avgOrgContactsPerMinuteBackupCount", UNSET)
