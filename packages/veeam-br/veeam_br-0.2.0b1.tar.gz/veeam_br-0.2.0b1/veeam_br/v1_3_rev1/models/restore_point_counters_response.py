...
T = TypeVar("T", bound="RestorePointCountersResponse")


@_attrs_define
class RestorePointCountersResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_point_counters_response.additional_properties = d
        return restore_point_counters_response
