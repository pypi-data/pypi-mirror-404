...
T = TypeVar("T", bound="BackupFilesResult")


@_attrs_define
class BackupFilesResult:
    """Details on backup files.

    Attributes:
        data (list[BackupFileModel] | Unset): Array of backup files.
        pagination (PaginationResult | Unset): Pagination settings.
    """

    data: list[BackupFileModel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = BackupFileModel.from_dict(data_item_data)
        ...
        backup_files_result = cls(
            data=data,
            pagination=pagination,
        )

        backup_files_result.additional_properties = d
        return backup_files_result
