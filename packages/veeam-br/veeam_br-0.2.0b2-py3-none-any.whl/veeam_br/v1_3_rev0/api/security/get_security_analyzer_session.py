...
def sync_detailed(
    *,
    ...
    """Get Security & Compliance Analyzer Last Run
     ...
     The HTTP GET request to the `/api/v1/securityAnalyzer/lastRun` path allows you to get the last
    session of Security & Compliance Analyzer.<p>**Available to**&#58; Veeam Backup Administrator, Veeam
