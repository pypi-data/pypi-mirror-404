...
def sync_detailed(
    *,
    ...
    """Start Security & Compliance Analyzer
     ...
     The HTTP POST request to the `/api/v1/securityAnalyzer/start` path allows you to start Security &
    Compliance Analyzer on the backup server.<p>**Available to**&#58; Veeam Backup Administrator, Veeam
