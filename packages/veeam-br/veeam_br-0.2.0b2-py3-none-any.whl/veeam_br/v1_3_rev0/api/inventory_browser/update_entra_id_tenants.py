...
def sync_detailed(
    ...
    *,
    ...
    """Edit Microsoft Entra ID Tenant
     ...
     The HTTP PUT request to the `/api/v1/inventory/entraId/tenants/{id}` path allows you to edit a
    Microsoft Entra ID tenant that has the specified `id`.<p>**Available to**&#58; Veeam Backup
    Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.3-rev0'.
        body (EntraIDTenantModel): Entra ID tenant settings.
