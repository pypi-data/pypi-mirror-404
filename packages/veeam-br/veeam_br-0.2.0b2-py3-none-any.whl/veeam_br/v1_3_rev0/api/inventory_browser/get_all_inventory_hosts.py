...
def sync_detailed(
    *,
    ...
    servers by type, use the following possible values&#58;<ul> <li>For VMware VSphere&#58;
    *VCenterServer*, *Folder*, *Host*</li> <li>For VMware Cloud Director&#58; *CloudDirectorServer*</li>
    <li>For Microsoft Hyper-V&#58; *Scvmm*, *Cluster*, *Host*</li> </ul>For details, see request
    samples.<p>To browse Veeam Agents inventory, use the [Get All Protection Groups](Inventory-
    Browser#operation/GetAllInventoryPGs) request.</p></div> <p>**Available to**&#58; Veeam Backup
    Administrator.</p>
