...
def sync_detailed(
    ...
    *,
    ...
    """Get Unstructured Data Mount Point
     ...
     The HTTP GET request to the `/api/v1/backupBrowser/flr/unstructuredData/{sessionId}` path allows you
    to get an unstructured data mount point that was created by a restore session that has the specified
