...
def sync_detailed(
    ...
    *,
    ...
    """Browse Search Results
     ...
     The HTTP POST request to the `/api/v1/backupBrowser/flr/{sessionId}/search/{taskId}/browse` path
    allows you to browse search results of a search task that has the specified `taskId`. <p>**Available
