...
def sync_detailed(
    *,
    ...
    """Get All Replica Restore Points
     ...
     The HTTP GET request to the `/api/v1/replicaPoints` path allows you to get an array of all replica
    restore points created on the backup server.<p>**Available to**&#58; Veeam Backup Administrator,
