...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/agents/protectionGroups/{id}/discoveredEntities/uninstallAllComponents` path allows you to
    uninstall all components from discovered entities in the protection group with the specified `id`.
