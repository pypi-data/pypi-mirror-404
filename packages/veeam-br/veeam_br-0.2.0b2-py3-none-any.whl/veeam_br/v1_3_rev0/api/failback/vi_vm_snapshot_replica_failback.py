...
def sync_detailed(
    *,
    ...
    """Start Failback
     ...
     The HTTP POST request to the `/api/v1/failback/failbackToProduction/vSphere/snapshot` path allows
    you to fail back from snapshot replicas to production VMware vSphere VMs.<p>Failback must be
