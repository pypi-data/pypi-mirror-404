...
def sync_detailed(
    ...
    *,
    ...
    """Revoke Instance License
     ...
     The HTTP POST request to the `/api/v1/license/instances/{instanceId}/revoke` path allows you to
    revoke an instance license from the workload that has the specified `instanceId`.<p>**Available
