...
def sync_detailed(
    ...
    *,
    ...
    """Download Deployment Kit Package
     ...
     The HTTP GET request to the `/api/v1/deployment/{taskId}/downloadKit` path allows you to download
    the deployment kit as a ZIP file. Save the ZIP file to the Windows server you want to add as a
