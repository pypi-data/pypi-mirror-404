...
T = TypeVar("T", bound="InstanceLicenseWorkloadResult")


@_attrs_define
class InstanceLicenseWorkloadResult:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = InstanceLicenseWorkloadModel.from_dict(data_item_data)

            data.append(data_item)

        pagination = PaginationResult.from_dict(d.pop("pagination"))

        instance_license_workload_result = cls(
            data=data,
            pagination=pagination,
        )

        instance_license_workload_result.additional_properties = d
        return instance_license_workload_result
