...
if TYPE_CHECKING:
    from ..models.amazon_ec2_browser_filters import AmazonEC2BrowserFilters


T = TypeVar("T", bound="AmazonEC2BrowserSpec")


@_attrs_define
class AmazonEC2BrowserSpec:
    """Amazon EC2 settings.
    ...
    Attributes:
        ...
        filters (AmazonEC2BrowserFilters | Unset): Amazon EC2 hierarchy filters. Using the filters reduces not only the
    ...
    filters: AmazonEC2BrowserFilters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        filters: AmazonEC2BrowserFilters | Unset
        if isinstance(_filters, Unset):
            filters = UNSET
        else:
            filters = AmazonEC2BrowserFilters.from_dict(_filters)

        amazon_ec2_browser_spec = cls(
        ...
        amazon_ec2_browser_spec.additional_properties = d
        return amazon_ec2_browser_spec
