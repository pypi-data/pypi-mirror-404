...
T = TypeVar("T", bound="FlrBrowseFolderModel")


@_attrs_define
class FlrBrowseFolderModel:
    """Item content.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flr_browse_folder_model = cls(
            path=path,
            items=items,
            pagination=pagination,
        )

        flr_browse_folder_model.additional_properties = d
        return flr_browse_folder_model
