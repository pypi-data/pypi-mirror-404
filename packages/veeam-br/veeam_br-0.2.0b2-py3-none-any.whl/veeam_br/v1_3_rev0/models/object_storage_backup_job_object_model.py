...
class ObjectStorageBackupJobObjectModel:
    ...
    Attributes:
        object_storage_server_id (UUID | Unset): ID of the object storage server.
    ...
    object_storage_server_id: UUID | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        object_storage_server_id: str | Unset = UNSET
        if not isinstance(self.object_storage_server_id, Unset):
        ...
        field_dict.update({})
        if object_storage_server_id is not UNSET:
            field_dict["objectStorageServerId"] = object_storage_server_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        _object_storage_server_id = d.pop("objectStorageServerId", UNSET)
        object_storage_server_id: UUID | Unset
        if isinstance(_object_storage_server_id, Unset):
            object_storage_server_id = UNSET
        else:
            object_storage_server_id = UUID(_object_storage_server_id)
