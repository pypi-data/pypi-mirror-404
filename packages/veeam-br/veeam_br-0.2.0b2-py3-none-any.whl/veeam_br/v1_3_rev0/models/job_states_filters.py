...
class JobStatesFilters:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        after_job_name_filter = self.after_job_name_filter
        ...
        if after_job_id_filter is not UNSET:
            field_dict["afterJobIdFilter"] = after_job_id_filter
        if after_job_name_filter is not UNSET:
            field_dict["afterJobNameFilter"] = after_job_name_filter
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_after_job_id_filter, Unset):
            ...
            after_job_id_filter = UUID(_after_job_id_filter)

        after_job_name_filter = d.pop("afterJobNameFilter", UNSET)
