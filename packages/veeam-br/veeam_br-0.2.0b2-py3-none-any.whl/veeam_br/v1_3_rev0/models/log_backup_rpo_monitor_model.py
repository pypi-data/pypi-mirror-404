...
class LogBackupRPOMonitorModel:
    ...
    Attributes:
        is_enabled (bool): If `true`, there will be a warning if a newly transaction log is not copied within the
            desired recovery point objective (RPO).
        type_ (EPeriodicallyKindsBackupCopy | Unset): Time unit for periodic job scheduling.
        quantity (int | Unset): Number of days, hours or minutes within that you will be warned if log backup is not
            copied.
    """
