...
T = TypeVar("T", bound="BackupRPOMonitorModel")


@_attrs_define
class BackupRPOMonitorModel:
    """RPO monitor settings if new backup is not copied.
    ...
    Attributes:
        ...
        quantity (int | Unset): Number of days, hours or minutes within that you will be warned if backup is not copied.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_rpo_monitor_model = cls(
            is_enabled=is_enabled,
            type_=type_,
            quantity=quantity,
        )

        backup_rpo_monitor_model.additional_properties = d
        return backup_rpo_monitor_model
