...
T = TypeVar("T", bound="WasabiCloudStorageBucketModel")


@_attrs_define
class WasabiCloudStorageBucketModel:
    """Wasabi bucket where backup data is stored.

    Attributes:
        bucket_name (str): Name of a Wasabi bucket.
        folder_name (str): Name of the folder to which object storage repository is mapped.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wasabi_cloud_storage_bucket_model = cls(
        ...
        wasabi_cloud_storage_bucket_model.additional_properties = d
        return wasabi_cloud_storage_bucket_model
