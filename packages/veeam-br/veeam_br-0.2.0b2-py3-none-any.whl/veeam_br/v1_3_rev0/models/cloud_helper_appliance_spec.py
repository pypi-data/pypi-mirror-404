...
T = TypeVar("T", bound="CloudHelperApplianceSpec")


@_attrs_define
class CloudHelperApplianceSpec:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_helper_appliance_spec = cls(
            type_=type_,
        )

        cloud_helper_appliance_spec.additional_properties = d
        return cloud_helper_appliance_spec
