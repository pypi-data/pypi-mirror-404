...
T = TypeVar("T", bound="CloudHelperApplianceModel")


@_attrs_define
class CloudHelperApplianceModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_helper_appliance_model = cls(
            type_=type_,
        )

        cloud_helper_appliance_model.additional_properties = d
        return cloud_helper_appliance_model
