...
T = TypeVar("T", bound="InventoryBrowserRequestOptions")


@_attrs_define
class InventoryBrowserRequestOptions:
    """Options for inventory browser request.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        inventory_browser_request_options = cls(
            reset_cache=reset_cache,
        )

        inventory_browser_request_options.additional_properties = d
        return inventory_browser_request_options
