...
T = TypeVar("T", bound="ReplicaTaskSessionModel")


@_attrs_define
class ReplicaTaskSessionModel:
    """Settings of replica task session.
    ...
    Attributes:
        ...
        replica_point_id (UUID | Unset): ID of the replica restore point.
        replica_point_reference (str | Unset): Reference of the replica restore point.
    ...
    replica_point_reference: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        replica_point_reference = self.replica_point_reference
        ...
        if replica_point_reference is not UNSET:
            field_dict["replicaPointReference"] = replica_point_reference
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replica_point_reference = d.pop("replicaPointReference", UNSET)
        ...
        replica_task_session_model = cls(
            id=id,
            type_=type_,
            ...
            replica_point_reference=replica_point_reference,
            algorithm=algorithm,
            result=result,
            progress=progress,
        )

        replica_task_session_model.additional_properties = d
        return replica_task_session_model
