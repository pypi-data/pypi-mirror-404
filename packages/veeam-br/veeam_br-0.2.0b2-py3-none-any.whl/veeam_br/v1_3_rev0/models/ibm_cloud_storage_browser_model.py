...
if TYPE_CHECKING:
    from ..models.ibm_cloud_storage_region_browser_model import IBMCloudStorageRegionBrowserModel


T = TypeVar("T", bound="IBMCloudStorageBrowserModel")


@_attrs_define
class IBMCloudStorageBrowserModel:
    """IBM cloud storage.
    ...
    Attributes:
        ...
        regions (list[IBMCloudStorageRegionBrowserModel] | Unset): Array of regions.
    """

    credentials_id: UUID
    service_type: ECloudServiceType
    host_id: UUID | Unset = UNSET
    regions: list[IBMCloudStorageRegionBrowserModel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _regions is not UNSET:
            ...
            for regions_item_data in _regions:
                regions_item = IBMCloudStorageRegionBrowserModel.from_dict(regions_item_data)

                regions.append(regions_item)

        ibm_cloud_storage_browser_model = cls(
        ...
        ibm_cloud_storage_browser_model.additional_properties = d
        return ibm_cloud_storage_browser_model
