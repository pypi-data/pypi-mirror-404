...
T = TypeVar("T", bound="CloudBrowserModel")


@_attrs_define
class CloudBrowserModel:
    """Cloud compute or storage resources.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_browser_model = cls(
            credentials_id=credentials_id,
            service_type=service_type,
        )

        cloud_browser_model.additional_properties = d
        return cloud_browser_model
