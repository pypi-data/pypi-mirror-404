...
T = TypeVar("T", bound="CloudDirectorViHostSpec")


@_attrs_define
class CloudDirectorViHostSpec:
    """Settings for vCenter Server added to VMware Cloud Director.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_director_vi_host_spec = cls(
            vi_server_name=vi_server_name,
            vi_credentials_id=vi_credentials_id,
            certificate_thumbprint=certificate_thumbprint,
        )

        cloud_director_vi_host_spec.additional_properties = d
        return cloud_director_vi_host_spec
