...
T = TypeVar("T", bound="ISCSIWindowsMountSpec")


@_attrs_define
class ISCSIWindowsMountSpec:
    """iSCSI mount settings. If you use the `SingleUse` credentials type, you must specify credentials in the
    `singleUseCredentials` property.
        ...
        Attributes:
            ...
            single_use_credentials (StandardCredentialsSpec | Unset): Standard credentials settings.
    ...
    single_use_credentials: StandardCredentialsSpec | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        single_use_credentials: StandardCredentialsSpec | Unset
        if isinstance(_single_use_credentials, Unset):
            single_use_credentials = UNSET
        else:
            single_use_credentials = StandardCredentialsSpec.from_dict(_single_use_credentials)
        ...
        iscsi_windows_mount_spec.additional_properties = d
        return iscsi_windows_mount_spec
