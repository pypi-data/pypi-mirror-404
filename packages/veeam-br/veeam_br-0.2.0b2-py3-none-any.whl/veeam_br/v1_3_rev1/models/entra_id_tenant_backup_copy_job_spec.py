...
class EntraIDTenantBackupCopyJobSpec:
    """Settings for Microsoft Entra ID backup copy job.
    ...
    Attributes:
        ...
        use_custom_retention (bool | Unset): If `true`, the backup copy job will use custom retention.
        retention_policy (FileBackupRetentionPolicySettingsModel | Unset): Retention policy settings.
        use_custom_encryption (bool | Unset): If `true`, the backup copy job will use custom encryption.
