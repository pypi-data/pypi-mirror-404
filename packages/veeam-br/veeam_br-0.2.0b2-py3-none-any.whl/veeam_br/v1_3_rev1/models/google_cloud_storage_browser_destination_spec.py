...
T = TypeVar("T", bound="GoogleCloudStorageBrowserDestinationSpec")


@_attrs_define
class GoogleCloudStorageBrowserDestinationSpec:
    """Settings for creating a new folder in Google Cloud storage.
    ...
    Attributes:
        ...
        region_id (str): Data center region where the bucket is located.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        google_cloud_storage_browser_destination_spec = cls(
        ...
        google_cloud_storage_browser_destination_spec.additional_properties = d
        return google_cloud_storage_browser_destination_spec
