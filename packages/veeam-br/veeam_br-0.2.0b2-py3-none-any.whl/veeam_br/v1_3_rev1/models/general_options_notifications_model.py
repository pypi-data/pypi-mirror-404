...
class GeneralOptionsNotificationsModel:
    ...
    Attributes:
        storage_space_threshold_enabled (bool): If `true`, notifications about critical amount of free space in backup
            storage are enabled.
        datastore_space_threshold_enabled (bool): If `true`, notifications about critical amount of free space in a
        ...
        datastore_space_threshold (int | Unset): Space threshold of a production datastore, in percent.
        skip_vm_space_threshold (int | Unset): Space threshold of a production datastore, in percent.
    """
