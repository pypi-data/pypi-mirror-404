...
T = TypeVar("T", bound="EntireCloudDirectorVMOriginalLocationRestoreSpec")


@_attrs_define
class EntireCloudDirectorVMOriginalLocationRestoreSpec:
    """Restore to the original location with initial settings.
    ...
    Attributes:
        ...
        quick_rollback (bool | Unset): If `true`, Veeam Backup & Replication performs incremental restore.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entire_cloud_director_vm_original_location_restore_spec = cls(
        ...
        entire_cloud_director_vm_original_location_restore_spec.additional_properties = d
        return entire_cloud_director_vm_original_location_restore_spec
