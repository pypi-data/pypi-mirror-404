...
T = TypeVar("T", bound="AzureBlobBrowserDestinationSpec")


@_attrs_define
class AzureBlobBrowserDestinationSpec:
    """Settings for creating a new folder in Microsoft Azure Blob storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        azure_blob_browser_destination_spec = cls(
        ...
        azure_blob_browser_destination_spec.additional_properties = d
        return azure_blob_browser_destination_spec
