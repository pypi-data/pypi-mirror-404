...
T = TypeVar("T", bound="EntireCloudDirectorVMRestoreSpec")


@_attrs_define
class EntireCloudDirectorVMRestoreSpec:
    """Settings for restoring entire VMware Cloud Director VM.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entire_cloud_director_vm_restore_spec = cls(
        ...
        entire_cloud_director_vm_restore_spec.additional_properties = d
        return entire_cloud_director_vm_restore_spec
