...
T = TypeVar("T", bound="EntraIdTenantItemRecursiveComparisonSpec")


@_attrs_define
class EntraIdTenantItemRecursiveComparisonSpec:
    """Settings for recursive comparison of the properties of a Microsoft Entra ID Conditional Access policy.
    ...
    Attributes:
        ...
        new_restore_point_id (UUID | Unset): ID of a later restore point. If you do not specify this property, the item
            from the earlier restore point will be compared to the item in production.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        entra_id_tenant_item_recursive_comparison_spec = cls(
            item_id=item_id,
        ...
        entra_id_tenant_item_recursive_comparison_spec.additional_properties = d
        return entra_id_tenant_item_recursive_comparison_spec
