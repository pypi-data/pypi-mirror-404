...
def sync_detailed(
    ...
    *,
    ...
    Instant Recovery mount point of a Microsoft Hyper-V VM, using the specified `mountID`.<p>**Available
    to**&#58; Veeam Backup Administrator, Veeam Backup Operator, Veeam Restore Operator, Veeam Tape
    Operator, Veeam Backup Viewer, Veeam Security Administrator.</p>
