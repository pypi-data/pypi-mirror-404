...
def sync_detailed(
    ...
    *,
    ...
    """Download Backup Metadata
     ...
     The HTTP POST request to the `/api/v1/backups/{id}/downloadBackupMeta` path allows you to download
    metadata of a backup that has the specified `id`.<p>**Available to**&#58; Veeam Backup
    Administrator.</p>

    Args:
        id (UUID):
        x_api_version (str):  Default: '1.2-rev1'.
        body (UnstructuredBackupDownloadMetaSpec | Unset):
