...
def sync_detailed(
    *,
    ...
    Restore](#tag/Restore/operation/GetEntraIdTenantRestoreDeviceCode) request.<p>You can use the
    credentials in the following requests&#58;</p> <ul><li>[Restore Microsoft Entra ID
    Items](#tag/BackupBrowsers/operation/RestoreEntraIdTenantItems)</li> <li>[Restore Microsoft Entra ID
    Item Properties](#tag/BackupBrowsers/operation/RestoreEntraIdTenantItemAttributes)</li>
    </ul><p>**Available to**&#58; Veeam Backup Administrator, Veeam Restore Operator.</p>
