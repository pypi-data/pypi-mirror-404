...
def sync_detailed(
    ...
    *,
    ...
    a restore point that has the specified `id` for a replica that has the specified
    `replicaId`.<p>**Available to**&#58; Veeam Backup Administrator, Veeam Restore Operator.</p>
