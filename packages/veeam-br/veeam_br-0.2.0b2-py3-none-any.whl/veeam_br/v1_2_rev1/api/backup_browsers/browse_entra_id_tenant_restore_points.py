...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupBrowser/entraIdTenant/{backupId}/browse/{itemId}/restorePoints` path allows you to
    get restore points that were created for a Microsoft Entra ID item that has the specified
