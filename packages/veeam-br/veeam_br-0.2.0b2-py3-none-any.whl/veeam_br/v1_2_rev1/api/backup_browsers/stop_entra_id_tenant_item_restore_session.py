...
def sync_detailed(
    ...
    *,
    ...
    `/api/v1/backupBrowser/entraIdTenant/{sessionId}/restoreSessions/{restoreSessionId}/stop` path
    allows you to stop a restore session of a Microsoft Entra ID tenant.<p>**Available to**&#58; Veeam
