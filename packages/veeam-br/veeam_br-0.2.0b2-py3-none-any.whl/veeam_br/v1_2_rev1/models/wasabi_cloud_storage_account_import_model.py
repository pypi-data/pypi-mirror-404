...
T = TypeVar("T", bound="WasabiCloudStorageAccountImportModel")


@_attrs_define
class WasabiCloudStorageAccountImportModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wasabi_cloud_storage_account_import_model = cls(
            region_id=region_id,
            credentials=credentials,
            connection_settings=connection_settings,
        )

        wasabi_cloud_storage_account_import_model.additional_properties = d
        return wasabi_cloud_storage_account_import_model
