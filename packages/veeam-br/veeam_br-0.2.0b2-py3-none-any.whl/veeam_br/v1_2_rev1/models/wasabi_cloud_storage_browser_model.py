...
if TYPE_CHECKING:
    from ..models.wasabi_cloud_storage_region_browser_model import WasabiCloudStorageRegionBrowserModel


T = TypeVar("T", bound="WasabiCloudStorageBrowserModel")


@_attrs_define
class WasabiCloudStorageBrowserModel:
    """
    Attributes:
        ...
        regions (list[WasabiCloudStorageRegionBrowserModel] | Unset): Array of regions.
    """

    credentials_id: UUID
    service_type: ECloudServiceType
    host_id: UUID | Unset = UNSET
    regions: list[WasabiCloudStorageRegionBrowserModel] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _regions is not UNSET:
            ...
            for regions_item_data in _regions:
                regions_item = WasabiCloudStorageRegionBrowserModel.from_dict(regions_item_data)

                regions.append(regions_item)

        wasabi_cloud_storage_browser_model = cls(
        ...
        wasabi_cloud_storage_browser_model.additional_properties = d
        return wasabi_cloud_storage_browser_model
