...
T = TypeVar("T", bound="BackupJobStorageModel")


@_attrs_define
class BackupJobStorageModel:
    """Backup storage settings.

    Attributes:
        backup_repository_id (UUID): ID of the backup repository.
        ...
        advanced_settings (BackupJobAdvancedSettingsModel | Unset): Advanced settings of the backup job.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_job_storage_model.additional_properties = d
        return backup_job_storage_model
