...
if TYPE_CHECKING:
    ...
    from ..models.performance_tier_model import PerformanceTierModel
    from ..models.placement_policy_model import PlacementPolicyModel


T = TypeVar("T", bound="ScaleOutRepositoryModel")


@_attrs_define
class ScaleOutRepositoryModel:
    """
    Attributes:
        id (UUID): ID of the scale-out backup repository.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        performance_tier = PerformanceTierModel.from_dict(d.pop("performanceTier"))
        ...
        scale_out_repository_model = cls(
            id=id,
            name=name,
            description=description,
        ...
        scale_out_repository_model.additional_properties = d
        return scale_out_repository_model
