...
T = TypeVar("T", bound="ISCSITargetPublishContentSpec")


@_attrs_define
class ISCSITargetPublishContentSpec:
    """
    Attributes:
        ...
        allowed_ips (list[str]): Array of IP addresses of target servers that are allowed to access the iSCSI target
            server (mount server).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        iscsi_target_publish_content_spec = cls(
        ...
        iscsi_target_publish_content_spec.additional_properties = d
        return iscsi_target_publish_content_spec
