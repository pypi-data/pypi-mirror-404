---
title: "Lenses"
description: "Bidirectional transformations between sample types"
---
...
- [Datasets](datasets.qmd) - Using lenses with Dataset.as_type()
- [Packable Samples](packable-samples.qmd) - Defining sample types
- [Atmosphere](atmosphere.qmd) - Publishing lenses to ATProto federation
