"""
Korean pronunciation rules documentation.
Converted from rules.txt

This module contains the documentation for Korean Standard Pronunciation Rules.
The rules are referenced by ID in the transformation table.

Original source: https://github.com/kyubyong/g2pK
Based on Korean Standard Pronunciation규칙 (표준 발음법)
"""
