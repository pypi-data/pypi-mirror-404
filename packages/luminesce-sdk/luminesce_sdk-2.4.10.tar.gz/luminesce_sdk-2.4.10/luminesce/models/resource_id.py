...
class ResourceId(BaseModel):
    """
    Unique identifier for a resource  # noqa: E501
    """
    scope:  StrictStr = Field(...,alias="scope", description="The scope used to identify a resource") 
    code:  Optional[StrictStr] = Field(None,alias="code", description="The code used to identify a resource") 
