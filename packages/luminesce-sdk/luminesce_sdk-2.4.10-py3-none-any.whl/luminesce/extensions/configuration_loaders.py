...
from luminesce.extensions.file_access_token import FileAccessToken
...
ENVIRONMENT_CONFIG_KEYS = {
    ...
    "api_url": "FBN_LUMINESCE_URL",
    "previous_api_url": "FBN_LUMINESCE_API_URL",
