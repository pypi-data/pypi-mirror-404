...
from .types import Node, NodeStatus, VerificationOutcome, VerificationResult
...
class GraphMemory:
    ...
    def create_node(self, content: str, parent_id: str | None = None) -> Node:
    ...
    def get_cached_solution(self, problem_hash: str) -> str | None:
    ...
    def record_approach_failure(self, solution: str, task: str) -> None:
        ...
        if self.approach_failures[approach_key] >= 2:
            ...
            logger.info(
                f"Approach '{approach}' marked as forbidden after {self.approach_failures[approach_key]} failures"
            )
