...
class SandboxExecutor:
    ...
    def __init__(
        self, timeout_seconds: int = 30, memory_limit_mb: int = 512, use_docker: bool = False
    ):
        """
        ...
        logger.info(
            f"SandboxExecutor initialized (timeout={timeout_seconds}s, docker={use_docker})"
        )

    def execute_python(self, code: str, test_code: str | None = None) -> dict[str, Any]:
        """
    ...
    def _execute_local_python(self, code: str, test_code: str | None = None) -> dict[str, Any]:
        ...
        try:
            ...
            result = subprocess.run(
                ["python3", code_file], capture_output=True, text=True, timeout=self.timeout_seconds
            )
    ...
    def _execute_in_docker(self, code: str, test_code: str | None, language: str) -> dict[str, Any]:
        """
