...
from axe_cli.utils.rich.syntax import AXE_ANSI_THEME_NAME, resolve_code_theme
...
class MarkdownContext:
    ...
    def __init__(
        ...
        inline_code_theme: str | SyntaxTheme = AXE_ANSI_THEME_NAME,
    ) -> None:
...
class Markdown(JupyterMixin):
    ...
    Args:
        ...
        code_theme (str, optional): Pygments theme for code blocks. Defaults to "axe-ansi".
    ...
    def __init__(
        self,
        markup: str,
        code_theme: str = AXE_ANSI_THEME_NAME,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--code-theme",
        dest="code_theme",
        default=AXE_ANSI_THEME_NAME,
        help='code theme (pygments name or "axe-ansi")',
    )
    parser.add_argument(
        "-i",
        "--inline-code-lexer",
