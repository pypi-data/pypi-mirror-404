...
from axe_cli.acp.convert import (
    acp_blocks_to_content_parts,
    display_block_to_acp_content,
    tool_result_to_acp_content,
)
from axe_cli.acp.types import ACPContentBlock
from axe_cli.app import AxeCLI
from axe_cli.soul import LLMNotSet, LLMNotSupported, MaxStepsReached, RunCancelled
...
def get_current_acp_tool_call_id_or_none() -> str | None:
    ...
    from axe_cli.soul.toolset import get_current_tool_call_or_none
...
class ACPSession:
    ...
    @property
    def cli(self) -> AxeCLI:
        """The Axe Code CLI instance bound to this ACP session."""
        return self._cli
