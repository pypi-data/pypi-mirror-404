...
from ...models.delete_variables_bulk_json_body import DeleteVariablesBulkJsonBody
...
def _get_kwargs(
    workspace: str,
    *,
    json_body: DeleteVariablesBulkJsonBody,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "delete",
        "url": "/w/{workspace}/variables/delete_bulk".format(
            workspace=workspace,
        ),
        "json": json_json_body,
    }
