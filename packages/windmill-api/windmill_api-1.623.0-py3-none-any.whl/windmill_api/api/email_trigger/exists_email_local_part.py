...
from ...models.exists_email_local_part_json_body import ExistsEmailLocalPartJsonBody
...
def _get_kwargs(
    workspace: str,
    *,
    json_body: ExistsEmailLocalPartJsonBody,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "post",
        "url": "/w/{workspace}/email_triggers/local_part_exists".format(
            workspace=workspace,
        ),
        "json": json_json_body,
    }
