...
from ...models.exists_native_trigger_service_name import ExistsNativeTriggerServiceName
from ...types import Response


def _get_kwargs(
    workspace: str,
    service_name: ExistsNativeTriggerServiceName,
    external_id: str,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "get",
        "url": "/w/{workspace}/native_triggers/{service_name}/exists/{external_id}".format(
            workspace=workspace,
