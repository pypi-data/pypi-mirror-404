...
from ...models.delete_resources_bulk_json_body import DeleteResourcesBulkJsonBody
...
def _get_kwargs(
    workspace: str,
    *,
    json_body: DeleteResourcesBulkJsonBody,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "delete",
        "url": "/w/{workspace}/resources/delete_bulk".format(
            workspace=workspace,
        ),
        "json": json_json_body,
    }
