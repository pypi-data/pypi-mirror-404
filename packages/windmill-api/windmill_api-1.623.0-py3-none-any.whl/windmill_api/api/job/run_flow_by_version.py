...
from ...models.run_flow_by_version_json_body import RunFlowByVersionJsonBody
...
def _get_kwargs(
    ...
    version: int,
    *,
    json_body: RunFlowByVersionJsonBody,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        json_body (RunFlowByVersionJsonBody): The arguments to pass to the script or flow
