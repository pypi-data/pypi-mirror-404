...
from ...models.run_and_stream_flow_by_version_json_body import RunAndStreamFlowByVersionJsonBody
...
def _get_kwargs(
    ...
    version: int,
    *,
    json_body: RunAndStreamFlowByVersionJsonBody,
    ...
    return {
        "method": "post",
        "url": "/w/{workspace}/jobs/run_and_stream/fv/{version}".format(
            workspace=workspace,
            version=version,
        ),
        "json": json_json_body,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        json_body (RunAndStreamFlowByVersionJsonBody): The arguments to pass to the script or flow
