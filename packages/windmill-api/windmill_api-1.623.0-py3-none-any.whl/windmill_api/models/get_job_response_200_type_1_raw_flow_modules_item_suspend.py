...
class GetJobResponse200Type1RawFlowModulesItemSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetJobResponse200Type1RawFlowModulesItemSuspendResumeForm]): Form schema for
        ...
        user_groups_required (Union['GetJobResponse200Type1RawFlowModulesItemSuspendUserGroupsRequiredType0',
            'GetJobResponse200Type1RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a
