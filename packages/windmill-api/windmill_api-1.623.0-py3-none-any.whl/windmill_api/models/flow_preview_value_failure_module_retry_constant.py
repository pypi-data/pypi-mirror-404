...
T = TypeVar("T", bound="FlowPreviewValueFailureModuleRetryConstant")


@_attrs_define
class FlowPreviewValueFailureModuleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_preview_value_failure_module_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        flow_preview_value_failure_module_retry_constant.additional_properties = d
