...
from ..models.forloop_flow_modules_item_suspend_user_groups_required_type_1_type import (
    ForloopFlowModulesItemSuspendUserGroupsRequiredType1Type,
)
...
@_attrs_define
class ForloopFlowModulesItemSuspendUserGroupsRequiredType1:
    ...
    via 'flow_input.property'. Inside loops, use 'flow_input.iter.value' for the current iteration value
        ...
        Attributes:
            ...
            type (ForloopFlowModulesItemSuspendUserGroupsRequiredType1Type):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = ForloopFlowModulesItemSuspendUserGroupsRequiredType1Type(d.pop("type"))

        forloop_flow_modules_item_suspend_user_groups_required_type_1 = cls(
            expr=expr,
            type=type,
        )

        forloop_flow_modules_item_suspend_user_groups_required_type_1.additional_properties = d
