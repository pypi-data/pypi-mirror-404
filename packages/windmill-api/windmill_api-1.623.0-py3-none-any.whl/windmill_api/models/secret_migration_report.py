...
if TYPE_CHECKING:
    from ..models.secret_migration_report_failures_item import SecretMigrationReportFailuresItem


T = TypeVar("T", bound="SecretMigrationReport")
...
class SecretMigrationReport:
    ...
    Attributes:
        ...
        failures (List['SecretMigrationReportFailuresItem']): Details of any failures encountered during migration
    """

    total_secrets: int
    migrated_count: int
    failed_count: int
    failures: List["SecretMigrationReportFailuresItem"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for failures_item_data in _failures:
            failures_item = SecretMigrationReportFailuresItem.from_dict(failures_item_data)

            failures.append(failures_item)

        secret_migration_report = cls(
            total_secrets=total_secrets,
            migrated_count=migrated_count,
            failed_count=failed_count,
            failures=failures,
        ...
        secret_migration_report.additional_properties = d
        return secret_migration_report
