...
class CompletedJobRawFlowPreprocessorModule:
    ...
    Attributes:
        ...
        sleep (Union['CompletedJobRawFlowPreprocessorModuleSleepType0',
            'CompletedJobRawFlowPreprocessorModuleSleepType1', Unset]): Maps input parameters for a step. Can be a static
        ...
        timeout (Union['CompletedJobRawFlowPreprocessorModuleTimeoutType0',
            'CompletedJobRawFlowPreprocessorModuleTimeoutType1', Unset]): Maps input parameters for a step. Can be a static
            value or a JavaScript expression that references previous results or flow inputs
