...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0RawFlowModulesItemRetryExponential")


@_attrs_define
class ExtendedJobsJobsItemType0RawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_0_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        extended_jobs_jobs_item_type_0_raw_flow_modules_item_retry_exponential.additional_properties = d
        return extended_jobs_jobs_item_type_0_raw_flow_modules_item_retry_exponential
