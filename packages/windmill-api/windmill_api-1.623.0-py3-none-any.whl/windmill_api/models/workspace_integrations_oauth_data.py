...
T = TypeVar("T", bound="WorkspaceIntegrationsOauthData")


@_attrs_define
class WorkspaceIntegrationsOauthData:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workspace_integrations_oauth_data = cls(
            client_id=client_id,
            client_secret=client_secret,
            base_url=base_url,
            redirect_uri=redirect_uri,
        ...
        workspace_integrations_oauth_data.additional_properties = d
        return workspace_integrations_oauth_data
