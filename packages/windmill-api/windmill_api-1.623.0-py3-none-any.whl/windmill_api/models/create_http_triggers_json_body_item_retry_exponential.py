...
T = TypeVar("T", bound="CreateHttpTriggersJsonBodyItemRetryExponential")


@_attrs_define
class CreateHttpTriggersJsonBodyItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_http_triggers_json_body_item_retry_exponential = cls(
            attempts=attempts,
        ...
        create_http_triggers_json_body_item_retry_exponential.additional_properties = d
        return create_http_triggers_json_body_item_retry_exponential
