...
from ..models.delete_completed_job_response_200_raw_flow_modules_item_suspend_user_groups_required_type_1_type import (
    DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1Type,
)
...
class DeleteCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_raw_flow_modules_item_suspend_user_groups_required_type_1.additional_properties = (
            d
        )
