...
T = TypeVar("T", bound="ScheduleWJobsRetryExponential")


@_attrs_define
class ScheduleWJobsRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schedule_w_jobs_retry_exponential = cls(
            attempts=attempts,
        ...
        return schedule_w_jobs_retry_exponential
