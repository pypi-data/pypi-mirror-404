...
T = TypeVar("T", bound="GetKafkaTriggerResponse200RetryConstant")


@_attrs_define
class GetKafkaTriggerResponse200RetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_kafka_trigger_response_200_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_kafka_trigger_response_200_retry_constant.additional_properties = d
        return get_kafka_trigger_response_200_retry_constant
