...
if TYPE_CHECKING:
    ...
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_sleep_type_1 import (
        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSleepType1,
    )
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_stop_after_all_iters_if import (
        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterAllItersIf,
    )
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_stop_after_if import (
        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterIf,
    )
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_suspend import (
        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspend,
    )
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_timeout_type_0 import (
        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType0,
    )
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_timeout_type_1 import (
        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType1,
    )


T = TypeVar("T", bound="GetFlowByPathWithDraftResponse200DraftValuePreprocessorModule")


@_attrs_define
class GetFlowByPathWithDraftResponse200DraftValuePreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterIf]): Early
            termination condition for a module
        stop_after_all_iters_if (Union[Unset,
            GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterAllItersIf]): Early termination condition
            for a module
        skip_if (Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSkipIf]): Conditionally skip
        ...
        sleep (Union['GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSleepType0',
            'GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSleepType1', Unset]): Maps input parameters for a
        ...
        timeout (Union['GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType0',
            'GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType1', Unset]): Maps input parameters for
        ...
        mock (Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleMock]): Mock configuration for
            testing without executing the actual step
        suspend (Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspend]): Configuration for
    ...
    id: str
    value: Any
    stop_after_if: Union[Unset, "GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterIf"] = UNSET
    ...
    mock: Union[Unset, "GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleMock"] = UNSET
    suspend: Union[Unset, "GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspend"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSleepType0):
            sleep = UNSET
        ...
        elif isinstance(self.timeout, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType0):
            timeout = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_stop_after_if, Unset):
            ...
            stop_after_if = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterIf.from_dict(
                _stop_after_if
            )
        ...
        if isinstance(_stop_after_all_iters_if, Unset):
            ...
            stop_after_all_iters_if = (
                GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterAllItersIf.from_dict(
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSleepType0.from_dict(
                        _sleep_type_0
                    )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _sleep_type_1 = data
            sleep_type_1: Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSleepType1]
            if isinstance(_sleep_type_1, Unset):
                sleep_type_1 = UNSET
            else:
                sleep_type_1 = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSleepType1.from_dict(
                    _sleep_type_1
                )
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = (
                        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType0.from_dict(
                            _timeout_type_0
                        )
                    )
            ...
            timeout_type_1: Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType1]
            if isinstance(_timeout_type_1, Unset):
                timeout_type_1 = UNSET
            else:
                timeout_type_1 = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleTimeoutType1.from_dict(
                    _timeout_type_1
                )
        ...
        mock: Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleMock]
        if isinstance(_mock, Unset):
            mock = UNSET
        else:
            mock = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleMock.from_dict(_mock)

        _suspend = d.pop("suspend", UNSET)
        suspend: Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspend]
        if isinstance(_suspend, Unset):
            suspend = UNSET
        else:
            suspend = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspend.from_dict(_suspend)
        ...
        retry: Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleRetry]
        ...
        return get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module
