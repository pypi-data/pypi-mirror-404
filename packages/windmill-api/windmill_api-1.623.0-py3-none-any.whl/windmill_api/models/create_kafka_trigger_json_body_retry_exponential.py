...
T = TypeVar("T", bound="CreateKafkaTriggerJsonBodyRetryExponential")


@_attrs_define
class CreateKafkaTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_kafka_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        create_kafka_trigger_json_body_retry_exponential.additional_properties = d
        return create_kafka_trigger_json_body_retry_exponential
