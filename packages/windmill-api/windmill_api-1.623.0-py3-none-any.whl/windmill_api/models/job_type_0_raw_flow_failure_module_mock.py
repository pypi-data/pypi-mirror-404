...
T = TypeVar("T", bound="JobType0RawFlowFailureModuleMock")


@_attrs_define
class JobType0RawFlowFailureModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_0_raw_flow_failure_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        job_type_0_raw_flow_failure_module_mock.additional_properties = d
        return job_type_0_raw_flow_failure_module_mock
