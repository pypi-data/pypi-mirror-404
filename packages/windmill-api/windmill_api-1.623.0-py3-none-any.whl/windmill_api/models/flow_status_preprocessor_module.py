...
from ..models.flow_status_preprocessor_module_type import FlowStatusPreprocessorModuleType
...
T = TypeVar("T", bound="FlowStatusPreprocessorModule")


@_attrs_define
class FlowStatusPreprocessorModule:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = FlowStatusPreprocessorModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = FlowStatusPreprocessorModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = FlowStatusPreprocessorModuleBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = FlowStatusPreprocessorModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = FlowStatusPreprocessorModuleApproversItem.from_dict(approvers_item_data)
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_0 = FlowStatusPreprocessorModuleAgentActionsItemType0.from_dict(data)
        ...
        return flow_status_preprocessor_module
