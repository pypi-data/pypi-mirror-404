...
T = TypeVar("T", bound="FlowPreviewValuePreprocessorModuleMock")


@_attrs_define
class FlowPreviewValuePreprocessorModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_preview_value_preprocessor_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        flow_preview_value_preprocessor_module_mock.additional_properties = d
        return flow_preview_value_preprocessor_module_mock
