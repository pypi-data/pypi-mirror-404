...
T = TypeVar("T", bound="ListQueueResponse200ItemRawFlowModulesItemRetryExponential")


@_attrs_define
class ListQueueResponse200ItemRawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_queue_response_200_item_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
