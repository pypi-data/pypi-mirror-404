...
from ..models.ai_agent_tools_item_value_type_1_tool_type import AiAgentToolsItemValueType1ToolType
from ..types import UNSET, Unset

T = TypeVar("T", bound="AiAgentToolsItemValueType1")


@_attrs_define
class AiAgentToolsItemValueType1:
    """Reference to an external MCP (Model Context Protocol) tool. The AI can call tools from MCP servers

    Attributes:
        tool_type (AiAgentToolsItemValueType1ToolType):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        tool_type = AiAgentToolsItemValueType1ToolType(d.pop("tool_type"))
        ...
        ai_agent_tools_item_value_type_1 = cls(
            tool_type=tool_type,
            resource_path=resource_path,
        ...
        ai_agent_tools_item_value_type_1.additional_properties = d
        return ai_agent_tools_item_value_type_1
