...
T = TypeVar("T", bound="JobType1FlowStatusRetry")


@_attrs_define
class JobType1FlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_1_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        job_type_1_flow_status_retry.additional_properties = d
        return job_type_1_flow_status_retry
