...
T = TypeVar("T", bound="GetHubFlowByIdResponse200FlowValueModulesItemRetryExponential")


@_attrs_define
class GetHubFlowByIdResponse200FlowValueModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_hub_flow_by_id_response_200_flow_value_modules_item_retry_exponential = cls(
            attempts=attempts,
