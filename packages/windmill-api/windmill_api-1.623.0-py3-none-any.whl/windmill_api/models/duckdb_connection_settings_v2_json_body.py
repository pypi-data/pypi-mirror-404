...
T = TypeVar("T", bound="DuckdbConnectionSettingsV2JsonBody")


@_attrs_define
class DuckdbConnectionSettingsV2JsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        duckdb_connection_settings_v2_json_body = cls(
            s3_resource_path=s3_resource_path,
        )

        duckdb_connection_settings_v2_json_body.additional_properties = d
