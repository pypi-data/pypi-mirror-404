...
T = TypeVar("T", bound="GetMqttTriggerResponse200RetryExponential")


@_attrs_define
class GetMqttTriggerResponse200RetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_mqtt_trigger_response_200_retry_exponential = cls(
            attempts=attempts,
        ...
        get_mqtt_trigger_response_200_retry_exponential.additional_properties = d
        return get_mqtt_trigger_response_200_retry_exponential
