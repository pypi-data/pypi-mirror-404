...
T = TypeVar("T", bound="S3ResourceInfoResponse200")


@_attrs_define
class S3ResourceInfoResponse200:
    """
    Attributes:
        bucket (str):
        region (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        s3_resource_info_response_200 = cls(
            bucket=bucket,
            region=region,
            end_point=end_point,
            use_ssl=use_ssl,
        ...
        s3_resource_info_response_200.additional_properties = d
        return s3_resource_info_response_200
