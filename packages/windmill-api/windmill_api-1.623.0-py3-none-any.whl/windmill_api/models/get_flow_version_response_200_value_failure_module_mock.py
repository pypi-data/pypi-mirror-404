...
T = TypeVar("T", bound="GetFlowVersionResponse200ValueFailureModuleMock")


@_attrs_define
class GetFlowVersionResponse200ValueFailureModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_version_response_200_value_failure_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        get_flow_version_response_200_value_failure_module_mock.additional_properties = d
        return get_flow_version_response_200_value_failure_module_mock
