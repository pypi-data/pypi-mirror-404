...
T = TypeVar("T", bound="GetCompletedJobResponse200FlowStatusPreprocessorModuleIterator")


@_attrs_define
class GetCompletedJobResponse200FlowStatusPreprocessorModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_completed_job_response_200_flow_status_preprocessor_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        get_completed_job_response_200_flow_status_preprocessor_module_iterator.additional_properties = d
        return get_completed_job_response_200_flow_status_preprocessor_module_iterator
