...
T = TypeVar("T", bound="CreateNatsTriggerJsonBodyRetryExponential")


@_attrs_define
class CreateNatsTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_nats_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        create_nats_trigger_json_body_retry_exponential.additional_properties = d
        return create_nats_trigger_json_body_retry_exponential
