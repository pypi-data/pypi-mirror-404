...
T = TypeVar("T", bound="FlowModuleRetryExponential")


@_attrs_define
class FlowModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_retry_exponential = cls(
            attempts=attempts,
        ...
        flow_module_retry_exponential.additional_properties = d
        return flow_module_retry_exponential
