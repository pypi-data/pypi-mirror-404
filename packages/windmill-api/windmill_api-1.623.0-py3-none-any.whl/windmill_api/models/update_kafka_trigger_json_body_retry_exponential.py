...
T = TypeVar("T", bound="UpdateKafkaTriggerJsonBodyRetryExponential")


@_attrs_define
class UpdateKafkaTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_kafka_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        update_kafka_trigger_json_body_retry_exponential.additional_properties = d
        return update_kafka_trigger_json_body_retry_exponential
