...
T = TypeVar("T", bound="UpdateKafkaTriggerJsonBodyRetryConstant")


@_attrs_define
class UpdateKafkaTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_kafka_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        update_kafka_trigger_json_body_retry_constant.additional_properties = d
        return update_kafka_trigger_json_body_retry_constant
