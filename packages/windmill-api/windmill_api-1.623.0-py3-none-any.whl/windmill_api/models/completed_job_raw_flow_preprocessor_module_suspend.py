...
if TYPE_CHECKING:
    from ..models.completed_job_raw_flow_preprocessor_module_suspend_resume_form import (
        CompletedJobRawFlowPreprocessorModuleSuspendResumeForm,
    )
    from ..models.completed_job_raw_flow_preprocessor_module_suspend_user_groups_required_type_0 import (
        CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.completed_job_raw_flow_preprocessor_module_suspend_user_groups_required_type_1 import (
        CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="CompletedJobRawFlowPreprocessorModuleSuspend")


@_attrs_define
class CompletedJobRawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, CompletedJobRawFlowPreprocessorModuleSuspendResumeForm]): Form schema for collecting
            input when resuming
        user_auth_required (Union[Unset, bool]): If true, only authenticated users can approve
        user_groups_required (Union['CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0',
            'CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a
    ...
    resume_form: Union[Unset, "CompletedJobRawFlowPreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, CompletedJobRawFlowPreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = CompletedJobRawFlowPreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    CompletedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        completed_job_raw_flow_preprocessor_module_suspend = cls(
        ...
        completed_job_raw_flow_preprocessor_module_suspend.additional_properties = d
        return completed_job_raw_flow_preprocessor_module_suspend
