...
class GetCompletedJobResponse200RawFlowModulesItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemStopAfterIf]): Early termination
            condition for a module
        stop_after_all_iters_if (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemStopAfterAllItersIf]): Early
            termination condition for a module
        skip_if (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSkipIf]): Conditionally skip this step based
            on previous results or flow inputs
        sleep (Union['GetCompletedJobResponse200RawFlowModulesItemSleepType0',
            'GetCompletedJobResponse200RawFlowModulesItemSleepType1', Unset]): Maps input parameters for a step. Can be a
        ...
        timeout (Union['GetCompletedJobResponse200RawFlowModulesItemTimeoutType0',
            'GetCompletedJobResponse200RawFlowModulesItemTimeoutType1', Unset]): Maps input parameters for a step. Can be a
            static value or a JavaScript expression that references previous results or flow inputs
        ...
        mock (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemMock]): Mock configuration for testing without
            executing the actual step
        suspend (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSuspend]): Configuration for approval/resume
        ...
        retry (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemRetry]): Retry configuration for failed module
            executions
    """
