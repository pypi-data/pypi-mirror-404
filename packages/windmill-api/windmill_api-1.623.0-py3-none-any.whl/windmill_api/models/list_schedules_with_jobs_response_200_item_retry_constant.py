...
T = TypeVar("T", bound="ListSchedulesWithJobsResponse200ItemRetryConstant")


@_attrs_define
class ListSchedulesWithJobsResponse200ItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_schedules_with_jobs_response_200_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        list_schedules_with_jobs_response_200_item_retry_constant.additional_properties = d
