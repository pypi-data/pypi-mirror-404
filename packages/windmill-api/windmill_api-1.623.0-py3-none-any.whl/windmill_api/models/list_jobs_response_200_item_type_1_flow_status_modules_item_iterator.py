...
T = TypeVar("T", bound="ListJobsResponse200ItemType1FlowStatusModulesItemIterator")


@_attrs_define
class ListJobsResponse200ItemType1FlowStatusModulesItemIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_jobs_response_200_item_type_1_flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        list_jobs_response_200_item_type_1_flow_status_modules_item_iterator.additional_properties = d
        return list_jobs_response_200_item_type_1_flow_status_modules_item_iterator
