...
T = TypeVar("T", bound="UpdateHttpTriggerJsonBodyRetryExponential")


@_attrs_define
class UpdateHttpTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_http_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        update_http_trigger_json_body_retry_exponential.additional_properties = d
        return update_http_trigger_json_body_retry_exponential
