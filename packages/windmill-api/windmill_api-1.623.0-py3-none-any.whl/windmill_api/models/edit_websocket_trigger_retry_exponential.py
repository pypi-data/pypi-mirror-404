...
T = TypeVar("T", bound="EditWebsocketTriggerRetryExponential")


@_attrs_define
class EditWebsocketTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_websocket_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        edit_websocket_trigger_retry_exponential.additional_properties = d
        return edit_websocket_trigger_retry_exponential
