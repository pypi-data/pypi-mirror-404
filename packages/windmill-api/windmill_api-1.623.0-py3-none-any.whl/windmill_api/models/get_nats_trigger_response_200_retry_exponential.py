...
T = TypeVar("T", bound="GetNatsTriggerResponse200RetryExponential")


@_attrs_define
class GetNatsTriggerResponse200RetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_nats_trigger_response_200_retry_exponential = cls(
            attempts=attempts,
        ...
        get_nats_trigger_response_200_retry_exponential.additional_properties = d
        return get_nats_trigger_response_200_retry_exponential
