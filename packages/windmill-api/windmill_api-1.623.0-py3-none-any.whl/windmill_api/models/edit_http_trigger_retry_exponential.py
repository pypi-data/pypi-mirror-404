...
T = TypeVar("T", bound="EditHttpTriggerRetryExponential")


@_attrs_define
class EditHttpTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_http_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        edit_http_trigger_retry_exponential.additional_properties = d
        return edit_http_trigger_retry_exponential
