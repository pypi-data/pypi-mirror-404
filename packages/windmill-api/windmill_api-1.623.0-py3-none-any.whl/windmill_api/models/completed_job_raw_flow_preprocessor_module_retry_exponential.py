...
T = TypeVar("T", bound="CompletedJobRawFlowPreprocessorModuleRetryExponential")


@_attrs_define
class CompletedJobRawFlowPreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        completed_job_raw_flow_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        completed_job_raw_flow_preprocessor_module_retry_exponential.additional_properties = d
        return completed_job_raw_flow_preprocessor_module_retry_exponential
