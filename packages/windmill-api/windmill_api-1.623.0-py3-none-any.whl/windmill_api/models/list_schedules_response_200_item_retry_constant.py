...
T = TypeVar("T", bound="ListSchedulesResponse200ItemRetryConstant")


@_attrs_define
class ListSchedulesResponse200ItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_schedules_response_200_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        list_schedules_response_200_item_retry_constant.additional_properties = d
