...
T = TypeVar("T", bound="ListCompletedJobsResponse200ItemRawFlowModulesItemStopAfterIf")


@_attrs_define
class ListCompletedJobsResponse200ItemRawFlowModulesItemStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_completed_jobs_response_200_item_raw_flow_modules_item_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        list_completed_jobs_response_200_item_raw_flow_modules_item_stop_after_if.additional_properties = d
