...
T = TypeVar("T", bound="CreateScheduleJsonBodyRetryConstant")


@_attrs_define
class CreateScheduleJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_schedule_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        create_schedule_json_body_retry_constant.additional_properties = d
        return create_schedule_json_body_retry_constant
