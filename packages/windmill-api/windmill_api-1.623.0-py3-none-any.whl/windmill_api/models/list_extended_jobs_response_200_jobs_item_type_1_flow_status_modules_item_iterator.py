...
T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemIterator")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_extended_jobs_response_200_jobs_item_type_1_flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        list_extended_jobs_response_200_jobs_item_type_1_flow_status_modules_item_iterator.additional_properties = d
        return list_extended_jobs_response_200_jobs_item_type_1_flow_status_modules_item_iterator
