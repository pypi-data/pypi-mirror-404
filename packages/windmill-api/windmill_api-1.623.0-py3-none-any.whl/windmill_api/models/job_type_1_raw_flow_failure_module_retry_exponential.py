...
T = TypeVar("T", bound="JobType1RawFlowFailureModuleRetryExponential")


@_attrs_define
class JobType1RawFlowFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_1_raw_flow_failure_module_retry_exponential = cls(
            attempts=attempts,
        ...
        job_type_1_raw_flow_failure_module_retry_exponential.additional_properties = d
        return job_type_1_raw_flow_failure_module_retry_exponential
