...
T = TypeVar("T", bound="CreatePostgresTriggerJsonBodyRetryConstant")


@_attrs_define
class CreatePostgresTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_postgres_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        create_postgres_trigger_json_body_retry_constant.additional_properties = d
        return create_postgres_trigger_json_body_retry_constant
