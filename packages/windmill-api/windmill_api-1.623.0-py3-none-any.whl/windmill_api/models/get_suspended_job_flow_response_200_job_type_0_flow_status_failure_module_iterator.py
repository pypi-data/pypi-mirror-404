...
T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleIterator")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_iterator.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_iterator
