...
from ..models.compare_workspaces_response_200_diffs_item_kind import CompareWorkspacesResponse200DiffsItemKind

T = TypeVar("T", bound="CompareWorkspacesResponse200DiffsItem")


@_attrs_define
class CompareWorkspacesResponse200DiffsItem:
    """
    Attributes:
        kind (CompareWorkspacesResponse200DiffsItemKind): Type of the item
    ...
    kind: CompareWorkspacesResponse200DiffsItemKind
    path: str
    ahead: int
    behind: int
    has_changes: bool
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        kind = CompareWorkspacesResponse200DiffsItemKind(d.pop("kind"))
        ...
        compare_workspaces_response_200_diffs_item = cls(
            kind=kind,
            path=path,
            ahead=ahead,
            behind=behind,
        ...
        compare_workspaces_response_200_diffs_item.additional_properties = d
        return compare_workspaces_response_200_diffs_item
