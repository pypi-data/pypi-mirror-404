...
T = TypeVar("T", bound="UpdateScriptHistoryJsonBody")


@_attrs_define
class UpdateScriptHistoryJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_script_history_json_body = cls(
            deployment_msg=deployment_msg,
        )

        update_script_history_json_body.additional_properties = d
        return update_script_history_json_body
