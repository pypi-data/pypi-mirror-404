...
T = TypeVar("T", bound="NatsTriggerRetryConstant")


@_attrs_define
class NatsTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nats_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        nats_trigger_retry_constant.additional_properties = d
        return nats_trigger_retry_constant
