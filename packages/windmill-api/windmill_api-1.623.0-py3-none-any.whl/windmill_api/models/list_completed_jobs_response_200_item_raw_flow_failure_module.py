...
class ListCompletedJobsResponse200ItemRawFlowFailureModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleStopAfterIf]): Early termination
        ...
        skip_if (Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleSkipIf]): Conditionally skip this step
            based on previous results or flow inputs
        sleep (Union['ListCompletedJobsResponse200ItemRawFlowFailureModuleSleepType0',
            'ListCompletedJobsResponse200ItemRawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a step. Can
        ...
        timeout (Union['ListCompletedJobsResponse200ItemRawFlowFailureModuleTimeoutType0',
            'ListCompletedJobsResponse200ItemRawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a step.
        ...
        mock (Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleRetry]): Retry configuration for failed
            module executions
    """
