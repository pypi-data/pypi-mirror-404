...
T = TypeVar("T", bound="UpdateNatsTriggerJsonBodyRetryConstant")


@_attrs_define
class UpdateNatsTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_nats_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        update_nats_trigger_json_body_retry_constant.additional_properties = d
        return update_nats_trigger_json_body_retry_constant
