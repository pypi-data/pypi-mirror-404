...
if TYPE_CHECKING:
    from ..models.list_queue_response_200_item_raw_flow_preprocessor_module_suspend_resume_form import (
        ListQueueResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm,
    )
...
@_attrs_define
class ListQueueResponse200ItemRawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm]): Form schema for
    ...
    resume_form: Union[Unset, "ListQueueResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = ListQueueResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListQueueResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        ListQueueResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
        ...
        list_queue_response_200_item_raw_flow_preprocessor_module_suspend = cls(
        ...
        list_queue_response_200_item_raw_flow_preprocessor_module_suspend.additional_properties = d
        return list_queue_response_200_item_raw_flow_preprocessor_module_suspend
