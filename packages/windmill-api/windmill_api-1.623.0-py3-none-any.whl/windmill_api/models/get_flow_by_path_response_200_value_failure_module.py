...
class GetFlowByPathResponse200ValueFailureModule:
    ...
    Attributes:
        ...
        sleep (Union['GetFlowByPathResponse200ValueFailureModuleSleepType0',
            'GetFlowByPathResponse200ValueFailureModuleSleepType1', Unset]): Maps input parameters for a step. Can be a
        ...
        timeout (Union['GetFlowByPathResponse200ValueFailureModuleTimeoutType0',
            'GetFlowByPathResponse200ValueFailureModuleTimeoutType1', Unset]): Maps input parameters for a step. Can be a
            static value or a JavaScript expression that references previous results or flow inputs
