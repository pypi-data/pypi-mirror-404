...
T = TypeVar("T", bound="GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleRetryExponential")


@_attrs_define
class GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_retry_exponential.additional_properties = (
            d
        )
        return get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_retry_exponential
