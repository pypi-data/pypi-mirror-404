...
class RunFlowPreviewJsonBodyValueFailureModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, RunFlowPreviewJsonBodyValueFailureModuleStopAfterIf]): Early termination condition
            for a module
        stop_after_all_iters_if (Union[Unset, RunFlowPreviewJsonBodyValueFailureModuleStopAfterAllItersIf]): Early
            termination condition for a module
        skip_if (Union[Unset, RunFlowPreviewJsonBodyValueFailureModuleSkipIf]): Conditionally skip this step based on
            previous results or flow inputs
        sleep (Union['RunFlowPreviewJsonBodyValueFailureModuleSleepType0',
            'RunFlowPreviewJsonBodyValueFailureModuleSleepType1', Unset]): Maps input parameters for a step. Can be a static
        ...
        timeout (Union['RunFlowPreviewJsonBodyValueFailureModuleTimeoutType0',
            'RunFlowPreviewJsonBodyValueFailureModuleTimeoutType1', Unset]): Maps input parameters for a step. Can be a
        ...
        mock (Union[Unset, RunFlowPreviewJsonBodyValueFailureModuleMock]): Mock configuration for testing without
            executing the actual step
        suspend (Union[Unset, RunFlowPreviewJsonBodyValueFailureModuleSuspend]): Configuration for approval/resume steps
        ...
        retry (Union[Unset, RunFlowPreviewJsonBodyValueFailureModuleRetry]): Retry configuration for failed module
            executions
    """
