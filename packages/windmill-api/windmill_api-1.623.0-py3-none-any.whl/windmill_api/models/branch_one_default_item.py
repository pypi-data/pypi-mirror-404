...
class BranchOneDefaultItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, BranchOneDefaultItemStopAfterIf]): Early termination condition for a module
        stop_after_all_iters_if (Union[Unset, BranchOneDefaultItemStopAfterAllItersIf]): Early termination condition for
            a module
        ...
        suspend (Union[Unset, BranchOneDefaultItemSuspend]): Configuration for approval/resume steps that wait for user
            input
        ...
        retry (Union[Unset, BranchOneDefaultItemRetry]): Retry configuration for failed module executions
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, BranchOneDefaultItemTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = BranchOneDefaultItemTimeoutType0.from_dict(_timeout_type_0)
