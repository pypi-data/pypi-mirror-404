...
if TYPE_CHECKING:
    from ..models.extended_jobs_jobs_item_type_0_flow_status_failure_module_agent_actions_item_type_0 import (
        ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType0,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_failure_module_agent_actions_item_type_1 import (
        ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType1,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_failure_module_agent_actions_item_type_2 import (
        ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType2,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_failure_module_agent_actions_item_type_3 import (
        ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType3,
    )
...
class ExtendedJobsJobsItemType0FlowStatusFailureModule:
    ...
    Attributes:
        ...
        agent_actions (Union[Unset, List[Union['ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType0',
            'ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType1',
            'ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType2',
            'ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType3']]]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType0
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    ExtendedJobsJobsItemType0FlowStatusFailureModuleAgentActionsItemType3.from_dict(data)
                )
