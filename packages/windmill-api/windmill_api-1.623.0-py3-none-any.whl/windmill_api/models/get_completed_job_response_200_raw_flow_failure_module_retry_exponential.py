...
T = TypeVar("T", bound="GetCompletedJobResponse200RawFlowFailureModuleRetryExponential")


@_attrs_define
class GetCompletedJobResponse200RawFlowFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_completed_job_response_200_raw_flow_failure_module_retry_exponential = cls(
            attempts=attempts,
        ...
        get_completed_job_response_200_raw_flow_failure_module_retry_exponential.additional_properties = d
