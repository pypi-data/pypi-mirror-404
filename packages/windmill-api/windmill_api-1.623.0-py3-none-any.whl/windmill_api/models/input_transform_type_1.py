...
from ..models.input_transform_type_1_type import InputTransformType1Type

T = TypeVar("T", bound="InputTransformType1")


@_attrs_define
class InputTransformType1:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = InputTransformType1Type(d.pop("type"))

        input_transform_type_1 = cls(
            expr=expr,
            type=type,
        )

        input_transform_type_1.additional_properties = d
