...
T = TypeVar("T", bound="CreateWebsocketTriggerJsonBodyRetryConstant")


@_attrs_define
class CreateWebsocketTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_websocket_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        create_websocket_trigger_json_body_retry_constant.additional_properties = d
        return create_websocket_trigger_json_body_retry_constant
