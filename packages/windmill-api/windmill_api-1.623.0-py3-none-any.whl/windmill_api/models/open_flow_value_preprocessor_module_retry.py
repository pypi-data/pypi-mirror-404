...
if TYPE_CHECKING:
    from ..models.open_flow_value_preprocessor_module_retry_constant import OpenFlowValuePreprocessorModuleRetryConstant
...
@_attrs_define
class OpenFlowValuePreprocessorModuleRetry:
    """Retry configuration for failed module executions

    Attributes:
        constant (Union[Unset, OpenFlowValuePreprocessorModuleRetryConstant]): Retry with constant delay between
            attempts
        exponential (Union[Unset, OpenFlowValuePreprocessorModuleRetryExponential]): Retry with exponential backoff
            (delay doubles each time)
        retry_if (Union[Unset, OpenFlowValuePreprocessorModuleRetryRetryIf]): Conditional retry based on error or result
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.open_flow_value_preprocessor_module_retry_constant import (
            OpenFlowValuePreprocessorModuleRetryConstant,
        )
        from ..models.open_flow_value_preprocessor_module_retry_exponential import (
            OpenFlowValuePreprocessorModuleRetryExponential,
        )
        ...
        if isinstance(_constant, Unset):
            ...
            constant = OpenFlowValuePreprocessorModuleRetryConstant.from_dict(_constant)
        ...
        return open_flow_value_preprocessor_module_retry
