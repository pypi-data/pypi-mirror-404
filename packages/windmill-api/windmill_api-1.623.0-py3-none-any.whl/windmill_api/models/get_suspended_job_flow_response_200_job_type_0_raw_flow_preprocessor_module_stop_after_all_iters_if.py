...
T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleStopAfterAllItersIf")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_suspended_job_flow_response_200_job_type_0_raw_flow_preprocessor_module_stop_after_all_iters_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        get_suspended_job_flow_response_200_job_type_0_raw_flow_preprocessor_module_stop_after_all_iters_if.additional_properties = (
            d
        )
        return get_suspended_job_flow_response_200_job_type_0_raw_flow_preprocessor_module_stop_after_all_iters_if
