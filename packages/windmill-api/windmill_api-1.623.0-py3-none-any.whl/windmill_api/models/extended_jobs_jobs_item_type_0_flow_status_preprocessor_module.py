...
from ..models.extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_type import (
    ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_0 import (
        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType0,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_1 import (
        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType1,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_2 import (
        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType2,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_3 import (
        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType3,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_approvers_item import (
        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleApproversItem,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_branch_chosen import (
        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleBranchChosen,
    )
...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0FlowStatusPreprocessorModule")


@_attrs_define
class ExtendedJobsJobsItemType0FlowStatusPreprocessorModule:
    """
    Attributes:
        type (ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
        ...
        agent_actions (Union[Unset,
            List[Union['ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType0',
            'ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType1',
            'ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType2',
            'ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType3']]]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType0
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleApproversItem.from_dict(
                approvers_item_data
            )
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType3.from_dict(data)
                )
        ...
        extended_jobs_jobs_item_type_0_flow_status_preprocessor_module = cls(
            type=type,
            id=id,
            job=job,
            count=count,
        ...
        extended_jobs_jobs_item_type_0_flow_status_preprocessor_module.additional_properties = d
        return extended_jobs_jobs_item_type_0_flow_status_preprocessor_module
