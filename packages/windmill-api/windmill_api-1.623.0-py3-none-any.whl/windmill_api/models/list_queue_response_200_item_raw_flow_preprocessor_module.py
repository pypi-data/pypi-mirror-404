...
class ListQueueResponse200ItemRawFlowPreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModuleStopAfterIf]): Early termination
        ...
        skip_if (Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModuleSkipIf]): Conditionally skip this step
            based on previous results or flow inputs
        sleep (Union['ListQueueResponse200ItemRawFlowPreprocessorModuleSleepType0',
            'ListQueueResponse200ItemRawFlowPreprocessorModuleSleepType1', Unset]): Maps input parameters for a step. Can be
        ...
        timeout (Union['ListQueueResponse200ItemRawFlowPreprocessorModuleTimeoutType0',
            'ListQueueResponse200ItemRawFlowPreprocessorModuleTimeoutType1', Unset]): Maps input parameters for a step. Can
        ...
        mock (Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModuleRetry]): Retry configuration for failed
            module executions
    """
