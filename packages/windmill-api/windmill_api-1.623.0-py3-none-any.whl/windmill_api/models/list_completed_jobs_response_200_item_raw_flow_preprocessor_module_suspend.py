...
if TYPE_CHECKING:
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_suspend_resume_form import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_suspend_user_groups_required_type_0 import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_suspend_user_groups_required_type_1 import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspend")


@_attrs_define
class ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm]): Form
        ...
        user_groups_required
            (Union['ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0',
            'ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input
    ...
    resume_form: Union[Unset, "ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        list_completed_jobs_response_200_item_raw_flow_preprocessor_module_suspend = cls(
        ...
        list_completed_jobs_response_200_item_raw_flow_preprocessor_module_suspend.additional_properties = d
        return list_completed_jobs_response_200_item_raw_flow_preprocessor_module_suspend
