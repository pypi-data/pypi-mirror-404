...
T = TypeVar("T", bound="ListJobsResponse200ItemType0FlowStatusRetry")


@_attrs_define
class ListJobsResponse200ItemType0FlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_jobs_response_200_item_type_0_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        list_jobs_response_200_item_type_0_flow_status_retry.additional_properties = d
        return list_jobs_response_200_item_type_0_flow_status_retry
