...
T = TypeVar("T", bound="EditScheduleRetryConstant")


@_attrs_define
class EditScheduleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_schedule_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        edit_schedule_retry_constant.additional_properties = d
        return edit_schedule_retry_constant
