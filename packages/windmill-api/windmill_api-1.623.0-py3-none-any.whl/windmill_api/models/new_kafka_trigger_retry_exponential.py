...
T = TypeVar("T", bound="NewKafkaTriggerRetryExponential")


@_attrs_define
class NewKafkaTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_kafka_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        new_kafka_trigger_retry_exponential.additional_properties = d
        return new_kafka_trigger_retry_exponential
