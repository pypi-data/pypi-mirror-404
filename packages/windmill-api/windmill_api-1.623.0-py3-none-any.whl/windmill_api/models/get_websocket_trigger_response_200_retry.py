...
if TYPE_CHECKING:
    from ..models.get_websocket_trigger_response_200_retry_constant import GetWebsocketTriggerResponse200RetryConstant
...
@_attrs_define
class GetWebsocketTriggerResponse200Retry:
    """Retry configuration for failed module executions

    Attributes:
        constant (Union[Unset, GetWebsocketTriggerResponse200RetryConstant]): Retry with constant delay between attempts
        exponential (Union[Unset, GetWebsocketTriggerResponse200RetryExponential]): Retry with exponential backoff
            (delay doubles each time)
        retry_if (Union[Unset, GetWebsocketTriggerResponse200RetryRetryIf]): Conditional retry based on error or result
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.get_websocket_trigger_response_200_retry_constant import (
            GetWebsocketTriggerResponse200RetryConstant,
        )
        from ..models.get_websocket_trigger_response_200_retry_exponential import (
            GetWebsocketTriggerResponse200RetryExponential,
        )
        ...
        if isinstance(_constant, Unset):
            ...
            constant = GetWebsocketTriggerResponse200RetryConstant.from_dict(_constant)
        ...
        return get_websocket_trigger_response_200_retry
