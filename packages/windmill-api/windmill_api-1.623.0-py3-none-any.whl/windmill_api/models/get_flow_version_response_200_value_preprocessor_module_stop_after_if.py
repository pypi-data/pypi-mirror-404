...
T = TypeVar("T", bound="GetFlowVersionResponse200ValuePreprocessorModuleStopAfterIf")


@_attrs_define
class GetFlowVersionResponse200ValuePreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_flow_version_response_200_value_preprocessor_module_stop_after_if
