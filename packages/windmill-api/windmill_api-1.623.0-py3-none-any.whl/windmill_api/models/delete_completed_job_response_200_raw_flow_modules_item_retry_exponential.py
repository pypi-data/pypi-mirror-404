...
T = TypeVar("T", bound="DeleteCompletedJobResponse200RawFlowModulesItemRetryExponential")


@_attrs_define
class DeleteCompletedJobResponse200RawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        delete_completed_job_response_200_raw_flow_modules_item_retry_exponential.additional_properties = d
