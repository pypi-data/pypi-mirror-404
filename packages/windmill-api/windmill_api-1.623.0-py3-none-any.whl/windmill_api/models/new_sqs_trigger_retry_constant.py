...
T = TypeVar("T", bound="NewSqsTriggerRetryConstant")


@_attrs_define
class NewSqsTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_sqs_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        new_sqs_trigger_retry_constant.additional_properties = d
        return new_sqs_trigger_retry_constant
