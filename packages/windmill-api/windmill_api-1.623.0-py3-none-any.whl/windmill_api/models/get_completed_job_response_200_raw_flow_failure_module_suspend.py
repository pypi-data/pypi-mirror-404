...
class GetCompletedJobResponse200RawFlowFailureModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetCompletedJobResponse200RawFlowFailureModuleSuspendResumeForm]): Form schema for
        ...
        user_groups_required (Union['GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'GetCompletedJobResponse200RawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters
