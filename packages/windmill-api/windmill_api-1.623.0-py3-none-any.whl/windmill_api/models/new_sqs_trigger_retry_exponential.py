...
T = TypeVar("T", bound="NewSqsTriggerRetryExponential")


@_attrs_define
class NewSqsTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_sqs_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        new_sqs_trigger_retry_exponential.additional_properties = d
        return new_sqs_trigger_retry_exponential
