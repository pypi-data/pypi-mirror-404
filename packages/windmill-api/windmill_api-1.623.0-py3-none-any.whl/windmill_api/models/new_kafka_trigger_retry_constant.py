...
T = TypeVar("T", bound="NewKafkaTriggerRetryConstant")


@_attrs_define
class NewKafkaTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_kafka_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        new_kafka_trigger_retry_constant.additional_properties = d
        return new_kafka_trigger_retry_constant
