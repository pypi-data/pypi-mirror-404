...
T = TypeVar("T", bound="OpenFlowWPathValuePreprocessorModuleStopAfterAllItersIf")


@_attrs_define
class OpenFlowWPathValuePreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return open_flow_w_path_value_preprocessor_module_stop_after_all_iters_if
