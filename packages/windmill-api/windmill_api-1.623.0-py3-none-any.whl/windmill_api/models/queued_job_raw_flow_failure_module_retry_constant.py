...
T = TypeVar("T", bound="QueuedJobRawFlowFailureModuleRetryConstant")


@_attrs_define
class QueuedJobRawFlowFailureModuleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        queued_job_raw_flow_failure_module_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        queued_job_raw_flow_failure_module_retry_constant.additional_properties = d
