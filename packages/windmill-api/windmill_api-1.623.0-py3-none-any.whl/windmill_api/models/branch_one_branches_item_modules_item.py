...
class BranchOneBranchesItemModulesItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, BranchOneBranchesItemModulesItemStopAfterIf]): Early termination condition for a
            module
        stop_after_all_iters_if (Union[Unset, BranchOneBranchesItemModulesItemStopAfterAllItersIf]): Early termination
            condition for a module
        skip_if (Union[Unset, BranchOneBranchesItemModulesItemSkipIf]): Conditionally skip this step based on previous
        ...
        mock (Union[Unset, BranchOneBranchesItemModulesItemMock]): Mock configuration for testing without executing the
            actual step
        suspend (Union[Unset, BranchOneBranchesItemModulesItemSuspend]): Configuration for approval/resume steps that
            wait for user input
        ...
        retry (Union[Unset, BranchOneBranchesItemModulesItemRetry]): Retry configuration for failed module executions
    """
