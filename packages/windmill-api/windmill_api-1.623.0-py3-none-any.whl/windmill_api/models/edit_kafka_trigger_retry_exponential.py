...
T = TypeVar("T", bound="EditKafkaTriggerRetryExponential")


@_attrs_define
class EditKafkaTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_kafka_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        edit_kafka_trigger_retry_exponential.additional_properties = d
        return edit_kafka_trigger_retry_exponential
