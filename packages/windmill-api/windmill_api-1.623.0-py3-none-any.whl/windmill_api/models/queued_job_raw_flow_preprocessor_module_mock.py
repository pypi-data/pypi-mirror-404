...
T = TypeVar("T", bound="QueuedJobRawFlowPreprocessorModuleMock")


@_attrs_define
class QueuedJobRawFlowPreprocessorModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        queued_job_raw_flow_preprocessor_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        queued_job_raw_flow_preprocessor_module_mock.additional_properties = d
        return queued_job_raw_flow_preprocessor_module_mock
