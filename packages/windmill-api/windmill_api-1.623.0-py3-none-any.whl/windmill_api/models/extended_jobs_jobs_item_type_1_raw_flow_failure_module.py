...
if TYPE_CHECKING:
    ...
    from ..models.extended_jobs_jobs_item_type_1_raw_flow_failure_module_stop_after_if import (
        ExtendedJobsJobsItemType1RawFlowFailureModuleStopAfterIf,
    )
    from ..models.extended_jobs_jobs_item_type_1_raw_flow_failure_module_suspend import (
        ExtendedJobsJobsItemType1RawFlowFailureModuleSuspend,
    )
...
T = TypeVar("T", bound="ExtendedJobsJobsItemType1RawFlowFailureModule")


@_attrs_define
class ExtendedJobsJobsItemType1RawFlowFailureModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleStopAfterIf]): Early termination
            condition for a module
        stop_after_all_iters_if (Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleStopAfterAllItersIf]): Early
        ...
        mock (Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleMock]): Mock configuration for testing without
            executing the actual step
        suspend (Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleSuspend]): Configuration for approval/resume
    ...
    mock: Union[Unset, "ExtendedJobsJobsItemType1RawFlowFailureModuleMock"] = UNSET
    suspend: Union[Unset, "ExtendedJobsJobsItemType1RawFlowFailureModuleSuspend"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, ExtendedJobsJobsItemType1RawFlowFailureModuleSleepType0):
            sleep = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_stop_after_if, Unset):
            ...
            stop_after_if = ExtendedJobsJobsItemType1RawFlowFailureModuleStopAfterIf.from_dict(_stop_after_if)
        ...
        if isinstance(_stop_after_all_iters_if, Unset):
            ...
            stop_after_all_iters_if = ExtendedJobsJobsItemType1RawFlowFailureModuleStopAfterAllItersIf.from_dict(
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = ExtendedJobsJobsItemType1RawFlowFailureModuleSleepType0.from_dict(_sleep_type_0)
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = ExtendedJobsJobsItemType1RawFlowFailureModuleTimeoutType0.from_dict(
                        _timeout_type_0
                    )
        ...
        mock: Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleMock]
        if isinstance(_mock, Unset):
            mock = UNSET
        else:
            mock = ExtendedJobsJobsItemType1RawFlowFailureModuleMock.from_dict(_mock)

        _suspend = d.pop("suspend", UNSET)
        suspend: Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleSuspend]
        if isinstance(_suspend, Unset):
            suspend = UNSET
        else:
            suspend = ExtendedJobsJobsItemType1RawFlowFailureModuleSuspend.from_dict(_suspend)
        ...
        retry: Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModuleRetry]
        ...
        return extended_jobs_jobs_item_type_1_raw_flow_failure_module
