...
T = TypeVar("T", bound="ListJobsResponse200ItemType1RawFlowPreprocessorModuleStopAfterIf")


@_attrs_define
class ListJobsResponse200ItemType1RawFlowPreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_stop_after_if
