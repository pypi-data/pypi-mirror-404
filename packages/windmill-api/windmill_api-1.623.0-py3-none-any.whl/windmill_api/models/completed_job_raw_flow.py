...
if TYPE_CHECKING:
    ...
    from ..models.completed_job_raw_flow_flow_env import CompletedJobRawFlowFlowEnv
    from ..models.completed_job_raw_flow_modules_item import CompletedJobRawFlowModulesItem
    from ..models.completed_job_raw_flow_notes_item import CompletedJobRawFlowNotesItem
...
class CompletedJobRawFlow:
    ...
    Attributes:
        modules (List['CompletedJobRawFlowModulesItem']): Array of steps that execute in sequence. Each step can be a
            script, subflow, loop, or branch
        failure_module (Union[Unset, CompletedJobRawFlowFailureModule]): A single step in a flow. Can be a script,
            subflow, loop, or branch
        preprocessor_module (Union[Unset, CompletedJobRawFlowPreprocessorModule]): A single step in a flow. Can be a
            script, subflow, loop, or branch
        ...
        flow_env (Union[Unset, CompletedJobRawFlowFlowEnv]): Environment variables available to all steps
        ...
        notes (Union[Unset, List['CompletedJobRawFlowNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "CompletedJobRawFlowFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["CompletedJobRawFlowNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, CompletedJobRawFlowFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = CompletedJobRawFlowFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = CompletedJobRawFlowNotesItem.from_dict(notes_item_data)
