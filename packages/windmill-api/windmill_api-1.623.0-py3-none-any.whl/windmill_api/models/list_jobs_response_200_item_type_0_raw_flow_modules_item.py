...
if TYPE_CHECKING:
    from ..models.list_jobs_response_200_item_type_0_raw_flow_modules_item_mock import (
        ListJobsResponse200ItemType0RawFlowModulesItemMock,
    )
    ...
    from ..models.list_jobs_response_200_item_type_0_raw_flow_modules_item_suspend import (
        ListJobsResponse200ItemType0RawFlowModulesItemSuspend,
    )
    from ..models.list_jobs_response_200_item_type_0_raw_flow_modules_item_timeout_type_0 import (
        ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType0,
    )
    from ..models.list_jobs_response_200_item_type_0_raw_flow_modules_item_timeout_type_1 import (
        ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType1,
    )


T = TypeVar("T", bound="ListJobsResponse200ItemType0RawFlowModulesItem")


@_attrs_define
class ListJobsResponse200ItemType0RawFlowModulesItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemStopAfterIf]): Early termination
            condition for a module
        stop_after_all_iters_if (Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemStopAfterAllItersIf]): Early
            termination condition for a module
        skip_if (Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemSkipIf]): Conditionally skip this step based
            on previous results or flow inputs
        sleep (Union['ListJobsResponse200ItemType0RawFlowModulesItemSleepType0',
            'ListJobsResponse200ItemType0RawFlowModulesItemSleepType1', Unset]): Maps input parameters for a step. Can be a
        ...
        timeout (Union['ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType0',
            'ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType1', Unset]): Maps input parameters for a step. Can be
        ...
        mock (Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemMock]): Mock configuration for testing without
            executing the actual step
        suspend (Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemSuspend]): Configuration for approval/resume
        ...
        retry (Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemRetry]): Retry configuration for failed module
            executions
    """
    ...
    mock: Union[Unset, "ListJobsResponse200ItemType0RawFlowModulesItemMock"] = UNSET
    suspend: Union[Unset, "ListJobsResponse200ItemType0RawFlowModulesItemSuspend"] = UNSET
    priority: Union[Unset, float] = UNSET
    continue_on_error: Union[Unset, bool] = UNSET
    retry: Union[Unset, "ListJobsResponse200ItemType0RawFlowModulesItemRetry"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, ListJobsResponse200ItemType0RawFlowModulesItemSleepType0):
            sleep = UNSET
        ...
        elif isinstance(self.timeout, ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType0):
            timeout = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = ListJobsResponse200ItemType0RawFlowModulesItemSleepType0.from_dict(_sleep_type_0)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _sleep_type_1 = data
            sleep_type_1: Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemSleepType1]
            if isinstance(_sleep_type_1, Unset):
                sleep_type_1 = UNSET
            else:
                sleep_type_1 = ListJobsResponse200ItemType0RawFlowModulesItemSleepType1.from_dict(_sleep_type_1)
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType0.from_dict(
                        _timeout_type_0
                    )
            ...
            timeout_type_1: Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType1]
            if isinstance(_timeout_type_1, Unset):
                timeout_type_1 = UNSET
            else:
                timeout_type_1 = ListJobsResponse200ItemType0RawFlowModulesItemTimeoutType1.from_dict(_timeout_type_1)
        ...
        mock: Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemMock]
        if isinstance(_mock, Unset):
            mock = UNSET
        else:
            mock = ListJobsResponse200ItemType0RawFlowModulesItemMock.from_dict(_mock)

        _suspend = d.pop("suspend", UNSET)
        suspend: Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemSuspend]
        if isinstance(_suspend, Unset):
            suspend = UNSET
        else:
            suspend = ListJobsResponse200ItemType0RawFlowModulesItemSuspend.from_dict(_suspend)
        ...
        retry: Union[Unset, ListJobsResponse200ItemType0RawFlowModulesItemRetry]
        if isinstance(_retry, Unset):
            retry = UNSET
        else:
            retry = ListJobsResponse200ItemType0RawFlowModulesItemRetry.from_dict(_retry)

        list_jobs_response_200_item_type_0_raw_flow_modules_item = cls(
            id=id,
            value=value,
        ...
        list_jobs_response_200_item_type_0_raw_flow_modules_item.additional_properties = d
        return list_jobs_response_200_item_type_0_raw_flow_modules_item
