...
T = TypeVar("T", bound="DeleteCompletedJobResponse200RawFlowModulesItemRetryConstant")


@_attrs_define
class DeleteCompletedJobResponse200RawFlowModulesItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_raw_flow_modules_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        delete_completed_job_response_200_raw_flow_modules_item_retry_constant.additional_properties = d
