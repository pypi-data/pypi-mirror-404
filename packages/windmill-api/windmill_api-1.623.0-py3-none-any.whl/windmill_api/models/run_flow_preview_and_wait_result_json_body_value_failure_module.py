...
class RunFlowPreviewAndWaitResultJsonBodyValueFailureModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleStopAfterIf]): Early
            termination condition for a module
        stop_after_all_iters_if (Union[Unset,
            RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleStopAfterAllItersIf]): Early termination condition for a
            module
        skip_if (Union[Unset, RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleSkipIf]): Conditionally skip this
            step based on previous results or flow inputs
        sleep (Union['RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleSleepType0',
            'RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleSleepType1', Unset]): Maps input parameters for a step.
        ...
        timeout (Union['RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleTimeoutType0',
            'RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleTimeoutType1', Unset]): Maps input parameters for a step.
            Can be a static value or a JavaScript expression that references previous results or flow inputs
        ...
        mock (Union[Unset, RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, RunFlowPreviewAndWaitResultJsonBodyValueFailureModuleRetry]): Retry configuration for failed
            module executions
    """
