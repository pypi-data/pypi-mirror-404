...
T = TypeVar("T", bound="GetScriptHistoryByPathResponse200Item")


@_attrs_define
class GetScriptHistoryByPathResponse200Item:
    """
    Attributes:
        script_hash (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_script_history_by_path_response_200_item = cls(
            script_hash=script_hash,
            deployment_msg=deployment_msg,
        )

        get_script_history_by_path_response_200_item.additional_properties = d
        return get_script_history_by_path_response_200_item
