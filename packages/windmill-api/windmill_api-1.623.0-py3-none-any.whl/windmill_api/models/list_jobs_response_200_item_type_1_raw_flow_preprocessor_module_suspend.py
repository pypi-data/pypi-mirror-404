...
if TYPE_CHECKING:
    from ..models.list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_suspend_resume_form import (
        ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendResumeForm,
    )
    from ..models.list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_suspend_user_groups_required_type_0 import (
        ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_suspend_user_groups_required_type_1 import (
        ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspend")


@_attrs_define
class ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendResumeForm]): Form schema
            for collecting input when resuming
        user_auth_required (Union[Unset, bool]): If true, only authenticated users can approve
        user_groups_required
            (Union['ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0',
            'ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input
    ...
    resume_form: Union[Unset, "ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_suspend = cls(
        ...
        list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_suspend.additional_properties = d
        return list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_suspend
