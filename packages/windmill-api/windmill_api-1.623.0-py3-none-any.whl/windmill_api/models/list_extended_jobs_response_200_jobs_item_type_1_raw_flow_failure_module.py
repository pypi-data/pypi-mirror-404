...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_failure_module_mock import (
        ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleMock,
    )
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_failure_module_suspend import (
        ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSuspend,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_failure_module_timeout_type_0 import (
        ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType0,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_failure_module_timeout_type_1 import (
        ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType1,
    )


T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType1RawFlowFailureModule")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType1RawFlowFailureModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleStopAfterIf]): Early
            termination condition for a module
        stop_after_all_iters_if (Union[Unset,
            ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleStopAfterAllItersIf]): Early termination condition
            for a module
        skip_if (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSkipIf]): Conditionally skip
        ...
        sleep (Union['ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSleepType0',
            'ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a
        ...
        timeout (Union['ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType0',
            'ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a
            step. Can be a static value or a JavaScript expression that references previous results or flow inputs
        ...
        mock (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleMock]): Mock configuration for
            testing without executing the actual step
        suspend (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleRetry]): Retry configuration for
    ...
    mock: Union[Unset, "ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleMock"] = UNSET
    suspend: Union[Unset, "ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSuspend"] = UNSET
    priority: Union[Unset, float] = UNSET
    continue_on_error: Union[Unset, bool] = UNSET
    retry: Union[Unset, "ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleRetry"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSleepType0):
            sleep = UNSET
        ...
        elif isinstance(self.timeout, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType0):
            timeout = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_stop_after_if, Unset):
            ...
            stop_after_if = ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleStopAfterIf.from_dict(
                _stop_after_if
            )
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSleepType0.from_dict(
                        _sleep_type_0
                    )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _sleep_type_1 = data
            sleep_type_1: Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSleepType1]
            if isinstance(_sleep_type_1, Unset):
                sleep_type_1 = UNSET
            else:
                sleep_type_1 = ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSleepType1.from_dict(
                    _sleep_type_1
                )
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType0.from_dict(
                        _timeout_type_0
                    )
            ...
            timeout_type_1: Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType1]
            if isinstance(_timeout_type_1, Unset):
                timeout_type_1 = UNSET
            else:
                timeout_type_1 = ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleTimeoutType1.from_dict(
                    _timeout_type_1
                )
        ...
        mock: Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleMock]
        if isinstance(_mock, Unset):
            mock = UNSET
        else:
            mock = ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleMock.from_dict(_mock)

        _suspend = d.pop("suspend", UNSET)
        suspend: Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSuspend]
        if isinstance(_suspend, Unset):
            suspend = UNSET
        else:
            suspend = ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleSuspend.from_dict(_suspend)
        ...
        retry: Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleRetry]
        if isinstance(_retry, Unset):
            retry = UNSET
        else:
            retry = ListExtendedJobsResponse200JobsItemType1RawFlowFailureModuleRetry.from_dict(_retry)

        list_extended_jobs_response_200_jobs_item_type_1_raw_flow_failure_module = cls(
            id=id,
            value=value,
        ...
        list_extended_jobs_response_200_jobs_item_type_1_raw_flow_failure_module.additional_properties = d
        return list_extended_jobs_response_200_jobs_item_type_1_raw_flow_failure_module
