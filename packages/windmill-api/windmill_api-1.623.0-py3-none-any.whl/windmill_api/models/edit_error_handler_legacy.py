...
if TYPE_CHECKING:
    from ..models.edit_error_handler_legacy_error_handler_extra_args import EditErrorHandlerLegacyErrorHandlerExtraArgs


T = TypeVar("T", bound="EditErrorHandlerLegacy")


@_attrs_define
class EditErrorHandlerLegacy:
    ...
    Attributes:
        ...
        error_handler_extra_args (Union[Unset, EditErrorHandlerLegacyErrorHandlerExtraArgs]): The arguments to pass to
            the script or flow
        error_handler_muted_on_cancel (Union[Unset, bool]):
    """

    error_handler: Union[Unset, str] = UNSET
    error_handler_extra_args: Union[Unset, "EditErrorHandlerLegacyErrorHandlerExtraArgs"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.edit_error_handler_legacy_error_handler_extra_args import (
            EditErrorHandlerLegacyErrorHandlerExtraArgs,
        )
        ...
        error_handler_extra_args: Union[Unset, EditErrorHandlerLegacyErrorHandlerExtraArgs]
        if isinstance(_error_handler_extra_args, Unset):
            error_handler_extra_args = UNSET
        else:
            error_handler_extra_args = EditErrorHandlerLegacyErrorHandlerExtraArgs.from_dict(_error_handler_extra_args)

        error_handler_muted_on_cancel = d.pop("error_handler_muted_on_cancel", UNSET)

        edit_error_handler_legacy = cls(
            error_handler=error_handler,
            error_handler_extra_args=error_handler_extra_args,
            error_handler_muted_on_cancel=error_handler_muted_on_cancel,
        )

        edit_error_handler_legacy.additional_properties = d
        return edit_error_handler_legacy
