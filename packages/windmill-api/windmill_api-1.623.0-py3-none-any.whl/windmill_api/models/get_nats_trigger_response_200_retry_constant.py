...
T = TypeVar("T", bound="GetNatsTriggerResponse200RetryConstant")


@_attrs_define
class GetNatsTriggerResponse200RetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_nats_trigger_response_200_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_nats_trigger_response_200_retry_constant.additional_properties = d
        return get_nats_trigger_response_200_retry_constant
