...
T = TypeVar("T", bound="GetFlowByPathResponse200ValuePreprocessorModuleRetryExponential")


@_attrs_define
class GetFlowByPathResponse200ValuePreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_by_path_response_200_value_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        get_flow_by_path_response_200_value_preprocessor_module_retry_exponential.additional_properties = d
        return get_flow_by_path_response_200_value_preprocessor_module_retry_exponential
