...
T = TypeVar("T", bound="GetCompletedJobResponse200FlowStatusFailureModuleIterator")


@_attrs_define
class GetCompletedJobResponse200FlowStatusFailureModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_completed_job_response_200_flow_status_failure_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        get_completed_job_response_200_flow_status_failure_module_iterator.additional_properties = d
