...
T = TypeVar("T", bound="ListJobsResponse200ItemType1RawFlowFailureModuleMock")
...
class ListJobsResponse200ItemType1RawFlowFailureModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_jobs_response_200_item_type_1_raw_flow_failure_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        list_jobs_response_200_item_type_1_raw_flow_failure_module_mock.additional_properties = d
        return list_jobs_response_200_item_type_1_raw_flow_failure_module_mock
