...
T = TypeVar("T", bound="ListJobsResponse200ItemType0RawFlowFailureModuleStopAfterIf")


@_attrs_define
class ListJobsResponse200ItemType0RawFlowFailureModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_jobs_response_200_item_type_0_raw_flow_failure_module_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        list_jobs_response_200_item_type_0_raw_flow_failure_module_stop_after_if.additional_properties = d
        return list_jobs_response_200_item_type_0_raw_flow_failure_module_stop_after_if
