...
T = TypeVar("T", bound="HttpTriggerRetryExponential")


@_attrs_define
class HttpTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        http_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        http_trigger_retry_exponential.additional_properties = d
        return http_trigger_retry_exponential
