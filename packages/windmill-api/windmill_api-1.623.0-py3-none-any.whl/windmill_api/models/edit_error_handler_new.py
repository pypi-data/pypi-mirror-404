...
if TYPE_CHECKING:
    from ..models.edit_error_handler_new_extra_args import EditErrorHandlerNewExtraArgs


T = TypeVar("T", bound="EditErrorHandlerNew")


@_attrs_define
class EditErrorHandlerNew:
    """New grouped format for editing error handler

    Attributes:
        path (Union[Unset, str]): Path to the error handler script or flow
        extra_args (Union[Unset, EditErrorHandlerNewExtraArgs]): The arguments to pass to the script or flow
        muted_on_cancel (Union[Unset, bool]):
        muted_on_user_path (Union[Unset, bool]):
    """

    path: Union[Unset, str] = UNSET
    extra_args: Union[Unset, "EditErrorHandlerNewExtraArgs"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extra_args: Union[Unset, EditErrorHandlerNewExtraArgs]
        if isinstance(_extra_args, Unset):
            extra_args = UNSET
        else:
            extra_args = EditErrorHandlerNewExtraArgs.from_dict(_extra_args)

        muted_on_cancel = d.pop("muted_on_cancel", UNSET)

        muted_on_user_path = d.pop("muted_on_user_path", UNSET)

        edit_error_handler_new = cls(
            path=path,
        ...
        edit_error_handler_new.additional_properties = d
        return edit_error_handler_new
