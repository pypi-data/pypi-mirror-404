...
T = TypeVar("T", bound="ScheduleWJobsRetryConstant")


@_attrs_define
class ScheduleWJobsRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schedule_w_jobs_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        schedule_w_jobs_retry_constant.additional_properties = d
        return schedule_w_jobs_retry_constant
