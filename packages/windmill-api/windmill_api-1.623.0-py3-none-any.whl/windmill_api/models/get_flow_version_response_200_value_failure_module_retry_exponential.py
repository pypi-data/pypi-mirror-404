...
T = TypeVar("T", bound="GetFlowVersionResponse200ValueFailureModuleRetryExponential")


@_attrs_define
class GetFlowVersionResponse200ValueFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_version_response_200_value_failure_module_retry_exponential = cls(
            attempts=attempts,
        ...
        get_flow_version_response_200_value_failure_module_retry_exponential.additional_properties = d
        return get_flow_version_response_200_value_failure_module_retry_exponential
