...
from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_preprocessor_module_type import (
    ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleType,
)
...
if TYPE_CHECKING:
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_3 import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType3,
    )
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_preprocessor_module_branch_chosen import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleBranchChosen,
    )
...
T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModule")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModule:
    """
    Attributes:
    ...
    branchall: Union[Unset, "ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleBranchall"] = UNSET
    approvers: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleBranchChosen.from_dict(
                _branch_chosen
            )
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleBranchall.from_dict(
                _branchall
            )
        ...
        for approvers_item_data in _approvers or []:
            approvers_item = (
                ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleApproversItem.from_dict(
                    approvers_item_data
                )
            )
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_0 = ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType0.from_dict(
                        data
                    )
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_2 = ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType2.from_dict(
                        data
                    )
                ...
                agent_actions_item_type_3 = (
                    ListExtendedJobsResponse200JobsItemType0FlowStatusPreprocessorModuleAgentActionsItemType3.from_dict(
                        data
                    )
                )
        ...
        return list_extended_jobs_response_200_jobs_item_type_0_flow_status_preprocessor_module
