...
T = TypeVar("T", bound="UpdateGcpTriggerJsonBodyRetryExponential")


@_attrs_define
class UpdateGcpTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_gcp_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        update_gcp_trigger_json_body_retry_exponential.additional_properties = d
        return update_gcp_trigger_json_body_retry_exponential
