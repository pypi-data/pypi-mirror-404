...
T = TypeVar("T", bound="ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterAllItersIf")
...
class ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_completed_jobs_response_200_item_raw_flow_preprocessor_module_stop_after_all_iters_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        list_completed_jobs_response_200_item_raw_flow_preprocessor_module_stop_after_all_iters_if.additional_properties = (
            d
        )
        return list_completed_jobs_response_200_item_raw_flow_preprocessor_module_stop_after_all_iters_if
