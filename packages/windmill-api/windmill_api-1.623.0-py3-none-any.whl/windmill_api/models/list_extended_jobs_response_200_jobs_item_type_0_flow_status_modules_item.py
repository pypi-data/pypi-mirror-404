...
if TYPE_CHECKING:
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_modules_item_flow_jobs_duration import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemFlowJobsDuration,
    )
...
class ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItem:
    ...
    flow_jobs_duration: Union[
        Unset, "ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemFlowJobsDuration"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_jobs_duration: Union[Unset, ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemFlowJobsDuration]
        if isinstance(_flow_jobs_duration, Unset):
            flow_jobs_duration = UNSET
        else:
            flow_jobs_duration = (
                ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemFlowJobsDuration.from_dict(
                    _flow_jobs_duration
                )
            )
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ListExtendedJobsResponse200JobsItemType0FlowStatusModulesItemAgentActionsItemType0.from_dict(
                            data
                        )
                    )
