...
if TYPE_CHECKING:
    from ..models.get_script_by_path_with_draft_response_200_assets_item import (
        GetScriptByPathWithDraftResponse200AssetsItem,
    )
...
class GetScriptByPathWithDraftResponse200:
    ...
    Attributes:
        ...
        assets (Union[Unset, List['GetScriptByPathWithDraftResponse200AssetsItem']]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for assets_item_data in _assets or []:
            assets_item = GetScriptByPathWithDraftResponse200AssetsItem.from_dict(assets_item_data)
