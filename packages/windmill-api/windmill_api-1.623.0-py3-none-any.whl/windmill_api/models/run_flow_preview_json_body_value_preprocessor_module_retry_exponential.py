...
T = TypeVar("T", bound="RunFlowPreviewJsonBodyValuePreprocessorModuleRetryExponential")


@_attrs_define
class RunFlowPreviewJsonBodyValuePreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        run_flow_preview_json_body_value_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        run_flow_preview_json_body_value_preprocessor_module_retry_exponential.additional_properties = d
        return run_flow_preview_json_body_value_preprocessor_module_retry_exponential
