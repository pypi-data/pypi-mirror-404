...
T = TypeVar("T", bound="OpenFlowWPathValuePreprocessorModuleMock")


@_attrs_define
class OpenFlowWPathValuePreprocessorModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_w_path_value_preprocessor_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        open_flow_w_path_value_preprocessor_module_mock.additional_properties = d
        return open_flow_w_path_value_preprocessor_module_mock
