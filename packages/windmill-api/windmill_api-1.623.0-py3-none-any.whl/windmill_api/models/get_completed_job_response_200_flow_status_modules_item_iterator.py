...
T = TypeVar("T", bound="GetCompletedJobResponse200FlowStatusModulesItemIterator")


@_attrs_define
class GetCompletedJobResponse200FlowStatusModulesItemIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_completed_job_response_200_flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        get_completed_job_response_200_flow_status_modules_item_iterator.additional_properties = d
