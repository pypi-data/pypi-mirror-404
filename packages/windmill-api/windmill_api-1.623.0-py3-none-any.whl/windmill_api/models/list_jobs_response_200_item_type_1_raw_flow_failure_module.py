...
if TYPE_CHECKING:
    from ..models.list_jobs_response_200_item_type_1_raw_flow_failure_module_mock import (
        ListJobsResponse200ItemType1RawFlowFailureModuleMock,
    )
    ...
    from ..models.list_jobs_response_200_item_type_1_raw_flow_failure_module_suspend import (
        ListJobsResponse200ItemType1RawFlowFailureModuleSuspend,
    )
    from ..models.list_jobs_response_200_item_type_1_raw_flow_failure_module_timeout_type_0 import (
        ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType0,
    )
    from ..models.list_jobs_response_200_item_type_1_raw_flow_failure_module_timeout_type_1 import (
        ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType1,
    )


T = TypeVar("T", bound="ListJobsResponse200ItemType1RawFlowFailureModule")


@_attrs_define
class ListJobsResponse200ItemType1RawFlowFailureModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleStopAfterIf]): Early termination
        ...
        skip_if (Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleSkipIf]): Conditionally skip this step
            based on previous results or flow inputs
        sleep (Union['ListJobsResponse200ItemType1RawFlowFailureModuleSleepType0',
            'ListJobsResponse200ItemType1RawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a step. Can be
        ...
        timeout (Union['ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType0',
            'ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a step. Can
        ...
        mock (Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleRetry]): Retry configuration for failed
            module executions
    """
    ...
    mock: Union[Unset, "ListJobsResponse200ItemType1RawFlowFailureModuleMock"] = UNSET
    suspend: Union[Unset, "ListJobsResponse200ItemType1RawFlowFailureModuleSuspend"] = UNSET
    priority: Union[Unset, float] = UNSET
    continue_on_error: Union[Unset, bool] = UNSET
    retry: Union[Unset, "ListJobsResponse200ItemType1RawFlowFailureModuleRetry"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, ListJobsResponse200ItemType1RawFlowFailureModuleSleepType0):
            sleep = UNSET
        ...
        elif isinstance(self.timeout, ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType0):
            timeout = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = ListJobsResponse200ItemType1RawFlowFailureModuleSleepType0.from_dict(_sleep_type_0)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _sleep_type_1 = data
            sleep_type_1: Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleSleepType1]
            if isinstance(_sleep_type_1, Unset):
                sleep_type_1 = UNSET
            else:
                sleep_type_1 = ListJobsResponse200ItemType1RawFlowFailureModuleSleepType1.from_dict(_sleep_type_1)
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType0.from_dict(
                        _timeout_type_0
                    )
            ...
            timeout_type_1: Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType1]
            if isinstance(_timeout_type_1, Unset):
                timeout_type_1 = UNSET
            else:
                timeout_type_1 = ListJobsResponse200ItemType1RawFlowFailureModuleTimeoutType1.from_dict(_timeout_type_1)
        ...
        mock: Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleMock]
        if isinstance(_mock, Unset):
            mock = UNSET
        else:
            mock = ListJobsResponse200ItemType1RawFlowFailureModuleMock.from_dict(_mock)

        _suspend = d.pop("suspend", UNSET)
        suspend: Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleSuspend]
        if isinstance(_suspend, Unset):
            suspend = UNSET
        else:
            suspend = ListJobsResponse200ItemType1RawFlowFailureModuleSuspend.from_dict(_suspend)
        ...
        retry: Union[Unset, ListJobsResponse200ItemType1RawFlowFailureModuleRetry]
        if isinstance(_retry, Unset):
            retry = UNSET
        else:
            retry = ListJobsResponse200ItemType1RawFlowFailureModuleRetry.from_dict(_retry)

        list_jobs_response_200_item_type_1_raw_flow_failure_module = cls(
            id=id,
            value=value,
        ...
        list_jobs_response_200_item_type_1_raw_flow_failure_module.additional_properties = d
        return list_jobs_response_200_item_type_1_raw_flow_failure_module
