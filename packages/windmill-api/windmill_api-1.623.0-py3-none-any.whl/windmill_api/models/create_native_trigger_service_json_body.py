...
T = TypeVar("T", bound="CreateNativeTriggerServiceJsonBody")


@_attrs_define
class CreateNativeTriggerServiceJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_native_trigger_service_json_body = cls(
            client_id=client_id,
            client_secret=client_secret,
            base_url=base_url,
            redirect_uri=redirect_uri,
        ...
        create_native_trigger_service_json_body.additional_properties = d
        return create_native_trigger_service_json_body
