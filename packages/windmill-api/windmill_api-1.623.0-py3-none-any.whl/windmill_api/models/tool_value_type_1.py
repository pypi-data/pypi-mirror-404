...
from ..models.tool_value_type_1_tool_type import ToolValueType1ToolType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ToolValueType1")


@_attrs_define
class ToolValueType1:
    """Reference to an external MCP (Model Context Protocol) tool. The AI can call tools from MCP servers

    Attributes:
        tool_type (ToolValueType1ToolType):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        tool_type = ToolValueType1ToolType(d.pop("tool_type"))
        ...
        tool_value_type_1.additional_properties = d
        return tool_value_type_1
