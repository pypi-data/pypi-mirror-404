...
T = TypeVar("T", bound="QueuedJobRawFlowPreprocessorModuleRetryExponential")


@_attrs_define
class QueuedJobRawFlowPreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        queued_job_raw_flow_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        queued_job_raw_flow_preprocessor_module_retry_exponential.additional_properties = d
        return queued_job_raw_flow_preprocessor_module_retry_exponential
