...
from ..models.list_jobs_response_200_item_type_0_flow_status_modules_item_type import (
    ListJobsResponse200ItemType0FlowStatusModulesItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.list_jobs_response_200_item_type_0_flow_status_modules_item_agent_actions_item_type_0 import (
        ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType0,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_modules_item_agent_actions_item_type_1 import (
        ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType1,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_modules_item_agent_actions_item_type_2 import (
        ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType2,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_modules_item_agent_actions_item_type_3 import (
        ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType3,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_modules_item_approvers_item import (
        ListJobsResponse200ItemType0FlowStatusModulesItemApproversItem,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_modules_item_branch_chosen import (
        ListJobsResponse200ItemType0FlowStatusModulesItemBranchChosen,
    )
...
T = TypeVar("T", bound="ListJobsResponse200ItemType0FlowStatusModulesItem")


@_attrs_define
class ListJobsResponse200ItemType0FlowStatusModulesItem:
    """
    Attributes:
        type (ListJobsResponse200ItemType0FlowStatusModulesItemType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
        ...
        agent_actions (Union[Unset, List[Union['ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType0',
            'ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType1',
            'ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType2',
            'ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType3']]]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    agent_actions_item_data, ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType0
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ListJobsResponse200ItemType0FlowStatusModulesItemType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ListJobsResponse200ItemType0FlowStatusModulesItemIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ListJobsResponse200ItemType0FlowStatusModulesItemBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ListJobsResponse200ItemType0FlowStatusModulesItemBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = ListJobsResponse200ItemType0FlowStatusModulesItemApproversItem.from_dict(
                approvers_item_data
            )
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    ListJobsResponse200ItemType0FlowStatusModulesItemAgentActionsItemType3.from_dict(data)
                )
        ...
        list_jobs_response_200_item_type_0_flow_status_modules_item = cls(
            type=type,
            id=id,
            job=job,
            count=count,
        ...
        list_jobs_response_200_item_type_0_flow_status_modules_item.additional_properties = d
        return list_jobs_response_200_item_type_0_flow_status_modules_item
