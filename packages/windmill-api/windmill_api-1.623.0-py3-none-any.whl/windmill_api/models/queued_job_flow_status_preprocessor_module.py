...
from ..models.queued_job_flow_status_preprocessor_module_type import QueuedJobFlowStatusPreprocessorModuleType
...
if TYPE_CHECKING:
    ...
    from ..models.queued_job_flow_status_preprocessor_module_agent_actions_item_type_3 import (
        QueuedJobFlowStatusPreprocessorModuleAgentActionsItemType3,
    )
    ...
    from ..models.queued_job_flow_status_preprocessor_module_branch_chosen import (
        QueuedJobFlowStatusPreprocessorModuleBranchChosen,
    )
...
T = TypeVar("T", bound="QueuedJobFlowStatusPreprocessorModule")


@_attrs_define
class QueuedJobFlowStatusPreprocessorModule:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                elif isinstance(agent_actions_item_data, QueuedJobFlowStatusPreprocessorModuleAgentActionsItemType2):
                    agent_actions_item = agent_actions_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = QueuedJobFlowStatusPreprocessorModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = QueuedJobFlowStatusPreprocessorModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = QueuedJobFlowStatusPreprocessorModuleBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = QueuedJobFlowStatusPreprocessorModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = QueuedJobFlowStatusPreprocessorModuleApproversItem.from_dict(approvers_item_data)
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_0 = QueuedJobFlowStatusPreprocessorModuleAgentActionsItemType0.from_dict(
                        data
                    )
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_2 = QueuedJobFlowStatusPreprocessorModuleAgentActionsItemType2.from_dict(
                        data
                    )
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                agent_actions_item_type_3 = QueuedJobFlowStatusPreprocessorModuleAgentActionsItemType3.from_dict(data)
        ...
        return queued_job_flow_status_preprocessor_module
