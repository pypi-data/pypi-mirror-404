...
from ..models.list_queue_response_200_item_raw_flow_notes_item_type import ListQueueResponse200ItemRawFlowNotesItemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.list_queue_response_200_item_raw_flow_notes_item_position import (
        ListQueueResponse200ItemRawFlowNotesItemPosition,
    )
    from ..models.list_queue_response_200_item_raw_flow_notes_item_size import (
        ListQueueResponse200ItemRawFlowNotesItemSize,
    )


T = TypeVar("T", bound="ListQueueResponse200ItemRawFlowNotesItem")


@_attrs_define
class ListQueueResponse200ItemRawFlowNotesItem:
    ...
    text: str
    color: str
    type: ListQueueResponse200ItemRawFlowNotesItemType
    position: Union[Unset, "ListQueueResponse200ItemRawFlowNotesItemPosition"] = UNSET
    size: Union[Unset, "ListQueueResponse200ItemRawFlowNotesItemSize"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = ListQueueResponse200ItemRawFlowNotesItemType(d.pop("type"))

        _position = d.pop("position", UNSET)
        position: Union[Unset, ListQueueResponse200ItemRawFlowNotesItemPosition]
        if isinstance(_position, Unset):
            position = UNSET
        else:
            position = ListQueueResponse200ItemRawFlowNotesItemPosition.from_dict(_position)

        _size = d.pop("size", UNSET)
        size: Union[Unset, ListQueueResponse200ItemRawFlowNotesItemSize]
        if isinstance(_size, Unset):
            size = UNSET
        else:
            size = ListQueueResponse200ItemRawFlowNotesItemSize.from_dict(_size)

        locked = d.pop("locked", UNSET)

        contained_node_ids = cast(List[str], d.pop("contained_node_ids", UNSET))

        list_queue_response_200_item_raw_flow_notes_item = cls(
            id=id,
            text=text,
            color=color,
            type=type,
        ...
        list_queue_response_200_item_raw_flow_notes_item.additional_properties = d
        return list_queue_response_200_item_raw_flow_notes_item
