...
if TYPE_CHECKING:
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_suspend_resume_form import (
        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspendResumeForm,
    )
...
@_attrs_define
class GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspendResumeForm]): Form
    ...
    resume_form: Union[Unset, "GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
        ...
        get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_suspend = cls(
        ...
        get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_suspend.additional_properties = d
        return get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_suspend
