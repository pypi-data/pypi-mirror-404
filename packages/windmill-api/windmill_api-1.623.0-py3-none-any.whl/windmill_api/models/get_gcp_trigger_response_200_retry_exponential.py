...
T = TypeVar("T", bound="GetGcpTriggerResponse200RetryExponential")


@_attrs_define
class GetGcpTriggerResponse200RetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_gcp_trigger_response_200_retry_exponential = cls(
            attempts=attempts,
        ...
        get_gcp_trigger_response_200_retry_exponential.additional_properties = d
        return get_gcp_trigger_response_200_retry_exponential
