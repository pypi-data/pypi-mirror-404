...
T = TypeVar("T", bound="DeleteCompletedJobResponse200RawFlowFailureModuleRetryConstant")


@_attrs_define
class DeleteCompletedJobResponse200RawFlowFailureModuleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_raw_flow_failure_module_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        delete_completed_job_response_200_raw_flow_failure_module_retry_constant.additional_properties = d
