...
if TYPE_CHECKING:
    from ..models.edit_success_handler_json_body_type_1_success_handler_extra_args import (
        EditSuccessHandlerJsonBodyType1SuccessHandlerExtraArgs,
    )


T = TypeVar("T", bound="EditSuccessHandlerJsonBodyType1")


@_attrs_define
class EditSuccessHandlerJsonBodyType1:
    ...
    Attributes:
        ...
        success_handler_extra_args (Union[Unset, EditSuccessHandlerJsonBodyType1SuccessHandlerExtraArgs]): The arguments
            to pass to the script or flow
    """

    success_handler: Union[Unset, str] = UNSET
    success_handler_extra_args: Union[Unset, "EditSuccessHandlerJsonBodyType1SuccessHandlerExtraArgs"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        success_handler_extra_args: Union[Unset, EditSuccessHandlerJsonBodyType1SuccessHandlerExtraArgs]
        if isinstance(_success_handler_extra_args, Unset):
            success_handler_extra_args = UNSET
        else:
            success_handler_extra_args = EditSuccessHandlerJsonBodyType1SuccessHandlerExtraArgs.from_dict(
                _success_handler_extra_args
            )

        edit_success_handler_json_body_type_1 = cls(
            success_handler=success_handler,
            success_handler_extra_args=success_handler_extra_args,
        )

        edit_success_handler_json_body_type_1.additional_properties = d
        return edit_success_handler_json_body_type_1
