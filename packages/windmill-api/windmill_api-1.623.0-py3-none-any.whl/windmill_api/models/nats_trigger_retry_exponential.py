...
T = TypeVar("T", bound="NatsTriggerRetryExponential")


@_attrs_define
class NatsTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        nats_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        nats_trigger_retry_exponential.additional_properties = d
        return nats_trigger_retry_exponential
