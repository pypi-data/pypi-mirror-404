...
from ..models.flow_module_timeout_type_1_type import FlowModuleTimeoutType1Type

T = TypeVar("T", bound="FlowModuleTimeoutType1")


@_attrs_define
class FlowModuleTimeoutType1:
    ...
    via 'flow_input.property'. Inside loops, use 'flow_input.iter.value' for the current iteration value
        ...
        Attributes:
            ...
            type (FlowModuleTimeoutType1Type):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = FlowModuleTimeoutType1Type(d.pop("type"))

        flow_module_timeout_type_1 = cls(
            expr=expr,
            type=type,
        )

        flow_module_timeout_type_1.additional_properties = d
        return flow_module_timeout_type_1
