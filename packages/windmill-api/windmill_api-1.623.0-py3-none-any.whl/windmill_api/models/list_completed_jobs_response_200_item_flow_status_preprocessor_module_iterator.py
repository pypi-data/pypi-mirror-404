...
T = TypeVar("T", bound="ListCompletedJobsResponse200ItemFlowStatusPreprocessorModuleIterator")


@_attrs_define
class ListCompletedJobsResponse200ItemFlowStatusPreprocessorModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_completed_jobs_response_200_item_flow_status_preprocessor_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        list_completed_jobs_response_200_item_flow_status_preprocessor_module_iterator.additional_properties = d
        return list_completed_jobs_response_200_item_flow_status_preprocessor_module_iterator
