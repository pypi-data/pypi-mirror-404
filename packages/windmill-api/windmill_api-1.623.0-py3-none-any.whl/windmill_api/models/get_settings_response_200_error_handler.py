...
T = TypeVar("T", bound="GetSettingsResponse200ErrorHandler")


@_attrs_define
class GetSettingsResponse200ErrorHandler:
    """Configuration for the workspace error handler

    Attributes:
        path (Union[Unset, str]): Path to the error handler script or flow
        extra_args (Union[Unset, GetSettingsResponse200ErrorHandlerExtraArgs]): The arguments to pass to the script or
            flow
    ...
    extra_args: Union[Unset, "GetSettingsResponse200ErrorHandlerExtraArgs"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extra_args: Union[Unset, GetSettingsResponse200ErrorHandlerExtraArgs]
        if isinstance(_extra_args, Unset):
            extra_args = UNSET
        else:
            extra_args = GetSettingsResponse200ErrorHandlerExtraArgs.from_dict(_extra_args)

        muted_on_cancel = d.pop("muted_on_cancel", UNSET)

        muted_on_user_path = d.pop("muted_on_user_path", UNSET)

        get_settings_response_200_error_handler = cls(
            path=path,
        ...
        get_settings_response_200_error_handler.additional_properties = d
        return get_settings_response_200_error_handler
