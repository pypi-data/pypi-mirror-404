...
T = TypeVar("T", bound="UpdateGcpTriggerJsonBodyRetryConstant")


@_attrs_define
class UpdateGcpTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_gcp_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        update_gcp_trigger_json_body_retry_constant.additional_properties = d
        return update_gcp_trigger_json_body_retry_constant
