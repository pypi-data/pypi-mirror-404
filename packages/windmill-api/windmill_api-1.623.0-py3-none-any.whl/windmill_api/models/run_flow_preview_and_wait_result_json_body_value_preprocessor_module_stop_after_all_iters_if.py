...
T = TypeVar("T", bound="RunFlowPreviewAndWaitResultJsonBodyValuePreprocessorModuleStopAfterAllItersIf")


@_attrs_define
class RunFlowPreviewAndWaitResultJsonBodyValuePreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        run_flow_preview_and_wait_result_json_body_value_preprocessor_module_stop_after_all_iters_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        run_flow_preview_and_wait_result_json_body_value_preprocessor_module_stop_after_all_iters_if.additional_properties = (
            d
        )
        return run_flow_preview_and_wait_result_json_body_value_preprocessor_module_stop_after_all_iters_if
