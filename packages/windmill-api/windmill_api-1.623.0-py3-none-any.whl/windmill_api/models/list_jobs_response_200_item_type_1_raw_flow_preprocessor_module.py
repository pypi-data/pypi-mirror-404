...
if TYPE_CHECKING:
    ...
    from ..models.list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_timeout_type_0 import (
        ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType0,
    )
    from ..models.list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_timeout_type_1 import (
        ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType1,
    )
...
class ListJobsResponse200ItemType1RawFlowPreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleStopAfterIf]): Early
            termination condition for a module
        stop_after_all_iters_if (Union[Unset,
            ListJobsResponse200ItemType1RawFlowPreprocessorModuleStopAfterAllItersIf]): Early termination condition for a
            module
        skip_if (Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleSkipIf]): Conditionally skip this
            step based on previous results or flow inputs
        sleep (Union['ListJobsResponse200ItemType1RawFlowPreprocessorModuleSleepType0',
            'ListJobsResponse200ItemType1RawFlowPreprocessorModuleSleepType1', Unset]): Maps input parameters for a step.
        ...
        timeout (Union['ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType0',
            'ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType1', Unset]): Maps input parameters for a step.
            Can be a static value or a JavaScript expression that references previous results or flow inputs
        ...
        mock (Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleRetry]): Retry configuration for failed
            module executions
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.timeout, ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType0):
            timeout = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType0.from_dict(
                        _timeout_type_0
                    )
            ...
            timeout_type_1: Union[Unset, ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType1]
            if isinstance(_timeout_type_1, Unset):
                timeout_type_1 = UNSET
            else:
                timeout_type_1 = ListJobsResponse200ItemType1RawFlowPreprocessorModuleTimeoutType1.from_dict(
                    _timeout_type_1
                )
