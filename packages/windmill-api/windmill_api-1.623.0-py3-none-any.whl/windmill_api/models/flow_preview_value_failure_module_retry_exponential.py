...
T = TypeVar("T", bound="FlowPreviewValueFailureModuleRetryExponential")


@_attrs_define
class FlowPreviewValueFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_preview_value_failure_module_retry_exponential = cls(
            attempts=attempts,
        ...
        flow_preview_value_failure_module_retry_exponential.additional_properties = d
