...
T = TypeVar("T", bound="ListNatsTriggersResponse200ItemRetryExponential")


@_attrs_define
class ListNatsTriggersResponse200ItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_nats_triggers_response_200_item_retry_exponential = cls(
            attempts=attempts,
        ...
        list_nats_triggers_response_200_item_retry_exponential.additional_properties = d
        return list_nats_triggers_response_200_item_retry_exponential
