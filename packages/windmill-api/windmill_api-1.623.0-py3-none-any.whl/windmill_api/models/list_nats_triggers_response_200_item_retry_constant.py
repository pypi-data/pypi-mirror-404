...
T = TypeVar("T", bound="ListNatsTriggersResponse200ItemRetryConstant")


@_attrs_define
class ListNatsTriggersResponse200ItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_nats_triggers_response_200_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        list_nats_triggers_response_200_item_retry_constant.additional_properties = d
        return list_nats_triggers_response_200_item_retry_constant
