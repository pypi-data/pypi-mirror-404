...
T = TypeVar("T", bound="FlowPreviewValueFailureModuleStopAfterIf")


@_attrs_define
class FlowPreviewValueFailureModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_preview_value_failure_module_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        flow_preview_value_failure_module_stop_after_if.additional_properties = d
        return flow_preview_value_failure_module_stop_after_if
