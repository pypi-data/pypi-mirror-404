...
T = TypeVar("T", bound="ListMqttTriggersResponse200ItemRetryExponential")


@_attrs_define
class ListMqttTriggersResponse200ItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_mqtt_triggers_response_200_item_retry_exponential = cls(
            attempts=attempts,
        ...
        list_mqtt_triggers_response_200_item_retry_exponential.additional_properties = d
        return list_mqtt_triggers_response_200_item_retry_exponential
