...
T = TypeVar("T", bound="CreatePostgresTriggerJsonBodyRetryExponential")


@_attrs_define
class CreatePostgresTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_postgres_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        create_postgres_trigger_json_body_retry_exponential.additional_properties = d
        return create_postgres_trigger_json_body_retry_exponential
