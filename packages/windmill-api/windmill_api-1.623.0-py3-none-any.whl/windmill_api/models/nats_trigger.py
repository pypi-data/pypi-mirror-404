...
if TYPE_CHECKING:
    from ..models.nats_trigger_error_handler_args import NatsTriggerErrorHandlerArgs
    from ..models.nats_trigger_extra_perms import NatsTriggerExtraPerms
    from ..models.nats_trigger_retry import NatsTriggerRetry
...
class NatsTrigger:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_error_handler_args, Unset):
            ...
            error_handler_args = NatsTriggerErrorHandlerArgs.from_dict(_error_handler_args)
        ...
        if isinstance(_retry, Unset):
            ...
            retry = NatsTriggerRetry.from_dict(_retry)
