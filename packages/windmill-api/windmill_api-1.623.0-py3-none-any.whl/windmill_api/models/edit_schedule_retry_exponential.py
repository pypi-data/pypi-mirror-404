...
T = TypeVar("T", bound="EditScheduleRetryExponential")


@_attrs_define
class EditScheduleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_schedule_retry_exponential = cls(
            attempts=attempts,
        ...
        edit_schedule_retry_exponential.additional_properties = d
        return edit_schedule_retry_exponential
