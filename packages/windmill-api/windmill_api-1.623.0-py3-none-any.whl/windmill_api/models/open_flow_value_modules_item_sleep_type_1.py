...
from ..models.open_flow_value_modules_item_sleep_type_1_type import OpenFlowValueModulesItemSleepType1Type

T = TypeVar("T", bound="OpenFlowValueModulesItemSleepType1")


@_attrs_define
class OpenFlowValueModulesItemSleepType1:
    ...
    via 'flow_input.property'. Inside loops, use 'flow_input.iter.value' for the current iteration value
        ...
        Attributes:
            ...
            type (OpenFlowValueModulesItemSleepType1Type):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = OpenFlowValueModulesItemSleepType1Type(d.pop("type"))

        open_flow_value_modules_item_sleep_type_1 = cls(
            expr=expr,
            type=type,
        )

        open_flow_value_modules_item_sleep_type_1.additional_properties = d
