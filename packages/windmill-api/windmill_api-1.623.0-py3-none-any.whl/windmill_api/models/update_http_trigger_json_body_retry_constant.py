...
T = TypeVar("T", bound="UpdateHttpTriggerJsonBodyRetryConstant")


@_attrs_define
class UpdateHttpTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_http_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        update_http_trigger_json_body_retry_constant.additional_properties = d
        return update_http_trigger_json_body_retry_constant
