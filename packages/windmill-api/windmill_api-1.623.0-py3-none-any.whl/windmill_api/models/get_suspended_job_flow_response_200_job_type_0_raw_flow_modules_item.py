...
class GetSuspendedJobFlowResponse200JobType0RawFlowModulesItem:
    ...
    Attributes:
        ...
        sleep (Union['GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSleepType0',
            'GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemSleepType1', Unset]): Maps input parameters for a step.
        ...
        timeout (Union['GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemTimeoutType0',
            'GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemTimeoutType1', Unset]): Maps input parameters for a
