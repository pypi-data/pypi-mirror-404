...
if TYPE_CHECKING:
    from ..models.run_flow_preview_json_body_value_preprocessor_module_suspend_resume_form import (
        RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendResumeForm,
    )
    from ..models.run_flow_preview_json_body_value_preprocessor_module_suspend_user_groups_required_type_0 import (
        RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.run_flow_preview_json_body_value_preprocessor_module_suspend_user_groups_required_type_1 import (
        RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="RunFlowPreviewJsonBodyValuePreprocessorModuleSuspend")


@_attrs_define
class RunFlowPreviewJsonBodyValuePreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendResumeForm]): Form schema for
            collecting input when resuming
        user_auth_required (Union[Unset, bool]): If true, only authenticated users can approve
        user_groups_required (Union['RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType0',
            'RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters
    ...
    resume_form: Union[Unset, "RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    RunFlowPreviewJsonBodyValuePreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        run_flow_preview_json_body_value_preprocessor_module_suspend = cls(
        ...
        run_flow_preview_json_body_value_preprocessor_module_suspend.additional_properties = d
        return run_flow_preview_json_body_value_preprocessor_module_suspend
