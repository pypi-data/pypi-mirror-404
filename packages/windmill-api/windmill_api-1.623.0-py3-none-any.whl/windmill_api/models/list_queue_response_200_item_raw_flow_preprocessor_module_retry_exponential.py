...
T = TypeVar("T", bound="ListQueueResponse200ItemRawFlowPreprocessorModuleRetryExponential")


@_attrs_define
class ListQueueResponse200ItemRawFlowPreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_queue_response_200_item_raw_flow_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        list_queue_response_200_item_raw_flow_preprocessor_module_retry_exponential.additional_properties = d
        return list_queue_response_200_item_raw_flow_preprocessor_module_retry_exponential
