...
T = TypeVar("T", bound="ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleRetryExponential")


@_attrs_define
class ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_completed_jobs_response_200_item_raw_flow_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        list_completed_jobs_response_200_item_raw_flow_preprocessor_module_retry_exponential.additional_properties = d
        return list_completed_jobs_response_200_item_raw_flow_preprocessor_module_retry_exponential
