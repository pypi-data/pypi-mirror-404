...
T = TypeVar("T", bound="PostgresTriggerRetryConstant")


@_attrs_define
class PostgresTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        postgres_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        postgres_trigger_retry_constant.additional_properties = d
        return postgres_trigger_retry_constant
