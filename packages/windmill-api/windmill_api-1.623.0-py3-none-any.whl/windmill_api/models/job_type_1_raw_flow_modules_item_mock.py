...
T = TypeVar("T", bound="JobType1RawFlowModulesItemMock")


@_attrs_define
class JobType1RawFlowModulesItemMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_1_raw_flow_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        job_type_1_raw_flow_modules_item_mock.additional_properties = d
        return job_type_1_raw_flow_modules_item_mock
