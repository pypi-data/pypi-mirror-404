...
class DeleteCompletedJobResponse200RawFlowPreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleStopAfterIf]): Early
            termination condition for a module
        stop_after_all_iters_if (Union[Unset,
            DeleteCompletedJobResponse200RawFlowPreprocessorModuleStopAfterAllItersIf]): Early termination condition for a
            module
        skip_if (Union[Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleSkipIf]): Conditionally skip this
        ...
        sleep (Union['DeleteCompletedJobResponse200RawFlowPreprocessorModuleSleepType0',
            'DeleteCompletedJobResponse200RawFlowPreprocessorModuleSleepType1', Unset]): Maps input parameters for a step.
        ...
        timeout (Union['DeleteCompletedJobResponse200RawFlowPreprocessorModuleTimeoutType0',
            'DeleteCompletedJobResponse200RawFlowPreprocessorModuleTimeoutType1', Unset]): Maps input parameters for a step.
            Can be a static value or a JavaScript expression that references previous results or flow inputs
        ...
        mock (Union[Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleRetry]): Retry configuration for
