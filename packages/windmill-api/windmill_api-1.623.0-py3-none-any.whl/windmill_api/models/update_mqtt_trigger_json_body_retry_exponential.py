...
T = TypeVar("T", bound="UpdateMqttTriggerJsonBodyRetryExponential")


@_attrs_define
class UpdateMqttTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_mqtt_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        update_mqtt_trigger_json_body_retry_exponential.additional_properties = d
        return update_mqtt_trigger_json_body_retry_exponential
