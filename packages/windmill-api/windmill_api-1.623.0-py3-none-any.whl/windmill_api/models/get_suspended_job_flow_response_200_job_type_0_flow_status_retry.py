...
T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType0FlowStatusRetry")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType0FlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_suspended_job_flow_response_200_job_type_0_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        get_suspended_job_flow_response_200_job_type_0_flow_status_retry.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_0_flow_status_retry
