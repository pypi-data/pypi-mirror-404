...
T = TypeVar("T", bound="GetHubFlowByIdResponse200FlowValueModulesItemStopAfterIf")


@_attrs_define
class GetHubFlowByIdResponse200FlowValueModulesItemStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_hub_flow_by_id_response_200_flow_value_modules_item_stop_after_if
