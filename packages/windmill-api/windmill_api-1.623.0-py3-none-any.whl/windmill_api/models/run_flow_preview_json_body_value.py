...
if TYPE_CHECKING:
    ...
    from ..models.run_flow_preview_json_body_value_flow_env import RunFlowPreviewJsonBodyValueFlowEnv
    from ..models.run_flow_preview_json_body_value_modules_item import RunFlowPreviewJsonBodyValueModulesItem
    from ..models.run_flow_preview_json_body_value_notes_item import RunFlowPreviewJsonBodyValueNotesItem
...
class RunFlowPreviewJsonBodyValue:
    ...
    Attributes:
        modules (List['RunFlowPreviewJsonBodyValueModulesItem']): Array of steps that execute in sequence. Each step can
            be a script, subflow, loop, or branch
        failure_module (Union[Unset, RunFlowPreviewJsonBodyValueFailureModule]): A single step in a flow. Can be a
            script, subflow, loop, or branch
        preprocessor_module (Union[Unset, RunFlowPreviewJsonBodyValuePreprocessorModule]): A single step in a flow. Can
            be a script, subflow, loop, or branch
        ...
        flow_env (Union[Unset, RunFlowPreviewJsonBodyValueFlowEnv]): Environment variables available to all steps
        ...
        notes (Union[Unset, List['RunFlowPreviewJsonBodyValueNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "RunFlowPreviewJsonBodyValueFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["RunFlowPreviewJsonBodyValueNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, RunFlowPreviewJsonBodyValueFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = RunFlowPreviewJsonBodyValueFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = RunFlowPreviewJsonBodyValueNotesItem.from_dict(notes_item_data)
