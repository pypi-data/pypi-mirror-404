...
T = TypeVar("T", bound="CreateKafkaTriggerJsonBodyRetryConstant")


@_attrs_define
class CreateKafkaTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_kafka_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        create_kafka_trigger_json_body_retry_constant.additional_properties = d
        return create_kafka_trigger_json_body_retry_constant
