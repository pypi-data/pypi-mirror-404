...
T = TypeVar("T", bound="EditKafkaTriggerRetryConstant")


@_attrs_define
class EditKafkaTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_kafka_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        edit_kafka_trigger_retry_constant.additional_properties = d
        return edit_kafka_trigger_retry_constant
