...
class QueuedJobRawFlowModulesItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, QueuedJobRawFlowModulesItemStopAfterIf]): Early termination condition for a module
        stop_after_all_iters_if (Union[Unset, QueuedJobRawFlowModulesItemStopAfterAllItersIf]): Early termination
        ...
        mock (Union[Unset, QueuedJobRawFlowModulesItemMock]): Mock configuration for testing without executing the
            actual step
        suspend (Union[Unset, QueuedJobRawFlowModulesItemSuspend]): Configuration for approval/resume steps that wait
            for user input
        ...
        retry (Union[Unset, QueuedJobRawFlowModulesItemRetry]): Retry configuration for failed module executions
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, QueuedJobRawFlowModulesItemTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = QueuedJobRawFlowModulesItemTimeoutType0.from_dict(_timeout_type_0)
