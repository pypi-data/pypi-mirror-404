...
class GetCompletedJobResponse200RawFlowPreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetCompletedJobResponse200RawFlowPreprocessorModuleStopAfterIf]): Early termination
        ...
        mock (Union[Unset, GetCompletedJobResponse200RawFlowPreprocessorModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, GetCompletedJobResponse200RawFlowPreprocessorModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, GetCompletedJobResponse200RawFlowPreprocessorModuleRetry]): Retry configuration for failed
            module executions
    """
