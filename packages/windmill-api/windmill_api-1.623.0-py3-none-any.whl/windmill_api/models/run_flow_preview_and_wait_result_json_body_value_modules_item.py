...
class RunFlowPreviewAndWaitResultJsonBodyValueModulesItem:
    ...
    Attributes:
        ...
        sleep (Union['RunFlowPreviewAndWaitResultJsonBodyValueModulesItemSleepType0',
            'RunFlowPreviewAndWaitResultJsonBodyValueModulesItemSleepType1', Unset]): Maps input parameters for a step. Can
        ...
        timeout (Union['RunFlowPreviewAndWaitResultJsonBodyValueModulesItemTimeoutType0',
            'RunFlowPreviewAndWaitResultJsonBodyValueModulesItemTimeoutType1', Unset]): Maps input parameters for a step.
