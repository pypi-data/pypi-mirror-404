...
T = TypeVar("T", bound="QueuedJobRawFlowModulesItemRetryConstant")


@_attrs_define
class QueuedJobRawFlowModulesItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        queued_job_raw_flow_modules_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        queued_job_raw_flow_modules_item_retry_constant.additional_properties = d
        return queued_job_raw_flow_modules_item_retry_constant
