...
T = TypeVar("T", bound="GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterAllItersIf")


@_attrs_define
class GetFlowByPathWithDraftResponse200DraftValuePreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module_stop_after_all_iters_if
