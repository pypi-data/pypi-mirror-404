...
T = TypeVar("T", bound="FlowPreviewValueModulesItemRetryExponential")


@_attrs_define
class FlowPreviewValueModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_preview_value_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        flow_preview_value_modules_item_retry_exponential.additional_properties = d
        return flow_preview_value_modules_item_retry_exponential
