...
if TYPE_CHECKING:
    from ..models.get_flow_by_path_response_200_value_failure_module_retry_constant import (
        GetFlowByPathResponse200ValueFailureModuleRetryConstant,
    )
    from ..models.get_flow_by_path_response_200_value_failure_module_retry_exponential import (
        GetFlowByPathResponse200ValueFailureModuleRetryExponential,
    )
    from ..models.get_flow_by_path_response_200_value_failure_module_retry_retry_if import (
        GetFlowByPathResponse200ValueFailureModuleRetryRetryIf,
    )
...
class GetFlowByPathResponse200ValueFailureModuleRetry:
    ...
    retry_if: Union[Unset, "GetFlowByPathResponse200ValueFailureModuleRetryRetryIf"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_retry_if, Unset):
            ...
            retry_if = GetFlowByPathResponse200ValueFailureModuleRetryRetryIf.from_dict(_retry_if)
