...
T = TypeVar("T", bound="QueuedJobFlowStatusPreprocessorModuleIterator")


@_attrs_define
class QueuedJobFlowStatusPreprocessorModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        queued_job_flow_status_preprocessor_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        queued_job_flow_status_preprocessor_module_iterator.additional_properties = d
        return queued_job_flow_status_preprocessor_module_iterator
