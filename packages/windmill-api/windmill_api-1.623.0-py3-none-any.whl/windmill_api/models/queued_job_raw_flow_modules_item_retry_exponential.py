...
T = TypeVar("T", bound="QueuedJobRawFlowModulesItemRetryExponential")


@_attrs_define
class QueuedJobRawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        queued_job_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        queued_job_raw_flow_modules_item_retry_exponential.additional_properties = d
        return queued_job_raw_flow_modules_item_retry_exponential
