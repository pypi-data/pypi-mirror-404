...
T = TypeVar("T", bound="OpenFlowValuePreprocessorModuleMock")


@_attrs_define
class OpenFlowValuePreprocessorModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_value_preprocessor_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        open_flow_value_preprocessor_module_mock.additional_properties = d
        return open_flow_value_preprocessor_module_mock
