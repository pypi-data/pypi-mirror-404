...
T = TypeVar("T", bound="NewWebsocketTriggerRetryConstant")


@_attrs_define
class NewWebsocketTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_websocket_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        new_websocket_trigger_retry_constant.additional_properties = d
        return new_websocket_trigger_retry_constant
