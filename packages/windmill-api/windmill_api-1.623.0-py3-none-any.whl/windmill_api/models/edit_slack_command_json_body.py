...
T = TypeVar("T", bound="EditSlackCommandJsonBody")


@_attrs_define
class EditSlackCommandJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_slack_command_json_body = cls(
            slack_command_script=slack_command_script,
        )

        edit_slack_command_json_body.additional_properties = d
