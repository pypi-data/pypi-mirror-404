...
T = TypeVar("T", bound="GetCompletedJobResponse200RawFlowPreprocessorModuleStopAfterIf")


@_attrs_define
class GetCompletedJobResponse200RawFlowPreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_completed_job_response_200_raw_flow_preprocessor_module_stop_after_if
