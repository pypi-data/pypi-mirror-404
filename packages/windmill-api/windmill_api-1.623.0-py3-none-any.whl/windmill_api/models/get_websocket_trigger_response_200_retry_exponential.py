...
T = TypeVar("T", bound="GetWebsocketTriggerResponse200RetryExponential")


@_attrs_define
class GetWebsocketTriggerResponse200RetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_websocket_trigger_response_200_retry_exponential = cls(
            attempts=attempts,
        ...
        get_websocket_trigger_response_200_retry_exponential.additional_properties = d
        return get_websocket_trigger_response_200_retry_exponential
