...
T = TypeVar("T", bound="PostgresTriggerRetryExponential")


@_attrs_define
class PostgresTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        postgres_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        postgres_trigger_retry_exponential.additional_properties = d
        return postgres_trigger_retry_exponential
