...
class QueuedJobRawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        user_groups_required (Union['QueuedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType0',
            'QueuedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a step.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(
            ...
            user_groups_required_type_1: Union[Unset, QueuedJobRawFlowPreprocessorModuleSuspendUserGroupsRequiredType1]
