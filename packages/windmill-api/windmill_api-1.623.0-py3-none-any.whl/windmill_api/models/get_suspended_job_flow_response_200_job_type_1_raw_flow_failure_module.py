...
class GetSuspendedJobFlowResponse200JobType1RawFlowFailureModule:
    ...
    Attributes:
        ...
        sleep (Union['GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSleepType0',
            'GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a
        ...
        timeout (Union['GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleTimeoutType0',
            'GetSuspendedJobFlowResponse200JobType1RawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a
            step. Can be a static value or a JavaScript expression that references previous results or flow inputs
