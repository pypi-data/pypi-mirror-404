...
from ..models.branch_one_branches_item_modules_item_suspend_user_groups_required_type_0_type import (
    BranchOneBranchesItemModulesItemSuspendUserGroupsRequiredType0Type,
)
