...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleIterator")


@_attrs_define
class ExtendedJobsJobsItemType0FlowStatusPreprocessorModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_iterator.additional_properties = d
        return extended_jobs_jobs_item_type_0_flow_status_preprocessor_module_iterator
