...
T = TypeVar("T", bound="ListSchedulesResponse200ItemRetryExponential")


@_attrs_define
class ListSchedulesResponse200ItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_schedules_response_200_item_retry_exponential = cls(
            attempts=attempts,
        ...
        list_schedules_response_200_item_retry_exponential.additional_properties = d
