...
T = TypeVar("T", bound="WhileloopFlowModulesItemMock")


@_attrs_define
class WhileloopFlowModulesItemMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        whileloop_flow_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        whileloop_flow_modules_item_mock.additional_properties = d
        return whileloop_flow_modules_item_mock
