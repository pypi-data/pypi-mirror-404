...
if TYPE_CHECKING:
    ...
    from ..models.get_job_response_200_type_0_raw_flow_flow_env import GetJobResponse200Type0RawFlowFlowEnv
    from ..models.get_job_response_200_type_0_raw_flow_modules_item import GetJobResponse200Type0RawFlowModulesItem
    from ..models.get_job_response_200_type_0_raw_flow_notes_item import GetJobResponse200Type0RawFlowNotesItem
...
class GetJobResponse200Type0RawFlow:
    ...
    Attributes:
        modules (List['GetJobResponse200Type0RawFlowModulesItem']): Array of steps that execute in sequence. Each step
            can be a script, subflow, loop, or branch
        failure_module (Union[Unset, GetJobResponse200Type0RawFlowFailureModule]): A single step in a flow. Can be a
            script, subflow, loop, or branch
        preprocessor_module (Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModule]): A single step in a flow.
            Can be a script, subflow, loop, or branch
        ...
        flow_env (Union[Unset, GetJobResponse200Type0RawFlowFlowEnv]): Environment variables available to all steps
        ...
        notes (Union[Unset, List['GetJobResponse200Type0RawFlowNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "GetJobResponse200Type0RawFlowFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["GetJobResponse200Type0RawFlowNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, GetJobResponse200Type0RawFlowFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = GetJobResponse200Type0RawFlowFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = GetJobResponse200Type0RawFlowNotesItem.from_dict(notes_item_data)
