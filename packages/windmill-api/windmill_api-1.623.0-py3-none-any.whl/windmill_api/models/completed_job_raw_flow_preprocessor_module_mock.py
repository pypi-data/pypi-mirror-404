...
T = TypeVar("T", bound="CompletedJobRawFlowPreprocessorModuleMock")


@_attrs_define
class CompletedJobRawFlowPreprocessorModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        completed_job_raw_flow_preprocessor_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        completed_job_raw_flow_preprocessor_module_mock.additional_properties = d
        return completed_job_raw_flow_preprocessor_module_mock
