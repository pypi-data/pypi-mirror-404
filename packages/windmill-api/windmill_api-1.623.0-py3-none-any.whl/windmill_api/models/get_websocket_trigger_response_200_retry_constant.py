...
T = TypeVar("T", bound="GetWebsocketTriggerResponse200RetryConstant")
...
class GetWebsocketTriggerResponse200RetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_websocket_trigger_response_200_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_websocket_trigger_response_200_retry_constant.additional_properties = d
        return get_websocket_trigger_response_200_retry_constant
