...
T = TypeVar("T", bound="FlowModuleRetryConstant")


@_attrs_define
class FlowModuleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        flow_module_retry_constant.additional_properties = d
        return flow_module_retry_constant
