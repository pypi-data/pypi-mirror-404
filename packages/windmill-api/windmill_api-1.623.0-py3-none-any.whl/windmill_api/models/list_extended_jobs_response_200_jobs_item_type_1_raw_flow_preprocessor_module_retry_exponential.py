...
T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType1RawFlowPreprocessorModuleRetryExponential")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType1RawFlowPreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_extended_jobs_response_200_jobs_item_type_1_raw_flow_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        list_extended_jobs_response_200_jobs_item_type_1_raw_flow_preprocessor_module_retry_exponential.additional_properties = (
            d
        )
        return list_extended_jobs_response_200_jobs_item_type_1_raw_flow_preprocessor_module_retry_exponential
