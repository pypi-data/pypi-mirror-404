...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_preprocessor_module_retry_constant import (
        ListExtendedJobsResponse200JobsItemType1RawFlowPreprocessorModuleRetryConstant,
    )
...
@_attrs_define
class ListExtendedJobsResponse200JobsItemType1RawFlowPreprocessorModuleRetry:
    """Retry configuration for failed module executions

    Attributes:
        constant (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowPreprocessorModuleRetryConstant]): Retry
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_constant, Unset):
            ...
            constant = ListExtendedJobsResponse200JobsItemType1RawFlowPreprocessorModuleRetryConstant.from_dict(
                _constant
            )
        ...
        if isinstance(_exponential, Unset):
            ...
            exponential = ListExtendedJobsResponse200JobsItemType1RawFlowPreprocessorModuleRetryExponential.from_dict(
                _exponential
            )
        ...
        return list_extended_jobs_response_200_jobs_item_type_1_raw_flow_preprocessor_module_retry
