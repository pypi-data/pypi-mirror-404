...
T = TypeVar("T", bound="FlowModuleValue2Type4ModulesItemRetryExponential")


@_attrs_define
class FlowModuleValue2Type4ModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_4_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        flow_module_value_2_type_4_modules_item_retry_exponential.additional_properties = d
        return flow_module_value_2_type_4_modules_item_retry_exponential
