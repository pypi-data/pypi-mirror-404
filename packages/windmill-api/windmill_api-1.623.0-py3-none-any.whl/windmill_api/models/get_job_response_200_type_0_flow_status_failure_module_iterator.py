...
T = TypeVar("T", bound="GetJobResponse200Type0FlowStatusFailureModuleIterator")


@_attrs_define
class GetJobResponse200Type0FlowStatusFailureModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_0_flow_status_failure_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        get_job_response_200_type_0_flow_status_failure_module_iterator.additional_properties = d
        return get_job_response_200_type_0_flow_status_failure_module_iterator
