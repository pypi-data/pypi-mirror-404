...
T = TypeVar("T", bound="OpenFlowWPathValueFailureModuleRetryExponential")


@_attrs_define
class OpenFlowWPathValueFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_w_path_value_failure_module_retry_exponential = cls(
            attempts=attempts,
        ...
        open_flow_w_path_value_failure_module_retry_exponential.additional_properties = d
