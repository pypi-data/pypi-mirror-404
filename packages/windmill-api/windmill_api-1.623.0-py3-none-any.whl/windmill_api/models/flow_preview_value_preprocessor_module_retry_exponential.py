...
T = TypeVar("T", bound="FlowPreviewValuePreprocessorModuleRetryExponential")


@_attrs_define
class FlowPreviewValuePreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_preview_value_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        flow_preview_value_preprocessor_module_retry_exponential.additional_properties = d
        return flow_preview_value_preprocessor_module_retry_exponential
