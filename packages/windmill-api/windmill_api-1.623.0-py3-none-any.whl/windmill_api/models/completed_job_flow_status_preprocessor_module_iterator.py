...
T = TypeVar("T", bound="CompletedJobFlowStatusPreprocessorModuleIterator")


@_attrs_define
class CompletedJobFlowStatusPreprocessorModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        completed_job_flow_status_preprocessor_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        completed_job_flow_status_preprocessor_module_iterator.additional_properties = d
        return completed_job_flow_status_preprocessor_module_iterator
