...
T = TypeVar("T", bound="CreateMqttTriggerJsonBodyRetryExponential")


@_attrs_define
class CreateMqttTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_mqtt_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        create_mqtt_trigger_json_body_retry_exponential.additional_properties = d
        return create_mqtt_trigger_json_body_retry_exponential
