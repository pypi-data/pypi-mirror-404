...
T = TypeVar("T", bound="OpenFlowValuePreprocessorModuleRetryConstant")


@_attrs_define
class OpenFlowValuePreprocessorModuleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_value_preprocessor_module_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        open_flow_value_preprocessor_module_retry_constant.additional_properties = d
        return open_flow_value_preprocessor_module_retry_constant
