...
class ListExtendedJobsResponse200JobsItemType0RawFlowFailureModule:
    ...
    Attributes:
        ...
        sleep (Union['ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSleepType0',
            'ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a
        ...
        timeout (Union['ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleTimeoutType0',
            'ListExtendedJobsResponse200JobsItemType0RawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a
            step. Can be a static value or a JavaScript expression that references previous results or flow inputs
