...
T = TypeVar("T", bound="CreateTemplateScriptJsonBodyRelationsItemTableToTrackItem")
...
class CreateTemplateScriptJsonBodyRelationsItemTableToTrackItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_template_script_json_body_relations_item_table_to_track_item = cls(
            table_name=table_name,
            columns_name=columns_name,
            where_clause=where_clause,
        )

        create_template_script_json_body_relations_item_table_to_track_item.additional_properties = d
        return create_template_script_json_body_relations_item_table_to_track_item
