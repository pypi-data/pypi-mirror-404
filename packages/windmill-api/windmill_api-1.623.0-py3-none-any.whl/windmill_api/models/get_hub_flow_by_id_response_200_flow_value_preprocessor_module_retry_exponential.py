...
T = TypeVar("T", bound="GetHubFlowByIdResponse200FlowValuePreprocessorModuleRetryExponential")


@_attrs_define
class GetHubFlowByIdResponse200FlowValuePreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_hub_flow_by_id_response_200_flow_value_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        get_hub_flow_by_id_response_200_flow_value_preprocessor_module_retry_exponential.additional_properties = d
        return get_hub_flow_by_id_response_200_flow_value_preprocessor_module_retry_exponential
