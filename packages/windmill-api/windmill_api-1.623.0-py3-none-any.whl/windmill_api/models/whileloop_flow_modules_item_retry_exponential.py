...
T = TypeVar("T", bound="WhileloopFlowModulesItemRetryExponential")


@_attrs_define
class WhileloopFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        whileloop_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        whileloop_flow_modules_item_retry_exponential.additional_properties = d
        return whileloop_flow_modules_item_retry_exponential
