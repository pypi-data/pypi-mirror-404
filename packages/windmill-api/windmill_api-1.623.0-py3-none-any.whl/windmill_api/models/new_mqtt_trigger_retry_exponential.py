...
T = TypeVar("T", bound="NewMqttTriggerRetryExponential")


@_attrs_define
class NewMqttTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_mqtt_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        new_mqtt_trigger_retry_exponential.additional_properties = d
        return new_mqtt_trigger_retry_exponential
