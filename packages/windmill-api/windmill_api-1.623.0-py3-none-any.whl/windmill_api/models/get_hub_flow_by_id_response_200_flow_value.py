...
if TYPE_CHECKING:
    ...
    from ..models.get_hub_flow_by_id_response_200_flow_value_flow_env import GetHubFlowByIdResponse200FlowValueFlowEnv
    from ..models.get_hub_flow_by_id_response_200_flow_value_modules_item import (
        GetHubFlowByIdResponse200FlowValueModulesItem,
    )
    from ..models.get_hub_flow_by_id_response_200_flow_value_notes_item import (
        GetHubFlowByIdResponse200FlowValueNotesItem,
    )
...
class GetHubFlowByIdResponse200FlowValue:
    ...
    Attributes:
        modules (List['GetHubFlowByIdResponse200FlowValueModulesItem']): Array of steps that execute in sequence. Each
            step can be a script, subflow, loop, or branch
        failure_module (Union[Unset, GetHubFlowByIdResponse200FlowValueFailureModule]): A single step in a flow. Can be
            a script, subflow, loop, or branch
        preprocessor_module (Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModule]): A single step in a
        ...
        flow_env (Union[Unset, GetHubFlowByIdResponse200FlowValueFlowEnv]): Environment variables available to all steps
        ...
        notes (Union[Unset, List['GetHubFlowByIdResponse200FlowValueNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "GetHubFlowByIdResponse200FlowValueFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["GetHubFlowByIdResponse200FlowValueNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.get_hub_flow_by_id_response_200_flow_value_flow_env import (
            GetHubFlowByIdResponse200FlowValueFlowEnv,
        )
        from ..models.get_hub_flow_by_id_response_200_flow_value_modules_item import (
            GetHubFlowByIdResponse200FlowValueModulesItem,
        )
        ...
        flow_env: Union[Unset, GetHubFlowByIdResponse200FlowValueFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = GetHubFlowByIdResponse200FlowValueFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = GetHubFlowByIdResponse200FlowValueNotesItem.from_dict(notes_item_data)
