...
T = TypeVar("T", bound="DeleteCompletedJobResponse200FlowStatusFailureModuleIterator")


@_attrs_define
class DeleteCompletedJobResponse200FlowStatusFailureModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_flow_status_failure_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        delete_completed_job_response_200_flow_status_failure_module_iterator.additional_properties = d
        return delete_completed_job_response_200_flow_status_failure_module_iterator
