...
T = TypeVar("T", bound="GetKafkaTriggerResponse200RetryExponential")


@_attrs_define
class GetKafkaTriggerResponse200RetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_kafka_trigger_response_200_retry_exponential = cls(
            attempts=attempts,
        ...
        get_kafka_trigger_response_200_retry_exponential.additional_properties = d
        return get_kafka_trigger_response_200_retry_exponential
