...
T = TypeVar("T", bound="GetHttpTriggerResponse200RetryConstant")


@_attrs_define
class GetHttpTriggerResponse200RetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_http_trigger_response_200_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_http_trigger_response_200_retry_constant.additional_properties = d
        return get_http_trigger_response_200_retry_constant
