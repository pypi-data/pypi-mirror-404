...
if TYPE_CHECKING:
    from ..models.create_websocket_trigger_json_body_retry_constant import CreateWebsocketTriggerJsonBodyRetryConstant
...
class CreateWebsocketTriggerJsonBodyRetry:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.create_websocket_trigger_json_body_retry_constant import (
            CreateWebsocketTriggerJsonBodyRetryConstant,
        )
        from ..models.create_websocket_trigger_json_body_retry_exponential import (
            CreateWebsocketTriggerJsonBodyRetryExponential,
        )
        ...
        if isinstance(_constant, Unset):
            ...
            constant = CreateWebsocketTriggerJsonBodyRetryConstant.from_dict(_constant)
        ...
        return create_websocket_trigger_json_body_retry
