...
class GetSuspendedJobFlowResponse200JobType0RawFlowFailureModule:
    ...
    Attributes:
        ...
        sleep (Union['GetSuspendedJobFlowResponse200JobType0RawFlowFailureModuleSleepType0',
            'GetSuspendedJobFlowResponse200JobType0RawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a
        ...
        timeout (Union['GetSuspendedJobFlowResponse200JobType0RawFlowFailureModuleTimeoutType0',
            'GetSuspendedJobFlowResponse200JobType0RawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a
            step. Can be a static value or a JavaScript expression that references previous results or flow inputs
