...
from ..models.import_completed_jobs_json_body_item_job_kind import ImportCompletedJobsJsonBodyItemJobKind
from ..models.import_completed_jobs_json_body_item_language import ImportCompletedJobsJsonBodyItemLanguage
from ..models.import_completed_jobs_json_body_item_trigger_kind import ImportCompletedJobsJsonBodyItemTriggerKind
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.import_completed_jobs_json_body_item_args import ImportCompletedJobsJsonBodyItemArgs
    from ..models.import_completed_jobs_json_body_item_flow_status import ImportCompletedJobsJsonBodyItemFlowStatus
    from ..models.import_completed_jobs_json_body_item_raw_flow import ImportCompletedJobsJsonBodyItemRawFlow
    from ..models.import_completed_jobs_json_body_item_result import ImportCompletedJobsJsonBodyItemResult
    from ..models.import_completed_jobs_json_body_item_workflow_as_code_status import (
        ImportCompletedJobsJsonBodyItemWorkflowAsCodeStatus,
    )


T = TypeVar("T", bound="ImportCompletedJobsJsonBodyItem")


@_attrs_define
class ImportCompletedJobsJsonBodyItem:
    ...
    Attributes:
        ...
        job_kind (ImportCompletedJobsJsonBodyItemJobKind):
        permissioned_as (str):
        email (str):
        ...
        args (Union[Unset, ImportCompletedJobsJsonBodyItemArgs]): Full job arguments without size restrictions
        result (Union[Unset, ImportCompletedJobsJsonBodyItemResult]): Full job result without size restrictions
        ...
        trigger_kind (Union[Unset, ImportCompletedJobsJsonBodyItemTriggerKind]):
        permissioned_as_email (Union[Unset, str]):
        flow_status (Union[Unset, ImportCompletedJobsJsonBodyItemFlowStatus]): Flow status from v2_job_status table
        workflow_as_code_status (Union[Unset, ImportCompletedJobsJsonBodyItemWorkflowAsCodeStatus]):
        raw_flow (Union[Unset, ImportCompletedJobsJsonBodyItemRawFlow]):
        is_flow_step (Union[Unset, bool]):
        language (Union[Unset, ImportCompletedJobsJsonBodyItemLanguage]):
    ...
    args: Union[Unset, "ImportCompletedJobsJsonBodyItemArgs"] = UNSET
    result: Union[Unset, "ImportCompletedJobsJsonBodyItemResult"] = UNSET
    ...
    trigger_kind: Union[Unset, ImportCompletedJobsJsonBodyItemTriggerKind] = UNSET
    permissioned_as_email: Union[Unset, str] = UNSET
    flow_status: Union[Unset, "ImportCompletedJobsJsonBodyItemFlowStatus"] = UNSET
    workflow_as_code_status: Union[Unset, "ImportCompletedJobsJsonBodyItemWorkflowAsCodeStatus"] = UNSET
    raw_flow: Union[Unset, "ImportCompletedJobsJsonBodyItemRawFlow"] = UNSET
    is_flow_step: Union[Unset, bool] = UNSET
    language: Union[Unset, ImportCompletedJobsJsonBodyItemLanguage] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_kind = ImportCompletedJobsJsonBodyItemJobKind(d.pop("job_kind"))
        ...
        args: Union[Unset, ImportCompletedJobsJsonBodyItemArgs]
        if isinstance(_args, Unset):
            args = UNSET
        else:
            args = ImportCompletedJobsJsonBodyItemArgs.from_dict(_args)

        _result = d.pop("result", UNSET)
        result: Union[Unset, ImportCompletedJobsJsonBodyItemResult]
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = ImportCompletedJobsJsonBodyItemResult.from_dict(_result)
        ...
        if isinstance(_trigger_kind, Unset):
            ...
            trigger_kind = ImportCompletedJobsJsonBodyItemTriggerKind(_trigger_kind)

        permissioned_as_email = d.pop("permissioned_as_email", UNSET)

        _flow_status = d.pop("flow_status", UNSET)
        flow_status: Union[Unset, ImportCompletedJobsJsonBodyItemFlowStatus]
        if isinstance(_flow_status, Unset):
            flow_status = UNSET
        else:
            flow_status = ImportCompletedJobsJsonBodyItemFlowStatus.from_dict(_flow_status)
        ...
        if isinstance(_workflow_as_code_status, Unset):
            ...
            workflow_as_code_status = ImportCompletedJobsJsonBodyItemWorkflowAsCodeStatus.from_dict(
        ...
        if isinstance(_raw_flow, Unset):
            ...
            raw_flow = ImportCompletedJobsJsonBodyItemRawFlow.from_dict(_raw_flow)
        ...
        if isinstance(_language, Unset):
            ...
            language = ImportCompletedJobsJsonBodyItemLanguage(_language)
        ...
        import_completed_jobs_json_body_item = cls(
            id=id,
            created_by=created_by,
            created_at=created_at,
            job_kind=job_kind,
        ...
        import_completed_jobs_json_body_item.additional_properties = d
        return import_completed_jobs_json_body_item
