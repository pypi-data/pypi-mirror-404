...
T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemRetryExponential")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType0RawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_suspended_job_flow_response_200_job_type_0_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        get_suspended_job_flow_response_200_job_type_0_raw_flow_modules_item_retry_exponential.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_0_raw_flow_modules_item_retry_exponential
