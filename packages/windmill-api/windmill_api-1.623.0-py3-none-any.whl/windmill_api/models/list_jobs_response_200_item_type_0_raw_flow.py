...
if TYPE_CHECKING:
    ...
    from ..models.list_jobs_response_200_item_type_0_raw_flow_flow_env import ListJobsResponse200ItemType0RawFlowFlowEnv
    ...
    from ..models.list_jobs_response_200_item_type_0_raw_flow_notes_item import (
        ListJobsResponse200ItemType0RawFlowNotesItem,
    )
...
class ListJobsResponse200ItemType0RawFlow:
    ...
    Attributes:
        modules (List['ListJobsResponse200ItemType0RawFlowModulesItem']): Array of steps that execute in sequence. Each
            step can be a script, subflow, loop, or branch
        failure_module (Union[Unset, ListJobsResponse200ItemType0RawFlowFailureModule]): A single step in a flow. Can be
            a script, subflow, loop, or branch
        preprocessor_module (Union[Unset, ListJobsResponse200ItemType0RawFlowPreprocessorModule]): A single step in a
        ...
        flow_env (Union[Unset, ListJobsResponse200ItemType0RawFlowFlowEnv]): Environment variables available to all
            steps
        ...
        notes (Union[Unset, List['ListJobsResponse200ItemType0RawFlowNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "ListJobsResponse200ItemType0RawFlowFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["ListJobsResponse200ItemType0RawFlowNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.list_jobs_response_200_item_type_0_raw_flow_flow_env import (
            ListJobsResponse200ItemType0RawFlowFlowEnv,
        )
        from ..models.list_jobs_response_200_item_type_0_raw_flow_modules_item import (
            ListJobsResponse200ItemType0RawFlowModulesItem,
        )
        ...
        flow_env: Union[Unset, ListJobsResponse200ItemType0RawFlowFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = ListJobsResponse200ItemType0RawFlowFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = ListJobsResponse200ItemType0RawFlowNotesItem.from_dict(notes_item_data)
