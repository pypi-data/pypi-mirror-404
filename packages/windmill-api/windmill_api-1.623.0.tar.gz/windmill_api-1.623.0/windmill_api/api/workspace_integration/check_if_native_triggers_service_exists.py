...
from ...models.check_if_native_triggers_service_exists_service_name import CheckIfNativeTriggersServiceExistsServiceName
from ...types import Response


def _get_kwargs(
    workspace: str,
    service_name: CheckIfNativeTriggersServiceExistsServiceName,
) -> Dict[str, Any]:
    pass

    return {
        "method": "get",
        "url": "/w/{workspace}/native_triggers/integrations/{service_name}/exists".format(
            workspace=workspace,
