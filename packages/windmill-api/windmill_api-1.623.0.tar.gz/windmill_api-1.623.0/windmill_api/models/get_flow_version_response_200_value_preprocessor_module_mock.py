...
T = TypeVar("T", bound="GetFlowVersionResponse200ValuePreprocessorModuleMock")
...
class GetFlowVersionResponse200ValuePreprocessorModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_version_response_200_value_preprocessor_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        get_flow_version_response_200_value_preprocessor_module_mock.additional_properties = d
        return get_flow_version_response_200_value_preprocessor_module_mock
