...
class ForloopFlowModulesItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ForloopFlowModulesItemStopAfterIf]): Early termination condition for a module
        stop_after_all_iters_if (Union[Unset, ForloopFlowModulesItemStopAfterAllItersIf]): Early termination condition
            for a module
        skip_if (Union[Unset, ForloopFlowModulesItemSkipIf]): Conditionally skip this step based on previous results or
            flow inputs
        sleep (Union['ForloopFlowModulesItemSleepType0', 'ForloopFlowModulesItemSleepType1', Unset]): Maps input
        ...
        timeout (Union['ForloopFlowModulesItemTimeoutType0', 'ForloopFlowModulesItemTimeoutType1', Unset]): Maps input
            parameters for a step. Can be a static value or a JavaScript expression that references previous results or flow
            inputs
        ...
        mock (Union[Unset, ForloopFlowModulesItemMock]): Mock configuration for testing without executing the actual
            step
        suspend (Union[Unset, ForloopFlowModulesItemSuspend]): Configuration for approval/resume steps that wait for
            user input
        ...
        retry (Union[Unset, ForloopFlowModulesItemRetry]): Retry configuration for failed module executions
    """
