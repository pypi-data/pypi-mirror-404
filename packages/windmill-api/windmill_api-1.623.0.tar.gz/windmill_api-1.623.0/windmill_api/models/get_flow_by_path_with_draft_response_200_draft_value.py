...
if TYPE_CHECKING:
    ...
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_flow_env import (
        GetFlowByPathWithDraftResponse200DraftValueFlowEnv,
    )
    ...
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_notes_item import (
        GetFlowByPathWithDraftResponse200DraftValueNotesItem,
    )
...
class GetFlowByPathWithDraftResponse200DraftValue:
    ...
    Attributes:
        modules (List['GetFlowByPathWithDraftResponse200DraftValueModulesItem']): Array of steps that execute in
            sequence. Each step can be a script, subflow, loop, or branch
        failure_module (Union[Unset, GetFlowByPathWithDraftResponse200DraftValueFailureModule]): A single step in a
            flow. Can be a script, subflow, loop, or branch
        preprocessor_module (Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModule]): A single step
        ...
        flow_env (Union[Unset, GetFlowByPathWithDraftResponse200DraftValueFlowEnv]): Environment variables available to
            all steps
        ...
        notes (Union[Unset, List['GetFlowByPathWithDraftResponse200DraftValueNotesItem']]): Sticky notes attached to the
            flow
    """
    ...
    flow_env: Union[Unset, "GetFlowByPathWithDraftResponse200DraftValueFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["GetFlowByPathWithDraftResponse200DraftValueNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, GetFlowByPathWithDraftResponse200DraftValueFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = GetFlowByPathWithDraftResponse200DraftValueFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = GetFlowByPathWithDraftResponse200DraftValueNotesItem.from_dict(notes_item_data)
