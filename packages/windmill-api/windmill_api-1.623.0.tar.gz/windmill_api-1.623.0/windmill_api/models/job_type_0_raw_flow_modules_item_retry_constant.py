...
T = TypeVar("T", bound="JobType0RawFlowModulesItemRetryConstant")


@_attrs_define
class JobType0RawFlowModulesItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_0_raw_flow_modules_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        job_type_0_raw_flow_modules_item_retry_constant.additional_properties = d
        return job_type_0_raw_flow_modules_item_retry_constant
