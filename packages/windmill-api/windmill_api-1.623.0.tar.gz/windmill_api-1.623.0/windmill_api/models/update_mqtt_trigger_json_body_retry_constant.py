...
T = TypeVar("T", bound="UpdateMqttTriggerJsonBodyRetryConstant")


@_attrs_define
class UpdateMqttTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_mqtt_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        update_mqtt_trigger_json_body_retry_constant.additional_properties = d
        return update_mqtt_trigger_json_body_retry_constant
