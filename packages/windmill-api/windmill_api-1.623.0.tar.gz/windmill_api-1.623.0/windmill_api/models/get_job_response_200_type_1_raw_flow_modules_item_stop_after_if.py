...
T = TypeVar("T", bound="GetJobResponse200Type1RawFlowModulesItemStopAfterIf")


@_attrs_define
class GetJobResponse200Type1RawFlowModulesItemStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_1_raw_flow_modules_item_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        get_job_response_200_type_1_raw_flow_modules_item_stop_after_if.additional_properties = d
        return get_job_response_200_type_1_raw_flow_modules_item_stop_after_if
