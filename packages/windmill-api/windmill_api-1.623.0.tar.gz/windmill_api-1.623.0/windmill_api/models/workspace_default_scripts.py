...
T = TypeVar("T", bound="WorkspaceDefaultScripts")


@_attrs_define
class WorkspaceDefaultScripts:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workspace_default_scripts = cls(
            order=order,
            hidden=hidden,
            default_script_content=default_script_content,
        )

        workspace_default_scripts.additional_properties = d
        return workspace_default_scripts
