...
T = TypeVar("T", bound="FlowModuleValue2Type4ModulesItemStopAfterAllItersIf")


@_attrs_define
class FlowModuleValue2Type4ModulesItemStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_4_modules_item_stop_after_all_iters_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        flow_module_value_2_type_4_modules_item_stop_after_all_iters_if.additional_properties = d
        return flow_module_value_2_type_4_modules_item_stop_after_all_iters_if
