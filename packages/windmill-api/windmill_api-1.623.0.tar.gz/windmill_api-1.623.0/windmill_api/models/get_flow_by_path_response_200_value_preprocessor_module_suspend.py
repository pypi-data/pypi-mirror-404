...
if TYPE_CHECKING:
    from ..models.get_flow_by_path_response_200_value_preprocessor_module_suspend_resume_form import (
        GetFlowByPathResponse200ValuePreprocessorModuleSuspendResumeForm,
    )
    from ..models.get_flow_by_path_response_200_value_preprocessor_module_suspend_user_groups_required_type_0 import (
        GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.get_flow_by_path_response_200_value_preprocessor_module_suspend_user_groups_required_type_1 import (
        GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="GetFlowByPathResponse200ValuePreprocessorModuleSuspend")


@_attrs_define
class GetFlowByPathResponse200ValuePreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetFlowByPathResponse200ValuePreprocessorModuleSuspendResumeForm]): Form schema for
            collecting input when resuming
        user_auth_required (Union[Unset, bool]): If true, only authenticated users can approve
        user_groups_required (Union['GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType0',
            'GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters
    ...
    resume_form: Union[Unset, "GetFlowByPathResponse200ValuePreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, GetFlowByPathResponse200ValuePreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = GetFlowByPathResponse200ValuePreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetFlowByPathResponse200ValuePreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        get_flow_by_path_response_200_value_preprocessor_module_suspend = cls(
        ...
        get_flow_by_path_response_200_value_preprocessor_module_suspend.additional_properties = d
        return get_flow_by_path_response_200_value_preprocessor_module_suspend
