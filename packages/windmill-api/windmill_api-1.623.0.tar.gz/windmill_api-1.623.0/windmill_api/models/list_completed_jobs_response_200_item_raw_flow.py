...
if TYPE_CHECKING:
    ...
    from ..models.list_completed_jobs_response_200_item_raw_flow_flow_env import (
        ListCompletedJobsResponse200ItemRawFlowFlowEnv,
    )
    ...
    from ..models.list_completed_jobs_response_200_item_raw_flow_notes_item import (
        ListCompletedJobsResponse200ItemRawFlowNotesItem,
    )
...
class ListCompletedJobsResponse200ItemRawFlow:
    ...
    Attributes:
        modules (List['ListCompletedJobsResponse200ItemRawFlowModulesItem']): Array of steps that execute in sequence.
            Each step can be a script, subflow, loop, or branch
        failure_module (Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModule]): A single step in a flow.
            Can be a script, subflow, loop, or branch
        preprocessor_module (Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModule]): A single step in
        ...
        flow_env (Union[Unset, ListCompletedJobsResponse200ItemRawFlowFlowEnv]): Environment variables available to all
            steps
        ...
        notes (Union[Unset, List['ListCompletedJobsResponse200ItemRawFlowNotesItem']]): Sticky notes attached to the
            flow
    """
    ...
    flow_env: Union[Unset, "ListCompletedJobsResponse200ItemRawFlowFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["ListCompletedJobsResponse200ItemRawFlowNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, ListCompletedJobsResponse200ItemRawFlowFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = ListCompletedJobsResponse200ItemRawFlowFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = ListCompletedJobsResponse200ItemRawFlowNotesItem.from_dict(notes_item_data)
