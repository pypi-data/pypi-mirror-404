...
T = TypeVar("T", bound="JobType1RawFlowFailureModuleRetryConstant")


@_attrs_define
class JobType1RawFlowFailureModuleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_1_raw_flow_failure_module_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        job_type_1_raw_flow_failure_module_retry_constant.additional_properties = d
        return job_type_1_raw_flow_failure_module_retry_constant
