...
T = TypeVar("T", bound="OpenFlowWPathValuePreprocessorModuleRetryExponential")


@_attrs_define
class OpenFlowWPathValuePreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_w_path_value_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        open_flow_w_path_value_preprocessor_module_retry_exponential.additional_properties = d
        return open_flow_w_path_value_preprocessor_module_retry_exponential
