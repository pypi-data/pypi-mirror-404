...
T = TypeVar("T", bound="DeleteCompletedJobResponse200RawFlowPreprocessorModuleStopAfterIf")


@_attrs_define
class DeleteCompletedJobResponse200RawFlowPreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_raw_flow_preprocessor_module_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        delete_completed_job_response_200_raw_flow_preprocessor_module_stop_after_if.additional_properties = d
        return delete_completed_job_response_200_raw_flow_preprocessor_module_stop_after_if
