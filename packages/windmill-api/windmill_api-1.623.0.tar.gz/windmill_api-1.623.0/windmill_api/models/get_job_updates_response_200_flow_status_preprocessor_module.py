...
if TYPE_CHECKING:
    from ..models.get_job_updates_response_200_flow_status_preprocessor_module_agent_actions_item_type_0 import (
        GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType0,
    )
    from ..models.get_job_updates_response_200_flow_status_preprocessor_module_agent_actions_item_type_1 import (
        GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType1,
    )
    from ..models.get_job_updates_response_200_flow_status_preprocessor_module_agent_actions_item_type_2 import (
        GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType2,
    )
    from ..models.get_job_updates_response_200_flow_status_preprocessor_module_agent_actions_item_type_3 import (
        GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType3,
    )
...
class GetJobUpdatesResponse200FlowStatusPreprocessorModule:
    ...
    Attributes:
        ...
        agent_actions (Union[Unset,
            List[Union['GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType0',
            'GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType1',
            'GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType2',
            'GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType3']]]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    agent_actions_item_data, GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType0
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    GetJobUpdatesResponse200FlowStatusPreprocessorModuleAgentActionsItemType3.from_dict(data)
                )
