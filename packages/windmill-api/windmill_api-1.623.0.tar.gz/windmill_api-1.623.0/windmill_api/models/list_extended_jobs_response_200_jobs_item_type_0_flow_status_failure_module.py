...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_failure_module_agent_actions_item_type_0 import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType0,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_failure_module_agent_actions_item_type_1 import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType1,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_failure_module_agent_actions_item_type_2 import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType2,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_failure_module_agent_actions_item_type_3 import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType3,
    )
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_flow_status_failure_module_flow_jobs_duration import (
        ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleFlowJobsDuration,
    )
...
class ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModule:
    ...
    Attributes:
        ...
        agent_actions (Union[Unset,
            List[Union['ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType0',
            'ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType1',
            'ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType2',
            'ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType3']]]):
    ...
    flow_jobs_duration: Union[
        Unset, "ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleFlowJobsDuration"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_flow_jobs_duration, Unset):
            ...
            flow_jobs_duration = (
                ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleFlowJobsDuration.from_dict(
                    _flow_jobs_duration
                )
            )
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType0.from_dict(
                            data
                        )
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType1.from_dict(
                            data
                        )
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType2.from_dict(
                            data
                        )
                    )
                ...
                agent_actions_item_type_3 = (
                    ListExtendedJobsResponse200JobsItemType0FlowStatusFailureModuleAgentActionsItemType3.from_dict(data)
                )
