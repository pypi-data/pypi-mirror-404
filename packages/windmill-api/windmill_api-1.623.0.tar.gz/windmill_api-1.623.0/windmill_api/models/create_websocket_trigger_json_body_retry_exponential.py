...
T = TypeVar("T", bound="CreateWebsocketTriggerJsonBodyRetryExponential")


@_attrs_define
class CreateWebsocketTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_websocket_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        create_websocket_trigger_json_body_retry_exponential.additional_properties = d
        return create_websocket_trigger_json_body_retry_exponential
