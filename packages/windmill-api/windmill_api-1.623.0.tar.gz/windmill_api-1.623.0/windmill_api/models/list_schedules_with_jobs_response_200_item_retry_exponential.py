...
T = TypeVar("T", bound="ListSchedulesWithJobsResponse200ItemRetryExponential")


@_attrs_define
class ListSchedulesWithJobsResponse200ItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_schedules_with_jobs_response_200_item_retry_exponential = cls(
            attempts=attempts,
