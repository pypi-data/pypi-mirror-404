...
if TYPE_CHECKING:
    ...
    from ..models.new_nats_trigger_retry_retry_if import NewNatsTriggerRetryRetryIf
...
class NewNatsTriggerRetry:
    ...
    retry_if: Union[Unset, "NewNatsTriggerRetryRetryIf"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_retry_if, Unset):
            ...
            retry_if = NewNatsTriggerRetryRetryIf.from_dict(_retry_if)
