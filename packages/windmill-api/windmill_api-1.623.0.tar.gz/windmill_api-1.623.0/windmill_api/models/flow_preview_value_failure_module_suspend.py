...
class FlowPreviewValueFailureModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, FlowPreviewValueFailureModuleSuspendResumeForm]): Form schema for collecting input
            when resuming
        ...
        user_groups_required (Union['FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType0',
            'FlowPreviewValueFailureModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a step. Can be
