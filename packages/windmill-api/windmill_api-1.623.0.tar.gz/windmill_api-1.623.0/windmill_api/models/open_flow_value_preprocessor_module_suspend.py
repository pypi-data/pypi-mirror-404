...
if TYPE_CHECKING:
    from ..models.open_flow_value_preprocessor_module_suspend_resume_form import (
        OpenFlowValuePreprocessorModuleSuspendResumeForm,
    )
    from ..models.open_flow_value_preprocessor_module_suspend_user_groups_required_type_0 import (
        OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.open_flow_value_preprocessor_module_suspend_user_groups_required_type_1 import (
        OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="OpenFlowValuePreprocessorModuleSuspend")


@_attrs_define
class OpenFlowValuePreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, OpenFlowValuePreprocessorModuleSuspendResumeForm]): Form schema for collecting input
            when resuming
        user_auth_required (Union[Unset, bool]): If true, only authenticated users can approve
        user_groups_required (Union['OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType0',
            'OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a step. Can
    ...
    resume_form: Union[Unset, "OpenFlowValuePreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, OpenFlowValuePreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = OpenFlowValuePreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = OpenFlowValuePreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        open_flow_value_preprocessor_module_suspend = cls(
        ...
        open_flow_value_preprocessor_module_suspend.additional_properties = d
        return open_flow_value_preprocessor_module_suspend
