...
T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemIterator")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_iterator.additional_properties = d
        return get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_iterator
