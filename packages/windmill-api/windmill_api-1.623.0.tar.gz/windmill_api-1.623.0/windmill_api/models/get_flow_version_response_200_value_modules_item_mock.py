...
T = TypeVar("T", bound="GetFlowVersionResponse200ValueModulesItemMock")


@_attrs_define
class GetFlowVersionResponse200ValueModulesItemMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_version_response_200_value_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        get_flow_version_response_200_value_modules_item_mock.additional_properties = d
        return get_flow_version_response_200_value_modules_item_mock
