...
T = TypeVar("T", bound="NewWebsocketTriggerRetryExponential")


@_attrs_define
class NewWebsocketTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_websocket_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        new_websocket_trigger_retry_exponential.additional_properties = d
        return new_websocket_trigger_retry_exponential
