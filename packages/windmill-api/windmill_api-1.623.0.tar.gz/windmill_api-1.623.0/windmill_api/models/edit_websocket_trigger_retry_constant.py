...
T = TypeVar("T", bound="EditWebsocketTriggerRetryConstant")


@_attrs_define
class EditWebsocketTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_websocket_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        edit_websocket_trigger_retry_constant.additional_properties = d
        return edit_websocket_trigger_retry_constant
