...
T = TypeVar("T", bound="FlowModuleValue2Type6BranchesItemModulesItemStopAfterIf")


@_attrs_define
class FlowModuleValue2Type6BranchesItemModulesItemStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_6_branches_item_modules_item_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        flow_module_value_2_type_6_branches_item_modules_item_stop_after_if.additional_properties = d
        return flow_module_value_2_type_6_branches_item_modules_item_stop_after_if
