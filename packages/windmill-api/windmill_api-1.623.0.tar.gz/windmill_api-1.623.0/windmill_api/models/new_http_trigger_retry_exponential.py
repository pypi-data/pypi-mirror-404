...
T = TypeVar("T", bound="NewHttpTriggerRetryExponential")


@_attrs_define
class NewHttpTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_http_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        new_http_trigger_retry_exponential.additional_properties = d
        return new_http_trigger_retry_exponential
