...
T = TypeVar("T", bound="HttpTriggerRetryConstant")


@_attrs_define
class HttpTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        http_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        http_trigger_retry_constant.additional_properties = d
        return http_trigger_retry_constant
