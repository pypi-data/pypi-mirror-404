...
T = TypeVar("T", bound="RunFlowPreviewJsonBodyValuePreprocessorModuleStopAfterIf")


@_attrs_define
class RunFlowPreviewJsonBodyValuePreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return run_flow_preview_json_body_value_preprocessor_module_stop_after_if
