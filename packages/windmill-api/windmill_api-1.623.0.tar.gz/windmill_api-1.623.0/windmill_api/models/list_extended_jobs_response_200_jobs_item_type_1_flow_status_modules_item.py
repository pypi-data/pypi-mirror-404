...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_modules_item_agent_actions_item_type_0 import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType0,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_modules_item_agent_actions_item_type_1 import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType1,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_modules_item_agent_actions_item_type_2 import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType2,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_modules_item_agent_actions_item_type_3 import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType3,
    )
...
class ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItem:
    ...
    Attributes:
        ...
        agent_actions (Union[Unset,
            List[Union['ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType0',
            'ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType1',
            'ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType2',
            'ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType3']]]):
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType0.from_dict(
                            data
                        )
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType1.from_dict(
                            data
                        )
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType2.from_dict(
                            data
                        )
                    )
                ...
                agent_actions_item_type_3 = (
                    ListExtendedJobsResponse200JobsItemType1FlowStatusModulesItemAgentActionsItemType3.from_dict(data)
                )
