...
T = TypeVar("T", bound="QueuedJobFlowStatusModulesItemIterator")


@_attrs_define
class QueuedJobFlowStatusModulesItemIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        queued_job_flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        queued_job_flow_status_modules_item_iterator.additional_properties = d
        return queued_job_flow_status_modules_item_iterator
