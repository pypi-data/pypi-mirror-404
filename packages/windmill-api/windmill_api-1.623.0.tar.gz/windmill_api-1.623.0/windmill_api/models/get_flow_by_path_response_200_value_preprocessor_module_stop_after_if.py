...
T = TypeVar("T", bound="GetFlowByPathResponse200ValuePreprocessorModuleStopAfterIf")


@_attrs_define
class GetFlowByPathResponse200ValuePreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_flow_by_path_response_200_value_preprocessor_module_stop_after_if
