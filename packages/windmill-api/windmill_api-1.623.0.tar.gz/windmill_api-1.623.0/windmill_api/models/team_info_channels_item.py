...
T = TypeVar("T", bound="TeamInfoChannelsItem")


@_attrs_define
class TeamInfoChannelsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        team_info_channels_item.additional_properties = d
        return team_info_channels_item
