...
if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_agent_actions_item_type_0 import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType0,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_agent_actions_item_type_1 import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType1,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_agent_actions_item_type_2 import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType2,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_modules_item_agent_actions_item_type_3 import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType3,
    )
...
class GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItem:
    ...
    Attributes:
        ...
        agent_actions (Union[Unset,
            List[Union['GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType0',
            'GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType1',
            'GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType2',
            'GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType3']]]):
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    GetSuspendedJobFlowResponse200JobType1FlowStatusModulesItemAgentActionsItemType3.from_dict(data)
                )
