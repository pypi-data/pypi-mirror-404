...
T = TypeVar("T", bound="WindmillFileMetadata")


@_attrs_define
class WindmillFileMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        windmill_file_metadata.additional_properties = d
        return windmill_file_metadata
