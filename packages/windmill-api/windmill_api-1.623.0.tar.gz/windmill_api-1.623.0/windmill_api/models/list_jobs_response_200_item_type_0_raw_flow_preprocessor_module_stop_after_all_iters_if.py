...
T = TypeVar("T", bound="ListJobsResponse200ItemType0RawFlowPreprocessorModuleStopAfterAllItersIf")


@_attrs_define
class ListJobsResponse200ItemType0RawFlowPreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return list_jobs_response_200_item_type_0_raw_flow_preprocessor_module_stop_after_all_iters_if
