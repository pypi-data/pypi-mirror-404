...
T = TypeVar("T", bound="UpdateScheduleJsonBodyRetryConstant")
...
class UpdateScheduleJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_schedule_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        update_schedule_json_body_retry_constant.additional_properties = d
        return update_schedule_json_body_retry_constant
