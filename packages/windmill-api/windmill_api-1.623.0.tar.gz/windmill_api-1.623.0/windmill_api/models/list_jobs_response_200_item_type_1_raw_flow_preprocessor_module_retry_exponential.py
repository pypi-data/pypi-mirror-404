...
T = TypeVar("T", bound="ListJobsResponse200ItemType1RawFlowPreprocessorModuleRetryExponential")


@_attrs_define
class ListJobsResponse200ItemType1RawFlowPreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_retry_exponential.additional_properties = d
        return list_jobs_response_200_item_type_1_raw_flow_preprocessor_module_retry_exponential
