...
from ..models.get_settings_response_200_large_file_storage_secondary_storage_additional_property_type import (
    GetSettingsResponse200LargeFileStorageSecondaryStorageAdditionalPropertyType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSettingsResponse200LargeFileStorageSecondaryStorageAdditionalProperty")


@_attrs_define
class GetSettingsResponse200LargeFileStorageSecondaryStorageAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = GetSettingsResponse200LargeFileStorageSecondaryStorageAdditionalPropertyType(_type)
        ...
        get_settings_response_200_large_file_storage_secondary_storage_additional_property.additional_properties = d
        return get_settings_response_200_large_file_storage_secondary_storage_additional_property
