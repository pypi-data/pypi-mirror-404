...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_modules_item_retry_constant import (
        ListExtendedJobsResponse200JobsItemType0RawFlowModulesItemRetryConstant,
    )
...
@_attrs_define
class ListExtendedJobsResponse200JobsItemType0RawFlowModulesItemRetry:
    """Retry configuration for failed module executions

    Attributes:
        constant (Union[Unset, ListExtendedJobsResponse200JobsItemType0RawFlowModulesItemRetryConstant]): Retry with
            constant delay between attempts
        exponential (Union[Unset, ListExtendedJobsResponse200JobsItemType0RawFlowModulesItemRetryExponential]): Retry
            with exponential backoff (delay doubles each time)
        retry_if (Union[Unset, ListExtendedJobsResponse200JobsItemType0RawFlowModulesItemRetryRetryIf]): Conditional
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_constant, Unset):
            ...
            constant = ListExtendedJobsResponse200JobsItemType0RawFlowModulesItemRetryConstant.from_dict(_constant)
        ...
        if isinstance(_exponential, Unset):
            ...
            exponential = ListExtendedJobsResponse200JobsItemType0RawFlowModulesItemRetryExponential.from_dict(
                _exponential
            )
        ...
        return list_extended_jobs_response_200_jobs_item_type_0_raw_flow_modules_item_retry
