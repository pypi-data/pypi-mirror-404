...
if TYPE_CHECKING:
    ...
    from ..models.list_queue_response_200_item_raw_flow_flow_env import ListQueueResponse200ItemRawFlowFlowEnv
    from ..models.list_queue_response_200_item_raw_flow_modules_item import ListQueueResponse200ItemRawFlowModulesItem
    from ..models.list_queue_response_200_item_raw_flow_notes_item import ListQueueResponse200ItemRawFlowNotesItem
...
class ListQueueResponse200ItemRawFlow:
    ...
    Attributes:
        modules (List['ListQueueResponse200ItemRawFlowModulesItem']): Array of steps that execute in sequence. Each step
            can be a script, subflow, loop, or branch
        failure_module (Union[Unset, ListQueueResponse200ItemRawFlowFailureModule]): A single step in a flow. Can be a
            script, subflow, loop, or branch
        preprocessor_module (Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModule]): A single step in a flow.
            Can be a script, subflow, loop, or branch
        ...
        flow_env (Union[Unset, ListQueueResponse200ItemRawFlowFlowEnv]): Environment variables available to all steps
        ...
        notes (Union[Unset, List['ListQueueResponse200ItemRawFlowNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "ListQueueResponse200ItemRawFlowFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["ListQueueResponse200ItemRawFlowNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, ListQueueResponse200ItemRawFlowFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = ListQueueResponse200ItemRawFlowFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = ListQueueResponse200ItemRawFlowNotesItem.from_dict(notes_item_data)
