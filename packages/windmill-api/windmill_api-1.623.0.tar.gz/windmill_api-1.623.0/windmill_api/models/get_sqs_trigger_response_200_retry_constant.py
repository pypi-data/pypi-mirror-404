...
T = TypeVar("T", bound="GetSqsTriggerResponse200RetryConstant")


@_attrs_define
class GetSqsTriggerResponse200RetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_sqs_trigger_response_200_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_sqs_trigger_response_200_retry_constant.additional_properties = d
        return get_sqs_trigger_response_200_retry_constant
