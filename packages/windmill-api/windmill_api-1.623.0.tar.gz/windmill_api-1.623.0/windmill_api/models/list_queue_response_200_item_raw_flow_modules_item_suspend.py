...
class ListQueueResponse200ItemRawFlowModulesItemSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, ListQueueResponse200ItemRawFlowModulesItemSuspendResumeForm]): Form schema for
        ...
        user_groups_required (Union['ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0',
            'ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a
