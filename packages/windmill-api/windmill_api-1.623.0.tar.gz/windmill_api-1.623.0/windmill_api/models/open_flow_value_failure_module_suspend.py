...
class OpenFlowValueFailureModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, OpenFlowValueFailureModuleSuspendResumeForm]): Form schema for collecting input when
            resuming
        ...
        user_groups_required (Union['OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0',
            'OpenFlowValueFailureModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a step. Can be a
