...
from ..models.raw_script_assets_item_access_type import RawScriptAssetsItemAccessType
from ..models.raw_script_assets_item_alt_access_type import RawScriptAssetsItemAltAccessType
from ..models.raw_script_assets_item_kind import RawScriptAssetsItemKind
from ..types import UNSET, Unset

T = TypeVar("T", bound="RawScriptAssetsItem")
...
class RawScriptAssetsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        raw_script_assets_item.additional_properties = d
        return raw_script_assets_item
