...
T = TypeVar("T", bound="GcpTriggerRetryConstant")


@_attrs_define
class GcpTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        gcp_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        gcp_trigger_retry_constant.additional_properties = d
        return gcp_trigger_retry_constant
