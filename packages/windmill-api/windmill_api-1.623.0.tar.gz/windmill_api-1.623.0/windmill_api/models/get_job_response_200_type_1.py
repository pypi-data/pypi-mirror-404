...
class GetJobResponse200Type1:
    ...
    Attributes:
        ...
        args (Union[Unset, GetJobResponse200Type1Args]): The arguments to pass to the script or flow
        ...
        raw_flow (Union[Unset, GetJobResponse200Type1RawFlow]): The flow structure containing modules and optional
