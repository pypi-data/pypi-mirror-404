...
T = TypeVar("T", bound="ListMqttTriggersResponse200ItemRetryConstant")


@_attrs_define
class ListMqttTriggersResponse200ItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_mqtt_triggers_response_200_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        list_mqtt_triggers_response_200_item_retry_constant.additional_properties = d
        return list_mqtt_triggers_response_200_item_retry_constant
