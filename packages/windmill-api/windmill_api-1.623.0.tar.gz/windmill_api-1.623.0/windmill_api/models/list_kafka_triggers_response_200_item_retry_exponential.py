...
T = TypeVar("T", bound="ListKafkaTriggersResponse200ItemRetryExponential")


@_attrs_define
class ListKafkaTriggersResponse200ItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_kafka_triggers_response_200_item_retry_exponential = cls(
            attempts=attempts,
        ...
        list_kafka_triggers_response_200_item_retry_exponential.additional_properties = d
        return list_kafka_triggers_response_200_item_retry_exponential
