...
T = TypeVar("T", bound="DeleteCompletedJobResponse200FlowStatusModulesItemIterator")


@_attrs_define
class DeleteCompletedJobResponse200FlowStatusModulesItemIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        delete_completed_job_response_200_flow_status_modules_item_iterator.additional_properties = d
        return delete_completed_job_response_200_flow_status_modules_item_iterator
