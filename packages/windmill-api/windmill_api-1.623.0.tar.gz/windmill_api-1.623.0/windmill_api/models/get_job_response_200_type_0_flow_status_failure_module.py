...
from ..models.get_job_response_200_type_0_flow_status_failure_module_type import (
    GetJobResponse200Type0FlowStatusFailureModuleType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_job_response_200_type_0_flow_status_failure_module_agent_actions_item_type_0 import (
        GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType0,
    )
    from ..models.get_job_response_200_type_0_flow_status_failure_module_agent_actions_item_type_1 import (
        GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType1,
    )
    from ..models.get_job_response_200_type_0_flow_status_failure_module_agent_actions_item_type_2 import (
        GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType2,
    )
    from ..models.get_job_response_200_type_0_flow_status_failure_module_agent_actions_item_type_3 import (
        GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType3,
    )
    from ..models.get_job_response_200_type_0_flow_status_failure_module_approvers_item import (
        GetJobResponse200Type0FlowStatusFailureModuleApproversItem,
    )
    from ..models.get_job_response_200_type_0_flow_status_failure_module_branch_chosen import (
        GetJobResponse200Type0FlowStatusFailureModuleBranchChosen,
    )
    from ..models.get_job_response_200_type_0_flow_status_failure_module_branchall import (
        GetJobResponse200Type0FlowStatusFailureModuleBranchall,
    )
    from ..models.get_job_response_200_type_0_flow_status_failure_module_flow_jobs_duration import (
        GetJobResponse200Type0FlowStatusFailureModuleFlowJobsDuration,
    )
    from ..models.get_job_response_200_type_0_flow_status_failure_module_iterator import (
        GetJobResponse200Type0FlowStatusFailureModuleIterator,
    )


T = TypeVar("T", bound="GetJobResponse200Type0FlowStatusFailureModule")


@_attrs_define
class GetJobResponse200Type0FlowStatusFailureModule:
    """
    Attributes:
        type (GetJobResponse200Type0FlowStatusFailureModuleType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
        ...
        flow_jobs_duration (Union[Unset, GetJobResponse200Type0FlowStatusFailureModuleFlowJobsDuration]):
        branch_chosen (Union[Unset, GetJobResponse200Type0FlowStatusFailureModuleBranchChosen]):
        ...
        agent_actions (Union[Unset, List[Union['GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType0',
            'GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType1',
            'GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType2',
            'GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType3']]]):
    ...
    flow_jobs_duration: Union[Unset, "GetJobResponse200Type0FlowStatusFailureModuleFlowJobsDuration"] = UNSET
    branch_chosen: Union[Unset, "GetJobResponse200Type0FlowStatusFailureModuleBranchChosen"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    agent_actions_item_data, GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType0
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = GetJobResponse200Type0FlowStatusFailureModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = GetJobResponse200Type0FlowStatusFailureModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_flow_jobs_duration, Unset):
            ...
            flow_jobs_duration = GetJobResponse200Type0FlowStatusFailureModuleFlowJobsDuration.from_dict(
                _flow_jobs_duration
            )
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = GetJobResponse200Type0FlowStatusFailureModuleBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = GetJobResponse200Type0FlowStatusFailureModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = GetJobResponse200Type0FlowStatusFailureModuleApproversItem.from_dict(approvers_item_data)
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    GetJobResponse200Type0FlowStatusFailureModuleAgentActionsItemType3.from_dict(data)
                )
        ...
        get_job_response_200_type_0_flow_status_failure_module.additional_properties = d
        return get_job_response_200_type_0_flow_status_failure_module
