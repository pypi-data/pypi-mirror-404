...
T = TypeVar("T", bound="GetJobResponse200Type0RawFlowFailureModuleRetryExponential")


@_attrs_define
class GetJobResponse200Type0RawFlowFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_0_raw_flow_failure_module_retry_exponential = cls(
            attempts=attempts,
        ...
        get_job_response_200_type_0_raw_flow_failure_module_retry_exponential.additional_properties = d
        return get_job_response_200_type_0_raw_flow_failure_module_retry_exponential
