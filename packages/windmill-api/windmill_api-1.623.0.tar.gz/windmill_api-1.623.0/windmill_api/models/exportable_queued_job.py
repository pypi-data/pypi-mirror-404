...
from ..models.exportable_queued_job_job_kind import ExportableQueuedJobJobKind
from ..models.exportable_queued_job_language import ExportableQueuedJobLanguage
from ..models.exportable_queued_job_trigger_kind import ExportableQueuedJobTriggerKind
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.exportable_queued_job_args import ExportableQueuedJobArgs
    from ..models.exportable_queued_job_flow_status import ExportableQueuedJobFlowStatus
    from ..models.exportable_queued_job_raw_flow import ExportableQueuedJobRawFlow
    from ..models.exportable_queued_job_workflow_as_code_status import ExportableQueuedJobWorkflowAsCodeStatus


T = TypeVar("T", bound="ExportableQueuedJob")


@_attrs_define
class ExportableQueuedJob:
    ...
    Attributes:
        ...
        job_kind (ExportableQueuedJobJobKind):
        permissioned_as (str):
        email (str):
        ...
        args (Union[Unset, ExportableQueuedJobArgs]): Full job arguments without size restrictions
        ...
        trigger_kind (Union[Unset, ExportableQueuedJobTriggerKind]):
        permissioned_as_email (Union[Unset, str]):
        flow_status (Union[Unset, ExportableQueuedJobFlowStatus]): Flow status from v2_job_status table
        workflow_as_code_status (Union[Unset, ExportableQueuedJobWorkflowAsCodeStatus]):
        raw_flow (Union[Unset, ExportableQueuedJobRawFlow]):
        is_flow_step (Union[Unset, bool]):
        language (Union[Unset, ExportableQueuedJobLanguage]):
    ...
    args: Union[Unset, "ExportableQueuedJobArgs"] = UNSET
    ...
    trigger_kind: Union[Unset, ExportableQueuedJobTriggerKind] = UNSET
    permissioned_as_email: Union[Unset, str] = UNSET
    flow_status: Union[Unset, "ExportableQueuedJobFlowStatus"] = UNSET
    workflow_as_code_status: Union[Unset, "ExportableQueuedJobWorkflowAsCodeStatus"] = UNSET
    raw_flow: Union[Unset, "ExportableQueuedJobRawFlow"] = UNSET
    is_flow_step: Union[Unset, bool] = UNSET
    language: Union[Unset, ExportableQueuedJobLanguage] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_kind = ExportableQueuedJobJobKind(d.pop("job_kind"))
        ...
        args: Union[Unset, ExportableQueuedJobArgs]
        if isinstance(_args, Unset):
            args = UNSET
        else:
            args = ExportableQueuedJobArgs.from_dict(_args)
        ...
        if isinstance(_trigger_kind, Unset):
            ...
            trigger_kind = ExportableQueuedJobTriggerKind(_trigger_kind)

        permissioned_as_email = d.pop("permissioned_as_email", UNSET)

        _flow_status = d.pop("flow_status", UNSET)
        flow_status: Union[Unset, ExportableQueuedJobFlowStatus]
        if isinstance(_flow_status, Unset):
            flow_status = UNSET
        else:
            flow_status = ExportableQueuedJobFlowStatus.from_dict(_flow_status)
        ...
        if isinstance(_workflow_as_code_status, Unset):
            ...
            workflow_as_code_status = ExportableQueuedJobWorkflowAsCodeStatus.from_dict(_workflow_as_code_status)
        ...
        if isinstance(_raw_flow, Unset):
            ...
            raw_flow = ExportableQueuedJobRawFlow.from_dict(_raw_flow)
        ...
        if isinstance(_language, Unset):
            ...
            language = ExportableQueuedJobLanguage(_language)
        ...
        exportable_queued_job.additional_properties = d
        return exportable_queued_job
