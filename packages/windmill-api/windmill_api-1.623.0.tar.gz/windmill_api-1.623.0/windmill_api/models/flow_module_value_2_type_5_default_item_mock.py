...
T = TypeVar("T", bound="FlowModuleValue2Type5DefaultItemMock")


@_attrs_define
class FlowModuleValue2Type5DefaultItemMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_module_value_2_type_5_default_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        flow_module_value_2_type_5_default_item_mock.additional_properties = d
        return flow_module_value_2_type_5_default_item_mock
