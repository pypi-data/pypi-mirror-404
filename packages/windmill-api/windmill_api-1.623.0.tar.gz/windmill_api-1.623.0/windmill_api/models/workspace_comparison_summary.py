...
T = TypeVar("T", bound="WorkspaceComparisonSummary")


@_attrs_define
class WorkspaceComparisonSummary:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workspace_comparison_summary.additional_properties = d
        return workspace_comparison_summary
