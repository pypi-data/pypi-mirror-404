...
T = TypeVar("T", bound="CompletedJobRawFlowPreprocessorModuleStopAfterIf")


@_attrs_define
class CompletedJobRawFlowPreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return completed_job_raw_flow_preprocessor_module_stop_after_if
