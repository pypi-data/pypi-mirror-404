...
class ListQueueResponse200ItemRawFlowFailureModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, ListQueueResponse200ItemRawFlowFailureModuleSuspendResumeForm]): Form schema for
        ...
        user_groups_required (Union['ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for
