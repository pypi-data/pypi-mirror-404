...
from ..models.open_flow_value_failure_module_sleep_type_1_type import OpenFlowValueFailureModuleSleepType1Type

T = TypeVar("T", bound="OpenFlowValueFailureModuleSleepType1")


@_attrs_define
class OpenFlowValueFailureModuleSleepType1:
    ...
    via 'flow_input.property'. Inside loops, use 'flow_input.iter.value' for the current iteration value
        ...
        Attributes:
            ...
            type (OpenFlowValueFailureModuleSleepType1Type):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = OpenFlowValueFailureModuleSleepType1Type(d.pop("type"))

        open_flow_value_failure_module_sleep_type_1 = cls(
            expr=expr,
            type=type,
        )

        open_flow_value_failure_module_sleep_type_1.additional_properties = d
