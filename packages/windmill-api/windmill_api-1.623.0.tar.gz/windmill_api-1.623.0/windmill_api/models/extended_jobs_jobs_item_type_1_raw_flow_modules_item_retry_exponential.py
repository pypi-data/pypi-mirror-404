...
T = TypeVar("T", bound="ExtendedJobsJobsItemType1RawFlowModulesItemRetryExponential")


@_attrs_define
class ExtendedJobsJobsItemType1RawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_1_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        extended_jobs_jobs_item_type_1_raw_flow_modules_item_retry_exponential.additional_properties = d
        return extended_jobs_jobs_item_type_1_raw_flow_modules_item_retry_exponential
