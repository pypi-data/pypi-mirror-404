...
class ListCompletedJobsResponse200ItemRawFlowModulesItem:
    ...
    Attributes:
        ...
        sleep (Union['ListCompletedJobsResponse200ItemRawFlowModulesItemSleepType0',
            'ListCompletedJobsResponse200ItemRawFlowModulesItemSleepType1', Unset]): Maps input parameters for a step. Can
        ...
        timeout (Union['ListCompletedJobsResponse200ItemRawFlowModulesItemTimeoutType0',
            'ListCompletedJobsResponse200ItemRawFlowModulesItemTimeoutType1', Unset]): Maps input parameters for a step. Can
            be a static value or a JavaScript expression that references previous results or flow inputs
