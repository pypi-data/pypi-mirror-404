...
T = TypeVar("T", bound="OpenFlowValuePreprocessorModuleRetryExponential")


@_attrs_define
class OpenFlowValuePreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_value_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        open_flow_value_preprocessor_module_retry_exponential.additional_properties = d
        return open_flow_value_preprocessor_module_retry_exponential
