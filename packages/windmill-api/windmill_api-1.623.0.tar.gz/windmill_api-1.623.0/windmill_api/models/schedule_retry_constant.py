...
T = TypeVar("T", bound="ScheduleRetryConstant")


@_attrs_define
class ScheduleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schedule_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        schedule_retry_constant.additional_properties = d
        return schedule_retry_constant
