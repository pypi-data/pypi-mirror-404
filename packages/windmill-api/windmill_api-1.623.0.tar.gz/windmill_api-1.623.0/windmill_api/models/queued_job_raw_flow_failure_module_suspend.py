...
class QueuedJobRawFlowFailureModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, QueuedJobRawFlowFailureModuleSuspendResumeForm]): Form schema for collecting input
            when resuming
        ...
        user_groups_required (Union['QueuedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0',
            'QueuedJobRawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a step. Can be
