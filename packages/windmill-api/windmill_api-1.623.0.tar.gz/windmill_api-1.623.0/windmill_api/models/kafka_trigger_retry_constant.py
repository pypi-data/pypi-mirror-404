...
T = TypeVar("T", bound="KafkaTriggerRetryConstant")


@_attrs_define
class KafkaTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        kafka_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        kafka_trigger_retry_constant.additional_properties = d
        return kafka_trigger_retry_constant
