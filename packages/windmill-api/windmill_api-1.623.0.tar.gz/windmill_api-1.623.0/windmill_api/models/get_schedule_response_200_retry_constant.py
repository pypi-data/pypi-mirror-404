...
T = TypeVar("T", bound="GetScheduleResponse200RetryConstant")


@_attrs_define
class GetScheduleResponse200RetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_schedule_response_200_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_schedule_response_200_retry_constant.additional_properties = d
        return get_schedule_response_200_retry_constant
