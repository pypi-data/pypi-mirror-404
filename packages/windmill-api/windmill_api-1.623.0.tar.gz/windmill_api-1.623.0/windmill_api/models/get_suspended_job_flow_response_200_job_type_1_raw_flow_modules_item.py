...
class GetSuspendedJobFlowResponse200JobType1RawFlowModulesItem:
    ...
    Attributes:
        ...
        sleep (Union['GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSleepType0',
            'GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemSleepType1', Unset]): Maps input parameters for a step.
        ...
        timeout (Union['GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemTimeoutType0',
            'GetSuspendedJobFlowResponse200JobType1RawFlowModulesItemTimeoutType1', Unset]): Maps input parameters for a
