...
from ..models.flow_module_value_2_type_8_tools_item_value_type_1_tool_type import (
    FlowModuleValue2Type8ToolsItemValueType1ToolType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="FlowModuleValue2Type8ToolsItemValueType1")


@_attrs_define
class FlowModuleValue2Type8ToolsItemValueType1:
    """Reference to an external MCP (Model Context Protocol) tool. The AI can call tools from MCP servers

    Attributes:
        tool_type (FlowModuleValue2Type8ToolsItemValueType1ToolType):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        tool_type = FlowModuleValue2Type8ToolsItemValueType1ToolType(d.pop("tool_type"))
        ...
        flow_module_value_2_type_8_tools_item_value_type_1 = cls(
            tool_type=tool_type,
            resource_path=resource_path,
        ...
        flow_module_value_2_type_8_tools_item_value_type_1.additional_properties = d
        return flow_module_value_2_type_8_tools_item_value_type_1
