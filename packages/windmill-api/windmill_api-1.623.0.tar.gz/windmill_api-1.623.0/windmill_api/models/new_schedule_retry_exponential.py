...
T = TypeVar("T", bound="NewScheduleRetryExponential")


@_attrs_define
class NewScheduleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_schedule_retry_exponential = cls(
            attempts=attempts,
        ...
        new_schedule_retry_exponential.additional_properties = d
        return new_schedule_retry_exponential
