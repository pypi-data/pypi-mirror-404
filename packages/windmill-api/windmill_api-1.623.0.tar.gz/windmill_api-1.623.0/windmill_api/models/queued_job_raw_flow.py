...
if TYPE_CHECKING:
    ...
    from ..models.queued_job_raw_flow_flow_env import QueuedJobRawFlowFlowEnv
    from ..models.queued_job_raw_flow_modules_item import QueuedJobRawFlowModulesItem
    from ..models.queued_job_raw_flow_notes_item import QueuedJobRawFlowNotesItem
...
class QueuedJobRawFlow:
    ...
    Attributes:
        modules (List['QueuedJobRawFlowModulesItem']): Array of steps that execute in sequence. Each step can be a
            script, subflow, loop, or branch
        failure_module (Union[Unset, QueuedJobRawFlowFailureModule]): A single step in a flow. Can be a script, subflow,
            loop, or branch
        preprocessor_module (Union[Unset, QueuedJobRawFlowPreprocessorModule]): A single step in a flow. Can be a
            script, subflow, loop, or branch
        ...
        flow_env (Union[Unset, QueuedJobRawFlowFlowEnv]): Environment variables available to all steps
        ...
        notes (Union[Unset, List['QueuedJobRawFlowNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "QueuedJobRawFlowFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["QueuedJobRawFlowNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, QueuedJobRawFlowFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = QueuedJobRawFlowFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = QueuedJobRawFlowNotesItem.from_dict(notes_item_data)
