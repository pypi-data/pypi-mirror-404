...
from ..models.list_jobs_response_200_item_type_0_flow_status_preprocessor_module_type import (
    ListJobsResponse200ItemType0FlowStatusPreprocessorModuleType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.list_jobs_response_200_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_0 import (
        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType0,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_1 import (
        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType1,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_2 import (
        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType2,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_preprocessor_module_agent_actions_item_type_3 import (
        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType3,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_preprocessor_module_approvers_item import (
        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleApproversItem,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_preprocessor_module_branch_chosen import (
        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleBranchChosen,
    )
...
T = TypeVar("T", bound="ListJobsResponse200ItemType0FlowStatusPreprocessorModule")


@_attrs_define
class ListJobsResponse200ItemType0FlowStatusPreprocessorModule:
    """
    Attributes:
        type (ListJobsResponse200ItemType0FlowStatusPreprocessorModuleType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
        ...
        agent_actions (Union[Unset,
            List[Union['ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType0',
            'ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType1',
            'ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType2',
            'ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType3']]]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ListJobsResponse200ItemType0FlowStatusPreprocessorModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ListJobsResponse200ItemType0FlowStatusPreprocessorModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ListJobsResponse200ItemType0FlowStatusPreprocessorModuleBranchChosen.from_dict(
                _branch_chosen
            )
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ListJobsResponse200ItemType0FlowStatusPreprocessorModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = ListJobsResponse200ItemType0FlowStatusPreprocessorModuleApproversItem.from_dict(
                approvers_item_data
            )
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    ListJobsResponse200ItemType0FlowStatusPreprocessorModuleAgentActionsItemType3.from_dict(data)
                )
        ...
        list_jobs_response_200_item_type_0_flow_status_preprocessor_module = cls(
            type=type,
            id=id,
            job=job,
            count=count,
        ...
        list_jobs_response_200_item_type_0_flow_status_preprocessor_module.additional_properties = d
        return list_jobs_response_200_item_type_0_flow_status_preprocessor_module
