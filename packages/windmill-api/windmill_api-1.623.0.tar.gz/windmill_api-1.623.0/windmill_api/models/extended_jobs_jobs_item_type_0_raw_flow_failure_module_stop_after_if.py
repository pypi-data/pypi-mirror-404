...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0RawFlowFailureModuleStopAfterIf")


@_attrs_define
class ExtendedJobsJobsItemType0RawFlowFailureModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_0_raw_flow_failure_module_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        extended_jobs_jobs_item_type_0_raw_flow_failure_module_stop_after_if.additional_properties = d
        return extended_jobs_jobs_item_type_0_raw_flow_failure_module_stop_after_if
