...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0FlowStatusRetry")


@_attrs_define
class ExtendedJobsJobsItemType0FlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_0_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        extended_jobs_jobs_item_type_0_flow_status_retry.additional_properties = d
        return extended_jobs_jobs_item_type_0_flow_status_retry
