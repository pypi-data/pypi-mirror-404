...
T = TypeVar("T", bound="GetSettingsResponse200DefaultScripts")


@_attrs_define
class GetSettingsResponse200DefaultScripts:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_settings_response_200_default_scripts = cls(
            order=order,
            hidden=hidden,
            default_script_content=default_script_content,
        )

        get_settings_response_200_default_scripts.additional_properties = d
        return get_settings_response_200_default_scripts
