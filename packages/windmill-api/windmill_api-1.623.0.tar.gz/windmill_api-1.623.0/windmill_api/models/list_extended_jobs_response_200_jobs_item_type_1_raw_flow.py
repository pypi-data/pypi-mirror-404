...
if TYPE_CHECKING:
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_flow_env import (
        ListExtendedJobsResponse200JobsItemType1RawFlowFlowEnv,
    )
    ...
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_raw_flow_notes_item import (
        ListExtendedJobsResponse200JobsItemType1RawFlowNotesItem,
    )
...
class ListExtendedJobsResponse200JobsItemType1RawFlow:
    ...
    Attributes:
        modules (List['ListExtendedJobsResponse200JobsItemType1RawFlowModulesItem']): Array of steps that execute in
            sequence. Each step can be a script, subflow, loop, or branch
        failure_module (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFailureModule]): A single step in a
            flow. Can be a script, subflow, loop, or branch
        preprocessor_module (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowPreprocessorModule]): A single
        ...
        flow_env (Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFlowEnv]): Environment variables available
            to all steps
        ...
        notes (Union[Unset, List['ListExtendedJobsResponse200JobsItemType1RawFlowNotesItem']]): Sticky notes attached to
            the flow
    """
    ...
    flow_env: Union[Unset, "ListExtendedJobsResponse200JobsItemType1RawFlowFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["ListExtendedJobsResponse200JobsItemType1RawFlowNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, ListExtendedJobsResponse200JobsItemType1RawFlowFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = ListExtendedJobsResponse200JobsItemType1RawFlowFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = ListExtendedJobsResponse200JobsItemType1RawFlowNotesItem.from_dict(notes_item_data)
