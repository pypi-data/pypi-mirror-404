...
T = TypeVar("T", bound="ListKafkaTriggersResponse200ItemRetryConstant")


@_attrs_define
class ListKafkaTriggersResponse200ItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_kafka_triggers_response_200_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        list_kafka_triggers_response_200_item_retry_constant.additional_properties = d
        return list_kafka_triggers_response_200_item_retry_constant
