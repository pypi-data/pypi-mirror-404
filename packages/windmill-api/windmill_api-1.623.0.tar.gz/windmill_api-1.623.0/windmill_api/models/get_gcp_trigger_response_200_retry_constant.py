...
T = TypeVar("T", bound="GetGcpTriggerResponse200RetryConstant")


@_attrs_define
class GetGcpTriggerResponse200RetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_gcp_trigger_response_200_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_gcp_trigger_response_200_retry_constant.additional_properties = d
        return get_gcp_trigger_response_200_retry_constant
