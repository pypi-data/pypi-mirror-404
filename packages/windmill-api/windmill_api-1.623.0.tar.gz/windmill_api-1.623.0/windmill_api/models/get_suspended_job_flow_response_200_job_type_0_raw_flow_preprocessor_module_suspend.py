...
if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_0_raw_flow_preprocessor_module_suspend_resume_form import (
        GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendResumeForm,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_0_raw_flow_preprocessor_module_suspend_user_groups_required_type_0 import (
        GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_0_raw_flow_preprocessor_module_suspend_user_groups_required_type_1 import (
        GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspend")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendResumeForm]):
        ...
        user_groups_required
            (Union['GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0',
            'GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps
    ...
    resume_form: Union[
        Unset, "GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendResumeForm"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        return get_suspended_job_flow_response_200_job_type_0_raw_flow_preprocessor_module_suspend
