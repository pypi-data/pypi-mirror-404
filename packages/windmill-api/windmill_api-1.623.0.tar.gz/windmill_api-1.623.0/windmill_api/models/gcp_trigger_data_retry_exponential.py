...
T = TypeVar("T", bound="GcpTriggerDataRetryExponential")


@_attrs_define
class GcpTriggerDataRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        gcp_trigger_data_retry_exponential = cls(
            attempts=attempts,
        ...
        gcp_trigger_data_retry_exponential.additional_properties = d
        return gcp_trigger_data_retry_exponential
