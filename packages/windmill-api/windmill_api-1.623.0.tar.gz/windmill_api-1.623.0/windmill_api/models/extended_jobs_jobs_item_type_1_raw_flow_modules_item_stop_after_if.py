...
T = TypeVar("T", bound="ExtendedJobsJobsItemType1RawFlowModulesItemStopAfterIf")


@_attrs_define
class ExtendedJobsJobsItemType1RawFlowModulesItemStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_1_raw_flow_modules_item_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        extended_jobs_jobs_item_type_1_raw_flow_modules_item_stop_after_if.additional_properties = d
        return extended_jobs_jobs_item_type_1_raw_flow_modules_item_stop_after_if
