...
T = TypeVar("T", bound="GetHubFlowByIdResponse200FlowValueModulesItemStopAfterAllItersIf")


@_attrs_define
class GetHubFlowByIdResponse200FlowValueModulesItemStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_hub_flow_by_id_response_200_flow_value_modules_item_stop_after_all_iters_if
