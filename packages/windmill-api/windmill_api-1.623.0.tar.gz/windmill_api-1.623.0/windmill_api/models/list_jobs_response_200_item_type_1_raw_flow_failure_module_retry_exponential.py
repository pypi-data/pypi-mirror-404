...
T = TypeVar("T", bound="ListJobsResponse200ItemType1RawFlowFailureModuleRetryExponential")


@_attrs_define
class ListJobsResponse200ItemType1RawFlowFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_jobs_response_200_item_type_1_raw_flow_failure_module_retry_exponential = cls(
            attempts=attempts,
        ...
        list_jobs_response_200_item_type_1_raw_flow_failure_module_retry_exponential.additional_properties = d
        return list_jobs_response_200_item_type_1_raw_flow_failure_module_retry_exponential
