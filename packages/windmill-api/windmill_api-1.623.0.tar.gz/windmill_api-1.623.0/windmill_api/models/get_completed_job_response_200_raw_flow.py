...
if TYPE_CHECKING:
    ...
    from ..models.get_completed_job_response_200_raw_flow_flow_env import GetCompletedJobResponse200RawFlowFlowEnv
    from ..models.get_completed_job_response_200_raw_flow_modules_item import (
        GetCompletedJobResponse200RawFlowModulesItem,
    )
    from ..models.get_completed_job_response_200_raw_flow_notes_item import GetCompletedJobResponse200RawFlowNotesItem
...
class GetCompletedJobResponse200RawFlow:
    ...
    Attributes:
        modules (List['GetCompletedJobResponse200RawFlowModulesItem']): Array of steps that execute in sequence. Each
            step can be a script, subflow, loop, or branch
        failure_module (Union[Unset, GetCompletedJobResponse200RawFlowFailureModule]): A single step in a flow. Can be a
            script, subflow, loop, or branch
        preprocessor_module (Union[Unset, GetCompletedJobResponse200RawFlowPreprocessorModule]): A single step in a
        ...
        flow_env (Union[Unset, GetCompletedJobResponse200RawFlowFlowEnv]): Environment variables available to all steps
        ...
        notes (Union[Unset, List['GetCompletedJobResponse200RawFlowNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "GetCompletedJobResponse200RawFlowFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["GetCompletedJobResponse200RawFlowNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.get_completed_job_response_200_raw_flow_notes_item import (
            GetCompletedJobResponse200RawFlowNotesItem,
        )
        from ..models.get_completed_job_response_200_raw_flow_preprocessor_module import (
            GetCompletedJobResponse200RawFlowPreprocessorModule,
        )
        ...
        flow_env: Union[Unset, GetCompletedJobResponse200RawFlowFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = GetCompletedJobResponse200RawFlowFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = GetCompletedJobResponse200RawFlowNotesItem.from_dict(notes_item_data)
