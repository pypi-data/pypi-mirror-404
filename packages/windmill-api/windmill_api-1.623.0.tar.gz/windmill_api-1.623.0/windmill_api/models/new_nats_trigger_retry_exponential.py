...
T = TypeVar("T", bound="NewNatsTriggerRetryExponential")


@_attrs_define
class NewNatsTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_nats_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        new_nats_trigger_retry_exponential.additional_properties = d
        return new_nats_trigger_retry_exponential
