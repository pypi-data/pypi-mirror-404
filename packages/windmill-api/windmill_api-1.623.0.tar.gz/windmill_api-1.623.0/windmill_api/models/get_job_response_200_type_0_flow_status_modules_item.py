...
from ..models.get_job_response_200_type_0_flow_status_modules_item_type import (
    GetJobResponse200Type0FlowStatusModulesItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_job_response_200_type_0_flow_status_modules_item_agent_actions_item_type_0 import (
        GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType0,
    )
    from ..models.get_job_response_200_type_0_flow_status_modules_item_agent_actions_item_type_1 import (
        GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType1,
    )
    from ..models.get_job_response_200_type_0_flow_status_modules_item_agent_actions_item_type_2 import (
        GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType2,
    )
    from ..models.get_job_response_200_type_0_flow_status_modules_item_agent_actions_item_type_3 import (
        GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType3,
    )
    from ..models.get_job_response_200_type_0_flow_status_modules_item_approvers_item import (
        GetJobResponse200Type0FlowStatusModulesItemApproversItem,
    )
    from ..models.get_job_response_200_type_0_flow_status_modules_item_branch_chosen import (
        GetJobResponse200Type0FlowStatusModulesItemBranchChosen,
    )
    from ..models.get_job_response_200_type_0_flow_status_modules_item_branchall import (
        GetJobResponse200Type0FlowStatusModulesItemBranchall,
    )
    from ..models.get_job_response_200_type_0_flow_status_modules_item_flow_jobs_duration import (
        GetJobResponse200Type0FlowStatusModulesItemFlowJobsDuration,
    )
    from ..models.get_job_response_200_type_0_flow_status_modules_item_iterator import (
        GetJobResponse200Type0FlowStatusModulesItemIterator,
    )


T = TypeVar("T", bound="GetJobResponse200Type0FlowStatusModulesItem")


@_attrs_define
class GetJobResponse200Type0FlowStatusModulesItem:
    """
    Attributes:
        ...
        flow_jobs_duration (Union[Unset, GetJobResponse200Type0FlowStatusModulesItemFlowJobsDuration]):
        branch_chosen (Union[Unset, GetJobResponse200Type0FlowStatusModulesItemBranchChosen]):
        ...
        agent_actions (Union[Unset, List[Union['GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType0',
            'GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType1',
            'GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType2',
            'GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType3']]]):
    ...
    flow_jobs_duration: Union[Unset, "GetJobResponse200Type0FlowStatusModulesItemFlowJobsDuration"] = UNSET
    branch_chosen: Union[Unset, "GetJobResponse200Type0FlowStatusModulesItemBranchChosen"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    agent_actions_item_data, GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType0
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = GetJobResponse200Type0FlowStatusModulesItemType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = GetJobResponse200Type0FlowStatusModulesItemIterator.from_dict(_iterator)
        ...
        if isinstance(_flow_jobs_duration, Unset):
            ...
            flow_jobs_duration = GetJobResponse200Type0FlowStatusModulesItemFlowJobsDuration.from_dict(
                _flow_jobs_duration
            )
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = GetJobResponse200Type0FlowStatusModulesItemBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = GetJobResponse200Type0FlowStatusModulesItemBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = GetJobResponse200Type0FlowStatusModulesItemApproversItem.from_dict(approvers_item_data)
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType2.from_dict(data)
                    )
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                agent_actions_item_type_3 = GetJobResponse200Type0FlowStatusModulesItemAgentActionsItemType3.from_dict(
                    data
                )
        ...
        return get_job_response_200_type_0_flow_status_modules_item
