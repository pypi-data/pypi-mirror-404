...
if TYPE_CHECKING:
    from ..models.run_flow_preview_json_body_value_preprocessor_module_retry_constant import (
        RunFlowPreviewJsonBodyValuePreprocessorModuleRetryConstant,
    )
...
@_attrs_define
class RunFlowPreviewJsonBodyValuePreprocessorModuleRetry:
    """Retry configuration for failed module executions

    Attributes:
        constant (Union[Unset, RunFlowPreviewJsonBodyValuePreprocessorModuleRetryConstant]): Retry with constant delay
            between attempts
        exponential (Union[Unset, RunFlowPreviewJsonBodyValuePreprocessorModuleRetryExponential]): Retry with
            exponential backoff (delay doubles each time)
        retry_if (Union[Unset, RunFlowPreviewJsonBodyValuePreprocessorModuleRetryRetryIf]): Conditional retry based on
            error or result
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_constant, Unset):
            ...
            constant = RunFlowPreviewJsonBodyValuePreprocessorModuleRetryConstant.from_dict(_constant)
        ...
        return run_flow_preview_json_body_value_preprocessor_module_retry
