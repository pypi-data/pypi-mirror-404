...
T = TypeVar("T", bound="CreateNatsTriggerJsonBodyRetryConstant")


@_attrs_define
class CreateNatsTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_nats_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        create_nats_trigger_json_body_retry_constant.additional_properties = d
        return create_nats_trigger_json_body_retry_constant
