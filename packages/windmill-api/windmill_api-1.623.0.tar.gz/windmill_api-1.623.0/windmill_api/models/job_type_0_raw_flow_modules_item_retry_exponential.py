...
T = TypeVar("T", bound="JobType0RawFlowModulesItemRetryExponential")


@_attrs_define
class JobType0RawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_0_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        job_type_0_raw_flow_modules_item_retry_exponential.additional_properties = d
        return job_type_0_raw_flow_modules_item_retry_exponential
