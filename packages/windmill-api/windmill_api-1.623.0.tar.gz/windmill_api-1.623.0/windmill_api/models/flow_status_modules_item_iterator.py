...
T = TypeVar("T", bound="FlowStatusModulesItemIterator")


@_attrs_define
class FlowStatusModulesItemIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        flow_status_modules_item_iterator.additional_properties = d
        return flow_status_modules_item_iterator
