...
T = TypeVar("T", bound="FlowPreviewValuePreprocessorModuleStopAfterAllItersIf")


@_attrs_define
class FlowPreviewValuePreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_preview_value_preprocessor_module_stop_after_all_iters_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        flow_preview_value_preprocessor_module_stop_after_all_iters_if.additional_properties = d
        return flow_preview_value_preprocessor_module_stop_after_all_iters_if
