...
T = TypeVar("T", bound="NewPostgresTriggerRetryExponential")


@_attrs_define
class NewPostgresTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_postgres_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        new_postgres_trigger_retry_exponential.additional_properties = d
        return new_postgres_trigger_retry_exponential
