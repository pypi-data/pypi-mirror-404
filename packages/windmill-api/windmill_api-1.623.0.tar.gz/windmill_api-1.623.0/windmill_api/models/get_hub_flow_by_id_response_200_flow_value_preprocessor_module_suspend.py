...
if TYPE_CHECKING:
    from ..models.get_hub_flow_by_id_response_200_flow_value_preprocessor_module_suspend_resume_form import (
        GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspendResumeForm,
    )
...
@_attrs_define
class GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspendResumeForm]): Form schema
    ...
    resume_form: Union[Unset, "GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
        ...
        get_hub_flow_by_id_response_200_flow_value_preprocessor_module_suspend = cls(
        ...
        get_hub_flow_by_id_response_200_flow_value_preprocessor_module_suspend.additional_properties = d
        return get_hub_flow_by_id_response_200_flow_value_preprocessor_module_suspend
