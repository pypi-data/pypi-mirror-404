...
T = TypeVar("T", bound="DeleteCompletedJobResponse200RawFlowFailureModuleRetryExponential")


@_attrs_define
class DeleteCompletedJobResponse200RawFlowFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        delete_completed_job_response_200_raw_flow_failure_module_retry_exponential = cls(
            attempts=attempts,
