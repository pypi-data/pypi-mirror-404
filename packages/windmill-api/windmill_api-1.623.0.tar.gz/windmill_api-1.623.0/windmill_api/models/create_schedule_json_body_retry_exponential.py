...
T = TypeVar("T", bound="CreateScheduleJsonBodyRetryExponential")


@_attrs_define
class CreateScheduleJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_schedule_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        return create_schedule_json_body_retry_exponential
