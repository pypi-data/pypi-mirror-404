...
T = TypeVar("T", bound="GetFlowByPathResponse200ValueModulesItemRetryExponential")


@_attrs_define
class GetFlowByPathResponse200ValueModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_by_path_response_200_value_modules_item_retry_exponential = cls(
            attempts=attempts,
