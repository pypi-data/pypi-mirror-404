...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_preprocessor_module_suspend_resume_form import (
        ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendResumeForm,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_preprocessor_module_suspend_user_groups_required_type_0 import (
        ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_preprocessor_module_suspend_user_groups_required_type_1 import (
        ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspend")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendResumeForm]):
        ...
        user_groups_required
            (Union['ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0',
            'ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps
    ...
    resume_form: Union[
        Unset, "ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendResumeForm"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form, Unset):
            ...
            resume_form = ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                if isinstance(_user_groups_required_type_0, Unset):
                    ...
                    user_groups_required_type_0 = ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        list_extended_jobs_response_200_jobs_item_type_0_raw_flow_preprocessor_module_suspend = cls(
        ...
        list_extended_jobs_response_200_jobs_item_type_0_raw_flow_preprocessor_module_suspend.additional_properties = d
        return list_extended_jobs_response_200_jobs_item_type_0_raw_flow_preprocessor_module_suspend
