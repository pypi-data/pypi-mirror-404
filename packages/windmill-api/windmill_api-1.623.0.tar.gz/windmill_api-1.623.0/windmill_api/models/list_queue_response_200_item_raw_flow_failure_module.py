...
class ListQueueResponse200ItemRawFlowFailureModule:
    ...
    Attributes:
        ...
        sleep (Union['ListQueueResponse200ItemRawFlowFailureModuleSleepType0',
            'ListQueueResponse200ItemRawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a step. Can be a
        ...
        timeout (Union['ListQueueResponse200ItemRawFlowFailureModuleTimeoutType0',
            'ListQueueResponse200ItemRawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a step. Can be a
            static value or a JavaScript expression that references previous results or flow inputs
