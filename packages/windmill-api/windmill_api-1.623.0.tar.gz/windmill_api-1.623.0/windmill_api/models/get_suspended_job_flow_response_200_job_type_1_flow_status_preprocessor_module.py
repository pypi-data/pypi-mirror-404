...
from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_preprocessor_module_type import (
    GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleType,
)
...
if TYPE_CHECKING:
    ...
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_preprocessor_module_agent_actions_item_type_2 import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleAgentActionsItemType2,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_preprocessor_module_agent_actions_item_type_3 import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleAgentActionsItemType3,
    )
    ...
    from ..models.get_suspended_job_flow_response_200_job_type_1_flow_status_preprocessor_module_branch_chosen import (
        GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleBranchChosen,
    )
...
T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModule")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModule:
    """
    Attributes:
    ...
    branchall: Union[Unset, "GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleBranchall"] = UNSET
    approvers: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleBranchChosen.from_dict(
                _branch_chosen
            )
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleBranchall.from_dict(
                _branchall
            )
        ...
        for approvers_item_data in _approvers or []:
            approvers_item = GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleApproversItem.from_dict(
                approvers_item_data
            )
        ...
        for agent_actions_item_data in _agent_actions or []:
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_1 = GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleAgentActionsItemType1.from_dict(
                        data
                    )
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_2 = GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleAgentActionsItemType2.from_dict(
                        data
                    )
                ...
                agent_actions_item_type_3 = (
                    GetSuspendedJobFlowResponse200JobType1FlowStatusPreprocessorModuleAgentActionsItemType3.from_dict(
                        data
                    )
                )
        ...
        return get_suspended_job_flow_response_200_job_type_1_flow_status_preprocessor_module
