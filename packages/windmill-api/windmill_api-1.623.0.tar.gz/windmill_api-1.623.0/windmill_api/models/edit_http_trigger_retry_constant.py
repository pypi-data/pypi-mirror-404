...
T = TypeVar("T", bound="EditHttpTriggerRetryConstant")


@_attrs_define
class EditHttpTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_http_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        edit_http_trigger_retry_constant.additional_properties = d
        return edit_http_trigger_retry_constant
