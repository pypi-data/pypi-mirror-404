...
if TYPE_CHECKING:
    ...
    from ..models.get_flow_version_response_200_value_modules_item_timeout_type_0 import (
        GetFlowVersionResponse200ValueModulesItemTimeoutType0,
    )
    from ..models.get_flow_version_response_200_value_modules_item_timeout_type_1 import (
        GetFlowVersionResponse200ValueModulesItemTimeoutType1,
    )
...
class GetFlowVersionResponse200ValueModulesItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetFlowVersionResponse200ValueModulesItemStopAfterIf]): Early termination condition
            for a module
        stop_after_all_iters_if (Union[Unset, GetFlowVersionResponse200ValueModulesItemStopAfterAllItersIf]): Early
            termination condition for a module
        skip_if (Union[Unset, GetFlowVersionResponse200ValueModulesItemSkipIf]): Conditionally skip this step based on
            previous results or flow inputs
        sleep (Union['GetFlowVersionResponse200ValueModulesItemSleepType0',
            'GetFlowVersionResponse200ValueModulesItemSleepType1', Unset]): Maps input parameters for a step. Can be a
        ...
        timeout (Union['GetFlowVersionResponse200ValueModulesItemTimeoutType0',
            'GetFlowVersionResponse200ValueModulesItemTimeoutType1', Unset]): Maps input parameters for a step. Can be a
            static value or a JavaScript expression that references previous results or flow inputs
        ...
        mock (Union[Unset, GetFlowVersionResponse200ValueModulesItemMock]): Mock configuration for testing without
            executing the actual step
        suspend (Union[Unset, GetFlowVersionResponse200ValueModulesItemSuspend]): Configuration for approval/resume
        ...
        retry (Union[Unset, GetFlowVersionResponse200ValueModulesItemRetry]): Retry configuration for failed module
            executions
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.timeout, GetFlowVersionResponse200ValueModulesItemTimeoutType0):
            timeout = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, GetFlowVersionResponse200ValueModulesItemTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = GetFlowVersionResponse200ValueModulesItemTimeoutType0.from_dict(_timeout_type_0)
            ...
            timeout_type_1: Union[Unset, GetFlowVersionResponse200ValueModulesItemTimeoutType1]
            if isinstance(_timeout_type_1, Unset):
                timeout_type_1 = UNSET
            else:
                timeout_type_1 = GetFlowVersionResponse200ValueModulesItemTimeoutType1.from_dict(_timeout_type_1)
