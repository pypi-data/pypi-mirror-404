...
T = TypeVar("T", bound="GetGroupPermissionHistoryResponse200Item")


@_attrs_define
class GetGroupPermissionHistoryResponse200Item:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        member_affected (Union[Unset, None, str]):
    """
    ...
    member_affected: Union[Unset, None, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        member_affected = self.member_affected
        ...
        if member_affected is not UNSET:
            field_dict["member_affected"] = member_affected
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        member_affected = d.pop("member_affected", UNSET)

        get_group_permission_history_response_200_item = cls(
            id=id,
        ...
        get_group_permission_history_response_200_item.additional_properties = d
        return get_group_permission_history_response_200_item
