...
T = TypeVar("T", bound="GetJobResponse200Type1RawFlowFailureModuleMock")


@_attrs_define
class GetJobResponse200Type1RawFlowFailureModuleMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_1_raw_flow_failure_module_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        get_job_response_200_type_1_raw_flow_failure_module_mock.additional_properties = d
        return get_job_response_200_type_1_raw_flow_failure_module_mock
