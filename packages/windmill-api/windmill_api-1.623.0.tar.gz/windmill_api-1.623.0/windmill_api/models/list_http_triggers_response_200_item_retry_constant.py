...
T = TypeVar("T", bound="ListHttpTriggersResponse200ItemRetryConstant")


@_attrs_define
class ListHttpTriggersResponse200ItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_http_triggers_response_200_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        list_http_triggers_response_200_item_retry_constant.additional_properties = d
        return list_http_triggers_response_200_item_retry_constant
