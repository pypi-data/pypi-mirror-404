...
from ..models.flow_note_type import FlowNoteType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.flow_note_position import FlowNotePosition
    from ..models.flow_note_size import FlowNoteSize


T = TypeVar("T", bound="FlowNote")
...
class FlowNote:
    ...
    Attributes:
        ...
        type (FlowNoteType): Type of note - 'free' for standalone notes, 'group' for notes that group other nodes
        position (Union[Unset, FlowNotePosition]): Position of the note in the flow editor
        size (Union[Unset, FlowNoteSize]): Size of the note in the flow editor
    ...
    color: str
    type: FlowNoteType
    position: Union[Unset, "FlowNotePosition"] = UNSET
    size: Union[Unset, "FlowNoteSize"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = FlowNoteType(d.pop("type"))

        _position = d.pop("position", UNSET)
        position: Union[Unset, FlowNotePosition]
        if isinstance(_position, Unset):
            position = UNSET
        else:
            position = FlowNotePosition.from_dict(_position)

        _size = d.pop("size", UNSET)
        size: Union[Unset, FlowNoteSize]
        if isinstance(_size, Unset):
            size = UNSET
        else:
            size = FlowNoteSize.from_dict(_size)
        ...
        flow_note.additional_properties = d
        return flow_note
