...
if TYPE_CHECKING:
    from ..models.get_job_response_200_type_0_raw_flow_preprocessor_module_suspend_resume_form import (
        GetJobResponse200Type0RawFlowPreprocessorModuleSuspendResumeForm,
    )
    from ..models.get_job_response_200_type_0_raw_flow_preprocessor_module_suspend_user_groups_required_type_0 import (
        GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.get_job_response_200_type_0_raw_flow_preprocessor_module_suspend_user_groups_required_type_1 import (
        GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="GetJobResponse200Type0RawFlowPreprocessorModuleSuspend")


@_attrs_define
class GetJobResponse200Type0RawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleSuspendResumeForm]): Form schema for
            collecting input when resuming
        user_auth_required (Union[Unset, bool]): If true, only authenticated users can approve
        user_groups_required (Union['GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0',
            'GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters
    ...
    resume_form: Union[Unset, "GetJobResponse200Type0RawFlowPreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.user_groups_required, Unset):
            ...
            self.user_groups_required, GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0
        ):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = GetJobResponse200Type0RawFlowPreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    GetJobResponse200Type0RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        get_job_response_200_type_0_raw_flow_preprocessor_module_suspend = cls(
        ...
        get_job_response_200_type_0_raw_flow_preprocessor_module_suspend.additional_properties = d
        return get_job_response_200_type_0_raw_flow_preprocessor_module_suspend
