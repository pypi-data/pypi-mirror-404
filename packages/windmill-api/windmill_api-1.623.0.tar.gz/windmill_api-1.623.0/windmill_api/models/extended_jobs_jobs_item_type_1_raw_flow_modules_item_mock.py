...
T = TypeVar("T", bound="ExtendedJobsJobsItemType1RawFlowModulesItemMock")


@_attrs_define
class ExtendedJobsJobsItemType1RawFlowModulesItemMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_1_raw_flow_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        extended_jobs_jobs_item_type_1_raw_flow_modules_item_mock.additional_properties = d
        return extended_jobs_jobs_item_type_1_raw_flow_modules_item_mock
