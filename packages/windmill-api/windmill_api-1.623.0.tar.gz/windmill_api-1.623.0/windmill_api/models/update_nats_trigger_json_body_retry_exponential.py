...
T = TypeVar("T", bound="UpdateNatsTriggerJsonBodyRetryExponential")


@_attrs_define
class UpdateNatsTriggerJsonBodyRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_nats_trigger_json_body_retry_exponential = cls(
            attempts=attempts,
        ...
        update_nats_trigger_json_body_retry_exponential.additional_properties = d
        return update_nats_trigger_json_body_retry_exponential
