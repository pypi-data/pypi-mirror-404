...
T = TypeVar("T", bound="EditMqttTriggerRetryConstant")


@_attrs_define
class EditMqttTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        edit_mqtt_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        edit_mqtt_trigger_retry_constant.additional_properties = d
        return edit_mqtt_trigger_retry_constant
