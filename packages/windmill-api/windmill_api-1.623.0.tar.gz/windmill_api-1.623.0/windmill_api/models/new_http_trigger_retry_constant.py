...
T = TypeVar("T", bound="NewHttpTriggerRetryConstant")


@_attrs_define
class NewHttpTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_http_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        new_http_trigger_retry_constant.additional_properties = d
        return new_http_trigger_retry_constant
