...
T = TypeVar("T", bound="ListWebsocketTriggersResponse200ItemRetryExponential")


@_attrs_define
class ListWebsocketTriggersResponse200ItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_websocket_triggers_response_200_item_retry_exponential = cls(
            attempts=attempts,
        ...
        list_websocket_triggers_response_200_item_retry_exponential.additional_properties = d
        return list_websocket_triggers_response_200_item_retry_exponential
