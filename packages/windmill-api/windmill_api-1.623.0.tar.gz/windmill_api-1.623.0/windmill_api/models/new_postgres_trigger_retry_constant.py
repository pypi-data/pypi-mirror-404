...
T = TypeVar("T", bound="NewPostgresTriggerRetryConstant")


@_attrs_define
class NewPostgresTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_postgres_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        new_postgres_trigger_retry_constant.additional_properties = d
        return new_postgres_trigger_retry_constant
