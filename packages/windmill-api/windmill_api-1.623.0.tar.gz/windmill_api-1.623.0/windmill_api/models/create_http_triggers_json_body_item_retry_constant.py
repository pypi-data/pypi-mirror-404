...
T = TypeVar("T", bound="CreateHttpTriggersJsonBodyItemRetryConstant")


@_attrs_define
class CreateHttpTriggersJsonBodyItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_http_triggers_json_body_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        create_http_triggers_json_body_item_retry_constant.additional_properties = d
        return create_http_triggers_json_body_item_retry_constant
