...
T = TypeVar("T", bound="GetSqsTriggerResponse200RetryExponential")


@_attrs_define
class GetSqsTriggerResponse200RetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_sqs_trigger_response_200_retry_exponential = cls(
            attempts=attempts,
        ...
        get_sqs_trigger_response_200_retry_exponential.additional_properties = d
        return get_sqs_trigger_response_200_retry_exponential
