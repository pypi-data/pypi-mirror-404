...
T = TypeVar("T", bound="ListJobsResponse200ItemType0FlowStatusFailureModuleIterator")


@_attrs_define
class ListJobsResponse200ItemType0FlowStatusFailureModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_jobs_response_200_item_type_0_flow_status_failure_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        list_jobs_response_200_item_type_0_flow_status_failure_module_iterator.additional_properties = d
        return list_jobs_response_200_item_type_0_flow_status_failure_module_iterator
