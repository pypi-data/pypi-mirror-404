...
T = TypeVar("T", bound="WebsocketTriggerRetryConstant")


@_attrs_define
class WebsocketTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        websocket_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        websocket_trigger_retry_constant.additional_properties = d
        return websocket_trigger_retry_constant
