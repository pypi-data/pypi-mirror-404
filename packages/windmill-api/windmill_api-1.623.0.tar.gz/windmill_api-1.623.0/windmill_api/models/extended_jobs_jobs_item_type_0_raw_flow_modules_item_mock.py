...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0RawFlowModulesItemMock")


@_attrs_define
class ExtendedJobsJobsItemType0RawFlowModulesItemMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_0_raw_flow_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        extended_jobs_jobs_item_type_0_raw_flow_modules_item_mock.additional_properties = d
        return extended_jobs_jobs_item_type_0_raw_flow_modules_item_mock
