...
class GetJobResponse200Type1RawFlowFailureModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetJobResponse200Type1RawFlowFailureModuleStopAfterIf]): Early termination condition
            for a module
        stop_after_all_iters_if (Union[Unset, GetJobResponse200Type1RawFlowFailureModuleStopAfterAllItersIf]): Early
            termination condition for a module
        skip_if (Union[Unset, GetJobResponse200Type1RawFlowFailureModuleSkipIf]): Conditionally skip this step based on
            previous results or flow inputs
        sleep (Union['GetJobResponse200Type1RawFlowFailureModuleSleepType0',
            'GetJobResponse200Type1RawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a step. Can be a
        ...
        timeout (Union['GetJobResponse200Type1RawFlowFailureModuleTimeoutType0',
            'GetJobResponse200Type1RawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a step. Can be a
            static value or a JavaScript expression that references previous results or flow inputs
        ...
        mock (Union[Unset, GetJobResponse200Type1RawFlowFailureModuleMock]): Mock configuration for testing without
            executing the actual step
        suspend (Union[Unset, GetJobResponse200Type1RawFlowFailureModuleSuspend]): Configuration for approval/resume
        ...
        retry (Union[Unset, GetJobResponse200Type1RawFlowFailureModuleRetry]): Retry configuration for failed module
            executions
    """
