...
T = TypeVar("T", bound="GetJobResponse200Type0RawFlowModulesItemMock")


@_attrs_define
class GetJobResponse200Type0RawFlowModulesItemMock:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_0_raw_flow_modules_item_mock = cls(
            enabled=enabled,
            return_value=return_value,
        )

        get_job_response_200_type_0_raw_flow_modules_item_mock.additional_properties = d
        return get_job_response_200_type_0_raw_flow_modules_item_mock
