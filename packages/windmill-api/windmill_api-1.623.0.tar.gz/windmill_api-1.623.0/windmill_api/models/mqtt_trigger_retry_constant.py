...
T = TypeVar("T", bound="MqttTriggerRetryConstant")


@_attrs_define
class MqttTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        mqtt_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        mqtt_trigger_retry_constant.additional_properties = d
        return mqtt_trigger_retry_constant
