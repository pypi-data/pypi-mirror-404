...
T = TypeVar("T", bound="GetFlowByPathResponse200ValueFailureModuleRetryConstant")
...
class GetFlowByPathResponse200ValueFailureModuleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_by_path_response_200_value_failure_module_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_flow_by_path_response_200_value_failure_module_retry_constant.additional_properties = d
