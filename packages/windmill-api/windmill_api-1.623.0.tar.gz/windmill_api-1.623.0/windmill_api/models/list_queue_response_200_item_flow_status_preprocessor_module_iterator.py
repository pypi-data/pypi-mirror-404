...
T = TypeVar("T", bound="ListQueueResponse200ItemFlowStatusPreprocessorModuleIterator")


@_attrs_define
class ListQueueResponse200ItemFlowStatusPreprocessorModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_queue_response_200_item_flow_status_preprocessor_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        list_queue_response_200_item_flow_status_preprocessor_module_iterator.additional_properties = d
        return list_queue_response_200_item_flow_status_preprocessor_module_iterator
