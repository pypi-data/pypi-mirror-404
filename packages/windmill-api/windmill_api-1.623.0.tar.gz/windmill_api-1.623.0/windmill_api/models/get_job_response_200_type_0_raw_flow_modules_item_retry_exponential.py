...
T = TypeVar("T", bound="GetJobResponse200Type0RawFlowModulesItemRetryExponential")


@_attrs_define
class GetJobResponse200Type0RawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_0_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        get_job_response_200_type_0_raw_flow_modules_item_retry_exponential.additional_properties = d
        return get_job_response_200_type_0_raw_flow_modules_item_retry_exponential
