...
T = TypeVar("T", bound="TestSecretBackendJsonBody")


@_attrs_define
class TestSecretBackendJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        test_secret_backend_json_body = cls(
            address=address,
            mount_path=mount_path,
            jwt_role=jwt_role,
            namespace=namespace,
        ...
        test_secret_backend_json_body.additional_properties = d
        return test_secret_backend_json_body
