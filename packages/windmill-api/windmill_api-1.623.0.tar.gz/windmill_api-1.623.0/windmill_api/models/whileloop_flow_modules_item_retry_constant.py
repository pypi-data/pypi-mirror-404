...
T = TypeVar("T", bound="WhileloopFlowModulesItemRetryConstant")


@_attrs_define
class WhileloopFlowModulesItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        whileloop_flow_modules_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        whileloop_flow_modules_item_retry_constant.additional_properties = d
        return whileloop_flow_modules_item_retry_constant
