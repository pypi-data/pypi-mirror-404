...
T = TypeVar("T", bound="GetMqttTriggerResponse200RetryConstant")


@_attrs_define
class GetMqttTriggerResponse200RetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_mqtt_trigger_response_200_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        get_mqtt_trigger_response_200_retry_constant.additional_properties = d
        return get_mqtt_trigger_response_200_retry_constant
