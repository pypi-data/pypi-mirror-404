...
class GetHubFlowByIdResponse200FlowValueFailureModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetHubFlowByIdResponse200FlowValueFailureModuleSuspendResumeForm]): Form schema for
        ...
        user_groups_required (Union['GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType0',
            'GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters
