...
if TYPE_CHECKING:
    ...
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_sleep_type_1 import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSleepType1,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_stop_after_all_iters_if import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterAllItersIf,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_stop_after_if import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterIf,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_suspend import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspend,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_timeout_type_0 import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType0,
    )
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module_timeout_type_1 import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType1,
    )


T = TypeVar("T", bound="ListCompletedJobsResponse200ItemRawFlowPreprocessorModule")


@_attrs_define
class ListCompletedJobsResponse200ItemRawFlowPreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterIf]): Early
            termination condition for a module
        stop_after_all_iters_if (Union[Unset,
            ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterAllItersIf]): Early termination condition for
            a module
        skip_if (Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSkipIf]): Conditionally skip this
        ...
        sleep (Union['ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSleepType0',
            'ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSleepType1', Unset]): Maps input parameters for a
        ...
        timeout (Union['ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType0',
            'ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType1', Unset]): Maps input parameters for a
            step. Can be a static value or a JavaScript expression that references previous results or flow inputs
        ...
        mock (Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleMock]): Mock configuration for
            testing without executing the actual step
        suspend (Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspend]): Configuration for
    ...
    id: str
    value: Any
    stop_after_if: Union[Unset, "ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterIf"] = UNSET
    ...
    mock: Union[Unset, "ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleMock"] = UNSET
    suspend: Union[Unset, "ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspend"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSleepType0):
            sleep = UNSET
        ...
        elif isinstance(self.timeout, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType0):
            timeout = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_stop_after_if, Unset):
            ...
            stop_after_if = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterIf.from_dict(
                _stop_after_if
            )
        ...
        if isinstance(_stop_after_all_iters_if, Unset):
            ...
            stop_after_all_iters_if = (
                ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleStopAfterAllItersIf.from_dict(
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSleepType0.from_dict(
                        _sleep_type_0
                    )
            ...
            if not isinstance(data, dict):
                raise TypeError()
            _sleep_type_1 = data
            sleep_type_1: Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSleepType1]
            if isinstance(_sleep_type_1, Unset):
                sleep_type_1 = UNSET
            else:
                sleep_type_1 = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSleepType1.from_dict(
                    _sleep_type_1
                )
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType0.from_dict(
                        _timeout_type_0
                    )
            ...
            timeout_type_1: Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType1]
            if isinstance(_timeout_type_1, Unset):
                timeout_type_1 = UNSET
            else:
                timeout_type_1 = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleTimeoutType1.from_dict(
                    _timeout_type_1
                )
        ...
        mock: Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleMock]
        if isinstance(_mock, Unset):
            mock = UNSET
        else:
            mock = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleMock.from_dict(_mock)

        _suspend = d.pop("suspend", UNSET)
        suspend: Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspend]
        if isinstance(_suspend, Unset):
            suspend = UNSET
        else:
            suspend = ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleSuspend.from_dict(_suspend)
        ...
        retry: Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModuleRetry]
        ...
        return list_completed_jobs_response_200_item_raw_flow_preprocessor_module
