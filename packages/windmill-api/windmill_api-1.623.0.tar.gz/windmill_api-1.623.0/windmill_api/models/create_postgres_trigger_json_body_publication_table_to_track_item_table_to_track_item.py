...
T = TypeVar("T", bound="CreatePostgresTriggerJsonBodyPublicationTableToTrackItemTableToTrackItem")
...
class CreatePostgresTriggerJsonBodyPublicationTableToTrackItemTableToTrackItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_postgres_trigger_json_body_publication_table_to_track_item_table_to_track_item = cls(
            table_name=table_name,
            columns_name=columns_name,
            where_clause=where_clause,
        )

        create_postgres_trigger_json_body_publication_table_to_track_item_table_to_track_item.additional_properties = d
        return create_postgres_trigger_json_body_publication_table_to_track_item_table_to_track_item
