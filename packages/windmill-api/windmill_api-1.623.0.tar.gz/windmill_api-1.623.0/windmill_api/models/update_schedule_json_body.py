...
class UpdateScheduleJsonBody:
    ...
    Attributes:
        ...
        retry (Union[Unset, UpdateScheduleJsonBodyRetry]): Retry configuration for failed module executions
    ...
    on_success_extra_args: Union[Unset, "UpdateScheduleJsonBodyOnSuccessExtraArgs"] = UNSET
