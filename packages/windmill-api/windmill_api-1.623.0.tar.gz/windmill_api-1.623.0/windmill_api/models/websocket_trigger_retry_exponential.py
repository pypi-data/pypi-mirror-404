...
T = TypeVar("T", bound="WebsocketTriggerRetryExponential")


@_attrs_define
class WebsocketTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        websocket_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        websocket_trigger_retry_exponential.additional_properties = d
        return websocket_trigger_retry_exponential
