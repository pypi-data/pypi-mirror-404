...
from ..models.flow_module_sleep_type_0_type import FlowModuleSleepType0Type
...
class FlowModuleSleepType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        type = FlowModuleSleepType0Type(d.pop("type"))

        value = d.pop("value", UNSET)

        flow_module_sleep_type_0 = cls(
            type=type,
            value=value,
        )

        flow_module_sleep_type_0.additional_properties = d
