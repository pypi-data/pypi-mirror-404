...
T = TypeVar("T", bound="NewScheduleRetryConstant")


@_attrs_define
class NewScheduleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_schedule_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        new_schedule_retry_constant.additional_properties = d
        return new_schedule_retry_constant
