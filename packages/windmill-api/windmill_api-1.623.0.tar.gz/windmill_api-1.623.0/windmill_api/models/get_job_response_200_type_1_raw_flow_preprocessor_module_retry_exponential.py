...
T = TypeVar("T", bound="GetJobResponse200Type1RawFlowPreprocessorModuleRetryExponential")


@_attrs_define
class GetJobResponse200Type1RawFlowPreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_1_raw_flow_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        get_job_response_200_type_1_raw_flow_preprocessor_module_retry_exponential.additional_properties = d
        return get_job_response_200_type_1_raw_flow_preprocessor_module_retry_exponential
