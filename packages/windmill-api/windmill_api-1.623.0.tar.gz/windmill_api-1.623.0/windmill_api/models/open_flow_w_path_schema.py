...
T = TypeVar("T", bound="OpenFlowWPathSchema")


@_attrs_define
class OpenFlowWPathSchema:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        open_flow_w_path_schema = cls()

        open_flow_w_path_schema.additional_properties = d
        return open_flow_w_path_schema
