...
T = TypeVar("T", bound="ListHttpTriggersResponse200ItemRetryExponential")


@_attrs_define
class ListHttpTriggersResponse200ItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_http_triggers_response_200_item_retry_exponential = cls(
            attempts=attempts,
        ...
        list_http_triggers_response_200_item_retry_exponential.additional_properties = d
        return list_http_triggers_response_200_item_retry_exponential
