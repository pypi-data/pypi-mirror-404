...
T = TypeVar("T", bound="MqttTriggerRetryExponential")


@_attrs_define
class MqttTriggerRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        mqtt_trigger_retry_exponential = cls(
            attempts=attempts,
        ...
        mqtt_trigger_retry_exponential.additional_properties = d
        return mqtt_trigger_retry_exponential
