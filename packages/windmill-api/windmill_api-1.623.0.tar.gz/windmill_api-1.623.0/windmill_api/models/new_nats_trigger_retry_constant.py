...
T = TypeVar("T", bound="NewNatsTriggerRetryConstant")


@_attrs_define
class NewNatsTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_nats_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        new_nats_trigger_retry_constant.additional_properties = d
        return new_nats_trigger_retry_constant
