...
T = TypeVar("T", bound="NewMqttTriggerRetryConstant")


@_attrs_define
class NewMqttTriggerRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_mqtt_trigger_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        new_mqtt_trigger_retry_constant.additional_properties = d
        return new_mqtt_trigger_retry_constant
