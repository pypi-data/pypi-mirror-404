...
T = TypeVar("T", bound="JobType1RawFlowModulesItemRetryExponential")


@_attrs_define
class JobType1RawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_1_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        job_type_1_raw_flow_modules_item_retry_exponential.additional_properties = d
        return job_type_1_raw_flow_modules_item_retry_exponential
