...
from ..models.import_queued_jobs_json_body_item_job_kind import ImportQueuedJobsJsonBodyItemJobKind
from ..models.import_queued_jobs_json_body_item_language import ImportQueuedJobsJsonBodyItemLanguage
from ..models.import_queued_jobs_json_body_item_trigger_kind import ImportQueuedJobsJsonBodyItemTriggerKind
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.import_queued_jobs_json_body_item_args import ImportQueuedJobsJsonBodyItemArgs
    from ..models.import_queued_jobs_json_body_item_flow_status import ImportQueuedJobsJsonBodyItemFlowStatus
    from ..models.import_queued_jobs_json_body_item_raw_flow import ImportQueuedJobsJsonBodyItemRawFlow
    from ..models.import_queued_jobs_json_body_item_workflow_as_code_status import (
        ImportQueuedJobsJsonBodyItemWorkflowAsCodeStatus,
    )


T = TypeVar("T", bound="ImportQueuedJobsJsonBodyItem")


@_attrs_define
class ImportQueuedJobsJsonBodyItem:
    ...
    Attributes:
        ...
        job_kind (ImportQueuedJobsJsonBodyItemJobKind):
        permissioned_as (str):
        email (str):
        ...
        args (Union[Unset, ImportQueuedJobsJsonBodyItemArgs]): Full job arguments without size restrictions
        ...
        trigger_kind (Union[Unset, ImportQueuedJobsJsonBodyItemTriggerKind]):
        permissioned_as_email (Union[Unset, str]):
        flow_status (Union[Unset, ImportQueuedJobsJsonBodyItemFlowStatus]): Flow status from v2_job_status table
        workflow_as_code_status (Union[Unset, ImportQueuedJobsJsonBodyItemWorkflowAsCodeStatus]):
        raw_flow (Union[Unset, ImportQueuedJobsJsonBodyItemRawFlow]):
        is_flow_step (Union[Unset, bool]):
        language (Union[Unset, ImportQueuedJobsJsonBodyItemLanguage]):
    ...
    args: Union[Unset, "ImportQueuedJobsJsonBodyItemArgs"] = UNSET
    ...
    trigger_kind: Union[Unset, ImportQueuedJobsJsonBodyItemTriggerKind] = UNSET
    permissioned_as_email: Union[Unset, str] = UNSET
    flow_status: Union[Unset, "ImportQueuedJobsJsonBodyItemFlowStatus"] = UNSET
    workflow_as_code_status: Union[Unset, "ImportQueuedJobsJsonBodyItemWorkflowAsCodeStatus"] = UNSET
    raw_flow: Union[Unset, "ImportQueuedJobsJsonBodyItemRawFlow"] = UNSET
    is_flow_step: Union[Unset, bool] = UNSET
    language: Union[Unset, ImportQueuedJobsJsonBodyItemLanguage] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_kind = ImportQueuedJobsJsonBodyItemJobKind(d.pop("job_kind"))
        ...
        args: Union[Unset, ImportQueuedJobsJsonBodyItemArgs]
        if isinstance(_args, Unset):
            args = UNSET
        else:
            args = ImportQueuedJobsJsonBodyItemArgs.from_dict(_args)
        ...
        if isinstance(_trigger_kind, Unset):
            ...
            trigger_kind = ImportQueuedJobsJsonBodyItemTriggerKind(_trigger_kind)

        permissioned_as_email = d.pop("permissioned_as_email", UNSET)

        _flow_status = d.pop("flow_status", UNSET)
        flow_status: Union[Unset, ImportQueuedJobsJsonBodyItemFlowStatus]
        if isinstance(_flow_status, Unset):
            flow_status = UNSET
        else:
            flow_status = ImportQueuedJobsJsonBodyItemFlowStatus.from_dict(_flow_status)
        ...
        if isinstance(_workflow_as_code_status, Unset):
            ...
            workflow_as_code_status = ImportQueuedJobsJsonBodyItemWorkflowAsCodeStatus.from_dict(
        ...
        if isinstance(_raw_flow, Unset):
            ...
            raw_flow = ImportQueuedJobsJsonBodyItemRawFlow.from_dict(_raw_flow)
        ...
        if isinstance(_language, Unset):
            ...
            language = ImportQueuedJobsJsonBodyItemLanguage(_language)
        ...
        import_queued_jobs_json_body_item = cls(
            id=id,
            created_by=created_by,
            created_at=created_at,
            job_kind=job_kind,
        ...
        import_queued_jobs_json_body_item.additional_properties = d
        return import_queued_jobs_json_body_item
