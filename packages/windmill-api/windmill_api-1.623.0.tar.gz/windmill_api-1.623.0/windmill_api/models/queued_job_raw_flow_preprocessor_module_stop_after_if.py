...
T = TypeVar("T", bound="QueuedJobRawFlowPreprocessorModuleStopAfterIf")


@_attrs_define
class QueuedJobRawFlowPreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return queued_job_raw_flow_preprocessor_module_stop_after_if
