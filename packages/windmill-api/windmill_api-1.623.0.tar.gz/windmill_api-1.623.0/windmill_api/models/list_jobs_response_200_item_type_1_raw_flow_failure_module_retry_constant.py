...
T = TypeVar("T", bound="ListJobsResponse200ItemType1RawFlowFailureModuleRetryConstant")
...
class ListJobsResponse200ItemType1RawFlowFailureModuleRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_jobs_response_200_item_type_1_raw_flow_failure_module_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        list_jobs_response_200_item_type_1_raw_flow_failure_module_retry_constant.additional_properties = d
        return list_jobs_response_200_item_type_1_raw_flow_failure_module_retry_constant
