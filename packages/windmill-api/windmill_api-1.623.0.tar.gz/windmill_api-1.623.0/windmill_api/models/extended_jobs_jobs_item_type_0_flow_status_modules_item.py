...
from ..models.extended_jobs_jobs_item_type_0_flow_status_modules_item_type import (
    ExtendedJobsJobsItemType0FlowStatusModulesItemType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.extended_jobs_jobs_item_type_0_flow_status_modules_item_agent_actions_item_type_0 import (
        ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType0,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_modules_item_agent_actions_item_type_1 import (
        ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType1,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_modules_item_agent_actions_item_type_2 import (
        ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType2,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_modules_item_agent_actions_item_type_3 import (
        ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType3,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_modules_item_approvers_item import (
        ExtendedJobsJobsItemType0FlowStatusModulesItemApproversItem,
    )
    from ..models.extended_jobs_jobs_item_type_0_flow_status_modules_item_branch_chosen import (
        ExtendedJobsJobsItemType0FlowStatusModulesItemBranchChosen,
    )
...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0FlowStatusModulesItem")


@_attrs_define
class ExtendedJobsJobsItemType0FlowStatusModulesItem:
    """
    Attributes:
        type (ExtendedJobsJobsItemType0FlowStatusModulesItemType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
        ...
        agent_actions (Union[Unset, List[Union['ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType0',
            'ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType1',
            'ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType2',
            'ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType3']]]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType0
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ExtendedJobsJobsItemType0FlowStatusModulesItemType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ExtendedJobsJobsItemType0FlowStatusModulesItemIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ExtendedJobsJobsItemType0FlowStatusModulesItemBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ExtendedJobsJobsItemType0FlowStatusModulesItemBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = ExtendedJobsJobsItemType0FlowStatusModulesItemApproversItem.from_dict(approvers_item_data)
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    ExtendedJobsJobsItemType0FlowStatusModulesItemAgentActionsItemType3.from_dict(data)
                )
        ...
        extended_jobs_jobs_item_type_0_flow_status_modules_item = cls(
            type=type,
            id=id,
            job=job,
            count=count,
        ...
        extended_jobs_jobs_item_type_0_flow_status_modules_item.additional_properties = d
        return extended_jobs_jobs_item_type_0_flow_status_modules_item
