...
T = TypeVar("T", bound="OpenFlowValueModulesItemRetryConstant")


@_attrs_define
class OpenFlowValueModulesItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_value_modules_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        open_flow_value_modules_item_retry_constant.additional_properties = d
