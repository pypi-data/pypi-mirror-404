...
T = TypeVar("T", bound="GetJobResponse200Type0FlowStatusRetry")


@_attrs_define
class GetJobResponse200Type0FlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_0_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        get_job_response_200_type_0_flow_status_retry.additional_properties = d
        return get_job_response_200_type_0_flow_status_retry
