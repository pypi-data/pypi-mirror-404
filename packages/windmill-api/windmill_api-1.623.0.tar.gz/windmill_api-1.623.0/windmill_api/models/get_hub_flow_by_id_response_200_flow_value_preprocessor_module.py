...
if TYPE_CHECKING:
    from ..models.get_hub_flow_by_id_response_200_flow_value_preprocessor_module_mock import (
        GetHubFlowByIdResponse200FlowValuePreprocessorModuleMock,
    )
    ...
    from ..models.get_hub_flow_by_id_response_200_flow_value_preprocessor_module_stop_after_if import (
        GetHubFlowByIdResponse200FlowValuePreprocessorModuleStopAfterIf,
    )
    from ..models.get_hub_flow_by_id_response_200_flow_value_preprocessor_module_suspend import (
        GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspend,
    )
...
T = TypeVar("T", bound="GetHubFlowByIdResponse200FlowValuePreprocessorModule")


@_attrs_define
class GetHubFlowByIdResponse200FlowValuePreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleStopAfterIf]): Early termination
        ...
        mock (Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleRetry]): Retry configuration for failed
            module executions
    """

    id: str
    value: Any
    stop_after_if: Union[Unset, "GetHubFlowByIdResponse200FlowValuePreprocessorModuleStopAfterIf"] = UNSET
    ...
    mock: Union[Unset, "GetHubFlowByIdResponse200FlowValuePreprocessorModuleMock"] = UNSET
    suspend: Union[Unset, "GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspend"] = UNSET
    priority: Union[Unset, float] = UNSET
    continue_on_error: Union[Unset, bool] = UNSET
    retry: Union[Unset, "GetHubFlowByIdResponse200FlowValuePreprocessorModuleRetry"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.sleep, GetHubFlowByIdResponse200FlowValuePreprocessorModuleSleepType0):
            sleep = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_stop_after_if, Unset):
            ...
            stop_after_if = GetHubFlowByIdResponse200FlowValuePreprocessorModuleStopAfterIf.from_dict(_stop_after_if)
        ...
        if isinstance(_stop_after_all_iters_if, Unset):
            ...
            stop_after_all_iters_if = GetHubFlowByIdResponse200FlowValuePreprocessorModuleStopAfterAllItersIf.from_dict(
        ...
        def _parse_sleep(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _sleep_type_0 = data
                sleep_type_0: Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleSleepType0]
                if isinstance(_sleep_type_0, Unset):
                    sleep_type_0 = UNSET
                else:
                    sleep_type_0 = GetHubFlowByIdResponse200FlowValuePreprocessorModuleSleepType0.from_dict(
                        _sleep_type_0
                    )
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = GetHubFlowByIdResponse200FlowValuePreprocessorModuleTimeoutType0.from_dict(
                        _timeout_type_0
                    )
        ...
        mock: Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleMock]
        if isinstance(_mock, Unset):
            mock = UNSET
        else:
            mock = GetHubFlowByIdResponse200FlowValuePreprocessorModuleMock.from_dict(_mock)

        _suspend = d.pop("suspend", UNSET)
        suspend: Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspend]
        if isinstance(_suspend, Unset):
            suspend = UNSET
        else:
            suspend = GetHubFlowByIdResponse200FlowValuePreprocessorModuleSuspend.from_dict(_suspend)
        ...
        retry: Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModuleRetry]
        if isinstance(_retry, Unset):
            retry = UNSET
        else:
            retry = GetHubFlowByIdResponse200FlowValuePreprocessorModuleRetry.from_dict(_retry)

        get_hub_flow_by_id_response_200_flow_value_preprocessor_module = cls(
            id=id,
            value=value,
        ...
        get_hub_flow_by_id_response_200_flow_value_preprocessor_module.additional_properties = d
        return get_hub_flow_by_id_response_200_flow_value_preprocessor_module
