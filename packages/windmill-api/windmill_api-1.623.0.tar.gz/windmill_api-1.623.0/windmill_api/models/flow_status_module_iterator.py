...
T = TypeVar("T", bound="FlowStatusModuleIterator")


@_attrs_define
class FlowStatusModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_status_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        flow_status_module_iterator.additional_properties = d
        return flow_status_module_iterator
