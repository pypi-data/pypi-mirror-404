...
if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_agent_actions_item_type_0 import (
        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType0,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_agent_actions_item_type_1 import (
        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType1,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_agent_actions_item_type_2 import (
        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType2,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_0_flow_status_failure_module_agent_actions_item_type_3 import (
        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType3,
    )
...
class GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModule:
    ...
    Attributes:
        ...
        agent_actions (Union[Unset,
            List[Union['GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType0',
            'GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType1',
            'GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType2',
            'GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType3']]]):
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType0.from_dict(
                            data
                        )
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType1.from_dict(
                            data
                        )
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType2.from_dict(
                            data
                        )
                    )
                ...
                agent_actions_item_type_3 = (
                    GetSuspendedJobFlowResponse200JobType0FlowStatusFailureModuleAgentActionsItemType3.from_dict(data)
                )
