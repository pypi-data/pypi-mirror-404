...
T = TypeVar("T", bound="JobType0RawFlowModulesItemStopAfterIf")


@_attrs_define
class JobType0RawFlowModulesItemStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_0_raw_flow_modules_item_stop_after_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        job_type_0_raw_flow_modules_item_stop_after_if.additional_properties = d
        return job_type_0_raw_flow_modules_item_stop_after_if
