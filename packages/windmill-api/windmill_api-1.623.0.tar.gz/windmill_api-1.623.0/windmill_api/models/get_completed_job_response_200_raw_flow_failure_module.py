...
class GetCompletedJobResponse200RawFlowFailureModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetCompletedJobResponse200RawFlowFailureModuleStopAfterIf]): Early termination
            condition for a module
        stop_after_all_iters_if (Union[Unset, GetCompletedJobResponse200RawFlowFailureModuleStopAfterAllItersIf]): Early
            termination condition for a module
        skip_if (Union[Unset, GetCompletedJobResponse200RawFlowFailureModuleSkipIf]): Conditionally skip this step based
            on previous results or flow inputs
        sleep (Union['GetCompletedJobResponse200RawFlowFailureModuleSleepType0',
            'GetCompletedJobResponse200RawFlowFailureModuleSleepType1', Unset]): Maps input parameters for a step. Can be a
        ...
        timeout (Union['GetCompletedJobResponse200RawFlowFailureModuleTimeoutType0',
            'GetCompletedJobResponse200RawFlowFailureModuleTimeoutType1', Unset]): Maps input parameters for a step. Can be
        ...
        mock (Union[Unset, GetCompletedJobResponse200RawFlowFailureModuleMock]): Mock configuration for testing without
            executing the actual step
        suspend (Union[Unset, GetCompletedJobResponse200RawFlowFailureModuleSuspend]): Configuration for approval/resume
        ...
        retry (Union[Unset, GetCompletedJobResponse200RawFlowFailureModuleRetry]): Retry configuration for failed module
            executions
    """
