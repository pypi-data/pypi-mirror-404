...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_preprocessor_module_agent_actions_item_type_0 import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType0,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_preprocessor_module_agent_actions_item_type_1 import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType1,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_preprocessor_module_agent_actions_item_type_2 import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType2,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_1_flow_status_preprocessor_module_agent_actions_item_type_3 import (
        ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType3,
    )
...
class ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModule:
    ...
    Attributes:
        ...
        agent_actions (Union[Unset,
            List[Union['ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType0',
            'ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType1',
            'ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType2',
            'ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType3']]]):
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_0 = ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType0.from_dict(
                        data
                    )
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_1 = ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType1.from_dict(
                        data
                    )
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    agent_actions_item_type_2 = ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType2.from_dict(
                        data
                    )
                ...
                agent_actions_item_type_3 = (
                    ListExtendedJobsResponse200JobsItemType1FlowStatusPreprocessorModuleAgentActionsItemType3.from_dict(
                        data
                    )
                )
