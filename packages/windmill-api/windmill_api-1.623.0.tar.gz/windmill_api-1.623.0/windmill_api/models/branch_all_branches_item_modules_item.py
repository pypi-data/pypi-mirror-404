...
class BranchAllBranchesItemModulesItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, BranchAllBranchesItemModulesItemStopAfterIf]): Early termination condition for a
            module
        stop_after_all_iters_if (Union[Unset, BranchAllBranchesItemModulesItemStopAfterAllItersIf]): Early termination
            condition for a module
        skip_if (Union[Unset, BranchAllBranchesItemModulesItemSkipIf]): Conditionally skip this step based on previous
        ...
        mock (Union[Unset, BranchAllBranchesItemModulesItemMock]): Mock configuration for testing without executing the
            actual step
        suspend (Union[Unset, BranchAllBranchesItemModulesItemSuspend]): Configuration for approval/resume steps that
            wait for user input
        ...
        retry (Union[Unset, BranchAllBranchesItemModulesItemRetry]): Retry configuration for failed module executions
    """
