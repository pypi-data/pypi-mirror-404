...
T = TypeVar("T", bound="JobType0FlowStatusModulesItemIterator")


@_attrs_define
class JobType0FlowStatusModulesItemIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_0_flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        job_type_0_flow_status_modules_item_iterator.additional_properties = d
        return job_type_0_flow_status_modules_item_iterator
