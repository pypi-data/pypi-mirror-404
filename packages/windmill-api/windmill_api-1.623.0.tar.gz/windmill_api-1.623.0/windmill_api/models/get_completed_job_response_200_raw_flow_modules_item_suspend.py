...
class GetCompletedJobResponse200RawFlowModulesItemSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSuspendResumeForm]): Form schema for
        ...
        user_groups_required (Union['GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0',
            'GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for
