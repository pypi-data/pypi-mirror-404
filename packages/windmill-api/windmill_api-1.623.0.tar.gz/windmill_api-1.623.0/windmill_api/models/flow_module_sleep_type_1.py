...
from ..models.flow_module_sleep_type_1_type import FlowModuleSleepType1Type

T = TypeVar("T", bound="FlowModuleSleepType1")


@_attrs_define
class FlowModuleSleepType1:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = FlowModuleSleepType1Type(d.pop("type"))

        flow_module_sleep_type_1 = cls(
            expr=expr,
            type=type,
        )

        flow_module_sleep_type_1.additional_properties = d
        return flow_module_sleep_type_1
