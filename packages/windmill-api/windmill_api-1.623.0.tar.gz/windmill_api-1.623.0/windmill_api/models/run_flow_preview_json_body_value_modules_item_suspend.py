...
class RunFlowPreviewJsonBodyValueModulesItemSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, RunFlowPreviewJsonBodyValueModulesItemSuspendResumeForm]): Form schema for collecting
            input when resuming
        ...
        user_groups_required (Union['RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0',
            'RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a
