...
T = TypeVar("T", bound="ListCompletedJobsResponse200ItemRawFlowFailureModuleRetryExponential")


@_attrs_define
class ListCompletedJobsResponse200ItemRawFlowFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_completed_jobs_response_200_item_raw_flow_failure_module_retry_exponential = cls(
            attempts=attempts,
