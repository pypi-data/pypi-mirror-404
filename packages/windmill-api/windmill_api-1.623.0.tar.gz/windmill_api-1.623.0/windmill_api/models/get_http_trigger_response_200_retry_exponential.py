...
T = TypeVar("T", bound="GetHttpTriggerResponse200RetryExponential")


@_attrs_define
class GetHttpTriggerResponse200RetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_http_trigger_response_200_retry_exponential = cls(
            attempts=attempts,
        ...
        get_http_trigger_response_200_retry_exponential.additional_properties = d
        return get_http_trigger_response_200_retry_exponential
