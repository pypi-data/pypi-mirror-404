...
T = TypeVar("T", bound="GetCompletedJobResponse200RawFlowPreprocessorModuleRetryExponential")


@_attrs_define
class GetCompletedJobResponse200RawFlowPreprocessorModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_completed_job_response_200_raw_flow_preprocessor_module_retry_exponential = cls(
            attempts=attempts,
        ...
        get_completed_job_response_200_raw_flow_preprocessor_module_retry_exponential.additional_properties = d
        return get_completed_job_response_200_raw_flow_preprocessor_module_retry_exponential
