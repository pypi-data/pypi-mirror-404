...
T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType1FlowStatusRetry")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType1FlowStatusRetry:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_extended_jobs_response_200_jobs_item_type_1_flow_status_retry = cls(
            fail_count=fail_count,
            failed_jobs=failed_jobs,
        )

        list_extended_jobs_response_200_jobs_item_type_1_flow_status_retry.additional_properties = d
        return list_extended_jobs_response_200_jobs_item_type_1_flow_status_retry
