...
if TYPE_CHECKING:
    ...
    from ..models.get_flow_version_response_200_value_flow_env import GetFlowVersionResponse200ValueFlowEnv
    from ..models.get_flow_version_response_200_value_modules_item import GetFlowVersionResponse200ValueModulesItem
    from ..models.get_flow_version_response_200_value_notes_item import GetFlowVersionResponse200ValueNotesItem
...
class GetFlowVersionResponse200Value:
    ...
    Attributes:
        modules (List['GetFlowVersionResponse200ValueModulesItem']): Array of steps that execute in sequence. Each step
            can be a script, subflow, loop, or branch
        failure_module (Union[Unset, GetFlowVersionResponse200ValueFailureModule]): A single step in a flow. Can be a
            script, subflow, loop, or branch
        preprocessor_module (Union[Unset, GetFlowVersionResponse200ValuePreprocessorModule]): A single step in a flow.
            Can be a script, subflow, loop, or branch
        ...
        flow_env (Union[Unset, GetFlowVersionResponse200ValueFlowEnv]): Environment variables available to all steps
        ...
        notes (Union[Unset, List['GetFlowVersionResponse200ValueNotesItem']]): Sticky notes attached to the flow
    """
    ...
    flow_env: Union[Unset, "GetFlowVersionResponse200ValueFlowEnv"] = UNSET
    priority: Union[Unset, float] = UNSET
    early_return: Union[Unset, str] = UNSET
    chat_input_enabled: Union[Unset, bool] = UNSET
    notes: Union[Unset, List["GetFlowVersionResponse200ValueNotesItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_env: Union[Unset, GetFlowVersionResponse200ValueFlowEnv]
        if isinstance(_flow_env, Unset):
            flow_env = UNSET
        else:
            flow_env = GetFlowVersionResponse200ValueFlowEnv.from_dict(_flow_env)
        ...
        for notes_item_data in _notes or []:
            notes_item = GetFlowVersionResponse200ValueNotesItem.from_dict(notes_item_data)
