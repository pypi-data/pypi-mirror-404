...
from ..models.get_job_response_200_type_0_flow_status_preprocessor_module_type import (
    GetJobResponse200Type0FlowStatusPreprocessorModuleType,
)
...
if TYPE_CHECKING:
    ...
    from ..models.get_job_response_200_type_0_flow_status_preprocessor_module_agent_actions_item_type_2 import (
        GetJobResponse200Type0FlowStatusPreprocessorModuleAgentActionsItemType2,
    )
    from ..models.get_job_response_200_type_0_flow_status_preprocessor_module_agent_actions_item_type_3 import (
        GetJobResponse200Type0FlowStatusPreprocessorModuleAgentActionsItemType3,
    )
    ...
    from ..models.get_job_response_200_type_0_flow_status_preprocessor_module_branch_chosen import (
        GetJobResponse200Type0FlowStatusPreprocessorModuleBranchChosen,
    )
...
T = TypeVar("T", bound="GetJobResponse200Type0FlowStatusPreprocessorModule")


@_attrs_define
class GetJobResponse200Type0FlowStatusPreprocessorModule:
    """
    Attributes:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    ...
                    agent_actions_item_data, GetJobResponse200Type0FlowStatusPreprocessorModuleAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, GetJobResponse200Type0FlowStatusPreprocessorModuleAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = GetJobResponse200Type0FlowStatusPreprocessorModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = GetJobResponse200Type0FlowStatusPreprocessorModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = GetJobResponse200Type0FlowStatusPreprocessorModuleBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = GetJobResponse200Type0FlowStatusPreprocessorModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = GetJobResponse200Type0FlowStatusPreprocessorModuleApproversItem.from_dict(
                approvers_item_data
            )
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        GetJobResponse200Type0FlowStatusPreprocessorModuleAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    GetJobResponse200Type0FlowStatusPreprocessorModuleAgentActionsItemType3.from_dict(data)
                )
        ...
        return get_job_response_200_type_0_flow_status_preprocessor_module
