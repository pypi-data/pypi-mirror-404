...
if TYPE_CHECKING:
    from ..models.flow_preview_value_preprocessor_module_suspend_resume_form import (
        FlowPreviewValuePreprocessorModuleSuspendResumeForm,
    )
    from ..models.flow_preview_value_preprocessor_module_suspend_user_groups_required_type_0 import (
        FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.flow_preview_value_preprocessor_module_suspend_user_groups_required_type_1 import (
        FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="FlowPreviewValuePreprocessorModuleSuspend")


@_attrs_define
class FlowPreviewValuePreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, FlowPreviewValuePreprocessorModuleSuspendResumeForm]): Form schema for collecting
            input when resuming
        user_auth_required (Union[Unset, bool]): If true, only authenticated users can approve
        user_groups_required (Union['FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType0',
            'FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input parameters for a step.
    ...
    resume_form: Union[Unset, "FlowPreviewValuePreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, FlowPreviewValuePreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = FlowPreviewValuePreprocessorModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[Unset, FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    FlowPreviewValuePreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        flow_preview_value_preprocessor_module_suspend = cls(
        ...
        flow_preview_value_preprocessor_module_suspend.additional_properties = d
        return flow_preview_value_preprocessor_module_suspend
