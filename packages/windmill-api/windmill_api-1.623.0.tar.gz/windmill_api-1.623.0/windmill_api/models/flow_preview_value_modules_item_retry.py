...
if TYPE_CHECKING:
    ...
    from ..models.flow_preview_value_modules_item_retry_retry_if import FlowPreviewValueModulesItemRetryRetryIf
...
class FlowPreviewValueModulesItemRetry:
    ...
    retry_if: Union[Unset, "FlowPreviewValueModulesItemRetryRetryIf"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_retry_if, Unset):
            ...
            retry_if = FlowPreviewValueModulesItemRetryRetryIf.from_dict(_retry_if)
