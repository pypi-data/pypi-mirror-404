...
from ..models.job_type_0_raw_flow_failure_module_sleep_type_1_type import JobType0RawFlowFailureModuleSleepType1Type

T = TypeVar("T", bound="JobType0RawFlowFailureModuleSleepType1")
...
class JobType0RawFlowFailureModuleSleepType1:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type = JobType0RawFlowFailureModuleSleepType1Type(d.pop("type"))

        job_type_0_raw_flow_failure_module_sleep_type_1 = cls(
            expr=expr,
            type=type,
        )

        job_type_0_raw_flow_failure_module_sleep_type_1.additional_properties = d
        return job_type_0_raw_flow_failure_module_sleep_type_1
