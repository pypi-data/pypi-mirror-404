...
if TYPE_CHECKING:
    ...
    from ..models.queued_job_raw_flow_modules_item_retry_retry_if import QueuedJobRawFlowModulesItemRetryRetryIf
...
class QueuedJobRawFlowModulesItemRetry:
    ...
    Attributes:
        constant (Union[Unset, QueuedJobRawFlowModulesItemRetryConstant]): Retry with constant delay between attempts
        exponential (Union[Unset, QueuedJobRawFlowModulesItemRetryExponential]): Retry with exponential backoff (delay
            doubles each time)
        retry_if (Union[Unset, QueuedJobRawFlowModulesItemRetryRetryIf]): Conditional retry based on error or result
    """
    ...
    retry_if: Union[Unset, "QueuedJobRawFlowModulesItemRetryRetryIf"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.queued_job_raw_flow_modules_item_retry_constant import QueuedJobRawFlowModulesItemRetryConstant
        from ..models.queued_job_raw_flow_modules_item_retry_exponential import (
            QueuedJobRawFlowModulesItemRetryExponential,
        )
        from ..models.queued_job_raw_flow_modules_item_retry_retry_if import QueuedJobRawFlowModulesItemRetryRetryIf
        ...
        retry_if: Union[Unset, QueuedJobRawFlowModulesItemRetryRetryIf]
        if isinstance(_retry_if, Unset):
            retry_if = UNSET
        else:
            retry_if = QueuedJobRawFlowModulesItemRetryRetryIf.from_dict(_retry_if)
