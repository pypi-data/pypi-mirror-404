...
T = TypeVar("T", bound="OpenFlowWPathValueModulesItemRetryConstant")


@_attrs_define
class OpenFlowWPathValueModulesItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_flow_w_path_value_modules_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        open_flow_w_path_value_modules_item_retry_constant.additional_properties = d
