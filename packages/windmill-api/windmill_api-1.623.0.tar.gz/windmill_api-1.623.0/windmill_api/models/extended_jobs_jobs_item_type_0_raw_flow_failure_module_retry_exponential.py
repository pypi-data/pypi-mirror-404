...
T = TypeVar("T", bound="ExtendedJobsJobsItemType0RawFlowFailureModuleRetryExponential")


@_attrs_define
class ExtendedJobsJobsItemType0RawFlowFailureModuleRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_0_raw_flow_failure_module_retry_exponential = cls(
            attempts=attempts,
        ...
        extended_jobs_jobs_item_type_0_raw_flow_failure_module_retry_exponential.additional_properties = d
        return extended_jobs_jobs_item_type_0_raw_flow_failure_module_retry_exponential
