...
T = TypeVar("T", bound="CreateMqttTriggerJsonBodyRetryConstant")


@_attrs_define
class CreateMqttTriggerJsonBodyRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_mqtt_trigger_json_body_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        create_mqtt_trigger_json_body_retry_constant.additional_properties = d
        return create_mqtt_trigger_json_body_retry_constant
