...
T = TypeVar("T", bound="GetCompletedJobResponse200RawFlowPreprocessorModuleStopAfterAllItersIf")


@_attrs_define
class GetCompletedJobResponse200RawFlowPreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_completed_job_response_200_raw_flow_preprocessor_module_stop_after_all_iters_if
