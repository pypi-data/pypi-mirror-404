...
from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_type import (
    ListJobsResponse200ItemType0FlowStatusFailureModuleType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_agent_actions_item_type_0 import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType0,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_agent_actions_item_type_1 import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType1,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_agent_actions_item_type_2 import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType2,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_agent_actions_item_type_3 import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType3,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_approvers_item import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleApproversItem,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_branch_chosen import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleBranchChosen,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_branchall import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleBranchall,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_flow_jobs_duration import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleFlowJobsDuration,
    )
    from ..models.list_jobs_response_200_item_type_0_flow_status_failure_module_iterator import (
        ListJobsResponse200ItemType0FlowStatusFailureModuleIterator,
    )


T = TypeVar("T", bound="ListJobsResponse200ItemType0FlowStatusFailureModule")


@_attrs_define
class ListJobsResponse200ItemType0FlowStatusFailureModule:
    """
    Attributes:
        type (ListJobsResponse200ItemType0FlowStatusFailureModuleType):
        id (Union[Unset, str]):
        job (Union[Unset, str]):
        ...
        flow_jobs_duration (Union[Unset, ListJobsResponse200ItemType0FlowStatusFailureModuleFlowJobsDuration]):
        ...
        agent_actions (Union[Unset,
            List[Union['ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType0',
            'ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType1',
            'ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType2',
            'ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType3']]]):
    ...
    flow_jobs_duration: Union[Unset, "ListJobsResponse200ItemType0FlowStatusFailureModuleFlowJobsDuration"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.agent_actions, Unset):
            ...
            for agent_actions_item_data in self.agent_actions:
                ...
                if isinstance(
                    agent_actions_item_data, ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType0
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType1
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()

                elif isinstance(
                    agent_actions_item_data, ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType2
                ):
                    agent_actions_item = agent_actions_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        type = ListJobsResponse200ItemType0FlowStatusFailureModuleType(d.pop("type"))
        ...
        if isinstance(_iterator, Unset):
            ...
            iterator = ListJobsResponse200ItemType0FlowStatusFailureModuleIterator.from_dict(_iterator)
        ...
        if isinstance(_flow_jobs_duration, Unset):
            ...
            flow_jobs_duration = ListJobsResponse200ItemType0FlowStatusFailureModuleFlowJobsDuration.from_dict(
                _flow_jobs_duration
            )
        ...
        if isinstance(_branch_chosen, Unset):
            ...
            branch_chosen = ListJobsResponse200ItemType0FlowStatusFailureModuleBranchChosen.from_dict(_branch_chosen)
        ...
        if isinstance(_branchall, Unset):
            ...
            branchall = ListJobsResponse200ItemType0FlowStatusFailureModuleBranchall.from_dict(_branchall)

        approvers = []
        _approvers = d.pop("approvers", UNSET)
        for approvers_item_data in _approvers or []:
            approvers_item = ListJobsResponse200ItemType0FlowStatusFailureModuleApproversItem.from_dict(
                approvers_item_data
            )
            ...
            def _parse_agent_actions_item(
                ...
                try:
                    ...
                    agent_actions_item_type_0 = (
                        ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType0.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_1 = (
                        ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType1.from_dict(data)
                    )
                ...
                try:
                    ...
                    agent_actions_item_type_2 = (
                        ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType2.from_dict(data)
                    )
                ...
                agent_actions_item_type_3 = (
                    ListJobsResponse200ItemType0FlowStatusFailureModuleAgentActionsItemType3.from_dict(data)
                )
        ...
        list_jobs_response_200_item_type_0_flow_status_failure_module = cls(
            type=type,
            id=id,
            job=job,
            count=count,
        ...
        list_jobs_response_200_item_type_0_flow_status_failure_module.additional_properties = d
        return list_jobs_response_200_item_type_0_flow_status_failure_module
