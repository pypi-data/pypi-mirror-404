...
from ..models.branch_one_branches_item_modules_item_suspend_user_groups_required_type_1_type import (
    BranchOneBranchesItemModulesItemSuspendUserGroupsRequiredType1Type,
)
