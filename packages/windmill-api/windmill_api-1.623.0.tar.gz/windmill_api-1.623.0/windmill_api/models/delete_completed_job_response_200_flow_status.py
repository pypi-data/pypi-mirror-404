...
if TYPE_CHECKING:
    ...
    from ..models.delete_completed_job_response_200_flow_status_preprocessor_module import (
        DeleteCompletedJobResponse200FlowStatusPreprocessorModule,
    )
...
class DeleteCompletedJobResponse200FlowStatus:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, DeleteCompletedJobResponse200FlowStatusPreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "DeleteCompletedJobResponse200FlowStatusPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = DeleteCompletedJobResponse200FlowStatusPreprocessorModule.from_dict(
