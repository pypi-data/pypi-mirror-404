...
T = TypeVar("T", bound="JobType1RawFlowModulesItemRetryConstant")


@_attrs_define
class JobType1RawFlowModulesItemRetryConstant:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_1_raw_flow_modules_item_retry_constant = cls(
            attempts=attempts,
            seconds=seconds,
        )

        job_type_1_raw_flow_modules_item_retry_constant.additional_properties = d
        return job_type_1_raw_flow_modules_item_retry_constant
