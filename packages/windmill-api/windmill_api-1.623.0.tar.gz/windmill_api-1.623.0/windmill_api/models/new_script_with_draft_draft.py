...
if TYPE_CHECKING:
    from ..models.new_script_with_draft_draft_assets_item import NewScriptWithDraftDraftAssetsItem
...
class NewScriptWithDraftDraft:
    ...
    Attributes:
        ...
        assets (Union[Unset, List['NewScriptWithDraftDraftAssetsItem']]):
    """
    ...
    assets: Union[Unset, List["NewScriptWithDraftDraftAssetsItem"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for assets_item_data in _assets or []:
            assets_item = NewScriptWithDraftDraftAssetsItem.from_dict(assets_item_data)
