...
T = TypeVar("T", bound="ExtendedJobsJobsItemType1FlowStatusFailureModuleIterator")


@_attrs_define
class ExtendedJobsJobsItemType1FlowStatusFailureModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extended_jobs_jobs_item_type_1_flow_status_failure_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        extended_jobs_jobs_item_type_1_flow_status_failure_module_iterator.additional_properties = d
        return extended_jobs_jobs_item_type_1_flow_status_failure_module_iterator
