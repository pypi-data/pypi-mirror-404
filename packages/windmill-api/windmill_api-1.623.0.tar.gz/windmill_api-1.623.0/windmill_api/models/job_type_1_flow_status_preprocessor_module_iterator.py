...
T = TypeVar("T", bound="JobType1FlowStatusPreprocessorModuleIterator")


@_attrs_define
class JobType1FlowStatusPreprocessorModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        job_type_1_flow_status_preprocessor_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        job_type_1_flow_status_preprocessor_module_iterator.additional_properties = d
        return job_type_1_flow_status_preprocessor_module_iterator
