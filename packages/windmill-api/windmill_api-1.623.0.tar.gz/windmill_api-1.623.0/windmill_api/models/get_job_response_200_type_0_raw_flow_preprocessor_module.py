...
if TYPE_CHECKING:
    ...
    from ..models.get_job_response_200_type_0_raw_flow_preprocessor_module_timeout_type_0 import (
        GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType0,
    )
    from ..models.get_job_response_200_type_0_raw_flow_preprocessor_module_timeout_type_1 import (
        GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType1,
    )
...
class GetJobResponse200Type0RawFlowPreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleStopAfterIf]): Early termination
        ...
        skip_if (Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleSkipIf]): Conditionally skip this step
            based on previous results or flow inputs
        sleep (Union['GetJobResponse200Type0RawFlowPreprocessorModuleSleepType0',
            'GetJobResponse200Type0RawFlowPreprocessorModuleSleepType1', Unset]): Maps input parameters for a step. Can be a
        ...
        timeout (Union['GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType0',
            'GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType1', Unset]): Maps input parameters for a step. Can be
        ...
        mock (Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleMock]): Mock configuration for testing without
            executing the actual step
        suspend (Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleRetry]): Retry configuration for failed
            module executions
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.timeout, GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType0):
            timeout = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_timeout(
            ...
            try:
                ...
                timeout_type_0: Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType0]
                if isinstance(_timeout_type_0, Unset):
                    timeout_type_0 = UNSET
                else:
                    timeout_type_0 = GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType0.from_dict(
                        _timeout_type_0
                    )
            ...
            timeout_type_1: Union[Unset, GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType1]
            if isinstance(_timeout_type_1, Unset):
                timeout_type_1 = UNSET
            else:
                timeout_type_1 = GetJobResponse200Type0RawFlowPreprocessorModuleTimeoutType1.from_dict(_timeout_type_1)
