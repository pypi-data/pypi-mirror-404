...
class FlowPreviewValueModulesItem:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, FlowPreviewValueModulesItemStopAfterIf]): Early termination condition for a module
        stop_after_all_iters_if (Union[Unset, FlowPreviewValueModulesItemStopAfterAllItersIf]): Early termination
        ...
        mock (Union[Unset, FlowPreviewValueModulesItemMock]): Mock configuration for testing without executing the
            actual step
        suspend (Union[Unset, FlowPreviewValueModulesItemSuspend]): Configuration for approval/resume steps that wait
            for user input
        ...
        retry (Union[Unset, FlowPreviewValueModulesItemRetry]): Retry configuration for failed module executions
    """
