...
T = TypeVar("T", bound="GetHubFlowByIdResponse200FlowValuePreprocessorModuleStopAfterIf")


@_attrs_define
class GetHubFlowByIdResponse200FlowValuePreprocessorModuleStopAfterIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return get_hub_flow_by_id_response_200_flow_value_preprocessor_module_stop_after_if
