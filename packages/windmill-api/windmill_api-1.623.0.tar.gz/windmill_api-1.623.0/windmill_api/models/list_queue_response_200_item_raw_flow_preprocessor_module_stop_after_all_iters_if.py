...
T = TypeVar("T", bound="ListQueueResponse200ItemRawFlowPreprocessorModuleStopAfterAllItersIf")


@_attrs_define
class ListQueueResponse200ItemRawFlowPreprocessorModuleStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return list_queue_response_200_item_raw_flow_preprocessor_module_stop_after_all_iters_if
