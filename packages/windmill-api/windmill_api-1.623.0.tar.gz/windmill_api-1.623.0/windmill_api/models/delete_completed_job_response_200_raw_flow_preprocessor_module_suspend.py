...
if TYPE_CHECKING:
    from ..models.delete_completed_job_response_200_raw_flow_preprocessor_module_suspend_resume_form import (
        DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendResumeForm,
    )
    from ..models.delete_completed_job_response_200_raw_flow_preprocessor_module_suspend_user_groups_required_type_0 import (
        DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0,
    )
    from ..models.delete_completed_job_response_200_raw_flow_preprocessor_module_suspend_user_groups_required_type_1 import (
        DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1,
    )


T = TypeVar("T", bound="DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspend")


@_attrs_define
class DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspend:
    ...
    Attributes:
        ...
        resume_form (Union[Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendResumeForm]): Form schema
            for collecting input when resuming
        user_auth_required (Union[Unset, bool]): If true, only authenticated users can approve
        user_groups_required
            (Union['DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0',
            'DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1', Unset]): Maps input
    ...
    resume_form: Union[Unset, "DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendResumeForm"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resume_form: Union[Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendResumeForm]
        if isinstance(_resume_form, Unset):
            resume_form = UNSET
        else:
            resume_form = DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendResumeForm.from_dict(
                _resume_form
            )
        ...
        def _parse_user_groups_required(
            ...
            try:
                ...
                user_groups_required_type_0: Union[
                    Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0
                ]
                if isinstance(_user_groups_required_type_0, Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = (
                        DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendUserGroupsRequiredType0.from_dict(
            ...
            user_groups_required_type_1: Union[
                Unset, DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1
            ]
            if isinstance(_user_groups_required_type_1, Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = (
                    DeleteCompletedJobResponse200RawFlowPreprocessorModuleSuspendUserGroupsRequiredType1.from_dict(
        ...
        delete_completed_job_response_200_raw_flow_preprocessor_module_suspend = cls(
        ...
        delete_completed_job_response_200_raw_flow_preprocessor_module_suspend.additional_properties = d
        return delete_completed_job_response_200_raw_flow_preprocessor_module_suspend
