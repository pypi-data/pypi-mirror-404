...
T = TypeVar("T", bound="FlowStatusPreprocessorModuleIterator")


@_attrs_define
class FlowStatusPreprocessorModuleIterator:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_status_preprocessor_module_iterator = cls(
            index=index,
            itered=itered,
        ...
        flow_status_preprocessor_module_iterator.additional_properties = d
        return flow_status_preprocessor_module_iterator
