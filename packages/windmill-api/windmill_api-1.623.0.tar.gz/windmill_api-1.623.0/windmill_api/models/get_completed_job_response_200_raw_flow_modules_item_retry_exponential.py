...
T = TypeVar("T", bound="GetCompletedJobResponse200RawFlowModulesItemRetryExponential")


@_attrs_define
class GetCompletedJobResponse200RawFlowModulesItemRetryExponential:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_completed_job_response_200_raw_flow_modules_item_retry_exponential = cls(
            attempts=attempts,
        ...
        get_completed_job_response_200_raw_flow_modules_item_retry_exponential.additional_properties = d
