...
T = TypeVar("T", bound="ListCompletedJobsResponse200ItemFlowStatusModulesItemIterator")
...
class ListCompletedJobsResponse200ItemFlowStatusModulesItemIterator:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_completed_jobs_response_200_item_flow_status_modules_item_iterator = cls(
            index=index,
            itered=itered,
        ...
        list_completed_jobs_response_200_item_flow_status_modules_item_iterator.additional_properties = d
