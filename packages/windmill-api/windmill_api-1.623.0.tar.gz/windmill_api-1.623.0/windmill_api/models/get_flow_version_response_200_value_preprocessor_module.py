...
class GetFlowVersionResponse200ValuePreprocessorModule:
    ...
    Attributes:
        ...
        value (Any):
        stop_after_if (Union[Unset, GetFlowVersionResponse200ValuePreprocessorModuleStopAfterIf]): Early termination
        ...
        skip_if (Union[Unset, GetFlowVersionResponse200ValuePreprocessorModuleSkipIf]): Conditionally skip this step
            based on previous results or flow inputs
        sleep (Union['GetFlowVersionResponse200ValuePreprocessorModuleSleepType0',
            'GetFlowVersionResponse200ValuePreprocessorModuleSleepType1', Unset]): Maps input parameters for a step. Can be
        ...
        timeout (Union['GetFlowVersionResponse200ValuePreprocessorModuleTimeoutType0',
            'GetFlowVersionResponse200ValuePreprocessorModuleTimeoutType1', Unset]): Maps input parameters for a step. Can
        ...
        mock (Union[Unset, GetFlowVersionResponse200ValuePreprocessorModuleMock]): Mock configuration for testing
            without executing the actual step
        suspend (Union[Unset, GetFlowVersionResponse200ValuePreprocessorModuleSuspend]): Configuration for
        ...
        retry (Union[Unset, GetFlowVersionResponse200ValuePreprocessorModuleRetry]): Retry configuration for failed
            module executions
    """
