...
T = TypeVar("T", bound="GetJobResponse200Type0RawFlowModulesItemStopAfterAllItersIf")


@_attrs_define
class GetJobResponse200Type0RawFlowModulesItemStopAfterAllItersIf:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_job_response_200_type_0_raw_flow_modules_item_stop_after_all_iters_if = cls(
            expr=expr,
            skip_if_stopped=skip_if_stopped,
            error_message=error_message,
        )

        get_job_response_200_type_0_raw_flow_modules_item_stop_after_all_iters_if.additional_properties = d
        return get_job_response_200_type_0_raw_flow_modules_item_stop_after_all_iters_if
