...
class TimelineNode(ABC):
    ...
    *This class has to be inherited by any class that is
    ...
    def __init__(
        self,
        # TODO: We need a reference to the Timeline to know fps
        name: str,
        ...
        # TODO: Validate 'parameters' as dict of 
        # 'str': VideoEditorParameter
    ...
    # TODO: Review this and with the context
    def _evaluate_parameters(
        ...
        *For internal use only*
        ...
        # TODO: Create the context as we do in 'yta_editor'
        # TODO: Move this to top
        from yta_editor_parameters.context import VideoEditorEvaluationContext
        # from yta_editor_parameters.context.utils import get_evaluation_context

        # evaluation_context = get_evaluation_context(
        #     t_track = t_timeline,
        #     t_start_item = self.t_start,
        #     t_end_item = self.t_end,
        #     # TODO: Need reference to Timeline
        #     # fps = self._timeline.fps,
        #     # track_duration = self._timeline.duration
        # )

        evaluation_context = VideoEditorEvaluationContext(
            t_normalized = t_local_normalized
        )

        for key, parameter in self.parameters.items():
            parameters_values[key] = parameter.evaluate(evaluation_context)

            # from yta_editor_nodes.timeline.parameter.evaluation_context import EvaluationContext

            # parameters_values[key] = parameter.evaluate(
