...
inline data_flow::LibraryNodeCode LibraryNodeType_Malloc("Malloc");

class MallocNode : public data_flow::LibraryNode {
private:
...
class MallocNodeDispatcher : public codegen::LibraryNodeDispatcher {
public:
    MallocNodeDispatcher(
