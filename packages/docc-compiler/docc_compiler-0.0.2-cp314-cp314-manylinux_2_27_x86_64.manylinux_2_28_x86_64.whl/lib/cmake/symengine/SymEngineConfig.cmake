...
if(SYMENGINE_BUILD_TREE)
    ...
    set(SYMENGINE_INCLUDE_DIRS /project/sdfg/3rdParty/symengine;/tmp/tmpkvwg3hqg/build/sdfg/3rdParty/symengine;/project/sdfg/3rdParty/symengine/symengine/utilities/cereal/include ${SYMENGINE_CMAKE_DIR})
    if (TARGET teuchos)
        set(SYMENGINE_INCLUDE_DIRS ${SYMENGINE_INCLUDE_DIRS} ${SYMENGINE_CMAKE_DIR}/symengine/utilities/teuchos)
    endif()
else()
    set(SYMENGINE_INSTALL_CMAKE_DIR "/tmp/tmpkvwg3hqg/wheel/platlib/lib/cmake/symengine")
