...
inline data_flow::LibraryNodeCode LibraryNodeType_Maximum("ml::Maximum");

class MaximumNode : public ElementWiseBinaryNode {
public:
    MaximumNode(
        size_t element_id,
...
typedef ElementWiseBinaryNodeSerializer<MaximumNode> MaximumNodeSerializer;
