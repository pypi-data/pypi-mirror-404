...
inline data_flow::LibraryNodeCode LibraryNodeType_Calloc("Calloc");

class CallocNode : public data_flow::LibraryNode {
private:
...
class CallocNodeSerializer : public serializer::LibraryNodeSerializer {
public:
...
class CallocNodeDispatcher : public codegen::LibraryNodeDispatcher {
public:
    CallocNodeDispatcher(
