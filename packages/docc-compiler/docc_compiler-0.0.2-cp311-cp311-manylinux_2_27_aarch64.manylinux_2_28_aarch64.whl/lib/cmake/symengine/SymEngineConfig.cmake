...
if(SYMENGINE_BUILD_TREE)
    ...
    set(SYMENGINE_INCLUDE_DIRS /project/sdfg/3rdParty/symengine;/tmp/tmpprjj1k6_/build/sdfg/3rdParty/symengine;/project/sdfg/3rdParty/symengine/symengine/utilities/cereal/include ${SYMENGINE_CMAKE_DIR})
    if (TARGET teuchos)
        set(SYMENGINE_INCLUDE_DIRS ${SYMENGINE_INCLUDE_DIRS} ${SYMENGINE_CMAKE_DIR}/symengine/utilities/teuchos)
    endif()
else()
    set(SYMENGINE_INSTALL_CMAKE_DIR "/tmp/tmpprjj1k6_/wheel/platlib/lib/cmake/symengine")
