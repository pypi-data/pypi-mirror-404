...
Welcome to `uniovi-simur-wearablepermed-ml` contributor's guide.
...
If you experience bugs or general issues with `uniovi-simur-wearablepermed-ml`, please have a look
...
You can help improve `uniovi-simur-wearablepermed-ml` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`uniovi-simur-wearablepermed-ml` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `uniovi-simur-wearablepermed-ml`'s files. While this mechanism can
...
```
conda create -n uniovi-simur-wearablepermed-ml python=3 six virtualenv pytest pytest-cov
conda activate uniovi-simur-wearablepermed-ml
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/uniovi-simur-wearablepermed-ml.git
...
5. Install [pre-commit]:
   ...
   `uniovi-simur-wearablepermed-ml` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/uniovi-simur-wearablepermed-ml
[issue tracker]: https://github.com/<USERNAME>/uniovi-simur-wearablepermed-ml/issues
