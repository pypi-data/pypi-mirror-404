...
from centurion.models.meta import GitLabRepositoryCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'GitLabRepositoryModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = GitLabRepositoryCenturionModelNote
...
@extend_schema_serializer(component_name = 'GitLabRepositoryViewSerializer')
