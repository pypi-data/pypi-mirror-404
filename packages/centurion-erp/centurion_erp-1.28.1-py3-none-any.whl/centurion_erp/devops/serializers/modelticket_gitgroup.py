...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    GitGroupTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'GitGroupTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'GitGroupTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """GitGroupTicket Base View Model"""
