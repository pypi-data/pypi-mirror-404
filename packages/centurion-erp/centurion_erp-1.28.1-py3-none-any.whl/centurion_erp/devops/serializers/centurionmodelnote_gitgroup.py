...
from centurion.models.meta import GitGroupCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
class ModelSerializer(
    ...
    class Meta:
        ...
        model = GitGroupCenturionModelNote
