...
from centurion.models.meta import GitHubRepositoryCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'GitHubRepositoryModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = GitHubRepositoryCenturionModelNote
...
@extend_schema_serializer(component_name = 'GitHubRepositoryViewSerializer')
