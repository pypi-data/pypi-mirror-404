...
from centurion.models.meta import ServiceCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'ServiceModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = ServiceCenturionModelNote
...
@extend_schema_serializer(component_name = 'ServiceModelNoteViewSerializer')
