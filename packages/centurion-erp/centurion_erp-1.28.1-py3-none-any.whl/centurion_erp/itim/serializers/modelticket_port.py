...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    PortTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'PortTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'PortTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """PortTicket Base View Model"""
