...
from centurion.models.meta import EmployeeCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'EmployeeModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = EmployeeCenturionModelNote
...
@extend_schema_serializer(component_name = 'EmployeeModelNoteViewSerializer')
