...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    TicketCategoryTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'TicketCategoryTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'TicketCategoryTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """TicketCategoryTicket Base View Model"""
