...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    TicketCommentCategoryTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'TicketCommentCategoryTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'TicketCommentCategoryTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """TicketCommentCategoryTicket Base View Model"""
