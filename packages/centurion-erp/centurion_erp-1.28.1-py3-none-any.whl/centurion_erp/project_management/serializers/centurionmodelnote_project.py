...
from centurion.models.meta import ProjectCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'ProjectModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = ProjectCenturionModelNote
...
@extend_schema_serializer(component_name = 'ProjectModelNoteViewSerializer')
