...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    ProjectTypeTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'ProjectTypeTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'ProjectTypeTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """ProjectTypeTicket Base View Model"""
