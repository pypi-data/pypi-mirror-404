...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    DeviceTypeTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'DeviceTypeTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'DeviceTypeTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """DeviceTypeTicket Base View Model"""
