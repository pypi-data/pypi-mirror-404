...
from centurion.models.meta import SoftwareCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'SoftwareModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = SoftwareCenturionModelNote
...
@extend_schema_serializer(component_name = 'SoftwareModelNoteViewSerializer')
