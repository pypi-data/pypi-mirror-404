...
from centurion.models.meta import SoftwareVersionCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'SoftwareVersionModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = SoftwareVersionCenturionModelNote
...
@extend_schema_serializer(component_name = 'SoftwareVersionModelNoteViewSerializer')
