...
from centurion.models.meta import OperatingSystemCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'OperatingSystemModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = OperatingSystemCenturionModelNote
...
@extend_schema_serializer(component_name = 'OperatingSystemModelNoteViewSerializer')
