...
from centurion.models.meta import SoftwareCategoryCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'SoftwareCategoryModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = SoftwareCategoryCenturionModelNote
...
@extend_schema_serializer(component_name = 'SoftwareCategoryModelNoteViewSerializer')
