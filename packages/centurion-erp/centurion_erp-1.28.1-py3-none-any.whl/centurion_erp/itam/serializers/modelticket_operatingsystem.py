...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    OperatingSystemTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'OperatingSystemTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'OperatingSystemTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """OperatingSystemTicket Base View Model"""
