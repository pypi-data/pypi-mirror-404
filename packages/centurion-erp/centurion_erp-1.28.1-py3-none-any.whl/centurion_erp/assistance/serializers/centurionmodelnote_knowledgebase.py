...
from centurion.models.meta import KnowledgeBaseCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'KnowledgeBaseModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = KnowledgeBaseCenturionModelNote
...
@extend_schema_serializer(component_name = 'KnowledgeBaseModelNoteViewSerializer')
