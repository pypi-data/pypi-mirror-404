...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    ConfigGroupsTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'ConfigGroupsTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'ConfigGroupsTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """ConfigGroupsTicket Base View Model"""
