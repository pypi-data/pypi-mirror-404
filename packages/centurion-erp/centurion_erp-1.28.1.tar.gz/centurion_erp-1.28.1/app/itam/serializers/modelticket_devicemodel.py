...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    DeviceModelTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'DeviceModelTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'DeviceModelTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """DeviceModelTicket Base View Model"""
