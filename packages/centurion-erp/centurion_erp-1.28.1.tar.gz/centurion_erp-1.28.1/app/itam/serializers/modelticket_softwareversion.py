...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    SoftwareVersionTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'SoftwareVersionTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'SoftwareVersionTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """SoftwareVersionTicket Base View Model"""
