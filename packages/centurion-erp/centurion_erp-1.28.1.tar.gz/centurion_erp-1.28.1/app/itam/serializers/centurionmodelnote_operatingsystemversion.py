...
from centurion.models.meta import OperatingSystemVersionCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'OperatingSystemVersionModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = OperatingSystemVersionCenturionModelNote
...
@extend_schema_serializer(component_name = 'OperatingSystemVersionModelNoteViewSerializer')
