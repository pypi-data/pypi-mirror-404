...
from centurion.models.meta import AppSettingsCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'AppSettingsModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = AppSettingsCenturionModelNote
...
@extend_schema_serializer(component_name = 'AppSettingsModelNoteViewSerializer')
