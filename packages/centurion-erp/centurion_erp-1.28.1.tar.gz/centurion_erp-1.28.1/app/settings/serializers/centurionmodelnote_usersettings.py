...
from centurion.models.meta import UserSettingsCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'UserSettingsModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = UserSettingsCenturionModelNote
...
@extend_schema_serializer(component_name = 'UserSettingsModelNoteViewSerializer')
