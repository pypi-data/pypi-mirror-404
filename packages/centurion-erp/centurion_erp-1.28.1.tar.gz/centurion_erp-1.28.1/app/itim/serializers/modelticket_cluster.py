...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    ClusterTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'ClusterTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'ClusterTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """ClusterTicket Base View Model"""
