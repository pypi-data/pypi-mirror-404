...
from centurion.models.meta import PortCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'PortModelNoteModelSerializer')
...
@extend_schema_serializer(component_name = 'PortModelNoteViewSerializer')
