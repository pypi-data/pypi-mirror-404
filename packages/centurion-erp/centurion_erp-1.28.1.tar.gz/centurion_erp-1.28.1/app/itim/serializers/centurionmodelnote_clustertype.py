...
from centurion.models.meta import ClusterTypeCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'ClusterTypeModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = ClusterTypeCenturionModelNote
...
@extend_schema_serializer(component_name = 'ClusterTypeModelNoteViewSerializer')
