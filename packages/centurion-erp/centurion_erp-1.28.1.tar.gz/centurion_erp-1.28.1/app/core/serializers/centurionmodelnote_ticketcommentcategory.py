...
from centurion.models.meta import TicketCommentCategoryCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'TicketCommentCategoryModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = TicketCommentCategoryCenturionModelNote
...
@extend_schema_serializer(component_name = 'TicketCommentCategoryModelNoteViewSerializer')
