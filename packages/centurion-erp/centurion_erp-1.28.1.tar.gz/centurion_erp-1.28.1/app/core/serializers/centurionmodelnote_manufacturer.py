...
from centurion.models.meta import ManufacturerCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'ManufacturerModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = ManufacturerCenturionModelNote
...
@extend_schema_serializer(component_name = 'ManufacturerModelNoteViewSerializer')
