...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    ManufacturerTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'ManufacturerTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'ManufacturerTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """ManufacturerTicket Base View Model"""
