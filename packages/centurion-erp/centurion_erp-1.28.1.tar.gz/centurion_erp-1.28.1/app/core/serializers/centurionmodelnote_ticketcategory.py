...
from centurion.models.meta import TicketCategoryCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'TicketCategoryModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = TicketCategoryCenturionModelNote
...
@extend_schema_serializer(component_name = 'TicketCategoryModelNoteViewSerializer')
