...
from centurion.models.meta import ProjectTypeCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'ProjectTypeModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = ProjectTypeCenturionModelNote
...
@extend_schema_serializer(component_name = 'ProjectTypeModelNoteViewSerializer')
