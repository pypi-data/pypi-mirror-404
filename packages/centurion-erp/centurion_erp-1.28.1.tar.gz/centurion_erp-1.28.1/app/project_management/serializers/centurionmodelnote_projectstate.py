...
from centurion.models.meta import ProjectStateCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'ProjectStateModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = ProjectStateCenturionModelNote
...
@extend_schema_serializer(component_name = 'ProjectStateModelNoteViewSerializer')
