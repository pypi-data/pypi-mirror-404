...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    FeatureFlagTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'FeatureFlagTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'FeatureFlagTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """FeatureFlagTicket Base View Model"""
