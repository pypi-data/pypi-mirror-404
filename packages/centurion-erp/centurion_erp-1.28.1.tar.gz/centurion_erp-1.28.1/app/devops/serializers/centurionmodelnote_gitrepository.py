...
from centurion.models.meta import GitRepositoryCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'GitRepositoryBaseModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = GitRepositoryCenturionModelNote
...
@extend_schema_serializer(component_name = 'GitRepositoryBaseViewSerializer')
