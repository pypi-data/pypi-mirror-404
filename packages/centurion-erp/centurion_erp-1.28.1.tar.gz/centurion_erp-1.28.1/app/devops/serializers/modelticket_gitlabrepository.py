...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    GitLabRepositoryTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'GitLabRepositoryTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'GitLabRepositoryTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """GitLabRepositoryTicket Base View Model"""
