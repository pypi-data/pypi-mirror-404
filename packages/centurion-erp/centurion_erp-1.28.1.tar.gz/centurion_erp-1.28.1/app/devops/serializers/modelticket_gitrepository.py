...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    GitRepositoryTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'GitRepositoryTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'GitRepositoryTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """GitRepositoryTicket Base View Model"""
