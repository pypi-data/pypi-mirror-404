...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    GitHubRepositoryTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'GitHubRepositoryTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'GitHubRepositoryTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """GitHubRepositoryTicket Base View Model"""
