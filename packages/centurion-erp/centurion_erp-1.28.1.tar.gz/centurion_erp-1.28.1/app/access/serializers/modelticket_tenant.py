...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    TenantTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'TenantTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'TenantTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """TenantTicket Base View Model"""
