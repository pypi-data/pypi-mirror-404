...
from centurion.models.meta import KnowledgeBaseCategoryCenturionModelNote    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
...
@extend_schema_serializer(component_name = 'KnowledgeBaseCategoryModelNoteModelSerializer')
class ModelSerializer(
    ...
    class Meta:
        ...
        model = KnowledgeBaseCategoryCenturionModelNote
...
@extend_schema_serializer(component_name = 'KnowledgeBaseCategoryModelNoteViewSerializer')
