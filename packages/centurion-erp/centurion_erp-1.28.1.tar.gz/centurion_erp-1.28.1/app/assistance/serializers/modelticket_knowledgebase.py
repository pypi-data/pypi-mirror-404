...
from centurion.models.meta import (    # pylint: disable=E0401:import-error disable=E0611:no-name-in-module
    KnowledgeBaseTicket as ModelLinkedtoTicket
)
...
@extend_schema_serializer(component_name = 'KnowledgeBaseTicketModelSerializer')
...
@extend_schema_serializer(component_name = 'KnowledgeBaseTicketViewSerializer')
class ViewSerializer(
    ModelSerializer,
    ModelTicketViewSerializer
):
    """KnowledgeBaseTicket Base View Model"""
