...
from yta_math_easings import SmoothStepEasing
from yta_math_interpolation.abstract import InterpolationFunction


class SmoothStepMotionSegment(MotionSegment):
    """
    ...
    applied in between is SmoothStepEasing.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            node_end = node_end,
            easing_function = SmoothStepEasing(),
