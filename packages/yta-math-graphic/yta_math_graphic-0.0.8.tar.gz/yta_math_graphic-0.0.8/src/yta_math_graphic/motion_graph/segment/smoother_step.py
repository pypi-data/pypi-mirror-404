...
from yta_math_easings import SmootherStepEasing
from yta_math_interpolation.abstract import InterpolationFunction


class SmootherStepMotionSegment(MotionSegment):
    """
    ...
    applied in between is Smoother.
    ...
    def __init__(
        ...
        super().__init__(
            ...
            node_end = node_end,
            easing_function = SmootherStepEasing(),
