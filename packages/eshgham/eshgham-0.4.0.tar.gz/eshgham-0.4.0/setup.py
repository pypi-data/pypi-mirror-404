...
class VersionPyFinder(object):
    ...
    def __init__(self, filename="version.py", max_depth=2):
        ...
        self.depth = None
        self.filename = os.getenv("AUTORELEASE_VERSION_PY", self._first_eligible())
    ...
    def _is_eligible(self, filename):
        ...
        return all(func in all_functions for func in self._VERSION_PY_FUNCTIONS)
...
def write_installed_version_py(filename="_installed_version.py", src_dir=None):
