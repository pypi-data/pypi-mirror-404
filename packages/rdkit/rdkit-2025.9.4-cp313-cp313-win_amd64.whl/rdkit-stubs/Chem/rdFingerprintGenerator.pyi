...
class AdditionalOutput(Boost.Python.instance):
    ...
    def AllocateAtomCounts(self) -> None:
        """
            ...
            C++ signature :
                void AllocateAtomCounts(struct RDKit::AdditionalOutput {lvalue})
        """
    def AllocateAtomToBits(self) -> None:
        """
            ...
            C++ signature :
                void AllocateAtomToBits(struct RDKit::AdditionalOutput {lvalue})
        """
    def AllocateAtomsPerBit(self) -> None:
        """
            ...
            C++ signature :
                void AllocateAtomsPerBit(struct RDKit::AdditionalOutput {lvalue})
        """
    def AllocateBitInfoMap(self) -> None:
        """
            ...
            C++ signature :
                void AllocateBitInfoMap(struct RDKit::AdditionalOutput {lvalue})
        """
    def AllocateBitPaths(self) -> None:
        """
            ...
            C++ signature :
                void AllocateBitPaths(struct RDKit::AdditionalOutput {lvalue})
        """
    def CollectAtomCounts(self) -> None:
        """
            ...
            C++ signature :
                void CollectAtomCounts(struct RDKit::AdditionalOutput {lvalue})
        """
    def CollectAtomToBits(self) -> None:
        """
            ...
            C++ signature :
                void CollectAtomToBits(struct RDKit::AdditionalOutput {lvalue})
        """
    def CollectAtomsPerBit(self) -> None:
        """
            ...
            C++ signature :
                void CollectAtomsPerBit(struct RDKit::AdditionalOutput {lvalue})
        """
    def CollectBitInfoMap(self) -> None:
        """
            ...
            C++ signature :
                void CollectBitInfoMap(struct RDKit::AdditionalOutput {lvalue})
        """
    def CollectBitPaths(self) -> None:
        """
            ...
            C++ signature :
                void CollectBitPaths(struct RDKit::AdditionalOutput {lvalue})
        """
    def GetAtomCounts(self) -> typing.Any:
        """
            C++ signature :
                class boost::python::api::object GetAtomCounts(struct RDKit::AdditionalOutput)
        """
    def GetAtomToBits(self) -> typing.Any:
        """
            C++ signature :
                class boost::python::api::object GetAtomToBits(struct RDKit::AdditionalOutput)
        """
    def GetAtomsPerBit(self) -> typing.Any:
        """
            C++ signature :
                class boost::python::api::object GetAtomsPerBit(struct RDKit::AdditionalOutput)
        """
    def GetBitInfoMap(self) -> typing.Any:
        """
            C++ signature :
                class boost::python::api::object GetBitInfoMap(struct RDKit::AdditionalOutput)
        """
    def GetBitPaths(self) -> typing.Any:
        """
            C++ signature :
                class boost::python::api::object GetBitPaths(struct RDKit::AdditionalOutput)
        """
...
class FingerprintGenerator32(Boost.Python.instance):
    ...
    def GetCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> UIntSparseIntVect:
        """
            ...
            C++ signature :
                class RDKit::SparseIntVect<unsigned int> * __ptr64 GetCountFingerprint(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            ...
            C++ signature :
                class boost::python::api::object GetCountFingerprintAsNumPy(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            ...
            C++ signature :
                class boost::python::tuple GetCountFingerprints(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class boost::python::api::object [,int=1])
        """
    def GetFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> ExplicitBitVect:
        """
            ...
            C++ signature :
                class ExplicitBitVect * __ptr64 GetFingerprint(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            ...
            C++ signature :
                class boost::python::api::object GetFingerprintAsNumPy(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            ...
            C++ signature :
                class boost::python::tuple GetFingerprints(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class boost::python::api::object [,int=1])
        """
    def GetInfoString(self) -> str:
        """
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetInfoString(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64)
        """
    def GetOptions(self) -> FingerprintOptions:
        """
            ...
            C++ signature :
                class RDKit::FingerprintArguments * __ptr64 GetOptions(class RDKit::FingerprintGenerator<unsigned int> * __ptr64)
        """
    def GetSparseCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> UIntSparseIntVect:
        """
            ...
            C++ signature :
                class RDKit::SparseIntVect<unsigned int> * __ptr64 GetSparseCountFingerprint(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetSparseCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            ...
            C++ signature :
                class boost::python::tuple GetSparseCountFingerprints(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class boost::python::api::object [,int=1])
        """
    def GetSparseFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> SparseBitVect:
        """
            ...
            C++ signature :
                class SparseBitVect * __ptr64 GetSparseFingerprint(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetSparseFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            ...
            C++ signature :
                class boost::python::tuple GetSparseFingerprints(class RDKit::FingerprintGenerator<unsigned int> const * __ptr64,class boost::python::api::object [,int=1])
        """
    def ToJSON(self) -> str:
        """
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > ToJSON(class RDKit::FingerprintGenerator<unsigned int>)
        """
class FingerprintGenerator64(Boost.Python.instance):
    ...
    def GetCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> UIntSparseIntVect:
        """
            ...
            C++ signature :
                class RDKit::SparseIntVect<unsigned int> * __ptr64 GetCountFingerprint(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            Generates a count fingerprint
            ...
            C++ signature :
                class boost::python::api::object GetCountFingerprintAsNumPy(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates count fingerprints for a sequence of molecules
            ...
            C++ signature :
                class boost::python::tuple GetCountFingerprints(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class boost::python::api::object [,int=1])
        """
    def GetFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> ExplicitBitVect:
        """
            Generates a fingerprint
            ...
            C++ signature :
                class ExplicitBitVect * __ptr64 GetFingerprint(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            Generates a fingerprint
            ...
            C++ signature :
                class boost::python::api::object GetFingerprintAsNumPy(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates fingerprints for a sequence of molecules
            ...
            C++ signature :
                class boost::python::tuple GetFingerprints(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class boost::python::api::object [,int=1])
        """
    def GetInfoString(self) -> str:
        """
            Returns a string containing information about the fingerprint generator
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetInfoString(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64)
        """
    def GetOptions(self) -> FingerprintOptions:
        """
            return the fingerprint options object
            ...
            C++ signature :
                class RDKit::FingerprintArguments * __ptr64 GetOptions(class RDKit::FingerprintGenerator<unsigned __int64> * __ptr64)
        """
    def GetSparseCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> ULongSparseIntVect:
        """
            ...
            C++ signature :
                class RDKit::SparseIntVect<unsigned __int64> * __ptr64 GetSparseCountFingerprint(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetSparseCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates sparse count fingerprints for a sequence of molecules
            ...
            C++ signature :
                class boost::python::tuple GetSparseCountFingerprints(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class boost::python::api::object [,int=1])
        """
    def GetSparseFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> SparseBitVect:
        """
            Generates a sparse fingerprint
            ...
            C++ signature :
                class SparseBitVect * __ptr64 GetSparseFingerprint(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class RDKit::ROMol [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=None]]]]]])
        """
    def GetSparseFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates sparse fingerprints for a sequence of molecules
            ...
            C++ signature :
                class boost::python::tuple GetSparseFingerprints(class RDKit::FingerprintGenerator<unsigned __int64> const * __ptr64,class boost::python::api::object [,int=1])
        """
    def ToJSON(self) -> str:
        """
            Serialize a FingerprintGenerator to JSON
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > ToJSON(class RDKit::FingerprintGenerator<unsigned __int64>)
        """
class FingerprintOptions(Boost.Python.instance):
    ...
    def SetCountBounds(self, bounds: typing.Any) -> None:
        """
            ...
            C++ signature :
                void SetCountBounds(class RDKit::FingerprintArguments {lvalue},class boost::python::api::object)
        """
    @property
...
def FingerprintGeneratorFromJSON(jsonString: str) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            class RDKit::FingerprintGenerator<unsigned __int64> * __ptr64 FingerprintGeneratorFromJSON(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
    """
def GetAtomPairAtomInvGen(includeChirality: bool = False) -> AtomInvariantsGenerator:
    """
        ...
        C++ signature :
            class RDKit::AtomInvariantsGenerator * __ptr64 GetAtomPairAtomInvGen([ bool=False])
    """
def GetAtomPairGenerator(minDistance: int = 1, maxDistance: int = 30, includeChirality: bool = False, use2D: bool = True, countSimulation: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            class RDKit::FingerprintGenerator<unsigned __int64> * __ptr64 GetAtomPairGenerator([ unsigned int=1 [,unsigned int=30 [,bool=False [,bool=True [,bool=True [,class boost::python::api::object {lvalue}=None [,unsigned int=2048 [,class boost::python::api::object {lvalue}=None]]]]]]]])
    """
def GetCountFPs(molecules: list = [], fpType: FPType = ...) -> list:
    """
        C++ signature :
            class boost::python::list GetCountFPs([ class boost::python::list {lvalue}=[] [,enum RDKit::FPType=rdkit.Chem.rdFingerprintGenerator.FPType.MorganFP]])
    """
def GetFPs(molecules: list = [], fpType: FPType = ...) -> list:
    """
        C++ signature :
            class boost::python::list GetFPs([ class boost::python::list {lvalue}=[] [,enum RDKit::FPType=rdkit.Chem.rdFingerprintGenerator.FPType.MorganFP]])
    """
def GetMorganAtomInvGen(includeRingMembership: bool) -> AtomInvariantsGenerator:
    """
        ...
        C++ signature :
            class RDKit::AtomInvariantsGenerator * __ptr64 GetMorganAtomInvGen(bool)
    """
def GetMorganBondInvGen(useBondTypes: bool = True, useChirality: bool = False) -> BondInvariantsGenerator:
    """
        ...
        C++ signature :
            class RDKit::BondInvariantsGenerator * __ptr64 GetMorganBondInvGen([ bool=True [,bool=False]])
    """
def GetMorganFeatureAtomInvGen(patterns: typing.Any = None) -> AtomInvariantsGenerator:
    """
        ...
        C++ signature :
            class RDKit::AtomInvariantsGenerator * __ptr64 GetMorganFeatureAtomInvGen([ class boost::python::api::object {lvalue}=None])
    """
def GetMorganGenerator(radius: int = 3, countSimulation: bool = False, includeChirality: bool = False, useBondTypes: bool = True, onlyNonzeroInvariants: bool = False, includeRingMembership: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None, bondInvariantsGenerator: typing.Any = None, includeRedundantEnvironments: bool = False) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            class RDKit::FingerprintGenerator<unsigned __int64> * __ptr64 GetMorganGenerator([ unsigned int=3 [,bool=False [,bool=False [,bool=True [,bool=False [,bool=True [,class boost::python::api::object {lvalue}=None [,unsigned int=2048 [,class boost::python::api::object {lvalue}=None [,class boost::python::api::object {lvalue}=None [,bool=False]]]]]]]]]]])
    """
def GetRDKitAtomInvGen() -> AtomInvariantsGenerator:
    """
        ...
        C++ signature :
            class RDKit::AtomInvariantsGenerator * __ptr64 GetRDKitAtomInvGen()
    """
...
def GetSparseCountFPs(molecules: list = [], fpType: FPType = ...) -> list:
    """
        C++ signature :
            class boost::python::list GetSparseCountFPs([ class boost::python::list {lvalue}=[] [,enum RDKit::FPType=rdkit.Chem.rdFingerprintGenerator.FPType.MorganFP]])
    """
def GetSparseFPs(molecules: list = [], fpType: FPType = ...) -> list:
    """
        C++ signature :
            class boost::python::list GetSparseFPs([ class boost::python::list {lvalue}=[] [,enum RDKit::FPType=rdkit.Chem.rdFingerprintGenerator.FPType.MorganFP]])
    """
def GetTopologicalTorsionGenerator(includeChirality: bool = False, torsionAtomCount: int = 4, countSimulation: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            class RDKit::FingerprintGenerator<unsigned __int64> * __ptr64 GetTopologicalTorsionGenerator([ bool=False [,unsigned int=4 [,bool=True [,class boost::python::api::object {lvalue}=None [,unsigned int=2048 [,class boost::python::api::object {lvalue}=None]]]]]])
    """
