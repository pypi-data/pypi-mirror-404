...
class FingerprintGenerator32(Boost.Python.instance):
    ...
    def ToJSON(self) -> str:
        """
            ...
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> ToJSON(RDKit::FingerprintGenerator<unsigned int>)
        """
class FingerprintGenerator64(Boost.Python.instance):
    ...
    def ToJSON(self) -> str:
        """
            ...
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> ToJSON(RDKit::FingerprintGenerator<unsigned long long>)
        """
...
def FingerprintGeneratorFromJSON(jsonString: str) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKit::FingerprintGenerator<unsigned long long>* FingerprintGeneratorFromJSON(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
    """
