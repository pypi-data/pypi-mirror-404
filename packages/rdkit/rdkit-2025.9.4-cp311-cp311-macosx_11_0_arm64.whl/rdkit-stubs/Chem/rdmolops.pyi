...
def CombineMols(mol1: Mol, mol2: Mol, offset: Point3D = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CombineMols(RDKit::ROMol,RDKit::ROMol [,RDGeom::Point3D=<rdkit.Geometry.rdGeometry.Point3D object at 0x1065e07c0>])
    """
...
def CopyMolSubset(mol: Mol, atomIndices: typing.Any, bondIndices: typing.Any, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,boost::python::api::object [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x104b4f610>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, atomIndices: typing.Any, bondIndices: typing.Any, subsetInfo: SubsetInfo, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,boost::python::api::object,RDKit::SubsetInfo {lvalue} [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x104b4f680>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, path: typing.Any, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x104b4f6f0>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, path: typing.Any, subsetInfo: SubsetInfo, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,RDKit::SubsetInfo {lvalue} [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x104b4f7d0>])
    """
...
def molzip(a: Mol, b: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(RDKit::ROMol,RDKit::ROMol [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x1065ec4a0>])
    """
@typing.overload
def molzip(a: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(RDKit::ROMol [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x1065ec540>])
    """
@typing.overload
def molzip(row: dict, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(boost::python::dict [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x1065ec680>])
    """
def molzipFragments(mols: typing.Any, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzipFragments(boost::python::api::object {lvalue} [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x1065ec5e0>])
    """
