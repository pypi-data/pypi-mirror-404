...
class SynthonSpace(Boost.Python.instance):
    ...
    def FingerprintSearchIncremental(self, query: Mol, fingerprintGenerator: typing.Any, callback: typing.Any, params: typing.Any = None) -> None:
        """
            ...
            C++ signature :
                void FingerprintSearchIncremental(class RDKit::SynthonSpaceSearch::SynthonSpace {lvalue},class RDKit::ROMol,class boost::python::api::object,class boost::python::api::object [,class boost::python::api::object=None])
        """
    ...
    def RascalSearchIncremental(self, query: Mol, rascalOptions: typing.Any, callback: typing.Any, params: typing.Any = None) -> None:
        """
            ...
            C++ signature :
                void RascalSearchIncremental(class RDKit::SynthonSpaceSearch::SynthonSpace {lvalue},class RDKit::ROMol,class boost::python::api::object,class boost::python::api::object [,class boost::python::api::object=None])
        """
    ...
    def SubstructureSearchIncremental(self, query: Mol, callback: typing.Any, substructMatchParams: typing.Any = None, params: typing.Any = None) -> None:
        """
            ...
            C++ signature :
                void SubstructureSearchIncremental(class RDKit::SynthonSpaceSearch::SynthonSpace {lvalue},class RDKit::ROMol,class boost::python::api::object [,class boost::python::api::object=None [,class boost::python::api::object=None]])
        """
...
class SynthonSpaceSearchParams(Boost.Python.instance):
    ...
    def timeOut(*args, **kwargs):
        ...
    @property
    def toTryChunkSize(*args, **kwargs):
        """
