...
def ConfigToNumElectrons(config, ignoreFullD = 0, ignoreFullF = 0):
    ...
    """
def GetAtomicData(atomDict, descriptorsDesired, dBase = '/project/build/temp.linux-aarch64-cpython-312/rdkit_install/share/RDKit/Data/atomdb.gdb', table = 'atomic_data', where = '', user = 'sysdba', password = 'masterkey', includeElCounts = 0):
    """
...
def SplitComposition(compStr):
    ...
    """
_atomDbName: str = '/project/build/temp.linux-aarch64-cpython-312/rdkit_install/share/RDKit/Data/atomdb.gdb'
