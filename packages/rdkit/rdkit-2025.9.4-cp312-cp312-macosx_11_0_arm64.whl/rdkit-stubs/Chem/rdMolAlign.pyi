...
def GetAllConformerBestRMS(mol: Mol, params: BestAlignmentParams) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GetAllConformerBestRMS(RDKit::ROMol {lvalue},RDKit::MolAlign::pyBestAlignmentParams)
    """
@typing.overload
...
def GetBestAlignmentTransform(prbMol: Mol, refMol: Mol, params: BestAlignmentParams, prbCid: int = -1, refCid: int = -1, reflect: bool = False, maxIters: int = 50) -> typing.Any:
    """
        ...
        C++ signature :
            _object* GetBestAlignmentTransform(RDKit::ROMol,RDKit::ROMol,RDKit::MolAlign::pyBestAlignmentParams [,int=-1 [,int=-1 [,bool=False [,unsigned int=50]]]])
    """
@typing.overload
...
def GetBestRMS(prbMol: Mol, refMol: Mol, params: BestAlignmentParams, prbId: int = -1, refId: int = -1) -> float:
    """
        ...
        C++ signature :
            double GetBestRMS(RDKit::ROMol {lvalue},RDKit::ROMol {lvalue},RDKit::MolAlign::pyBestAlignmentParams [,int=-1 [,int=-1]])
    """
