...
def GetMolHash(all_layers, hash_scheme: HashScheme = ...) -> str:
    ...
    """
def GetMolLayers(original_molecule: rdkit.Chem.rdchem.Mol, data_field_names: typing.Iterable | None = None, escape: str | None = None, cxflag = 1089, enable_tautomer_hash_v2 = False) -> typing.Dict[rdkit.Chem.RegistrationHash.HashLayer, str]:
    """
