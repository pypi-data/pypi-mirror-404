...
f: _io.BufferedReader  # value = <_io.BufferedReader name='/project/build/temp.linux-aarch64-cpython-311/rdkit_install/lib/python3.11/site-packages/rdkit/sping/PIL/pilfonts/metrics.dat'>
figureArc: int = 2
figureCurve: int = 3
figureLine: int = 1
