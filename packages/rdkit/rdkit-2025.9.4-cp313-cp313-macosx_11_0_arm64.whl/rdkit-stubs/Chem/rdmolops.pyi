...
def CombineMols(mol1: Mol, mol2: Mol, offset: Point3D = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CombineMols(RDKit::ROMol,RDKit::ROMol [,RDGeom::Point3D=<rdkit.Geometry.rdGeometry.Point3D object at 0x104ccc440>])
    """
...
def CopyMolSubset(mol: Mol, atomIndices: typing.Any, bondIndices: typing.Any, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,boost::python::api::object [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x104c92180>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, atomIndices: typing.Any, bondIndices: typing.Any, subsetInfo: SubsetInfo, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,boost::python::api::object,RDKit::SubsetInfo {lvalue} [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x104c921f0>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, path: typing.Any, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x104c92260>])
    """
@typing.overload
def CopyMolSubset(mol: Mol, path: typing.Any, subsetInfo: SubsetInfo, options: SubsetOptions = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* CopyMolSubset(RDKit::ROMol,boost::python::api::object,RDKit::SubsetInfo {lvalue} [,RDKit::SubsetOptions=<rdkit.Chem.rdmolops.SubsetOptions object at 0x104c92340>])
    """
...
def molzip(a: Mol, b: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(RDKit::ROMol,RDKit::ROMol [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x104c82700>])
    """
@typing.overload
def molzip(a: Mol, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(RDKit::ROMol [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x104c827a0>])
    """
@typing.overload
def molzip(row: dict, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzip(boost::python::dict [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x104c828e0>])
    """
def molzipFragments(mols: typing.Any, params: MolzipParams = ...) -> rdkit.Chem.Mol:
    """
        ...
        C++ signature :
            RDKit::ROMol* molzipFragments(boost::python::api::object {lvalue} [,RDKit::MolzipParams=<rdkit.Chem.rdmolops.MolzipParams object at 0x104c82840>])
    """
