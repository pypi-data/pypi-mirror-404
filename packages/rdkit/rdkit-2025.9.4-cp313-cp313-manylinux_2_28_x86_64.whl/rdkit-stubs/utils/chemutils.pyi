...
def ConfigToNumElectrons(config, ignoreFullD = 0, ignoreFullF = 0):
    ...
    **Returns**
    ...
    """
def GetAtomicData(atomDict, descriptorsDesired, dBase = '/project/build/temp.linux-x86_64-cpython-313/rdkit_install/share/RDKit/Data/atomdb.gdb', table = 'atomic_data', where = '', user = 'sysdba', password = 'masterkey', includeElCounts = 0):
    """
...
def SplitComposition(compStr):
    ...
    **Note**
    ...
    """
_atomDbName: str = '/project/build/temp.linux-x86_64-cpython-313/rdkit_install/share/RDKit/Data/atomdb.gdb'
