...
import typing
__all__: list[str] = ['GetAlignmentTransform']
def GetAlignmentTransform(refPoints: typing.Any, probePoints: typing.Any, weights: typing.Any = [], reflect: bool = False, maxIterations: int = 50) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetAlignmentTransform(class boost::python::api::object,class boost::python::api::object [,class boost::python::api::object=[] [,bool=False [,unsigned int=50]]])
    """
