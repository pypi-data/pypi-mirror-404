...
class GetAllPlaidAccounts200Response(BaseModel):
    """
    GetAllPlaidAccounts200Response
    """ # noqa: E501
    plaid_accounts: Optional[List[PlaidAccountObject]] = None
    __properties: ClassVar[List[str]] = ["plaid_accounts"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in plaid_accounts (list)
        _items = []
        if self.plaid_accounts:
            for _item_plaid_accounts in self.plaid_accounts:
                if _item_plaid_accounts:
                    _items.append(_item_plaid_accounts.to_dict())
            _dict['plaid_accounts'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plaid_accounts": [PlaidAccountObject.from_dict(_item) for _item in obj["plaid_accounts"]] if obj.get("plaid_accounts") is not None else None
        })
        return _obj
