...
class SummaryTotalsBreakdownObject(BaseModel):
    ...
    """ # noqa: E501
    other_activity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount, in the user's default currency, of non recurring activity for the given date range.")
    recurring_activity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount, in the user's default currency, of recurring activity that has occurred for the given date range.")
    recurring_remaining: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount, in the user's default currency, of expected recurring activity that has not yet occurred.")
    uncategorized: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount, in the user's default currency, of non recurring activity coming from un-categorized transactions.")
    uncategorized_count: Optional[StrictInt] = Field(default=None, description="Number of un-categorized transactions for the given date range.")
    uncategorized_recurring: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total amount, in the user's default currency, of recurring activity coming from un-categorized transactions.")
    __properties: ClassVar[List[str]] = ["other_activity", "recurring_activity", "recurring_remaining", "uncategorized", "uncategorized_count", "uncategorized_recurring"]
