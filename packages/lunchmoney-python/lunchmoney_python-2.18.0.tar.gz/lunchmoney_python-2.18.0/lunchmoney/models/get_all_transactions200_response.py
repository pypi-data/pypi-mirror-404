...
class GetAllTransactions200Response(BaseModel):
    """
    GetAllTransactions200Response
    """ # noqa: E501
    transactions: List[TransactionObject]
    has_more: StrictBool = Field(description="Set to true if more transactions are available")
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["transactions", "has_more", "error"]
