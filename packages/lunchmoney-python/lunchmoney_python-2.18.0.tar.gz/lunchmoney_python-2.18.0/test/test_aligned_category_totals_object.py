...
class TestAlignedCategoryTotalsObject(unittest.TestCase):
    """AlignedCategoryTotalsObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlignedCategoryTotalsObject:
        """Test AlignedCategoryTotalsObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlignedCategoryTotalsObject`
        """
        model = AlignedCategoryTotalsObject()
        if include_optional:
            return AlignedCategoryTotalsObject(
    ...
    def testAlignedCategoryTotalsObject(self):
        """Test AlignedCategoryTotalsObject"""
