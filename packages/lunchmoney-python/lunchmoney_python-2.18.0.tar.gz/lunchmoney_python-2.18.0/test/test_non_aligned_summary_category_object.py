...
class TestNonAlignedSummaryCategoryObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NonAlignedSummaryCategoryObject:
        """Test NonAlignedSummaryCategoryObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonAlignedSummaryCategoryObject`
        """
        model = NonAlignedSummaryCategoryObject()
        if include_optional:
    ...
    def testNonAlignedSummaryCategoryObject(self):
        """Test NonAlignedSummaryCategoryObject"""
