...
class TestRecurringObjectOverrides(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecurringObjectOverrides:
        """Test RecurringObjectOverrides
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecurringObjectOverrides`
        """
        model = RecurringObjectOverrides()
        if include_optional:
            return RecurringObjectOverrides(
                payee = '',
                notes = '',
                category_id = 56
            )
    ...
    def testRecurringObjectOverrides(self):
        """Test RecurringObjectOverrides"""
