...
class TestUpdateCategoryRequestObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateCategoryRequestObject:
        """Test UpdateCategoryRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCategoryRequestObject`
        """
        model = UpdateCategoryRequestObject()
        if include_optional:
            return UpdateCategoryRequestObject(
                name = '0',
                description = '',
                is_income = True,
    ...
    def testUpdateCategoryRequestObject(self):
        """Test UpdateCategoryRequestObject"""
