...
class TestSkippedExistingExternalIdObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SkippedExistingExternalIdObject:
        """Test SkippedExistingExternalIdObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SkippedExistingExternalIdObject`
        """
        model = SkippedExistingExternalIdObject()
        if include_optional:
            return SkippedExistingExternalIdObject(
    ...
    def testSkippedExistingExternalIdObject(self):
        """Test SkippedExistingExternalIdObject"""
