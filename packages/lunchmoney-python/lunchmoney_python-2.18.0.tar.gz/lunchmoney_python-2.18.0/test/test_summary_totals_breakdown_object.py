...
class TestSummaryTotalsBreakdownObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SummaryTotalsBreakdownObject:
        """Test SummaryTotalsBreakdownObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SummaryTotalsBreakdownObject`
        """
        model = SummaryTotalsBreakdownObject()
        if include_optional:
            return SummaryTotalsBreakdownObject(
    ...
    def testSummaryTotalsBreakdownObject(self):
        """Test SummaryTotalsBreakdownObject"""
