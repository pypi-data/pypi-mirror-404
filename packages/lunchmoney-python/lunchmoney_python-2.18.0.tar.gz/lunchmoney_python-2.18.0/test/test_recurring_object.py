...
class TestRecurringObject(unittest.TestCase):
    """RecurringObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecurringObject:
        """Test RecurringObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecurringObject`
        """
        model = RecurringObject()
        if include_optional:
