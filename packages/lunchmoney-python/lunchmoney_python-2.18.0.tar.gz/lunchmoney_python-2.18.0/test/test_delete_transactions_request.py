...
class TestDeleteTransactionsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeleteTransactionsRequest:
        """Test DeleteTransactionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteTransactionsRequest`
        """
    ...
    def testDeleteTransactionsRequest(self):
        """Test DeleteTransactionsRequest"""
