...
class TestUpdateTransactionsRequestTransactionsInner(unittest.TestCase):
    """UpdateTransactionsRequestTransactionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTransactionsRequestTransactionsInner:
        """Test UpdateTransactionsRequestTransactionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTransactionsRequestTransactionsInner`
        """
        model = UpdateTransactionsRequestTransactionsInner()
        if include_optional:
            return UpdateTransactionsRequestTransactionsInner(
                id = 56,
    ...
    def testUpdateTransactionsRequestTransactionsInner(self):
        """Test UpdateTransactionsRequestTransactionsInner"""
