...
class TestDeleteCategoryResponseWithDependenciesDependents(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeleteCategoryResponseWithDependenciesDependents:
        """Test DeleteCategoryResponseWithDependenciesDependents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteCategoryResponseWithDependenciesDependents`
        """
        model = DeleteCategoryResponseWithDependenciesDependents()
        if include_optional:
            return DeleteCategoryResponseWithDependenciesDependents(
                budget = 56,
                category_rules = 56,
                transactions = 56,
                children = 56,
    ...
    def testDeleteCategoryResponseWithDependenciesDependents(self):
        """Test DeleteCategoryResponseWithDependenciesDependents"""
