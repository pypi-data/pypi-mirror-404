...
class TestSummaryCategoryOccurrenceObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SummaryCategoryOccurrenceObject:
        """Test SummaryCategoryOccurrenceObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SummaryCategoryOccurrenceObject`
        """
        model = SummaryCategoryOccurrenceObject()
        if include_optional:
            return SummaryCategoryOccurrenceObject(
                in_range = True,
    ...
    def testSummaryCategoryOccurrenceObject(self):
        """Test SummaryCategoryOccurrenceObject"""
