...
class TestSummaryRolloverPoolObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SummaryRolloverPoolObject:
        """Test SummaryRolloverPoolObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SummaryRolloverPoolObject`
        """
        model = SummaryRolloverPoolObject()
        if include_optional:
    ...
    def testSummaryRolloverPoolObject(self):
        """Test SummaryRolloverPoolObject"""
