...
class TestUpdateTagRequestObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateTagRequestObject:
        """Test UpdateTagRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTagRequestObject`
        """
        model = UpdateTagRequestObject()
        if include_optional:
            return UpdateTagRequestObject(
                name = '0',
                description = '',
                text_color = '',
                background_color = '',
    ...
    def testUpdateTagRequestObject(self):
        """Test UpdateTagRequestObject"""
