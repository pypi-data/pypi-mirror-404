...
class TestRecurringObjectMatchesFoundTransactionsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecurringObjectMatchesFoundTransactionsInner:
        """Test RecurringObjectMatchesFoundTransactionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecurringObjectMatchesFoundTransactionsInner`
        """
        model = RecurringObjectMatchesFoundTransactionsInner()
        if include_optional:
            return RecurringObjectMatchesFoundTransactionsInner(
    ...
    def testRecurringObjectMatchesFoundTransactionsInner(self):
        """Test RecurringObjectMatchesFoundTransactionsInner"""
