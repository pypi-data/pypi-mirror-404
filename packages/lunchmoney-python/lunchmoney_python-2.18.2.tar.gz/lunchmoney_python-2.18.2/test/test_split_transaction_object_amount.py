...
class TestSplitTransactionObjectAmount(unittest.TestCase):
    """SplitTransactionObjectAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SplitTransactionObjectAmount:
        """Test SplitTransactionObjectAmount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SplitTransactionObjectAmount`
        """
        model = SplitTransactionObjectAmount()
        if include_optional:
    ...
    def testSplitTransactionObjectAmount(self):
        """Test SplitTransactionObjectAmount"""
