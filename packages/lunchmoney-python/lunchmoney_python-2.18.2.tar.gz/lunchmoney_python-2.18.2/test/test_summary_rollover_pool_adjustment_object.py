...
class TestSummaryRolloverPoolAdjustmentObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SummaryRolloverPoolAdjustmentObject:
        """Test SummaryRolloverPoolAdjustmentObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SummaryRolloverPoolAdjustmentObject`
        """
        model = SummaryRolloverPoolAdjustmentObject()
        if include_optional:
            return SummaryRolloverPoolAdjustmentObject(
                in_range = True,
    ...
    def testSummaryRolloverPoolAdjustmentObject(self):
        """Test SummaryRolloverPoolAdjustmentObject"""
