...
class TestUpdateManualAccountRequestObjectBalance(unittest.TestCase):
    """UpdateManualAccountRequestObjectBalance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateManualAccountRequestObjectBalance:
        """Test UpdateManualAccountRequestObjectBalance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateManualAccountRequestObjectBalance`
        """
        model = UpdateManualAccountRequestObjectBalance()
        if include_optional:
    ...
    def testUpdateManualAccountRequestObjectBalance(self):
        """Test UpdateManualAccountRequestObjectBalance"""
