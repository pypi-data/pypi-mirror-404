...
class TestInsertTransactionObjectAmount(unittest.TestCase):
    """InsertTransactionObjectAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsertTransactionObjectAmount:
        """Test InsertTransactionObjectAmount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertTransactionObjectAmount`
        """
        model = InsertTransactionObjectAmount()
        if include_optional:
    ...
    def testInsertTransactionObjectAmount(self):
        """Test InsertTransactionObjectAmount"""
