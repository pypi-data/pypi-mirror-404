...
class TestUpdateTransactionObjectAmount(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateTransactionObjectAmount:
        """Test UpdateTransactionObjectAmount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTransactionObjectAmount`
        """
        model = UpdateTransactionObjectAmount()
        if include_optional:
    ...
    def testUpdateTransactionObjectAmount(self):
        """Test UpdateTransactionObjectAmount"""
