...
class TestCreateManualAccountRequestObjectBalance(unittest.TestCase):
    """CreateManualAccountRequestObjectBalance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateManualAccountRequestObjectBalance:
        """Test CreateManualAccountRequestObjectBalance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateManualAccountRequestObjectBalance`
        """
        model = CreateManualAccountRequestObjectBalance()
        if include_optional:
    ...
    def testCreateManualAccountRequestObjectBalance(self):
        """Test CreateManualAccountRequestObjectBalance"""
