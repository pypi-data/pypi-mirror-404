...
class TestAlignedSummaryCategoryObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AlignedSummaryCategoryObject:
        """Test AlignedSummaryCategoryObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlignedSummaryCategoryObject`
        """
        model = AlignedSummaryCategoryObject()
        if include_optional:
    ...
    def testAlignedSummaryCategoryObject(self):
        """Test AlignedSummaryCategoryObject"""
