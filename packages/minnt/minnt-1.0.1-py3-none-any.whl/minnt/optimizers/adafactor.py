...
This implementation (including the documentation below) is taken from
HuggingFace transformers library, which itself is adapted from the original
fairseq implementation, which is based on the description in the paper
[Adafactor: Adaptive Learning Rates with Sublinear Memory Cost](https://arxiv.org/abs/1804.04235).

Note that this implementation differs from the PyTorch [torch.optim.Adafactor][]
one, which intentionally deviates from the original paper (the documentation
of the PyTorch implementation describes these differences). However, in our
