...
Derived, read-only properties of a DatabaseResource. Use these to determine how to interact with a DatabaseResource, or to see its current state. If you have not assigned the DatabaseResource to a Connector, then some of its status will not be availble. 

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**gateway_uri** | **str** | The base uri at which to access the gateway for this DatabaseResource.  | [optional] 
...
**stats** | [**DatabaseResourceStats**](DatabaseResourceStats.md) |  | [optional] 
