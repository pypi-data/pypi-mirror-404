...
The read-only details of a UserSSHAccessInfo.
...
**hostname** | **str** | The address of the ssh resource.  | [optional] 
**port** | **int** | The port to connect to. If empty, will default to port 22.  | [optional] 
...
**gateway_uri** | **str** | Many resources may be accessed via a gateway. This field provides provides the URI for the gateway, if any, providing access to this object.  | [optional] 
