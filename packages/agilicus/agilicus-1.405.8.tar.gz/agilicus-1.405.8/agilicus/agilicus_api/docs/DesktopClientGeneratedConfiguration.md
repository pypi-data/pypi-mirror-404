# DesktopClientGeneratedConfiguration
...
**expiry** | **datetime** | When the config expires. An expired config may not work. Users should request a new one before it expires | [optional] 
