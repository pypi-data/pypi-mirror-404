...
__all__ = ['AzurePostgresqlDatabaseArgs', 'AzurePostgresqlDatabase']

@pulumi.input_type
class AzurePostgresqlDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] sku_name: Specifies the SKU Name for this PostgreSQL Server.
        ...
        :param pulumi.Input[int] storage_mb: Max storage allowed for a server. Possible values are between `5120` MB(5GB) and `1048576` MB(1TB) for the Basic SKU and between `5120` MB(5GB) and `16777216` MB(16TB) for General Purpose/Memory Optimized SKUs.
...
@pulumi.input_type
class _AzurePostgresqlDatabaseState:
    def __init__(__self__, *,
                 administrator_login: Optional[pulumi.Input[str]] = None,
                 administrator_login_password: Optional[pulumi.Input[str]] = None,
                 backup_retention_days: Optional[pulumi.Input[int]] = None,
...
class AzurePostgresqlDatabase(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AzurePostgresqlDatabaseArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        `AzurePostgresqlDatabase` manages an azure postgresql database in Duplo.
        ...
        :param str resource_name: The name of the resource.
        :param AzurePostgresqlDatabaseArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AzurePostgresqlDatabaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AzurePostgresqlDatabaseArgs.__new__(AzurePostgresqlDatabaseArgs)
        ...
        super(AzurePostgresqlDatabase, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[str]] = None,
            version: Optional[pulumi.Input[str]] = None,
            wait_until_ready: Optional[pulumi.Input[bool]] = None) -> 'AzurePostgresqlDatabase':
        """
        ...
        __props__ = _AzurePostgresqlDatabaseState.__new__(_AzurePostgresqlDatabaseState)
        ...
        __props__.__dict__["version"] = version
        __props__.__dict__["wait_until_ready"] = wait_until_ready
        return AzurePostgresqlDatabase(resource_name, opts=opts, __props__=__props__)
