...
__all__ = [
    'GetGkeCredentialsResult',
    'AwaitableGetGkeCredentialsResult',
    'get_gke_credentials',
    'get_gke_credentials_output',
]

@pulumi.output_type
class GetGkeCredentialsResult:
    """
...
class AwaitableGetGkeCredentialsResult(GetGkeCredentialsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetGkeCredentialsResult(
...
def get_gke_credentials(plan_id: Optional[str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGkeCredentialsResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('duplocloud:index/getGkeCredentials:getGkeCredentials', __args__, opts=opts, typ=GetGkeCredentialsResult).value

    return AwaitableGetGkeCredentialsResult(
...
def get_gke_credentials_output(plan_id: Optional[pulumi.Input[str]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGkeCredentialsResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('duplocloud:index/getGkeCredentials:getGkeCredentials', __args__, opts=opts, typ=GetGkeCredentialsResult)
    return __ret__.apply(lambda __response__: GetGkeCredentialsResult(
