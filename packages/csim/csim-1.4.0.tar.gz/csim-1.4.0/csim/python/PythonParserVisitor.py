...
class PythonParserVisitor(ParseTreeVisitor):
    ...
    def visitType_param_default(self, ctx:PythonParser.Type_param_defaultContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by PythonParser#type_param_starred_default.
    def visitType_param_starred_default(self, ctx:PythonParser.Type_param_starred_defaultContext):
        return self.visitChildren(ctx)
    ...
    def visitName_except_underscore(self, ctx:PythonParser.Name_except_underscoreContext):
        return self.visitChildren(ctx)
