...
`BMesh Design Document <https://developer.blender.org/docs/features/objects/mesh/bmesh/>`_.
...
def new(self, *args, use_operators: bool = True) -> types.BMesh:

  ...

def update_edit_mesh(self, mesh: bpy.types.Mesh, *args, loop_triangles: bool = True, destructive: bool = True) -> None:
