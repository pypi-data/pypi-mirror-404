...
def to_string(self, unit_system: str, unit_category: str, value: float, *args, precision: int = 3, split_unit: bool = False, compatible_unit: bool = False) -> str:
...
def to_value(self, unit_system: str, unit_category: str, str_input: str, *args, str_ref_unit: str = None) -> float:
