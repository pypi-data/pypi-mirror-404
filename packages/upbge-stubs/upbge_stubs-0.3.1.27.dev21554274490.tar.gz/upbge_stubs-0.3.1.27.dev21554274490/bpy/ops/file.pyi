...
def external_operation(*args, operation: str = 'OPEN') -> None:
...
def select(*args, wait_to_deselect_others: bool = False, use_select_on_click: bool = False, mouse_x: int = 0, mouse_y: int = 0, extend: bool = False, fill: bool = False, open: bool = True, deselect_all: bool = False, only_activate_if_selected: bool = False, pass_through: bool = False) -> None:
