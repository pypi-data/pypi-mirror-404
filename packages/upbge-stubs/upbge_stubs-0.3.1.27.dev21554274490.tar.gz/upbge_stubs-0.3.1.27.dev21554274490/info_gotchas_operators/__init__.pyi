...
Note: Blender does have the functionality for poll functions to describe why they fail,
...
``context`` category when ::`logging <blender_manual:command-line-args-logging-options>` can help.
