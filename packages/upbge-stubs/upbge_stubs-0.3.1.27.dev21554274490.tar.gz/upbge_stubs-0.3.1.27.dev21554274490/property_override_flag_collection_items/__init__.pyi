...
NOTE: For a property to be overridable, its whole chain of parent properties must also be defined as overridable.
...
.. _rna-enum-property-override-flag-collection-items:
