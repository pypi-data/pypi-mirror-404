...
:func:`object_report_if_active_shape_key_is_locked`
...
def object_data_add(context: bpy.types.Context, obdata: bpy.types.ID, operator: bpy.types.Operator = None, name: str = None) -> bpy.types.Object:
...
def object_report_if_active_shape_key_is_locked(obj: bpy.types.Object, operator: bpy.types.Operator) -> None:
