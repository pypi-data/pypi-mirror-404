...
Note: In the following examples ``bpy.context.object`` is assumed to be an armature object.
...
Note: Notice the pose is accessed from the object rather than the object data,
this is why Blender can have two or more objects sharing the same armature in different poses.

Note: Strictly speaking pose bones are not bones, they are just the state of the armature,
