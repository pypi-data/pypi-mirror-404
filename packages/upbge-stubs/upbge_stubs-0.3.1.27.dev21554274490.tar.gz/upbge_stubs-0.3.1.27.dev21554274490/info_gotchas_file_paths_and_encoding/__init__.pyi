...
See `PEP 263 <https://www.python.org/dev/peps/pep-0263/>`_.
...
Note: Sometimes it's preferable to avoid string encoding issues by using bytes instead of Python strings,
