...
from teachworks_sdk.models import WageTier, WageTierListParams

if TYPE_CHECKING:
    from teachworks_sdk.session import TeachworksSession


class WageTiersClient:
    """Client for Teachworks wage tier endpoints."""

    def __init__(self, session: TeachworksSession) -> None:
        """Initialize the wage tiers client.
    ...
    def retrieve(self, wage_tier_id: int) -> WageTier:
        """Retrieve a wage tier by ID.

        :param wage_tier_id: Wage tier identifier.
        :type wage_tier_id: int
        :returns: The requested wage tier.
        :rtype: WageTier
        ...
        """
        return self._session._retrieve("/wage_tiers", WageTier, wage_tier_id)
    ...
    def list(
        ...
        *,
        ...
        query: WageTierListParams | None = None,
        params: Dict[str, Any] | None = None,
    ) -> List[WageTier]:
        """List wage tiers with SDK pagination and filters.
