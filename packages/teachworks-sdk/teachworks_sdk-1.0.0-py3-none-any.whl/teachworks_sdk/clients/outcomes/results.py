...
from teachworks_sdk.models import Result, ResultListParams

if TYPE_CHECKING:
    from teachworks_sdk.session import TeachworksSession

class ResultsClient:
    """Client for Teachworks result endpoints."""
    ...
    def retrieve(self, result_id: int) -> Result:
        ...
        """
        return self._session._retrieve("/results", Result, result_id)
    ...
    def list(
        ...
        *,
        ...
        query: ResultListParams | None = None,
        params: Dict[str, Any] | None = None,
    ) -> List[Result]:
        """List results with SDK pagination and filters.
        ...
        :type query: ResultListParams | None
    ...
    def create(self, payload: Dict[str, Any]) -> Result:
        """Create a result.
        ...
        :raises TeachworksRateLimitError: When rate limits persist after retries.
        """
        data = self._session._request("POST", "/results", payload=payload)
        return self._session._parse_model(Result, data)

    def update(self, result_id: int, payload: Dict[str, Any]) -> Result:
        """Update a result.
        ...
        :raises TeachworksRateLimitError: When rate limits persist after retries.
        """
        data = self._session._request("PUT", f"/results/{result_id}", payload=payload)
        return self._session._handle_update_response(Result, result_id, data)
