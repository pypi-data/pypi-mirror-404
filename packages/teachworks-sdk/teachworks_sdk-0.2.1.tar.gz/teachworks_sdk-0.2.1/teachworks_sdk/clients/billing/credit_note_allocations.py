...
from teachworks_sdk.models import CreditNoteAllocation, CreditNoteAllocationListParams

if TYPE_CHECKING:
    from teachworks_sdk.session import TeachworksSession

class CreditNoteAllocationsClient:
    """Client for Teachworks credit note allocation endpoints."""

    def __init__(self, session: TeachworksSession) -> None:
        """Initialize the credit note allocations client.
    ...
    def retrieve(self, allocation_id: int) -> CreditNoteAllocation:
        """Retrieve a credit note allocation by ID.

        :param allocation_id: Allocation identifier.
        :type allocation_id: int
        :returns: The requested credit note allocation.
        :rtype: CreditNoteAllocation
        ...
        """
        return self._session._retrieve("/credit_note_allocations", CreditNoteAllocation, allocation_id)
    ...
    def list(
        ...
        *,
        ...
        query: CreditNoteAllocationListParams | None = None,
        params: Dict[str, Any] | None = None,
    ) -> List[CreditNoteAllocation]:
        """List credit note allocations with SDK pagination and filters.
