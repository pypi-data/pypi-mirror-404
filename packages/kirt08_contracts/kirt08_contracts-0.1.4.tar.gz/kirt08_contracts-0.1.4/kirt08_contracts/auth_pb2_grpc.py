...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.VerifyOtp = channel.unary_unary(
                ...
                request_serializer=kirt08__contracts_dot_auth__pb2.VerifyOtpRequest.SerializeToString,
                response_deserializer=kirt08__contracts_dot_auth__pb2.VerifyOtpResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'VerifyOtp': grpc.unary_unary_rpc_method_handler(
                    servicer.VerifyOtp,
                    request_deserializer=kirt08__contracts_dot_auth__pb2.VerifyOtpRequest.FromString,
                    response_serializer=kirt08__contracts_dot_auth__pb2.VerifyOtpResponse.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def VerifyOtp(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.v1.AuthService/VerifyOtp',
            kirt08__contracts_dot_auth__pb2.VerifyOtpRequest.SerializeToString,
            kirt08__contracts_dot_auth__pb2.VerifyOtpResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
