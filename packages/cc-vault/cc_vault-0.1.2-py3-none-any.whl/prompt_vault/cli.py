"""Main CLI entry point for CC-Vault."""
...
def main():
    ...
    # auth command
    auth_parser = subparsers.add_parser("auth", help="Authenticate with CC-Vault")
