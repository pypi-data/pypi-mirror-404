...
/rispec.specify Real-time chat system with message history and user presence
...
/rispec.plan WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
...
```text
Every feature in RISE Spec MUST begin its existence as a standalone library.
