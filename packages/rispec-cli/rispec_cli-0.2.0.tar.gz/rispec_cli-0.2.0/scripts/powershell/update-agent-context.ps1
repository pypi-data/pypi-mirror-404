...
$TEMPLATE_FILE = Join-Path $REPO_ROOT '.rispec/templates/agent-file-template.md'
...
function Validate-Environment {
    ...
    if (-not (Test-Path $TEMPLATE_FILE)) {
        ...
        Write-Info 'Run rispec init to scaffold .rispec/templates, or add agent-file-template.md there.'
        exit 1
    }
}
