...
[![PyPI Downloads](https://static.pepy.tech/personalized-badge/hedayat-media?period=total&units=INTERNATIONAL_SYSTEM&left_color=BLACK&right_color=GREEN&left_text=downloads)](https://pepy.tech/projects/hedayat-media)
...
HedayatMedia.get_response_from_chat(text,api_key)
چت با هوش مصنوعی مذهبی
...
ورودی ها:
page= شماره صفحه
results_per_page = چقدر پاسخ بگیره
