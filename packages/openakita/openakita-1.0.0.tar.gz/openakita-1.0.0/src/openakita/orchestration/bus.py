...
class AgentBus:
    ...
    def __init__(
        ...
        if not HAS_ZMQ:
            raise ImportError(
                "pyzmq is required for AgentBus. "
        ...
        # Socket
        self._router: Optional[zmq.asyncio.Socket] = None  # Master 端
        self._pub: Optional[zmq.asyncio.Socket] = None     # Master 端
        self._dealer: Optional[zmq.asyncio.Socket] = None  # Worker 端
        self._sub: Optional[zmq.asyncio.Socket] = None     # Worker 端
