...
class StrandsHandler:
    ...
    async def _on_before_model_call(self, event: "BeforeModelCallEvent") -> None:
        ...
        try:
            ...
            # Calculate depth for flow view ordering
            llm_depth = self._register_span_depth(self.model_span_id, self._current_parent_span_id)
    ...
    async def _on_after_model_call(self, event: "AfterModelCallEvent") -> None:
        ...
        try:
            ...
            per_call_usage = self._calculate_per_call_tokens(
                agent=event.agent,
                start_tokens=self._model_call_start_tokens,
            )
            ...
            logger.debug(
                ...
                f"(start_tokens={self._model_call_start_tokens})"
            )
            ...
            # Clear the start tokens for next model call
