...
_current_session_context: contextvars.ContextVar[Optional[StrandsSessionContext]] = (
    contextvars.ContextVar("_current_strands_session_context", default=None)
)


def get_session_context() -> Optional[StrandsSessionContext]:
    """
...
def set_session_context(context: Optional[StrandsSessionContext]) -> contextvars.Token:
    """
