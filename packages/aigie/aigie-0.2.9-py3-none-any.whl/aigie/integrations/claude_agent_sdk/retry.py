"""
Retry and timeout utilities for Claude Agent SDK integration.
...
class RetryContext:
    ...
    Example:
        async with RetryContext(max_retries=3, operation="agent_query") as ctx:
            result = await ctx.execute(my_agent.query, prompt)
