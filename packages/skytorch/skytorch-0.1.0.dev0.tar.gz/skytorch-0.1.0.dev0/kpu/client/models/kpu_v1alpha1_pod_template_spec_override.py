...
class KpuV1alpha1PodTemplateSpecOverride(BaseModel):
    """
    PodTemplateSpecOverride represents the spec overrides for Pod template.
    """ # noqa: E501
    affinity: Optional[IoK8sApiCoreV1Affinity] = Field(default=None, description="affinity overrides for the affinity.")
    containers: Optional[List[KpuV1alpha1ContainerOverride]] = Field(default=None, description="containers overrides for the containers.")
    image_pull_secrets: Optional[List[IoK8sApiCoreV1LocalObjectReference]] = Field(default=None, description="imagePullSecrets overrides the image pull secrets.", alias="imagePullSecrets")
    init_containers: Optional[List[KpuV1alpha1ContainerOverride]] = Field(default=None, description="initContainers overrides the init containers.", alias="initContainers")
    node_selector: Optional[Dict[str, StrictStr]] = Field(default=None, description="nodeSelector overrides the node selector.", alias="nodeSelector")
    scheduling_gates: Optional[List[IoK8sApiCoreV1PodSchedulingGate]] = Field(default=None, description="schedulingGates overrides the scheduling gates. More info: https://kubernetes.io/docs/concepts/scheduling-eviction/pod-scheduling-readiness/", alias="schedulingGates")
    ...
    tolerations: Optional[List[IoK8sApiCoreV1Toleration]] = Field(default=None, description="tolerations overrides the tolerations.")
    volumes: Optional[List[IoK8sApiCoreV1Volume]] = Field(default=None, description="volumes overrides the volumes.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KpuV1alpha1PodTemplateSpecOverride from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KpuV1alpha1PodTemplateSpecOverride from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "containers": [KpuV1alpha1ContainerOverride.from_dict(_item) for _item in obj["containers"]] if obj.get("containers") is not None else None,
            ...
            "initContainers": [KpuV1alpha1ContainerOverride.from_dict(_item) for _item in obj["initContainers"]] if obj.get("initContainers") is not None else None,
