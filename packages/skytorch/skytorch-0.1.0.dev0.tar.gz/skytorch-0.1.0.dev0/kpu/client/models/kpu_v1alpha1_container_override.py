...
class KpuV1alpha1ContainerOverride(BaseModel):
    """
    ContainerOverride represents parameters that can be overridden using PodSpecOverrides.
    """ # noqa: E501
    env: Optional[List[IoK8sApiCoreV1EnvVar]] = Field(default=None, description="env is the list of environment variables to set in the container.")
    name: StrictStr = Field(description="name for the container.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KpuV1alpha1ContainerOverride from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KpuV1alpha1ContainerOverride from a dict"""
        if obj is None:
            return None
