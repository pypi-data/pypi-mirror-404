...
from kpu.client.models.io_k8s_apimachinery_pkg_apis_meta_v1_list_meta import IoK8sApimachineryPkgApisMetaV1ListMeta
from kpu.client.models.kpu_v1alpha1_compute import KpuV1alpha1Compute
from typing import Optional, Set
from typing_extensions import Self

class KpuV1alpha1ComputeList(BaseModel):
    """
    ...
    items: List[KpuV1alpha1Compute] = Field(description="List of Computes.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KpuV1alpha1ComputeList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KpuV1alpha1ComputeList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [KpuV1alpha1Compute.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
