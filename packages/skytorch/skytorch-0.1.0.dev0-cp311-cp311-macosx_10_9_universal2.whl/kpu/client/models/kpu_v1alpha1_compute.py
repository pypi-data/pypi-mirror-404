...
class KpuV1alpha1Compute(BaseModel):
    """
    ...
    metadata: Optional[IoK8sApimachineryPkgApisMetaV1ObjectMeta] = Field(default=None, description="metadata of the Compute.")
    spec: Optional[KpuV1alpha1ComputeSpec] = Field(default=None, description="spec of the Compute.")
    status: Optional[KpuV1alpha1ComputeStatus] = Field(default=None, description="status of the Compute.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KpuV1alpha1Compute from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KpuV1alpha1Compute from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": KpuV1alpha1ComputeSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": KpuV1alpha1ComputeStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
