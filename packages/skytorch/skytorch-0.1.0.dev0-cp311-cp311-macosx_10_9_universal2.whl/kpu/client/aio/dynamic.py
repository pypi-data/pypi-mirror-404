...
from kubernetes.dynamic.exceptions import KubernetesValidateMissing, api_exception
...
class DynamicClient(object):
    ...
    async def watch(self, resource, namespace=None, name=None, label_selector=None, field_selector=None,
        ...
        """
        if not watcher:
            watcher = watch.Watch(api_client=self.client)
