...
if TYPE_CHECKING:
    ...
    Constructors:
        This base type has 151 constructors available.
        ...
        def __init__(self):
            raise TypeError("Base types can only be used for type checking purposes: "
                            ...
                            "More info: https://docs.kurigram.icu/telegram/base/update")
