...
from .inline_query_result_mpeg4_animation import InlineQueryResultMpeg4Animation
from .inline_query_result_cached_mpeg4_animation import InlineQueryResultCachedMpeg4Animation
...
__all__ = [
    ...
    "InlineQueryResultMpeg4Animation",
    "InlineQueryResultCachedMpeg4Animation",
]
