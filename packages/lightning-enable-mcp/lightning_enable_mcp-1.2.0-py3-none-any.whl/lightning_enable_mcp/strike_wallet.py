...
NOTE: Strike does NOT return preimage for outgoing payments, so this wallet
cannot be used for L402 authentication. Use for general invoice payments only.
For L402, use NWC or a wallet that returns preimages.
...
class StrikeWallet:
    ...
    NOTE: Strike does NOT return preimage for Lightning payments.
    This means L402 authentication WILL NOT WORK with Strike.
    For L402 support, use NWC or LND wallet instead.
    """
    ...
    async def pay_invoice(self, bolt11: str, amount_sats: int | None = None) -> str:
        ...
        NOTE: Strike does NOT return preimage for outgoing payments.
        The returned value is the payment ID, not a preimage.
        This means L402 authentication WILL NOT WORK with Strike.
        ...
        Returns:
            Payment ID (NOT preimage - Strike doesn't provide preimage)
        ...
        logger.warning(
            "Strike does not return preimage - L402 verification will NOT work. "
            "For L402 support, use NWC or LND wallet."
        )
    ...
    async def get_info(self) -> dict[str, Any]:
        ...
        return {
            ...
            "preimage_support": False,
            "l402_compatible": False,
            "note": "Strike does not return preimage. Use NWC for L402.",
        }
