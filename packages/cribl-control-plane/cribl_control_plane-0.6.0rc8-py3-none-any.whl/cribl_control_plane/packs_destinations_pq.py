...
class PacksDestinationsPq(BaseSDK):
    def clear(
        self,
        *,
        id: str,
        ...
        r"""Clear the persistent queue for a Destination within a Pack
        ...
        request = models.DeleteOutputSystemPqByPackAndIDRequest(
            id=id,
            pack=pack,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="deleteOutputSystemPqByPackAndId",
                oauth2_scopes=[],
    ...
    def get(
        ...
        *,
        ...
        r"""Get information about the latest job to clear the persistent queue for a Destination within a Pack
        ...
        request = models.GetOutputSystemPqByPackAndIDRequest(
            id=id,
            pack=pack,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getOutputSystemPqByPackAndId",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
