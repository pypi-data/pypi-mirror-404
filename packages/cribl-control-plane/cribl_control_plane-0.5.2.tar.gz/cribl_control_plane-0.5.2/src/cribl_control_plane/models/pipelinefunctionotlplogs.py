...
class PipelineFunctionOtlpLogsID(str, Enum):
    r"""Function ID"""

    OTLP_LOGS = "otlp_logs"


class PipelineFunctionOtlpLogsTypedDict(TypedDict):
    id: PipelineFunctionOtlpLogsID
    r"""Function ID"""
    conf: FunctionConfSchemaOtlpLogsTypedDict
...
class PipelineFunctionOtlpLogs(BaseModel):
    id: PipelineFunctionOtlpLogsID
    r"""Function ID"""
