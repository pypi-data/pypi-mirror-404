...
class PipelineFunctionSamplingID(str, Enum):
    r"""Function ID"""

    SAMPLING = "sampling"


class PipelineFunctionSamplingTypedDict(TypedDict):
    id: PipelineFunctionSamplingID
    r"""Function ID"""
    conf: FunctionConfSchemaSamplingTypedDict
...
class PipelineFunctionSampling(BaseModel):
    id: PipelineFunctionSamplingID
    r"""Function ID"""
