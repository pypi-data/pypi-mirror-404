...
class PacksSamples(BaseSDK):
    def get(
        ...
        *,
        ...
        r"""Get sample event data for a Destination within a Pack
        ...
        request = models.GetOutputSystemSamplesByPackAndIDRequest(
            id=id,
            pack=pack,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="getOutputSystemSamplesByPackAndId",
                oauth2_scopes=[],
    ...
    def create(
        ...
        *,
        ...
        r"""Send sample event data to a Destination within a Pack
        ...
        request = models.CreateOutputSystemTestByPackAndIDRequest(
            id=id,
            pack=pack,
        ...
        req = self._build_request(
            method="POST",
            path="/p/{pack}/system/outputs/{id}/test",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="createOutputSystemTestByPackAndId",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
