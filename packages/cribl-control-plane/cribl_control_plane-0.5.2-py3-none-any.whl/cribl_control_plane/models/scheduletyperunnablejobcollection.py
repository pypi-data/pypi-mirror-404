...
class ScheduleTypeRunnableJobCollectionType(str, Enum, metaclass=utils.OpenEnumMeta):
    COLLECTION = "collection"


class ScheduleTypeRunnableJobCollectionRunSettingsTypedDict(TypedDict):
    mode: str
    ...
    type: NotRequired[ScheduleTypeRunnableJobCollectionType]
...
class ScheduleTypeRunnableJobCollectionRunSettings(BaseModel):
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return models.ScheduleTypeRunnableJobCollectionType(value)
            except ValueError:
                return value
        return value
...
class ScheduleTypeRunnableJobCollectionTypedDict(TypedDict):
    ...
    run: NotRequired[ScheduleTypeRunnableJobCollectionRunSettingsTypedDict]


class ScheduleTypeRunnableJobCollection(BaseModel):
    r"""Configuration for a scheduled job"""
