...
class ItemsTypeHealthCheckAuthenticationOauthAuthRequestHeadersTypedDict(TypedDict):
    name: str
    r"""Header name."""
    value: str
...
class ItemsTypeHealthCheckAuthenticationOauthAuthRequestHeaders(BaseModel):
    name: str
    r"""Header name."""
