...
class PacksHecTokens(BaseSDK):
    def create(
        ...
        *,
        ...
        r"""Add an HEC token and optional metadata to a Splunk HEC Source within a Pack
        ...
        request = models.CreateInputSystemHecTokenByPackAndIDRequest(
            id=id,
            pack=pack,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="createInputSystemHecTokenByPackAndId",
                oauth2_scopes=[],
    ...
    def update(
        ...
        *,
        ...
        r"""Update metadata for an HEC token for a Splunk HEC Source within a Pack
        ...
        request = models.UpdateInputSystemHecTokenByPackAndIDAndTokenRequest(
            id=id,
            token=token,
            pack=pack,
        ...
        req = self._build_request(
            method="PATCH",
            path="/p/{pack}/system/inputs/{id}/hectoken/{token}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="updateInputSystemHecTokenByPackAndIdAndToken",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
