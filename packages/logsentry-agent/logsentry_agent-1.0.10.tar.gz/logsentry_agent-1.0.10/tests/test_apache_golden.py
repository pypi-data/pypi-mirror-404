...
from logsentry_agent.collectors.apache import parse_line
...
FIXTURES = Path(__file__).parent / "fixtures" / "apache"


def test_apache_fixtures():
    with patch_hostname(), patch_time(), patch_uuid4("FIXTURE-APA"):
