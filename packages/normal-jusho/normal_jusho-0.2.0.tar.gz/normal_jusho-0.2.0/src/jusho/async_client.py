"""Asynchronous client for the Jusho address normalization API.
...
class AsyncJusho:
    """Asynchronous client for the Jusho API.

    This client uses :class:`httpx.AsyncClient` under the hood and must be
    used with ``await``.  It is best used as an async context manager::
    ...
    Args:
        ...
        http_client: An existing :class:`httpx.AsyncClient`.  When
    ...
    async def __aenter__(self) -> "AsyncJusho":
        return self
    ...
    async def normalize(self, address: str) -> NormalizeResult:
        ...
        """
        data = await self._request("POST", "/normalize", json={"address": address})
        return _parse_normalize_result(data)

    async def normalize_batch(self, addresses: Sequence[str]) -> BatchResult:
    ...
    async def postal(self, code: str) -> PostalResult:
        ...
        Raises:
            ...
            APIError: On other unexpected API errors.
        """
        data = await self._request("GET", f"/postal/{code}")
        return _parse_postal_result(data)

    async def suggest(self, query: str) -> SuggestResult:
        ...
        Raises:
            ...
            APIError: On other unexpected API errors.
        """
        data = await self._request("GET", "/suggest", params={"q": query})
    ...
    async def validate(self, address: str) -> ValidationResult:
        ...
        Raises:
            ...
            APIError: On other unexpected API errors.
        """
        data = await self._request("GET", "/validate", params={"address": address})
        return _parse_validation_result(data)

    async def reverse(self, address: str) -> ReverseResult:
        ...
        Raises:
            ...
            APIError: On other unexpected API errors.
        """
        data = await self._request("GET", "/reverse", params={"address": address})
