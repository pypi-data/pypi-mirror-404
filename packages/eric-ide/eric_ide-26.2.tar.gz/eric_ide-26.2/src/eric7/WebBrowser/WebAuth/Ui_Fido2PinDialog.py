...
class Ui_Fido2PinDialog(object):
    def setupUi(self, Fido2PinDialog):
        ...
        self.pinEdit = EricPasswordEdit(parent=Fido2PinDialog)
        ...
        self.newPinEdit = EricPasswordEdit(parent=self.newPinGroupBox)
        self.newPinEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
