...
class HistoryMenuModel(QAbstractProxyModel):
    ...
    def mapToSource(self, proxyIndex):
        ...
        return self.__treeModel.mapFromSource(historyIndex)
...
class HistoryMenu(EricModelMenu):
    ...
    def __init__(self, mainWindow=None, tabWidget=None):
        """
        Constructor

        @param mainWindow reference to the main browser window object
        @type WebBrowserWindow
        @param tabWidget reference to the tab widget managing the browser
            tabs
        @type WebBrowserTabWidget
        """
        EricModelMenu.__init__(self)
