...
class EricServerDebuggerRequestHandler(EricServerBaseRequestHandler):
    ...
    def __serviceDbgClientConnection(self, key):
        ...
        if data is None:
            ...
            # debugging
            # - print("Client Response:", jsonStr)  # noqa: ERA001
            self._server.sendJson(
    ...
    def __stopClient(self, _params):
        """
        Private method to stop the current debug client process.

        @param _params dictionary containing the request data
        @type dict
    ...
    def __relayDebugClientCommand(self, params):
        ...
        if debuggerId == "<<all>>":
            ...
            try:  # noqa: Y-105
                ...
                # - print(
                # -    f"Command for unknown debugger ID"
                # -    f" '{debuggerId}' received."  # noqa: ERA001
                # - )
                pass
