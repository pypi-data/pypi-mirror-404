...
from PyQt6.QtWidgets import QDialog, QMenu, QSplitter, QTabWidget, QToolBar, QWhatsThis

from eric7 import EricUtilities, Preferences
from eric7.EricGui import EricPixmapCache
from eric7.EricGui.EricAction import EricAction
from eric7.EricWidgets import EricFileDialog, EricMessageBox, EricPasswordDialog
...
class PdfViewerWindow(EricMainWindow):
    ...
    def __initGotoActions(self):
        ...
        self.previousPageAct = EricAction(
            ...
            self.tr("&Previous Page"),
            QKeySequence(self.tr("PgUp", "Goto|Page Up")),
            0,
            self,
        ...
        self.nextPageAct = EricAction(
            ...
            self.tr("&Next Page"),
            QKeySequence(self.tr("PgDown", "Goto|Page Down")),
            0,
            self,
            "pdfviewer_goto_next",
        )
    ...
    def __loadPdfFile(self, fileName):
        ...
        while not canceled and err == QPdfDocument.Error.IncorrectPassword:
            ...
            if err == QPdfDocument.Error.IncorrectPassword:
                password, ok = EricPasswordDialog.getPassword(
                    self,
    ...
    def __copyAllText(self):
        ...
        """
        textPages = [
            self.__pdfDocument.getAllText(page).text()
