...
class VcsProjectBrowserHelper(QObject):
    ...
    def showContextMenu(self, menu, standardItems):  # noqa: U-100
        """
    ...
    def showContextMenuMulti(self, menu, standardItems):  # noqa: U-100
        """
    ...
    def showContextMenuDir(self, menu, standardItems):  # noqa: U-100
        """
        Public slot called before the context menu is shown.
    ...
    def showContextMenuDirMulti(self, menu, standardItems):  # noqa: U-100
        """
        Public slot called before the context menu is shown.
