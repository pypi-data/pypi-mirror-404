...
class VersionControl(QObject):
    ...
    def vcsInit(self, vcsDir, noDialog=False):  # noqa: ARG002, U-100
        """
    ...
    def vcsConvertProject(self, vcsDataDict, project, addAll=True):  # noqa: U-100
        """
    ...
    def vcsImport(
        self,
        vcsDataDict,  # noqa: ARG002, U-100
        projectDir,  # noqa: ARG002, U-100
        noDialog=False,  # noqa: ARG002, U-100
        addAll=True,  # noqa: ARG002, U-100
    ):
        """
    ...
    def vcsExport(self, vcsDataDict, projectDir):  # noqa: ARG002, U-100
        """
    ...
    def vcsCommit(self, name, message, noDialog=False):  # noqa: ARG002, U-100
        """
    ...
    def vcsAddCommitMessage(self, message):  # noqa: U-100
        """
    ...
    def vcsUpdate(self, name, noDialog=False):  # noqa: ARG002, U-100
        """
    ...
    def vcsAddBinary(self, name, isDir=False):  # noqa: U-100
        """
    ...
    def vcsAddTree(self, path):  # noqa: U-100
        """
    ...
    def vcsMove(
        self,
        name,  # noqa: ARG002, U-100
        project,  # noqa: ARG002, U-100
        target=None,  # noqa: ARG002, U-100
        noDialog=False,  # noqa: ARG002, U-100
    ):
        """
    ...
    def vcsLogBrowser(self, name, isFile=False):  # noqa: U-100
        """
    ...
    def vcsDiff(self, name):  # noqa: U-100
        """
    ...
    def vcsSbsDiff(self, name, extended=False, revisions=None):  # noqa: U-100
        """
    ...
    def vcsStatus(self, name):  # noqa: U-100
        """
    ...
    def vcsTag(self, name):  # noqa: U-100
        """
    ...
    def vcsRevert(self, name):  # noqa: ARG002, U-100
        """
    ...
    def vcsForget(self, name):  # noqa: U-100
        """
    ...
    def vcsSwitch(self, name):  # noqa: ARG002, U-100
        """
    ...
    def vcsMerge(self, name):  # noqa: U-100
        """
    ...
    def vcsRegisteredState(self, name):  # noqa: ARG002, U-100
        """
    ...
    def vcsAllRegisteredStates(self, names, dname):  # noqa: ARG002, U-100
        """
    ...
    def vcsCleanup(self, name):  # noqa: U-100
        """
    ...
    def vcsCommandLine(self, name):  # noqa: U-100
        """
    ...
    def vcsNewProjectOptionsDialog(self, parent=None):  # noqa: U-100
        """
    ...
    def vcsRepositoryInfos(self, ppath):  # noqa: ARG002, U-100
        """
    ...
    def vcsGetProjectBrowserHelper(
        self,
        browser,  # noqa: ARG002, U-100
        project,  # noqa: ARG002, U-100
        isTranslationsBrowser=False,  # noqa: ARG002, U-100
    ):
        """
    ...
    def vcsGetProjectHelper(self, project):  # noqa: ARG002, U-100
        """
    ...
    def _createStatusMonitorThread(self, interval, project):  # noqa: ARG002, U-100
        """
