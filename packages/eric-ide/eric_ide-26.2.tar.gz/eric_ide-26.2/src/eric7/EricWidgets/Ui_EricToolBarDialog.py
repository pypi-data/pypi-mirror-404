...
class Ui_EricToolBarDialog(object):
    def setupUi(self, EricToolBarDialog):
        ...
        EricToolBarDialog.resize(600, 600)
        EricToolBarDialog.setSizeGripEnabled(True)
        self.verticalLayout = QtWidgets.QVBoxLayout(EricToolBarDialog)
        ...
        self.gridLayout.addWidget(self.actionsTree, 1, 0, 4, 1)
        self.separatorButton = QtWidgets.QPushButton(parent=EricToolBarDialog)
        self.separatorButton.setObjectName("separatorButton")
        self.gridLayout.addWidget(self.separatorButton, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.toolbarActionsList, 1, 2, 4, 1)
        ...
        self.gridLayout.addLayout(self.gridlayout, 3, 1, 1, 1)
        ...
        EricToolBarDialog.setTabOrder(self.leftButton, self.separatorButton)
    ...
    def retranslateUi(self, EricToolBarDialog):
        ...
        self.separatorButton.setToolTip(_translate("EricToolBarDialog", "Press to add a separator entry"))
        self.separatorButton.setText(_translate("EricToolBarDialog", "Separator >"))
