...
from PyQt6.QtCore import QCoreApplication, QLocale, QSize, Qt, pyqtSignal, pyqtSlot
...
class HexEditMainWindow(EricMainWindow):
    ...
    def __saveHexFileReadable(self, selectionOnly=False):
        ...
        if FileSystemUtilities.isRemoteFileName(savePath):
            fileName = EricServerFileDialog.getSaveFileNameWithExtension(
                self,
    ...
    def __about(self):
        ...
        EricMessageBox.about(
            ...
            self.tr(
                "The eric Hex Editor is a simple editor component to edit binary files."
            ),
        )
