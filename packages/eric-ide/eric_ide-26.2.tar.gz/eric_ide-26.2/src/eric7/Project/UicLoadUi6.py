...
import os
import sys
import xml.etree.ElementTree as ET  # noqa: N-815
...
with contextlib.suppress(ImportError):
    from PyQt6 import QtWebEngineWidgets  # noqa: F401 __IGNORE_WARNING__
...
def objectName(formFile, projectPath):
    ...
    try:
        ...
        sys.exit(0)
    except (AttributeError, ET.ParseError, ImportError) as err:
        _printerr(str(err))
        sys.exit(1)
...
def __mapType(type_):
    ...
    return mapped.replace("double", "float")
