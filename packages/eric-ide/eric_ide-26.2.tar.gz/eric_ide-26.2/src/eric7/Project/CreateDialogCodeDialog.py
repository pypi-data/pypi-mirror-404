...
class CreateDialogCodeDialog(QDialog, Ui_CreateDialogCodeDialog):
    ...
    def __runUicLoadUi(self, command):
        ...
        if not venvName and projectType in ("PyQt6", "E7Plugin", "PySide6"):
        ...
        if self.__module is None:
            ...
            try:
                if self.project.getProjectType() == "PySide6":
                    ...
                    return
                with open(tmplName, encoding="utf-8") as tmplFile:
            ...
            try:
                with open(self.srcFile, encoding="utf-8") as srcFile:
