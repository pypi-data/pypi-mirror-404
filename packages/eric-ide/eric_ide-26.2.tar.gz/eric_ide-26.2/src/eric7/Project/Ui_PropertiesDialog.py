...
class Ui_PropertiesDialog(object):
    def setupUi(self, PropertiesDialog):
        ...
        PropertiesDialog.resize(600, 706)
        ...
        self.horizontalLayout_4.addWidget(self.embeddedVenvCheckBox)
        self.embeddedVenvTypeComboBox = QtWidgets.QComboBox(parent=PropertiesDialog)
        self.embeddedVenvTypeComboBox.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.embeddedVenvTypeComboBox.sizePolicy().hasHeightForWidth())
        self.embeddedVenvTypeComboBox.setSizePolicy(sizePolicy)
        self.embeddedVenvTypeComboBox.setObjectName("embeddedVenvTypeComboBox")
        self.horizontalLayout_4.addWidget(self.embeddedVenvTypeComboBox)
        ...
        self.populateButton = QtWidgets.QPushButton(parent=PropertiesDialog)
        ...
        self.embeddedVenvCheckBox.toggled['bool'].connect(self.embeddedVenvTypeComboBox.setEnabled) # type: ignore
        ...
        PropertiesDialog.setTabOrder(self.embeddedVenvCheckBox, self.embeddedVenvTypeComboBox)
        PropertiesDialog.setTabOrder(self.embeddedVenvTypeComboBox, self.spellPropertiesButton)
        ...
        PropertiesDialog.setTabOrder(self.vcsInfoButton, self.populateButton)
...
"<p>Enter a short description for the project.</p>"))
        ...
        self.embeddedVenvTypeComboBox.setToolTip(_translate("PropertiesDialog", "Select the type of the embedded environment"))
        ...
        self.populateButton.setToolTip(_translate("PropertiesDialog", "Press to populate the dialog with data of a \'pyproject.toml\' file."))
        self.populateButton.setText(_translate("PropertiesDialog", "Populate From \'pyproject.toml\'"))
