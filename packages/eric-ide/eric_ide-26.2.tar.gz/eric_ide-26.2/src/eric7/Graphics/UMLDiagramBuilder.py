...
class UMLDiagramBuilder(QObject):
    ...
    def buildDiagram(self):
        ...
        @exception NotImplementedError raised to indicate that this class
            must be subclassed
        """
        err = "Method 'buildDiagram' must be implemented in subclasses."
        raise NotImplementedError(err)

    def parsePersistenceData(self, version, data):  # noqa: ARG002, U-100
        """
    ...
    def fromDict(self, version, data):  # noqa: ARG002, U-100
        """
