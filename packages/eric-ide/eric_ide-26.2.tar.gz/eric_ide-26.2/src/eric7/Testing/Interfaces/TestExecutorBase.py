...
class TestConfig:
    ...
    customParameters: list = field(
        default_factory=list
    )  # list of custom commandline parameters
...
class TestExecutorBase(QObject):
    ...
    def getVersions(self, interpreter):  # noqa: ARG002, U-100
        """
    ...
    def hasCoverage(self, interpreter):  # noqa: ARG002, U-100
        """
    ...
    def supportsPatterns(self, interpreter):  # noqa: ARG002, U-100
        """
    ...
    def supportsMarkers(self, interpreter):  # noqa: ARG002, U-100
        """
    ...
    def getMarkers(self, interpreter, workdir):  # noqa: ARG002, U-100
        """
    ...
    def createArguments(self, config):  # noqa: ARG002
        """
    ...
    def discover(self, config, pythonpath):
        ...
        if not config.discoveryStart:
            exc = "No discovery start directory given."
        ...
        if not running:
            exc = "Test discovery process did not start."
    ...
    def start(self, config, pythonpath):
        ...
        running = self.__process.waitForStarted()
        if not running:
            exc = "Test process did not start."
            raise RuntimeError(exc)
