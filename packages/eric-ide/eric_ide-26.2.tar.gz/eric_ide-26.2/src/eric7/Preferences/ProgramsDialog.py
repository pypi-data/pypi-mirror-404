...
class ProgramsDialog(QDialog, Ui_ProgramsDialog):
    ...
    def on_programsSearchButton_clicked(self):
        ...
        with EricOverrideCursor():
            ...
            # 7. do the MicroPython related entries
