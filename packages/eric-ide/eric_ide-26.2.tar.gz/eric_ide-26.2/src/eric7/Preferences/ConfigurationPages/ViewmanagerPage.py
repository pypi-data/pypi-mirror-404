...
class ViewmanagerPage(ConfigurationPageBase, Ui_ViewmanagerPage):
    ...
    def __init__(self):
        ...
        self.maxHistorySizeSpinBox.setValue(
            Preferences.getUI("NavigationHistoryMaximumSize")
        )

        self.minLineDeltaSpinBox.setValue(
            Preferences.getUI("NavigationHistoryLineOffset")
        )

        self.maxHistoryMenuLengthSpinBox.setValue(
    ...
    def save(self):
        ...
        Preferences.setUI(
            "NavigationHistoryMaximumSize", self.maxHistorySizeSpinBox.value()
        )
        Preferences.setUI(
            "NavigationHistoryLineOffset", self.minLineDeltaSpinBox.value()
        )
        Preferences.setUI(
            "NavigationMaximumHistoryMenuItems",
            self.maxHistoryMenuLengthSpinBox.value(),
        )
