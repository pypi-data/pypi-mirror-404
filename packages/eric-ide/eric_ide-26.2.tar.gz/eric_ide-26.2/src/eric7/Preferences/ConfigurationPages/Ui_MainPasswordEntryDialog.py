...
class Ui_MainPasswordEntryDialog(object):
    def setupUi(self, MainPasswordEntryDialog):
        ...
        MainPasswordEntryDialog.resize(450, 350)
        ...
        self.currentPasswordEdit = EricPasswordEdit(parent=MainPasswordEntryDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.currentPasswordEdit.sizePolicy().hasHeightForWidth())
        self.currentPasswordEdit.setSizePolicy(sizePolicy)
        self.currentPasswordEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        self.newPasswordEdit = EricPasswordEdit(parent=MainPasswordEntryDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.newPasswordEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        self.newPasswordAgainEdit = EricPasswordEdit(parent=MainPasswordEntryDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.newPasswordAgainEdit.sizePolicy().hasHeightForWidth())
        self.newPasswordAgainEdit.setSizePolicy(sizePolicy)
        self.newPasswordAgainEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
