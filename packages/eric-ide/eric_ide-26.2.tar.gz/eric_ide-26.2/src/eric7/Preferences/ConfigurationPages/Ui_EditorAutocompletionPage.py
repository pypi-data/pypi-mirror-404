...
class Ui_EditorAutocompletionPage(object):
    def setupUi(self, EditorAutocompletionPage):
        ...
        EditorAutocompletionPage.resize(474, 655)
        ...
        self.gridLayout_4.addWidget(self.textLabel1_2, 0, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.acTimeoutSpinBox, 1, 1, 1, 1)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.noAcCommentsCheckBox = QtWidgets.QCheckBox(parent=self.acEnabledGroupBox)
        self.noAcCommentsCheckBox.setObjectName("noAcCommentsCheckBox")
        self.horizontalLayout_3.addWidget(self.noAcCommentsCheckBox)
        self.noAcStringsCheckBox = QtWidgets.QCheckBox(parent=self.acEnabledGroupBox)
        self.noAcStringsCheckBox.setObjectName("noAcStringsCheckBox")
        self.horizontalLayout_3.addWidget(self.noAcStringsCheckBox)
        ...
        EditorAutocompletionPage.setTabOrder(self.acTimeoutSpinBox, self.noAcCommentsCheckBox)
        EditorAutocompletionPage.setTabOrder(self.noAcCommentsCheckBox, self.noAcStringsCheckBox)
        EditorAutocompletionPage.setTabOrder(self.noAcStringsCheckBox, self.acScintillaCheckBox)
    ...
    def retranslateUi(self, EditorAutocompletionPage):
        ...
        self.noAcCommentsCheckBox.setToolTip(_translate("EditorAutocompletionPage", "Select to disable automatic completions in comment areas"))
        self.noAcCommentsCheckBox.setText(_translate("EditorAutocompletionPage", "No completions in comments"))
        self.noAcStringsCheckBox.setToolTip(_translate("EditorAutocompletionPage", "Select to disable automatic completions in string areas"))
        self.noAcStringsCheckBox.setText(_translate("EditorAutocompletionPage", "No completions in strings"))
