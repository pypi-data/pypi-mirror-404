...
class Ui_EditorFilePage(object):
    def setupUi(self, EditorFilePage):
        ...
        EditorFilePage.resize(600, 1717)
    ...
    def retranslateUi(self, EditorFilePage):
        ...
        self.autosaveOnFocusLostCheckBox.setToolTip(_translate("EditorFilePage", "Select to save the file automatically when the editor loses the input focus."))
