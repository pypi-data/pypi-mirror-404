...
class DebuggerPython3Page(ConfigurationPageBase, Ui_DebuggerPython3Page):
    ...
    def __init__(self):
        ...
        self.settraceCheckBox.setChecked(
            Preferences.getDebugger("PythonTracingDebugger")
        )
    ...
    def save(self):
        ...
        Preferences.setDebugger(
            "PythonTracingDebugger", self.settraceCheckBox.isChecked()
        )
