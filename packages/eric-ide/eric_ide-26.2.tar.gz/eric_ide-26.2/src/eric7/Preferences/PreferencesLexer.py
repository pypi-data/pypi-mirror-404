...
class PreferencesLexer(QObject):
    ...
    def defaultWords(self, style, substyle=-1):
        ...
        @rtype str
        """
        return self.__lex.substyleDefaultWords(style, substyle) if substyle >= 0 else ""
    ...
    def words(self, style, substyle=-1):
        ...
        @rtype str
        """
        return self.__lex.substyleWords(style, substyle) if substyle >= 0 else ""
    ...
    def hasStyle(self, style, substyle):
        ...
        @rtype bool
        """
        return self.__lex.hasSubstyle(style, substyle) if substyle >= 0 else True
