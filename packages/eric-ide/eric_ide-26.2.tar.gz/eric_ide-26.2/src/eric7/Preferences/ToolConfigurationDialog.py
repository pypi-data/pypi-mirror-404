...
class ToolConfigurationDialog(QDialog, Ui_ToolConfigurationDialog):
    ...
    def __init__(self, toollist, parent=None):
        ...
        self.iconPicker.setFilters(self.tr("Icon files (*.png *.svg)"))
    ...
    @pyqtSlot(str)
    def on_menuEdit_textChanged(self, _text):
        """
        Private slot called, when the menu text was changed.

        @param _text the new text (ignored)
        @type str
        """
        self.__toolEntryChanged()

    @pyqtSlot(str)
    def on_iconPicker_textChanged(self, _text):
        """
    ...
    @pyqtSlot(str)
    def on_executablePicker_textChanged(self, _text):
        """
    ...
    @pyqtSlot(str)
    def on_argumentsEdit_textChanged(self, _text):
        """
