...
class Ui_FileDialogWizardDialog(object):
    def setupUi(self, FileDialogWizardDialog):
        ...
        FileDialogWizardDialog.resize(645, 939)
        ...
        self.rSaveFileExt = QtWidgets.QRadioButton(parent=self.typeGroupBox)
        self.rSaveFileExt.setObjectName("rSaveFileExt")
        self.gridLayout.addWidget(self.rSaveFileExt, 2, 2, 1, 2)
        ...
        FileDialogWizardDialog.setTabOrder(self.rfSaveFile, self.rSaveFileExt)
        FileDialogWizardDialog.setTabOrder(self.rSaveFileExt, self.rOpenFileUrl)
    ...
    def retranslateUi(self, FileDialogWizardDialog):
        ...
        self.rSaveFileExt.setToolTip(_translate("FileDialogWizardDialog", "Select to create a \'Save File\' dialog ensuring the returned file name has an extension"))
        self.rSaveFileExt.setText(_translate("FileDialogWizardDialog", "Save File with Extension"))
