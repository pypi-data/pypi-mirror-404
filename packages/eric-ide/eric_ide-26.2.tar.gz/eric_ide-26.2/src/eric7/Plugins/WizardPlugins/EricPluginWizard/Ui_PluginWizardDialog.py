...
class Ui_PluginWizardDialog(object):
    def setupUi(self, PluginWizardDialog):
        ...
        self.convertPasswordsCheckBox = QtWidgets.QCheckBox(parent=self.configurationGroup)
        self.convertPasswordsCheckBox.setObjectName("convertPasswordsCheckBox")
        self.gridLayout_3.addWidget(self.convertPasswordsCheckBox, 1, 0, 1, 2)
        ...
        PluginWizardDialog.setTabOrder(self.preferencesKeyEdit, self.convertPasswordsCheckBox)
        PluginWizardDialog.setTabOrder(self.convertPasswordsCheckBox, self.pixmapCheckBox)
    ...
    def retranslateUi(self, PluginWizardDialog):
        ...
        self.convertPasswordsCheckBox.setToolTip(_translate("PluginWizardDialog", "Select to create a \'convertPasswords()\' function skeleton with example code"))
        self.convertPasswordsCheckBox.setText(_translate("PluginWizardDialog", "Include \'convertPasswords()\' function"))
