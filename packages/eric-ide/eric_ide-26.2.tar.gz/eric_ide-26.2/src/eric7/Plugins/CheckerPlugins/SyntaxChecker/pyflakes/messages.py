...
class UnusedIndirectAssignment(Message):
    """
    Class defining a message for a `global` or `nonlocal` statement where the name
    is never reassigned.
    """
...
class FStringMissingPlaceholders(Message):
    """
    Class defining the "Missing Placeholder" message for f-strings.

    Indicates that a f-string is missing some placeholders.
    """
...
class TStringMissingPlaceholders(Message):
    """
    Class defining the "Missing Placeholder" message for t-strings.

    Indicates that a t-string is missing some placeholders.
    """
