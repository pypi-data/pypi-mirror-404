...
class Ui_GitPage(object):
    def setupUi(self, GitPage):
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(parent=GitPage)
        self.groupBox_4.setObjectName("groupBox_4")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.groupBox_4)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.politicalCorrectnessCheckBox = QtWidgets.QCheckBox(parent=self.groupBox_4)
        self.politicalCorrectnessCheckBox.setObjectName("politicalCorrectnessCheckBox")
        self.verticalLayout_3.addWidget(self.politicalCorrectnessCheckBox)
        ...
        GitPage.setTabOrder(self.commitIdSpinBox, self.politicalCorrectnessCheckBox)
        GitPage.setTabOrder(self.politicalCorrectnessCheckBox, self.cleanupPatternEdit)
    ...
    def retranslateUi(self, GitPage):
        ...
        self.groupBox_4.setTitle(_translate("GitPage", "Branches"))
        self.politicalCorrectnessCheckBox.setToolTip(_translate("GitPage", "Select to respect political correctness when naming or showing branches (e.g. a branch named \'master\' would be considered inappropriate)."))
        self.politicalCorrectnessCheckBox.setText(_translate("GitPage", "Respect political correctness for branch names"))
