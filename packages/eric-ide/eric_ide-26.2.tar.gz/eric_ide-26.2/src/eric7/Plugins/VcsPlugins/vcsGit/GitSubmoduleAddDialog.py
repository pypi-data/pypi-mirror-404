...
class GitSubmoduleAddDialog(QDialog, Ui_GitSubmoduleAddDialog):
    ...
    def __init__(self, vcs, repodir, parent=None):
        ...
        submoduleUrlHistory = VcsGitPlugin.getPreferences("RepositoryUrlHistory")
    ...
    def __saveHistory(self):
        ...
        submoduleUrlHistory = [
            self.submoduleUrlCombo.itemText(index)
        ...
        VcsGitPlugin.setPreferences("RepositoryUrlHistory", newSubmoduleUrlHistory)
