...
def qWebEngineVersionTuple():
    """
    Module function to get the QtWebEngine version as a tuple.

    @return QtWebEngine version as a tuple
    @rtype tuple of (int, int, int)
    """
    return tuple(EricUtilities.versionToTuple(qWebEngineVersion()))
