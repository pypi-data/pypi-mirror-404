        ...
        if connected:
            ...
            with contextlib.suppress(OSError):
                ...
                if "mpy_name" in data:
                    ...
                    # Initialize the network related entries because the detection
                    # functions might time out.
                    self._deviceData["wifi"], self._deviceData["wifi_type"] = False, ""
                    self._deviceData["bluetooth"] = False
                    (
...
del __os_
""".format(dirname)
            _out, err = self.executeCommands(command, mode=self._submitMode)
            if err:
                raise OSError(self._shortError(err))
...
""".format(oldname, newname)
    ...
    def put(self, hostFileName, deviceFileName=None):
        ...
        if not os.path.isfile(hostFileName):
            err = "No such file: {0}".format(hostFileName)
            raise OSError(err)
...
print(hash())
del hash
""".format(deviceFileName, algorithm, chunkSize)
...
"""
    ...
    def __getDeviceData(self):
        ...
        @exception OSError raised to indicate an issue with the device
        """
        commands = [  # needs to be split for boards with low memory
            """def get_device_data():
    res = {}
...
""",
    ...
    try:
        ...
        try:
            ...
            vbl = version.BUILD.split('-')
            for v in vbl:
                if v.startswith('v'):
                    res['mpy_variant_version'] = v[1:]
                    break
            else:
...
"""
    ...
    def syncTime(self, _deviceType, hasCPy=False):  # noqa: ARG002, U-100
        """
...
"""
    ...
    def connectWifi(self, ssid, password, hostname, country=""):  # noqa: ARG002, U-100
        """
    ...
    def writeCredentials(
        self,
        ssid,  # noqa: ARG002, U-100
        password,  # noqa: ARG002, U-100
        hostname,  # noqa: ARG002, U-100
        country,  # noqa: ARG002, U-100
    ):
        """
    ...
    def deactivateInterface(self, interface):  # noqa: ARG002, U-100
        """
    ...
    def startAccessPoint(
        self,
        ssid,  # noqa: ARG002, U-100
        security=None,  # noqa: ARG002, U-100
        password=None,  # noqa: ARG002, U-100
        hostname=None,  # noqa: ARG002, U-100
        ifconfig=None,  # noqa: ARG002, U-100
    ):
        """
...
"""
    ...
    def enableWebrepl(self, password):  # noqa: ARG002, U-100
        """
    ...
    def connectToLan(self, config, hostname):  # noqa: ARG002, U-100
        """
    ...
    def writeLanAutoConnect(self, config, hostname):  # noqa: ARG002, U-100
        """
    ...
    def getDeviceScan(self, timeout=10):  # noqa: ARG002, U-100
        """
    ...
    def setNetworkTime(
        self,
        server="pool.ntp.org",  # noqa: ARG002, U-100
        tzOffset=0,  # noqa: ARG002, U-100
        timeout=10,  # noqa: ARG002, U-100
    ):
        """
