...
from PyQt6.QtCore import QSize, QUrl, Qt, pyqtSignal, pyqtSlot
...
class MicroPythonWindow(EricMainWindow):
    ...
    def getEditor(self, fn):
        ...
        miniEditor = MiniEditor(filename=fn)
        miniEditor.closing.connect(lambda: self.__editorClosing(miniEditor))
        miniEditor.show()
