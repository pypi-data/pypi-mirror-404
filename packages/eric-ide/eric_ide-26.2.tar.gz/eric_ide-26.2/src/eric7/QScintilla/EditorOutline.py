...
from PyQt6.QtCore import QCoreApplication, QModelIndex, QPoint, QTimer, Qt, pyqtSlot
...
class EditorOutlineView(QTreeView):
    ...
    def __createPopupMenus(self):
        ...
        self.__gotoMenu = QMenu(QCoreApplication.translate("EditorOutlineView", "Goto"))
