...
class CompleterPython(CompleterBase):
    ...
    def __init__(self, editor, parent=None):
        ...
        self.__selfRX = re.compile(r"^[ \t]*self[ \t]*[,)]")
        self.__clsRX = re.compile(r"^[ \t]*cls[ \t]*[,)]")
    ...
    def __dedentToIf(self):
        ...
        """
        line, _col = self.editor.getCursorPosition()
            ...
            if not inMultiLineString:
                if (
                    ...
                    or (
                        ...
                        and (
                            rxIndex(self.__selfRX, self.editor.text(curLine + 1)) == 0
                            or rxIndex(self.__clsRX, self.editor.text(curLine + 1)) == 0
                        )
                        and self.editor.indentation(curLine) == indentation
                    )
                    or (
