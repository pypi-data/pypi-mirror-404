...
from PyQt6.QtCore import QByteArray, QTimer, QUrl, Qt, pyqtSlot
...
class HelpViewerWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.__useQTextBrowser = not WebEngineAvailable or Preferences.getHelp(
            "ForceQTextBrowser"
        )
