...
class SingleApplicationServer(QLocalServer):
    ...
    def __receiveJson(self):
        ...
        while self.qsock and self.qsock.canReadLine():
            ...
            ##print(line)          ## debug  # noqa: ERA001, M-891
    ...
    def handleCommand(self, command, arguments):  # noqa: U-100
        """
        ...
        """
        exc = "'handleCommand' must be overridden"
...
class SingleApplicationClient:
    ...
    def processArgs(self, args):  # noqa: U-100
        """
        ...
        @exception NotImplementedError raised to indicate that this method must be
            implemented by a subclass
        """
        exc = "'processArgs' must be overridden"
        raise NotImplementedError(exc)
