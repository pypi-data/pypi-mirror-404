            ...
            '<a href="{0}">{0}</a>'.format(
                self.__sanitize(
                    (
                        ...
                        if detailsData["project_urls"]
                        and "Homepage" in detailsData["project_urls"]
            ...
            '<a href="{0}">{0}</a>'.format(
                self.__sanitize(
                    (
                        ...
                        if detailsData["project_urls"]
                        and "Documentation" in detailsData["project_urls"]
        ...
        if downloadsData:
            ...
            for download in downloadsData:
                itm = QTreeWidgetItem(
                    ...
                    [
                        "",
                        self.__packageTypeMap.get(download["packagetype"], ""),
                        (
