...
class Ui_WebBrowserWebAuthDialog(object):
    def setupUi(self, WebBrowserWebAuthDialog):
        ...
        self.pinEdit = EricPasswordEdit(parent=self.pinGroupBox)
        self.pinEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        ...
        self.gridLayout.addWidget(self.confirmPinErrorLabel, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pinErrorLabel, 3, 0, 1, 2)
        ...
        WebBrowserWebAuthDialog.setTabOrder(self.pinEdit, self.confirmPinEdit)
