...
try:
    ...
    QtHelpAvailable = True
except ImportError:
    QtHelpAvailable = False
...
class WebBrowserWindow(EricMainWindow):
    ...
    def __initWebEngineSettings(self):
        ...
        if QtUtilities.qWebEngineVersionTuple() >= (6, 9, 0):
            ...
            settings.setAttribute(
                ...
                Preferences.getWebBrowser("PrintHeaderAndFooter"),
            )
        ...
        if QtUtilities.qWebEngineVersionTuple() >= (6, 10, 0):
            ...
            settings.setAttribute(
                ...
                Preferences.getWebBrowser("BackForwardCacheEnabled"),
            )
    ...
    def __initMenus(self):
        ...
        menu.addSeparator()
        self.__textEncodingMenu = QMenu(self.tr("Text Encoding"))
        ...
        menu.addSeparator()
        self.__toolbarsMenu = QMenu(self.tr("&Toolbars"))
    ...
    def setUseQtHelp(cls, use):
        ...
        """
        if use:
            cls._useQtHelp = use and QtHelpAvailable
        else:
    ...
    def __clearPrivateData(self):
        ...
        if dlg.exec() == QDialog.DialogCode.Accepted:
            ...
            if permissions and QtUtilities.qWebEngineVersionTuple() >= (6, 8, 0):
    ...
    def __showFeaturePermissionDialog(self):
        ...
        """
        if QtUtilities.qWebEngineVersionTuple() >= (6, 8, 0):
            # Qt 6.8+
    ...
    @pyqtSlot(QUrl)
    @pyqtSlot(QUrl, str)
    def openUrl(self, url, title=None):  # noqa: ARG002
        """
    ...
    @pyqtSlot(QUrl)
    @pyqtSlot(QUrl, str)
    def openUrlNewTab(self, url, title=None):  # noqa: ARG002
        """
    ...
    @pyqtSlot(QUrl)
    @pyqtSlot(QUrl, str)
    def openUrlNewBackgroundTab(self, url, title=None):  # noqa: ARG002
        """
    ...
    @pyqtSlot(QUrl)
    @pyqtSlot(QUrl, str)
    def openUrlNewWindow(self, url, title=None):  # noqa: ARG002
        """
    ...
    @pyqtSlot(QUrl)
    @pyqtSlot(QUrl, str)
    def openUrlNewPrivateWindow(self, url, title=None):  # noqa: ARG002
        """
