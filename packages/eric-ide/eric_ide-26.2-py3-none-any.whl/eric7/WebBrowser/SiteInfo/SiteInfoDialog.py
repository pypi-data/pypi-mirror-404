...
try:
    from PyQt6.QtNetwork import QSslCertificate  # noqa: F401 __IGNORE_WARNING__
...
class SiteInfoDialog(QDialog, Ui_SiteInfoDialog):
    ...
    def __init__(self, browser, parent=None):
        ...
        if sslInfo and SslAvailable:
            self.sslWidget.showCertificateChain(sslInfo)
        self.tabWidget.setTabEnabled(2, SslAvailable and bool(sslInfo))
        self.securityDetailsButton.setEnabled(SslAvailable and bool(sslInfo))
