...
class WebBrowserPage(QWebEnginePage):
    ...
    if QtUtilities.qWebEngineVersionTuple() >= (6, 8, 0):  # noqa: Y-108
    ...
    def acceptNavigationRequest(self, url, type_, isMainFrame):
        ...
        if result:
            if isMainFrame:
                ...
                enable = globalJsEnabled if isWeb else True
    ...
    def getSslCertificateChain(self):
        ...
        return self.__sslConfiguration.peerCertificateChain()
    ...
    def showSslInfo(self, pos):
        ...
        @type QPoint
        """
        if SslAvailable and self.__sslConfiguration is not None:
