...
"""
        updateQueryStr = """
UPDATE full_hash SET expires_at=datetime(current_timestamp, '+{0} SECONDS')
...
""".format(int(negativeCacheDuration))
    ...
    def getThreatLists(self):
        ...
        """
        queryStr = """
SELECT threat_type,platform_type,threat_entry_type,client_state FROM threat_list
"""
        output = []
...
"""
    ...
    def updateThreatListClientState(self, threatList, clientState):
        ...
        queryStr = """
UPDATE threat_list
    SET timestamp=current_timestamp, client_state=?
    WHERE threat_type=? AND platform_type=? AND threat_entry_type=?
"""
