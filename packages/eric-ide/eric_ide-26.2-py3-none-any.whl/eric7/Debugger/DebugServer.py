...
class DebugServer(QTcpServer):
    ...
    def getHostAddress(self, localhost):
        ...
        if self.networkInterface in ("all", "allv6", "localv6"):
    ...
    def remoteEnvironment(self, env):
        ...
        if not isinstance(env, (dict, str)):
            err = "'env' must be of type str or dict"
            raise TypeError(err)
    ...
    def remoteSetThread(self, debuggerId, tid, release_thread=False):
        ...
        @type bool
        """
        self.debuggerInterface.remoteSetThread(debuggerId, tid, release_thread)
    ...
    def getProjectEnvironmentString(self):
        ...
        """
        with contextlib.suppress(KeyError):
            # The project object may not be present
            project = ericApp().getObject("Project")
