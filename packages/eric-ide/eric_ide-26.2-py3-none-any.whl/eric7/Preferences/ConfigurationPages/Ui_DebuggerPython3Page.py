...
class Ui_DebuggerPython3Page(object):
    def setupUi(self, DebuggerPython3Page):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=DebuggerPython3Page)
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.groupBox)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.settraceCheckBox = QtWidgets.QCheckBox(parent=self.groupBox)
        self.settraceCheckBox.setObjectName("settraceCheckBox")
        self.horizontalLayout_3.addWidget(self.settraceCheckBox)
        ...
        DebuggerPython3Page.setTabOrder(self.debugClientPicker, self.settraceCheckBox)
        DebuggerPython3Page.setTabOrder(self.settraceCheckBox, self.sourceExtensionsEdit)
        ...
        DebuggerPython3Page.setTabOrder(self.pyNoEncodingCheckBox, self.callTraceCheckBox)
    ...
    def retranslateUi(self, DebuggerPython3Page):
        ...
        self.groupBox.setTitle(_translate("DebuggerPython3Page", "Debugger Type"))
        self.settraceCheckBox.setToolTip(_translate("DebuggerPython3Page", "Select to always use the tracing Python debugger. If unselected, a more performant event based debugger will be used for Python 3.12 and newer."))
        self.settraceCheckBox.setText(_translate("DebuggerPython3Page", "Always use \'settrace\' based debugger backend"))
