...
class EditorAPIsPage(ConfigurationPageBase, Ui_EditorAPIsPage):
    ...
    def __init__(self):
        ...
        self.apis = {}
        apiLanguages = ["", *sorted(Lexers.getSupportedApiLanguages())]
    ...
    def __apiKey(self, language, projectType):
        ...
        @rtype str
        """
        return (language, projectType) if projectType else (language, "")
    ...
    def __editorGetApisFromApiList(self):
        ...
        @rtype list of str
        """
        return [self.apiList.item(row).text() for row in range(self.apiList.count())]
