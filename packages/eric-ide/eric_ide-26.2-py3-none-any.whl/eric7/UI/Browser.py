...
class Browser(QTreeView):
    ...
    def __createPopupMenus(self):
        ...
        self.__gotoMenu = QMenu(QCoreApplication.translate("Browser", "Goto"))
        ...
        if not self._activating:
            ...
            for itm in itmList:
                if isinstance(itm, BrowserFileItem):
                    ...
                    itm,
                    (BrowserClassItem, BrowserMethodItem, BrowserClassAttributeItem),
                ):
    ...
    def __deleteMultiple(self):
        ...
        items.
        """
        fileNames = [itm.fileName() for itm in self.getSelectedItems()]
