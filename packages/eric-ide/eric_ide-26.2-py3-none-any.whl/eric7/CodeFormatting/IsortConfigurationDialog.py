...
class IsortConfigurationDialog(QDialog, Ui_IsortConfigurationDialog):
    ...
    def __init__(self, withProject=True, onlyProject=False, parent=None):
        ...
        self.__parameterWidgetMapping = {
            ...
            "known_local_folder": self.localFoldersEdit,
        }
    ...
    def __loadConfiguration(self, confDict):
        ...
        self.extensionsEdit.setText(
            " ".join(
                confDict.get(
                    "supported_extensions", self.__defaultConfig.supported_extensions
                )
            )
        )
        for parameter in (
        ...
        self.profileComboBox.setEditText(
            confDict.get("profile", self.__defaultConfig.profile)
        )
    ...
    def __getConfigurationDict(self):
        ...
        for parameter in (
            ...
            if self.__parameterWidgetMapping[
                ...
                parameter
            ].value() != getattr(self.__defaultConfig, parameter):
        ...
        for parameter in (
            ...
            if self.__parameterWidgetMapping[
                ...
                parameter
            ].isChecked() != getattr(self.__defaultConfig, parameter):
