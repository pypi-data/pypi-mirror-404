...
class Ui_TestingWidget(object):
    def setupUi(self, TestingWidget):
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.parametersTab)
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(self.optionsGroup)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.optionsGroup)
        self.label_7.setObjectName("label_7")
        self.horizontalLayout_3.addWidget(self.label_7)
        self.customParametersComboBox = QtWidgets.QComboBox(parent=self.optionsGroup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.customParametersComboBox.sizePolicy().hasHeightForWidth())
        self.customParametersComboBox.setSizePolicy(sizePolicy)
        self.customParametersComboBox.setEditable(True)
        self.customParametersComboBox.setObjectName("customParametersComboBox")
        self.horizontalLayout_3.addWidget(self.customParametersComboBox)
        ...
        self.verticalLayout_2.addWidget(self.discoveryGroup)
        ...
        TestingWidget.setTabOrder(self.debuggerCheckBox, self.customParametersComboBox)
        TestingWidget.setTabOrder(self.customParametersComboBox, self.discoveryList)
...
"Note that all test modules must be importable from this directory.</p>"))
        ...
        self.label_7.setText(_translate("TestingWidget", "Custom Parameters:"))
        self.customParametersComboBox.setToolTip(_translate("TestingWidget", "Enter custom commandline parameters."))
