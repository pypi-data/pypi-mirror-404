...
class EricPlugin:
    ...
    def pytest_runtest_logstart(self, nodeid, location):  # noqa: ARG002, U-100
        """
    ...
    def pytest_sessionstart(self, session):  # noqa: ARG002, U-100
        """
    ...
    def pytest_sessionfinish(self, session, exitstatus):  # noqa: ARG002, U-100
        """
...
def getVersions():
    ...
    try:
        ...
        pytest.main(["--version", "--version", "--capture=sys"], plugins=[plugin])
