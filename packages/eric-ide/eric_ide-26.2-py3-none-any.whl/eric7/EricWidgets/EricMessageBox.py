...
Warning = QMessageBox.Icon.Warning  # noqa: A001, M-131
...
def yesNo(
    ...
    if icon not in [Critical, Information, Question, Warning]:
        err = "Bad value for 'icon' parameter."
    ...
    res = __messageBox(
        ...
        QMessageBox.StandardButton.Yes if yesDefault else QMessageBox.StandardButton.No,
        textFormat,
    )
