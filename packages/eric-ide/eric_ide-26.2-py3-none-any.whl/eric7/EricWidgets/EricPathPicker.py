...
try:
    ...
    HasRemoteServerSupport = True
except ImportError:
    HasRemoteServerSupport = False
...
class EricPathPickerBase(QWidget):
    ...
    def setMode(self, mode):
        ...
        if mode not in EricPathPickerModes:
            err = "Bad value for 'mode' parameter."
    ...
    def setRemote(self, remote):
        ...
        @type bool
        """
        self.__remote = remote and HasRemoteServerSupport
        if self.__remote:
    ...
    def __showPathPickerDialog(self):
        ...
        if self.__mode == EricPathPickerModes.OPEN_FILE_MODE:
            ...
            if self.__remote:
                fpath = EricServerFileDialog.getSaveFileNameWithExtension(
                    self,
                    windowTitle,
                    directory,
                    self.__filters,
                ...
                fpath = EricFileDialog.getSaveFileNameWithExtension(
                    self,
                    windowTitle,
                    directory,
                    self.__filters,
...
class EricComboPathPicker(EricPathPickerBase):
    ...
    def getPathItems(self):
        ...
        @rtype list of str
        """
        return [self._editor.itemText(index) for index in range(self._editor.count())]
    ...
    def getPathLibItems(self):
        ...
        """
        return [
            pathlib.Path(self._editor.itemText(index))
