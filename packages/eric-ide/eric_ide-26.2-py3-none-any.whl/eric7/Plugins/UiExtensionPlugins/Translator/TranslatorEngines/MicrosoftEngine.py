...
class MicrosoftEngine(TranslationEngine):
    ...
    def __getClientDataAzure(self):
        ...
        """
        subscriptionKey = TranslatorPlugin.getPreferences("MsTranslatorKey")
        subscriptionRegion = TranslatorPlugin.getPreferences("MsTranslatorRegion")
