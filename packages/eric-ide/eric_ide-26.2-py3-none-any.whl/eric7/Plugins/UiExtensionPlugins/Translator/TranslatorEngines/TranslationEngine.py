...
class TranslationEngine(QObject):
    ...
    def getTextToSpeechData(self, requestObject, text, language):  # noqa: ARG002, U-100
        """
    ...
    def getTranslation(
        self,
        requestObject,  # noqa: ARG002, U-100
        text,  # noqa: ARG002, U-100
        originalLanguage,  # noqa: ARG002, U-100
        translationLanguage,  # noqa: ARG002, U-100
    ):
        """
