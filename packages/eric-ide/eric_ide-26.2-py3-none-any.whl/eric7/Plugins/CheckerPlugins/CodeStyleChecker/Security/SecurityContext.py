...
class SecurityContext:
    ...
    def __repr__(self):
        ...
        @rtype str
        """
        return "<SecurityContext {0}>".format(self.__context)
    ...
    def __getLiteralValue(self, literal):
        ...
        if (
            ...
            literalValue = [self.__getLiteralValue(li) for li in literal.elts]
            ...
            literalValue = dict(zip(literal.keys, literal.values, strict=True))
