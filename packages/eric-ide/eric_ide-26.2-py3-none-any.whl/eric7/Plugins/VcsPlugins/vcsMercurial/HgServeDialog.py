...
class HgServeDialog(EricMainWindow):
    ...
    def __init__(self, vcs, path, parent=None):
        ...
        self.__portSpin.setValue(VcsMercurialPlugin.getPreferences("ServerPort"))
        ...
        self.__styleCombo.setCurrentIndex(
            self.__styleCombo.findText(VcsMercurialPlugin.getPreferences("ServerStyle"))
        )
    ...
    def __startServer(self):
        ...
        if procStarted:
            ...
            VcsMercurialPlugin.setPreferences("ServerPort", port)
            VcsMercurialPlugin.setPreferences("ServerStyle", style)
        else:
