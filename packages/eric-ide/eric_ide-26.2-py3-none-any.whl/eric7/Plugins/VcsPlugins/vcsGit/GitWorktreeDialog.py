...
from PyQt6.QtCore import QDateTime, QProcess, QSize, QTime, QTimer, Qt, pyqtSlot
...
class GitWorktreeDialog(QWidget, Ui_GitWorktreeDialog):
    ...
    def closeEvent(self, e):
        ...
        VcsGitPlugin.setPreferences("WorktreeDialogGeometry", self.saveGeometry())
    ...
    def show(self):
        ...
        geom = VcsGitPlugin.getPreferences("WorktreeDialogGeometry")
        if geom.isEmpty():
            s = QSize(900, 600)
            self.resize(s)
        else:
    ...
    def start(self, projectDir):
        ...
        self.__outputLines = []
        self.__commitIdLength = VcsGitPlugin.getPreferences("CommitIdLength")
    ...
    @pyqtSlot()
    def on_expireDateTimeEdit_dateTimeChanged(self):
        """
