...
class GitNewProjectOptionsDialog(QDialog, Ui_GitNewProjectOptionsDialog):
    ...
    def __init__(self, vcs, parent=None):
        ...
        vcsUrlHistory = VcsGitPlugin.getPreferences("RepositoryUrlHistory")
    ...
    def __saveHistory(self):
        ...
        vcsUrlHistory = [
            self.vcsUrlCombo.itemText(index)
        ...
        VcsGitPlugin.setPreferences("RepositoryUrlHistory", newVcsUrlHistory)
