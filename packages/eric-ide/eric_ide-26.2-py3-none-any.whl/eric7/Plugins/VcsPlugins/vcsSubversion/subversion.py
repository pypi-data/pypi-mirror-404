...
class Subversion(VersionControl):
    ...
    def vcsCommitMessages(self):
        ...
        if not messages:
            ...
            messages = VcsSubversionPlugin.getPreferences("Commits")
    ...
    def vcsAddCommitMessage(self, message):
        ...
        if not self._vcsAddProjectCommitMessage(message):
            ...
            VcsSubversionPlugin.setPreferences("Commits", commitMessages)
    ...
    def vcsClearCommitMessages(self):
        ...
        if not self._vcsClearProjectCommitMessages():
            VcsSubversionPlugin.setPreferences("Commits", [])
            ...
            if finished and process.exitCode() == 0:
                ...
                for line in output.splitlines():
                    ...
                    if line.startswith("<url>"):
                        return line.replace("<url>", "").replace("</url>", "")
    ...
    def vcsSbsDiff(self, name, extended=False, revisions=None):
        ...
        @exception TypeError raised to indicate an illegal name parameter type
        """
