...
from PyQt6.QtCore import QDate, QPoint, QProcess, QTimer, Qt, pyqtSlot
...
class SvnLogBrowserDialog(QWidget, Ui_SvnLogBrowserDialog):
    ...
    def __resetUI(self):
        ...
        self.limitSpinBox.setValue(VcsSubversionPlugin.getPreferences("LogLimit"))
        self.stopCheckBox.setChecked(
            VcsSubversionPlugin.getPreferences("StopLogOnCopy")
        )
    ...
    def __generateLogItem(self, author, date, message, revision, changedPaths):
        ...
        """
        msg = [line.strip() for line in message]
