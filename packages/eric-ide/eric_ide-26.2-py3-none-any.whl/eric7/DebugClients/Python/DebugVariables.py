...
class QtResolver(BaseResolver):
    ...
    def getVariableList(self, var):
        ...
        d.extend((attribute, getattr(var, attribute)()) for attribute in attributes)
...
def updateTypeMap():
    ...
    if _TryNumpy and "numpy" in sys.modules:
        import numpy as np  # __IGNORE_WARNING_I-10__

        _TypeMap.append((np.ndarray, ndarrayResolver))
        _TryNumpy = False
