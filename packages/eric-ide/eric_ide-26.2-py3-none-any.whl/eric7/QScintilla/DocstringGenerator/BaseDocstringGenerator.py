...
class BaseDocstringGenerator:
    ...
    def isFunctionStart(self, text):  # noqa: ARG002, U-100
        """
    ...
    def hasFunctionDefinition(self, cursorPosition):  # noqa: ARG002, U-100
        """
    ...
    def isDocstringIntro(self, cursorPosition):  # noqa: ARG002, U-100
        """
    ...
    def insertDocstring(self, cursorPosition, fromStart=True):  # noqa: ARG002, U-100
        """
    ...
    def insertDocstringFromShortcut(self, cursorPosition):  # noqa: ARG002, U-100
        """
        Public method to insert a docstring for the function at the cursor
