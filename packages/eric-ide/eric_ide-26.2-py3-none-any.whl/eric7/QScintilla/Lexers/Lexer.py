...
class Lexer:
    ...
    def smartIndentSelection(self, editor):
        ...
        if indexStart < 0:
            indexStart = 0
        indexEnd = indexTo + indentDifference if indexTo != 0 else 0
        if indexEnd < 0:
            indexEnd = 0
    ...
    def isCommentStyle(self, style):  # noqa: ARG002, U-100
        """
    ...
    def isStringStyle(self, style):  # noqa: ARG002, U-100
        """
    ...
    def defaultKeywords(self, kwSet):  # noqa: ARG002, U-100
        """
