    ...
    def itemIndexByLine(self, lineno):
        ...
        if self.__populated:
            for rootChild in self.rootItem.children():
                itm = None
                if isinstance(rootChild, (BrowserClassItem, BrowserMethodItem)):
                    ...
                    rootChild,
                    (BrowserImportsItem, BrowserGlobalsItem, BrowserMetadataItem),
                ):
                    itm = findItem(lineno, rootChild)
                elif (
