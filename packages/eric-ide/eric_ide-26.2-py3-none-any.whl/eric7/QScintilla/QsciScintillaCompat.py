#
# Copyright (c) 2004 - 2026 Detlev Offenbach <detlev@die-offenbachs.de>
#
...
class QsciScintillaCompat(QsciScintilla):
    ...
    def selectionIsRectangle(self):
        ...
        @rtype bool
        """
        startLine, _startIndex, endLine, _endIndex = self.getSelection()
        return (
            startLine != -1
    ...
    def getSelections(self):
        ...
        """
        return [self.getSelectionN(index) for index in range(self.getSelectionCount())]
    ...
    def hasIndicator(self, indicator, pos):
        ...
        @rtype bool
        """
        return self.SendScintilla(QsciScintilla.SCI_INDICATORVALUEAT, indicator, pos)
    ...
    def gotoPreviousIndicator(self, indicator, wrap):
        ...
        if self.hasIndicator(indicator, posStart):
            # found it
            line, _index = self.lineIndexFromPosition(posEnd)
    ...
    def setFolding(self, style, margin=2):
        ...
        @type int
        """
        if style <= QsciScintilla.FoldStyle.BoxedTreeFoldStyle.value:
    ...
    @pyqtSlot(int, str)
    def __userListActivated(self, _listId, _txt):
        """
        ...
        @param _listId the ID of the user list
        @type int
        @param _txt the selected text
        @type str
        """
        self.activateWindow()
