...
from PyQt6.QtCore import QLocale, QPoint, QRect, QTimer, Qt, pyqtSignal
...
class SnapshotRegionGrabber(QWidget):
    ...
    def __init__(self, mode=Rectangle):
        ...
        if mode not in [SnapshotRegionGrabber.Rectangle, SnapshotRegionGrabber.Ellipse]:
            exc = "Bad value for 'mode' parameter."
    ...
    def mouseDoubleClickEvent(self, _evt):
        ...
        @param _evt mouse double click event
        @type QMouseEvent
        """
        self.__grabRect()
