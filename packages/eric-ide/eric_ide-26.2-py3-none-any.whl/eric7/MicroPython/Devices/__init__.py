...
SupportedBoards = {
    ...
    "circuitpython": {
        "ids": (
            ...
            (0x0483, 0x5740),  # STMicroelectronics Daisy Seed
            ...
            (0x1209, 0xCECE),  # eAFAQ OMNIMO nRF52840
            ...
            (0x1209, 0xE004),  # Bronco Space ProvesKit RP2040 v4
            ...
            (0x1209, 0xFD42),  # HXR.DK SAO Digital Multimeter
            ...
            (0x239A, 0x816C),  # Adafruit Fruit Jam
            (0x239A, 0x816E),  # Adafruit Feather RP2350 Adalogger
            ...
            (0x2E8A, 0x1090),  # Wee Noise Makers Noise Nugget 2040
            ...
            (0x2E8A, 0x109F),  # WIZnet W5500-EVB-Pico2
            ...
            (0x2E8A, 0x10D0),  # Hack Club Orpheus Pico
            ...
            # Espressif ESP32-S3-DevKitC-1-N8R2 CPY/ROS
            ...
            (0x303A, 0x81B9),  # senseBox MCU-S2 ESP32S2
            (0x303A, 0x81BF),
            ...
            (0x303A, 0x81DA),
            # M5STACK M5Stack Cardputer - CircuitPython
            # M5STACK M5Stack Cardputer - Circuitpython/ROS
            ...
            (0x303A, 0x8217),  # WEMOS LOLIN S3 MINI PRO 4MB Flash 2MB PSRAM
            ...
            (0x303A, 0x828B),  # Waveshare Electronics ESP32-S3-LCD-1.47
            (0x303A, 0x82A7),  # Waveshare Electronics ESP32-S3-ETH
            (0x303A, 0x82C2),  # LILYGO T-Dongle S3
            (0x303A, 0x82C4),  # Unknown ESP32-S2-WROOM
            (0x303A, 0x82C9),  # Heltec Vision Master E290
            (0x303A, 0x82CE),  # Waveshare Electronics ESP32S3 Touch LCD 2
            (0x303A, 0x82D2),  # senseBox senseBox-eye ESP32S3
            (0x303A, 0x82DD),  # UnexpectedMaker EDGES3D
            (0x30A4, 0x0002),  # Blues Inc. Swan R5
            (0x30A4, 0x0003),  # Blues Inc. Cygnet
            ...
            ##(0x239A, None),  # Any Adafruit Boards  # noqa: ERA001, M-891
        ),
...
def getSupportedDevices():
    ...
    @return list of tuples with the board type and description
    @rtype list of tuples of (str, str)
    """
    return [(board, SupportedBoards[board]["description"]) for board in SupportedBoards]
            ...
            for board in SupportedBoards:
                if (vid, pid) in SupportedBoards[board]["ids"] or (
                    ...
                    if board in ("bbc_microbit", "calliope") and (
                        ...
                        continue
                    if board in ("generic", "pyboard", "teensy") and (
...
def getDeviceIcon(boardName, iconFormat=True):
    ...
    iconName = (
        ...
        else "micropython48"  # return a generic MicroPython icon
    )
