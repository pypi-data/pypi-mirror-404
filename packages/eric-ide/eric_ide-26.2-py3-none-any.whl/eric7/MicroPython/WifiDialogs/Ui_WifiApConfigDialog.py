...
class Ui_WifiApConfigDialog(object):
    def setupUi(self, WifiApConfigDialog):
        ...
        WifiApConfigDialog.resize(400, 327)
        ...
        self.gridLayout_2.addWidget(self.apSsidEdit, 0, 1, 1, 1)
        self.label_12 = QtWidgets.QLabel(parent=WifiApConfigDialog)
        self.label_12.setObjectName("label_12")
        self.gridLayout_2.addWidget(self.label_12, 1, 0, 1, 1)
        self.apPasswordEdit = EricPasswordEdit(parent=WifiApConfigDialog)
        ...
        self.gridLayout_2.addWidget(self.hostnameEdit, 3, 1, 1, 1)
        ...
        WifiApConfigDialog.setTabOrder(self.apPasswordEdit, self.apSecurityComboBox)
