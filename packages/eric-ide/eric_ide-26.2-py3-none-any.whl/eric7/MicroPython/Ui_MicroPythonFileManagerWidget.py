...
class Ui_MicroPythonFileManagerWidget(object):
    def setupUi(self, MicroPythonFileManagerWidget):
        ...
        self.localFileTreeWidget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.deviceFileTreeWidget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
    ...
    def retranslateUi(self, MicroPythonFileManagerWidget):
        ...
        self.openButton.setToolTip(_translate("MicroPythonFileManagerWidget", "Press to open the selected files of the device in editors."))
