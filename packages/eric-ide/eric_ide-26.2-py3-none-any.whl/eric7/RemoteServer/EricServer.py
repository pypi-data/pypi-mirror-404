...
class EricServer:
    ...
    def sendJsonCommand(self, jsonCommand, sock):
        ...
        # for debugging
        # - print("Eric Server Send:", jsonCommand)  # noqa: ERA001
    ...
    def receiveJsonCommand(self, sock):
        ...
        if self.__clientId and sock == self.__connection:
            ...
            if msgClientId != self.__clientId:
                print(f"Received illegal client ID '{msgClientId}'.")
                return {}
        ...
        # for debugging
        # - print("Eric Server Receive:", jsonStr)  # noqa: ERA001, M-801
        try:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print(f"{exctype!s} / {excval!s} / {tbinfo}")
    ...
    def registerRequestHandler(self, requestCategory, handler):
        ...
        if requestCategory in self.__requestCategoryHandlerRegistry:
            exc = f"Request category '{requestCategory} already registered."
    ...
    def __handleEchoRequest(self, _request, params, reqestUuid):
        """
        Private method to handle an 'Echo' request.

        @param _request request name
        @type str
        @param params request parameters
        @type dict
        @param reqestUuid UUID of the associated request as sent by the eric IDE
    ...
    def __handleServerRequest(self, request, _params, reqestUuid):
        """
