...
class Ui_VirtualenvAddEditDialog(object):
    def setupUi(self, VirtualenvAddEditDialog):
        ...
        self.environmentTypeComboBox = QtWidgets.QComboBox(parent=self.groupBox)
        self.environmentTypeComboBox.setObjectName("environmentTypeComboBox")
        self.horizontalLayout.addWidget(self.environmentTypeComboBox)
        self.ericServerInfoLabel = QtWidgets.QLabel(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ericServerInfoLabel.sizePolicy().hasHeightForWidth())
        self.ericServerInfoLabel.setSizePolicy(sizePolicy)
        ...
        VirtualenvAddEditDialog.setTabOrder(self.descriptionEdit, self.serverLineEdit)
    ...
    def retranslateUi(self, VirtualenvAddEditDialog):
        ...
        self.environmentTypeComboBox.setToolTip(_translate("VirtualenvAddEditDialog", "Select the environment type."))
