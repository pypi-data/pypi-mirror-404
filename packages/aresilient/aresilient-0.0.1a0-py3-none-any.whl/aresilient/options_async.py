...
async def options_with_automatic_retry_async(
    ...
    **kwargs: Any,
    ...
    r"""Send an HTTP OPTIONS request asynchronously with automatic retry
    ...
    Args:
        ...
        **kwargs: Additional keyword arguments passed to ``httpx.AsyncClient.options()``.

    Returns:
        An httpx.Response object containing the server's HTTP response with
        communication options in headers (e.g., Allow, Access-Control-Allow-*).
