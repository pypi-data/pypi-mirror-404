...
from orchestrator.orchestrator_runner import get_os_subdir
from utils import (
    CONFIG,
    BrowseResponse,
...
async def get_default_config(source_dir: str | None = None) -> ConfigDefaultsResponse:
    ...
    # Auto-fill work_dir if source_dir provided (with OS-specific subdirectory)
    if source_dir:
        source_path = Path(source_dir)
        os_subdir = get_os_subdir()
        work_dir = source_path.parent / CONFIG.orchestrator.DEFAULT_WORK_DIR_NAME / os_subdir
