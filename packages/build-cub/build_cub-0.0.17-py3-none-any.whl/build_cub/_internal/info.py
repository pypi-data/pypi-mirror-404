...
PACKAGE_NAME: Literal["build-cub"] = "build-cub"
PROJECT_NAME: Literal["build_cub"] = "build_cub"
PROJECT_NAME_UPPER: Literal["BUILD_CUB"] = "BUILD_CUB"
ENV_VARIABLE: Literal["BUILD_CUB_ENV"] = "BUILD_CUB_ENV"
...
class _Package(NamedTuple):  # pragma: no cover
    ...
    def _package_info(cls, name: str) -> _Package:
        ...
        if find_spec(f"{PROJECT_NAME}._internal._version"):
            from ._version import __version__ as v, __version_tuple__ as vp
...
PACKAGE: Final[_Package] = _Package._package_info(name=PACKAGE_NAME)
...
class _ProjectMetadata(NamedTuple):
    ...
    name: Literal["build-cub"] = PACKAGE_NAME
    project_name: Literal["build_cub"] = PROJECT_NAME
    name_upper: Literal["BUILD_CUB"] = PROJECT_NAME_UPPER
    env_variable: Literal["BUILD_CUB_ENV"] = ENV_VARIABLE
...
__all__ = ["ENV_VARIABLE", "METADATA", "PACKAGE_NAME", "PROJECT_NAME", "ExitCode"]
