...
class TurnProcessor:
    ...
    def _handle_reasoning_start(self) -> None:
        ...
        self.current_part = ReasoningPart(text="", time=TimeInfo(start=int(time.time() * 1000)))
    ...
    def _check_doom_loop(self, tool_name: str, tool_input: dict[str, Any]) -> bool:
        ...
        all_identical = all(name == tool_name and inp == tool_input for name, inp in last_calls)
