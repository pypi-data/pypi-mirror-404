...
Расписания (Schedules) запускаются автоматически по cron-выражению.
Если `action_type` расписания совпадает с зарегистрированной командой —
используется тот же обработчик:
