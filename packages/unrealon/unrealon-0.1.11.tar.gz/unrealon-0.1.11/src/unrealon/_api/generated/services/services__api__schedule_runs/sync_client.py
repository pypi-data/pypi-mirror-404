...
class SyncServicesScheduleRunsAPI:
    """Synchronous API endpoints for Schedule Runs."""

    def __init__(self, client: httpx.Client):
        """Initialize sync sub-client with shared httpx client."""
        self._client = client

    def services_schedule_runs_list(
        self,
    ...
    def services_schedule_runs_retrieve(self, id: str) -> ScheduleRunDetail:
        """
