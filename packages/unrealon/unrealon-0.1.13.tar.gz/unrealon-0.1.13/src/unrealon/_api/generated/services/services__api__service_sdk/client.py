...
class ServicesServiceSdkAPI:
    """API endpoints for Service SDK."""

    def __init__(self, client: httpx.AsyncClient):
        """Initialize sub-client with shared httpx client."""
        self._client = client

    async def services_commands_ack_create(
        self,
        id: str,
    ...
    async def services_services_deregister_create(
        self,
        id: str,
        data: ServiceRequest,
    ) -> Service:
    ...
    async def services_services_heartbeat_create(
        self,
        id: str,
    ...
    async def services_services_logs_batch_create(
        self,
        service_id: str,
    ...
    async def services_services_register_create(
        self,
