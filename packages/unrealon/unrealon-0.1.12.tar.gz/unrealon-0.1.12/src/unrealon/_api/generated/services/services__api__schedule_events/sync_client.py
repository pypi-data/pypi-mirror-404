...
class SyncServicesScheduleEventsAPI:
    """Synchronous API endpoints for Schedule Events."""

    def __init__(self, client: httpx.Client):
        """Initialize sync sub-client with shared httpx client."""
        self._client = client

    def services_schedule_events_list(
        self,
    ...
    def services_schedule_events_retrieve(self, id: str) -> ScheduleEvent:
        """
