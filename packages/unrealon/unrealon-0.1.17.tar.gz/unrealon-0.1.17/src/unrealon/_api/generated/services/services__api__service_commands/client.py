...
class ServicesServiceCommandsAPI:
    """API endpoints for Service Commands."""

    def __init__(self, client: httpx.AsyncClient):
        """Initialize sub-client with shared httpx client."""
        self._client = client

    async def services_commands_list(
        self,
    ...
    async def services_commands_retrieve(self, id: str) -> Command:
        """
        Get command details
