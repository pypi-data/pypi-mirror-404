...
class SyncServicesServicesAPI:
    """Synchronous API endpoints for Services."""
    ...
    def services_create(self, data: ServiceRequest) -> Service:
        """
        Create service
    ...
    def services_retrieve(self, id: str) -> ServiceDetail:
        """
        Get service details
    ...
    def services_update(self, id: str, data: ServiceDetailRequest) -> ServiceDetail:
        """
        Update service
    ...
    def services_destroy(self, id: str) -> None:
        """
        Delete service
    ...
    def services_commands_retrieve(self, service_id: str) -> None:
        """
