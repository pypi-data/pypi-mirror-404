...
Need to change topology or method quickly? Use the interactive helper located at [`tools/pnm/pnm_file_retrieval_setup.py`](https://github.com/PyPNMApps/PyPNM/blob/main/tools/pnm/pnm_file_retrieval_setup.py) to update `system.json` without editing by hand.
