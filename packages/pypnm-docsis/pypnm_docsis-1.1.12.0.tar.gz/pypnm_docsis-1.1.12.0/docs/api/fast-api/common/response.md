...
| `file_type_version` | integer | —       | Numeric version for the given file type (e.g., `4`). See mapping: [`pnm_file_type.py`](https://github.com/PyPNMApps/PyPNM/blob/main/src/pypnm/pnm/parser/pnm_file_type.py). |
