...
- [`CmDsOfdmRxMer`](https://github.com/PyPNMApps/PyPNM/blob/main/src/pypnm/pnm/parser/CmDsOfdmRxMer.py)
...
- [`CmSpectrumAnalysisSnmp`](https://github.com/PyPNMApps/PyPNM/blob/main/src/pypnm/pnm/parser/CmSpectrumAnalysisSnmp.py)
...
- Same parser class [`CmUsOfdmaPreEq`](https://github.com/PyPNMApps/PyPNM/blob/main/src/pypnm/pnm/parser/CmUsOfdmaPreEq.py),
