...
- [Project overview](https://github.com/PyPNMApps/PyPNM/blob/main/README.md) - why PyPNM exists plus installer basics.
- [Install flow](https://github.com/PyPNMApps/PyPNM/blob/main/README.md#getting-started) - clone, run `./install.sh`, and bring up the FastAPI stack.
...
- [Demo mode guide](https://github.com/PyPNMApps/PyPNM/blob/main/demo/README.md) - how the sample data environment is staged and how to reset it.
...
- [Security](https://github.com/PyPNMApps/PyPNM/blob/main/SECURITY.md) - responsible disclosure guidelines.

## Need more context?

- [Style guide](style-guide.md) - guidelines for writing or updating documentation.
- [Project roadmap / README next steps](https://github.com/PyPNMApps/PyPNM/blob/main/README.md#next-steps) - suggestions on what to explore after installation.
