...
class PipelineRunReport(BaseModel):
    """
    Object containing metadata about the pipeline that was run, as well as signed URLs for pipeline run outputs if the run has completed successfully. 
    """ # noqa: E501
    ...
    user_inputs: Dict[str, Any] = Field(description="A map(string:object) of user-provided inputs for the Pipeline. ", alias="userInputs")
    outputs: Optional[Dict[str, Any]] = Field(default=None, description="Signed URLs to download pipeline output files. ")
    ...
    input_size_units: Optional[StrictStr] = Field(default=None, description="The unit for the size of the user's inputs ", alias="inputSizeUnits")
    input_size: Optional[StrictInt] = Field(default=None, description="The size of the user's inputs ", alias="inputSize")
    __properties: ClassVar[List[str]] = ["pipelineName", "pipelineVersion", "toolVersion", "userInputs", "outputs", "outputExpirationDate", "quotaConsumed", "inputSizeUnits", "inputSize"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inputSizeUnits": obj.get("inputSizeUnits"),
