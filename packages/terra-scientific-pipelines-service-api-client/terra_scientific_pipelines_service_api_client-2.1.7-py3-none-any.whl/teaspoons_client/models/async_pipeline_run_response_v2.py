...
class AsyncPipelineRunResponseV2(BaseModel):
    """
    ...
    pipeline_run_report: PipelineRunReportV2 = Field(alias="pipelineRunReport")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AsyncPipelineRunResponseV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AsyncPipelineRunResponseV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pipelineRunReport": PipelineRunReportV2.from_dict(obj["pipelineRunReport"]) if obj.get("pipelineRunReport") is not None else None
        })
        return _obj
