...
class GetPipelineRunsResponseV2(BaseModel):
    ...
    """ # noqa: E501
    total_results: Optional[StrictInt] = Field(default=None, description="The total number of results before filtering is applied", alias="totalResults")
    total_filtered_results: Optional[StrictInt] = Field(default=None, description="The total number of results after filtering is applied", alias="totalFilteredResults")
    results: Optional[List[PipelineRun]] = Field(default=None, description="List of pipeline runs")
    __properties: ClassVar[List[str]] = ["totalResults", "totalFilteredResults", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalFilteredResults": obj.get("totalFilteredResults"),
