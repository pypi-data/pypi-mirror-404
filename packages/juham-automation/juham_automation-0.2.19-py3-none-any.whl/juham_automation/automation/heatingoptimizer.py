...
class HeatingOptimizer(Juham):
    ...
    def enable_relay(
        ...
        return (
            slot >= self.start_slot and slot < end_slot
        )
    ...
    def create_heating_plan(self) -> list[dict[str, Any]]:
        ...
        for hp in self.power_plan:
            ...
            print(f"Slot {slot}, start_slot={self.start_slot}, end_slot={end_slot}, schedule on {schedule_on} and enable_relay {self.enable_relay(slot, spot, fom, end_slot)}")
