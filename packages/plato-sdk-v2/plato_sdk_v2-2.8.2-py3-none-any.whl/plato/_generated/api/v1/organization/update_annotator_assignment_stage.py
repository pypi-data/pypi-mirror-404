...
from plato._generated.models import UpdateAnnotatorAssignmentStageRequest, UpdateAnnotatorAssignmentStageResponse
...
def sync(
    ...
    return UpdateAnnotatorAssignmentStageResponse.model_validate(response.json())
