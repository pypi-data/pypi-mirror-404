"""Plato SDK v2 - Sync Artifact operations."""
...
class ArtifactManager:
    """Manager for artifact operations, accessed via plato.artifacts."""

    def __init__(self, http_client: httpx.Client, api_key: str):
        self._http = http_client
        self._api_key = api_key

    def get(self, artifact_id: str) -> ArtifactInfoResponse:
        ...
        Examples:
            ...
            >>> plato = Plato()
            >>> artifact = plato.artifacts.get("abc123")
            >>> print(artifact.status)  # "creating", "ready", or "failed"
        """
        return get_artifact.sync(
            client=self._http,
