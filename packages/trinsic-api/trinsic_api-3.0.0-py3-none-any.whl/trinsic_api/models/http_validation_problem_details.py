...
class HttpValidationProblemDetails(BaseModel):
    ...
    title: Optional[StrictStr] = Field(default=None, description="A short, human-readable summary of the error.")
    status: Optional[StrictInt] = Field(default=None, description="The HTTP status code returned for the request.")
    detail: Optional[StrictStr] = Field(default=None, description="A human-readable explanation specific of the problem.")
