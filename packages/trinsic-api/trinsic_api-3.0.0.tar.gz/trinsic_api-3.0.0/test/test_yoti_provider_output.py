...
class TestYotiProviderOutput(unittest.TestCase):
    """YotiProviderOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YotiProviderOutput:
        """Test YotiProviderOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YotiProviderOutput`
        """
        model = YotiProviderOutput()
        if include_optional:
            return YotiProviderOutput(
    ...
    def testYotiProviderOutput(self):
        """Test YotiProviderOutput"""
