...
class ListSessionsResponse(BaseModel):
    ...
    total: StrictInt = Field(description="The total number of sessions tied to your account")
    more: StrictBool = Field(description="Whether there are additional pages of sessions to retrieve")
    __properties: ClassVar[List[str]] = ["sessions", "total", "more"]
