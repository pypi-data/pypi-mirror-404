#+title: bisos.banna:  BANNA (BISOS Assigned Names and Numbers Authority)
...
bisos.banna is a python package for BISOS Assigned Names and Numbers Authority


* Package Documentation At Github

The information below is a subset of the full of documentation for this bisos-pip package.
More complete documentation is available at: https://github.com/bisos-pip/banna-cs


* Realted Resources

| bisos Capabilities Panel | file:./panels/bisos.banna/_nodeBase_/fullUsagePanel-en.org |
|                          |                                                                |
...
- [[#bisosbanna-as-a-standalone-piece-of-bisos][bisos.banna as a Standalone Piece of BISOS]]
- [[#documentation-and-blee-panels][Documentation and Blee-Panels]]
  - [[#bisosbanna-blee-panels][bisos.banna Blee-Panels]]
- [[#support][Support]]
...
If you need access to bisos.banna as a python module, you can install it with pip:
...
If you only need access to bisos.banna as a command on command-line, you can install it with pipx:
...
bisos.banna is a standalone piece of BISOS. It can be used as a self-contained
...
bisos.banna Blee-Panels are in ./panels directory.
