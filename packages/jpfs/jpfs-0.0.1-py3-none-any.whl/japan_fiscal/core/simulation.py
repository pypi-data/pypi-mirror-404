...
from japan_fiscal.core.model import VARIABLE_INDICES, N_VARIABLES, N_SHOCKS, SHOCK_VARS

if TYPE_CHECKING:
    from japan_fiscal.core.model import DSGEModel, PolicyFunctionResult
