...
from japan_fiscal.mcp.tools import get_context
from japan_fiscal.policies.consumption_tax import (
    SCENARIO_TAX_CUT_2PCT,
    SCENARIO_TAX_CUT_5PCT,
    SCENARIO_TAX_INCREASE_2PCT,
)
from japan_fiscal.policies.social_security import (
    SCENARIO_TRANSFER_INCREASE,
    SCENARIO_PENSION_CUT,
)
from japan_fiscal.policies.subsidies import (
