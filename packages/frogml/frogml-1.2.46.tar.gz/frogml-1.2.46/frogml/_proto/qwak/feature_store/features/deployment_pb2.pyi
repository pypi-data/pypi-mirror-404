...
class _DeploymentUpdateRequestStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeploymentUpdateRequestStatus.ValueType], builtins.type):
...
class DeploymentUpdateRequestState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["invalid_request_type", b"invalid_request_type", "type", b"type", "undeploy_request_type", b"undeploy_request_type", "update_request_type", b"update_request_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["deployment_update_request_status", b"deployment_update_request_status", "invalid_request_type", b"invalid_request_type", "type", b"type", "undeploy_request_type", b"undeploy_request_type", "update_request_type", b"update_request_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["invalid_request_type", "update_request_type", "undeploy_request_type"] | None: ...
...
class DeploymentState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["extractor_identifier", b"extractor_identifier", "identifier_type", b"identifier_type", "status_details", b"status_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["extractor_identifier", b"extractor_identifier", "identifier_type", b"identifier_type", "status_details", b"status_details"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["identifier_type", b"identifier_type"]) -> typing.Literal["extractor_identifier"] | None: ...
...
class ExtractorDeploymentIdentifier(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["extractor_deployment_id", b"extractor_deployment_id", "extractor_id", b"extractor_id", "featureset_id", b"featureset_id"]) -> None: ...
...
class DeploymentStatusDetails(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["failed_status_details", b"failed_status_details", "running_status_details", b"running_status_details", "status_details", b"status_details", "update_in_progress_status_details", b"update_in_progress_status_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["failed_status_details", b"failed_status_details", "running_status_details", b"running_status_details", "status_details", b"status_details", "update_in_progress_status_details", b"update_in_progress_status_details"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["status_details", b"status_details"]) -> typing.Literal["update_in_progress_status_details", "running_status_details", "failed_status_details"] | None: ...
...
class InstanceDetails(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["extractor_identifier", b"extractor_identifier", "identifier_type", b"identifier_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["available_replicas", b"available_replicas", "extractor_identifier", b"extractor_identifier", "identifier_type", b"identifier_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["identifier_type", b"identifier_type"]) -> typing.Literal["extractor_identifier"] | None: ...
...
class ExtractorInstanceIdentifier(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["extractor_deployment_update_request_id", b"extractor_deployment_update_request_id"]) -> None: ...
