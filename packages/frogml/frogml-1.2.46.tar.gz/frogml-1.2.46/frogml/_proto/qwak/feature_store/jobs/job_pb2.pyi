...
class JobRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["creation_time", b"creation_time", "end_time", b"end_time", "ingestion_window", b"ingestion_window", "start_time", b"start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["creation_time", b"creation_time", "end_time", b"end_time", "feature_set_name", b"feature_set_name", "ingestion_message", b"ingestion_message", "ingestion_window", b"ingestion_window", "job_id", b"job_id", "job_state", b"job_state", "start_time", b"start_time", "try_number", b"try_number"]) -> None: ...
...
class ElaborateJobRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error_technical_details", b"error_technical_details", "job_record", b"job_record", "status_message", b"status_message"]) -> None: ...
...
class IngestionWindow(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["batch_execution_time", b"batch_execution_time", "ingested_data_end_time", b"ingested_data_end_time", "ingested_data_start_time", b"ingested_data_start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["batch_execution_time", b"batch_execution_time", "ingested_data_end_time", b"ingested_data_end_time", "ingested_data_start_time", b"ingested_data_start_time", "ingested_data_updated_rows", b"ingested_data_updated_rows"]) -> None: ...
