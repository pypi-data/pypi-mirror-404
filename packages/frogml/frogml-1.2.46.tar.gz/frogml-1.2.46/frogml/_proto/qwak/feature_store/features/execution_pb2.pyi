...
class _ClusterTemplateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ClusterTemplate.ValueType], builtins.type):
...
class ExecutionSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cluster_template", b"cluster_template", "resource_configuration", b"resource_configuration", "spec", b"spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cluster_template", b"cluster_template", "resource_configuration", b"resource_configuration", "spec", b"spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["spec", b"spec"]) -> typing.Literal["cluster_template", "resource_configuration"] | None: ...
...
class StreamingExecutionSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["offline_cluster_template", b"offline_cluster_template", "offline_resource_configuration", b"offline_resource_configuration", "offline_resource_spec", b"offline_resource_spec", "online_cluster_template", b"online_cluster_template", "online_resource_configuration", b"online_resource_configuration", "online_resource_spec", b"online_resource_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["offline_cluster_template", b"offline_cluster_template", "offline_resource_configuration", b"offline_resource_configuration", "offline_resource_spec", b"offline_resource_spec", "online_cluster_template", b"online_cluster_template", "online_resource_configuration", b"online_resource_configuration", "online_resource_spec", b"online_resource_spec"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["offline_resource_spec", b"offline_resource_spec"]) -> typing.Literal["offline_cluster_template", "offline_resource_configuration"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["online_resource_spec", b"online_resource_spec"]) -> typing.Literal["online_cluster_template", "online_resource_configuration"] | None: ...
...
class BackfillExecutionSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["backfill_resource_spec", b"backfill_resource_spec", "cluster_template", b"cluster_template", "resource_configuration", b"resource_configuration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["backfill_resource_spec", b"backfill_resource_spec", "cluster_template", b"cluster_template", "resource_configuration", b"resource_configuration"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["backfill_resource_spec", b"backfill_resource_spec"]) -> typing.Literal["cluster_template", "resource_configuration"] | None: ...
