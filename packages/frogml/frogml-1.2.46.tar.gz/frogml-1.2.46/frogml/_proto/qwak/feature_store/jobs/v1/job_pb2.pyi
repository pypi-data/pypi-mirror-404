...
class IngestionWindow(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["ingested_data_end_time", b"ingested_data_end_time", "ingested_data_start_time", b"ingested_data_start_time", "scheduled_execution_time", b"scheduled_execution_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["ingested_data_end_time", b"ingested_data_end_time", "ingested_data_start_time", b"ingested_data_start_time", "ingested_data_updated_rows", b"ingested_data_updated_rows", "scheduled_execution_time", b"scheduled_execution_time"]) -> None: ...
...
class FeaturesetLevelJobsSummary(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["featureset_id", b"featureset_id", "total_num_affected_rows", b"total_num_affected_rows"]) -> None: ...
