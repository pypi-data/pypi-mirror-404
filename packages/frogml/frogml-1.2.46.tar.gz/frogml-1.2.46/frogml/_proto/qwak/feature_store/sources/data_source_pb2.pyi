...
class DataSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["data_source_definition", b"data_source_definition", "metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["data_source_definition", b"data_source_definition", "feature_sets", b"feature_sets", "metadata", b"metadata"]) -> None: ...
...
class DataSourceMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["created_at", b"created_at", "created_by", b"created_by", "environment_id", b"environment_id", "last_modified_at", b"last_modified_at", "last_modified_by", b"last_modified_by"]) -> None: ...
...
class DataSourceSpec(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["batch_source", "stream_source"] | None: ...
...
class FeatureSetBrief(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["feature_set_id", b"feature_set_id", "feature_set_name", b"feature_set_name", "feature_set_type", b"feature_set_type"]) -> None: ...
