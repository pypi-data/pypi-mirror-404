...
class _MemoryUnitApiEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_MemoryUnitApi.ValueType], builtins.type):
...
class ListInferenceJobFilesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aws_credentials", b"aws_credentials", "cloud_client_credentials", b"cloud_client_credentials", "gcp_credentials", b"gcp_credentials", "grouped_task_details", b"grouped_task_details", "task_flow", b"task_flow"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aws_credentials", b"aws_credentials", "bucket", b"bucket", "cloud_client_credentials", b"cloud_client_credentials", "directory_path", b"directory_path", "environment_id", b"environment_id", "gcp_credentials", b"gcp_credentials", "grouped_task_details", b"grouped_task_details", "role_arn", b"role_arn", "secret_secret", b"secret_secret", "secret_service_url", b"secret_service_url", "task_flow", b"task_flow", "token_secret", b"token_secret"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["cloud_client_credentials", b"cloud_client_credentials"]) -> typing.Literal["aws_credentials", "gcp_credentials"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["task_flow", b"task_flow"]) -> typing.Literal["grouped_task_details"] | None: ...
...
class GroupedTaskDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["concurrentTasks", b"concurrentTasks", "destination_bucket", b"destination_bucket", "destination_path", b"destination_path"]) -> None: ...
...
class CleanStorageObjectFromCloudStorageRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aws_credentials", b"aws_credentials", "cloud_client_credentials", b"cloud_client_credentials", "gcp_credentials", b"gcp_credentials"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aws_credentials", b"aws_credentials", "bucket", b"bucket", "cloud_client_credentials", b"cloud_client_credentials", "environment_id", b"environment_id", "gcp_credentials", b"gcp_credentials", "object_prefix", b"object_prefix", "secret_service_url", b"secret_service_url"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["cloud_client_credentials", b"cloud_client_credentials"]) -> typing.Literal["aws_credentials", "gcp_credentials"] | None: ...
...
class AwsCredentials(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["role_arn", b"role_arn", "secret_secret", b"secret_secret", "token_secret", b"token_secret"]) -> None: ...
...
class GcpCredentials(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["service_account_json_key_secret", b"service_account_json_key_secret"]) -> None: ...
...
class ListInferenceJobFilesResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["failure_reason", b"failure_reason", "file_names", b"file_names", "list_file_details", b"list_file_details", "success", b"success"]) -> None: ...
...
class ListFileDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["is_point_file", b"is_point_file", "object_paths", b"object_paths", "point_file_path", b"point_file_path"]) -> None: ...
...
class CreateInferenceTaskExecutorRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["inference_task_configuration", b"inference_task_configuration", "task_executor_configuration", b"task_executor_configuration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["inference_task_configuration", b"inference_task_configuration", "task_executor_configuration", b"task_executor_configuration"]) -> None: ...
...
class PrepareInferenceJobRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["inference_job_configuration_message", b"inference_job_configuration_message"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["inference_job_configuration_message", b"inference_job_configuration_message"]) -> None: ...
...
class TaskExecutorConfigurationMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["job_size", b"job_size", "model_identifier", b"model_identifier"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["backoff_limit", b"backoff_limit", "cpu", b"cpu", "custom_iam_role_arn", b"custom_iam_role_arn", "custom_service_account_secret", b"custom_service_account_secret", "environment_id", b"environment_id", "image_pull_secret", b"image_pull_secret", "image_url", b"image_url", "inference_job_id", b"inference_job_id", "inference_task_id", b"inference_task_id", "jfrog_base_url", b"jfrog_base_url", "jfrog_token_api_secret_name", b"jfrog_token_api_secret_name", "job_size", b"job_size", "memory_amount", b"memory_amount", "memory_units", b"memory_units", "model_identifier", b"model_identifier", "purchase_option", b"purchase_option"]) -> None: ...
...
class InferenceJobConfigurationMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["custom_iam_role_arn", b"custom_iam_role_arn", "environment_id", b"environment_id", "inference_job_id", b"inference_job_id"]) -> None: ...
...
class ModelIdentifier(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["branch_id", b"branch_id", "build_id", b"build_id", "model_group_name", b"model_group_name", "model_id", b"model_id", "model_uuid", b"model_uuid"]) -> None: ...
...
class ListFilesPreStepConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["task_index", b"task_index"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["list_files_file_name", b"list_files_file_name", "source_path", b"source_path", "task_index", b"task_index", "total_number_of_tasks", b"total_number_of_tasks"]) -> None: ...
...
class CleanInferenceTasksExecutorsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["inference_job_id", b"inference_job_id"]) -> None: ...
...
class CleanInferenceTaskExecutorRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["inference_job_id", b"inference_job_id", "inference_task_id", b"inference_task_id"]) -> None: ...
...
class StartInferenceJobWarmupRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["branch_id", b"branch_id", "build_id", b"build_id", "cpu", b"cpu", "executors", b"executors", "image_pull_secret", b"image_pull_secret", "image_url", b"image_url", "job_size", b"job_size", "memory_amount", b"memory_amount", "memory_units", b"memory_units", "model_id", b"model_id", "model_uuid", b"model_uuid", "timeout", b"timeout"]) -> None: ...
...
class CancelInferenceJobWarmupRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["branch_id", b"branch_id", "build_id", b"build_id", "model_id", b"model_id", "model_uuid", b"model_uuid"]) -> None: ...
...
class BatchJobResources(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["gpu_resources", b"gpu_resources"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cpu", b"cpu", "gpu_resources", b"gpu_resources", "memory_amount", b"memory_amount", "memory_units", b"memory_units", "number_of_pods", b"number_of_pods"]) -> None: ...
