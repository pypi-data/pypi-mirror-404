...
class _TriggerMetricTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_TriggerMetricType.ValueType], builtins.type):
...
class KubeServingStrategy(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["Strategy", b"Strategy", "realtime_config", b"realtime_config", "stream_config", b"stream_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["Strategy", b"Strategy", "realtime_config", b"realtime_config", "stream_config", b"stream_config"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["Strategy", b"Strategy"]) -> typing.Literal["realtime_config", "stream_config"] | None: ...
...
class PrometheusTrigger(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["metric_name", b"metric_name", "metric_type", b"metric_type", "query", b"query", "threshold", b"threshold"]) -> None: ...
...
class RealTimeConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["assumed_iam_role_arn", b"assumed_iam_role_arn", "selected_variation_mapping_name", b"selected_variation_mapping_name"]) -> None: ...
...
class StreamConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["configuration", b"configuration", "kafka", b"kafka"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["configuration", b"configuration", "kafka", b"kafka"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["configuration", b"configuration"]) -> typing.Literal["kafka"] | None: ...
...
class KubeDeploymentSize(google.protobuf.message.Message):
    ...
    class _GpuTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[KubeDeploymentSize._GpuType.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _MemoryUnitEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[KubeDeploymentSize._MemoryUnit.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class KubeRuntimeDeploymentSettings(google.protobuf.message.Message):
    ...
    class _LogLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[KubeRuntimeDeploymentSettings._LogLevel.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
