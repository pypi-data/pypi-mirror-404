...
class OpenAIModelDescriptor(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["capabilities", b"capabilities", "model_id", b"model_id"]) -> None: ...
...
class OpenAIChatModelParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["frequency_penalty", b"frequency_penalty", "logit_bias", b"logit_bias", "logprobs", b"logprobs", "max_tokens", b"max_tokens", "n", b"n", "optional_frequency_penalty", b"optional_frequency_penalty", "optional_logit_bias", b"optional_logit_bias", "optional_logprobs", b"optional_logprobs", "optional_max_tokens", b"optional_max_tokens", "optional_n", b"optional_n", "optional_presence_penalty", b"optional_presence_penalty", "optional_response_format", b"optional_response_format", "optional_seed", b"optional_seed", "optional_stop", b"optional_stop", "optional_temperature", b"optional_temperature", "optional_tool_choice", b"optional_tool_choice", "optional_tools", b"optional_tools", "optional_top_logprobs", b"optional_top_logprobs", "optional_top_p", b"optional_top_p", "optional_user", b"optional_user", "presence_penalty", b"presence_penalty", "response_format", b"response_format", "seed", b"seed", "stop", b"stop", "temperature", b"temperature", "tool_choice", b"tool_choice", "tools_spec", b"tools_spec", "top_logprobs", b"top_logprobs", "top_p", b"top_p", "user", b"user"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["frequency_penalty", b"frequency_penalty", "logit_bias", b"logit_bias", "logprobs", b"logprobs", "max_tokens", b"max_tokens", "n", b"n", "optional_frequency_penalty", b"optional_frequency_penalty", "optional_logit_bias", b"optional_logit_bias", "optional_logprobs", b"optional_logprobs", "optional_max_tokens", b"optional_max_tokens", "optional_n", b"optional_n", "optional_presence_penalty", b"optional_presence_penalty", "optional_response_format", b"optional_response_format", "optional_seed", b"optional_seed", "optional_stop", b"optional_stop", "optional_temperature", b"optional_temperature", "optional_tool_choice", b"optional_tool_choice", "optional_tools", b"optional_tools", "optional_top_logprobs", b"optional_top_logprobs", "optional_top_p", b"optional_top_p", "optional_user", b"optional_user", "presence_penalty", b"presence_penalty", "response_format", b"response_format", "seed", b"seed", "stop", b"stop", "temperature", b"temperature", "tool_choice", b"tool_choice", "tools_spec", b"tools_spec", "top_logprobs", b"top_logprobs", "top_p", b"top_p", "user", b"user"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_frequency_penalty", b"optional_frequency_penalty"]) -> typing.Literal["frequency_penalty"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_logit_bias", b"optional_logit_bias"]) -> typing.Literal["logit_bias"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_logprobs", b"optional_logprobs"]) -> typing.Literal["logprobs"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_max_tokens", b"optional_max_tokens"]) -> typing.Literal["max_tokens"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_n", b"optional_n"]) -> typing.Literal["n"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_presence_penalty", b"optional_presence_penalty"]) -> typing.Literal["presence_penalty"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_response_format", b"optional_response_format"]) -> typing.Literal["response_format"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_seed", b"optional_seed"]) -> typing.Literal["seed"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_stop", b"optional_stop"]) -> typing.Literal["stop"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_temperature", b"optional_temperature"]) -> typing.Literal["temperature"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_tool_choice", b"optional_tool_choice"]) -> typing.Literal["tool_choice"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_tools", b"optional_tools"]) -> typing.Literal["tools_spec"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_top_logprobs", b"optional_top_logprobs"]) -> typing.Literal["top_logprobs"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_top_p", b"optional_top_p"]) -> typing.Literal["top_p"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["optional_user", b"optional_user"]) -> typing.Literal["user"] | None: ...
...
class ToolChoice(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["json", b"json", "literal", b"literal", "value_type", b"value_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["json", b"json", "literal", b"literal", "value_type", b"value_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["value_type", b"value_type"]) -> typing.Literal["json", "literal"] | None: ...
...
class OpenAICapabilities(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["chat_api", b"chat_api", "optional_chat", b"optional_chat"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["chat_api", b"chat_api", "optional_chat", b"optional_chat"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["optional_chat", b"optional_chat"]) -> typing.Literal["chat_api"] | None: ...
...
class OpenAIChatAPI(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["chat_params", b"chat_params", "optional_chat_params", b"optional_chat_params"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["chat_params", b"chat_params", "optional_chat_params", b"optional_chat_params"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["optional_chat_params", b"optional_chat_params"]) -> typing.Literal["chat_params"] | None: ...
