...
# source: frogml._proto.qwak.build/v1/build_api.proto
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_REGISTEREXPERIMENTTRACKINGREQUEST_PARAMSENTRY']._options = None
  _globals['_REGISTEREXPERIMENTTRACKINGREQUEST_PARAMSENTRY']._serialized_options = b'8\001'
  _globals['_REGISTEREXPERIMENTTRACKINGREQUEST_METRICSENTRY']._options = None
  _globals['_REGISTEREXPERIMENTTRACKINGREQUEST_METRICSENTRY']._serialized_options = b'8\001'
  _globals['_LISTBUILDSREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_LISTBUILDSREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_GETBUILDSARTIFACTSSCANSUMMARYREQUEST'].fields_by_name['artifact_name']._options = None
  _globals['_GETBUILDSARTIFACTSSCANSUMMARYREQUEST'].fields_by_name['artifact_name']._serialized_options = b'\030\001'
  _globals['_GETBUILDSARTIFACTSSCANSUMMARYRESPONSE_RESULTBYARTIFACTNAMEENTRY']._options = None
  _globals['_GETBUILDSARTIFACTSSCANSUMMARYRESPONSE_RESULTBYARTIFACTNAMEENTRY']._serialized_options = b'8\001'
  _globals['_GETBUILDSARTIFACTSSCANSUMMARYRESPONSE'].fields_by_name['result']._options = None
  _globals['_GETBUILDSARTIFACTSSCANSUMMARYRESPONSE'].fields_by_name['result']._serialized_options = b'\030\001'
  _globals['_GETBUILDSARTIFACTSSCANSUMMARYRESPONSE'].fields_by_name['ui_direct_link']._options = None
  _globals['_GETBUILDSARTIFACTSSCANSUMMARYRESPONSE'].fields_by_name['ui_direct_link']._serialized_options = b'\030\001'
