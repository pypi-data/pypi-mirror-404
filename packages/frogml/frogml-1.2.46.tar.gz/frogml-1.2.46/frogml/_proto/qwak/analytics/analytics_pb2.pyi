...
class _QueryStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_QueryStatus.ValueType], builtins.type):
...
class ResultData(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["headers", b"headers", "headersDesc", b"headersDesc", "rows", b"rows"]) -> None: ...
...
class TableColumn(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["comment", b"comment", "name", b"name", "type", b"type"]) -> None: ...
...
class TableDefinition(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["format", b"format"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["columns", b"columns", "data_path", b"data_path", "db_name", b"db_name", "format", b"format", "partitions", b"partitions", "table_name", b"table_name"]) -> None: ...
