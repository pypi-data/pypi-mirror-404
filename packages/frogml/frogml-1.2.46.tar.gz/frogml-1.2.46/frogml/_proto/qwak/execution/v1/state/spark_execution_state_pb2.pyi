...
class _SparkAppTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SparkAppType.ValueType], builtins.type):
...
class _SparkAppStateTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SparkAppStateType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class SparkExecutionState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["spark_app_state", b"spark_app_state", "state_descriptor", b"state_descriptor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["applicationLabels", b"applicationLabels", "application_id", b"application_id", "spark_app_state", b"spark_app_state", "spark_application_type", b"spark_application_type", "state_descriptor", b"state_descriptor"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["state_descriptor", b"state_descriptor"]) -> typing.Literal["spark_app_state"] | None: ...
...
class SparkAppState(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error_message", b"error_message", "state_type", b"state_type"]) -> None: ...
