...
import frogml._proto.qwak.automation.v1.auto_scaling_pb2
import frogml._proto.qwak.automation.v1.common_pb2
import frogml._proto.qwak.batch_job.v1.batch_job_service_pb2
...
class BatchExecutionAction(google.protobuf.message.Message):
    ...
    @property
    def execute_batch_job(self) -> frogml._proto.qwak.batch_job.v1.batch_job_service_pb2.BatchJobRequest: ...
    def __init__(
        self,
        *,
...
class AdvancedDeploymentOptions(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        daemon_mode: builtins.bool = ...,
        custom_iam_role_arn: builtins.str = ...,
        auto_scaling_config: frogml._proto.qwak.automation.v1.auto_scaling_pb2.AutoScalingConfig | None = ...,
        max_batch_size: builtins.int = ...,
        deployment_process_timeout_limit: builtins.int = ...,
        service_account_key_secret_name: builtins.str = ...,
    ) -> None: ...
