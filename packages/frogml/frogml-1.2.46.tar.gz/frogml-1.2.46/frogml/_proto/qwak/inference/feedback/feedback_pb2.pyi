...
class ActualValuesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["actuals", b"actuals", "entity", b"entity", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["actuals", b"actuals", "entity", b"entity", "model_id", b"model_id", "timestamp", b"timestamp"]) -> None: ...
...
class EnrichedActualValuesData(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["actuals", b"actuals", "entity", b"entity", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["actuals", b"actuals", "entity", b"entity", "model_id", b"model_id", "qwak_environment_id", b"qwak_environment_id", "timestamp", b"timestamp"]) -> None: ...
...
class Actuals(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["tag", b"tag", "value", b"value"]) -> None: ...
...
class ActualValuesResponse(google.protobuf.message.Message):
    ...
    class _ValueStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ActualValuesResponse._ValueStatus.ValueType], builtins.type):
...
class ConfigureFeedbackRequest(google.protobuf.message.Message):
    ...
    class _ModelTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ConfigureFeedbackRequest._ModelType.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def ClearField(self, field_name: typing.Literal["analytics_entity_column", b"analytics_entity_column", "feedback_config", b"feedback_config", "feedback_entity_column", b"feedback_entity_column", "model_id", b"model_id", "model_type", b"model_type"]) -> None: ...
...
class FeedbackConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["actual_tag", b"actual_tag", "output_column", b"output_column"]) -> None: ...
...
class ConfigureFeedbackResponse(google.protobuf.message.Message):
    ...
    class _ValueStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ConfigureFeedbackResponse._ValueStatus.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
