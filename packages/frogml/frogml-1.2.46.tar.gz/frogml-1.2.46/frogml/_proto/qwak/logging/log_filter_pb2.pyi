...
class SearchFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["and_operator_filter", b"and_operator_filter", "filter", b"filter", "log_emitting_time_filter", b"log_emitting_time_filter", "log_text_filter", b"log_text_filter"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["and_operator_filter", b"and_operator_filter", "filter", b"filter", "log_emitting_time_filter", b"log_emitting_time_filter", "log_text_filter", b"log_text_filter"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["filter", b"filter"]) -> typing.Literal["log_text_filter", "and_operator_filter", "log_emitting_time_filter"] | None: ...
...
class LogText(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["contains", b"contains"]) -> None: ...
...
class LogTimeFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["after_time", b"after_time", "before_time", b"before_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["after_time", b"after_time", "before_time", b"before_time"]) -> None: ...
...
class AndOperatorFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["search_filters", b"search_filters"]) -> None: ...
