...
class _CommunicationManagerTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CommunicationManagerType.ValueType], builtins.type):
...
class QwakEnvironmentConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cloud_configuration", b"cloud_configuration", "environment_runtime_config", b"environment_runtime_config", "feature_store_configuration", b"feature_store_configuration", "optional_runtime_config", b"optional_runtime_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["analytics_data_api_url", b"analytics_data_api_url", "bi_system_api_key", b"bi_system_api_key", "cloud_configuration", b"cloud_configuration", "communication_manager_type", b"communication_manager_type", "container_registry_prefix", b"container_registry_prefix", "edge_services_url", b"edge_services_url", "environment_runtime_config", b"environment_runtime_config", "feature_store_configuration", b"feature_store_configuration", "management_access_url", b"management_access_url", "model_api_url", b"model_api_url", "object_storage_bucket", b"object_storage_bucket", "optional_runtime_config", b"optional_runtime_config"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["optional_runtime_config", b"optional_runtime_config"]) -> typing.Literal["environment_runtime_config"] | None: ...
...
class FeatureStoreConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["airflow_connection_id", b"airflow_connection_id", "redis_address", b"redis_address", "user_code_execution_allowed", b"user_code_execution_allowed"]) -> None: ...
...
class QwakCloudConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aws_cloud_configuration", b"aws_cloud_configuration", "configuration", b"configuration", "gcp_cloud_configuration", b"gcp_cloud_configuration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aws_cloud_configuration", b"aws_cloud_configuration", "configuration", b"configuration", "gcp_cloud_configuration", b"gcp_cloud_configuration"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["configuration", b"configuration"]) -> typing.Literal["aws_cloud_configuration", "gcp_cloud_configuration"] | None: ...
...
class AwsCloudConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["feature_store_emr", b"feature_store_emr"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["external_id", b"external_id", "feature_store_emr", b"feature_store_emr", "region", b"region", "role_arn", b"role_arn", "workgroup", b"workgroup"]) -> None: ...
...
class GcpCloudConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["big_lake_catalog_name", b"big_lake_catalog_name", "big_lake_connection_name", b"big_lake_connection_name", "big_lake_location", b"big_lake_location", "project_id", b"project_id", "region", b"region", "service_account", b"service_account"]) -> None: ...
...
class FeatureStoreEmr(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["ec2_additional_security_group", b"ec2_additional_security_group", "ec2_key_name", b"ec2_key_name", "ec2_subnet_id", b"ec2_subnet_id", "emr_job_flow_role", b"emr_job_flow_role", "emr_service_role", b"emr_service_role", "target_on_demand_capacity_workers", b"target_on_demand_capacity_workers"]) -> None: ...
...
class EnvironmentRuntimeConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["network_configuration", b"network_configuration", "runtime_configuration", b"runtime_configuration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["network_configuration", b"network_configuration", "runtime_configuration", b"runtime_configuration"]) -> None: ...
