...
class _ClusterInstallationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ClusterInstallationType.ValueType], builtins.type):
...
class Cluster(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cluster_metadata", b"cluster_metadata", "configuration", b"configuration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cluster_metadata", b"cluster_metadata", "configuration", b"configuration", "id", b"id", "name", b"name"]) -> None: ...
...
class ClusterConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["hybrid_configuration", b"hybrid_configuration", "self_hosted_configuration", b"self_hosted_configuration", "self_service_configuration", b"self_service_configuration", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["hybrid_configuration", b"hybrid_configuration", "self_hosted_configuration", b"self_hosted_configuration", "self_service_configuration", b"self_service_configuration", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["self_hosted_configuration", "self_service_configuration", "hybrid_configuration"] | None: ...
...
class SelfHostedConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["runtime_configuration", b"runtime_configuration"]) -> None: ...
...
class RuntimeConfiguration(google.protobuf.message.Message):
    ...
    @property
    def network_configuration(self) -> frogml._proto.qwak.administration.runtime_configuration.v0.network_config_pb2.ClusterNetworkConfiguration: ...
    def __init__(
        self,
        *,
        ...
        network_configuration: frogml._proto.qwak.administration.runtime_configuration.v0.network_config_pb2.ClusterNetworkConfiguration | None = ...,
    ) -> None: ...
...
class ClusterSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["configuration_spec", b"configuration_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["configuration_spec", b"configuration_spec", "display_name", b"display_name"]) -> None: ...
...
class ClusterState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["state", b"state", "valid", b"valid"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["state", b"state", "valid", b"valid"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["state", b"state"]) -> typing.Literal["valid"] | None: ...
...
class ClusterBrief(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["installation_type", b"installation_type"]) -> None: ...
