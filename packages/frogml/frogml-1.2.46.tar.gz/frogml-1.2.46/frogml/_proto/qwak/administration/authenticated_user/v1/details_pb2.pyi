...
class EnvironmentDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["configuration", b"configuration", "id", b"id"]) -> None: ...
...
class EnvironmentConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cloud_configuration", b"cloud_configuration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["analytics_data_api_url", b"analytics_data_api_url", "bi_system_api_key", b"bi_system_api_key", "cloud_configuration", b"cloud_configuration", "edge_services_url", b"edge_services_url", "management_access_url", b"management_access_url", "model_api_url", b"model_api_url", "object_storage_bucket", b"object_storage_bucket"]) -> None: ...
...
class QwakCloudConfiguration(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aws_cloud_configuration", b"aws_cloud_configuration", "configuration", b"configuration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aws_cloud_configuration", b"aws_cloud_configuration", "configuration", b"configuration"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["configuration", b"configuration"]) -> typing.Literal["aws_cloud_configuration"] | None: ...
...
class AwsCloudConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["external_id", b"external_id", "region", b"region", "role_arn", b"role_arn", "workgroup", b"workgroup"]) -> None: ...
