...
class ExecutionState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["exec_state", b"exec_state", "spark_app_state", b"spark_app_state"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["environment_id", b"environment_id", "exec_state", b"exec_state", "execution_id", b"execution_id", "featureset_id", b"featureset_id", "spark_app_state", b"spark_app_state"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["exec_state", b"exec_state"]) -> typing.Literal["spark_app_state"] | None: ...
