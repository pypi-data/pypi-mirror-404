...
class BatchIngestion(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["trigger_type", b"trigger_type"]) -> typing.Literal["manual_trigger", "scheduled_trigger"] | None: ...
...
class ManualTrigger(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["trigger_date", b"trigger_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["trigger_date", b"trigger_date"]) -> None: ...
...
class ScheduledTrigger(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["logical_batch_date", b"logical_batch_date"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["logical_batch_date", b"logical_batch_date"]) -> None: ...
