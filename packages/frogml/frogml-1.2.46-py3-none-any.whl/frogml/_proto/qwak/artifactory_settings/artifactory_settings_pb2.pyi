...
class ArtifactorySettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["authentication_details", b"authentication_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["authentication_details", b"authentication_details", "container_registry_prefix", b"container_registry_prefix", "internal_repository_name", b"internal_repository_name"]) -> None: ...
...
class ArtifactoryAuthenticationDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["tenant_id", b"tenant_id", "token", b"token", "username", b"username"]) -> None: ...
