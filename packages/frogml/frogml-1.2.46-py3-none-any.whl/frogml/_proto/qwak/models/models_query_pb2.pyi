...
class _SortByEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SortBy.ValueType], builtins.type):
...
class _DeploymentModelStatusFilterEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeploymentModelStatusFilter.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class SortModels(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["sort_by", b"sort_by", "sort_by_opt", b"sort_by_opt", "sort_order", b"sort_order", "sort_order_opt", b"sort_order_opt"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["sort_by", b"sort_by", "sort_by_opt", b"sort_by_opt", "sort_order", b"sort_order", "sort_order_opt", b"sort_order_opt"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["sort_by_opt", b"sort_by_opt"]) -> typing.Literal["sort_by"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["sort_order_opt", b"sort_order_opt"]) -> typing.Literal["sort_order"] | None: ...
...
class Filter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["deployment_model_status", b"deployment_model_status", "deployment_model_status_opt", b"deployment_model_status_opt", "model_name_substring", b"model_name_substring", "search_opt", b"search_opt"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["deployment_model_status", b"deployment_model_status", "deployment_model_status_opt", b"deployment_model_status_opt", "model_group_names", b"model_group_names", "model_name_substring", b"model_name_substring", "search_opt", b"search_opt"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["deployment_model_status_opt", b"deployment_model_status_opt"]) -> typing.Literal["deployment_model_status"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["search_opt", b"search_opt"]) -> typing.Literal["model_name_substring"] | None: ...
...
class PaginationMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["next_cursor", b"next_cursor", "page_size", b"page_size"]) -> None: ...
