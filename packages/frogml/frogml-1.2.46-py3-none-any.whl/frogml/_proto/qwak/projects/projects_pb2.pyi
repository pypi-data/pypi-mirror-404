...
import frogml._proto.qwak.models.models_pb2
...
class ProjectRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["create_project_request", b"create_project_request", "delete_project_request", b"delete_project_request", "get_project_request", b"get_project_request", "list_projects_request", b"list_projects_request", "request", b"request", "update_project_request", b"update_project_request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["create_project_request", b"create_project_request", "delete_project_request", b"delete_project_request", "get_project_request", b"get_project_request", "list_projects_request", b"list_projects_request", "request", b"request", "update_project_request", b"update_project_request"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["request", b"request"]) -> typing.Literal["create_project_request", "delete_project_request", "update_project_request", "get_project_request", "list_projects_request"] | None: ...
...
class CreateProjectRequest(google.protobuf.message.Message):
    ...
    """Project description"""
    @property
    def jfrog_spec(self) -> frogml._proto.qwak.projects.jfrog_project_spec_pb2.ModelRepositoryJFrogSpec:
        """jfrog spec"""
    ...
    def __init__(
        ...
        *,
        project_name: builtins.str = ...,
        project_description: builtins.str = ...,
        jfrog_spec: frogml._proto.qwak.projects.jfrog_project_spec_pb2.ModelRepositoryJFrogSpec | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["jfrog_spec", b"jfrog_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["jfrog_spec", b"jfrog_spec", "project_description", b"project_description", "project_name", b"project_name"]) -> None: ...
...
class GetProjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["project_id", b"project_id", "project_name", b"project_name"]) -> None: ...
...
class UpdateProjectRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["project_spec_config", b"project_spec_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["project_id", b"project_id", "project_spec_config", b"project_spec_config"]) -> None: ...
...
class UpdateProjectResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["project_spec", b"project_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["project_spec", b"project_spec"]) -> None: ...
...
class Project(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["models", b"models", "models_briefs", b"models_briefs", "spec", b"spec"]) -> None: ...
...
class ProjectSpec(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ProjectSpec._Status.ValueType], builtins.type):
    ...
    def HasField(self, field_name: typing.Literal["created_at", b"created_at", "jfrog_settings", b"jfrog_settings", "last_modified_at", b"last_modified_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["created_at", b"created_at", "created_by", b"created_by", "jfrog_settings", b"jfrog_settings", "last_modified_at", b"last_modified_at", "last_modified_by", b"last_modified_by", "models_active", b"models_active", "models_count", b"models_count", "project_description", b"project_description", "project_id", b"project_id", "project_name", b"project_name", "project_status", b"project_status"]) -> None: ...
...
class ProjectSpecConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["project_description", b"project_description", "project_name", b"project_name"]) -> None: ...
...
class ModelRepositoryJFrogSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["jfrog_project_details", b"jfrog_project_details", "jfrog_repositories_details", b"jfrog_repositories_details", "pull_image_secret", b"pull_image_secret"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["jfrog_project_details", b"jfrog_project_details", "jfrog_repositories_details", b"jfrog_repositories_details", "pull_image_secret", b"pull_image_secret"]) -> None: ...
...
class ModelRepositoryPullImageSecret(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["pull_image_secret_name", b"pull_image_secret_name"]) -> None: ...
...
class ModelRepositoryJFrogProjectDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["jfrog_project_key", b"jfrog_project_key"]) -> None: ...
...
class ModelRepositoryArtifactoryDetails(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["artifact_repository_details", b"artifact_repository_details", "dataset_repository_details", b"dataset_repository_details", "docker_repository_details", b"docker_repository_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["artifact_repository_details", b"artifact_repository_details", "dataset_repository_details", b"dataset_repository_details", "docker_repository_details", b"docker_repository_details"]) -> None: ...
