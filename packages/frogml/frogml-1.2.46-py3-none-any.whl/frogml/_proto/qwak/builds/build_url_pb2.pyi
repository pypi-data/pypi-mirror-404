...
class _BuildVersioningTagsTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_BuildVersioningTagsType.ValueType], builtins.type):
...
class BuildVersioningUrlParams(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cloud_provider_option", b"cloud_provider_option", "use_cloud_provider_storage", b"use_cloud_provider_storage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["build_id", b"build_id", "cloud_provider_option", b"cloud_provider_option", "environment_id", b"environment_id", "model_id", b"model_id", "tag", b"tag", "tag_type", b"tag_type", "use_cloud_provider_storage", b"use_cloud_provider_storage"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["cloud_provider_option", b"cloud_provider_option"]) -> typing.Literal["use_cloud_provider_storage"] | None: ...
...
class BuildVersioningTags(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["build_id", b"build_id", "environment_id", b"environment_id", "model_id", b"model_id", "tags", b"tags", "tags_definition", b"tags_definition"]) -> None: ...
...
class BuildVersioningTagsProperties(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["external_download_url", b"external_download_url"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["download_url", b"download_url", "external_download_url", b"external_download_url", "file_size", b"file_size", "tag", b"tag", "tag_type", b"tag_type", "ui_direct_link", b"ui_direct_link"]) -> None: ...
...
class ExternalUrl(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["original_hostname", b"original_hostname", "url", b"url"]) -> None: ...
...
class BuildArtifactPathSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["build_id", b"build_id", "key_path", b"key_path", "model_id", b"model_id", "tag", b"tag"]) -> None: ...
...
class BuildArtifact(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["code_artifact", b"code_artifact", "data_artifact", b"data_artifact", "file_artifact", b"file_artifact", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["code_artifact", b"code_artifact", "data_artifact", b"data_artifact", "file_artifact", b"file_artifact", "name", b"name", "path", b"path", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["data_artifact", "code_artifact", "file_artifact"] | None: ...
