...
class _SparkClusterResourceTemplateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SparkClusterResourceTemplate.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _NodeOptimizationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_NodeOptimizationType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class SparkResourceConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["driver_cores", b"driver_cores", "driver_memory", b"driver_memory", "executor_cores", b"executor_cores", "executor_memory", b"executor_memory", "initial_executors", b"initial_executors", "max_executors", b"max_executors", "min_executors", b"min_executors"]) -> None: ...
...
class PodComputeResources(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cpu_resources", b"cpu_resources", "gpu_resources", b"gpu_resources", "template_spec", b"template_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cpu_resources", b"cpu_resources", "gpu_resources", b"gpu_resources", "optimization_type", b"optimization_type", "template_spec", b"template_spec"]) -> None: ...
...
class SparkComputeResources(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["resource_configuration", b"resource_configuration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["resource_configuration", b"resource_configuration"]) -> None: ...
...
class ClientSparkComputeResources(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["resource_configuration", b"resource_configuration", "resources", b"resources", "template_spec", b"template_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["resource_configuration", b"resource_configuration", "resources", b"resources", "template_spec", b"template_spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["resources", b"resources"]) -> typing.Literal["template_spec", "resource_configuration"] | None: ...
...
class ClientPodComputeResources(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cpu_resources", b"cpu_resources", "gpu_resources", b"gpu_resources", "resources", b"resources", "template_spec", b"template_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cpu_resources", b"cpu_resources", "gpu_resources", b"gpu_resources", "node_optimization_type", b"node_optimization_type", "resources", b"resources", "template_spec", b"template_spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["resources", b"resources"]) -> typing.Literal["template_spec", "cpu_resources", "gpu_resources"] | None: ...
