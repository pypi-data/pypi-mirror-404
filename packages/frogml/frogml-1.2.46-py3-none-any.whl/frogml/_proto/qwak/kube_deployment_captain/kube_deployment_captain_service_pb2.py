...
# source: frogml._proto.qwak.kube_deployment_captain/kube_deployment_captain_service.proto
...
from frogml._proto.qwak.kube_deployment_captain import alert_pb2 as qwak_dot_kube__deployment__captain_dot_alert__pb2
from frogml._proto.qwak.kube_deployment_captain import deployment_pb2 as qwak_dot_kube__deployment__captain_dot_deployment__pb2
from frogml._proto.qwak.kube_deployment_captain import feature_set_deployment_pb2 as qwak_dot_kube__deployment__captain_dot_feature__set__deployment__pb2
...
from frogml._proto.qwak.kube_deployment_captain import traffic_mapping_pb2 as qwak_dot_kube__deployment__captain_dot_traffic__mapping__pb2
from frogml._proto.qwak.kube_deployment_captain import alerting_pb2 as qwak_dot_kube__deployment__captain_dot_alerting__pb2
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_APPLYMODELSALERTSREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_APPLYMODELSALERTSREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_KUBEDEPLOYMODELREQUEST_ENVIRONMENTVARIABLESENTRY']._options = None
  _globals['_KUBEDEPLOYMODELREQUEST_ENVIRONMENTVARIABLESENTRY']._serialized_options = b'8\001'
  _globals['_KUBEDEPLOYMODELREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_KUBEDEPLOYMODELREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_KUBEDEPLOYMODELREQUEST'].fields_by_name['number_of_pods']._options = None
  _globals['_KUBEDEPLOYMODELREQUEST'].fields_by_name['number_of_pods']._serialized_options = b'\030\001'
  _globals['_REVERTFAILEDKUBEDEPLOYMENTREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_REVERTFAILEDKUBEDEPLOYMENTREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_UPDATEKUBEDEPLOYMENTRUNTIMESETTINGSREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_UPDATEKUBEDEPLOYMENTRUNTIMESETTINGSREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_KUBEDEPLOYMENTCAPTAIN'].methods_by_name['ApplyModelTrafficMapping']._options = None
  _globals['_KUBEDEPLOYMENTCAPTAIN'].methods_by_name['ApplyModelTrafficMapping']._serialized_options = b'\210\002\001'
