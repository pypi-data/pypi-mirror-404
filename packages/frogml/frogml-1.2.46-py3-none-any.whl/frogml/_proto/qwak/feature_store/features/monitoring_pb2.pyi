...
class MonitoringConfigurations(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["monitoring", b"monitoring"]) -> None: ...
...
class Monitoring(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["failure_alert", b"failure_alert", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["failure_alert", b"failure_alert", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["failure_alert"] | None: ...
