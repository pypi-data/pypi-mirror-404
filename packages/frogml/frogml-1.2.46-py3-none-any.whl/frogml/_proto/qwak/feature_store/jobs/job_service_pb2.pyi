...
import frogml._proto.qwak.feature_store.jobs.job_pb2
import typing
...
class ApplyJobRequest(google.protobuf.message.Message):
    ...
    @property
    def job_record(self) -> frogml._proto.qwak.feature_store.jobs.job_pb2.JobRecord:
        """The job record to register"""

    def __init__(
        self,
        *,
        job_record: frogml._proto.qwak.feature_store.jobs.job_pb2.JobRecord | None = ...,
        logs_path: builtins.str = ...,
        partner_id: builtins.str = ...,
        error_technical_details: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["job_record", b"job_record"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["error_technical_details", b"error_technical_details", "job_record", b"job_record", "logs_path", b"logs_path", "partner_id", b"partner_id"]) -> None: ...
...
class ApplyJobResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["job_running_id", b"job_running_id"]) -> None: ...
...
class InitPaginationResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["last_id", b"last_id", "record_count", b"record_count"]) -> None: ...
...
class ListJobsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["after_id", b"after_id", "feature_set_name", b"feature_set_name", "page_number", b"page_number", "page_size", b"page_size"]) -> None: ...
...
class GetJobLogsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["logs_folder_path", b"logs_folder_path"]) -> None: ...
...
class GetLatestSuccessfulJobRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["feature_set_name", b"feature_set_name", "partner_id", b"partner_id"]) -> None: ...
...
class GetLatestSuccessfulJobResponse(google.protobuf.message.Message):
    ...
    @property
    def job(self) -> frogml._proto.qwak.feature_store.jobs.job_pb2.ElaborateJobRecord:
        """the requested job"""

    def __init__(
        self,
        *,
        job: frogml._proto.qwak.feature_store.jobs.job_pb2.ElaborateJobRecord | None = ...,
        found: builtins.bool = ...,
    ) -> None: ...
