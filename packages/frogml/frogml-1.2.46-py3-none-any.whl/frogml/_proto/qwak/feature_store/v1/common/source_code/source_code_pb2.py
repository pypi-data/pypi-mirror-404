...
from frogml._proto.qwak.feature_store.v1.common.jfrog_artifact import jfrog_artifact_pb2 as qwak_dot_feature__store_dot_v1_dot_common_dot_jfrog__artifact_dot_jfrog__artifact__pb2
