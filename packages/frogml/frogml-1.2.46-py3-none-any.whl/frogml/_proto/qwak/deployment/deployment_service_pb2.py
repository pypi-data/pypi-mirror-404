...
# source: frogml._proto.qwak.deployment/deployment_service.proto
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_DEPLOYMODELREQUEST_ENVIRONMENTTODEPLOYMENTENTRY']._options = None
  _globals['_DEPLOYMODELREQUEST_ENVIRONMENTTODEPLOYMENTENTRY']._serialized_options = b'8\001'
  _globals['_DEPLOYMODELREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_DEPLOYMODELREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_DEPLOYMODELREQUEST'].fields_by_name['build_id']._options = None
  _globals['_DEPLOYMODELREQUEST'].fields_by_name['build_id']._serialized_options = b'\030\001'
  _globals['_DEPLOYMODELREQUEST'].fields_by_name['hosting_service']._options = None
  _globals['_DEPLOYMODELREQUEST'].fields_by_name['hosting_service']._serialized_options = b'\030\001'
  _globals['_DEPLOYMODELRESPONSE_ENVIRONMENTTODEPLOYMENTRESULTENTRY']._options = None
  _globals['_DEPLOYMODELRESPONSE_ENVIRONMENTTODEPLOYMENTRESULTENTRY']._serialized_options = b'8\001'
  _globals['_DEPLOYMODELRESPONSE'].fields_by_name['deployment_named_id']._options = None
  _globals['_DEPLOYMODELRESPONSE'].fields_by_name['deployment_named_id']._serialized_options = b'\030\001'
  _globals['_DEPLOYMODELRESPONSE'].fields_by_name['status']._options = None
  _globals['_DEPLOYMODELRESPONSE'].fields_by_name['status']._serialized_options = b'\030\001'
  _globals['_DEPLOYMODELRESPONSE'].fields_by_name['info']._options = None
  _globals['_DEPLOYMODELRESPONSE'].fields_by_name['info']._serialized_options = b'\030\001'
  _globals['_UNDEPLOYMODELREQUEST_ENVIRONMENTTOUNDEPLOYMENTENTRY']._options = None
  _globals['_UNDEPLOYMODELREQUEST_ENVIRONMENTTOUNDEPLOYMENTENTRY']._serialized_options = b'8\001'
  _globals['_UNDEPLOYMODELREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_UNDEPLOYMODELREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_UNDEPLOYMODELREQUEST'].fields_by_name['hosting_service_type']._options = None
  _globals['_UNDEPLOYMODELREQUEST'].fields_by_name['hosting_service_type']._serialized_options = b'\030\001'
  _globals['_UNDEPLOYMODELREQUEST'].fields_by_name['traffic_config']._options = None
  _globals['_UNDEPLOYMODELREQUEST'].fields_by_name['traffic_config']._serialized_options = b'\030\001'
  _globals['_UNDEPLOYMODELREQUEST'].fields_by_name['variation_name']._options = None
  _globals['_UNDEPLOYMODELREQUEST'].fields_by_name['variation_name']._serialized_options = b'\030\001'
  _globals['_UNDEPLOYMODELRESPONSE_ENVIRONMENTTOUNDEPLOYMENTRESULTENTRY']._options = None
  _globals['_UNDEPLOYMODELRESPONSE_ENVIRONMENTTOUNDEPLOYMENTRESULTENTRY']._serialized_options = b'8\001'
  _globals['_UNDEPLOYMODELRESPONSE'].fields_by_name['status']._options = None
  _globals['_UNDEPLOYMODELRESPONSE'].fields_by_name['status']._serialized_options = b'\030\001'
  _globals['_UNDEPLOYMODELRESPONSE'].fields_by_name['info']._options = None
  _globals['_UNDEPLOYMODELRESPONSE'].fields_by_name['info']._serialized_options = b'\030\001'
  _globals['_GETDEPLOYMENTSTATUSREQUEST'].fields_by_name['hosting_service_type']._options = None
  _globals['_GETDEPLOYMENTSTATUSREQUEST'].fields_by_name['hosting_service_type']._serialized_options = b'\030\001'
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSREQUEST_ENVIRONMENTTORUNTIMEDEPLOYMENTSETTINGSENTRY']._options = None
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSREQUEST_ENVIRONMENTTORUNTIMEDEPLOYMENTSETTINGSENTRY']._serialized_options = b'8\001'
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSREQUEST'].fields_by_name['deployment_settings']._options = None
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSREQUEST'].fields_by_name['deployment_settings']._serialized_options = b'\030\001'
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSREQUEST'].fields_by_name['variation_name']._options = None
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSREQUEST'].fields_by_name['variation_name']._serialized_options = b'\030\001'
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSRESPONSE_ENVIRONMENTTORUNTIMEDEPLOYMENTSETTINGSRESPONSEENTRY']._options = None
  _globals['_UPDATEDEPLOYMENTRUNTIMESETTINGSRESPONSE_ENVIRONMENTTORUNTIMEDEPLOYMENTSETTINGSRESPONSEENTRY']._serialized_options = b'8\001'
  _globals['_GETDEPLOYMENTDETAILSREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_GETDEPLOYMENTDETAILSREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_GETDEPLOYMENTDETAILSRESPONSE_ENVIRONMENTTODEPLOYMENTDETAILSENTRY']._options = None
  _globals['_GETDEPLOYMENTDETAILSRESPONSE_ENVIRONMENTTODEPLOYMENTDETAILSENTRY']._serialized_options = b'8\001'
  _globals['_GETDEPLOYMENTDETAILSRESPONSE_BUILDTOENVIRONMENTDEPLOYMENTSTATUSENTRY']._options = None
  _globals['_GETDEPLOYMENTDETAILSRESPONSE_BUILDTOENVIRONMENTDEPLOYMENTSTATUSENTRY']._serialized_options = b'8\001'
  _globals['_GETDEPLOYMENTDETAILSRESPONSE'].fields_by_name['current_deployment_details']._options = None
  _globals['_GETDEPLOYMENTDETAILSRESPONSE'].fields_by_name['current_deployment_details']._serialized_options = b'\030\001'
  _globals['_GETDEPLOYMENTDETAILSRESPONSE'].fields_by_name['last_deployment_brief']._options = None
  _globals['_GETDEPLOYMENTDETAILSRESPONSE'].fields_by_name['last_deployment_brief']._serialized_options = b'\030\001'
  _globals['_GETDEPLOYMENTDETAILSRESPONSE'].fields_by_name['current_deployments_details']._options = None
  _globals['_GETDEPLOYMENTDETAILSRESPONSE'].fields_by_name['current_deployments_details']._serialized_options = b'\030\001'
  _globals['_GETDEPLOYMENTDETAILSRESPONSE'].fields_by_name['multi_env_support']._options = None
  _globals['_GETDEPLOYMENTDETAILSRESPONSE'].fields_by_name['multi_env_support']._serialized_options = b'\030\001'
  _globals['_GETDEPLOYMENTHISTORYREQUEST'].fields_by_name['branch_id']._options = None
  _globals['_GETDEPLOYMENTHISTORYREQUEST'].fields_by_name['branch_id']._serialized_options = b'\030\001'
  _globals['_GETDEPLOYMENTHISTORYRESPONSE_ENVIRONMENTTODEPLOYMENTHISTORYENTRY']._options = None
  _globals['_GETDEPLOYMENTHISTORYRESPONSE_ENVIRONMENTTODEPLOYMENTHISTORYENTRY']._serialized_options = b'8\001'
  _globals['_GETDEPLOYMENTHISTORYRESPONSE'].fields_by_name['environment_to_deployment_history']._options = None
  _globals['_GETDEPLOYMENTHISTORYRESPONSE'].fields_by_name['environment_to_deployment_history']._serialized_options = b'\030\001'
  _globals['_APPLYMODELTRAFFICRESPONSE_ENVIRONMENTTOAPPLYMODELTRAFFICRESPONSEENTRY']._options = None
  _globals['_APPLYMODELTRAFFICRESPONSE_ENVIRONMENTTOAPPLYMODELTRAFFICRESPONSEENTRY']._serialized_options = b'8\001'
  _globals['_GETMODELTRAFFICRESPONSE_ENVIRONMENTTOMODELTRAFFICENTRY']._options = None
  _globals['_GETMODELTRAFFICRESPONSE_ENVIRONMENTTOMODELTRAFFICENTRY']._serialized_options = b'8\001'
  _globals['_GETMODELTRAFFICRESPONSE'].fields_by_name['variations']._options = None
  _globals['_GETMODELTRAFFICRESPONSE'].fields_by_name['variations']._serialized_options = b'\030\001'
  _globals['_GETMODELTRAFFICRESPONSE'].fields_by_name['multi_env_support']._options = None
  _globals['_GETMODELTRAFFICRESPONSE'].fields_by_name['multi_env_support']._serialized_options = b'\030\001'
  _globals['_CANCELDEPLOYMENTSRESPONSE_CANCELREQUESTSTATUSENTRY']._options = None
  _globals['_CANCELDEPLOYMENTSRESPONSE_CANCELREQUESTSTATUSENTRY']._serialized_options = b'8\001'
  _globals['_DEPLOYMENTMANAGEMENTSERVICE'].methods_by_name['ApplyModelTraffic']._options = None
  _globals['_DEPLOYMENTMANAGEMENTSERVICE'].methods_by_name['ApplyModelTraffic']._serialized_options = b'\210\002\001'
  _globals['_DEPLOYMENTMANAGEMENTSERVICE'].methods_by_name['GetModelTraffic']._options = None
  _globals['_DEPLOYMENTMANAGEMENTSERVICE'].methods_by_name['GetModelTraffic']._serialized_options = b'\210\002\001'
