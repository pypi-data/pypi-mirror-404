...
class _ModelDeploymentStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ModelDeploymentStatus.ValueType], builtins.type):
...
class _DeploymentHostingServiceTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeploymentHostingServiceType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _KubeDeploymentTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_KubeDeploymentType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _DeploymentManagedByEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeploymentManagedBy.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _DeploymentFailureReasonCodeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeploymentFailureReasonCode.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _ModelPodPhaseEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ModelPodPhase.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _DeploymentPhaseTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeploymentPhaseType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _DeploymentPhaseStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeploymentPhaseStatus.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class HostingService(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["kube_deployment", b"kube_deployment", "sagemaker", b"sagemaker", "val", b"val"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["kube_deployment", b"kube_deployment", "sagemaker", b"sagemaker", "val", b"val"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["val", b"val"]) -> typing.Literal["sagemaker", "kube_deployment"] | None: ...
...
class KubeDeployment(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["advanced_deployment_options", b"advanced_deployment_options", "deployment_size", b"deployment_size", "serving_strategy", b"serving_strategy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["advanced_deployment_options", b"advanced_deployment_options", "deployment_size", b"deployment_size", "environment_variables", b"environment_variables", "kube_deployment_type", b"kube_deployment_type", "pod_count", b"pod_count", "serving_strategy", b"serving_strategy"]) -> None: ...
...
class ServingStrategy(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["Strategy", b"Strategy", "batch_config", b"batch_config", "realtime_config", b"realtime_config", "stream_config", b"stream_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["Strategy", b"Strategy", "batch_config", b"batch_config", "realtime_config", b"realtime_config", "stream_config", b"stream_config"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["Strategy", b"Strategy"]) -> typing.Literal["realtime_config", "stream_config", "batch_config"] | None: ...
...
class RealTimeConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["auto_scaling_config", b"auto_scaling_config", "traffic_config", b"traffic_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["auto_scaling_config", b"auto_scaling_config", "traffic_config", b"traffic_config"]) -> None: ...
...
class TrafficConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["audience_routes_entries", b"audience_routes_entries", "fallback_variation", b"fallback_variation", "selected_variation_name", b"selected_variation_name", "selected_variation_protect_state", b"selected_variation_protect_state", "variations", b"variations"]) -> None: ...
...
class StreamConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["kafka", b"kafka"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["kafka", b"kafka"]) -> None: ...
...
class KafkaConfig(google.protobuf.message.Message):
    ...
    class Consumer(google.protobuf.message.Message):
        ...
        class _AutoOffSetTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[KafkaConfig.Consumer._AutoOffSetType.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        ...
        def ClearField(self, field_name: typing.Literal["auto_offset_type", b"auto_offset_type", "bootstrap_server", b"bootstrap_server", "group", b"group", "max_batch_size", b"max_batch_size", "max_poll_latency", b"max_poll_latency", "timeout", b"timeout", "topic", b"topic"]) -> None: ...
    ...
    class Producer(google.protobuf.message.Message):
        ...
        class _CompressionTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[KafkaConfig.Producer._CompressionType.ValueType], builtins.type):
            DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        ...
        def ClearField(self, field_name: typing.Literal["bootstrap_server", b"bootstrap_server", "compression_type", b"compression_type", "topic", b"topic"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["consumer", b"consumer", "producer", b"producer"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["consumer", b"consumer", "producer", b"producer", "workers", b"workers"]) -> None: ...
...
class SageMaker(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["instance_count", b"instance_count", "instance_type", b"instance_type"]) -> None: ...
...
class AdvancedDeploymentOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["daemon_mode", b"daemon_mode"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["custom_iam_role_arn", b"custom_iam_role_arn", "daemon_mode", b"daemon_mode", "deployment_process_timeout_limit", b"deployment_process_timeout_limit", "http_request_timeout_ms", b"http_request_timeout_ms", "max_batch_size", b"max_batch_size", "number_of_http_server_workers", b"number_of_http_server_workers", "purchase_option", b"purchase_option", "service_account_key_secret_name", b"service_account_key_secret_name"]) -> None: ...
...
class DeploymentDetails(google.protobuf.message.Message):
    ...
    max_batch_size: builtins.int
    """Max batch size"""
    gpu_type: frogml._proto.qwak.user_application.common.v0.resources_pb2.GpuType.ValueType
    """The type of the GPU"""
    gpu_amount: builtins.int
    """Amount of GPUs"""
...
class RuntimeDeploymentSettings(google.protobuf.message.Message):
    ...
    class _LogLevelEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[RuntimeDeploymentSettings._LogLevel.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def ClearField(self, field_name: typing.Literal["root_logger_level", b"root_logger_level"]) -> None: ...
...
class DeploymentBrief(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["build_id", b"build_id", "deployment_timestamp", b"deployment_timestamp", "image_identifier", b"image_identifier", "qwak_model_registry_identifier", b"qwak_model_registry_identifier"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["build_id", b"build_id", "deployed_by", b"deployed_by", "deployment_id", b"deployment_id", "deployment_timestamp", b"deployment_timestamp", "environment_id", b"environment_id", "failure_message", b"failure_message", "failure_reason_code", b"failure_reason_code", "image_identifier", b"image_identifier", "qwak_model_registry_identifier", b"qwak_model_registry_identifier", "status", b"status", "technical_details", b"technical_details", "variation_name", b"variation_name", "variation_protect_state", b"variation_protect_state"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["image_identifier", b"image_identifier"]) -> typing.Literal["build_id", "qwak_model_registry_identifier"] | None: ...
...
class KubernetesModelDeploymentState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["status_details", b"status_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["branch_id", b"branch_id", "deployment_id", b"deployment_id", "managed_by", b"managed_by", "model_id", b"model_id", "model_uuid", b"model_uuid", "status", b"status", "status_details", b"status_details", "variation_name", b"variation_name"]) -> None: ...
...
class StatusDetails(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["failed_status_details", b"failed_status_details", "pending_status_details", b"pending_status_details", "status_details", b"status_details", "success_status_details", b"success_status_details"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["failed_status_details", b"failed_status_details", "pending_status_details", b"pending_status_details", "status_details", b"status_details", "success_status_details", b"success_status_details"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["status_details", b"status_details"]) -> typing.Literal["pending_status_details", "success_status_details", "failed_status_details"] | None: ...
...
class PendingStatusDetails(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["new_instance", b"new_instance", "old_instance", b"old_instance"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["new_instance", b"new_instance", "old_instance", b"old_instance"]) -> None: ...
...
class SuccessfulStatusDetails(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["running_instance", b"running_instance"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["running_instance", b"running_instance"]) -> None: ...
...
class FailedStatusDetails(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["failed_instance", b"failed_instance", "failure_details", b"failure_details", "old_instance", b"old_instance"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["failed_instance", b"failed_instance", "failure_details", b"failure_details", "old_instance", b"old_instance"]) -> None: ...
...
class FailureDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["deployment_failure_reason_code", b"deployment_failure_reason_code", "failure_reason_details", b"failure_reason_details"]) -> None: ...
...
class InstanceDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["available_replicas", b"available_replicas", "build_id", b"build_id", "deployment_id", b"deployment_id", "pods", b"pods"]) -> None: ...
...
class DeploymentPhasesDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["deployment_phases", b"deployment_phases"]) -> None: ...
...
class DeploymentPhase(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["last_modified_at", b"last_modified_at", "started_at", b"started_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["deployment_phase_status", b"deployment_phase_status", "deployment_phase_type", b"deployment_phase_type", "display_message", b"display_message", "last_modified_at", b"last_modified_at", "phase_duration_in_seconds", b"phase_duration_in_seconds", "started_at", b"started_at"]) -> None: ...
...
class Variation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["spec", b"spec", "traffic", b"traffic"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["environment_id", b"environment_id", "name", b"name", "protected", b"protected", "spec", b"spec", "traffic", b"traffic"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["spec", b"spec"]) -> typing.Literal["traffic"] | None: ...
...
class TrafficSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["is_shadow", b"is_shadow", "percentage", b"percentage"]) -> None: ...
...
class FutureDeploymentSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["traffic_config", b"traffic_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["traffic_config", b"traffic_config"]) -> None: ...
...
class EnvironmentDeploymentMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["build_id", b"build_id", "hosting_service", b"hosting_service", "image_identifier", b"image_identifier", "qwak_model_registry_identifier", b"qwak_model_registry_identifier"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["branch_id", b"branch_id", "build_id", b"build_id", "hosting_service", b"hosting_service", "image_identifier", b"image_identifier", "model_id", b"model_id", "model_uuid", b"model_uuid", "qwak_model_registry_identifier", b"qwak_model_registry_identifier"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["image_identifier", b"image_identifier"]) -> typing.Literal["build_id", "qwak_model_registry_identifier"] | None: ...
...
class EnvironmentDeploymentResultMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["deployment_named_id", b"deployment_named_id", "info", b"info", "status", b"status"]) -> None: ...
...
class EnvironmentUndeploymentMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["traffic_config", b"traffic_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["branch_id", b"branch_id", "hosting_service_type", b"hosting_service_type", "model_id", b"model_id", "model_uuid", b"model_uuid", "traffic_config", b"traffic_config", "variation_name", b"variation_name"]) -> None: ...
...
class EnvironmentRuntimeDeploymentSettingsMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["branch_id", b"branch_id", "deployment_settings", b"deployment_settings", "model_id", b"model_id", "model_uuid", b"model_uuid", "variation_name", b"variation_name"]) -> None: ...
...
class EnvironmentRuntimeDeploymentSettingsResultMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error_info", b"error_info"]) -> None: ...
...
class EnvironmentDeploymentDetailsMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["audiences_routes", b"audiences_routes", "deployments_details", b"deployments_details", "fallback_variation", b"fallback_variation"]) -> None: ...
...
class EnvironmentTrafficMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["variations", b"variations"]) -> None: ...
...
class BuildDeploymentEnvironmentStatus(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["environment_to_deployment_brief", b"environment_to_deployment_brief"]) -> None: ...
...
class BuildDeploymentStatus(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["build_uuid", b"build_uuid", "is_deployed", b"is_deployed", "is_in_use", b"is_in_use"]) -> None: ...
...
class CancelDeploymentRequestStatus(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["cancel_requested_successfully", b"cancel_requested_successfully", "error_message", b"error_message"]) -> None: ...
