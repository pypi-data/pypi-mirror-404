...
class AWSAuthMethod(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["auth_type", b"auth_type", "aws_security_token_service", b"aws_security_token_service"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["auth_type", b"auth_type", "aws_security_token_service", b"aws_security_token_service"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["auth_type", b"auth_type"]) -> typing.Literal["aws_security_token_service"] | None: ...
...
class AWSSecurityTokenService(google.protobuf.message.Message):
    ...
    @property
    def secret_key_ref(self) -> frogml._proto.qwak.administration.runtime_configuration.v0.creds.secret_pb2.SecretKeyRef: ...
    def __init__(
        self,
        *,
        secret_key_ref: frogml._proto.qwak.administration.runtime_configuration.v0.creds.secret_pb2.SecretKeyRef | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["location", b"location", "secret_key_ref", b"secret_key_ref"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["location", b"location", "secret_key_ref", b"secret_key_ref"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["location", b"location"]) -> typing.Literal["secret_key_ref"] | None: ...
...
class AWSScopedPermissions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["scope_type", b"scope_type", "workload_scope", b"workload_scope"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["scope_type", b"scope_type", "workload_scope", b"workload_scope"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["scope_type", b"scope_type"]) -> typing.Literal["workload_scope"] | None: ...
...
class AWSWorkloadPermissionScope(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["analytics_scope", b"analytics_scope", "batch_inference_job_scope", b"batch_inference_job_scope", "feature_store_scope", b"feature_store_scope", "remote_build_job_scope", b"remote_build_job_scope"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["analytics_scope", b"analytics_scope", "batch_inference_job_scope", b"batch_inference_job_scope", "feature_store_scope", b"feature_store_scope", "remote_build_job_scope", b"remote_build_job_scope"]) -> None: ...
...
class AnalyticsPermissionScope(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["auth_method", b"auth_method"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["auth_method", b"auth_method"]) -> None: ...
