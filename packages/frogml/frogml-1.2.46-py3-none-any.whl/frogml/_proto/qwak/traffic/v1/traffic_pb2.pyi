...
class MultipleHttpTraffic(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["http_traffics", b"http_traffics"]) -> None: ...
...
class HttpTraffic(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["http_traffic", b"http_traffic", "route_match", b"route_match"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["group_id", b"group_id", "http_traffic", b"http_traffic", "id", b"id", "order", b"order", "route_match", b"route_match"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["http_traffic", b"http_traffic"]) -> typing.Literal["route_match"] | None: ...
...
class RouteMatch(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["matches", b"matches", "path", b"path", "routes", b"routes"]) -> None: ...
...
class Match(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["header_match", b"header_match", "rule", b"rule"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["header_match", b"header_match", "rule", b"rule"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["rule", b"rule"]) -> typing.Literal["header_match"] | None: ...
...
class HeaderMatch(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["condition", b"condition", "invert", b"invert", "key", b"key"]) -> None: ...
...
class HeaderCondition(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["binary_condition", b"binary_condition", "condition", b"condition", "unary_condition", b"unary_condition"]) -> None: ...
...
class Route(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["endpoint", b"endpoint", "request_timeout_ms", b"request_timeout_ms", "shadow", b"shadow", "variation", b"variation", "weight", b"weight"]) -> None: ...
