...
class ValidationSuccessResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["column_description", b"column_description", "pandas_column_description", b"pandas_column_description", "sample", b"sample", "spark_column_description", b"spark_column_description"]) -> None: ...
...
class ValidationFailureResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "error_message", b"error_message", "phase", b"phase"]) -> None: ...
