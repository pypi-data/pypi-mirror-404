...
class _MetricOperatorTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_MetricOperatorType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _ParameterOperatorTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ParameterOperatorType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class Audit(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["created_at", b"created_at", "created_by", b"created_by", "last_modified_at", b"last_modified_at", "last_modified_by", b"last_modified_by"]) -> None: ...
...
class DockerBuild(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["assumed_iam_role_arn", b"assumed_iam_role_arn", "base_image", b"base_image", "build_args", b"build_args", "cache", b"cache", "env_vars", b"env_vars", "no_cache", b"no_cache", "params", b"params", "push", b"push", "service_account_key_secret_name", b"service_account_key_secret_name"]) -> None: ...
...
class BuildFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["build_ids", b"build_ids", "include_extra_tags", b"include_extra_tags", "metric_filters", b"metric_filters", "model_version_ids", b"model_version_ids", "parameter_filters", b"parameter_filters", "require_all_tags", b"require_all_tags", "tags", b"tags"]) -> None: ...
...
class MetricFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["metric_name", b"metric_name", "metric_value", b"metric_value", "operator", b"operator"]) -> None: ...
...
class ParameterFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["operator", b"operator", "parameter_name", b"parameter_name", "parameter_value", b"parameter_value"]) -> None: ...
...
class FrameworkModelsSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["build_id", b"build_id", "framework_models", b"framework_models"]) -> None: ...
...
class FrameworkModel(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["huggingface_model_spec", b"huggingface_model_spec", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["huggingface_model_spec", b"huggingface_model_spec", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["huggingface_model_spec"] | None: ...
...
class HuggingFaceModelSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["model_name", b"model_name", "repository", b"repository", "sha1", b"sha1", "version", b"version"]) -> None: ...
...
class ScanResultSummary(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["issues", b"issues", "ui_direct_link", b"ui_direct_link", "ui_scan_direct_link", b"ui_scan_direct_link"]) -> None: ...
...
class Issue(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "issue_type", b"issue_type", "name", b"name", "severity", b"severity", "summary", b"summary"]) -> None: ...
...
class BuildImageDetails(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["image_full_path", b"image_full_path", "image_pull_secret_name", b"image_pull_secret_name"]) -> None: ...
...
class ScanRequestType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["scan_feature_state_request", b"scan_feature_state_request", "scan_malicious_packages_request", b"scan_malicious_packages_request", "scan_policy_violations_request", b"scan_policy_violations_request", "scan_software_components_request", b"scan_software_components_request", "scan_status_request", b"scan_status_request", "scan_vulnerabilities_request", b"scan_vulnerabilities_request", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["scan_feature_state_request", b"scan_feature_state_request", "scan_malicious_packages_request", b"scan_malicious_packages_request", "scan_policy_violations_request", b"scan_policy_violations_request", "scan_software_components_request", b"scan_software_components_request", "scan_status_request", b"scan_status_request", "scan_vulnerabilities_request", b"scan_vulnerabilities_request", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["type", b"type"]) -> typing.Literal["scan_software_components_request", "scan_vulnerabilities_request", "scan_malicious_packages_request", "scan_policy_violations_request", "scan_status_request", "scan_feature_state_request"] | None: ...
...
class ScanFeatureStateRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["feature_name", b"feature_name"]) -> None: ...
