...
from frogml.sdk.model_version.model_loggers.scikit_learn_model_version_manager import (
    ScikitLearnModelVersionManager,
)
...
def log_model(
    ...
    *,
    ...
    model_version_manager = ScikitLearnModelVersionManager()
...
def load_model(repository: str, model_name: str, version: str):
    ...
    _validate_load_model(
        ...
        model_framework=ModelFramework.SCIKIT_LEARN,
    )
