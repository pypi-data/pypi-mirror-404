...
JF_ACCESS_TOKEN_RELOAD_INTERVAL_SECONDS = (
    "JF_ACCESS_TOKEN_RELOAD_INTERVAL_SECONDS"  # nosec B105
)

JF_USE_SHORT_TOKEN_ROTATION = "JF_USE_SHORT_TOKEN_ROTATION"  # nosec B105
JF_USE_SHORT_TOKEN_ROTATION_DEFAULT: bool = False
JF_SHORT_TOKEN_ROTATION_INTERVAL_SECONDS = (
    "JF_SHORT_TOKEN_ROTATION_INTERVAL_SECONDS"  # nosec B105
)
JF_SHORT_TOKEN_ROTATION_INTERVAL_SECONDS_DEFAULT: int = 1500

JF_SHORT_TOKEN_ROTATION_GENERATION_TIMEOUT_SECONDS = (
    "JF_SHORT_TOKEN_ROTATION_GENERATION_TIMEOUT_SECONDS"  # nosec B105
)
JF_SHORT_TOKEN_ROTATION_GENERATION_TIMEOUT_SECONDS_DEFAULT: int = 20
JF_SHORT_TOKEN_ROTATION_GRACE_PERIOD_SECONDS = (
    "JF_SHORT_TOKEN_ROTATION_GRACE_PERIOD_SECONDS"  # nosec B105
)
JF_SHORT_TOKEN_ROTATION_GRACE_PERIOD_SECONDS_DEFAULT: int = 1500
