...
class JrmConfig:
    ...
    def from_env(cls, prefix: str = "JRM_") -> "JrmConfig":
        ...
        Env contract (all optional; any one path must provide at least one DB):
          ...
          - Selector / tuning:
              {P}DB_DEFAULT, {P}CONNECT_TIMEOUT, {P}DATA_FETCH_LIMIT, {P}MIN_CONN_POOL_SIZE,
              {P}MAX_CONN_POOL_SIZE, {P}MAX_CACHED_CONN, {P}_POOL_TIMEOUT
        ...
        return cls(
            ...
            connect_timeout=_i("CONNECT_TIMEOUT", 40),
