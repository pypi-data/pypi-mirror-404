...
area_shape_1 = eg.ShapeArea(196.6)
...
strDimension = (
    "FERRAILLAGE 1D - CS21 - 300x500 - Ai=196.6 As=0 - Nx = +388KN - Mz = +121.00KN"
)
strMaterial = "concrete: B450C steel: C35/45 gammas: 1.15 gammac: 1.5"

# tensionPoints = [[+0,+58.49]]
tensionPoints = [[388, (123.00 + 119) / 2]]
...
ep.interactionDomainBasePlot2d(
    ...
    export="test_benchmark_CS21_no2.png",
    dpi=300,
)
