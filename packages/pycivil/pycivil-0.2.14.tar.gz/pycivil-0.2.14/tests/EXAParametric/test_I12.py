...
def test_box_004(tmp_path: Path) -> None:
    ...
    title = "CENTROPADANA - tombino sottostrada - manufatto I.12"
    box = param.BoxTubeShape01(
        descr=title, B=2000 + 300, H=1500 + 300, Tw=300, Tt=300, Tb=300
    )
    ...
    box.setTopCover(8300.0 - 600.0 + 150)
