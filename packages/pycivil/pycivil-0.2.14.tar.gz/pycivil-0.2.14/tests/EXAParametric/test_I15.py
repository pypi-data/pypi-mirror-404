...
def test_box_005(tmp_path: Path) -> None:
    ...
    title = "CENTROPADANA - tombino sottostrada - manufatto I.15"
    box = param.BoxTubeShape01(
        descr=title, B=2500 + 300, H=2000 + 300, Tw=300, Tt=300, Tb=300
    )
    ...
    box.setTopCover(5000.0 - 600.0 + 150.0)
