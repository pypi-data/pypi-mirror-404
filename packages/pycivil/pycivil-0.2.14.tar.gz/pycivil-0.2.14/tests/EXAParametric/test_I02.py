...
def test_box_001(tmp_path: Path) -> None:
    ...
    title = "CENTROPADANA - tombino sottostrada - manufatto I.02"
    box = param.BoxTubeShape01(
        descr=title, B=3000 + 300, H=3000 + 300, Tw=300, Tt=300, Tb=300
    )
    ...
    box.setTopCover(7000.0 - 600.0 + 150.0)
