...
def test_tube_002(tmp_path: Path) -> None:
    ...
    title = "CENTROPADANA - tombino sottostrada - manufatto I.61 - DN 800"
    circle = param.CircularTubeShape01(
        descr=title, B=800 + 200 + 200, H=800 + 100 + 200 + 200, Tw=200, Tt=200, Tb=200
    )
    ...
    circle.setTopCover(5500.0 - 600.0 + 100)
