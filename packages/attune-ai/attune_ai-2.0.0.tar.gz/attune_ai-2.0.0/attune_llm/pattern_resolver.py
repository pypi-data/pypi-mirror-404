...
class PatternResolver:
    ...
    def regenerate_summary(self) -> bool:
        ...
        """
        try:
            from attune_llm.pattern_summary import PatternSummaryGenerator
...
Examples:
  ...
  python -m attune_llm.pattern_resolver

  # Resolve a specific bug
  python -m attune_llm.pattern_resolver bug_20251212_3c5b9951 \\
      --root-cause "Missing null check" \\
      --fix "Added optional chaining" \\
      --fix-code "data?.items ?? []" \\
      --time 15
