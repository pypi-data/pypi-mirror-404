...
Connect Attune AI to Claude Desktop or any MCP-compatible client using the Socratic workflow builder.

---

## What is MCP?

The [Model Context Protocol (MCP)](https://modelcontextprotocol.io) is an open standard for connecting AI applications to external tools and data sources. Attune AI exposes its Socratic workflow builder as MCP tools.
