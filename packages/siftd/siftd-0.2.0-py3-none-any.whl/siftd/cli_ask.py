...
examples:
  ...
  siftd ask --chrono "chunking"                     # sort by time instead of score""",
    ...
    p_ask.add_argument("--since", metavar="DATE", help="Conversations started after this date (ISO format: YYYY-MM-DD)")
    p_ask.add_argument("--before", metavar="DATE", help="Conversations started before this date (ISO format: YYYY-MM-DD)")
