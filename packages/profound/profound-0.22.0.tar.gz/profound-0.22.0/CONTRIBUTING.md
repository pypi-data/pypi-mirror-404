...
modify the contents of the `src/profound/lib/` and `examples/` directories.
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/cooper-square-technologies/profound-python-sdk/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
