...
from v1 import adapter_engine_pb2 as v1_dot_adapter__engine__pb2
...
class AdapterEngineStub(object):
...
class AdapterEngineServicer(object):
    """Missing associated documentation comment in .proto file."""

    def DiscoverProviderResources(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_AdapterEngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'orchestration.v1.AdapterEngine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('orchestration.v1.AdapterEngine', rpc_method_handlers)
...
class AdapterEngine(object):
    ...
    @staticmethod
    def DiscoverProviderResources(request,
            target,
            options=(),
