#!/usr/bin/env python3
"""
souleyez.ui.terminal - Terminal configuration and input handling
"""
...
def init_readline():
    ...
    """
    # Set up history
    histfile = os.path.join(os.path.expanduser("~"), ".souleyez_history")
    try:
    ...
    try:
        ...
        fd = sys.stdin.fileno()
        # old_settings = termios.tcgetattr(fd)  # not used currently
