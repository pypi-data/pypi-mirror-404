...
EXTERNAL_TOOLS = {
    "prerequisites": {
        ...
        "chromium": {
            ...
            "install_ubuntu": "pipx install playwright && pipx run playwright install chromium && sudo ln -sf $HOME/.cache/ms-playwright/chromium-*/chrome-linux/chrome /usr/local/bin/chromium",
    ...
    "reconnaissance": {
        ...
        "theharvester": {
            ...
            "install_ubuntu": "pipx install --force git+https://github.com/laramies/theHarvester.git@4.4.4 && pipx inject theharvester netaddr aiomultiprocess aiosqlite pyppeteer uvloop certifi PyYAML censys aiohttp aiodns beautifulsoup4 requests shodan dnspython ujson lxml python-dateutil",
            "install_method": "kali_only",
    ...
    "windows_ad": {
        ...
        "gpp-decrypt": {
            ...
            "install_ubuntu": "sudo apt install -y python3-pycryptodome",
            "install_method": "kali_only",
