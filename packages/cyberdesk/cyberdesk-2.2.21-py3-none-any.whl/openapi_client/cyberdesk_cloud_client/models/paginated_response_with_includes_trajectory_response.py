...
T = TypeVar("T", bound="PaginatedResponseWithIncludesTrajectoryResponse")


@_attrs_define
class PaginatedResponseWithIncludesTrajectoryResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_response_with_includes_trajectory_response = cls(
            items=items,
            total=total,
            skip=skip,
            limit=limit,
        ...
        paginated_response_with_includes_trajectory_response.additional_properties = d
        return paginated_response_with_includes_trajectory_response
