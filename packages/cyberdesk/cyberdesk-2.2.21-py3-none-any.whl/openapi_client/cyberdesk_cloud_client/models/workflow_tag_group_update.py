...
T = TypeVar("T", bound="WorkflowTagGroupUpdate")


@_attrs_define
class WorkflowTagGroupUpdate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_tag_group_update.additional_properties = d
        return workflow_tag_group_update
