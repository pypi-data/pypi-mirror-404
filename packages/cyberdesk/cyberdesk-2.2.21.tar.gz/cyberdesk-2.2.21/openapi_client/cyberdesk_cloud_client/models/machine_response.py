...
class MachineResponse:
    ...
    Attributes:
        ...
        machine_parameters (MachineResponseMachineParametersType0 | None | Unset): Machine-specific input values that
            auto-populate runs
        machine_sensitive_parameters (MachineResponseMachineSensitiveParametersType0 | None | Unset): Machine-specific
        ...
        physical_server_id (None | str | Unset): Fly machine ID hosting the WebSocket connection
    ...
    machine_parameters: MachineResponseMachineParametersType0 | None | Unset = UNSET
    machine_sensitive_parameters: MachineResponseMachineSensitiveParametersType0 | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_machine_parameters(data: object) -> MachineResponseMachineParametersType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(MachineResponseMachineParametersType0 | None | Unset, data)

        machine_parameters = _parse_machine_parameters(d.pop("machine_parameters", UNSET))

        def _parse_machine_sensitive_parameters(
            data: object,
        ) -> MachineResponseMachineSensitiveParametersType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(MachineResponseMachineSensitiveParametersType0 | None | Unset, data)
