...
T = TypeVar("T", bound="PaginatedResponseWithIncludesMachineResponse")


@_attrs_define
class PaginatedResponseWithIncludesMachineResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = MachineResponse.from_dict(items_item_data)
        ...
        paginated_response_with_includes_machine_response = cls(
            items=items,
            total=total,
            skip=skip,
            limit=limit,
        ...
        paginated_response_with_includes_machine_response.additional_properties = d
        return paginated_response_with_includes_machine_response
