...
class RunCreate:
    ...
    Attributes:
        ...
        input_values (None | RunCreateInputValuesType0 | Unset): Input values for workflow variables
        file_inputs (list[FileInput] | None | Unset): Files to upload to the machine
        sensitive_input_values (None | RunCreateSensitiveInputValuesType0 | Unset): Sensitive input values (supports
            nested objects). These are not stored and will be written to a secure vault and referenced by alias only.
        session_id (None | Unset | UUID): Join an existing session; overrides machine_id/pool_ids
        start_session (bool | None | Unset): Start a new session on the machine used by this run. Session ID will be
            this run's ID. Default: False.
        session_alias (None | str | Unset): Persist outputs under this alias for $ref in this session
        release_session_after (bool | None | Unset): Release the session after this run completes successfully
    """

    workflow_id: UUID
    machine_id: None | Unset | UUID = UNSET
    pool_ids: list[UUID] | None | Unset = UNSET
    input_values: None | RunCreateInputValuesType0 | Unset = UNSET
    file_inputs: list[FileInput] | None | Unset = UNSET
    sensitive_input_values: None | RunCreateSensitiveInputValuesType0 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_input_values(data: object) -> None | RunCreateInputValuesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | RunCreateInputValuesType0 | Unset, data)
        ...
        def _parse_sensitive_input_values(data: object) -> None | RunCreateSensitiveInputValuesType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(None | RunCreateSensitiveInputValuesType0 | Unset, data)
