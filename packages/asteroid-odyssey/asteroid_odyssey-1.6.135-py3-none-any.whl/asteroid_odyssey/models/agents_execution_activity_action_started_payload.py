...
class AgentsExecutionActivityActionStartedPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["activityType", "message", "actionName", "actionId", "info"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentsExecutionActivityActionStartedPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentsExecutionActivityActionStartedPayload from a dict"""
        if obj is None:
            return None
