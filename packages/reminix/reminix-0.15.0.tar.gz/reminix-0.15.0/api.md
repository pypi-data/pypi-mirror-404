...
- <code title="get /memories/{key}">client.memories.<a href="./src/reminix/resources/memories.py">retrieve</a>(key) -> <a href="./src/reminix/types/memory.py">Memory</a></code>
- <code title="get /memories">client.memories.<a href="./src/reminix/resources/memories.py">list</a>() -> <a href="./src/reminix/types/memory_list_response.py">MemoryListResponse</a></code>
- <code title="delete /memories/{key}">client.memories.<a href="./src/reminix/resources/memories.py">delete</a>(key) -> None</code>
- <code title="delete /memories">client.memories.<a href="./src/reminix/resources/memories.py">delete_all</a>() -> <a href="./src/reminix/types/memory_delete_all_response.py">MemoryDeleteAllResponse</a></code>
- <code title="post /memories">client.memories.<a href="./src/reminix/resources/memories.py">store</a>(\*\*<a href="src/reminix/types/memory_store_params.py">params</a>) -> <a href="./src/reminix/types/memory.py">Memory</a></code>
