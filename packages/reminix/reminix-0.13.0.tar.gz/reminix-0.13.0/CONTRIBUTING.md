...
modify the contents of the `src/reminix/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/reminix-ai/reminix-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/reminix-ai/reminix-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
