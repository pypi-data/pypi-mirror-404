...
if __name__ == '__main__':
    logger.info("Starting mult_core tests>> ignore_errors = True")
    with tempfile.TemporaryDirectory() as td:
        ...
        Parallel.run_all_jobs(create_jobs, n_cores=12, threads=False, clear_db=False, retry_rate=3, subset='Yield', ignore_runtime_errors=True)
