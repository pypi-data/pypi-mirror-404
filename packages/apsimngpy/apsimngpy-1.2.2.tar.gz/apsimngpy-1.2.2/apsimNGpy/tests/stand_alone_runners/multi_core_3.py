...
if __name__ == '__main__':
    logger.info("Starting mult_core tests>> subset = None")
    with tempfile.TemporaryDirectory() as td:
        ...
        Parallel.run_all_jobs(create_jobs, n_cores=12, threads=False, clear_db=False, retry_rate=3, subset=None, ignore_runtime_errors=False)
