...
class vtkRemoteInteractionAdapter(vtkmodules.vtkCommonCore.vtkObject):
    device_pixel_ratio:'getset_descriptor'
    device_pixel_ratio_tolerance:'getset_descriptor'
    interactor:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetDevicePixelRatio(self) -> float: ...
    def GetDevicePixelRatioTolerance(self) -> float: ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkRemoteInteractionAdapter': ...
    @overload
    def ProcessEvent(self, event:str) -> bool: ...
    @overload
    @staticmethod
    def ProcessEvent(iren:'vtkRenderWindowInteractor', event:str, devicePixelRatio:float=1.0, devicePixelRatioTolerance:float=1e-5) -> bool: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkRemoteInteractionAdapter': ...
    def SetDevicePixelRatio(self, _arg:float) -> None: ...
    def SetDevicePixelRatioTolerance(self, _arg:float) -> None: ...
...
class vtkWebApplication(vtkmodules.vtkCommonCore.vtkObject):
    ...
    ENCODING_BASE64:int
    ENCODING_NONE:int
    image_compression:'getset_descriptor'
    image_encoding:'getset_descriptor'
    last_still_render_to_m_time:'getset_descriptor'
    number_of_encoder_threads:'getset_descriptor'
    object_id_map:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
