...
class vtkVPICReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    x_extent:'getset_descriptor'
    x_layout:'getset_descriptor'
    y_extent:'getset_descriptor'
    y_layout:'getset_descriptor'
    z_extent:'getset_descriptor'
    z_layout:'getset_descriptor'
