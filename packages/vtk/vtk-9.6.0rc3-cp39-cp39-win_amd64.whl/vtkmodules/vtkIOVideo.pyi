...
class vtkVideoSource(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    auto_advance:'getset_descriptor'
    clip_region:'getset_descriptor'
    data_origin:'getset_descriptor'
    data_spacing:'getset_descriptor'
    frame_buffer_size:'getset_descriptor'
    frame_count:'getset_descriptor'
    frame_index:'getset_descriptor'
    frame_rate:'getset_descriptor'
    frame_size:'getset_descriptor'
    frame_time_stamp:'getset_descriptor'
    initialized:'getset_descriptor'
    number_of_output_frames:'getset_descriptor'
    opacity:'getset_descriptor'
    output_format:'getset_descriptor'
    output_whole_extent:'getset_descriptor'
    playing:'getset_descriptor'
    recording:'getset_descriptor'
    start_time_stamp:'getset_descriptor'
