...
class vtkLODActor(vtkmodules.vtkRenderingCore.vtkActor):
    lod_mappers:'getset_descriptor'
    low_res_filter:'getset_descriptor'
    medium_res_filter:'getset_descriptor'
    number_of_cloud_points:'getset_descriptor'
...
class vtkQuadricLODActor(vtkmodules.vtkRenderingCore.vtkActor):
    ...
    collapse_dimension_ratio:'getset_descriptor'
    data_configuration:'getset_descriptor'
    defer_lod_construction:'getset_descriptor'
    lod_filter:'getset_descriptor'
    prop_type:'getset_descriptor'
