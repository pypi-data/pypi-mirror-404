...
class vtkXMLParser(vtkmodules.vtkCommonCore.vtkObject):
    encoding:'getset_descriptor'
    file_name:'getset_descriptor'
    ignore_character_data:'getset_descriptor'
...
class vtkXMLDataParser(vtkXMLParser):
    BigEndian:int
    LittleEndian:int
    abort:'getset_descriptor'
    appended_data_position:'getset_descriptor'
    attributes_encoding:'getset_descriptor'
    compressor:'getset_descriptor'
    progress:'getset_descriptor'
    root_element:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
