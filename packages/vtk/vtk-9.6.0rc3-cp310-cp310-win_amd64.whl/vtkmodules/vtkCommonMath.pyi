...
class vtkAmoebaMinimizer(vtkmodules.vtkCommonCore.vtkObject):
    contraction_ratio:'getset_descriptor'
    expansion_ratio:'getset_descriptor'
    function_evaluations:'getset_descriptor'
    function_value:'getset_descriptor'
    iterations:'getset_descriptor'
    max_iterations:'getset_descriptor'
    number_of_parameters:'getset_descriptor'
    parameter_tolerance:'getset_descriptor'
...
class vtkFunctionSet(vtkmodules.vtkCommonCore.vtkObject):
    number_of_functions:'getset_descriptor'
    number_of_independent_variables:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    @overload
...
class vtkMatrix3x3(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def SetData(self, data:Sequence[float]) -> None: ...
...
class vtkMatrix4x4(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def Determinant(elements:Sequence[float]) -> float: ...
    def GetData(self) -> Tuple[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]: ...
    def GetElement(self, i:int, j:int) -> float: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkPolynomialSolversUnivariate(vtkmodules.vtkCommonCore.vtkObject):
    division_tolerance:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    @staticmethod
...
class vtkQuaternionInterpolator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    number_of_quaternions:'getset_descriptor'
    search_method:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    @overload
