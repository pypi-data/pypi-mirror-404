...
class vtkSegYReader(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    force2d:'getset_descriptor'
    structured_grid:'getset_descriptor'
    vertical_crs:'getset_descriptor'
    x_coord_byte:'getset_descriptor'
    xy_coord_mode:'getset_descriptor'
    y_coord_byte:'getset_descriptor'
