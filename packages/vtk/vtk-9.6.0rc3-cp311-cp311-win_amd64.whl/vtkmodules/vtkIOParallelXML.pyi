...
class vtkXMLDataWriterHelper(vtkmodules.vtkIOXML.vtkXMLWriter):
    data_set_name:'getset_descriptor'
    data_set_version:'getset_descriptor'
...
class vtkXMLPDataObjectWriter(vtkmodules.vtkIOXML.vtkXMLWriter):
    ...
    use_subdirectory:'getset_descriptor'
    write_summary_file:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
...
class vtkXMLWriter2(vtkmodules.vtkIOXML.vtkXMLWriterBase):
    controller:'getset_descriptor'
    number_of_ghost_levels:'getset_descriptor'
    number_of_ghost_levels_max_value:'getset_descriptor'
    number_of_ghost_levels_min_value:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetController(self) -> 'vtkMultiProcessController': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
