...
class vtkAMRCutPlane(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    ...
    initial_request:'getset_descriptor'
    level_of_resolution:'getset_descriptor'
    normal:'getset_descriptor'
    use_native_cutter:'getset_descriptor'
...
class vtkAMRGaussianPulseSource(vtkmodules.vtkCommonExecutionModel.vtkOverlappingAMRAlgorithm):
    ...
    pulse_amplitude:'getset_descriptor'
    pulse_origin:'getset_descriptor'
    pulse_width:'getset_descriptor'
    refinement_ratio:'getset_descriptor'
    root_spacing:'getset_descriptor'
    x_pulse_origin:'getset_descriptor'
    x_pulse_width:'getset_descriptor'
    y_pulse_origin:'getset_descriptor'
    y_pulse_width:'getset_descriptor'
    z_pulse_origin:'getset_descriptor'
    z_pulse_width:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkAMRResampleFilter(vtkmodules.vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm):
    bias_vector:'getset_descriptor'
    controller:'getset_descriptor'
    demand_driven_mode:'getset_descriptor'
    max:'getset_descriptor'
    min:'getset_descriptor'
    number_of_partitions:'getset_descriptor'
    number_of_samples:'getset_descriptor'
    transfer_to_nodes:'getset_descriptor'
    use_bias_vector:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def FillInputPortInformation(self, port:int, info:'vtkInformation') -> int: ...
    def FillOutputPortInformation(self, port:int, info:'vtkInformation') -> int: ...
...
class vtkAMRSliceFilter(vtkmodules.vtkCommonExecutionModel.vtkOverlappingAMRAlgorithm):
    ...
    Z_NORMAL:'NormalTag'
    controller:'getset_descriptor'
    max_resolution:'getset_descriptor'
    normal:'getset_descriptor'
    offset_from_origin:'getset_descriptor'
    def __init__(self, **properties:Any) -> None: ...
    def FillInputPortInformation(self, port:int, info:'vtkInformation') -> int: ...
    def FillOutputPortInformation(self, port:int, info:'vtkInformation') -> int: ...
    def GetController(self) -> 'vtkMultiProcessController': ...
...
class vtkImageToAMR(vtkmodules.vtkCommonExecutionModel.vtkOverlappingAMRAlgorithm):
    maximum_number_of_blocks:'getset_descriptor'
    number_of_levels:'getset_descriptor'
