...
[Documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mpa/paginators/)
...
class ListApprovalTeamsPaginator(_ListApprovalTeamsPaginatorBase):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mpa/paginators/#listapprovalteamspaginator)
    """
...
class ListIdentitySourcesPaginator(_ListIdentitySourcesPaginatorBase):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mpa/paginators/#listidentitysourcespaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListPoliciesPaginator(_ListPoliciesPaginatorBase):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mpa/paginators/#listpoliciespaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListPolicyVersionsPaginator(_ListPolicyVersionsPaginatorBase):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mpa/paginators/#listpolicyversionspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListResourcePoliciesPaginator(_ListResourcePoliciesPaginatorBase):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mpa/paginators/#listresourcepoliciespaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListSessionsPaginator(_ListSessionsPaginatorBase):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_mpa/paginators/#listsessionspaginator)
    """
    def paginate(  # type: ignore[override]
