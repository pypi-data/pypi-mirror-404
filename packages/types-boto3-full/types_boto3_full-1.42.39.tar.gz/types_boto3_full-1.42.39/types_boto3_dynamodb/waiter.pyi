...
class ContributorInsightsEnabledWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dynamodb/waiters/#contributorinsightsenabledwaiter)
    """
...
class ExportCompletedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dynamodb/waiters/#exportcompletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class ImportCompletedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dynamodb/waiters/#importcompletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class KinesisStreamingDestinationActiveWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_dynamodb/waiters/#kinesisstreamingdestinationactivewaiter)
    """
    def wait(  # type: ignore[override]
