...
[Documentation](https://youtype.github.io/types_boto3_docs/types_boto3_repostspace/waiters/)
...
class ChannelCreatedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_repostspace/waiters/#channelcreatedwaiter)
    """
...
class ChannelDeletedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_repostspace/waiters/#channeldeletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class SpaceCreatedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_repostspace/waiters/#spacecreatedwaiter)
    """
    def wait(  # type: ignore[override]
...
class SpaceDeletedWaiter(Waiter):
    ...
    [Show types-boto3-full documentation](https://youtype.github.io/types_boto3_docs/types_boto3_repostspace/waiters/#spacedeletedwaiter)
    """
    def wait(  # type: ignore[override]
