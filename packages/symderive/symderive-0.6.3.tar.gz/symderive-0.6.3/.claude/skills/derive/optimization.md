# symderive: Optimization

## Overview
symderive provides symbolic and numerical optimization through a cvxpy-based interface for convex optimization and analytical methods for unconstrained problems.

```python
from symderive import *
from symderive.optimize import OptVar, Minimize, Maximize, Constraint
```
...
symderive supports standard convex functions:
