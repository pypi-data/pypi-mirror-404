# symderive: Symbolic Mathematics for Physics

symderive is a Python symbolic mathematics library built on SymPy with a Mathematica-style API, designed for theoretical physics and applied mathematics.
...
```python
from symderive import *                    # Main API
from symderive.diffgeo import *            # Differential geometry
from symderive.ode import DSolve, NDSolve  # ODE solvers
from symderive.optimize import *           # Optimization
from symderive.plotting import *           # Visualization
from symderive.calculus import *           # Advanced calculus
```
...
### General Relativity
```python
from symderive.diffgeo import schwarzschild_metric, Metric
