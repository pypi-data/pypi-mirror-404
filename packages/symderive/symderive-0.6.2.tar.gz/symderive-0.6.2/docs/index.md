# symderive Documentation

**symderive** is a Python library that provides intuitive symbolic mathematics capabilities for calculus, linear algebra, differential equations, tensor calculus, and more.
