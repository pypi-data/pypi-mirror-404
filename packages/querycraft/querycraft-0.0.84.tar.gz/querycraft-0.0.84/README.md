...
│ mode     ┆ on         │
└──────────┴────────────┘
Services reconnus : ollama, ollama_cloud, poe, openai et generic
...
- lms (LM Studio ; IA.service=lms IA.modele=mistralai/mistral-nemo-instruct-2407 IA.url=None IA.api-key = None ; pas de IA.url car l'API local est recherchée par l'application) 
