...
def get_user_data(
    ...
    commands=None,
    packages=None,
    rootfs_skel_dirs=None,
    storage=None,
    mime_multipart_archive=False,
    ssh_ca_keys=None,
    provision_users=None,
    **kwargs,
):
    """
    ...
    cloud_config_data["bootcmd"] = [
        # systemd interferes with aliases
    ...
    if ssh_ca_keys:
        ...
        cloud_config_data["runcmd"].append(
...
def upload_bootstrap_asset(cloud_config_data, rootfs_skel_dirs):
    ...
    cipher = subprocess.Popen(
        ["openssl", "aes-256-cbc", "-e", "-k", enc_key], stdin=subprocess.PIPE, stdout=subprocess.PIPE
    )
