...
def snapshot(args):
    return clients.rds.create_db_snapshot(
        DBInstanceIdentifier=args.instance_name, DBSnapshotIdentifier=args.snapshot_name, Tags=encode_tags(args.tags)
    )
...
def restore(args):
    ...
    clients.rds.restore_db_instance_from_db_snapshot(
        DBInstanceIdentifier=args.instance_name,
