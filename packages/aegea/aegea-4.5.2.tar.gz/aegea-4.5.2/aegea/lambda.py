...
parser_event_source_mappings = register_listing_parser(
    event_source_mappings, parent=lambda_parser, help="List event source mappings"
)
...
update_config_parser.add_argument(
    "--timeout", type=int, help="The amount of time that Lambda allows a function to run before stopping it"
)
update_config_parser.add_argument(
    "--memory-size", type=int, help="The amount of memory that your function has access to"
)
update_config_parser.add_argument(
    "--environment",
    nargs="+",
