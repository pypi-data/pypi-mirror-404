...
from kcwsqlite import __version__
confkcws={}
confkcws['name']='kcwsqlite'
confkcws['version']=__version__
confkcws['description']='kcwsqlite'
...
def get_file(folder='./',lists=[]):
    ...
    return lists
def start():
    b=get_file("kcwsqlite",['kcwsqlite'])
    setup(
        name = confkcws["name"],
        version = confkcws["version"],
        keywords = "kcwsqlite"+confkcws['version'],
