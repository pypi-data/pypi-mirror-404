...
class V0KeywordsStatisticsResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0KeywordsStatisticsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0KeywordsStatisticsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "keywords": [V0KeywordsStatistics.from_dict(_item) for _item in obj["keywords"]] if obj.get("keywords") is not None else None
        })
        return _obj
