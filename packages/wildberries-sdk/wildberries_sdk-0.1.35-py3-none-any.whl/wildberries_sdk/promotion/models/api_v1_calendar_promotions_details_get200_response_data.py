...
class ApiV1CalendarPromotionsDetailsGet200ResponseData(BaseModel):
    """
    Данные ответа
    """ # noqa: E501
    promotions: Optional[List[ApiV1CalendarPromotionsDetailsGet200ResponseDataPromotionsInner]] = Field(default=None, description="Список акций")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1CalendarPromotionsDetailsGet200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1CalendarPromotionsDetailsGet200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "promotions": [ApiV1CalendarPromotionsDetailsGet200ResponseDataPromotionsInner.from_dict(_item) for _item in obj["promotions"]] if obj.get("promotions") is not None else None
        })
        return _obj
