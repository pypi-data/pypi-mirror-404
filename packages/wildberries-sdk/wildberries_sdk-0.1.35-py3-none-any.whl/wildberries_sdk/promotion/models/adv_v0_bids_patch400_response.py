...
class AdvV0BidsPatch400Response(BaseModel):
    """
    ...
    request_id: Optional[StrictStr] = Field(default=None, description="Уникальный ID запроса")
    ...
    errors: Optional[List[AdvV0BidsPatch400ResponseErrorsInner]] = Field(default=None, description="Детализация ошибки")
    type: Optional[StrictStr] = Field(default=None, description="Тип ошибки")
    __properties: ClassVar[List[str]] = ["detail", "origin", "request_id", "status", "title", "errors", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0BidsPatch400Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0BidsPatch400Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "errors": [AdvV0BidsPatch400ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
            "type": obj.get("type")
        })
        return _obj
