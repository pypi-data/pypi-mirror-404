...
class GetAuctionAdverts(BaseModel):
    """
    GetAuctionAdverts
    """ # noqa: E501
    adverts: List[GetAuctionAdvertsAdvertsInner] = Field(description="Кампании")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAuctionAdverts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAuctionAdverts from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "adverts": [GetAuctionAdvertsAdvertsInner.from_dict(_item) for _item in obj["adverts"]] if obj.get("adverts") is not None else None
        })
        return _obj
