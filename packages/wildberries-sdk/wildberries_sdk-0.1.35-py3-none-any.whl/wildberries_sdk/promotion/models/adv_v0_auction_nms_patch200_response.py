...
class AdvV0AuctionNmsPatch200Response(BaseModel):
    """
    AdvV0AuctionNmsPatch200Response
    """ # noqa: E501
    nms: List[AdvV0AuctionNmsPatch200ResponseNmsInner] = Field(description="Результат отработки запроса")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0AuctionNmsPatch200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0AuctionNmsPatch200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nms": [AdvV0AuctionNmsPatch200ResponseNmsInner.from_dict(_item) for _item in obj["nms"]] if obj.get("nms") is not None else None
        })
        return _obj
