...
class AdvV0BidsPatch400ResponseErrorsInner(BaseModel):
    """
    AdvV0BidsPatch400ResponseErrorsInner
    """ # noqa: E501
    detail: Optional[StrictStr] = Field(default=None, description="Детали ошибки")
    var_field: Optional[StrictStr] = Field(default=None, description="Поле с ошибкой", alias="field")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0BidsPatch400ResponseErrorsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0BidsPatch400ResponseErrorsInner from a dict"""
        if obj is None:
            return None
