...
class AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner from a dict"""
        if obj is None:
            return None
