...
class AdvV1CountGet200Response(BaseModel):
    """
    ...
    adverts: Optional[AdvV1CountGet200ResponseAdverts] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "all": obj.get("all"),
            "adverts": AdvV1CountGet200ResponseAdverts.from_dict(obj["adverts"]) if obj.get("adverts") is not None else None
        })
        return _obj
