...
class V0KeywordsStatistics(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0KeywordsStatistics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0KeywordsStatistics from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "stats": [V0KeywordsStatistic.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
