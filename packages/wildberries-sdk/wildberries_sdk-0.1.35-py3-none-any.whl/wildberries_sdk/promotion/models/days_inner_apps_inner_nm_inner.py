...
class DaysInnerAppsInnerNmInner(BaseModel):
    """
    ...
    cr: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="CR(conversion rate) — отношение количества заказов к общему количеству посещений кампании ")
    ...
    nm_id: Optional[StrictInt] = Field(default=None, description="ID артикула WB", alias="nmId")
    __properties: ClassVar[List[str]] = ["views", "clicks", "ctr", "cpc", "sum", "atbs", "orders", "cr", "shks", "sum_price", "name", "nmId"]
