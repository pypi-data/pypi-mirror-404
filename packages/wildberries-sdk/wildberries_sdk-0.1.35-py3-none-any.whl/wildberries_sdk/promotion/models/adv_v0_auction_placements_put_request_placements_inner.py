...
class AdvV0AuctionPlacementsPutRequestPlacementsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0AuctionPlacementsPutRequestPlacementsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0AuctionPlacementsPutRequestPlacementsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "placements": AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements.from_dict(obj["placements"]) if obj.get("placements") is not None else None
        })
        return _obj
