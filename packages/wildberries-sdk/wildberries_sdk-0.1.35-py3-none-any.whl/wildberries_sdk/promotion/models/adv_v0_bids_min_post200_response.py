...
class AdvV0BidsMinPost200Response(BaseModel):
    """
    AdvV0BidsMinPost200Response
    """ # noqa: E501
    bids: List[AdvV0BidsMinPost200ResponseBidsInner] = Field(description="Список карточек товаров со ставками")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0BidsMinPost200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0BidsMinPost200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": [AdvV0BidsMinPost200ResponseBidsInner.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None
        })
        return _obj
