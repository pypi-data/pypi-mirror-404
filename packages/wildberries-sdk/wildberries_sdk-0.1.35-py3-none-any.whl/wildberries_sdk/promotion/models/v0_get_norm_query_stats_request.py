...
class V0GetNormQueryStatsRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0GetNormQueryStatsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0GetNormQueryStatsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "from": obj.get("from"),
            "to": obj.get("to"),
            "items": [V0GetNormQueryStatsRequestItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
