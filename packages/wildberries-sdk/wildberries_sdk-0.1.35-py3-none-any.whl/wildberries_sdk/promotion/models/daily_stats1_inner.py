...
class DailyStats1Inner(BaseModel):
    """
    DailyStats1Inner
    """ # noqa: E501
    var_date: Optional[datetime] = Field(default=None, description="Дата", alias="date")
    app_type_stats: Optional[List[DailyStats1InnerAppTypeStatsInner]] = Field(default=None, description="Статистика по платформам")
    __properties: ClassVar[List[str]] = ["date", "app_type_stats"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in app_type_stats (list)
        _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "app_type_stats": [DailyStats1InnerAppTypeStatsInner.from_dict(_item) for _item in obj["app_type_stats"]] if obj.get("app_type_stats") is not None else None
        })
        return _obj
