...
class AuctionAdvertNMsSettings(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bids", "subject", "nm_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuctionAdvertNMsSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuctionAdvertNMsSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": AuctionAdvertBids.from_dict(obj["bids"]) if obj.get("bids") is not None else None,
            "subject": AuctionAdvertSubject.from_dict(obj["subject"]) if obj.get("subject") is not None else None,
            "nm_id": obj.get("nm_id")
        })
        return _obj
