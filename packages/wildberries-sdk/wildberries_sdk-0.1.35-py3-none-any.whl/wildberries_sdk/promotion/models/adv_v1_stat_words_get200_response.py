...
class AdvV1StatWordsGet200Response(BaseModel):
    ...
    stat: Optional[List[AdvV1StatWordsGet200ResponseStatInner]] = Field(default=None, description="Массив информации по статистике.<br> **Первый элемент массива** с `keyword: \"Всего по кампании\"` содержит суммарную информацию обо всех ключевых фразах.<br> **Каждый следующий элемент массива** содержит информацию об отдельных ключевых фразах.<br> Отображается 60 ключевых фраз с наибольшим количеством просмотров. ")
