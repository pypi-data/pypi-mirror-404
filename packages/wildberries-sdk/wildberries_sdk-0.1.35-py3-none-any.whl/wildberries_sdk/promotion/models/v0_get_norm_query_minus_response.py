...
class V0GetNormQueryMinusResponse(BaseModel):
    ...
    """ # noqa: E501
    items: List[V0GetNormQueryMinusResponseItem]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0GetNormQueryMinusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0GetNormQueryMinusResponse from a dict"""
        if obj is None:
            return None
