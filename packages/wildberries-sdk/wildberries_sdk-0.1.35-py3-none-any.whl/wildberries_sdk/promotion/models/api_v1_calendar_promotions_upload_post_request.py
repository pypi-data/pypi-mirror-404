...
class ApiV1CalendarPromotionsUploadPostRequest(BaseModel):
    """
    ApiV1CalendarPromotionsUploadPostRequest
    """ # noqa: E501
    data: Optional[ApiV1CalendarPromotionsUploadPostRequestData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1CalendarPromotionsUploadPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1CalendarPromotionsUploadPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": ApiV1CalendarPromotionsUploadPostRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
