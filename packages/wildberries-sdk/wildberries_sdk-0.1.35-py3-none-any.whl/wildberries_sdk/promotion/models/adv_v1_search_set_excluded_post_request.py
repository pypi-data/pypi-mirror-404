...
class AdvV1SearchSetExcludedPostRequest(BaseModel):
    """
    AdvV1SearchSetExcludedPostRequest
    """ # noqa: E501
    excluded: Optional[List[StrictStr]] = Field(default=None, description="Список минус-фраз, до 1000 фраз")
    __properties: ClassVar[List[str]] = ["excluded"]
