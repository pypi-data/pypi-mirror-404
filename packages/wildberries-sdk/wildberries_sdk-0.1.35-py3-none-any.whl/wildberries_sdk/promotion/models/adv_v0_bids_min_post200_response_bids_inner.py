...
class AdvV0BidsMinPost200ResponseBidsInner(BaseModel):
    """
    AdvV0BidsMinPost200ResponseBidsInner
    """ # noqa: E501
    bids: List[AdvV0BidsMinPost200ResponseBidsInnerBidsInner] = Field(description="Список ставок по местам размещения")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0BidsMinPost200ResponseBidsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0BidsMinPost200ResponseBidsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": [AdvV0BidsMinPost200ResponseBidsInnerBidsInner.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None,
            "nm_id": obj.get("nm_id")
        })
        return _obj
