...
class AuctionAdvertSettings(BaseModel):
    """
    Настройки кампании
    """ # noqa: E501
    payment_type: StrictStr = Field(description="Тип оплаты: - `cpm` — за показы - `cpc` — за клик ")
    name: StrictStr = Field(description="Имя кампании")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuctionAdvertSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuctionAdvertSettings from a dict"""
        if obj is None:
            return None
