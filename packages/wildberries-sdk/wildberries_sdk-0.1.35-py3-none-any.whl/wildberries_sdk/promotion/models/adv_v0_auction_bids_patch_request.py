...
class AdvV0AuctionBidsPatchRequest(BaseModel):
    """
    AdvV0AuctionBidsPatchRequest
    """ # noqa: E501
    bids: Annotated[List[AdvV0AuctionBidsPatchRequestBidsInner], Field(max_length=50)] = Field(description="Ставки в кампаниях")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0AuctionBidsPatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0AuctionBidsPatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": [AdvV0AuctionBidsPatchRequestBidsInner.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None
        })
        return _obj
