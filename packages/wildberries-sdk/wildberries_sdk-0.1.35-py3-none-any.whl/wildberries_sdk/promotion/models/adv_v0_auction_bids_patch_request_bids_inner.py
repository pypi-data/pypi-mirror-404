...
class AdvV0AuctionBidsPatchRequestBidsInner(BaseModel):
    """
    AdvV0AuctionBidsPatchRequestBidsInner
    """ # noqa: E501
    advert_id: StrictInt = Field(description="ID кампании")
    nm_bids: Annotated[List[AdvV0AuctionBidsPatchRequestBidsInnerNmBidsInner], Field(max_length=50)] = Field(description="Ставки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0AuctionBidsPatchRequestBidsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0AuctionBidsPatchRequestBidsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nm_bids": [AdvV0AuctionBidsPatchRequestBidsInnerNmBidsInner.from_dict(_item) for _item in obj["nm_bids"]] if obj.get("nm_bids") is not None else None
        })
        return _obj
