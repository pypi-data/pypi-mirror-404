...
class AdvV0AuctionBidsPatch200ResponseBidsInner(BaseModel):
    """
    AdvV0AuctionBidsPatch200ResponseBidsInner
    """ # noqa: E501
    advert_id: StrictInt = Field(description="ID кампании")
    nm_bids: List[AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner] = Field(description="Ставки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0AuctionBidsPatch200ResponseBidsInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in nm_bids (list)
        _items = []
        if self.nm_bids:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0AuctionBidsPatch200ResponseBidsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nm_bids": [AdvV0AuctionBidsPatch200ResponseBidsInnerNmBidsInner.from_dict(_item) for _item in obj["nm_bids"]] if obj.get("nm_bids") is not None else None
        })
        return _obj
