...
class ApiV1CalendarPromotionsGet200Response(BaseModel):
    """
    ApiV1CalendarPromotionsGet200Response
    """ # noqa: E501
    data: Optional[ApiV1CalendarPromotionsGet200ResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1CalendarPromotionsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1CalendarPromotionsGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": ApiV1CalendarPromotionsGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
