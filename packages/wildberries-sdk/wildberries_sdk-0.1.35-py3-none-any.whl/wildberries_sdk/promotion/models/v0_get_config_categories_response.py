...
class V0GetConfigCategoriesResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="ID категории товара")
    name: StrictStr = Field(description="Название категории товара")
    cpm_min: StrictInt = Field(description="Минимально допустимая ставка")
    __properties: ClassVar[List[str]] = ["id", "name", "cpm_min"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0GetConfigCategoriesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0GetConfigCategoriesResponse from a dict"""
        if obj is None:
            return None
