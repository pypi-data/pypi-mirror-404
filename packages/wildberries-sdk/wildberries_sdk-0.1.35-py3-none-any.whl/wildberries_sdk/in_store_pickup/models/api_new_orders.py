...
class ApiNewOrders(BaseModel):
    """
    ApiNewOrders
    """ # noqa: E501
    orders: Optional[List[ApiNewOrder]] = Field(default=None, description="Список сборочных заданий")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiNewOrders from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiNewOrders from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "orders": [ApiNewOrder.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
