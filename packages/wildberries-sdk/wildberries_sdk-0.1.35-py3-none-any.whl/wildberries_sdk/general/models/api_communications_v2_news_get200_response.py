...
class ApiCommunicationsV2NewsGet200Response(BaseModel):
    """
    ApiCommunicationsV2NewsGet200Response
    """ # noqa: E501
    data: Optional[List[ApiCommunicationsV2NewsGet200ResponseDataInner]] = Field(default=None, description="Новости")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiCommunicationsV2NewsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiCommunicationsV2NewsGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [ApiCommunicationsV2NewsGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
