...
class ContentDeleteRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentDeleteRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentDeleteRequest from a dict"""
        if obj is None:
            return None
