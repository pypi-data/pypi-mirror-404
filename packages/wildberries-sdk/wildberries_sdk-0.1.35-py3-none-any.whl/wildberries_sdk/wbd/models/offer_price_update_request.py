...
class OfferPriceUpdateRequest(BaseModel):
    """
    Новая цена для предложения
    """ # noqa: E501
    regular_price: Optional[StrictInt] = Field(default=None, description="Цена, ₽")
    discount_price: Optional[StrictInt] = Field(default=None, description="Цена с учетом скидки, ₽")
    __properties: ClassVar[List[str]] = ["regular_price", "discount_price"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OfferPriceUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OfferPriceUpdateRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "regular_price": obj.get("regular_price"),
