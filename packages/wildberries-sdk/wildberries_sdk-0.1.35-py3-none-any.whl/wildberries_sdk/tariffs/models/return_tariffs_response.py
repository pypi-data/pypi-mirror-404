...
class ReturnTariffsResponse(BaseModel):
    ...
    """ # noqa: E501
    response: Optional[ModelsReturnTariffsResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ModelsReturnTariffsResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
