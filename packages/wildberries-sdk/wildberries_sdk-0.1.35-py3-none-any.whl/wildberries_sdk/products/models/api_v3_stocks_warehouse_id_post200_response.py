...
class ApiV3StocksWarehouseIdPost200Response(BaseModel):
    """
    ApiV3StocksWarehouseIdPost200Response
    """ # noqa: E501
    stocks: Optional[List[ApiV3StocksWarehouseIdPost200ResponseStocksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stocks": [ApiV3StocksWarehouseIdPost200ResponseStocksInner.from_dict(_item) for _item in obj["stocks"]] if obj.get("stocks") is not None else None
        })
        return _obj
