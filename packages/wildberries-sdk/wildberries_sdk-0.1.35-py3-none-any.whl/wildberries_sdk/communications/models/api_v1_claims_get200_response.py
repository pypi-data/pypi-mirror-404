...
class ApiV1ClaimsGet200Response(BaseModel):
    """
    ApiV1ClaimsGet200Response
    """ # noqa: E501
    claims: Optional[List[ApiV1ClaimsGet200ResponseClaimsInner]] = Field(default=None, description="Заявки")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "claims": [ApiV1ClaimsGet200ResponseClaimsInner.from_dict(_item) for _item in obj["claims"]] if obj.get("claims") is not None else None,
            "total": obj.get("total")
        })
        return _obj
