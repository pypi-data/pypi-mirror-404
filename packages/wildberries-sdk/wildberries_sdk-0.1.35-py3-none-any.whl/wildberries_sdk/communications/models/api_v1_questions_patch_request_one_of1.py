...
class ApiV1QuestionsPatchRequestOneOf1(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "answer": ApiV1QuestionsPatchRequestOneOf1Answer.from_dict(obj["answer"]) if obj.get("answer") is not None else None,
            "state": obj.get("state")
        })
        return _obj
