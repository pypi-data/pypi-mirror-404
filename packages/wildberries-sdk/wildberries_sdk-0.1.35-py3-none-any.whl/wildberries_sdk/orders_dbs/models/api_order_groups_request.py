...
class ApiOrderGroupsRequest(BaseModel):
    ...
    """ # noqa: E501
    groups: Optional[Annotated[List[StrictStr], Field(max_length=1000)]] = Field(default=None, description="Список значений `groupId`. Можно получить из [новых](./orders-dbs#tag/Sborochnye-zadaniya-DBS/paths/~1api~1v3~1dbs~1orders~1new/get) и [завершенных](./orders-dbs#tag/Sborochnye-zadaniya-DBS/paths/~1api~1v3~1dbs~1orders/get) сборочных заданий")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiOrderGroupsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiOrderGroupsRequest from a dict"""
        if obj is None:
            return None
