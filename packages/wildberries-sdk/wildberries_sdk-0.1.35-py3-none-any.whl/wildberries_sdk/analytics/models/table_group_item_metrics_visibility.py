...
class TableGroupItemMetricsVisibility(BaseModel):
    """
    Процент видимости товара в результатах поиска
    """ # noqa: E501
    current: StrictInt = Field(description="Текущий процент видимости")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableGroupItemMetricsVisibility from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableGroupItemMetricsVisibility from a dict"""
        if obj is None:
            return None
