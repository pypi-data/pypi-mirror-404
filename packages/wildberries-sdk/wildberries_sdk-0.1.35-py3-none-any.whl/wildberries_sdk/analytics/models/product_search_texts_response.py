...
class ProductSearchTextsResponse(BaseModel):
    """
    ProductSearchTextsResponse
    """ # noqa: E501
    items: List[TableSearchTextItem] = Field(description="Элементы таблицы")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProductSearchTextsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProductSearchTextsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [TableSearchTextItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
