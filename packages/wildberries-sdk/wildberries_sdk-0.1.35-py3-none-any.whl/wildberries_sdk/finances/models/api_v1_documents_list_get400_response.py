...
class ApiV1DocumentsListGet400Response(BaseModel):
    """
    ...
    detail: Optional[StrictStr] = Field(default=None, description="Детализация ошибки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1DocumentsListGet400Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1DocumentsListGet400Response from a dict"""
        if obj is None:
            return None
