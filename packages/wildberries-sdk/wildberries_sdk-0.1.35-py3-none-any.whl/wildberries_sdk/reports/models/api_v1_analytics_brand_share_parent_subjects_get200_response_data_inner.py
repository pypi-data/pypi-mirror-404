...
class ApiV1AnalyticsBrandShareParentSubjectsGet200ResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["parentId", "parentName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1AnalyticsBrandShareParentSubjectsGet200ResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1AnalyticsBrandShareParentSubjectsGet200ResponseDataInner from a dict"""
        if obj is None:
            return None
