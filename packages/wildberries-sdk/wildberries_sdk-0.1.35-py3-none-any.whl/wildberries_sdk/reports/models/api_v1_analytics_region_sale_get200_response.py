...
class ApiV1AnalyticsRegionSaleGet200Response(BaseModel):
    """
    ApiV1AnalyticsRegionSaleGet200Response
    """ # noqa: E501
    report: Optional[List[ApiV1AnalyticsRegionSaleGet200ResponseReportInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1AnalyticsRegionSaleGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1AnalyticsRegionSaleGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "report": [ApiV1AnalyticsRegionSaleGet200ResponseReportInner.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
        return _obj
