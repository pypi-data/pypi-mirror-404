...
class ApiV1AnalyticsBrandShareParentSubjectsGet200Response(BaseModel):
    """
    ApiV1AnalyticsBrandShareParentSubjectsGet200Response
    """ # noqa: E501
    data: Optional[List[ApiV1AnalyticsBrandShareParentSubjectsGet200ResponseDataInner]] = Field(default=None, description="Категории бренда")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1AnalyticsBrandShareParentSubjectsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1AnalyticsBrandShareParentSubjectsGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [ApiV1AnalyticsBrandShareParentSubjectsGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
