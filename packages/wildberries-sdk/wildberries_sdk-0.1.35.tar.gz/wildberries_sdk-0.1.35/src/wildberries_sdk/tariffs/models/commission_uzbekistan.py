...
class CommissionUzbekistan(BaseModel):
    ...
    """ # noqa: E501
    report: Optional[List[CommissionUzbekistanReportInner]] = Field(default=None, description="Список комиссий")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "report": [CommissionUzbekistanReportInner.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
        return _obj
