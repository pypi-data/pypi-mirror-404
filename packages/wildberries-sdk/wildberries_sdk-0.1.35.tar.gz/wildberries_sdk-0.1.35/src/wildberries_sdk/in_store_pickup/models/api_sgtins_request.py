...
class ApiSGTINsRequest(BaseModel):
    """
    ApiSGTINsRequest
    """ # noqa: E501
    sgtins: Optional[List[StrictStr]] = Field(default=None, description="Массив кодов маркировки. Допускается от 16 до 135 символов для кода одной маркировки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiSGTINsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiSGTINsRequest from a dict"""
        if obj is None:
            return None
