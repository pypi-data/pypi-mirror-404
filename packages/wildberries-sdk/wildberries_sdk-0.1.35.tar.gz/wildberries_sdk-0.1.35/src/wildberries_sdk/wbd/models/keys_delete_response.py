...
class KeysDeleteResponse(BaseModel):
    ...
    KeysDeleteResponse
    """ # noqa: E501
    statuses: List[KeysDeleteResponseStatusesInner] = Field(description="Статусы удаления ключей")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeysDeleteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeysDeleteResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "statuses": [KeysDeleteResponseStatusesInner.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
