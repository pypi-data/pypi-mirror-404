...
class UploadChunkResponse(BaseModel):
    ...
    """ # noqa: E501
    chunk: Optional[StrictInt] = Field(default=None, description="Количество переданных фреймов (частей контента)")
    uri: Optional[StrictStr] = Field(default=None, description="URI адреса загруженного файла ")
    __properties: ClassVar[List[str]] = ["chunk", "uri"]
