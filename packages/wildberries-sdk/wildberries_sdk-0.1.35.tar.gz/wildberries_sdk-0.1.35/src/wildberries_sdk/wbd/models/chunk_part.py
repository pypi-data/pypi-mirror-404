...
class ChunkPart(BaseModel):
    ...
    ChunkPart
    """ # noqa: E501
    index: StrictInt = Field(description="Индекс фрейма (фрагмента)")
    size: StrictInt = Field(description="Размер фрейма (фрагмента) в байтах")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChunkPart from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChunkPart from a dict"""
        if obj is None:
            return None
