...
class ApiMarketplaceV3OrdersOrderIdMetaCustomsDeclarationPutRequest(BaseModel):
    """
    ApiMarketplaceV3OrdersOrderIdMetaCustomsDeclarationPutRequest
    """ # noqa: E501
    customs_declaration: Optional[Annotated[str, Field(min_length=17, strict=True, max_length=29)]] = Field(default=None, description="Номер ГТД", alias="customsDeclaration")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiMarketplaceV3OrdersOrderIdMetaCustomsDeclarationPutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiMarketplaceV3OrdersOrderIdMetaCustomsDeclarationPutRequest from a dict"""
        if obj is None:
            return None
