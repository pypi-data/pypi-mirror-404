...
class ApiV1FeedbacksGet200ResponseData(BaseModel):
    """
    ...
    count_archive: Optional[StrictInt] = Field(default=None, description="Количество обработанных отзывов", alias="countArchive")
    feedbacks: Optional[List[ResponseFeedbackInner]] = Field(default=None, description="Массив отзывов")
    __properties: ClassVar[List[str]] = ["countUnanswered", "countArchive", "feedbacks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feedbacks": [ResponseFeedbackInner.from_dict(_item) for _item in obj["feedbacks"]] if obj.get("feedbacks") is not None else None
        })
        return _obj
