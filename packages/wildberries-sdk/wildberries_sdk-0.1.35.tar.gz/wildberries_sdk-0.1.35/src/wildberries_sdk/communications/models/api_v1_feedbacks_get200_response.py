...
class ApiV1FeedbacksGet200Response(BaseModel):
    """
    ApiV1FeedbacksGet200Response
    """ # noqa: E501
    data: Optional[ApiV1FeedbacksGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiV1FeedbacksGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
