...
class ApiV1FeedbacksArchiveGet200Response(BaseModel):
    """
    ApiV1FeedbacksArchiveGet200Response
    """ # noqa: E501
    data: Optional[ApiV1FeedbacksArchiveGet200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ApiV1FeedbacksArchiveGet200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "error": obj.get("error"),
