...
class RespondResultErr(BaseModel):
    """
    RespondResultErr
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["detail", "origin", "requestId", "status", "title"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RespondResultErr from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RespondResultErr from a dict"""
        if obj is None:
            return None
