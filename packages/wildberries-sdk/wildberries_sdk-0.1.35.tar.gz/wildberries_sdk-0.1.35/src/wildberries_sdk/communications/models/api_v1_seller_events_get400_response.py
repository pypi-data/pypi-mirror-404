...
class ApiV1SellerEventsGet400Response(BaseModel):
    """
    ...
    error: Optional[StrictStr] = Field(default=None, description="Текст ошибки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1SellerEventsGet400Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1SellerEventsGet400Response from a dict"""
        if obj is None:
            return None
