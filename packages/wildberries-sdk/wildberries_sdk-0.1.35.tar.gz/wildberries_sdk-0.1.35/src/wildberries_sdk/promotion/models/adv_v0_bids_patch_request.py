...
class AdvV0BidsPatchRequest(BaseModel):
    """
    AdvV0BidsPatchRequest
    """ # noqa: E501
    bids: Annotated[List[V0AdvertMultibid], Field(max_length=20)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0BidsPatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0BidsPatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": [V0AdvertMultibid.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None
        })
        return _obj
