...
class AdvV0AuctionPlacementsPutRequest(BaseModel):
    """
    AdvV0AuctionPlacementsPutRequest
    """ # noqa: E501
    placements: Annotated[List[AdvV0AuctionPlacementsPutRequestPlacementsInner], Field(max_length=50)] = Field(description="Места размещения в кампаниях")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0AuctionPlacementsPutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0AuctionPlacementsPutRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "placements": [AdvV0AuctionPlacementsPutRequestPlacementsInner.from_dict(_item) for _item in obj["placements"]] if obj.get("placements") is not None else None
        })
        return _obj
