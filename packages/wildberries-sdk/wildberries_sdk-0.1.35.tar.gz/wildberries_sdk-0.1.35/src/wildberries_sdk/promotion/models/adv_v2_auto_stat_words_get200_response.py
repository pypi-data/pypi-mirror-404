...
class AdvV2AutoStatWordsGet200Response(BaseModel):
    """
    AdvV2AutoStatWordsGet200Response
    """ # noqa: E501
    excluded: Optional[List[StrictStr]] = Field(default=None, description="Исключения (минус-фразы) для товаров из кампании. Можно задать помощью метода [установка/удаление минус-фраз](./ru/openapi/promotion#tag/Parametry-kampanij/paths/~1adv~1v1~1search~1set-phrase/post) или в настройках кампании в личном кабинете")
    clusters: Optional[List[AdvV2AutoStatWordsGet200ResponseClustersInner]] = Field(default=None, description="Кластеры ключевых фраз")
    __properties: ClassVar[List[str]] = ["excluded", "clusters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "clusters": [AdvV2AutoStatWordsGet200ResponseClustersInner.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None
        })
        return _obj
