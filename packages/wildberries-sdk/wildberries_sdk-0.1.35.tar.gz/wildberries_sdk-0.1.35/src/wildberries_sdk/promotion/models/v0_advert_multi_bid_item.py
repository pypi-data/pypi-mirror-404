...
class V0AdvertMultiBidItem(BaseModel):
    ...
    bid: StrictInt = Field(description="Ставка. Минимально допустимые ставки вы можете получить в ответе метода [получения минимальных ставок для карточек товаров](./promotion#tag/Sozdanie-kampanij/paths/~1adv~1v0~1bids~1min/post)")
    __properties: ClassVar[List[str]] = ["nm", "bid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0AdvertMultiBidItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0AdvertMultiBidItem from a dict"""
        if obj is None:
            return None
