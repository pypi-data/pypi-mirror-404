...
class AdvV1PromotionCountGet200ResponseAdvertsInner(BaseModel):
    """
    AdvV1PromotionCountGet200ResponseAdvertsInner
    """ # noqa: E501
    type: Optional[StrictInt] = Field(default=None, description="Тип кампании:   - `8` — кампания с единой ставкой (**устаревший тип**)   - `9` — кампания с единой или ручной ставкой. Тип ставки вы можете получить с помощью метода [Информация о кампаниях](./promotion#tag/Kampanii/paths/~1api~1advert~1v2~1adverts/get), поле `bid_type` ")
    ...
    advert_list: Optional[List[AdvV1PromotionCountGet200ResponseAdvertsInnerAdvertListInner]] = Field(default=None, description="Список кампаний")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in advert_list (list)
        _items = []
        if self.advert_list:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "advert_list": [AdvV1PromotionCountGet200ResponseAdvertsInnerAdvertListInner.from_dict(_item) for _item in obj["advert_list"]] if obj.get("advert_list") is not None else None
        })
        return _obj
