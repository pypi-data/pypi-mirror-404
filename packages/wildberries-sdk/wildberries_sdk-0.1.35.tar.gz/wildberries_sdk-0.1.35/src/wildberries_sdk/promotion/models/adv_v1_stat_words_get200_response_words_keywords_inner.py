...
class AdvV1StatWordsGet200ResponseWordsKeywordsInner(BaseModel):
    """
    AdvV1StatWordsGet200ResponseWordsKeywordsInner
    """ # noqa: E501
    keyword: Optional[StrictStr] = Field(default=None, description="Ключевая фраза")
    count: Optional[StrictInt] = Field(default=None, description="Количество просмотров по ключевой фразе")
    __properties: ClassVar[List[str]] = ["keyword", "count"]
