...
class ApiV1CalendarPromotionsUploadPostRequestData(BaseModel):
    """
    Данные запроса
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1CalendarPromotionsUploadPostRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1CalendarPromotionsUploadPostRequestData from a dict"""
        if obj is None:
            return None
