...
class AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements(BaseModel):
    """
    Места размещения
    """ # noqa: E501
    search: StrictBool = Field(description="Размещение в поиске:   - `false` — отключено   - `true` — включено ")
    recommendations: StrictBool = Field(description="Размещение в рекомендациях:   - `false` — отключено   - `true` — включено ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0AuctionPlacementsPutRequestPlacementsInnerPlacements from a dict"""
        if obj is None:
            return None
