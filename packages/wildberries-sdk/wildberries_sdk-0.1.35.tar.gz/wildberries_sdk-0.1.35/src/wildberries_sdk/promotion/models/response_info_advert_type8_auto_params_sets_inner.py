...
class ResponseInfoAdvertType8AutoParamsSetsInner(BaseModel):
    """
    ResponseInfoAdvertType8AutoParamsSetsInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID set")
    name: Optional[StrictStr] = Field(default=None, description="Название set")
