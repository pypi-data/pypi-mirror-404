...
class V0KeywordsStatistic(BaseModel):
    """
    V0KeywordsStatistic
    """ # noqa: E501
    clicks: StrictInt = Field(description="Количество кликов")
    ctr: Union[StrictFloat, StrictInt] = Field(description="CTR (Click-Through Rate) — показатель кликабельности")
    keyword: StrictStr = Field(description="Ключевая фраза")
    sum: Union[StrictFloat, StrictInt] = Field(description="Сумма затрат по ключевой фразе")
    views: StrictInt = Field(description="Количество показов")
    __properties: ClassVar[List[str]] = ["clicks", "ctr", "keyword", "sum", "views"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0KeywordsStatistic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0KeywordsStatistic from a dict"""
        if obj is None:
            return None
