...
class ApiAdvertV1BidsPatch200ResponseBidsInner(BaseModel):
    """
    ApiAdvertV1BidsPatch200ResponseBidsInner
    """ # noqa: E501
    advert_id: StrictInt = Field(description="ID кампании")
    nm_bids: List[ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner] = Field(description="Ставки")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiAdvertV1BidsPatch200ResponseBidsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiAdvertV1BidsPatch200ResponseBidsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nm_bids": [ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner.from_dict(_item) for _item in obj["nm_bids"]] if obj.get("nm_bids") is not None else None
        })
        return _obj
