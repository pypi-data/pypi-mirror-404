...
class AdvV0ConfigGet200Response(BaseModel):
    """
    AdvV0ConfigGet200Response
    """ # noqa: E501
    categories: Optional[List[V0GetConfigCategoriesResponse]] = Field(default=None, description="Список категорий товаров (предметов) с минимально допустимыми ставками")
    config: Optional[List[AdvV0ConfigGet200ResponseConfigInner]] = Field(default=None, description="Список основных параметров конфигурации с допустимыми значениями")
    __properties: ClassVar[List[str]] = ["categories", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0ConfigGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0ConfigGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "categories": [V0GetConfigCategoriesResponse.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None,
            "config": [AdvV0ConfigGet200ResponseConfigInner.from_dict(_item) for _item in obj["config"]] if obj.get("config") is not None else None
        })
        return _obj
