...
class AdvV0BidsMinPost200ResponseBidsInnerBidsInner(BaseModel):
    """
    AdvV0BidsMinPost200ResponseBidsInnerBidsInner
    """ # noqa: E501
    type: PlacementType
    value: StrictInt = Field(description="Минимальная ставка")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0BidsMinPost200ResponseBidsInnerBidsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0BidsMinPost200ResponseBidsInnerBidsInner from a dict"""
        if obj is None:
            return None
