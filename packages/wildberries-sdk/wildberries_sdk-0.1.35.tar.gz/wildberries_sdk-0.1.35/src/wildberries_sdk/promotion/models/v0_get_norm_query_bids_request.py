...
class V0GetNormQueryBidsRequest(BaseModel):
    """
    V0GetNormQueryBidsRequest
    """ # noqa: E501
    items: Annotated[List[V0GetNormQueryBidsRequestItem], Field(max_length=100)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0GetNormQueryBidsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0GetNormQueryBidsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [V0GetNormQueryBidsRequestItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
