...
class AdvV0ConfigGet200ResponseConfigInner(BaseModel):
    """
    AdvV0ConfigGet200ResponseConfigInner
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Описание параметра")
    name: Optional[StrictStr] = Field(default=None, description="Название параметра")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdvV0ConfigGet200ResponseConfigInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdvV0ConfigGet200ResponseConfigInner from a dict"""
        if obj is None:
            return None
