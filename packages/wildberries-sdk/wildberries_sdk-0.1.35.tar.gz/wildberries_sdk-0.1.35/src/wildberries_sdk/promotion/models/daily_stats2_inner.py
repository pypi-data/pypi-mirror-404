...
class DailyStats2Inner(BaseModel):
    """
    DailyStats2Inner
    """ # noqa: E501
    var_date: Optional[datetime] = Field(default=None, description="Дата", alias="date")
    app_type_stats: Optional[List[DailyStats2InnerAppTypeStatsInner]] = Field(default=None, description="Статистика по платформам")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "app_type_stats": [DailyStats2InnerAppTypeStatsInner.from_dict(_item) for _item in obj["app_type_stats"]] if obj.get("app_type_stats") is not None else None
        })
        return _obj
