...
class ResponseInfoAdvertType8AutoParamsMenusInner(BaseModel):
    """
    Меню, где размещается кампания
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID меню")
    name: Optional[StrictStr] = Field(default=None, description="Название меню")
