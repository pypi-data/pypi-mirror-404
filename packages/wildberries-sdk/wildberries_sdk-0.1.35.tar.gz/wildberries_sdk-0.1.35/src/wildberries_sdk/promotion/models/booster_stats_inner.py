...
class BoosterStatsInner(BaseModel):
    """
    BoosterStatsInner
    """ # noqa: E501
    var_date: Optional[datetime] = Field(default=None, description="Дата, за которую предоставлены данные", alias="date")
    nm: Optional[StrictInt] = Field(default=None, description="Артикул WB")
    avg_position: Optional[StrictInt] = Field(default=None, description="Средняя позиция товара на страницах поисковой выдачи и каталога")
    __properties: ClassVar[List[str]] = ["date", "nm", "avg_position"]
