...
class ApiAdvertV1BidsPatchRequest(BaseModel):
    """
    ApiAdvertV1BidsPatchRequest
    """ # noqa: E501
    bids: Annotated[List[ApiAdvertV1BidsPatchRequestBidsInner], Field(max_length=50)] = Field(description="Ставки в кампаниях")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiAdvertV1BidsPatchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiAdvertV1BidsPatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bids": [ApiAdvertV1BidsPatchRequestBidsInner.from_dict(_item) for _item in obj["bids"]] if obj.get("bids") is not None else None
        })
        return _obj
