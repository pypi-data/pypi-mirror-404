...
class AdvV1SearchSetPlusPostRequest(BaseModel):
    """
    AdvV1SearchSetPlusPostRequest
    """ # noqa: E501
    pluse: Optional[List[StrictStr]] = Field(default=None, description="Список фиксированных фраз (max. 100)")
    __properties: ClassVar[List[str]] = ["pluse"]
