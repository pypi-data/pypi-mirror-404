...
class V0GetNormQueryStatsResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V0GetNormQueryStatsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V0GetNormQueryStatsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "stats": [V0GetNormQueryStatsItem.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
