...
class ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner(BaseModel):
    """
    ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner
    """ # noqa: E501
    nm_id: StrictInt = Field(description="Артикул WB")
    bid_kopecks: StrictInt = Field(description="Ставка")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiAdvertV1BidsPatch200ResponseBidsInnerNmBidsInner from a dict"""
        if obj is None:
            return None
