...
class StatsBlok1(BaseModel):
    ...
    daily_stats: Optional[List[DailyStats1Inner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "daily_stats": [DailyStats1Inner.from_dict(_item) for _item in obj["daily_stats"]] if obj.get("daily_stats") is not None else None,
