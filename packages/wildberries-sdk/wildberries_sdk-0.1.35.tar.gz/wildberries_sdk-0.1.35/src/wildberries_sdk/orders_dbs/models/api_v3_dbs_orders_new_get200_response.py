...
class ApiV3DbsOrdersNewGet200Response(BaseModel):
    """
    ApiV3DbsOrdersNewGet200Response
    """ # noqa: E501
    orders: Optional[List[OrderNewDBS]] = Field(default=None, description="Список новых сборочных заданий")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV3DbsOrdersNewGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV3DbsOrdersNewGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "orders": [OrderNewDBS.from_dict(_item) for _item in obj["orders"]] if obj.get("orders") is not None else None
        })
        return _obj
