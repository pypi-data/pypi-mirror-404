...
class ApiV1AnalyticsAntifraudDetailsGet200Response(BaseModel):
    """
    ApiV1AnalyticsAntifraudDetailsGet200Response
    """ # noqa: E501
    details: Optional[List[ApiV1AnalyticsAntifraudDetailsGet200ResponseDetailsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiV1AnalyticsAntifraudDetailsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiV1AnalyticsAntifraudDetailsGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "details": [ApiV1AnalyticsAntifraudDetailsGet200ResponseDetailsInner.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
