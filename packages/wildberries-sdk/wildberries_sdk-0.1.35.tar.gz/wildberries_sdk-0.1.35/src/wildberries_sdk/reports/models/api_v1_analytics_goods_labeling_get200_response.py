...
class ApiV1AnalyticsGoodsLabelingGet200Response(BaseModel):
    """
    ApiV1AnalyticsGoodsLabelingGet200Response
    """ # noqa: E501
    report: Optional[List[ApiV1AnalyticsGoodsLabelingGet200ResponseReportInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "report": [ApiV1AnalyticsGoodsLabelingGet200ResponseReportInner.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
        return _obj
