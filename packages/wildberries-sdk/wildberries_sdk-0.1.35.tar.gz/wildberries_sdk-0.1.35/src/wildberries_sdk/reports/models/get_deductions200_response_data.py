...
class GetDeductions200ResponseData(BaseModel):
    """
    Данные ответа
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeductions200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeductions200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "reports": [GetDeductions200ResponseDataReportsInner.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
            "total": obj.get("total")
        })
        return _obj
