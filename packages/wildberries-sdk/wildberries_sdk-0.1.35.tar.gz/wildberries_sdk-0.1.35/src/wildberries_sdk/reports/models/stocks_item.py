...
class StocksItem(BaseModel):
    ...
    quantity: Optional[StrictInt] = Field(default=None, description="Количество, доступное для продажи (сколько можно добавить в корзину)")
    in_way_to_client: Optional[StrictInt] = Field(default=None, description="В пути к клиенту", alias="inWayToClient")
    in_way_from_client: Optional[StrictInt] = Field(default=None, description="В пути от клиента", alias="inWayFromClient")
    quantity_full: Optional[StrictInt] = Field(default=None, description="Полное (непроданное) количество, которое числится за складом (= `quantity` + в пути)", alias="quantityFull")
    ...
    tech_size: Optional[Annotated[str, Field(strict=True, max_length=30)]] = Field(default=None, description="Размер", alias="techSize")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Цена", alias="Price")
    discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Скидка", alias="Discount")
    is_supply: Optional[StrictBool] = Field(default=None, description="Договор поставки (внутренние технологические данные)", alias="isSupply")
    is_realization: Optional[StrictBool] = Field(default=None, description="Договор реализации (внутренние технологические данные)", alias="isRealization")
    sc_code: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="Код контракта (внутренние технологические данные)", alias="SCCode")
    __properties: ClassVar[List[str]] = ["lastChangeDate", "warehouseName", "supplierArticle", "nmId", "barcode", "quantity", "inWayToClient", "inWayFromClient", "quantityFull", "category", "subject", "brand", "techSize", "Price", "Discount", "isSupply", "isRealization", "SCCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "quantityFull": obj.get("quantityFull"),
