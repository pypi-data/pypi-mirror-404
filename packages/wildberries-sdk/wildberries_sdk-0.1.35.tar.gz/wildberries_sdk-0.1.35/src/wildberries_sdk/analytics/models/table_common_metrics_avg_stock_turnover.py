...
class TableCommonMetricsAvgStockTurnover(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableCommonMetricsAvgStockTurnover from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableCommonMetricsAvgStockTurnover from a dict"""
        if obj is None:
            return None
