...
class PeriodOrdersRequest(BaseModel):
    """
    ...
    end: date = Field(description="Дата окончания периода. Не ранее 365 суток от сегодня")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PeriodOrdersRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PeriodOrdersRequest from a dict"""
        if obj is None:
            return None
