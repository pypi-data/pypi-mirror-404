...
class SearchReportProductReq(BaseModel):
    """
    SearchReportProductReq
    """ # noqa: E501
    id: UUID = Field(description="ID отчёта в UUID-формате. Генерируется продавцом самостоятельно")
    report_type: StrictStr = Field(description="Тип отчёта `SEARCH_QUERIES_PREMIUM_REPORT_PRODUCT` — Отчёт по параметрам поиска. По артикулам WB", alias="reportType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchReportProductReq from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchReportProductReq from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "params": SearchReportProductReqParams.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
