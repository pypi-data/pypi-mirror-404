...
class TableSearchTextItemAllOfOrders(BaseModel):
    """
    ...
    percentile: StrictInt = Field(description="Процент, на который показатель заказов выше, чем у карточек конкурентов по поисковому запросу")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TableSearchTextItemAllOfOrders from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TableSearchTextItemAllOfOrders from a dict"""
        if obj is None:
            return None
