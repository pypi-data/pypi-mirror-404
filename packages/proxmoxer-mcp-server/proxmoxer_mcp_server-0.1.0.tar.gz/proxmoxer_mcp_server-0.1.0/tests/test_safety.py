...
class TestDestructiveOperationControls:
    ...
    def test_relaxed_confirmation_mode_bypasses_safe_ops(self):
        ...
        with patch.dict(os.environ, env_vars, clear=True):
            # Reset module-level variables by re-importing the module
            import importlib
...
class TestAuditLogging:
    ...
    def test_audit_log_default_level_2(self, mock_environment):
    ...
    def test_audit_log_default_level(self, mock_environment):
        ...
        with patch("proxmoxer_mcp_server.logger") as mock_logger:
            ...
            # Should use standard level by default
            mock_logger.info.assert_called_once_with(
                "Operation: test_operation, Params: {'test': 'param'}"
            )
