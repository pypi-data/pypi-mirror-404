// Deformable Convolution 2D for Apple Silicon (MPS)
// Port of torchvision deform_conv2d CUDA kernel
//
// Key operations:
...
kernel void deformable_col2im_fp32(
    ...
    // Scatter to 2x2 neighborhood with bilinear weights
