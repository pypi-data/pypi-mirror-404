...
{
    "distutils": {
        "name": "agentfoundry.agents.memory.constants",
        "sources": [
            "agentfoundry/agents/memory/constants.py"
        ]
    },
    "module_name": "agentfoundry.agents.memory.constants"
}
END: Cython Metadata */
...
#define __PYX_HAVE__agentfoundry__agents__memory__constants
#define __PYX_HAVE_API__agentfoundry__agents__memory__constants
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "agentfoundry.agents.memory.constants" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "agentfoundry.agents.memory.constants"
extern int __pyx_module_is_main_agentfoundry__agents__memory__constants;
int __pyx_module_is_main_agentfoundry__agents__memory__constants = 0;

/* Implementation of "agentfoundry.agents.memory.constants" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Constants_for_the_memory_managem[] = "Constants for the memory management module.";
/* #### Code section: decls ### */
...
#define __pyx_n_u_DEFAULT_K __pyx_string_tab[2]
#define __pyx_n_u_ROLE_LEVEL_DEFAULT __pyx_string_tab[3]
#define __pyx_n_u_SCOPE_GLOBAL __pyx_string_tab[4]
#define __pyx_n_u_SCOPE_ORG __pyx_string_tab[5]
#define __pyx_n_u_SCOPE_THREAD __pyx_string_tab[6]
#define __pyx_n_u_SCOPE_USER __pyx_string_tab[7]
#define __pyx_n_u_SYSTEM_USER_ID __pyx_string_tab[8]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[9]
#define __pyx_n_u_global __pyx_string_tab[10]
...
#define __pyx_n_u_org __pyx_string_tab[14]
...
#define __pyx_n_u_thread __pyx_string_tab[18]
#define __pyx_n_u_user __pyx_string_tab[19]
...
namespace {
  ...
  #endif
  {
      ...
      "constants",
      __pyx_k_Constants_for_the_memory_managem, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_RefNannySetupContext("PyInit_constants", 0);
  ...
  if (__pyx_module_is_main_agentfoundry__agents__memory__constants) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "agentfoundry.agents.memory.constants")) {
      if (unlikely((PyDict_SetItemString(modules, "agentfoundry.agents.memory.constants", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_SYSTEM_USER_ID, __pyx_mstate_global->__pyx_kp_u_0) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_SCOPE_GLOBAL, __pyx_mstate_global->__pyx_n_u_global) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_SCOPE_ORG, __pyx_mstate_global->__pyx_n_u_org) < (0)) __PYX_ERR(0, 8, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_SCOPE_USER, __pyx_mstate_global->__pyx_n_u_user) < (0)) __PYX_ERR(0, 9, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_SCOPE_THREAD, __pyx_mstate_global->__pyx_n_u_thread) < (0)) __PYX_ERR(0, 10, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_ROLE_LEVEL_DEFAULT, __pyx_mstate_global->__pyx_int_0) < (0)) __PYX_ERR(0, 13, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_DEFAULT_K, __pyx_mstate_global->__pyx_int_5) < (0)) __PYX_ERR(0, 14, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init agentfoundry.agents.memory.constants", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init agentfoundry.agents.memory.constants");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{9},{18},{12},{9},{12},{10},{14},{18},{6},{8},{10},{8},{3},{12},{10},{8},{6},{4}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (138 bytes) */
const char* const cstring = "x\332-\310Q\016\2020\020\004\320+y\003\203\262\242\261\246\246\005\023\277&\013\254H(\020K{\177\301:\037;og\277\313\351\224U\252\304\325hEP\364 \205\377f\217\372N(\224>d*Y\233\"\241<\033\312\362\344\312\222\261O[\322\355G\\\362\306\365\223\240\237\020<7Rs3tn\256\331\001#\257\353\232qn\243\223M\023\217k\317\276\003>\221]z\027\t\255\2748\272\000\004Y\266\373\366\302m\\\304\177\001\242h?\234";
    PyObject *data = __Pyx_DecompressString(cstring, 138, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (179 bytes) */
const char* const bytes = "?0DEFAULT_KROLE_LEVEL_DEFAULTSCOPE_GLOBALSCOPE_ORGSCOPE_THREADSCOPE_USERSYSTEM_USER_IDcline_in_tracebackglobal__main____module____name__org__qualname__setdefault__test__threaduser";
    PyObject *data = NULL;
