...
{
    "distutils": {
        "name": "agentfoundry.utils.exceptions",
        "sources": [
            "agentfoundry/utils/exceptions.py"
        ]
    },
    "module_name": "agentfoundry.utils.exceptions"
}
END: Cython Metadata */
...
#define __PYX_HAVE__agentfoundry__utils__exceptions
#define __PYX_HAVE_API__agentfoundry__utils__exceptions
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "agentfoundry.utils.exceptions" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "agentfoundry.utils.exceptions"
extern int __pyx_module_is_main_agentfoundry__utils__exceptions;
int __pyx_module_is_main_agentfoundry__utils__exceptions = 0;

/* Implementation of "agentfoundry.utils.exceptions" */
...
#define __pyx_kp_u_2_21_2025 __pyx_string_tab[2]
#define __pyx_kp_u_Chris_Steel __pyx_string_tab[3]
#define __pyx_kp_u_Copyright_2025_Syntheticore_Corp __pyx_string_tab[4]
#define __pyx_kp_u_Syntheticore_Confidential __pyx_string_tab[5]
#define __pyx_kp_u_csteel_syntheticore_com __pyx_string_tab[6]
#define __pyx_n_u_Production __pyx_string_tab[7]
#define __pyx_n_u_author __pyx_string_tab[8]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[9]
#define __pyx_n_u_copyright __pyx_string_tab[10]
#define __pyx_n_u_credits __pyx_string_tab[11]
#define __pyx_n_u_date __pyx_string_tab[12]
...
#define __pyx_n_u_status __pyx_string_tab[20]
#define __pyx_n_u_test __pyx_string_tab[21]
#define __pyx_n_u_version __pyx_string_tab[22]
...
__Pyx_RefNannySetupContext("PyInit_exceptions", 0);
  ...
  if (__pyx_module_is_main_agentfoundry__utils__exceptions) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "agentfoundry.utils.exceptions")) {
      if (unlikely((PyDict_SetItemString(modules, "agentfoundry.utils.exceptions", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_author, __pyx_mstate_global->__pyx_kp_u_Chris_Steel) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_copyright, __pyx_mstate_global->__pyx_kp_u_Copyright_2025_Syntheticore_Corp) < (0)) __PYX_ERR(0, 2, __pyx_L1_error)

  __pyx_t_2 = __Pyx_PyList_Pack(1, __pyx_mstate_global->__pyx_kp_u_Chris_Steel); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_credits, __pyx_t_2) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_date, __pyx_mstate_global->__pyx_kp_u_2_21_2025) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_license, __pyx_mstate_global->__pyx_kp_u_Syntheticore_Confidential) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_version, __pyx_mstate_global->__pyx_kp_u_1_0) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_email, __pyx_mstate_global->__pyx_kp_u_csteel_syntheticore_com) < (0)) __PYX_ERR(0, 7, __pyx_L1_error)

  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_status, __pyx_mstate_global->__pyx_n_u_Production) < (0)) __PYX_ERR(0, 8, __pyx_L1_error)
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init agentfoundry.utils.exceptions", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init agentfoundry.utils.exceptions");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{3},{9},{11},{40},{25},{23},{10},{10},{18},{13},{11},{8},{9},{11},{8},{10},{8},{12},{10},{10},{8},{11}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (222 bytes) */
const char* const cstring = "BZh91AY&SY\313\033\350b\000\000\020\337\200@\000@\005\362\000\310\000H\000\277\357\377 0\000\273m\r\022<\241\262\231\023\311\000\310\304\0214\3054\364\200\001\241\246\200\r4S\312\215\204\324\323\322\000\r\006A\006\272\rb\223\300\322DT\326\225\n\030S\264\241Os\340\272\004\nB\013['\n\010\021\227rCs\032 \211\007\204\274@\214\313\302\276*%\220\223!m-S\237\240\240\255\316\371\211\354\2522\3002Y\312Gr\273\014B\001\266\342\0222\254\205E\021\034\322S\304S\033\346\354\327\207\300\026\020J\315Y\377!\226\222\204\314-\376\2524b&l@v\027\361k\265\323\322\216\260n\030W\241\255!\316lNjK\026\225\237\272\210dq`\372\017\342\356H\247\n\022\031c}\014@";
    PyObject *data = __Pyx_DecompressString(cstring, 222, 2);
...
const char* const cstring = "x\332]\216]\212\002A\014\204\2572\007\020\177\006|^a. x\200&\246\243\023\354Ik\222\026\346\366\333\335\313\202\230\227*\276\220\252\374\034\266\373q7\036v\343~<N\263\262\r\027'JS~\256\312\367\331\207\266\330\014\227U|&g\314J\303\224\365\231\025\234\263|q\271q$q\206\204\326bN\366\261\337b^\316\232c\301v\031\002\024\237\263\206\200\211\205\002Kp\005\244+\340\243\262\377\376P\007\225\"\2735\033\301\251)-\300\251\231\304Hb\235U$]kE\352D`\351\372*\220\376\274\221G\272AI5\330\034\274\364T'\353EoR\353\257\375\002\303Ok\320";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (279 bytes) */
const char* const bytes = "?1.02/21/2025Chris SteelCopyright 2025, Syntheticore CorporationSyntheticore Confidentialcsteel@syntheticore.comProduction__author__cline_in_traceback__copyright____credits____date____email____license____main____module____name____qualname__setdefault__status____test____version__";
    PyObject *data = NULL;
