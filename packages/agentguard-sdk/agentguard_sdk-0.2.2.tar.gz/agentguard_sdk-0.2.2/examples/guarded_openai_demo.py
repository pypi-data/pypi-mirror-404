...
Demonstrates how to use GuardedOpenAI as a drop-in replacement
...
async def main():
    """Demonstrate GuardedOpenAI functionality."""
    print("=== GuardedOpenAI Demo ===\n")
    ...
    # 3. Create GuardedOpenAI client
    print("3. Creating GuardedOpenAI client...")
    ...
    # 9. Make a request with guardrails disabled
    print("9. Making request with guardrails disabled...")
    try:
        response = await client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
    ...
    # 10. Re-enable guardrails
    print("10. Re-enabling guardrails...")
    client.update_config(enable_guardrails=True)
    print("✓ Guardrails re-enabled\n")
