...
class TestWorkflowSubTaskSubTask(unittest.TestCase):
    """WorkflowSubTaskSubTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowSubTaskSubTask:
        """Test WorkflowSubTaskSubTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowSubTaskSubTask`
        """
        model = WorkflowSubTaskSubTask()
        if include_optional:
            return WorkflowSubTaskSubTask(
                parent_task_type = 'patient',
                uuid = '',
    ...
    def testWorkflowSubTaskSubTask(self):
        """Test WorkflowSubTaskSubTask"""
