...
class TestPrescriptionTask(unittest.TestCase):
    """PrescriptionTask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrescriptionTask:
        """Test PrescriptionTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrescriptionTask`
        """
        model = PrescriptionTask()
        if include_optional:
