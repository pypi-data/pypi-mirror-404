...
class TestPatientMedication(unittest.TestCase):
    """PatientMedication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientMedication:
        """Test PatientMedication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientMedication`
        """
    ...
    def testPatientMedication(self):
        """Test PatientMedication"""
