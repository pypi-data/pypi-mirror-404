...
class TestPharmacyProgramPricing(unittest.TestCase):
    """PharmacyProgramPricing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PharmacyProgramPricing:
        """Test PharmacyProgramPricing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PharmacyProgramPricing`
        """
        model = PharmacyProgramPricing()
        if include_optional:
            return PharmacyProgramPricing(
    ...
    def testPharmacyProgramPricing(self):
        """Test PharmacyProgramPricing"""
