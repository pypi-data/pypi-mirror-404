...
class TestMedicationProgramPricing(unittest.TestCase):
    """MedicationProgramPricing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedicationProgramPricing:
        """Test MedicationProgramPricing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedicationProgramPricing`
        """
        model = MedicationProgramPricing()
        if include_optional:
            return MedicationProgramPricing(
    ...
    def testMedicationProgramPricing(self):
        """Test MedicationProgramPricing"""
