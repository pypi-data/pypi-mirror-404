...
def get_table_schema(table_name: str) -> Dict[str, Any]:
    ...
    Raises:
        SchemaToolError: If table doesn't exist or query fails
    """
    try:
...
def get_relationships(table_name: str) -> Dict[str, Any]:
    ...
    (other tables referencing this one).
...
def search_tables(query: str) -> Dict[str, Any]:
    ...
    relevant tables. Returns results with relevance scores.
...
def get_column_stats(table_name: str, column_name: str) -> Dict[str, Any]:
    ...
    Raises:
        SchemaToolError: If column doesn't exist or query fails
    """
    try:
        _validate_table_name(table_name)
