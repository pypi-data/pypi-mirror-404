...
class ChemCompCategoryStyle(PdbxCategoryStyleBase):
    ...
    _categoryInfo = [('chem_comp', 'key-value'),
                     ...
                     ('pdbx_chem_comp_atom_coordination', 'table'),
                     ('pdbx_chem_comp_atom_coordination_sphere', 'table'),
    ...
    _cDict = {
        'chem_comp': [
            ...
            ('_chem_comp.pdbx_comp_type', '%s', 'str', ''),
        ...
        'chem_comp_bond': [
            ...
            ('_chem_comp_bond.pdbx_metal_pi_flag', '%s', 'str', ''),
            ('_chem_comp_bond.pdbx_metal_coordination_flag', '%s', 'str', ''),                        
            ('_chem_comp_bond.pdbx_ordinal', '%s', 'str', '')
        ],
        'pdbx_chem_comp_atom_coordination': [
            ('_pdbx_chem_comp_atom_coordination.geometry_id', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination.comp_id', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination.atom_id', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination.number', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination.geometry_calculated', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination.geometry_generic', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination.provenance', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination.geometry_abbr', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination.representative_entry_id', '%s', 'str', '')
        ],
        'pdbx_chem_comp_atom_coordination_sphere': [
            ('_pdbx_chem_comp_atom_coordination_sphere.id', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination_sphere.geometry_id', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination_sphere.comp_id', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination_sphere.atom_id', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination_sphere.descriptor', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination_sphere.provenance', '%s', 'str', ''),
            ('_pdbx_chem_comp_atom_coordination_sphere.representative_entry_id', '%s', 'str', '')
        ],
    ...
    _excludeList = ['_pdbx_chem_comp_audit.annotator', '_pdbx_chem_comp_audit.details', '_pdbx_chem_comp_pcm.first_instance_model_db_code',
                    '_pdbx_chem_comp_atom_coordination.representative_entry_id', '_pdbx_chem_comp_atom_coordination_sphere.representative_entry_id']
    #
