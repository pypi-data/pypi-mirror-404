...
export class PrometheusMetrics implements IMetrics {
  ...
  constructor() {
    ...
    this.configureMetric('index_agent_requests_total', ['action']);
    this.configureMetric('index_agent_requests_success_total', ['action']);
    this.configureMetric('index_agent_requests_error_total', ['action']);
    this.configureMetric('index_agent_request_duration_seconds', ['action']);
    this.configureMetric('index_agent_repositories_indexed_total', []);
    this.configureMetric('index_agent_symbols_total', []);
    this.configureMetric('index_agent_symbols_by_type', ['type']);
    this.configureMetric('index_agent_files_indexed_total', []);
    this.configureMetric('index_agent_searches_performed_total', []);
    this.configureMetric('index_agent_references_found_total', []);
  }
