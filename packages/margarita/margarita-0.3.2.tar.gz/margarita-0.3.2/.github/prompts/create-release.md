...
4. run mike to create a new versioned docs site:
   ...
   ```
5. Commit all changes with a message like "Release vX.Y.Z".
6. Push the gh-pages branch to update the docs site:
   ```bash
   git checkout gh-pages
   git push origin gh-pages
   ```
7. Push the changes to the main branch with all tags:
   ```bash
