...
class OpenRouterModel(OpenAIChatModel):
    """A model that uses the OpenRouter API via OpenAI-compatible interface.

    This class is a convenience wrapper around `OpenAIChatModel` that sets the provider to `'openrouter'` by default.
    ...
    def __init__(
        ...
        *,
        ...
        | Provider[AsyncOpenAI] = 'openrouter',
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            provider: The provider to use. Defaults to `'openrouter'`.
