...
class DeviceHealthAggregationsApi:
    ...
    def _get_device_health_metric_aggregation_list_serialize(
        ...
        """Serialize parameters for get_device_health_metric_aggregation_list.

        :param metric: The metric for the device health aggregation detailed list.
    ...
    def _get_device_health_metric_aggregations_serialize(
        ...
        """Serialize parameters for get_device_health_metric_aggregations.
