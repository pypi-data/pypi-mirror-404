...
class CompletionStatusDto(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the device. Note: this will be the name of the node on the cdFMC if the device is part of an HA pair or cluster.")
    ...
    percentage_complete: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Percentage completion of the current task being performed.", alias="percentageComplete")
