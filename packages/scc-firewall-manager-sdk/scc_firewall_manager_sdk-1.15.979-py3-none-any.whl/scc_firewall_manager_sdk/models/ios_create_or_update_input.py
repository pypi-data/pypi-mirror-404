...
class IosCreateOrUpdateInput(BaseModel):
    ...
    """ # noqa: E501
    connector_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The name of the Secure Device Connector (SDC) that will be used to communicate with the device.", alias="connectorName")
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="A human-readable name for the device.")
    password: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The password used to authenticate with the device.")
    username: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The username used to authenticate with the device.")
