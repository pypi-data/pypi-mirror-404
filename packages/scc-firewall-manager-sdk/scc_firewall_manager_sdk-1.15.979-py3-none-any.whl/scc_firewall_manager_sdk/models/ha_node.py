...
class HaNode(BaseModel):
    ...
    role: Optional[StrictStr] = Field(default=None, description="(cdFMC-managed FTDs only) Information on the current role of the node in the HA Pair.")
    ...
    __properties: ClassVar[List[str]] = ["chassisSerial", "name", "role", "serial", "softwareVersion", "status", "uidOnFmc"]
