...
class MspManagedDeviceManager(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "connectivityState", "dedicatedCdFmcInstance", "deviceManagerType", "fmcDomainUid", "managedTenantDisplayName", "managedTenantName", "managedTenantRegion", "managedTenantUid", "name", "softwareVersion", "tenantUid", "uid"]
