...
class SearchApi:
    ...
    def _initiate_full_indexing_serialize(
        ...
        """Serialize parameters for initiate_full_indexing.
    ...
    def _search_serialize(
        ...
        """Serialize parameters for search.

        :param q: This can be any non-empty string, and represents the search criteria. Spaces are allowed, but must be URL encoded.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
