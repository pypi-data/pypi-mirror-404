...
class MSPTenantManagementApi:
    ...
    def _add_msp_tenant_serialize(
        ...
        """Serialize parameters for add_msp_tenant.

        :param msp_add_tenant_input:
    ...
    def _add_tenant_to_msp_portal_serialize(
        ...
        """Serialize parameters for add_tenant_to_msp_portal.

        :param tenant_uid: Unique identifier of the tenant to add to the MSP portal.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _create_tenant_serialize(
        ...
        """Serialize parameters for create_tenant.

        :param msp_create_tenant_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _enable_multicloud_defense_for_tenant_in_msp_portal_serialize(
        ...
        """Serialize parameters for enable_multicloud_defense_for_tenant_in_msp_portal.

        :param tenant_uid: Unique identifier of the tenant that Multicloud Defense will be enabled for.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _generate_api_token_for_user_in_tenant_serialize(
        ...
        """Serialize parameters for generate_api_token_for_user_in_tenant.

        :param tenant_uid: The unique identifier of the tenant in Security Cloud Control.
        :param api_user_uid: The unique identifier of the API-only user in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_msp_managed_tenant_serialize(
        ...
        """Serialize parameters for get_msp_managed_tenant.
    ...
    def _get_msp_managed_tenants_serialize(
        ...
        """Serialize parameters for get_msp_managed_tenants.
    ...
    def _provision_cd_fmc_for_tenant_in_msp_portal_serialize(
        ...
        """Serialize parameters for provision_cd_fmc_for_tenant_in_msp_portal.

        :param tenant_uid: Unique identifier of the tenant that cdFMC provisioning will be enabled for.
        :param enable_cd_fmc_for_tenant_request:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
    ...
    def _remove_tenant_from_msp_portal_serialize(
        ...
        """Serialize parameters for remove_tenant_from_msp_portal.

        :param tenant_uid: The unique identifier, represented as a UUID, of the tenant in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
