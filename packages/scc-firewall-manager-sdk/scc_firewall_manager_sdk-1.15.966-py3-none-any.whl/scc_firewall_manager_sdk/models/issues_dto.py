...
class IssuesDto(BaseModel):
    ...
    duplicates_ignored: Optional[StrictBool] = Field(default=None, alias="duplicatesIgnored")
    unused_ignored: Optional[StrictBool] = Field(default=None, alias="unusedIgnored")
    unused_target_ids: Optional[List[StrictStr]] = Field(default=None, alias="unusedTargetIds")
    __properties: ClassVar[List[str]] = ["duplicateTargetIds", "duplicatesIgnored", "unusedIgnored", "unusedTargetIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "duplicatesIgnored": obj.get("duplicatesIgnored"),
            "unusedIgnored": obj.get("unusedIgnored"),
