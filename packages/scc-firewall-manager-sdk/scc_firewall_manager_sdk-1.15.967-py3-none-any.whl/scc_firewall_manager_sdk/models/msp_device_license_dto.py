...
class MspDeviceLicenseDto(BaseModel):
    """
    MspDeviceLicenseDto
    """ # noqa: E501
    ...
    is_export_control_features_allowed: Optional[StrictBool] = Field(default=None, description="Indicates if export control features are allowed on the device.", alias="isExportControlFeaturesAllowed")
    ...
    licenses: Optional[List[MspDeviceLicenseDetail]] = Field(default=None, description="The list of licenses enabled on the device.")
    managed_tenant_uid: Optional[StrictStr] = Field(default=None, description="The unique identifier, represented as a UUID, of the managed tenant associated with the device.", alias="managedTenantUid")
    ...
    smart_account: Optional[SmartAccountDto] = Field(default=None, alias="smartAccount")
    ...
    __properties: ClassVar[List[str]] = ["complianceStatus", "deviceType", "isEvaluationLicenseExpired", "isExportControlFeaturesAllowed", "lastUpdatedTime", "licenseStatus", "licenses", "managedTenantUid", "modelNumber", "name", "serial", "smartAccount", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "licenses": [MspDeviceLicenseDetail.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None,
            "managedTenantUid": obj.get("managedTenantUid"),
            "modelNumber": obj.get("modelNumber"),
            "name": obj.get("name"),
            "serial": obj.get("serial"),
            "smartAccount": SmartAccountDto.from_dict(obj["smartAccount"]) if obj.get("smartAccount") is not None else None,
            "uid": obj.get("uid")
        })
        return _obj
