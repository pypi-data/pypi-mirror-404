...
class UsersApi:
    ...
    def _create_active_directory_group_serialize(
        ...
        """Serialize parameters for create_active_directory_group.

        :param active_directory_group_create_or_update_input:
    ...
    def _create_multiple_users_serialize(
        ...
        """Serialize parameters for create_multiple_users.

        :param user_create_or_update_input:
        :param x_calling_service:
        :param x_request_metadata: Custom metadata to identify the request
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
    ...
    def _create_user_serialize(
        ...
        """Serialize parameters for create_user.
    ...
    def _delete_active_directory_group_serialize(
        ...
        """Serialize parameters for delete_active_directory_group.

        :param group_uid: The unique identifier, represented as a UUID, of the Active Directory Group in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _delete_multiple_users_serialize(
        ...
        """Serialize parameters for delete_multiple_users.
    ...
    def _delete_user_serialize(
        ...
        """Serialize parameters for delete_user.

        :param user_uid: The unique identifier of the user in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _generate_api_token_serialize(
        ...
        """Serialize parameters for generate_api_token.

        :param api_user_uid: The unique identifier, represented as a UUID, of the API-only user in Security Cloud Control
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_active_directory_group_serialize(
        ...
        """Serialize parameters for get_active_directory_group.
    ...
    def _get_active_directory_groups_serialize(
        ...
        """Serialize parameters for get_active_directory_groups.
    ...
    def _get_api_only_users_serialize(
        ...
        """Serialize parameters for get_api_only_users.
    ...
    def _get_token_serialize(
        ...
        """Serialize parameters for get_token.
    ...
    def _get_user_serialize(
        ...
        """Serialize parameters for get_user.
    ...
    def _get_users_serialize(
        ...
        """Serialize parameters for get_users.
    ...
    def _modify_active_directory_group_serialize(
        ...
        """Serialize parameters for modify_active_directory_group.
    ...
    def _revoke_api_token_serialize(
        ...
        """Serialize parameters for revoke_api_token.

        :param api_user_uid: The unique identifier, represented as a UUID, of the API user in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _revoke_token_serialize(
        ...
        """Serialize parameters for revoke_token.
