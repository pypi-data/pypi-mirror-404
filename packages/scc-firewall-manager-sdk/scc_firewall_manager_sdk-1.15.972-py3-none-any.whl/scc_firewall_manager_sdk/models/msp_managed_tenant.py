...
class MspManagedTenant(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dedicatedCdFmcInstance", "displayName", "name", "region", "uid"]
    ...
    def region_validate_enum(cls, value):
        ...
        if value not in set(['US', 'EU', 'APJ', 'AUS', 'IN', 'CI', 'SCALE', 'STAGING', 'DEVFED', 'STGF9', 'DEVF9', 'PRODF9', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('US', 'EU', 'APJ', 'AUS', 'IN', 'CI', 'SCALE', 'STAGING', 'DEVFED', 'STGF9', 'DEVF9', 'PRODF9', 'UNKNOWN')")
        return value
