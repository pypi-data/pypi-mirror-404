...
class InterfaceHealthAggregationsApi:
    ...
    def _get_interface_health_metric_aggregation_list_serialize(
        ...
        """Serialize parameters for get_interface_health_metric_aggregation_list.

        :param metric: The metric for the device interface health aggregation detailed list. (e.g. linkStatus,overruns).
        :param threshold: The metric threshold (e.g. CRITICAL).
        :param aggregation_period: The aggregation period of the metrics returned.
        :param managed_tenant_uid: A managed tenant UUID to filter list, if applicable.
        :param q: Lucene-style query filter. Only prefix queries (e.g. field:value*) and wildcard queries (e.g. field:*value or field:*value*) are supported for filtering.
    ...
    def _get_interface_health_metric_aggregations_serialize(
        ...
        """Serialize parameters for get_interface_health_metric_aggregations.
    ...
    def _get_interface_health_metric_error_aggregations_serialize(
        ...
        """Serialize parameters for get_interface_health_metric_error_aggregations.
