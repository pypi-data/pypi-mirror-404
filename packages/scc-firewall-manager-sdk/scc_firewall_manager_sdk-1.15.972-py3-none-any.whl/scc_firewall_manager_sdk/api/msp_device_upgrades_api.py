...
class MSPDeviceUpgradesApi:
    ...
    def _calculate_msp_ftd_compatible_upgrade_versions_serialize(
        ...
        """Serialize parameters for calculate_msp_ftd_compatible_upgrade_versions.

        :param msp_calculate_compatible_upgrade_versions_input:
    ...
    def _delete_msp_device_upgrade_run_serialize(
        ...
        """Serialize parameters for delete_msp_device_upgrade_run.
    ...
    def _get_msp_device_upgrade_run_serialize(
        ...
        """Serialize parameters for get_msp_device_upgrade_run.

        :param msp_upgrade_run_uid: The unique identifier, represented as a UUID, of the FTD Device Upgrade Run in SCC Firewall Manager.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_msp_device_upgrade_runs_serialize(
        ...
        """Serialize parameters for get_msp_device_upgrade_runs.
    ...
    def _get_msp_ftd_compatible_upgrade_versions_serialize(
        ...
        """Serialize parameters for get_msp_ftd_compatible_upgrade_versions.

        :param upgrade_version_uid: Unique identifier, represented as a UUID, of the Device Upgrade Version object in SCC Firewall Manager.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_msp_upgrade_runs_attribute_values_serialize(
        ...
        """Serialize parameters for get_msp_upgrade_runs_attribute_values.
    ...
    def _upgrade_msp_managed_ftd_devices_serialize(
        ...
        """Serialize parameters for upgrade_msp_managed_ftd_devices.

        :param msp_upgrade_ftd_devices_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
