...
class ConnectorsApi:
    ...
    def _create_sdc_serialize(
        ...
        """Serialize parameters for create_sdc.

        :param sdc_create_input:
    ...
    def _delete_sdc_serialize(
        ...
        """Serialize parameters for delete_sdc.

        :param sdc_uid: The unique identifier, represented as a UUID, of the SDC in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_sdc_serialize(
        ...
        """Serialize parameters for get_sdc.
    ...
    def _get_sdcs_serialize(
        ...
        """Serialize parameters for get_sdcs.
    ...
    def _modify_sdc_serialize(
        ...
        """Serialize parameters for modify_sdc.

        :param sdc_uid: The unique identifier, represented as a UUID, of the SDC in Security Cloud Control.
        :param sdc_patch_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
