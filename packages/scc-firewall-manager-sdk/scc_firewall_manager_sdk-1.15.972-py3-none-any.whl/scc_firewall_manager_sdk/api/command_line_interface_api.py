...
class CommandLineInterfaceApi:
    ...
    def _create_cli_macro_serialize(
        ...
        """Serialize parameters for create_cli_macro.

        :param cli_macro_create_input:
    ...
    def _delete_cli_macro_serialize(
        ...
        """Serialize parameters for delete_cli_macro.

        :param macro_uid: The unique identifier, represented as a UUID, of the CDO CLI macro in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _execute_cli_command_serialize(
        ...
        """Serialize parameters for execute_cli_command.
    ...
    def _execute_cli_macro_serialize(
        ...
        """Serialize parameters for execute_cli_macro.
    ...
    def _get_cli_macro_serialize(
        ...
        """Serialize parameters for get_cli_macro.
    ...
    def _get_cli_macros_serialize(
        ...
        """Serialize parameters for get_cli_macros.
    ...
    def _get_cli_result_serialize(
        ...
        """Serialize parameters for get_cli_result.

        :param cli_result_uid: The unique identifier, represented as a UUID, of the CDO CLI result in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_cli_results_serialize(
        ...
        """Serialize parameters for get_cli_results.
    ...
    def _modify_cli_macro_serialize(
        ...
        """Serialize parameters for modify_cli_macro.

        :param macro_uid: The unique identifier, represented as a UUID, of the CDO CLI macro in Security Cloud Control.
        :param cli_macro_patch_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
