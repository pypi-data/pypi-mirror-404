...
class ObjectManagementApi:
    ...
    def _create_object_serialize(
        ...
        """Serialize parameters for create_object.
    ...
    def _create_targets_serialize(
        ...
        """Serialize parameters for create_targets.

        :param uid: the unique identifier of the object for which the targets are being added to.
        :param targets_request:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _delete_object_serialize(
        ...
        """Serialize parameters for delete_object.

        :param uid: The unique identifier of the object being deleted.
        :param forced_delete: Force mode is required to delete an object that hasn't targets but is in use by another object.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
    ...
    def _delete_targets_serialize(
        ...
        """Serialize parameters for delete_targets.

        :param uid: the unique identifier of the object for which the targets are being removed from.
        :param target_uuids: The list of UIDs of the targets being removed.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_duplicate_objects_serialize(
        ...
        """Serialize parameters for get_duplicate_objects.

        :param uid: The unique identifier of the object to retrieve duplicates for.
        :param target_uid: the unique identifier of the target to restrict the duplicate search to.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_issues_count_serialize(
        ...
        """Serialize parameters for get_issues_count.
    ...
    def _get_object_serialize(
        ...
        """Serialize parameters for get_object.

        :param uid: The unique identifier of the object being retrieved.
        :param fields: The scope of the fields to be retrieved. One of [\"@basic\", \"@detailed\"]. Defaults to \"@basic\".
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
    ...
    def _get_object_usages_serialize(
        ...
        """Serialize parameters for get_object_usages.

        :param uid: The unique identifier of the object to retrieve usages for.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_objects_serialize(
        ...
        """Serialize parameters for get_objects.
    ...
    def _get_override_object_serialize(
        ...
        """Serialize parameters for get_override_object.

        :param uid: The unique identifier of the object being retrieved.
        :param target_uid: The target UID to calculate values for.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_targets_serialize(
        ...
        """Serialize parameters for get_targets.

        :param uid: The unique identifier of the object for which the targets are being retrieved.
        :param q: The query to execute. Use the Lucene Query Syntax to construct your query. Possible fields to search by are: targetType.
        :param offset: The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified.
        :param limit: The number of results to retrieve.
        :param _request_auth: set to override the auth_settings for an a single request.
    ...
    def _modify_object_serialize(
        ...
        """Serialize parameters for modify_object.

        :param uid: The unique identifier of the object being updated.
