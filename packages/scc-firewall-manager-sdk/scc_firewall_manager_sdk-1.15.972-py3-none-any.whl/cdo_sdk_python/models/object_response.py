    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.references_info_from_default_and_overrides:
            for _item_references_info_from_default_and_overrides in self.references_info_from_default_and_overrides:
                if _item_references_info_from_default_and_overrides:
                    _items.append(_item_references_info_from_default_and_overrides.to_dict())
