...
class FmcHealthMetrics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chassisStatsHealthMetrics", "cpuHealthMetrics", "deviceName", "deviceUid", "diskHealthMetrics", "endTime", "haHealthMetrics", "interfaceHealthMetrics", "memoryHealthMetrics", "startTime", "vpnHealthMetrics"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.interface_health_metrics:
            for _item_interface_health_metrics in self.interface_health_metrics:
                if _item_interface_health_metrics:
                    _items.append(_item_interface_health_metrics.to_dict())
