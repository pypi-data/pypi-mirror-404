...
class Cause(BaseModel):
    ...
    def cause_types_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['SHADOWED_BY_NETWORK_ADDRESS', 'SHADOWED_BY_PORT', 'SHADOWED_BY_ICMP', 'SHADOWED_BY_ACTION', 'DUPLICATE_REMARK', 'UNKNOWN']):
                raise ValueError("each list item must be one of ('SHADOWED_BY_NETWORK_ADDRESS', 'SHADOWED_BY_PORT', 'SHADOWED_BY_ICMP', 'SHADOWED_BY_ACTION', 'DUPLICATE_REMARK', 'UNKNOWN')")
        return value
