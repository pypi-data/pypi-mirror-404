...
class CdoTokenInfo(BaseModel):
    ...
    tenant_pay_type: Optional[StrictStr] = Field(default=None, description="The pay type of the tenant this token is associated with.", alias="tenantPayType")
    ...
    __properties: ClassVar[List[str]] = ["enterpriseId", "expiresAt", "name", "productInstanceId", "roles", "tenantName", "tenantPayType", "tenantUid", "uid"]

    @field_validator('tenant_pay_type')
    def tenant_pay_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tenantPayType": obj.get("tenantPayType"),
