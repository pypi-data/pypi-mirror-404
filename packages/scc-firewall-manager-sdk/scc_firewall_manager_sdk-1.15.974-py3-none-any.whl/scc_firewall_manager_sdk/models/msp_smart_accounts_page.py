...
class MspSmartAccountsPage(BaseModel):
    """
    MspSmartAccountsPage
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="The total number of results available.")
    items: Optional[List[MspSmartAccountDto]] = Field(default=None, description="The list of items retrieved.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MspSmartAccountsPage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MspSmartAccountsPage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "items": [MspSmartAccountDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "limit": obj.get("limit"),
