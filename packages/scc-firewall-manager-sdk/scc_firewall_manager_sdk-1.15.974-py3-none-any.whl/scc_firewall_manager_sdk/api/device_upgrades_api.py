...
class DeviceUpgradesApi:
    ...
    def _delete_device_upgrade_run_serialize(
        ...
        """Serialize parameters for delete_device_upgrade_run.

        :param uid: The unique identifier, represented as a UUID, of the FTD Device Upgrade Run in SCC Firewall Manager.
    ...
    def _get_asa_upgrade_versions_serialize(
        ...
        """Serialize parameters for get_asa_upgrade_versions.
    ...
    def _get_compatible_asa_versions_for_multiple_asas_serialize(
        ...
        """Serialize parameters for get_compatible_asa_versions_for_multiple_asas.

        :param device_uids: A list of unique identifiers, represented as UUIDs, of the devices in Security Cloud Control.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_compatible_ftd_versions_serialize(
        ...
        """Serialize parameters for get_compatible_ftd_versions.
    ...
    def _get_compatible_ftd_versions_for_multiple_ftds_serialize(
        ...
        """Serialize parameters for get_compatible_ftd_versions_for_multiple_ftds.
    ...
    def _get_device_upgrade_run_serialize(
        ...
        """Serialize parameters for get_device_upgrade_run.

        :param upgrade_run_uid: The unique identifier, represented as a UUID, of the FTD Device Upgrade Run in SCC Firewall Manager.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_device_upgrade_runs_serialize(
        ...
        """Serialize parameters for get_device_upgrade_runs.
    ...
    def _modify_device_upgrade_run_serialize(
        ...
        """Serialize parameters for modify_device_upgrade_run.

        :param upgrade_run_uid: The unique identifier, represented as a UUID, of the FTD Device Upgrade Run in SCC Firewall Manager.
        :param upgrade_run_modify_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _update_ftd_upgrade_packages_cache_serialize(
        ...
        """Serialize parameters for update_ftd_upgrade_packages_cache.
    ...
    def _upgrade_asa_device_serialize(
        ...
        """Serialize parameters for upgrade_asa_device.

        :param device_uid: The unique identifier, represented as a UUID, of the device in Security Cloud Control.
        :param upgrade_asa_device_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _upgrade_asa_devices_serialize(
        ...
        """Serialize parameters for upgrade_asa_devices.

        :param upgrade_asa_devices_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _upgrade_ftd_device_serialize(
        ...
        """Serialize parameters for upgrade_ftd_device.

        :param device_uid: The unique identifier, represented as a UUID, of the device in Security Cloud Control.
        :param upgrade_ftd_device_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _upgrade_ftd_devices_serialize(
        ...
        """Serialize parameters for upgrade_ftd_devices.

        :param upgrade_ftd_devices_input:
        :param x_calling_service:
        :param x_request_metadata: Custom metadata to identify the request
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
