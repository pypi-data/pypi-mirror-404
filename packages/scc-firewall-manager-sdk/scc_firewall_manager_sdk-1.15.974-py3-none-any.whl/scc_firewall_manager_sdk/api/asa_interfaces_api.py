...
class ASAInterfacesApi:
    ...
    def _create_asa_ether_channel_interface_serialize(
        ...
        """Serialize parameters for create_asa_ether_channel_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param ether_channel_interface_create_input:
    ...
    def _create_asa_sub_interface_serialize(
        ...
        """Serialize parameters for create_asa_sub_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA parent interface.
        :param sub_interface_create_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _create_asa_vlan_interface_serialize(
        ...
        """Serialize parameters for create_asa_vlan_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param vlan_interface_create_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _delete_asa_ether_channel_interface_serialize(
        ...
        """Serialize parameters for delete_asa_ether_channel_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA EtherChannel interface.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _delete_asa_sub_interface_serialize(
        ...
        """Serialize parameters for delete_asa_sub_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA subinterface.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _delete_asa_vlan_interface_serialize(
        ...
        """Serialize parameters for delete_asa_vlan_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA VLAN interface.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_asa_ether_channel_interface_serialize(
        ...
        """Serialize parameters for get_asa_ether_channel_interface.
    ...
    def _get_asa_ether_channel_interfaces_serialize(
        ...
        """Serialize parameters for get_asa_ether_channel_interfaces.
    ...
    def _get_asa_interface_sub_interfaces_serialize(
        ...
        """Serialize parameters for get_asa_interface_sub_interfaces.
    ...
    def _get_asa_physical_interface_serialize(
        ...
        """Serialize parameters for get_asa_physical_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA physical interface.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_asa_physical_interfaces_serialize(
        ...
        """Serialize parameters for get_asa_physical_interfaces.
    ...
    def _get_asa_sub_interface_serialize(
        ...
        """Serialize parameters for get_asa_sub_interface.
    ...
    def _get_asa_sub_interfaces_serialize(
        ...
        """Serialize parameters for get_asa_sub_interfaces.
    ...
    def _get_asa_virtual_tunnel_interface_serialize(
        ...
        """Serialize parameters for get_asa_virtual_tunnel_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA virtual tunnel interface.
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _get_asa_virtual_tunnel_interfaces_serialize(
        ...
        """Serialize parameters for get_asa_virtual_tunnel_interfaces.
    ...
    def _get_asa_vlan_interface_serialize(
        ...
        """Serialize parameters for get_asa_vlan_interface.
    ...
    def _get_asa_vlan_interfaces_serialize(
        ...
        """Serialize parameters for get_asa_vlan_interfaces.
    ...
    def _modify_asa_ether_channel_interface_serialize(
        ...
        """Serialize parameters for modify_asa_ether_channel_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA EtherChannel interface.
        :param ether_channel_interface_patch_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _modify_asa_physical_interface_serialize(
        ...
        """Serialize parameters for modify_asa_physical_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA physical interface.
        :param physical_interface_patch_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _modify_asa_sub_interface_serialize(
        ...
        """Serialize parameters for modify_asa_sub_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA subinterface.
        :param sub_interface_patch_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
    ...
    def _modify_asa_vlan_interface_serialize(
        ...
        """Serialize parameters for modify_asa_vlan_interface.

        :param device_uid: Unique identifier (UUID) of the device.
        :param interface_uid: Unique identifier (UUID) of the ASA VLAN interface.
        :param vlan_interface_patch_input:
        :param _request_auth: set to override the auth_settings for an a single request.
        :param _content_type: force content-type for the request.
        :param _headers: set to override the headers for a single request.
        :param _host_index: set to override the host_index for a single request.
