...
TEMPLATE_PARAMS = {
    ...
    "model_metrics_s3_path": "s3://sandbox-sageworks-artifacts/models/logd-xgb-split-butina/training",
    "hyperparameters": {'n_estimators': 200, 'max_depth': 6, 'split_strategy': 'butina'},
}
...
if __name__ == "__main__":
    ...
    if n_folds == 1 and "training" in all_df.columns:
        ...
        folds, split_groups = get_split_indices(
            all_df,
            n_splits=n_folds,
        ...
        all_df["split_group"] = split_groups
        print(f"Split strategy: {split_strategy} ({len(np.unique(split_groups))} groups)")
