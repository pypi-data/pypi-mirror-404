...
class Deauth(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        user_type: Literal["proxy", "firewall"] | None = None,
        id: Any | None = None,
        ip: str | None = None,
        ...
        """
        Create new user/firewall/deauth object.
        ...
        Examples:
            ...
            >>> payload = Deauth.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.user_firewall_deauth.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Deauth.required_fields()) }}
            
            Use Deauth.help('field_name') to get field details.
        ...
        from ._helpers.deauth import DEPRECATED_FIELDS
