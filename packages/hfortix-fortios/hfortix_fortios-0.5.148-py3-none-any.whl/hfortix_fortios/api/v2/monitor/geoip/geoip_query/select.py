...
class Select(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new geoip/geoip_query/select object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.geoip_geoip_query_select.post(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/geoip/geoip_query/select",
            )
