...
class Dynamic(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/external_resource/dynamic object.
        ...
        Examples:
            ...
            >>> payload = Dynamic.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_external_resource_dynamic.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Dynamic.required_fields()) }}
            
            Use Dynamic.help('field_name') to get field details.
        ...
        from ._helpers.dynamic import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/external_resource/dynamic",
            )
