...
class Upload(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/lte_modem/upload object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_lte_modem_upload.post(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/system/lte_modem/upload",
            )
