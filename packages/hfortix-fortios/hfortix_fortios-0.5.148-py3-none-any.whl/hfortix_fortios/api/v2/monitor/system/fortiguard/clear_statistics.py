...
class ClearStatistics(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/fortiguard/clear_statistics object.
        ...
        Examples:
            ...
            >>> payload = ClearStatistics.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_fortiguard_clear_statistics.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ClearStatistics.required_fields()) }}
            
            Use ClearStatistics.help('field_name') to get field details.
        ...
        from ._helpers.clear_statistics import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/fortiguard/clear_statistics",
            )
