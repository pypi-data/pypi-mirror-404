...
class Test(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/automation_stitch/test object.
        ...
        Examples:
            ...
            >>> payload = Test.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_automation_stitch_test.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Test.required_fields()) }}
            
            Use Test.help('field_name') to get field details.
        ...
        from ._helpers.test import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/automation_stitch/test",
            )
