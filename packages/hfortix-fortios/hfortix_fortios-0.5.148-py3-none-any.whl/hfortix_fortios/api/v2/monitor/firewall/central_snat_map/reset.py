...
class Reset(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new firewall/central_snat_map/reset object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.firewall_central_snat_map_reset.post(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/firewall/central_snat_map/reset",
            )
