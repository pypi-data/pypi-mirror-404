...
class CloseAll(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new firewall/session/close_all object.
        ...
        Examples:
            ...
            >>> payload = CloseAll.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.firewall_session_close_all.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(CloseAll.required_fields()) }}
            
            Use CloseAll.help('field_name') to get field details.
        ...
        from ._helpers.close_all import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/firewall/session/close_all",
            )
