...
class TunnelResetStats(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new vpn/ipsec/tunnel_reset_stats object.
        ...
        Examples:
            ...
            >>> payload = TunnelResetStats.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.vpn_ipsec_tunnel_reset_stats.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(TunnelResetStats.required_fields()) }}
            
            Use TunnelResetStats.help('field_name') to get field details.
        ...
        from ._helpers.tunnel_reset_stats import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/vpn/ipsec/tunnel_reset_stats",
            )
