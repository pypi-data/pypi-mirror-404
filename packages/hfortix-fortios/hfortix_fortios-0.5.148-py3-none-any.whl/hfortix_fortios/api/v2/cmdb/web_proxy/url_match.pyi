...
class UrlMatchPayload(TypedDict, total=False):
    """Payload type for UrlMatch operations."""
    name: str
...
class UrlMatchResponse(TypedDict, total=False):
    """Response type for UrlMatch - use with .dict property for typed dict access."""
    name: str
    status: Literal["enable", "disable"]
    url_pattern: str
    forward_server: str
...
class UrlMatchObject(FortiObject):
    """Typed FortiObject for UrlMatch with field access."""
    name: str
    status: Literal["enable", "disable"]
    url_pattern: str
    forward_server: str
