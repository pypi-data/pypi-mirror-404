"""
FortiOS CMDB - User tacacs_plus_

Configuration endpoint for managing cmdb user/tacacs_plus_ objects.
...
class TacacsPlus(CRUDEndpoint, MetadataMixin):
    ...
    _helper_module_name = "tacacs_plus_"
    ...
    def get(
        ...
        """
        Retrieve user/tacacs_plus_ configuration.
        ...
        Examples:
            >>> # Get all user/tacacs_plus_ objects
            >>> result = fgt.api.cmdb.user_tacacs_plus.get()
            >>> print(f"Found {len(result['results'])} objects")
            
            >>> # Get specific user/tacacs_plus_ by name
        ...
        See Also:
            - post(): Create new user/tacacs_plus_ object
            - put(): Update existing user/tacacs_plus_ object
            - delete(): Remove user/tacacs_plus_ object
    ...
    def put(
        ...
        """
        Update existing user/tacacs_plus_ object.
        ...
        from ._helpers.tacacs_plus_ import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="cmdb/user/tacacs_plus_",
            )
    ...
    def post(
        ...
        """
        Create new user/tacacs_plus_ object.
    ...
    def delete(
        ...
        """
        Delete user/tacacs_plus_ object.
    ...
    def exists(
        ...
        """
        Check if user/tacacs_plus_ object exists.
    ...
    def set(
        ...
        **kwargs: Any,
        ...
        """
        Create or update user/tacacs_plus_ object (intelligent operation).
    ...
    def move(
        ...
        **kwargs: Any,
        ...
        """
        Move user/tacacs_plus_ object to a new position.
    ...
    def clone(
        ...
        **kwargs: Any,
        ...
        """
        Clone user/tacacs_plus_ object.
