...
class CustomCommand(CRUDEndpoint, MetadataMixin):
    ...
    def get(
        ...
        if command_name:
            endpoint = "/switch-controller/custom-command/" + quote_path_param(command_name)
            unwrap_single = True
        else:
    ...
    def put(
        ...
        endpoint = "/switch-controller/custom-command/" + quote_path_param(command_name_value)
    ...
    def exists(
        ...
        endpoint = "/switch-controller/custom-command"
        endpoint = f"{endpoint}/{quote_path_param(command_name)}"
