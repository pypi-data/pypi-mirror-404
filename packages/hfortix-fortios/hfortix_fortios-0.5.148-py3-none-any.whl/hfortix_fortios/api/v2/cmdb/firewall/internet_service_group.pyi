...
class InternetServiceGroupPayload(TypedDict, total=False):
    """Payload type for InternetServiceGroup operations."""
    name: str
    comment: str
...
class InternetServiceGroupResponse(TypedDict, total=False):
    """Response type for InternetServiceGroup - use with .dict property for typed dict access."""
    name: str
    comment: str
    direction: Literal["source", "destination", "both"]
...
class InternetServiceGroup:
    ...
    def get(
        ...
        *,
        ...
        error_mode: Literal["raise", "return", "print"] | None = ...,
        error_format: Literal["detailed", "simple", "code_only"] | None = ...,
    ) -> FortiObjectList[InternetServiceGroupObject]: ...
