...
class RecurringPayload(TypedDict, total=False):
    """Payload type for Recurring operations."""
    name: str
    uuid: str
    start: str
    end: str
...
class RecurringResponse(TypedDict, total=False):
    """Response type for Recurring - use with .dict property for typed dict access."""
    name: str
    uuid: str
    start: str
    end: str
...
class RecurringObject(FortiObject):
    """Typed FortiObject for Recurring with field access."""
    name: str
    uuid: str
    start: str
    end: str
