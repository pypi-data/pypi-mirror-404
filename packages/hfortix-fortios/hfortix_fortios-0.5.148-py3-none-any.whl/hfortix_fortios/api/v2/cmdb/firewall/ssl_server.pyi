...
class SslServerPayload(TypedDict, total=False):
    """Payload type for SslServer operations."""
    name: str
    ip: str
    port: int
...
class SslServerResponse(TypedDict, total=False):
    """Response type for SslServer - use with .dict property for typed dict access."""
    name: str
    ip: str
    port: int
    ssl_mode: Literal["half", "full"]
