...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.cmdb.firewall_global.get()
    >>>
    >>> # Create with auto-normalization (strings/lists converted automatically)
    >>> result = fgt.api.cmdb.firewall_global.post(
    ...     name="example",
...
class Global(CRUDEndpoint, MetadataMixin):
    ...
    def get(
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.firewall_global.get()
            ...
            >>> schema = fgt.api.cmdb.firewall_global.get_schema()
        ...
        if name:
            endpoint = f"/firewall/global/{quote_path_param(name)}"
            unwrap_single = True
        else:
    ...
    def get_schema(
        ...
        Example:
            ...
            >>> json_schema = fgt.api.cmdb.firewall_global.get_schema(format="json-schema")
    ...
    def put(
        ...
        Examples:
            ...
            >>> result = fgt.api.cmdb.firewall_global.put(
            ...
            ...     "field1": "new-value",
            ... }
            >>> result = fgt.api.cmdb.firewall_global.put(payload_dict=payload)
    ...
    def move(
        ...
        **kwargs: Any,
        ...
        Example:
            ...
            >>> fgt.api.cmdb.firewall_global.move(
            ...     name="object1",
            ...     action="before",
    ...
    def clone(
        ...
        **kwargs: Any,
        ...
        Example:
            ...
            >>> fgt.api.cmdb.firewall_global.clone(
            ...     name="template",
    ...
    def exists(
        ...
        Example:
            ...
            >>> if not fgt.api.cmdb.firewall_global.exists(name="myobj"):
            ...     fgt.api.cmdb.firewall_global.post(payload_dict=data)
        """
