"""Validation helpers for log/tacacs_plus_accounting2/filter - Auto-generated"""
...
def validate_log_tacacs_plus_accounting2_filter_get(
    attr: str | None = None,
    filters: dict[str, Any] | None = None,
    **params: Any,
) -> tuple[bool, str | None]:
    """Validate GET request parameters for log/tacacs_plus_accounting2/filter."""
...
def validate_log_tacacs_plus_accounting2_filter_post(
    payload: dict,
    **params: Any,
) -> tuple[bool, str | None]:
    """Validate POST request to create new log/tacacs_plus_accounting2/filter object."""
...
def validate_log_tacacs_plus_accounting2_filter_put(
    payload: dict,
    **params: Any,
) -> tuple[bool, str | None]:
    """Validate PUT request to update log/tacacs_plus_accounting2/filter."""
...
SCHEMA_INFO = {
    "endpoint": "log/tacacs_plus_accounting2/filter",
    "category": "cmdb",
