...
class DedicatedMgmtPayload(TypedDict, total=False):
    """Payload type for DedicatedMgmt operations."""
...
class DedicatedMgmtResponse(TypedDict, total=False):
    """Response type for DedicatedMgmt - use with .dict property for typed dict access."""
    status: Literal["enable", "disable"]
    interface: str
    default_gateway: str
    dhcp_server: Literal["enable", "disable"]
...
class DedicatedMgmtObject(FortiObject):
    """Typed FortiObject for DedicatedMgmt with field access."""
    status: Literal["enable", "disable"]
    interface: str
    default_gateway: str
    dhcp_server: Literal["enable", "disable"]
