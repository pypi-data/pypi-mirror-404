...
class NacQuarPayload(TypedDict, total=False):
    """Payload type for NacQuar operations."""
    msg_type: str
    buffer: str
...
class NacQuarResponse(TypedDict, total=False):
    """Response type for NacQuar - use with .dict property for typed dict access."""
    msg_type: str
    buffer: str
    header: Literal["none", "http", "8bit"]
    format: Literal["none", "text", "html"]
...
class NacQuarObject(FortiObject):
    """Typed FortiObject for NacQuar with field access."""
    msg_type: str
    buffer: str
    header: Literal["none", "http", "8bit"]
    format: Literal["none", "text", "html"]
