...
class DomainFilterPayload(TypedDict, total=False):
    """Payload type for DomainFilter operations."""
    id: int
    name: str
    comment: str
...
class DomainFilterResponse(TypedDict, total=False):
    """Response type for DomainFilter - use with .dict property for typed dict access."""
    id: int
    name: str
    comment: str
