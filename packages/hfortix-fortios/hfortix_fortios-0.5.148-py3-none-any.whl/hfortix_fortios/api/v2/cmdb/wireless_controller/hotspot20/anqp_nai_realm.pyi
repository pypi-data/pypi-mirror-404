...
class AnqpNaiRealmResponse(TypedDict, total=False):
    """Response type for AnqpNaiRealm - use with .dict property for typed dict access."""
    name: str
...
class AnqpNaiRealm:
    ...
    def get(
        ...
        *,
        ...
        error_mode: Literal["raise", "return", "print"] | None = ...,
        error_format: Literal["detailed", "simple", "code_only"] | None = ...,
    ) -> FortiObjectList[AnqpNaiRealmObject]: ...
