...
class ManualkeyPayload(TypedDict, total=False):
    """Payload type for Manualkey operations."""
    name: str
    interface: str
    remote_gw: str
    local_gw: str
...
class ManualkeyResponse(TypedDict, total=False):
    """Response type for Manualkey - use with .dict property for typed dict access."""
    name: str
    interface: str
    remote_gw: str
    local_gw: str
...
class ManualkeyObject(FortiObject):
    """Typed FortiObject for Manualkey with field access."""
    name: str
    interface: str
    remote_gw: str
    local_gw: str
