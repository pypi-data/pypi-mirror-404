...
class Phase1InterfacePayload(TypedDict, total=False):
    """Payload type for Phase1Interface operations."""
    name: str
...
class Phase1InterfaceResponse(TypedDict, total=False):
    """Response type for Phase1Interface - use with .dict property for typed dict access."""
    name: str
    type: Literal["static", "dynamic", "ddns"]
    interface: str
    ip_version: Literal["4", "6"]
