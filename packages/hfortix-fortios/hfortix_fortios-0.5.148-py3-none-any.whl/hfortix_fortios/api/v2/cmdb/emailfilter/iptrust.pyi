...
class IptrustPayload(TypedDict, total=False):
    """Payload type for Iptrust operations."""
    id: int
    name: str
    comment: str
...
class IptrustResponse(TypedDict, total=False):
    """Response type for Iptrust - use with .dict property for typed dict access."""
    id: int
    name: str
    comment: str
