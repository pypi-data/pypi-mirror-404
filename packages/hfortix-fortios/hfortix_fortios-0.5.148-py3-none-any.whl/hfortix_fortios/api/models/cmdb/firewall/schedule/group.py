...
class GroupMember(BaseModel):
    ...
    name: str = Field(max_length=79, description="Schedule name.")  # datasource: ['firewall.schedule.onetime.name', 'firewall.schedule.recurring.name']
# ============================================================================
...
class GroupModel(BaseModel):
    ...
    name: str = Field(max_length=31, description="Schedule group name.")    
    member: list[GroupMember] = Field(description="Schedules added to the schedule group.")    
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:53.279694Z
# ============================================================================