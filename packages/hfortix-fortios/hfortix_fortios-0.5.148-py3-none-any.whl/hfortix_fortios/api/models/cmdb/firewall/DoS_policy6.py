...
class DosPolicy6Model(BaseModel):
    ...
    srcaddr: list[DosPolicy6Srcaddr] = Field(description="Source address name from available addresses.")    
    dstaddr: list[DosPolicy6Dstaddr] = Field(description="Destination address name from available addresses.")    
    service: list[DosPolicy6Service] = Field(description="Service object from available options.")    
    anomaly: list[DosPolicy6Anomaly] = Field(default_factory=list, description="Anomaly name.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "DosPolicy6Model":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:53.524157Z
# ============================================================================