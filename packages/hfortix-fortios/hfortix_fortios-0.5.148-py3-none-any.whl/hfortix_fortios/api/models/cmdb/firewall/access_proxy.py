...
class AccessProxyApiGateway6SslCipherSuitesCipherEnum(str, Enum):
...
class AccessProxyApiGateway6SslCipherSuitesVersionsEnum(str, Enum):
...
class AccessProxyApiGateway6ServiceEnum(str, Enum):
...
class AccessProxyApiGateway6LdbMethodEnum(str, Enum):
...
class AccessProxyApiGateway6SslDhBitsEnum(str, Enum):
...
class AccessProxyApiGateway6SslMinVersionEnum(str, Enum):
...
class AccessProxyApiGateway6SslMaxVersionEnum(str, Enum):
...
class AccessProxyApiGatewaySslCipherSuitesCipherEnum(str, Enum):
...
class AccessProxyApiGatewaySslCipherSuitesVersionsEnum(str, Enum):
...
class AccessProxyApiGatewayServiceEnum(str, Enum):
...
class AccessProxyApiGatewayLdbMethodEnum(str, Enum):
...
class AccessProxyApiGatewaySslDhBitsEnum(str, Enum):
...
class AccessProxyApiGatewaySslMinVersionEnum(str, Enum):
...
class AccessProxyApiGatewaySslMaxVersionEnum(str, Enum):
...
class AccessProxyApiGateway6SslCipherSuites(BaseModel):
    """
    ...
    cipher: AccessProxyApiGateway6SslCipherSuitesCipherEnum = Field(description="Cipher suite name.")    
    versions: list[AccessProxyApiGateway6SslCipherSuitesVersionsEnum] = Field(default_factory=list, description="SSL/TLS versions that the cipher suite can be used with.")
class AccessProxyApiGateway6RealserversSshHostKey(BaseModel):
    """
...
class AccessProxyApiGateway6Realservers(BaseModel):
    """
    ...
    ssh_host_key: list[AccessProxyApiGateway6RealserversSshHostKey] = Field(default_factory=list, description="One or more server host key.")    
...
class AccessProxyApiGateway6Quic(BaseModel):
    """
...
class AccessProxyApiGateway6Application(BaseModel):
    """
...
class AccessProxyApiGateway6(BaseModel):
    ...
    service: AccessProxyApiGateway6ServiceEnum = Field(default=AccessProxyApiGateway6ServiceEnum.HTTPS, description="Service.")    
    ldb_method: AccessProxyApiGateway6LdbMethodEnum | None = Field(default=AccessProxyApiGateway6LdbMethodEnum.STATIC, description="Method used to distribute sessions to real servers.")    
    ...
    quic: AccessProxyApiGateway6Quic | None = Field(default=None, description="QUIC setting.")    
    realservers: list[AccessProxyApiGateway6Realservers] = Field(default_factory=list, description="Select the real servers that this Access Proxy will distribute traffic to.")    
    application: list[AccessProxyApiGateway6Application] = Field(description="SaaS application controlled by this Access Proxy.")    
    ...
    ssl_dh_bits: AccessProxyApiGateway6SslDhBitsEnum | None = Field(default=AccessProxyApiGateway6SslDhBitsEnum.V_2048, description="Number of bits to use in the Diffie-Hellman exchange for RSA encryption of SSL sessions.")    
    ...
    ssl_cipher_suites: list[AccessProxyApiGateway6SslCipherSuites] = Field(default_factory=list, description="SSL/TLS cipher suites to offer to a server, ordered by priority.")    
    ssl_min_version: AccessProxyApiGateway6SslMinVersionEnum | None = Field(default=AccessProxyApiGateway6SslMinVersionEnum.TLS_1_1, description="Lowest SSL/TLS version acceptable from a server.")    
    ssl_max_version: AccessProxyApiGateway6SslMaxVersionEnum | None = Field(default=AccessProxyApiGateway6SslMaxVersionEnum.TLS_1_3, description="Highest SSL/TLS version acceptable from a server.")    
...
class AccessProxyApiGatewaySslCipherSuites(BaseModel):
    """
    ...
    priority: int | None = Field(ge=0, le=4294967295, default=0, description="SSL/TLS cipher suites priority.")    
    cipher: AccessProxyApiGatewaySslCipherSuitesCipherEnum = Field(description="Cipher suite name.")    
    versions: list[AccessProxyApiGatewaySslCipherSuitesVersionsEnum] = Field(default_factory=list, description="SSL/TLS versions that the cipher suite can be used with.")
class AccessProxyApiGatewayRealserversSshHostKey(BaseModel):
    """
    ...
    name: str | None = Field(max_length=79, default=None, description="Server host key name.")  # datasource: ['firewall.ssh.host-key.name']
class AccessProxyApiGatewayRealservers(BaseModel):
    """
    ...
    ssh_client_cert: str | None = Field(max_length=79, default=None, description="Set access-proxy SSH client certificate profile.")  # datasource: ['firewall.access-proxy-ssh-client-cert.name']    
    ssh_host_key_validation: Literal["disable", "enable"] | None = Field(default="disable", description="Enable/disable SSH real server host key validation.")    
    ssh_host_key: list[AccessProxyApiGatewayRealserversSshHostKey] = Field(default_factory=list, description="One or more server host key.")    
    verify_cert: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable certificate verification of the real server.")
class AccessProxyApiGatewayQuic(BaseModel):
    """
    ...
    active_migration: Literal["enable", "disable"] | None = Field(default="disable", description="Enable/disable active migration (default = disable).")    
    grease_quic_bit: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable grease QUIC bit (default = enable).")
class AccessProxyApiGatewayApplication(BaseModel):
    """
...
class AccessProxyApiGateway(BaseModel):
    ...
    id_: int | None = Field(ge=0, le=4294967295, default=0, serialization_alias="id", description="API Gateway ID.")    
    url_map: str = Field(max_length=511, default="/", description="URL pattern to match.")    
    service: AccessProxyApiGatewayServiceEnum = Field(default=AccessProxyApiGatewayServiceEnum.HTTPS, description="Service.")    
    ldb_method: AccessProxyApiGatewayLdbMethodEnum | None = Field(default=AccessProxyApiGatewayLdbMethodEnum.STATIC, description="Method used to distribute sessions to real servers.")    
    virtual_host: str | None = Field(max_length=79, default=None, description="Virtual host.")  # datasource: ['firewall.access-proxy-virtual-host.name']    
    url_map_type: Literal["sub-string", "wildcard", "regex"] = Field(default="sub-string", description="Type of url-map.")    
    h2_support: Literal["enable", "disable"] = Field(default="enable", description="HTTP2 support, default=Enable.")    
    h3_support: Literal["enable", "disable"] | None = Field(default="disable", description="HTTP3/QUIC support, default=Disable.")    
    quic: AccessProxyApiGatewayQuic | None = Field(default=None, description="QUIC setting.")    
    realservers: list[AccessProxyApiGatewayRealservers] = Field(default_factory=list, description="Select the real servers that this Access Proxy will distribute traffic to.")    
    application: list[AccessProxyApiGatewayApplication] = Field(description="SaaS application controlled by this Access Proxy.")    
    persistence: Literal["none", "http-cookie"] | None = Field(default="none", description="Configure how to make sure that clients connect to the same server every time they make a request that is part of the same session.")    
    http_cookie_domain_from_host: Literal["disable", "enable"] | None = Field(default="disable", description="Enable/disable use of HTTP cookie domain from host field in HTTP.")    
    http_cookie_domain: str | None = Field(max_length=35, default=None, description="Domain that HTTP cookie persistence should apply to.")    
    http_cookie_path: str | None = Field(max_length=35, default=None, description="Limit HTTP cookie persistence to the specified path.")    
    ...
    saml_server: str | None = Field(max_length=35, default=None, description="SAML service provider configuration for VIP authentication.")  # datasource: ['user.saml.name']    
    saml_redirect: Literal["disable", "enable"] | None = Field(default="enable", description="Enable/disable SAML redirection after successful authentication.")    
    ssl_dh_bits: AccessProxyApiGatewaySslDhBitsEnum | None = Field(default=AccessProxyApiGatewaySslDhBitsEnum.V_2048, description="Number of bits to use in the Diffie-Hellman exchange for RSA encryption of SSL sessions.")    
    ssl_algorithm: Literal["high", "medium", "low"] | None = Field(default="high", description="Permitted encryption algorithms for the server side of SSL full mode sessions according to encryption strength.")    
    ssl_cipher_suites: list[AccessProxyApiGatewaySslCipherSuites] = Field(default_factory=list, description="SSL/TLS cipher suites to offer to a server, ordered by priority.")    
    ssl_min_version: AccessProxyApiGatewaySslMinVersionEnum | None = Field(default=AccessProxyApiGatewaySslMinVersionEnum.TLS_1_1, description="Lowest SSL/TLS version acceptable from a server.")    
    ssl_max_version: AccessProxyApiGatewaySslMaxVersionEnum | None = Field(default=AccessProxyApiGatewaySslMaxVersionEnum.TLS_1_3, description="Highest SSL/TLS version acceptable from a server.")    
    ssl_renegotiation: Literal["enable", "disable"] | None = Field(default="enable", description="Enable/disable secure renegotiation to comply with RFC 5746.")    
    ssl_vpn_web_portal: str | None = Field(max_length=35, default=None, description="Agentless VPN web portal.")  # datasource: ['vpn.ssl.web.portal.name']
# ============================================================================
...
class AccessProxyModel(BaseModel):
    ...
    vip: str = Field(max_length=79, description="Virtual IP name.")  # datasource: ['firewall.vip.name']    
    ...
    api_gateway: list[AccessProxyApiGateway] = Field(default_factory=list, description="Set IPv4 API Gateway.")    
    api_gateway6: list[AccessProxyApiGateway6] = Field(default_factory=list, description="Set IPv6 API Gateway.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "AccessProxyModel":
        """
...
__all__ = [
    "AccessProxyModel",    "AccessProxyApiGateway",    "AccessProxyApiGateway.Quic",    "AccessProxyApiGateway.Realservers",    "AccessProxyApiGateway.Realservers.SshHostKey",    "AccessProxyApiGateway.Application",    "AccessProxyApiGateway.SslCipherSuites",    "AccessProxyApiGateway6",    "AccessProxyApiGateway6.Quic",    "AccessProxyApiGateway6.Realservers",    "AccessProxyApiGateway6.Realservers.SshHostKey",    "AccessProxyApiGateway6.Application",    "AccessProxyApiGateway6.SslCipherSuites",]


# ============================================================================
# Generated by hfortix generator v0.6.0
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:53.979246Z
# ============================================================================