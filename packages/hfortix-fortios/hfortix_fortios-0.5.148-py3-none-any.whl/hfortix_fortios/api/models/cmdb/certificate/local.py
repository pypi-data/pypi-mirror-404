...
class LocalModel(BaseModel):
    ...
    cmp_server_cert: str | None = Field(max_length=79, default=None, description="CMP server certificate.")  # datasource: ['certificate.ca.name', 'certificate.remote.name']    
    ...
    est_client_cert: str | None = Field(max_length=79, default=None, description="Certificate used to authenticate this FortiGate to EST server.")  # datasource: ['certificate.local.name']    
    est_server_cert: str | None = Field(max_length=79, default=None, description="EST server's certificate must be verifiable by this certificate to be authenticated.")  # datasource: ['certificate.ca.name', 'certificate.remote.name']    
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:54.500064Z
# ============================================================================