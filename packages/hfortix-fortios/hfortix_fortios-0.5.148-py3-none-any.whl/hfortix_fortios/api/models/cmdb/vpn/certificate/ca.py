...
class CaModel(BaseModel):
    ...
    range_: Literal["global", "vdom"] | None = Field(default="vdom", serialization_alias="range", description="Either global or VDOM IP address range for the CA certificate.")    
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:38:54.769538Z
# ============================================================================