...
class Phase1InterfaceMonitor(BaseModel):
    ...
    name: str | None = Field(max_length=79, default=None, description="IPsec interface as backup for primary interface.")  # datasource: ['vpn.ipsec.phase1-interface.name']
...
class Phase1InterfaceModel(BaseModel):
    ...
    name: str | None = Field(max_length=15, default=None, description="IPsec remote gateway name.")    
    ...
    certificate: list[Phase1InterfaceCertificate] = Field(description="The names of up to 4 signed personal certificates.")    
    ...
    peertype: Phase1InterfacePeertypeEnum | None = Field(default=Phase1InterfacePeertypeEnum.PEER, description="Accept this peer type.")    
    ...
    monitor: list[Phase1InterfaceMonitor] = Field(default_factory=list, description="IPsec interface as backup for primary interface.")    
    ...
    monitor_hold_down_weekday: Phase1InterfaceMonitorHoldDownWeekdayEnum = Field(default=Phase1InterfaceMonitorHoldDownWeekdayEnum.SUNDAY, description="Day of the week to recover once primary re-establishes.")    
    monitor_hold_down_time: str = Field(description="Time of day at which to fail back to primary after it re-establishes.")    
    ...
    assign_ip_from: Phase1InterfaceAssignIpFromEnum | None = Field(default=Phase1InterfaceAssignIpFromEnum.RANGE, description="Method by which the IP address will be assigned.")    
    ...
    internal_domain_list: list[Phase1InterfaceInternalDomainList] = Field(default_factory=list, description="One or more internal domain names in quotes separated by spaces.")    
    dns_suffix_search: list[Phase1InterfaceDnsSuffixSearch] = Field(default_factory=list, description="One or more DNS domain name suffixes in quotes separated by spaces.")    
    ...
    ipv4_exclude_range: list[Phase1InterfaceIpv4ExcludeRange] = Field(default_factory=list, description="Configuration Method IPv4 exclude ranges.")    
    ...
    ipv6_exclude_range: list[Phase1InterfaceIpv6ExcludeRange] = Field(default_factory=list, description="Configuration method IPv6 exclude ranges.")    
    ...
    backup_gateway: list[Phase1InterfaceBackupGateway] = Field(default_factory=list, description="Instruct unity clients about the backup gateway address(es).")    
    proposal: list[Phase1InterfaceProposalEnum] = Field(description="Phase1 proposal.")    
    ...
    localid_type: Phase1InterfaceLocalidTypeEnum | None = Field(default=Phase1InterfaceLocalidTypeEnum.AUTO, description="Local ID type.")    
    ...
    dhgrp: list[Phase1InterfaceDhgrpEnum] = Field(default_factory=list, description="DH group.")    
    addke1: list[Phase1InterfaceAddke1Enum] = Field(default_factory=list, description="ADDKE1 group.")    
    addke2: list[Phase1InterfaceAddke2Enum] = Field(default_factory=list, description="ADDKE2 group.")    
    addke3: list[Phase1InterfaceAddke3Enum] = Field(default_factory=list, description="ADDKE3 group.")    
    addke4: list[Phase1InterfaceAddke4Enum] = Field(default_factory=list, description="ADDKE4 group.")    
    addke5: list[Phase1InterfaceAddke5Enum] = Field(default_factory=list, description="ADDKE5 group.")    
    addke6: list[Phase1InterfaceAddke6Enum] = Field(default_factory=list, description="ADDKE6 group.")    
    addke7: list[Phase1InterfaceAddke7Enum] = Field(default_factory=list, description="ADDKE7 group.")    
    ...
    wizard_type: Phase1InterfaceWizardTypeEnum | None = Field(default=Phase1InterfaceWizardTypeEnum.CUSTOM, description="GUI VPN Wizard Type.")    
    xauthtype: Phase1InterfaceXauthtypeEnum | None = Field(default=Phase1InterfaceXauthtypeEnum.DISABLE, description="XAuth type.")    
    ...
    encapsulation: Phase1InterfaceEncapsulationEnum | None = Field(default=Phase1InterfaceEncapsulationEnum.NONE, description="Enable/disable GRE/VXLAN/VPNID encapsulation.")    
    ...
    signature_hash_alg: list[Phase1InterfaceSignatureHashAlgEnum] = Field(description="Digital Signature Authentication hash algorithms.")    
    ...
    remote_gw_match: Phase1InterfaceRemoteGwMatchEnum | None = Field(default=Phase1InterfaceRemoteGwMatchEnum.ANY, description="Set type of IPv4 remote gateway address matching.")    
    ...
    remote_gw_ztna_tags: list[Phase1InterfaceRemoteGwZtnaTags] = Field(description="IPv4 ZTNA posture tags.")    
    remote_gw6_match: Phase1InterfaceRemoteGw6MatchEnum | None = Field(default=Phase1InterfaceRemoteGw6MatchEnum.ANY, description="Set type of IPv6 remote gateway address matching.")    
    ...
    cert_peer_username_validation: Phase1InterfaceCertPeerUsernameValidationEnum | None = Field(default=Phase1InterfaceCertPeerUsernameValidationEnum.NONE, description="Enable/disable cross validation of peer username and the identity in the peer's certificate.")    
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "Phase1InterfaceModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:53.694418Z
# ============================================================================