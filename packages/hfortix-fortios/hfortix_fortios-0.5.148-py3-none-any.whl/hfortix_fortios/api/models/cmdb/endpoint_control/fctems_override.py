...
class FctemsOverrideModel(BaseModel):
    ...
    capabilities: list[FctemsOverrideCapabilitiesEnum] = Field(default_factory=list, description="List of EMS capabilities.")    
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "FctemsOverrideModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:38:54.763461Z
# ============================================================================