"""
Pydantic Models for CMDB - log/tacacs_plus_accounting3/setting

Runtime validation models for log/tacacs_plus_accounting3/setting configuration.
...
class SettingModel(BaseModel):
    """
    Pydantic model for log/tacacs_plus_accounting3/setting configuration.
    ...
    async def validate_interface_references(self, client: Any) -> list[str]:
        ...
        Example:
            ...
            ... else:
            ...     result = await fgt.api.cmdb.log.tacacs_plus_accounting3.setting.post(policy.to_fortios_dict())
        """
        errors: list[str] = []
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:52.890095Z
# ============================================================================