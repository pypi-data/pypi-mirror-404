...
class OverrideFilterModel(BaseModel):
    ...
    severity: OverrideFilterSeverityEnum | None = Field(default=OverrideFilterSeverityEnum.INFORMATION, description="Log every message above and including this severity level.")    
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "OverrideFilterModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:54.294479Z
# ============================================================================