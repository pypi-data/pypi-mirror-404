"""
Pydantic Models for CMDB - log/tacacs_plus_accounting2/setting

Runtime validation models for log/tacacs_plus_accounting2/setting configuration.
...
class SettingModel(BaseModel):
    """
    Pydantic model for log/tacacs_plus_accounting2/setting configuration.
    ...
    server: str = Field(max_length=63, description="Address of TACACS+ server.")    
    server_key: Any = Field(max_length=128, default=None, description="Key to access the TACACS+ server.")    
    source_ip: str | None = Field(max_length=63, default=None, description="Source IP address for communication to TACACS+ server.")    
    ...
    async def validate_interface_references(self, client: Any) -> list[str]:
        ...
        Example:
            ...
            ... else:
            ...     result = await fgt.api.cmdb.log.tacacs_plus_accounting2.setting.post(policy.to_fortios_dict())
        """
        errors: list[str] = []
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:55.179509Z
# ============================================================================