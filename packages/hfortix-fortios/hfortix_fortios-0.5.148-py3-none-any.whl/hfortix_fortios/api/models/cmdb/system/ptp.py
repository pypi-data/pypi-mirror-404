...
class PtpServerInterface(BaseModel):
    ...
    server_interface_name: str = Field(max_length=15, description="Interface name.")  # datasource: ['system.interface.name']    
...
class PtpModel(BaseModel):
    ...
    interface: str = Field(max_length=15, description="PTP client will reply through this interface.")  # datasource: ['system.interface.name']    
    ...
    server_interface: list[PtpServerInterface] = Field(default_factory=list, description="FortiGate interface(s) with PTP server mode enabled. Devices on your network can contact these interfaces for PTP services.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "PtpModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:54.983094Z
# ============================================================================