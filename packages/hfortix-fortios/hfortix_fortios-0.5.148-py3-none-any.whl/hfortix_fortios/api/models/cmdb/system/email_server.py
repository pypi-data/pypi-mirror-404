...
class EmailServerModel(BaseModel):
    ...
    type_: Literal["custom"] | None = Field(default="custom", serialization_alias="type", description="Use FortiGuard Message service or custom email server.")    
    server: str | None = Field(max_length=63, default=None, description="SMTP server IP address or hostname.")    
    ...
    username: str | None = Field(max_length=255, default=None, description="SMTP server user name for authentication.")    
    ...
    ssl_min_proto_version: EmailServerSslMinProtoVersionEnum | None = Field(default=EmailServerSslMinProtoVersionEnum.DEFAULT, description="Minimum supported protocol version for SSL/TLS connections (default is to follow system global setting).")    
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "EmailServerModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:53.929639Z
# ============================================================================