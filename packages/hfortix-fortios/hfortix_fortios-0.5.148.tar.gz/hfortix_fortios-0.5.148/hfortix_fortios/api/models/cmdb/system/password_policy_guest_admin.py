...
class PasswordPolicyGuestAdminModel(BaseModel):
    ...
    apply_to: list[Literal["guest-admin-password"]] = Field(default_factory=list, description="Guest administrator to which this password policy applies.")    
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "PasswordPolicyGuestAdminModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:38:55.042951Z
# ============================================================================