...
class BfdModel(BaseModel):
    ...
    neighbor: list[BfdNeighbor] = Field(default_factory=list, description="Neighbor.")    
    multihop_template: list[BfdMultihopTemplate] = Field(default_factory=list, description="BFD multi-hop template table.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "BfdModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:38:55.421222Z
# ============================================================================