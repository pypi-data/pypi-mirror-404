...
class SflowModel(BaseModel):
    ...
    collectors: list[SflowCollectors] = Field(default_factory=list, description="sFlow collectors.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "SflowModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:54.604730Z
# ============================================================================