...
class SsoForticloudAdminModel(BaseModel):
    ...
    vdom: list[SsoForticloudAdminVdom] = Field(default_factory=list, description="Virtual domain(s) that the administrator can access.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "SsoForticloudAdminModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:52.615946Z
# ============================================================================