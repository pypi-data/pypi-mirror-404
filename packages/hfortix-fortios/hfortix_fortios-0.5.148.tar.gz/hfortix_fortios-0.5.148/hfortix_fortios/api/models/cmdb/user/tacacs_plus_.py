"""
Pydantic Models for CMDB - user/tacacs_plus_

Runtime validation models for user/tacacs_plus_ configuration.
...
class TacacsPlusModel(BaseModel):
    """
    Pydantic model for user/tacacs_plus_ configuration.
    ...
    async def validate_interface_references(self, client: Any) -> list[str]:
        ...
        Example:
            ...
            ... else:
            ...     result = await fgt.api.cmdb.user.tacacs_plus_.post(policy.to_fortios_dict())
        """
        errors: list[str] = []
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:53.858350Z
# ============================================================================