...
class OtvpModel(BaseModel):
    ...
    metadata: list[OtvpMetadata] = Field(default_factory=list, description="Meta data.")    
    # ========================================================================
    # Custom Validators
    # ========================================================================
    ...
    @classmethod
    def from_fortios_response(cls, data: dict[str, Any]) -> "OtvpModel":
        """
...
# Schema: 1.7.4
# Generated: 2026-01-27T21:47:53.962182Z
# ============================================================================