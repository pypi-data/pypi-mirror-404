...
class DnsblEntriesItem(TypedDict, total=False):
...
class DnsblPayload(TypedDict, total=False):
    """Payload type for Dnsbl operations."""
    id: int
    name: str
    comment: str
    entries: str | list[str] | list[DnsblEntriesItem]
...
class DnsblResponse(TypedDict, total=False):
    """Response type for Dnsbl - use with .dict property for typed dict access."""
    id: int
    name: str
    comment: str
