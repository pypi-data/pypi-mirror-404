...
class AspathListPayload(TypedDict, total=False):
    """Payload type for AspathList operations."""
    name: str
    rule: str | list[str] | list[AspathListRuleItem]
...
class AspathListResponse(TypedDict, total=False):
    """Response type for AspathList - use with .dict property for typed dict access."""
    name: str
...
class AspathList:
    ...
    def get(
        ...
        *,
        ...
        error_mode: Literal["raise", "return", "print"] | None = ...,
        error_format: Literal["detailed", "simple", "code_only"] | None = ...,
    ) -> FortiObjectList[AspathListObject]: ...
    ...
    def post(
        ...
        name: str | None = ...,
        rule: str | list[str] | list[AspathListRuleItem] | None = ...,
        vdom: str | bool | None = ...,
        error_mode: Literal["raise", "return", "print"] | None = ...,
        error_format: Literal["detailed", "simple", "code_only"] | None = ...,
    ) -> AspathListObject: ...
