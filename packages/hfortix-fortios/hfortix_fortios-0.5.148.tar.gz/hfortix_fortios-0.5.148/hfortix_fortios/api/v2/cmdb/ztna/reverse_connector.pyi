...
class ReverseConnectorPayload(TypedDict, total=False):
    """Payload type for ReverseConnector operations."""
    name: str
...
class ReverseConnectorResponse(TypedDict, total=False):
    """Response type for ReverseConnector - use with .dict property for typed dict access."""
    name: str
    status: Literal["enable", "disable"]
    address: str
    port: int
...
class ReverseConnectorObject(FortiObject):
    """Typed FortiObject for ReverseConnector with field access."""
    name: str
    status: Literal["enable", "disable"]
    address: str
    port: int
