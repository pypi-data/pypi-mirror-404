...
class MulticastAddress6Payload(TypedDict, total=False):
    """Payload type for MulticastAddress6 operations."""
    name: str
    ip6: str
    comment: str
    color: int
...
class MulticastAddress6Response(TypedDict, total=False):
    """Response type for MulticastAddress6 - use with .dict property for typed dict access."""
    name: str
    ip6: str
    comment: str
    color: int
...
class MulticastAddress6TaggingTagsItemObject(FortiObject[MulticastAddress6TaggingTagsItem]):
...
class MulticastAddress6:
    ...
    def get(
        ...
        *,
        ...
        error_mode: Literal["raise", "return", "print"] | None = ...,
        error_format: Literal["detailed", "simple", "code_only"] | None = ...,
    ) -> FortiObjectList[MulticastAddress6Object]: ...
