...
class AccessList6Payload(TypedDict, total=False):
    """Payload type for AccessList6 operations."""
    name: str
    comments: str
    rule: str | list[str] | list[AccessList6RuleItem]
...
class AccessList6Response(TypedDict, total=False):
    """Response type for AccessList6 - use with .dict property for typed dict access."""
    name: str
    comments: str
