...
class FctemsPayload(TypedDict, total=False):
    """Payload type for Fctems operations."""
    ems_id: int
...
class FctemsResponse(TypedDict, total=False):
    """Response type for Fctems - use with .dict property for typed dict access."""
    ems_id: int
    status: Literal["enable", "disable"]
    name: str
    dirty_reason: Literal["none", "mismatched-ems-sn"]
...
class FctemsObject(FortiObject):
    """Typed FortiObject for Fctems with field access."""
    ems_id: int
    status: Literal["enable", "disable"]
    name: str
    dirty_reason: Literal["none", "mismatched-ems-sn"]
