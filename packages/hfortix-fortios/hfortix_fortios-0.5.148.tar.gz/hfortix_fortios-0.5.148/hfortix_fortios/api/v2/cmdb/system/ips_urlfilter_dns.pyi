...
class IpsUrlfilterDnsPayload(TypedDict, total=False):
    """Payload type for IpsUrlfilterDns operations."""
    address: str
...
class IpsUrlfilterDnsResponse(TypedDict, total=False):
    """Response type for IpsUrlfilterDns - use with .dict property for typed dict access."""
    address: str
    status: Literal["enable", "disable"]
    ipv6_capability: Literal["enable", "disable"]
...
class IpsUrlfilterDnsObject(FortiObject):
    """Typed FortiObject for IpsUrlfilterDns with field access."""
    address: str
    status: Literal["enable", "disable"]
    ipv6_capability: Literal["enable", "disable"]
