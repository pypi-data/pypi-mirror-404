...
class Setting(CRUDEndpoint, MetadataMixin):
    ...
    def exists(
        ...
        """
        Check if log/tacacs_plus_accounting/setting object exists.
        ...
        Example:
            ...
            >>> if not fgt.api.cmdb.log_tacacs_plus_accounting_setting.exists(name="myobj"):
            ...     fgt.api.cmdb.log_tacacs_plus_accounting_setting.post(payload_dict=data)
        """
