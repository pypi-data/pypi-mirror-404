...
class SchedulePayload(TypedDict, total=False):
    """Payload type for Schedule operations."""
...
class ScheduleResponse(TypedDict, total=False):
    """Response type for Schedule - use with .dict property for typed dict access."""
    status: Literal["enable", "disable"]
    frequency: Literal["every", "daily", "weekly", "automatic"]
    time: str
    day: Literal["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]
...
class ScheduleObject(FortiObject):
    """Typed FortiObject for Schedule with field access."""
    status: Literal["enable", "disable"]
    frequency: Literal["every", "daily", "weekly", "automatic"]
    time: str
    day: Literal["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]
