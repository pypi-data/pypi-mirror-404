"""Validation helpers for log/tacacs_plus_accounting3/setting - Auto-generated"""
...
def validate_log_tacacs_plus_accounting3_setting_get(
    attr: str | None = None,
    filters: dict[str, Any] | None = None,
    **params: Any,
) -> tuple[bool, str | None]:
    """Validate GET request parameters for log/tacacs_plus_accounting3/setting."""
...
def validate_log_tacacs_plus_accounting3_setting_post(
    payload: dict,
    **params: Any,
) -> tuple[bool, str | None]:
    """Validate POST request to create new log/tacacs_plus_accounting3/setting object."""
...
def validate_log_tacacs_plus_accounting3_setting_put(
    payload: dict,
    **params: Any,
) -> tuple[bool, str | None]:
    """Validate PUT request to update log/tacacs_plus_accounting3/setting."""
...
SCHEMA_INFO = {
    "endpoint": "log/tacacs_plus_accounting3/setting",
    "category": "cmdb",
