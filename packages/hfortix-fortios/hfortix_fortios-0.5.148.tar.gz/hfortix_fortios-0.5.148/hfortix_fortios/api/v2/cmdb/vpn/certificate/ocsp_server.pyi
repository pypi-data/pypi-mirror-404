...
class OcspServerPayload(TypedDict, total=False):
    """Payload type for OcspServer operations."""
    name: str
    url: str
    cert: str
    secondary_url: str
...
class OcspServerResponse(TypedDict, total=False):
    """Response type for OcspServer - use with .dict property for typed dict access."""
    name: str
    url: str
    cert: str
    secondary_url: str
...
class OcspServerObject(FortiObject):
    """Typed FortiObject for OcspServer with field access."""
    name: str
    url: str
    cert: str
    secondary_url: str
