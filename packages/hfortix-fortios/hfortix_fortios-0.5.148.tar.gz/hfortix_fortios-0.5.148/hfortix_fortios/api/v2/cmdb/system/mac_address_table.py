...
class MacAddressTable(CRUDEndpoint, MetadataMixin):
    ...
    def get(
        ...
        if mac:
            endpoint = "/system/mac-address-table/" + quote_path_param(mac)
            unwrap_single = True
        else:
    ...
    def put(
        ...
        endpoint = "/system/mac-address-table/" + quote_path_param(mac_value)
    ...
    def exists(
        ...
        endpoint = "/system/mac-address-table"
        endpoint = f"{endpoint}/{quote_path_param(mac)}"
