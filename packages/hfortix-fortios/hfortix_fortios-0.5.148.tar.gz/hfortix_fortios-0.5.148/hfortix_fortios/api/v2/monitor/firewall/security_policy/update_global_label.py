...
class UpdateGlobalLabel(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new firewall/security_policy/update_global_label object.
        ...
        Examples:
            ...
            >>> payload = UpdateGlobalLabel.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.firewall_security_policy_update_global_label.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(UpdateGlobalLabel.required_fields()) }}
            
            Use UpdateGlobalLabel.help('field_name') to get field details.
        ...
        from ._helpers.update_global_label import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/firewall/security_policy/update_global_label",
            )
