...
Example Usage:
    ...
    >>>
    >>> # List all items
    >>> items = fgt.api.monitor.vpn_certificate_remote_import.get()
    >>>
    >>> # Create with auto-normalization (strings/lists converted automatically)
    >>> result = fgt.api.monitor.vpn_certificate_remote_import.post(
    ...     name="example",
...
class Import(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new vpn_certificate/remote/import_ object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.vpn_certificate_remote_import.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Import.required_fields()) }}
            
            Use Import.help('field_name') to get field details.
        ...
        from ._helpers.import_ import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/vpn_certificate/remote/import_",
            )
