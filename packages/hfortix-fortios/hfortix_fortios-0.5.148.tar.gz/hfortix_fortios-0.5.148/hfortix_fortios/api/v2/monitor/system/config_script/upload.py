...
class Upload(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/config_script/upload object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_config_script_upload.post(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/system/config_script/upload",
            )
