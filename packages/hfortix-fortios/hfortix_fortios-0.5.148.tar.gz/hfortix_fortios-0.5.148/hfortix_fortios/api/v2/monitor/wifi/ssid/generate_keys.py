...
class GenerateKeys(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        count: Any | None = None,
        key_length: Any | None = None,
        vdom: str | bool | None = None,
        error_mode: Literal["raise", "return", "print"] | None = None,
        error_format: Literal["detailed", "simple", "code_only"] | None = None,
    ):  # type: ignore[no-untyped-def]
        """
        Create new wifi/ssid/generate_keys object.
        ...
        Examples:
            ...
            >>> payload = GenerateKeys.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.wifi_ssid_generate_keys.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(GenerateKeys.required_fields()) }}
            
            Use GenerateKeys.help('field_name') to get field details.
        ...
        from ._helpers.generate_keys import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/wifi/ssid/generate_keys",
            )
