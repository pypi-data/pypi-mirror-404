...
class DhcpRenew(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/interface/dhcp_renew object.
        ...
        Examples:
            ...
            >>> payload = DhcpRenew.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_interface_dhcp_renew.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(DhcpRenew.required_fields()) }}
            
            Use DhcpRenew.help('field_name') to get field details.
        ...
        from ._helpers.dhcp_renew import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/interface/dhcp_renew",
            )
