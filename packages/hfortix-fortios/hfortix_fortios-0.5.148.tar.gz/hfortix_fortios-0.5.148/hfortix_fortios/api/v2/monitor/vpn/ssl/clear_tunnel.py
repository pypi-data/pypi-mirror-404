...
class ClearTunnel(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new vpn/ssl/clear_tunnel object.
        ...
        Examples:
            ...
            >>> payload = ClearTunnel.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.vpn_ssl_clear_tunnel.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ClearTunnel.required_fields()) }}
            
            Use ClearTunnel.help('field_name') to get field details.
        ...
        from ._helpers.clear_tunnel import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/vpn/ssl/clear_tunnel",
            )
