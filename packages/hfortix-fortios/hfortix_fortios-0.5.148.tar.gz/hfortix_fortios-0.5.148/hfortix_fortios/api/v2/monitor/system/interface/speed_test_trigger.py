...
class SpeedTestTrigger(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/interface/speed_test_trigger object.
        ...
        Examples:
            ...
            >>> payload = SpeedTestTrigger.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_interface_speed_test_trigger.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(SpeedTestTrigger.required_fields()) }}
            
            Use SpeedTestTrigger.help('field_name') to get field details.
        ...
        from ._helpers.speed_test_trigger import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/interface/speed_test_trigger",
            )
