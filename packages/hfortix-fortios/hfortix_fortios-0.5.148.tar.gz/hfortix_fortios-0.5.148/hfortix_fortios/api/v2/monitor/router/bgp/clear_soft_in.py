...
class ClearSoftIn(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new router/bgp/clear_soft_in object.
        ...
        Examples:
            ...
            >>> payload = ClearSoftIn.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.router_bgp_clear_soft_in.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ClearSoftIn.required_fields()) }}
            
            Use ClearSoftIn.help('field_name') to get field details.
        ...
        from ._helpers.clear_soft_in import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/router/bgp/clear_soft_in",
            )
