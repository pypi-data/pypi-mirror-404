...
class TestAvailability(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/fortiguard/test_availability object.
        ...
        Examples:
            ...
            >>> payload = TestAvailability.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_fortiguard_test_availability.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(TestAvailability.required_fields()) }}
            
            Use TestAvailability.help('field_name') to get field details.
        ...
        from ._helpers.test_availability import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/fortiguard/test_availability",
            )
