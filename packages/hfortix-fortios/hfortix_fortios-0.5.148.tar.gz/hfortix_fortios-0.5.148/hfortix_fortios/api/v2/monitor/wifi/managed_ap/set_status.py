...
class SetStatus(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new wifi/managed_ap/set_status object.
        ...
        Examples:
            ...
            >>> payload = SetStatus.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.wifi_managed_ap_set_status.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(SetStatus.required_fields()) }}
            
            Use SetStatus.help('field_name') to get field details.
        ...
        from ._helpers.set_status import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/wifi/managed_ap/set_status",
            )
