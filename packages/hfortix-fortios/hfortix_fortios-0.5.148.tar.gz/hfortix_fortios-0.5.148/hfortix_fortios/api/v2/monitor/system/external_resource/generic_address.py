...
class GenericAddress(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/external_resource/generic_address object.
        ...
        Examples:
            ...
            >>> payload = GenericAddress.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_external_resource_generic_address.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(GenericAddress.required_fields()) }}
            
            Use GenericAddress.help('field_name') to get field details.
        ...
        from ._helpers.generic_address import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/external_resource/generic_address",
            )
