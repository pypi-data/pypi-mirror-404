...
class ClearAll(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new wifi/rogue_ap/clear_all object.
        ...
        Examples:
            ...
            >>> payload = ClearAll.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.wifi_rogue_ap_clear_all.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ClearAll.required_fields()) }}
            
            Use ClearAll.help('field_name') to get field details.
        ...
        from ._helpers.clear_all import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/wifi/rogue_ap/clear_all",
            )
