...
class Upload(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/vmlicense/upload object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.system_vmlicense_upload.post(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/system/vmlicense/upload",
            )
