...
class Restart(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new switch_controller/managed_switch/restart object.
        ...
        Examples:
            ...
            >>> payload = Restart.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.switch_controller_managed_switch_restart.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Restart.required_fields()) }}
            
            Use Restart.help('field_name') to get field details.
        ...
        from ._helpers.restart import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/switch_controller/managed_switch/restart",
            )
