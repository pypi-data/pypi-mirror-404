...
class Start(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        wtp: str | None = None,
        start_vlan_id: Any | None = None,
        end_vlan_id: Any | None = None,
        ...
        """
        Create new wifi/vlan_probe/start object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.wifi_vlan_probe_start.post(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/wifi/vlan_probe/start",
            )
