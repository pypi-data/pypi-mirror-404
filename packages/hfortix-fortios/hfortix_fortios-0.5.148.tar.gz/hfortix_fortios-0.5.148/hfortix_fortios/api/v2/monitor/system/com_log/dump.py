...
class Dump(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/com_log/dump object.
        ...
        Examples:
            ...
            >>> payload = Dump.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_com_log_dump.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(Dump.required_fields()) }}
            
            Use Dump.help('field_name') to get field details.
        ...
        from ._helpers.dump import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/com_log/dump",
            )
