...
class Reset(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new webfilter/category_quota/reset object.
        ...
        Examples:
            ...
            >>> result = fgt.api.monitor.webfilter_category_quota_reset.post(payload_dict=payload)
        ...
        if DEPRECATED_FIELDS:
            ...
            check_deprecated_fields(
                ...
                endpoint="monitor/webfilter/category_quota/reset",
            )
