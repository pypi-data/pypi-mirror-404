...
class ReadInfo(CRUDEndpoint, MetadataMixin):
    ...
    def post(
        ...
        """
        Create new system/certificate/read_info object.
        ...
        Examples:
            ...
            >>> payload = ReadInfo.defaults()  # Start with defaults
            >>> payload['name'] = 'my-object'
            >>> result = fgt.api.monitor.system_certificate_read_info.post(payload_dict=payload)

        Note:
            Required fields: {{ ", ".join(ReadInfo.required_fields()) }}
            
            Use ReadInfo.help('field_name') to get field details.
        ...
        from ._helpers.read_info import DEPRECATED_FIELDS
        if DEPRECATED_FIELDS:
            from hfortix_core import check_deprecated_fields
            check_deprecated_fields(
                payload=payload_data,
                deprecated_fields=DEPRECATED_FIELDS,
                endpoint="monitor/system/certificate/read_info",
            )
