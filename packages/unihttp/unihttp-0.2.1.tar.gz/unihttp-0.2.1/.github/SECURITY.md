...
Security and stability are paramount for unihttp.

Learn more below. 👇

## Versions

The latest version of unihttp is actively supported.

We strongly encourage you to write tests for your application and regularly update your unihttp version after confirming that your tests pass. This ensures you benefit from the latest features, bug fixes, and **security updates**.
