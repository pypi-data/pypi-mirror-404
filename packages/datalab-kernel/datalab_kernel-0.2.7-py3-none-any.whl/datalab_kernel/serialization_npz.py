...
Serialization of SignalObj and ImageObj to/from NumPy NPZ format.

This module provides the client-side implementation of the NPZ format
used by the DataLab Web API for efficient binary data transfer.
