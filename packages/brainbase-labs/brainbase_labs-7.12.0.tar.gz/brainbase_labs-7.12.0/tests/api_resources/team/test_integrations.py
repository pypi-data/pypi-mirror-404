...
class TestIntegrations:
    ...
    def test_method_update(self, client: BrainbaseLabs) -> None:
        integration = client.team.integrations.update(
    ...
    def test_raw_response_update(self, client: BrainbaseLabs) -> None:
        response = client.team.integrations.with_raw_response.update(
            integration_id="integrationId",
        )
    ...
    def test_streaming_response_update(self, client: BrainbaseLabs) -> None:
        with client.team.integrations.with_streaming_response.update(
            integration_id="integrationId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `integration_id` but received ''"):
            client.team.integrations.with_raw_response.update(
                integration_id="",
            )
...
class TestAsyncIntegrations:
    ...
    async def test_method_update(self, async_client: AsyncBrainbaseLabs) -> None:
        integration = await async_client.team.integrations.update(
            integration_id="integrationId",
        )
        assert_matches_type(Integration, integration, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.team.integrations.with_raw_response.update(
            integration_id="integrationId",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.team.integrations.with_streaming_response.update(
            integration_id="integrationId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `integration_id` but received ''"):
            await async_client.team.integrations.with_raw_response.update(
                integration_id="",
            )
