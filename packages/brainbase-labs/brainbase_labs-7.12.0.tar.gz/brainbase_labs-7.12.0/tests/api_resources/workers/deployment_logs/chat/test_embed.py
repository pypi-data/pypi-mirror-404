...
class TestEmbed:
    ...
    def test_method_retrieve(self, client: BrainbaseLabs) -> None:
        embed = client.workers.deployment_logs.chat.embed.retrieve(
            log_id="logId",
            worker_id="workerId",
        )
    ...
    def test_raw_response_retrieve(self, client: BrainbaseLabs) -> None:
        response = client.workers.deployment_logs.chat.embed.with_raw_response.retrieve(
            log_id="logId",
            worker_id="workerId",
        )
    ...
    def test_streaming_response_retrieve(self, client: BrainbaseLabs) -> None:
        with client.workers.deployment_logs.chat.embed.with_streaming_response.retrieve(
            log_id="logId",
            worker_id="workerId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.workers.deployment_logs.chat.embed.with_raw_response.retrieve(
                log_id="logId",
                worker_id="",
            )
    ...
    def test_method_list(self, client: BrainbaseLabs) -> None:
        embed = client.workers.deployment_logs.chat.embed.list(
            worker_id="workerId",
        )
    ...
    def test_raw_response_list(self, client: BrainbaseLabs) -> None:
        response = client.workers.deployment_logs.chat.embed.with_raw_response.list(
            worker_id="workerId",
        )
    ...
    def test_streaming_response_list(self, client: BrainbaseLabs) -> None:
        with client.workers.deployment_logs.chat.embed.with_streaming_response.list(
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: BrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            client.workers.deployment_logs.chat.embed.with_raw_response.list(
                worker_id="",
            )
...
class TestAsyncEmbed:
    ...
    async def test_method_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        embed = await async_client.workers.deployment_logs.chat.embed.retrieve(
            log_id="logId",
            worker_id="workerId",
        )
        assert_matches_type(EmbedRetrieveResponse, embed, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.workers.deployment_logs.chat.embed.with_raw_response.retrieve(
            log_id="logId",
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.workers.deployment_logs.chat.embed.with_streaming_response.retrieve(
            log_id="logId",
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.workers.deployment_logs.chat.embed.with_raw_response.retrieve(
                log_id="logId",
                worker_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncBrainbaseLabs) -> None:
        embed = await async_client.workers.deployment_logs.chat.embed.list(
            worker_id="workerId",
        )
        assert_matches_type(EmbedListResponse, embed, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBrainbaseLabs) -> None:
        response = await async_client.workers.deployment_logs.chat.embed.with_raw_response.list(
            worker_id="workerId",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncBrainbaseLabs) -> None:
        async with async_client.workers.deployment_logs.chat.embed.with_streaming_response.list(
            worker_id="workerId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncBrainbaseLabs) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `worker_id` but received ''"):
            await async_client.workers.deployment_logs.chat.embed.with_raw_response.list(
                worker_id="",
            )
