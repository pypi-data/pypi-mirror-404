...
__all__ = ["OutboundCampaignListResponse", "OutboundCampaignListResponseItem"]


class OutboundCampaignListResponseItem(BaseModel):
    id: str
...
OutboundCampaignListResponse: TypeAlias = List[OutboundCampaignListResponseItem]
