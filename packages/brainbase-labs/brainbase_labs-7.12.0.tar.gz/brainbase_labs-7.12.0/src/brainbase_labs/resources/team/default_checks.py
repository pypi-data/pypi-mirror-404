...
from ...types.team import default_check_update_params
...
class DefaultChecksResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """Get team default checks configuration"""
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._get(
            "/api/team/default-checks",
    ...
    def initialize(
        ...
        *,
        ...
        """Initialize team default checks with default values"""
        extra_headers = {"Accept": "*/*", **(extra_headers or {})}
        return self._post(
            "/api/team/default-checks",
            options=make_request_options(
