...
SYSTEM_PROMPT = "You are a helpful assistant. Give complete, concise answers. Always finish your thoughts - never stop mid-sentence."
...
def chat():
    ...
    try:
        ...
        # Handle models with chat template (Gemma 3, Llama 3)
        if prompt_format in ("gemma3", "llama3"):
