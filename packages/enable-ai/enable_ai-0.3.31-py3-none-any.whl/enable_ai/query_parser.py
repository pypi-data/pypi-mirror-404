...
- If the user specifies how many results to return (a number or phrases like first N, top N), set limit to that number; the system will map it to the API's parameter from the schema.{next_url_instruction}
