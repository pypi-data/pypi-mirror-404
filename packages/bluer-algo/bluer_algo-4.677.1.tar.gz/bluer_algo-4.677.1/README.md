...
|   |   |
| --- | --- |
| [`bps`](./bluer_algo/docs/bps) [![image](https://github.com/kamangir/assets2/raw/main/anchor/03.png?raw=true)](./bluer_algo/docs/bps) ultra-low-bandwidth command and telemetry channel using BLE local sensing and LoRa extended range | [`yolo`](./bluer_algo/docs/yolo) [![image](https://github.com/kamangir/assets/raw/main/swallow-debug-2025-09-16-19-53-19-4yzsp8/swallow-debug-2025-09-16-19-53-19-4yzsp8-2.gif?raw=true)](./bluer_algo/docs/yolo) a yolo interface. |
...
built by 🌀 [`bluer README`](https://github.com/kamangir/bluer-objects/tree/main/bluer_objects/README), based on 🪄 [`bluer_algo-4.677.1`](https://github.com/kamangir/bluer-algo).
