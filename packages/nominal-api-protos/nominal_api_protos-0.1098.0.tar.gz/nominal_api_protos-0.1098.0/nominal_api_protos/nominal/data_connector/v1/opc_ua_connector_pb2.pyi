...
class OpcUaSubscriptionConfig(_message.Message):
    __slots__ = ("failed_monitor_handling", "data_change_filter")
    ...
    def __init__(self, failed_monitor_handling: _Optional[_Union[OpcUaFailedMonitorHandling, str]] = ..., data_change_filter: _Optional[_Union[OpcUaDataChangeFilter, _Mapping]] = ...) -> None: ...

class OpcUaPollingConfig(_message.Message):
    __slots__ = ("polling_interval_ms",)
    POLLING_INTERVAL_MS_FIELD_NUMBER: _ClassVar[int]
    polling_interval_ms: int
    def __init__(self, polling_interval_ms: _Optional[int] = ...) -> None: ...

class OpcUaDataAcquisitionConfig(_message.Message):
    __slots__ = ("subscription", "polling")
    SUBSCRIPTION_FIELD_NUMBER: _ClassVar[int]
    POLLING_FIELD_NUMBER: _ClassVar[int]
    subscription: OpcUaSubscriptionConfig
    polling: OpcUaPollingConfig
    def __init__(self, subscription: _Optional[_Union[OpcUaSubscriptionConfig, _Mapping]] = ..., polling: _Optional[_Union[OpcUaPollingConfig, _Mapping]] = ...) -> None: ...
...
class OpcUaScrapingConfig(_message.Message):
    __slots__ = ("node_exploration_config", "unit_node_name", "channel_naming_convention", "override_host", "unknown_data_type_handling", "failed_monitor_handling", "timestamp_handling", "data_change_filter", "data_acquisition_config")
    ...
    DATA_CHANGE_FILTER_FIELD_NUMBER: _ClassVar[int]
    DATA_ACQUISITION_CONFIG_FIELD_NUMBER: _ClassVar[int]
