...
- Simple arithmetic (2+2=4): **20% → 68%** confidence (+240% improvement)
- Factual queries: **44% → 75%** confidence (+70% improvement)
- Verbose responses: **19% → 60%** confidence (+216% improvement)
