...
call apoc.load.jsonArray('https://raw.githubusercontent.com/joakimskoog/AnApiOfIceAndFire/77326fa5090327d4907c8150888b507e7a4938e2/AnApiOfIceAndFire.Data.Feeder/Data/characters.json') yield value
...
call apoc.load.jsonArray('https://raw.githubusercontent.com/joakimskoog/AnApiOfIceAndFire/77326fa5090327d4907c8150888b507e7a4938e2/AnApiOfIceAndFire.Data.Feeder/Data/houses.json') yield value
with apoc.convert.toMap(value) as data
with apoc.map.clean(data, [],['',[''],[],null]) as data
with apoc.map.fromPairs([k in keys(data) | [toLower(substring(k,0,1))+substring(k,1,size(k)), data[k]]]) as data
