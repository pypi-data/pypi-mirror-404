...
class RedisCache:
    ...
    def __init__(
        ...
        # File cache fallback - use centralized paths
    ...
    def _init_redis_client(self, pool_size: int) -> None:
        ...
        redis_module = redis  # Narrow type for mypy
        ...
        try:
            ...
            if self.ssl:
                ...
                connection_kwargs["ssl_cert_reqs"] = (
                    ssl.CERT_NONE
                )  # Don't verify cert for development
    ...
    def set(self, key: str, value: Any, ttl: int = 3600) -> bool:
        ...
        if self.redis_available and self.client is not None:
            try:
                ...
                self.circuit_breaker.call(self.client.setex, key, ttl, serialized)
...
class ToolCache:
    ...
    def get_search_results(
        self, query_hash: str, catalog_version: str, top_k: int
    ) -> list[Any] | None:
    ...
    def set_search_results(
        self, query_hash: str, catalog_version: str, top_k: int, results: list[Any]
    ) -> bool:
