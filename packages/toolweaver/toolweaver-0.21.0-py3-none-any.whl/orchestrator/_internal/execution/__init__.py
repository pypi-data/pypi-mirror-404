...
# Keep SmallModelWorker assignment after imports for optional use
if TYPE_CHECKING:
    from .small_model_worker import SmallModelWorker as SmallModelWorkerType

_SmallModelWorker: Any
try:
    from .small_model_worker import SmallModelWorker as _SmallModelWorker
except Exception:
    _SmallModelWorker = None

SmallModelWorker = _SmallModelWorker
...
__all__ = [
    ...
    "code_exec_worker",
    "_exec_code",
    # SmallModelWorker appended below if available
    # skill library
    "Skill",
    "save_skill",
    "get_skill",
...
if SmallModelWorker is not None:
    __all__.append("SmallModelWorker")
