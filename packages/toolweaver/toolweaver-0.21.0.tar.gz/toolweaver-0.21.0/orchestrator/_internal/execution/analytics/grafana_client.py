...
class GrafanaClient:
    ...
    def _make_request(
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                logger.error(f"Grafana API error [{response.status_code}]: {response.text[:200]}")
                return None
    ...
    def update_datasource(
        ...
        result = self._make_request("PUT", f"datasources/{existing['id']}", payload)
        if isinstance(result, dict):
    ...
    def create_usage_dashboard(self, datasource: str) -> bool:
        ...
        return bool(self.create_dashboard("Usage Trends", panels, uid="toolweaver-usage"))
    ...
    def create_leaderboard_dashboard(self, datasource: str) -> bool:
        ...
        return bool(self.create_dashboard("Leaderboards", panels, uid="toolweaver-leaderboards"))
    ...
    def create_metrics_dashboard(self, datasource: str) -> bool:
        ...
        return bool(self.create_dashboard("Performance Metrics", panels, uid="toolweaver-metrics"))
    ...
    def create_adoption_dashboard(self, datasource: str) -> bool:
        ...
        return bool(self.create_dashboard("Adoption Tracking", panels, uid="toolweaver-adoption"))
    ...
    def create_health_dashboard(self, datasource: str) -> bool:
        ...
        return bool(self.create_dashboard("Health Dashboard", panels, uid="toolweaver-health"))
