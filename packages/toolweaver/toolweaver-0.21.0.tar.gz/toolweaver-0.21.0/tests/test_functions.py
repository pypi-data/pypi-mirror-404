...
class TestComputeTax:
    ...
    def test_invalid_tax_rate_negative(self) -> None:
    ...
    def test_invalid_tax_rate_over_one(self) -> None:
...
class TestApplyDiscount:
    ...
    def test_negative_discount_raises_error(self) -> None:
    ...
    def test_over_hundred_discount_raises_error(self) -> None:
...
class TestMergeItems:
    ...
    def test_basic_merge(self) -> None:
        ...
        items = [{"total": 10.0}, {"total": 20.0}, {"total": 30.0}]
        result = merge_items(items)
        assert result == {"total_sum": 60.0, "count": 3, "avg_total": 20.0}

    def test_empty_list(self) -> None:
        """Test with empty list"""
        result = merge_items([])
        assert result == {"total_sum": 0.0, "count": 0, "avg_total": 0.0}

    def test_single_item(self) -> None:
        """Test with single item"""
        result = merge_items([{"total": 15.0}])
        assert result == {"total_sum": 15.0, "count": 1, "avg_total": 15.0}

    def test_items_without_total(self) -> None:
        """Test items without total field"""
        items = [{"description": "Item 1"}, {"total": 10.0}, {"description": "Item 3"}]
        result = merge_items(items)
    ...
    def test_rounding(self) -> None:
        """Test rounding to 2 decimal places"""
        items = [{"total": 10.333}, {"total": 20.667}]
        result = merge_items(items)
    ...
    def test_nested_dict_format(self) -> None:
        ...
        data = {"items": [{"total": 10.0}, {"total": 20.0}]}
...
class TestFilterItemsByCategory:
    ...
    def test_case_insensitive(self) -> None:
        ...
        items = [{"name": "Coffee", "category": "Food"}, {"name": "Soda", "category": "DRINK"}]
        result = filter_items_by_category(items, "food")
        assert len(result) == 1
    ...
    def test_items_without_category(self) -> None:
    ...
    def test_categorized_field(self) -> None:
...
class TestComputeItemStatistics:
    ...
    def test_uncategorized_items(self) -> None:
    ...
    def test_items_without_quantities(self) -> None:
        """Test items without quantity or total fields"""
        items = [{"description": "Item1"}, {"description": "Item2", "total": 10.0}]
        result = compute_item_statistics(items)
        assert result["count"] == 2
    ...
    def test_nested_dict_format(self) -> None:
        """Test with items nested in dict"""
        data = {
            "items": [{"total": 10.0, "category": "food"}, {"total": 20.0, "category": "drink"}]
        }
