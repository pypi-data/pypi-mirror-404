...
@pytest.fixture
def mock_tool_executor(monkeypatch: Any, sample_catalog: ToolCatalog) -> ProgrammaticToolExecutor:
    ...
    async def mock_execute(tool_def: ToolDefinition, parameters: dict[str, Any]) -> dict[str, Any]:
...
class TestBasicExecution:
    ...
    @pytest.mark.asyncio
    async def test_simple_print(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_variable_assignment(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_async_await_syntax(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_json_output(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
class TestToolWrapping:
    ...
    @pytest.mark.asyncio
    async def test_single_tool_call(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_multiple_tool_calls(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_tool_call_logging(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_missing_required_parameter(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
class TestStubIntegration:
    ...
    @pytest.mark.asyncio
    async def test_stub_import_routes_through_executor(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
        code = """
...
class TestParallelExecution:
    ...
    @pytest.mark.asyncio
    async def test_parallel_tool_calls(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_parallel_different_tools(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
class TestSecurityValidation:
    ...
    @pytest.mark.asyncio
    async def test_forbidden_import_os(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_forbidden_import_subprocess(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_forbidden_from_import(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_forbidden_function_eval(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_forbidden_function_exec(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_forbidden_function_open(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_forbidden_builtins_modification(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_allowed_safe_operations(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
class TestTimeoutHandling:
    ...
    @pytest.mark.asyncio
    async def test_timeout_with_sleep(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
        """Test timeout with asyncio.sleep"""
        # Set very short timeout
        mock_tool_executor.timeout = 1  # Minimum 1 second timeout
...
"""
    ...
    @pytest.mark.asyncio
    async def test_no_timeout_fast_execution(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
        """Test that fast execution completes without timeout"""
        mock_tool_executor.timeout = 5
...
class TestErrorRecovery:
    ...
    @pytest.mark.asyncio
    async def test_python_syntax_error(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
    ...
    @pytest.mark.asyncio
    async def test_runtime_exception(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_exception_with_partial_output(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
class TestToolCallLimits:
    ...
    @pytest.mark.asyncio
    async def test_max_tool_calls_limit(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
class TestConvenienceFunction:
    ...
    @pytest.mark.asyncio
    async def test_execute_programmatic_code(self, sample_catalog: ToolCatalog, monkeypatch: Any) -> None:
        """Test convenience function"""

        # Mock the execute_tool method
        async def mock_execute(self: Any, tool_def: ToolDefinition, parameters: dict[str, Any]) -> dict[str, Any]:
            if tool_def.name == "add_numbers":
                return {"result": parameters["a"] + parameters["b"]}
            return {}
...
class TestContextInjection:
    ...
    @pytest.mark.asyncio
    async def test_context_variables(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
        """Test that context variables are available in code"""
        code = """
print(f"user_id: {user_id}")
print(f"session: {session}")
"""
        context = {"user_id": "user_123", "session": "abc-def-ghi"}
    ...
    @pytest.mark.asyncio
    async def test_context_with_tool_calls(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
class TestExecutionMetadata:
    ...
    @pytest.mark.asyncio
    async def test_execution_id_uniqueness(self, sample_catalog: ToolCatalog) -> None:
    ...
    @pytest.mark.asyncio
    async def test_execution_time_measurement(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_tool_call_duration(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
class TestSafeBuiltins:
    ...
    @pytest.mark.asyncio
    async def test_safe_collection_operations(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_safe_string_operations(self, mock_tool_executor: ProgrammaticToolExecutor) -> None:
