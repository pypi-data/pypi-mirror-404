...
def test_add_tool_with_explicit_domain(sample_tools: Any) -> None:
...
def test_add_tool_auto_detect_domain(sample_tools: Any) -> None:
...
def test_add_multiple_tools(sample_tools: Any) -> None:
...
def test_get_shard() -> None:
    ...
    tool = ToolDefinition(
        name="test_tool", type="function", description="Test", parameters=[], domain="github"
    )
    catalog.add_tool(tool)
...
def test_detect_domain_github() -> None:
...
def test_detect_domain_slack() -> None:
...
def test_detect_domain_aws() -> None:
...
def test_detect_domain_database() -> None:
...
def test_detect_domain_no_match() -> None:
...
def test_search_by_domain(sample_tools: Any) -> None:
...
def test_search_by_domain_fallback() -> None:
    """Test fallback to global when domain is empty"""
    catalog = ShardedCatalog()

    # Add only general tools
    tool = ToolDefinition(
        name="test_tool", type="function", description="Test", parameters=[], domain="general"
    )
    catalog.add_tool(tool)
...
def test_search_with_detection(sample_tools: Any) -> None:
...
def test_search_with_detection_no_domain(sample_tools: Any) -> None:
...
def test_get_stats(sample_tools: Any) -> None:
...
def test_domain_detection_case_insensitive() -> None:
...
def test_multiple_domain_keywords() -> None:
...
def test_empty_catalog_search() -> None:
...
def test_unknown_domain_defaults_to_general() -> None:
