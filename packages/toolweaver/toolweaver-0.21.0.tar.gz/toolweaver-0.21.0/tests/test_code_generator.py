...
from orchestrator._internal.execution.code_generator import GeneratedStub, StubGenerator
from orchestrator.shared.models import ToolCatalog, ToolDefinition, ToolParameter


@pytest.fixture
def test_catalog() -> ToolCatalog:
    ...
    catalog.add_tool(
        ToolDefinition(
            ...
            parameters=[
                ...
                ToolParameter(
                    name="priority", type="integer", description="Priority level", required=False
                ),
            ],
        )
    )
...
@pytest.fixture
def generator(test_catalog: Any, stub_dir: Any) -> Any:
...
class TestStubGenerator:
    ...
    def test_initialization(self, generator: Any, test_catalog: Any, stub_dir: Any) -> None:
    ...
    def test_group_by_server(self, generator: Any) -> None:
    ...
    def test_generate_input_model_simple(self, generator: Any, test_catalog: Any) -> None:
    ...
    def test_generate_input_model_multiple_params(self, generator: Any, test_catalog: Any) -> None:
    ...
    def test_generate_input_model_no_params(self, generator: Any, test_catalog: Any) -> None:
    ...
    def test_generate_output_model(self, generator: Any, test_catalog: Any) -> None:
    ...
    def test_generate_function(self, generator: Any, test_catalog: Any) -> None:
    ...
    def test_control_flow_doc_injection(self, generator: Any) -> None:
    ...
    def test_generate_docstring(self, generator: Any, test_catalog: Any) -> None:
    ...
    def test_python_type_conversion(self, generator: Any) -> None:
    ...
    def test_camel_case_conversion(self, generator: Any) -> None:
    ...
    def test_generate_stub_complete(self, generator: Any, test_catalog: Any) -> None:
    ...
    def test_generate_all(self, generator: Any, stub_dir: Any) -> None:
        """Verify complete stub generation"""
    ...
    def test_generated_stub_info(self, generator: Any) -> None:
    ...
    def test_list_generated_stubs(self, generator: Any) -> None:
    ...
    def test_extract_imports(self, generator: Any) -> None:
...
"""
    ...
    def test_extract_classes(self, generator: Any) -> None:
...
"""
    ...
    def test_server_init_generation(self, generator: Any, stub_dir: Any) -> None:
    ...
    def test_generated_stub_is_importable(self, generator: Any, stub_dir: Any) -> None:
