...
def test_load_simple_tool(clean_registry: Any, temp_yaml_file: Any) -> None:
...
@pytest.mark.asyncio
async def test_execute_yaml_tool_sync(clean_registry: Any, temp_yaml_file: Any) -> None:
...
@pytest.mark.asyncio
async def test_execute_yaml_tool_async(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_load_multiple_tools(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_missing_name_field(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_missing_worker_field(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_invalid_worker_path(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_invalid_yaml(temp_yaml_file: Any) -> None:
...
def test_missing_tools_key(temp_yaml_file: Any) -> None:
...
def test_tools_not_list(temp_yaml_file: Any) -> None:
...
def test_load_from_directory(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_colon_separator_in_worker_path(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_dot_separator_in_worker_path(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_metadata_preservation(clean_registry: Any, temp_yaml_file: Any) -> None:
...
def test_optional_fields_defaults(clean_registry: Any, temp_yaml_file: Any) -> None:
