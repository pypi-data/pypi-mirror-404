...
class TestToolParameter:
    ...
    def test_nested_object_parameter(self) -> None:
    ...
    def test_array_parameter(self) -> None:
        ...
        param = ToolParameter(
            name="tags", type="array", description="List of tags", items={"type": "string"}
        )
...
class TestToolDefinition:
    ...
    def test_basic_tool_definition(self) -> None:
    ...
    def test_tool_type_validation(self) -> None:
        """Test that tool type must be one of: mcp, function, code_exec."""
        with pytest.raises(ValidationError):
            ToolDefinition(
                name="invalid_tool",
                type=cast(Any, "invalid_type"),  # Should fail
                description="Test",
                parameters=[],
            )
    ...
    def test_code_exec_tool(self) -> None:
    ...
    def test_to_llm_format_basic(self) -> None:
    ...
    def test_to_llm_format_with_enum(self) -> None:
    ...
    def test_to_llm_format_with_default(self) -> None:
        ...
        tool = ToolDefinition(
            ...
            parameters=[
                ToolParameter(name="seconds", type="integer", description="Wait time", default=10)
            ],
        )
...
class TestToolCatalog:
    ...
    def test_add_tool(self) -> None:
        ...
        catalog = ToolCatalog()
        tool = ToolDefinition(name="test_tool", type="function", description="Test", parameters=[])
    ...
    def test_get_tool(self) -> None:
        ...
        catalog = ToolCatalog()
        tool = ToolDefinition(name="my_tool", type="function", description="Test", parameters=[])
        catalog.add_tool(tool)
    ...
    def test_get_by_type(self) -> None:
        ...
        # Add different types
        catalog.add_tool(
            ToolDefinition(name="func1", type="function", description="Test", parameters=[])
        )
        catalog.add_tool(
            ToolDefinition(name="func2", type="function", description="Test", parameters=[])
        )
        catalog.add_tool(ToolDefinition(name="mcp1", type="mcp", description="Test", parameters=[]))
        catalog.add_tool(
            ToolDefinition(name="code1", type="code_exec", description="Test", parameters=[])
        )
    ...
    def test_to_llm_format(self) -> None:
        ...
        catalog.add_tool(
            ToolDefinition(
                ...
                parameters=[
                    ToolParameter(name="arg1", type="string", description="Arg", required=True)
                ],
            )
        )
        catalog.add_tool(
            ToolDefinition(name="tool2", type="function", description="Second tool", parameters=[])
        )
    ...
    def test_to_llm_format_with_defer_loading(self) -> None:
...
class TestToolCatalogIntegration:
    ...
    def test_receipt_processing_catalog(self) -> None:
        ...
        catalog.add_tool(
            ToolDefinition(
                ...
                parameters=[
                    ToolParameter(
                        name="text", type="string", description="Receipt text", required=True
                    )
                ],
            )
        )
...
class TestToolExamples:
    ...
    def test_tool_example_creation(self) -> None:
        ...
        assert example.notes is not None and "production outages" in example.notes

    def test_tool_definition_with_examples(self) -> None:
    ...
    def test_llm_format_with_examples(self) -> None:
    ...
    def test_llm_format_without_examples(self) -> None:
