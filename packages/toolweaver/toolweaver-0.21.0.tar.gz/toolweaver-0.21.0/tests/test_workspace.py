...
@pytest.fixture
def workspace(temp_workspace: Path) -> WorkspaceManager:
    """Create WorkspaceManager instance."""
    return WorkspaceManager(session_id="test-session", workspace_root=temp_workspace)
...
class TestWorkspaceSkill:
    ...
    def test_create_skill(self) -> None:
        ...
        skill = WorkspaceSkill(
            name="test_skill", code="def hello(): return 'world'", description="A test skill"
        )
    ...
    def test_skill_to_dict(self) -> None:
        ...
        skill = WorkspaceSkill(name="test", code="code", description="desc")
    ...
    def test_skill_to_markdown(self) -> None:
    ...
    def test_skill_from_markdown(self) -> None:
...
class TestWorkspaceManager:
    ...
    def test_create_workspace(self, workspace: Any) -> None:
    ...
    def test_save_skill(self, workspace: Any) -> None:
        """Test saving a skill."""
    ...
    def test_load_skill(self, workspace: Any) -> None:
        """Test loading a skill."""
        # Save skill first
        workspace.save_skill(
            name="loader_test", code="def load(): pass", description="Test loading"
        )
    ...
    def test_load_nonexistent_skill(self, workspace: Any) -> None:
        """Test loading skill that doesn't exist."""
        with pytest.raises(SkillNotFound):
            workspace.load_skill("nonexistent")

    def test_skill_versioning(self, workspace: Any) -> None:
        """Test that updating skill increments version."""
        # Save initial version
        skill_v1 = workspace.save_skill(
            name="versioned", code="def v1(): pass", description="Version 1"
        )
        ...
        skill_v2 = workspace.save_skill(
            name="versioned", code="def v2(): pass", description="Version 2"
        )

        assert skill_v2.version == 2

    def test_list_skills(self, workspace: Any) -> None:
        """Test listing skills."""
    ...
    def test_delete_skill(self, workspace: Any) -> None:
    ...
    def test_delete_nonexistent_skill(self, workspace: Any) -> None:
        """Test deleting skill that doesn't exist."""
        with pytest.raises(SkillNotFound):
            workspace.delete_skill("nonexistent")

    def test_save_intermediate(self, workspace: Any) -> None:
    ...
    def test_load_intermediate(self, workspace: Any) -> None:
    ...
    def test_load_nonexistent_intermediate(self, workspace: Any) -> None:
        """Test loading intermediate that doesn't exist."""
        with pytest.raises(FileNotFoundError):
            workspace.load_intermediate("nonexistent")

    def test_list_intermediates(self, workspace: Any) -> None:
    ...
    def test_get_workspace_stats(self, workspace: Any) -> None:
    ...
    def test_clear_workspace(self, workspace: Any) -> None:
...
class TestWorkspaceQuota:
    ...
    def test_quota_max_size(self, temp_workspace: Any) -> None:
        """Test max size quota."""
        # Create workspace with small quota
        quota = WorkspaceQuota(max_size_bytes=1000)
        workspace = WorkspaceManager(
            session_id="quota-test", workspace_root=temp_workspace, quota=quota
        )
    ...
    def test_quota_max_files(self, temp_workspace: Any) -> None:
    ...
    def test_quota_max_skill_size(self, temp_workspace: Any) -> None:
    ...
    def test_quota_max_intermediate_size(self, temp_workspace: Any) -> None:
...
class TestWorkspaceIntegration:
    ...
    def test_agent_workflow(self, workspace: Any) -> None:
...
""",
            ...
            dependencies=[],
            tags=["parsing", "csv"],
            examples=["data = 'name,age\\nAlice,30\\nBob,25'", "result = parse_csv(data)"],
        )
...
""",
    ...
    def test_skill_evolution(self, workspace: Any) -> None:
...
""",
    ...
    def test_multi_agent_workspace(self, temp_workspace: Any) -> None:
