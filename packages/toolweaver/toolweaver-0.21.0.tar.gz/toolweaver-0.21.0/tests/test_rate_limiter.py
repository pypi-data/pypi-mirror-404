...
class TestRateEnforcement:
    ...
    @pytest.mark.asyncio
    async def test_sustained_rate_enforcement(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_wait_for_token_refill(self) -> None:
        ...
        # Allow for up to 0.5s in slow CI environments
        assert 0.08 <= elapsed <= 0.5, f"Expected ~0.1s wait, got {elapsed:.2f}s"

    @pytest.mark.asyncio
    async def test_multiple_token_acquisition(self) -> None:
...
class TestTokenRefill:
    ...
    @pytest.mark.asyncio
    async def test_refill_capped_at_burst_size(self) -> None:
...
class TestEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_acquire_negative_tokens(self) -> None:
