...
def test_calculate_efficiency_score(tool_balanced: Any) -> None:
...
def test_calculate_efficiency_with_cost_constraint_violated() -> None:
    optimizer = CostOptimizer()
    tool = ToolDefinition(
        name="expensive",
        type="tool",
...
def test_calculate_efficiency_with_latency_constraint_violated() -> None:
    optimizer = CostOptimizer()
    tool = ToolDefinition(
        name="slow",
        type="tool",
...
def test_select_best_tool_cost_optimized(tool_slow_expensive: Any, tool_fast_cheap: Any, tool_balanced: Any) -> None:
...
def test_select_best_tool_reliability_optimized(tool_slow_expensive: Any, tool_fast_cheap: Any, tool_balanced: Any) -> None:
...
def test_select_best_tool_latency_optimized(tool_slow_expensive: Any, tool_fast_cheap: Any, tool_balanced: Any) -> None:
...
def test_select_best_tool_with_budget(tool_slow_expensive: Any, tool_fast_cheap: Any, tool_balanced: Any) -> None:
    optimizer = CostOptimizer()
    tools = [tool_slow_expensive, tool_fast_cheap, tool_balanced]
...
def test_select_best_tool_with_capability_filter(tool_slow_expensive: Any, tool_fast_cheap: Any, tool_balanced: Any) -> None:
    optimizer = CostOptimizer()
    tools = [tool_slow_expensive, tool_fast_cheap, tool_balanced]
...
def test_select_best_tool_no_qualify() -> None:
    optimizer = CostOptimizer()
    tool = ToolDefinition(
        name="expensive_tool",
        type="tool",
...
def test_rank_tools(tool_slow_expensive: Any, tool_fast_cheap: Any, tool_balanced: Any) -> None:
    optimizer = CostOptimizer()
    tools = [tool_slow_expensive, tool_fast_cheap, tool_balanced]
...
def test_rank_tools_with_constraints(tool_slow_expensive: Any, tool_fast_cheap: Any, tool_balanced: Any) -> None:
    optimizer = CostOptimizer()
    tools = [tool_slow_expensive, tool_fast_cheap, tool_balanced]
...
def test_weight_normalization() -> None:
    ...
    assert (
        abs(optimizer.cost_weight + optimizer.latency_weight + optimizer.reliability_weight - 1.0)
        < 0.001
    )
