...
class TestSecretsRedactor:
    ...
    def test_redact_openai_key(self, redactor: Any) -> None:
    ...
    def test_redact_github_token_ghp(self, redactor: Any) -> None:
    ...
    def test_redact_github_pat(self, redactor: Any) -> None:
    ...
    def test_redact_bearer_token(self, redactor: Any) -> None:
    ...
    def test_redact_aws_key(self, redactor: Any) -> None:
    ...
    def test_redact_jwt(self, redactor: Any) -> None:
    ...
    def test_redact_api_key_equals(self, redactor: Any) -> None:
    ...
    def test_redact_api_key_colon(self, redactor: Any) -> None:
        """Should redact api_key: value format."""
    ...
    def test_redact_password_equals(self, redactor: Any) -> None:
    ...
    def test_redact_pwd_colon(self, redactor: Any) -> None:
    ...
    def test_redact_anthropic_key(self, redactor: Any) -> None:
    ...
    def test_preserve_safe_text(self, redactor: Any) -> None:
        """Should not modify text without secrets."""
        text = "Normal log message with no secrets"
        result = redactor.redact_secrets(text)
        assert result == text

    def test_multiple_secrets(self, redactor: Any) -> None:
    ...
    def test_filter_log_record(self, redactor: Any) -> None:
    ...
    def test_filter_log_args_dict(self, redactor: Any) -> None:
    ...
    def test_filter_log_args_tuple(self, redactor: Any) -> None:
        ...
        if isinstance(record.args, tuple) and len(record.args) > 0:
            arg_value = record.args[0]
            if isinstance(arg_value, str):
                assert "[REDACTED_OPENAI_KEY]" in arg_value

    def test_filter_non_string_args(self, redactor: Any) -> None:
...
class TestInstallation:
    ...
    def test_install_on_logger(self, logger: Any) -> None:
    ...
    def test_install_idempotent(self, logger: Any) -> None:
    ...
    def test_remove_redactor(self, logger: Any) -> None:
...
class TestIntegration:
    ...
    def test_logs_with_secrets_redacted(self, logger: Any, caplog: Any) -> None:
    ...
    def test_formatted_logs_redacted(self, logger: Any, caplog: Any) -> None:
    ...
    def test_direct_log_message_redacted(self, logger: Any, caplog: Any) -> None:
