...
# Skip if OpenTelemetry is not installed (optional integration)
...
def test_otlp_config_loaded() -> None:
    ...
    print(f"[PASS] OTLP_TOKEN: ***{token[-8:] if token else 'None'}")


def test_otlp_import() -> None:
...
def test_otlp_client_creation() -> None:
