...
class TestResourceLimits:
    ...
    def test_custom_limits(self) -> None:
        ...
        limits = ResourceLimits(max_duration=60.0, max_memory_mb=256, allow_network=False)
...
"""
    ...
    def test_forbid_open(self) -> None:
    ...
    def test_forbid_os_import(self) -> None:
    ...
    def test_forbid_subprocess_import(self) -> None:
    ...
    def test_forbid_builtins_access(self) -> None:
    ...
    def test_allow_module_with_permission(self) -> None:
...
"""
    ...
    async def test_security_error_during_execution(self) -> None:
    ...
    async def test_safe_builtins_available(self) -> None:
...
"""
    ...
    async def test_typing_hints_available(self) -> None:
...
"""
    ...
    async def test_asyncio_available(self) -> None:
...
"""
    ...
    async def test_partial_execution_before_error(self) -> None:
...
class TestSandboxFactory:
    ...
    def test_docker_not_implemented_yet(self) -> None:
...
class TestExecutionResult:
    ...
    def test_success_result(self) -> None:
        ...
        result = ExecutionResult(
            success=True, output="test", stdout="output", stderr="", duration=1.5
        )
...
"""
    ...
    async def test_exception_with_context(self) -> None:
...
"""
    ...
    async def test_dictionary_operations(self) -> None:
