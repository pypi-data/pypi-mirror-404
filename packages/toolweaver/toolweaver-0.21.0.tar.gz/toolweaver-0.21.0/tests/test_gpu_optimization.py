...
def use_local_embeddings() -> Any:
    """
    Use 'local' embedding provider for GPU optimization tests.

    These tests measure GPU performance and normalization, requiring actual
    embeddings rather than zero vectors from 'none' provider.
    """
...
@pytest.fixture
def sample_catalog(sample_tools: Any) -> Any:
    """Create a sample tool catalog"""
    catalog = ToolCatalog(source="test_catalog")
...
class TestGPUDetection:
    ...
    def test_detect_cuda_available(self) -> None:
    ...
    def test_detect_mps_available(self) -> None:
    ...
    def test_gpu_disabled_by_config(self) -> None:
...
class TestBatchEmbeddingGeneration:
    ...
    def test_batch_embeddings_without_cache(self) -> None:
    ...
    def test_batch_embeddings_with_cache(self) -> None:
    ...
    def test_batch_size_adjustment_for_gpu(self) -> None:
...
class TestPrecomputation:
    ...
    def test_precompute_catalog_embeddings(self, sample_catalog: Any) -> None:
    ...
    def test_precompute_empty_catalog(self) -> None:
        ...
        empty_catalog = ToolCatalog(source="empty")
    ...
    def test_precompute_disabled_by_config(self, sample_catalog: Any) -> None:
    ...
    def test_precompute_timing_with_cuda(self, sample_catalog: Any) -> None:
...
class TestSearchWithCache:
    ...
    def test_search_uses_cache(self, sample_catalog: Any) -> None:
    ...
    def test_search_without_precompute(self, sample_catalog: Any) -> None:
...
class TestCacheKeyGeneration:
    ...
    def test_cache_key_truncation(self) -> None:
