...
@pytest.fixture
def stub_dir(tool_catalog: ToolCatalog) -> Generator[Path, None, None]:
...
@pytest.fixture
def filesystem(stub_dir: Path) -> ToolFileSystem:
...
class TestToolFileSystem:
    ...
    def test_initialization(self, stub_dir: Any) -> None:
    ...
    def test_list_tools_all(self, filesystem: Any) -> None:
    ...
    def test_list_tools_by_server(self, filesystem: Any) -> None:
    ...
    def test_list_tools_invalid_server(self, filesystem: Any) -> None:
        """Test listing tools for non-existent server"""
        tools = filesystem.list_tools("nonexistent")
        assert tools == []

    def test_get_tool_info(self, filesystem: Any) -> None:
    ...
    def test_get_tool_info_caching(self, filesystem: Any) -> None:
    ...
    def test_get_tool_info_invalid(self, filesystem: Any) -> None:
        """Test getting info for non-existent tool"""
        info = filesystem.get_tool_info("nonexistent_tool")
        assert info is None

    def test_get_tool_info_parameters(self, filesystem: Any) -> None:
    ...
    def test_get_import_statement(self, filesystem: Any) -> None:
    ...
    def test_get_import_statement_invalid(self, filesystem: Any) -> None:
        """Test import statement for non-existent tool"""
        stmt = filesystem.get_import_statement("nonexistent")
        assert stmt is None

    def test_search_tools_by_name(self, filesystem: Any) -> None:
    ...
    def test_search_tools_by_description(self, filesystem: Any) -> None:
    ...
    def test_search_tools_case_insensitive(self, filesystem: Any) -> None:
    ...
    def test_search_tools_no_matches(self, filesystem: Any) -> None:
        """Test search with no matches"""
        results = filesystem.search_tools("xyz_nonexistent")
        assert results == []

    def test_get_directory_tree(self, filesystem: Any) -> None:
    ...
    def test_find_tool_file(self, filesystem: Any) -> None:
    ...
    def test_find_tool_file_invalid(self, filesystem: Any) -> None:
        """Test finding non-existent tool file"""
        path = filesystem._find_tool_file("nonexistent")
        assert path is None

    def test_extract_parameters(self, filesystem: Any) -> None:
    ...
    def test_extract_parameters_no_args(self, filesystem: Any) -> None:
...
class TestToolFileSystemIntegration:
    ...
    def test_full_workflow(self, filesystem: Any) -> None:
    ...
    def test_progressive_discovery_pattern(self, filesystem: Any) -> None:
