...
class TestStreamingMetadataSurface:
    ...
    def test_mcp_streaming_metadata_in_discovery(self) -> None:
    ...
    def test_a2a_agent_streaming_metadata(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_agent_discoverer_surfaces_streaming(self) -> None:
    ...
    def test_tool_definition_streaming_schema(self) -> None:
        ...
        tool = ToolDefinition(
            ...
            output_schema={
                "type": "object",
                "properties": {"report": {"type": "string"}, "metadata": {"type": "object"}},
            },
            metadata={
                "supports_streaming": True,
    ...
    @pytest.mark.asyncio
    async def test_streaming_metadata_in_discovery_response(self) -> None:
    ...
    def test_streaming_guidance_in_tool_metadata(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_streaming_discovery_consistency(self) -> None:
        ...
        mcp_tool = ToolDefinition(
            ...
            input_schema={"type": "object"},
            output_schema={"type": "object"},
            metadata={"supports_streaming": True, "execution_time_ms": 500},
        )
    ...
    def test_streaming_parameter_exposure(self) -> None:
        ...
        props = tool.input_schema["properties"]  # type: ignore[index]
