...
def test_sanitize_string_valid() -> None:
...
def test_sanitize_string_too_long() -> None:
...
def test_sanitize_dict_simple() -> None:
...
def test_sanitize_dict_nested() -> None:
    ...
    input_dict = {"user": {"name": "Alice", "settings": {"theme": "dark"}}}
    result = sanitize_dict(input_dict)
...
def test_sanitize_dict_too_many_keys() -> None:
...
def test_sanitize_dict_too_deep() -> None:
...
def test_sanitize_dict_with_dangerous_value() -> None:
...
def test_validate_file_path_simple(tmp_path: Any) -> None:
...
def test_validate_file_path_traversal(tmp_path: Any) -> None:
    """Test detection of path traversal."""
...
def test_validate_file_path_within_base(tmp_path: Any) -> None:
...
def test_validate_code_simple() -> None:
...
def test_validate_code_function() -> None:
...
def test_validate_code_import_blocked() -> None:
...
def test_validate_code_import_allowed() -> None:
...
def test_validate_code_eval() -> None:
    """Test blocking eval()."""
    code = "eval('1 + 1')"
...
def test_validate_code_exec() -> None:
    """Test blocking exec()."""
    code = "exec('print(1)')"
...
def test_validate_code_os_system() -> None:
...
def test_validate_code_open_blocked() -> None:
...
def test_validate_code_open_allowed() -> None:
...
def test_validate_code_too_long() -> None:
...
def test_validate_params_valid() -> None:
    ...
    result = cast(UserParams, validate_params(params, UserParams))
...
def test_validate_tool_input_simple() -> None:
...
def test_validate_tool_input_with_sanitization() -> None:
...
def test_validate_tool_input_dangerous() -> None:
...
def test_validate_tool_input_with_schema() -> None:
...
def test_validate_tool_input_schema_validation_fails() -> None:
...
def test_full_validation_workflow() -> None:
