...
def sample_catalog() -> ToolCatalog:
    ...
    catalog.add_tool(
        ToolDefinition(
            ...
            parameters=[
                ToolParameter(
                    name="image_url", type="string", description="Receipt image URL", required=True
                )
            ],
            domain="finance",
            source="test",
...
class TestToolSearchEngineBasic:
    ...
    def test_search_engine_initialization(self, temp_cache_dir: Any) -> None:
    ...
    def test_custom_weights(self, temp_cache_dir: Any) -> None:
        """Test custom BM25 and embedding weights"""
        engine = ToolSearchEngine(bm25_weight=0.5, embedding_weight=0.5, cache_dir=temp_cache_dir)
        assert engine.bm25_weight == 0.5
        assert engine.embedding_weight == 0.5

    def test_empty_catalog_returns_empty_results(self, temp_cache_dir: Any) -> None:
...
class TestSmartRouting:
    ...
    def test_small_catalog_skips_search(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
...
class TestBM25Search:
    ...
    def test_bm25_exact_match(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
    ...
    def test_bm25_normalization(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
...
class TestEmbeddingSearch:
    ...
    def test_embedding_initialization(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
    ...
    def test_embedding_semantic_match(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
    ...
    def test_embedding_scores_normalized(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
...
class TestHybridScoring:
    ...
    def test_hybrid_combines_scores(self, temp_cache_dir: Any) -> None:
...
class TestCaching:
    ...
    def test_embedding_caching(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
    ...
    def test_query_result_caching(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
        """Test query results are cached"""
        # Need >20 tools for actual search
        for i in range(15):
            sample_catalog.add_tool(
                ToolDefinition(
...
class TestScoreThresholds:
    ...
    def test_min_score_filtering(self, temp_cache_dir: Any) -> None:
        ...
        results = engine.search("super specific unique testing", catalog, top_k=10, min_score=0.5)
...
class TestResultRanking:
    ...
    def test_results_sorted_by_score(self, temp_cache_dir: Any) -> None:
    ...
    def test_top_k_limit(self, temp_cache_dir: Any) -> None:
...
class TestConvenienceFunction:
    ...
    def test_search_tools_returns_definitions_only(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
        """Test convenience function returns tools without scores"""
        tools = search_tools("receipt", sample_catalog, top_k=3, cache_dir=temp_cache_dir)
    ...
    def test_search_tools_filters_by_domain(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
...
class TestExplainResults:
    ...
    def test_explain_results_format(self, sample_catalog: Any, temp_cache_dir: Any) -> None:
