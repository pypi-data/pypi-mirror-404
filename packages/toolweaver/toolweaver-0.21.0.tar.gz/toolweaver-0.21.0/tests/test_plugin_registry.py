...
class AnotherValidPlugin:
    ...
    def get_tools(self) -> list[dict[str, Any]]:
        return [{"name": "test_tool_2", "description": "Test tool 2", "parameters": {}}]
...
def test_global_convenience_functions(clean_registry: Any) -> None:
...
def test_register_plugin(clean_registry: Any) -> None:
...
def test_register_multiple_plugins(clean_registry: Any) -> None:
...
def test_register_duplicate_plugin(clean_registry: Any) -> None:
...
def test_register_duplicate_plugin_with_replace(clean_registry: Any) -> None:
...
def test_register_invalid_plugin_no_get_tools(clean_registry: Any) -> None:
    ...
    with pytest.raises(InvalidPluginError, match="must implement get_tools"):
        register_plugin("invalid", NoGetTools())  # type: ignore[arg-type]


def test_register_invalid_plugin_no_execute(clean_registry: Any) -> None:
    ...
    with pytest.raises(InvalidPluginError, match="must implement execute"):
        register_plugin("invalid", NoExecute())  # type: ignore[arg-type]
...
def test_get_plugin_success(clean_registry: Any) -> None:
...
def test_get_plugin_not_found(clean_registry: Any) -> None:
...
def test_list_plugins_empty(clean_registry: Any) -> None:
    """Test listing plugins when registry is empty."""
    assert list_plugins() == []


def test_list_plugins_with_plugins(clean_registry: Any) -> None:
...
def test_unregister_plugin(clean_registry: Any) -> None:
...
def test_unregister_nonexistent_plugin(clean_registry: Any) -> None:
...
def test_plugin_get_tools(clean_registry: Any) -> None:
...
@pytest.mark.asyncio
async def test_plugin_execute(clean_registry: Any) -> None:
...
def test_registry_has_method(clean_registry: Any) -> None:
...
def test_registry_clear_method(clean_registry: Any) -> None:
...
def test_registry_get_all_tools(clean_registry: Any) -> None:
...
def test_plugin_get_tools_failure(clean_registry: Any) -> None:
    ...
    def register_many() -> None:
        try:
            for _ in range(100):
                ...
                class UniquePlugin:
                    def __init__(self, plugin_idx: int) -> None:
...
def test_get_registry_singleton(clean_registry: Any) -> None:
...
def test_plugin_workflow(clean_registry: Any) -> None:
