...
class TestPIIDetector:
    ...
    def test_multiple_pii_detection(self) -> None:
    ...
    def test_has_pii_method(self) -> None:
...
class TestPIIRedaction:
    ...
    def test_multiple_pii_redaction(self) -> None:
...
class TestResponseFilter:
    ...
    def test_filter_sensitive_keys(self) -> None:
    ...
    def test_filter_pii_in_values(self) -> None:
        """Test PII redaction in string values."""
        filter = ResponseFilter()

        response = {"message": "User email is user@example.com"}
    ...
    def test_filter_nested_dict(self) -> None:
        ...
        response = {"user": {"name": "John", "email": "john@test.com", "password": "secret"}}
    ...
    def test_filter_list_values(self) -> None:
        """Test filtering lists."""
        filter = ResponseFilter()

        response = {"emails": ["user1@test.com", "user2@test.com"]}
    ...
    def test_filter_string_response(self) -> None:
    ...
    def test_filter_passthrough_types(self) -> None:
        """Test that non-sensitive types pass through."""
        filter = ResponseFilter()

        response = {"count": 42, "enabled": True, "items": [1, 2, 3]}
    ...
    def test_no_metadata_when_clean(self) -> None:
        """Test that clean responses don't get metadata."""
        filter = ResponseFilter()

        response = {"message": "All good", "status": "ok"}
    ...
    def test_filter_string_method(self) -> None:
...
class TestEdgeCases:
    ...
    def test_none_values_in_response(self) -> None:
        """Test None value handling."""
        filter = ResponseFilter()

        response = {"result": None, "message": "test"}
    ...
    def test_case_insensitive_keys(self) -> None:
        ...
        response = {"PASSWORD": "secret", "Api_Key": "key123"}
