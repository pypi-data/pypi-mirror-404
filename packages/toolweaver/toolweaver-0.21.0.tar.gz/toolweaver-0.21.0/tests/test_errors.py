...
def test_require_packages_aggregates_missing() -> None:
...
def test_optional_feature_logs_and_continues(caplog: Any) -> None:
...
def test_get_install_suggestion_map_and_fallback() -> None:
