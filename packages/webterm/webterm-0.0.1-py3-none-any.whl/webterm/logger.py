"""Custom logger for webterm using rich library."""
...
class WebtermLogger:
    ...
    def __init__(self, name: str = "webterm", level: str = "INFO"):
...
def get_logger(name: Optional[str] = None) -> WebtermLogger:
    ...
    Returns:
        WebtermLogger instance
    """
    if name is None:
        return logger
    return WebtermLogger(name)