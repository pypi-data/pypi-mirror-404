### The codes in this file is copy from https://github.com/anazalea/pySankey
### original author: Anneya Golob & marcomanz & pierre-sassoulas & jorwoods
...
def sankey(left, right, ax, leftWeight=None, rightWeight=None, colorDict=None,
    ...
    Inputs:
        ...
        ax = Matplotlib axes object to draw the plot on, if None a new figure is created
    Output:
        ax = Matplotlib axes object containing the Sankey diagram
    '''
