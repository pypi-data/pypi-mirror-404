...
def _heatmap_with_dendrogram_and_bar(
        ...
        x_map: dict = None,
        y_map: dict = None,
        x_dendrogram: bool = False,
        y_dendrogram: bool = False,
        x_bar: bool = True,
        y_bar: bool = True,
    ...
    if x_bar:
        ...
        sns.countplot(x=x_label, data=data_count, ax=bottom_hist, order=new_xtick, palette=palette, **xbar_kwags)
    ...
    if y_bar:
        ...
        sns.countplot(y=y_label, data=data_count, ax=right_hist, orient='h', order=new_ytick, palette=palette, **ybar_kwags)
