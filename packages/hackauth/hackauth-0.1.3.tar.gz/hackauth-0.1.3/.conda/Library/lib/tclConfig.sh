...
# installed.
TCL_PREFIX='e:/HackClub/Flavortown/Authenticator/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='e:/HackClub/Flavortown/Authenticator/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='e:/HackClub/Flavortown/Authenticator/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ie:/HackClub/Flavortown/Authenticator/.conda\Library\include'
...
TCL_PACKAGE_PATH='e:/HackClub/Flavortown/Authenticator/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Le:/HackClub/Flavortown/Authenticator/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='e:/HackClub/Flavortown/Authenticator/.conda\Library\lib\tclstub86.lib'
