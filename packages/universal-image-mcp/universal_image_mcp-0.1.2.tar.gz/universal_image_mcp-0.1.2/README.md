...
| Style | Model | Output |
|-------|-------|--------|
| **Technical Diagram** | OpenAI `gpt-image-1.5` | ![OpenAI Technical](https://raw.githubusercontent.com/manu-mishra/universal-image-mcp/main/images/universal-image-mcp-architecture.png) |
| **Technical Diagram** | Google `gemini-2.5-flash-image` | ![Gemini Technical](https://raw.githubusercontent.com/manu-mishra/universal-image-mcp/main/images/universal-image-mcp-architecture-gemini.png) |
| **Technical Diagram** | AWS `amazon.nova-canvas-v1:0` | ![Nova Technical](https://raw.githubusercontent.com/manu-mishra/universal-image-mcp/main/images/universal-image-mcp-architecture-nova.png) |
| **3D Clay Art** | Google `gemini-2.5-flash-image` | ![Gemini Clay](https://raw.githubusercontent.com/manu-mishra/universal-image-mcp/main/images/universal-image-mcp-architecture-clay-gemini.png) |
| **3D Clay Art** | OpenAI `gpt-image-1.5` | ![OpenAI Clay](https://raw.githubusercontent.com/manu-mishra/universal-image-mcp/main/images/universal-image-mcp-architecture-clay-openai.png) |
| **3D Clay Art** | AWS `amazon.nova-canvas-v1:0` | ![Nova Clay](https://raw.githubusercontent.com/manu-mishra/universal-image-mcp/main/images/universal-image-mcp-architecture-clay-nova.png) |
