...
class servify_read:
    ...
    def __init__(self, spark=None, log_enabled: bool | None = None):
        ...
        # Import dinâmico para evitar congelar LOG_ENABLED
        from servify.servify_configs import LOG_ENABLED  # pylint: disable=import-outside-toplevel

        # Se o usuário não passar nada, usa o global
