...
class CertificateUtils:
    ...
    def create_server_certificate(
        ...
        """
        Create a server certificate signed by CA using mcp_security_framework.
        ...
        return CertificateCreator.create_server_certificate(
            ...
            validity_days, key_size, san_dns, san_ip, roles or []
        )
    ...
    def create_client_certificate(
        ...
        return CertificateCreator.create_client_certificate(
            common_name, output_dir, ca_cert_path, ca_key_path,
            validity_days, key_size, roles or []
        )
    ...
    def create_ssl_context(
        ...
        verify_mode: Any = 0,  # Compatible with ssl.CERT_* ints or strings
        ...
        if hasattr(mode, "name"):
            ...
            mapping = {0: "CERT_NONE", 1: "CERT_OPTIONAL", 2: "CERT_REQUIRED"}
            mode = mapping.get(mode, "CERT_NONE")

        return SSLContextManager.create_ssl_context(
            cert_file, key_file, ca_cert_file, str(mode), check_hostname
        )
