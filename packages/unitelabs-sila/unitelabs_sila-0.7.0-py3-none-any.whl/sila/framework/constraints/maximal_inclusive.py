...
class MaximalInclusive(Constraint[T]):
    ...
    value: T
    """
    The upper inclusive limit for the value.
    """
    ...
    async def validate(self, value: T) -> bool:
        ...
        if value > self.value:
            msg = f"Value '{value}' must be less than or equal to the maximal inclusive limit of '{self.value}'."
    ...
    def serialize(self, serializer: Serializer) -> None:
        serializer.write_str("MaximalInclusive", str(self.value))
