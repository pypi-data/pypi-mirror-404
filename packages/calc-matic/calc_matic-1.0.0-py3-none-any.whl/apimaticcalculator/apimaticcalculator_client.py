...
from apimaticcalculator.apis.simple_calculator_api import (
    SimpleCalculatorApi,
)
...
class ApimaticcalculatorClient(object):
    ...
    def simple_calculator(self):
        """Provide access to the SimpleCalculatorApi endpoints."""
        return SimpleCalculatorApi(self.global_configuration)
