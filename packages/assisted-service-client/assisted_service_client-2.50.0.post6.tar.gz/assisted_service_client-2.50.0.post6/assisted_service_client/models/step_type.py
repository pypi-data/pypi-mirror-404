...
class StepType(object):
    ...
    TANG_CONNECTIVITY_CHECK = "tang-connectivity-check"
    ...
    DOWNLOAD_BOOT_ARTIFACTS = "download-boot-artifacts"
    REBOOT_FOR_RECLAIM = "reboot-for-reclaim"
    VERIFY_VIPS = "verify-vips"
