...
class Interface(object):
    ...
    def __init__(self, ipv6_addresses=None, vendor=None, name=None, has_carrier=None, product=None, mtu=None, ipv4_addresses=None, biosdevname=None, client_id=None, mac_address=None, flags=None, speed_mbps=None, type=None):  # noqa: E501
