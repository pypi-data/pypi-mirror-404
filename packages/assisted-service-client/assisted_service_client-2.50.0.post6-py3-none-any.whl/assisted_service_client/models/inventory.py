...
class Inventory(object):
    ...
    @property
    def routes(self):
        """Gets the routes of this Inventory.  # noqa: E501


        :return: The routes of this Inventory.  # noqa: E501
        :rtype: list[Route]
        """
        return self._routes
    ...
    def routes(self, routes):
        """Sets the routes of this Inventory.


        :param routes: The routes of this Inventory.  # noqa: E501
        :type: list[Route]
        """
    ...
    def tpm_version(self):
        """Gets the tpm_version of this Inventory.  # noqa: E501


        :return: The tpm_version of this Inventory.  # noqa: E501
        :rtype: str
        """
    ...
    def tpm_version(self, tpm_version):
        """Sets the tpm_version of this Inventory.


        :param tpm_version: The tpm_version of this Inventory.  # noqa: E501
        :type: str
        """
        allowed_values = ["none", "1.2", "2.0"]  # noqa: E501
        if tpm_version not in allowed_values:
            raise ValueError(
                "Invalid value for `tpm_version` ({0}), must be one of {1}"  # noqa: E501
                .format(tpm_version, allowed_values)
            )
