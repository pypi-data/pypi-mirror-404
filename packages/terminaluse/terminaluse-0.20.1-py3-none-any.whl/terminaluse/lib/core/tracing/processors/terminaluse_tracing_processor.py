...
from terminaluse.lib.types.tracing import TerminalUseTracingProcessorConfig
...
class TerminalUseSyncTracingProcessor(SyncTracingProcessor):
    def __init__(self, config: TerminalUseTracingProcessorConfig):  # noqa: ARG002
        self.client = TerminalUse()
...
class TerminalUseAsyncTracingProcessor(AsyncTracingProcessor):
    def __init__(self, config: TerminalUseTracingProcessorConfig):  # noqa: ARG002
        self.client = create_async_terminaluse_client()
