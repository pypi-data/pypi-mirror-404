...
class AgentTaskTrackerModule:
    """
    Module for managing agent task trackers in TerminalUse.
    ...
    def __init__(
        ...
        if agent_task_tracker_service is None:
            ...
            self._agent_task_tracker_service = AgentTaskTrackerService(terminaluse_client=terminaluse_client, tracer=tracer)
        else:
