...
class MessagesActivities:
    ...
    async def send(self, params: CreateMessageParams) -> TaskMessage:
        return await self._messages_service.send(
    ...
    async def send_batch(self, params: CreateMessagesBatchParams) -> list[TaskMessage]:
