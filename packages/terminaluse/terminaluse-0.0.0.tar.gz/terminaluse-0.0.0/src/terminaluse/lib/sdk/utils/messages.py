...
class DefaultTextContentConverter(TaskMessageConverter):
    ...
    def convert(self, task_message: TaskMessage) -> Message:
        ...
        if not isinstance(task_message.content, TaskMessageContent_Text):
            raise ValueError(f"Expected TaskMessageContent_Text, got {type(task_message.content)}")
...
class DefaultToolRequestConverter(TaskMessageConverter):
    ...
    def convert(self, task_message: TaskMessage) -> Message:
        ...
        if not isinstance(task_message.content, TaskMessageContent_ToolRequest):
            raise ValueError(f"Expected TaskMessageContent_ToolRequest, got {type(task_message.content)}")
...
class DefaultToolResponseConverter(TaskMessageConverter):
    ...
    def convert(self, task_message: TaskMessage) -> Message:
        ...
        if not isinstance(task_message.content, TaskMessageContent_ToolResponse):
            raise ValueError(f"Expected TaskMessageContent_ToolResponse, got {type(task_message.content)}")
...
class DefaultDataContentConverter(TaskMessageConverter):
    ...
    def convert(self, task_message: TaskMessage) -> Message:
        ...
        if not isinstance(task_message.content, TaskMessageContent_Data):
            raise ValueError(f"Expected TaskMessageContent_Data, got {type(task_message.content)}")
