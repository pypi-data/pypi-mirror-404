...
from terminaluse.lib.core.temporal.activities.adk.agents_activities import AgentsActivityName, GetAgentParams
from temporalio.common import RetryPolicy

from terminaluse import AsyncTerminalUse  # noqa: F401
from terminaluse.lib.core.services.adk.agents import AgentsService
...
class AgentsModule:
    """
    Module for managing agents in TerminalUse.
    ...
    def __init__(
        ...
        if agents_service is None:
            ...
            self._agents_service = AgentsService(terminaluse_client=terminaluse_client, tracer=tracer)
        else:
