...
from terminaluse.lib.core.temporal.activities.adk.tasks_activities import (
    DeleteTaskParams,
    GetTaskParams,
    TasksActivityName,
)
...
class TasksModule:
    """
    Module for managing tasks in TerminalUse.
    ...
    def __init__(
        ...
        if tasks_service is None:
            ...
            self._tasks_service = TasksService(terminaluse_client=terminaluse_client, tracer=tracer)
        else:
