"""
Debug process handlers for TerminalUse CLI.
...
async def start_temporal_worker_debug(worker_path: Path, env: Dict[str, str], debug_config: DebugConfig):
    ...
    debug_env.update(
        {
            "TERMINALUSE_DEBUG_ENABLED": "true",
            "TERMINALUSE_DEBUG_PORT": str(debug_port),
            "TERMINALUSE_DEBUG_WAIT_FOR_ATTACH": str(debug_config.wait_for_attach).lower(),
            "TERMINALUSE_DEBUG_TYPE": "worker",
        }
    )
...
def inject_debug_code_to_worker_template() -> str:
    ...
    return (
        """
# === DEBUG SETUP (Auto-generated by TerminalUse CLI) ===
"""
