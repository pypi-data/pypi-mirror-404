...
class PlaidAccountsApi:
    ...
    @validate_call
    async def get_all_plaid_accounts(
        self,
    ...
    @validate_call
    async def get_all_plaid_accounts_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_all_plaid_accounts_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_plaid_account_by_id(
        self,
    ...
    @validate_call
    async def get_plaid_account_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the plaid account to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_plaid_account_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the plaid account to retrieve")],
        _request_timeout: Union[
            None,
