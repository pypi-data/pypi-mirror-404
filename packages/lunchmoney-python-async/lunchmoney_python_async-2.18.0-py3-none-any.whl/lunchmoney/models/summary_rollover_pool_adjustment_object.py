...
class SummaryRolloverPoolAdjustmentObject(BaseModel):
    ...
    amount: StrictStr = Field(description="Amount of the rollover pool at the time of the adjustment.")
    currency: CurrencyEnum = Field(description="Currency of the rollover pool at the time of the adjustment.")
    to_base: Union[StrictFloat, StrictInt] = Field(description="Amount of the rollover pool converted to the user's default currency.")
