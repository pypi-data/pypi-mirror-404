...
class TestTransactionsFilesApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_attach_file_to_transaction(self) -> None:
    ...
    async def test_delete_transaction_attachment(self) -> None:
    ...
    async def test_get_transaction_attachment_url(self) -> None:
