...
class TestUpdateManualAccountRequestObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateManualAccountRequestObject:
        """Test UpdateManualAccountRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateManualAccountRequestObject`
        """
        model = UpdateManualAccountRequestObject()
        if include_optional:
            return UpdateManualAccountRequestObject(
                id = 56,
                name = '0',
                type = 'cash',
                subtype = '0',
    ...
    def testUpdateManualAccountRequestObject(self):
        """Test UpdateManualAccountRequestObject"""
