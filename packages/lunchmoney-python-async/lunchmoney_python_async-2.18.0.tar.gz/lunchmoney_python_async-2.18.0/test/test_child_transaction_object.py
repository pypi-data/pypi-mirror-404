...
class TestChildTransactionObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChildTransactionObject:
        """Test ChildTransactionObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildTransactionObject`
        """
        model = ChildTransactionObject()
        if include_optional:
            return ChildTransactionObject(
                id = 56,
    ...
    def testChildTransactionObject(self):
        """Test ChildTransactionObject"""
