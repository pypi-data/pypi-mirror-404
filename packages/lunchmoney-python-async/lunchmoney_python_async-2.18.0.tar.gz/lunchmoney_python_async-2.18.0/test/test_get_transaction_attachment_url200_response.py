...
class TestGetTransactionAttachmentUrl200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransactionAttachmentUrl200Response:
        """Test GetTransactionAttachmentUrl200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransactionAttachmentUrl200Response`
        """
        model = GetTransactionAttachmentUrl200Response()
        if include_optional:
    ...
    def testGetTransactionAttachmentUrl200Response(self):
        """Test GetTransactionAttachmentUrl200Response"""
