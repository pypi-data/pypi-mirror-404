...
class TestDeleteTagResponseWithDependencies(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeleteTagResponseWithDependencies:
        """Test DeleteTagResponseWithDependencies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteTagResponseWithDependencies`
        """
        model = DeleteTagResponseWithDependencies()
        if include_optional:
    ...
    def testDeleteTagResponseWithDependencies(self):
        """Test DeleteTagResponseWithDependencies"""
