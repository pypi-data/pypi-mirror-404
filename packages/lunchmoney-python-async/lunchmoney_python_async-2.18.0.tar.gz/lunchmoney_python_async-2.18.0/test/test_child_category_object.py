...
class TestChildCategoryObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChildCategoryObject:
        """Test ChildCategoryObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildCategoryObject`
        """
        model = ChildCategoryObject()
        if include_optional:
            return ChildCategoryObject(
                id = 56,
                name = '0',
                description = '',
                is_income = True,
    ...
    def testChildCategoryObject(self):
        """Test ChildCategoryObject"""
