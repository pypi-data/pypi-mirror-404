...
class TestUpdateTransactionObject(unittest.TestCase):
    """UpdateTransactionObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTransactionObject:
        """Test UpdateTransactionObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTransactionObject`
        """
        model = UpdateTransactionObject()
        if include_optional:
            return UpdateTransactionObject(
                id = 56,
    ...
    def testUpdateTransactionObject(self):
        """Test UpdateTransactionObject"""
