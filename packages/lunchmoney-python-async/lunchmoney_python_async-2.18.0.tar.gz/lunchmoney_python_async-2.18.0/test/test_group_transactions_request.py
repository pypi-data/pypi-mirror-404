...
class TestGroupTransactionsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GroupTransactionsRequest:
        """Test GroupTransactionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupTransactionsRequest`
        """
        model = GroupTransactionsRequest()
        if include_optional:
    ...
    def testGroupTransactionsRequest(self):
        """Test GroupTransactionsRequest"""
