...
class TestTransactionsGroupApi(unittest.IsolatedAsyncioTestCase):
    """TransactionsGroupApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = TransactionsGroupApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_group_transactions(self) -> None:
        """Test case for group_transactions

        Create a transaction group
        """
        pass

    async def test_ungroup_transactions(self) -> None:
        """Test case for ungroup_transactions
