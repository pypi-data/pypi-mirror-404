...
class TestRecurringItemsApi(unittest.IsolatedAsyncioTestCase):
    """RecurringItemsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = RecurringItemsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_get_all_recurring(self) -> None:
        """Test case for get_all_recurring

        Get all recurring items
        """
        pass

    async def test_get_recurring_by_id(self) -> None:
        """Test case for get_recurring_by_id
