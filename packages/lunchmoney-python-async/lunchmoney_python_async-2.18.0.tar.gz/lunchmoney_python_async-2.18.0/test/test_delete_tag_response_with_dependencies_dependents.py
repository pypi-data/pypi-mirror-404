...
class TestDeleteTagResponseWithDependenciesDependents(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeleteTagResponseWithDependenciesDependents:
        ...
        # uncomment below to create an instance of `DeleteTagResponseWithDependenciesDependents`
        """
        model = DeleteTagResponseWithDependenciesDependents()
        if include_optional:
            return DeleteTagResponseWithDependenciesDependents(
                rules = 56,
                transactions = 56
            )
        else:
    ...
    def testDeleteTagResponseWithDependenciesDependents(self):
        """Test DeleteTagResponseWithDependenciesDependents"""
