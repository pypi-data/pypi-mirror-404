...
class TestCreateCategoryRequestObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateCategoryRequestObject:
        """Test CreateCategoryRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCategoryRequestObject`
        """
        model = CreateCategoryRequestObject()
        if include_optional:
            return CreateCategoryRequestObject(
                name = '0',
                description = '',
                is_income = True,
    ...
    def testCreateCategoryRequestObject(self):
        """Test CreateCategoryRequestObject"""
