...
class TestDeleteCategoryResponseWithDependencies(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeleteCategoryResponseWithDependencies:
        """Test DeleteCategoryResponseWithDependencies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteCategoryResponseWithDependencies`
        """
        model = DeleteCategoryResponseWithDependencies()
        if include_optional:
    ...
    def testDeleteCategoryResponseWithDependencies(self):
        """Test DeleteCategoryResponseWithDependencies"""
