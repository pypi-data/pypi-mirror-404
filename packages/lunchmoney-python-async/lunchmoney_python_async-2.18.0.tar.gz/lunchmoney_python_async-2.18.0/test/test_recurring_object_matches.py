...
class TestRecurringObjectMatches(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecurringObjectMatches:
        """Test RecurringObjectMatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecurringObjectMatches`
        """
        model = RecurringObjectMatches()
        if include_optional:
            return RecurringObjectMatches(
    ...
    def testRecurringObjectMatches(self):
        """Test RecurringObjectMatches"""
