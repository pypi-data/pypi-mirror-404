...
class TestUpdateTransactionsRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateTransactionsRequest:
        """Test UpdateTransactionsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTransactionsRequest`
        """
        model = UpdateTransactionsRequest()
        if include_optional:
    ...
    def testUpdateTransactionsRequest(self):
        """Test UpdateTransactionsRequest"""
