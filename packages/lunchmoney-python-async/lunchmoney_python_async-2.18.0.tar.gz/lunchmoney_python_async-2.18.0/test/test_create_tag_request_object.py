...
class TestCreateTagRequestObject(unittest.TestCase):
    """CreateTagRequestObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTagRequestObject:
        """Test CreateTagRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTagRequestObject`
        """
        model = CreateTagRequestObject()
        if include_optional:
            return CreateTagRequestObject(
                name = '0',
                description = '',
                text_color = '',
                background_color = '',
    ...
    def testCreateTagRequestObject(self):
        """Test CreateTagRequestObject"""
