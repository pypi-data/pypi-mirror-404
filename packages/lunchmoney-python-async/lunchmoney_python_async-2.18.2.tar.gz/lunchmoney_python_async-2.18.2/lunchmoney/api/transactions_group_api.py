...
class TransactionsGroupApi:
    ...
    @validate_call
    async def group_transactions_with_http_info(
        self,
        group_transactions_request: GroupTransactionsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def group_transactions_without_preload_content(
        self,
        group_transactions_request: GroupTransactionsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def ungroup_transactions_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the transaction group to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def ungroup_transactions_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the transaction group to delete")],
        _request_timeout: Union[
            None,
