...
class TransactionsSplitApi:
    ...
    @validate_call
    async def split_transaction_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the transaction to spit")],
        split_transaction_request: SplitTransactionRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def split_transaction_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the transaction to spit")],
        split_transaction_request: SplitTransactionRequest,
        _request_timeout: Union[
    ...
    @validate_call
    async def unsplit_transaction_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the previously split transaction to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def unsplit_transaction_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the previously split transaction to delete.")],
        _request_timeout: Union[
            None,
