...
class TestManualAccountObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ManualAccountObject:
        """Test ManualAccountObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManualAccountObject`
        """
    ...
    def testManualAccountObject(self):
        """Test ManualAccountObject"""
