...
class TestNonAlignedCategoryTotalsObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NonAlignedCategoryTotalsObject:
        """Test NonAlignedCategoryTotalsObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonAlignedCategoryTotalsObject`
        """
        model = NonAlignedCategoryTotalsObject()
        if include_optional:
            return NonAlignedCategoryTotalsObject(
    ...
    def testNonAlignedCategoryTotalsObject(self):
        """Test NonAlignedCategoryTotalsObject"""
