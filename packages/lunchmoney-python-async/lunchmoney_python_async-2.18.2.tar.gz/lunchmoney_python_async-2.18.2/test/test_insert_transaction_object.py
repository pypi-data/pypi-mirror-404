...
class TestInsertTransactionObject(unittest.TestCase):
    """InsertTransactionObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsertTransactionObject:
        """Test InsertTransactionObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsertTransactionObject`
        """
        model = InsertTransactionObject()
        if include_optional:
    ...
    def testInsertTransactionObject(self):
        """Test InsertTransactionObject"""
