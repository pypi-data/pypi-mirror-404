...
class TestGetAllTransactionsCreatedSinceParameter(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetAllTransactionsCreatedSinceParameter:
        """Test GetAllTransactionsCreatedSinceParameter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllTransactionsCreatedSinceParameter`
        """
        model = GetAllTransactionsCreatedSinceParameter()
        if include_optional:
            return GetAllTransactionsCreatedSinceParameter(
            )
        else:
            return GetAllTransactionsCreatedSinceParameter(
        )
    ...
    def testGetAllTransactionsCreatedSinceParameter(self):
        """Test GetAllTransactionsCreatedSinceParameter"""
