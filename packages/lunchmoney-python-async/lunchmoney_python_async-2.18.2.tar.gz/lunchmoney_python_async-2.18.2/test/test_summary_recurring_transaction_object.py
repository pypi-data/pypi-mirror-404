...
class TestSummaryRecurringTransactionObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SummaryRecurringTransactionObject:
        """Test SummaryRecurringTransactionObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SummaryRecurringTransactionObject`
        """
        model = SummaryRecurringTransactionObject()
        if include_optional:
            return SummaryRecurringTransactionObject(
    ...
    def testSummaryRecurringTransactionObject(self):
        """Test SummaryRecurringTransactionObject"""
