...
class TestManualAccountsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_delete_manual_account(self) -> None:
    ...
    async def test_get_all_manual_accounts(self) -> None:
    ...
    async def test_get_manual_account_by_id(self) -> None:
    ...
    async def test_update_manual_account(self) -> None:
