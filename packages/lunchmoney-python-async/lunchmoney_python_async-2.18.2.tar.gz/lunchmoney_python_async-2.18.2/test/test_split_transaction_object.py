...
class TestSplitTransactionObject(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SplitTransactionObject:
        """Test SplitTransactionObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SplitTransactionObject`
        """
        model = SplitTransactionObject()
        if include_optional:
            return SplitTransactionObject(
                amount = None,
                payee = '',
    ...
    def testSplitTransactionObject(self):
        """Test SplitTransactionObject"""
