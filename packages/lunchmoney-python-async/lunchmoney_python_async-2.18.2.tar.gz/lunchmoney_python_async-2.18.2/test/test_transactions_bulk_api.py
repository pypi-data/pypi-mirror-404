...
class TestTransactionsBulkApi(unittest.IsolatedAsyncioTestCase):
    """TransactionsBulkApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = TransactionsBulkApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_create_new_transactions(self) -> None:
        """Test case for create_new_transactions

        Insert one or more transactions.
        """
        pass

    async def test_delete_transactions(self) -> None:
    ...
    async def test_get_all_transactions(self) -> None:
