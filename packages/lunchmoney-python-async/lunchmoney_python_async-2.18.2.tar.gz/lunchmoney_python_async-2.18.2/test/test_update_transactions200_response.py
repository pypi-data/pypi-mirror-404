...
class TestUpdateTransactions200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateTransactions200Response:
        """Test UpdateTransactions200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTransactions200Response`
        """
        model = UpdateTransactions200Response()
        if include_optional:
    ...
    def testUpdateTransactions200Response(self):
        """Test UpdateTransactions200Response"""
