...
class TestErrorResponseObjectErrorsInner(unittest.TestCase):
    """ErrorResponseObjectErrorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorResponseObjectErrorsInner:
        """Test ErrorResponseObjectErrorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorResponseObjectErrorsInner`
        """
        model = ErrorResponseObjectErrorsInner()
        if include_optional:
            return ErrorResponseObjectErrorsInner(
                err_msg = ''
            )
        else:
            return ErrorResponseObjectErrorsInner(
    ...
    def testErrorResponseObjectErrorsInner(self):
        """Test ErrorResponseObjectErrorsInner"""
