...
class Group(BaseModel):
    ...
    type: Optional[PayGroupType] = PayGroupType.UNSPECIFIED
    parent_group_merge_account_id: Optional[StrictStr] = Field(default=None, alias="parentGroupMergeAccountId")
    ...
    __properties: ClassVar[List[str]] = ["id", "remoteId", "name", "type", "parentGroupMergeAccountId", "remoteWasDeleted", "createdAt", "modifiedAt", "mergeAccountId", "deletedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "type": obj.get("type") if obj.get("type") is not None else PayGroupType.UNSPECIFIED,
            "parentGroupMergeAccountId": obj.get("parentGroupMergeAccountId"),
