...
class Milestone(BaseModel):
    ...
    target_date: Optional[StrictStr] = Field(default=None, alias="targetDate")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "targetDate", "targetAmount", "isCompleted", "budget", "createdAt", "deletedAt"]
