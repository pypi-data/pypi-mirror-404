...
class UpdateCommentRequest(BaseModel):
    """
    Comment Update Operations UpdateCommentRequest represents a request to update various aspects of a comment including content, metadata, visibility, and status.
    """ # noqa: E501
