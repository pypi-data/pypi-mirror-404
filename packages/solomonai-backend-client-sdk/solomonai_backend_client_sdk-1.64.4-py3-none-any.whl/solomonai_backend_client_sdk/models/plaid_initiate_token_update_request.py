...
class PlaidInitiateTokenUpdateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["userId", "linkId", "profileType", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaidInitiateTokenUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaidInitiateTokenUpdateRequest from a dict"""
        if obj is None:
            return None
