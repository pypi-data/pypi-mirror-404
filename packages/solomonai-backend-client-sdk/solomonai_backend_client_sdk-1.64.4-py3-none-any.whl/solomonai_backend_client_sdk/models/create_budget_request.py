...
class CreateBudgetRequest(BaseModel):
    ...
    CreateBudgetRequest
    """ # noqa: E501
    milestrone_id: StrictStr = Field(alias="milestroneId")
    budget: Budget
    ...
    __properties: ClassVar[List[str]] = ["milestroneId", "budget", "userId", "profileType", "orgId", "tenantId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "milestroneId": obj.get("milestroneId"),
