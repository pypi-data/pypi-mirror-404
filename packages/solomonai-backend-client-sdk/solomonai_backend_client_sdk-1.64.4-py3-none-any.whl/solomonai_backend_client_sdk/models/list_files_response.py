...
class ListFilesResponse(BaseModel):
    ...
    statistics: Optional[Dict[str, StrictStr]] = None
    total_size: Optional[StrictStr] = Field(default=None, description="Total size of all matching files", alias="totalSize")
    type_counts: Optional[Dict[str, StrictInt]] = Field(default=None, alias="typeCounts")
    tag_counts: Optional[Dict[str, StrictInt]] = Field(default=None, alias="tagCounts")
    __properties: ClassVar[List[str]] = ["files", "totalCount", "nextPageToken", "statistics", "totalSize", "typeCounts", "tagCounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "typeCounts": obj.get("typeCounts"),
            "tagCounts": obj.get("tagCounts")
        })
        return _obj
