...
class PlaidSyncAccountFromAccessTokenRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["userId", "accessToken", "institutionId", "institutionName", "profileType", "itemId", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaidSyncAccountFromAccessTokenRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaidSyncAccountFromAccessTokenRequest from a dict"""
        if obj is None:
            return None
