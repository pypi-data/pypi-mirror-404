...
class ReportItem(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The report item's name.")
    value: Optional[StrictStr] = Field(default=None, description="The report item's value.")
    ...
    __properties: ClassVar[List[str]] = ["id", "remoteId", "name", "value", "company", "modifiedAt", "createdAt", "deletedAt"]
