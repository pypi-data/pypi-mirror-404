...
class AccountBalanceHistory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["time", "accountId", "isoCurrencyCode", "balance", "userId", "sign", "id", "profileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountBalanceHistory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountBalanceHistory from a dict"""
        if obj is None:
            return None
