...
class UpdateUserV2Response(BaseModel):
    """
    UpdateUserV2Response
    """ # noqa: E501
    account_updated: Optional[StrictBool] = Field(default=None, alias="accountUpdated")
    ...
    __properties: ClassVar[List[str]] = ["accountUpdated", "userAccount", "businessAccount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateUserV2Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateUserV2Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "accountUpdated": obj.get("accountUpdated"),
