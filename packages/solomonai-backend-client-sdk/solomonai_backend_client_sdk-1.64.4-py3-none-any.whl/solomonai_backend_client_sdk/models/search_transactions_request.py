...
class SearchTransactionsRequest(BaseModel):
    ...
    page_number: StrictStr = Field(alias="pageNumber")
    page_size: StrictStr = Field(alias="pageSize")
    ...
    __properties: ClassVar[List[str]] = ["userId", "profileType", "pageNumber", "pageSize", "minAmount", "maxAmount", "category", "startDate", "endDate", "financialAccountType", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchTransactionsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchTransactionsRequest from a dict"""
        if obj is None:
            return None
