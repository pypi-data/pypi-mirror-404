...
class GetPostsByCategoryResponse(BaseModel):
    """
    GetPostsByCategoryResponse
    """ # noqa: E501
    posts: Optional[List[Post]] = None
    next_offset: Optional[StrictStr] = Field(default=None, alias="nextOffset")
    __properties: ClassVar[List[str]] = ["posts", "nextOffset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetPostsByCategoryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetPostsByCategoryResponse from a dict"""
        if obj is None:
            return None
