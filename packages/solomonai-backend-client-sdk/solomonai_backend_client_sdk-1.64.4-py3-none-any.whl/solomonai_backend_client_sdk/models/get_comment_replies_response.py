...
class GetCommentRepliesResponse(BaseModel):
    """
    GetCommentRepliesResponse
    """ # noqa: E501
    replies: Optional[List[CommentReply]] = None
    __properties: ClassVar[List[str]] = ["replies"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCommentRepliesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCommentRepliesResponse from a dict"""
        if obj is None:
            return None
