...
class ExpenseMetrics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["month", "personalFinanceCategoryPrimary", "transactionCount", "totalExpenses", "userId", "profileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpenseMetrics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpenseMetrics from a dict"""
        if obj is None:
            return None
