...
class Actor(BaseModel):
    ...
    actor_type: AccountType = Field(alias="actorType")
    __properties: ClassVar[List[str]] = ["userProfile", "community", "actorType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "community": CommunityProfile.from_dict(obj["community"]) if obj.get("community") is not None else None,
            "actorType": obj.get("actorType") if obj.get("actorType") is not None else AccountType.UNSPECIFIED
        })
        return _obj
