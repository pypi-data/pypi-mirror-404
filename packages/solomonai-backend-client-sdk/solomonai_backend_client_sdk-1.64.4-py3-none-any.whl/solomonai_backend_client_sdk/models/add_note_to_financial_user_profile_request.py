...
class AddNoteToFinancialUserProfileRequest(BaseModel):
    """
    AddNoteToFinancialUserProfileRequest
    """ # noqa: E501
    business_account_id: StrictStr = Field(alias="businessAccountId")
    note: SmartNote
    ...
    __properties: ClassVar[List[str]] = ["businessAccountId", "note", "userId", "profileType", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddNoteToFinancialUserProfileRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddNoteToFinancialUserProfileRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "businessAccountId": obj.get("businessAccountId"),
