...
class GenerateFileEmbeddingsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "jobId", "estimatedCompletionTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerateFileEmbeddingsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerateFileEmbeddingsResponse from a dict"""
        if obj is None:
            return None
