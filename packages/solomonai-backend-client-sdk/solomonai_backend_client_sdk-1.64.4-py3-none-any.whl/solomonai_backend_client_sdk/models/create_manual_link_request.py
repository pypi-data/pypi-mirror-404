...
class CreateManualLinkRequest(BaseModel):
    ...
    manual_account_link: Link = Field(alias="manualAccountLink")
    ...
    __properties: ClassVar[List[str]] = ["userId", "manualAccountLink", "profileType", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateManualLinkRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of manual_account_link
        if self.manual_account_link:
            _dict['manualAccountLink'] = self.manual_account_link.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateManualLinkRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "manualAccountLink": Link.from_dict(obj["manualAccountLink"]) if obj.get("manualAccountLink") is not None else None,
