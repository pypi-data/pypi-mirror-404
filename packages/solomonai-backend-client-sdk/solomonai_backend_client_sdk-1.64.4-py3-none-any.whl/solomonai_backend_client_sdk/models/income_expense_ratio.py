...
class IncomeExpenseRatio(BaseModel):
    """
    IncomeExpenseRatio This message is used to represent the income expense ratio of a user.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["month", "ratio", "userId", "profileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IncomeExpenseRatio from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IncomeExpenseRatio from a dict"""
        if obj is None:
            return None
