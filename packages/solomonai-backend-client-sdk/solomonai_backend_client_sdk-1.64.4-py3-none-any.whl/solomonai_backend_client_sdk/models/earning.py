...
class Earning(BaseModel):
    ...
    type: Optional[EarningType] = EarningType.UNSPECIFIED
    ...
    __properties: ClassVar[List[str]] = ["id", "remoteId", "amount", "type", "remoteWasDeleted", "createdAt", "modifiedAt", "payrollRunMergeAccountId", "mergeAccountId", "deletedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else EarningType.UNSPECIFIED,
