...
class TaxRate(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="The tax rate's description.")
    total_tax_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The tax rate's total tax rate.", alias="totalTaxRate")
    effective_tax_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The tax rate's effective tax rate.", alias="effectiveTaxRate")
    company: Optional[StrictStr] = Field(default=None, description="The company the tax rate belongs to.")
    ...
    __properties: ClassVar[List[str]] = ["id", "remoteId", "description", "totalTaxRate", "effectiveTaxRate", "company", "remoteWasDeleted", "modifiedAt", "mergeRecordId", "createdAt", "deletedAt"]
