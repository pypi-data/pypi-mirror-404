...
class TestListTeamInvitesResponse(unittest.TestCase):
    """ListTeamInvitesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTeamInvitesResponse:
        """Test ListTeamInvitesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTeamInvitesResponse`
        """
        model = ListTeamInvitesResponse()
        if include_optional:
            return ListTeamInvitesResponse(
                team_invites = [
...
Metadata for additional flexibility(), 
    ...
    def testListTeamInvitesResponse(self):
        """Test ListTeamInvitesResponse"""
