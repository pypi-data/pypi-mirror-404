...
class TestGetMelodyFinancialContextResponse(unittest.TestCase):
    """GetMelodyFinancialContextResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMelodyFinancialContextResponse:
        """Test GetMelodyFinancialContextResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMelodyFinancialContextResponse`
        """
        model = GetMelodyFinancialContextResponse()
        if include_optional:
            return GetMelodyFinancialContextResponse(
                melody_financial_context = solomonai_backend_client_sdk.models.melody_financial_context.MelodyFinancialContext(
                    categories = [
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testGetMelodyFinancialContextResponse(self):
        """Test GetMelodyFinancialContextResponse"""
