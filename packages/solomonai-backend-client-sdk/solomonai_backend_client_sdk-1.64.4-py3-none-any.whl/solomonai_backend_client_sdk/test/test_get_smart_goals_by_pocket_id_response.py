...
class TestGetSmartGoalsByPocketIdResponse(unittest.TestCase):
    """GetSmartGoalsByPocketIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSmartGoalsByPocketIdResponse:
        """Test GetSmartGoalsByPocketIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSmartGoalsByPocketIdResponse`
        """
        model = GetSmartGoalsByPocketIdResponse()
        if include_optional:
            return GetSmartGoalsByPocketIdResponse(
                smart_goals = [
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testGetSmartGoalsByPocketIdResponse(self):
        """Test GetSmartGoalsByPocketIdResponse"""
