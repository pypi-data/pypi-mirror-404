...
class TestAddPostToPublicationResponse(unittest.TestCase):
    """AddPostToPublicationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddPostToPublicationResponse:
        """Test AddPostToPublicationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddPostToPublicationResponse`
        """
        model = AddPostToPublicationResponse()
        if include_optional:
            return AddPostToPublicationResponse(
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testAddPostToPublicationResponse(self):
        """Test AddPostToPublicationResponse"""
