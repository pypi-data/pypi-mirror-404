...
class TestUpdateFileResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateFileResponse:
        """Test UpdateFileResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateFileResponse`
        """
        model = UpdateFileResponse()
        if include_optional:
            return UpdateFileResponse(
                metadata = solomonai_backend_client_sdk.models.file_metadata.FileMetadata(
                    id = '', 
                    name = '', 
