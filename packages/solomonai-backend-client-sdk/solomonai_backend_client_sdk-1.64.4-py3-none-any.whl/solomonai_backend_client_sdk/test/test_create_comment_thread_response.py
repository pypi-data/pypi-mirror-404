...
class TestCreateCommentThreadResponse(unittest.TestCase):
    """CreateCommentThreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCommentThreadResponse:
        """Test CreateCommentThreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCommentThreadResponse`
        """
        model = CreateCommentThreadResponse()
        if include_optional:
            return CreateCommentThreadResponse(
    ...
    def testCreateCommentThreadResponse(self):
        """Test CreateCommentThreadResponse"""
