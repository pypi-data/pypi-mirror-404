...
class TestBulkUpdateRecurringTransactionResponse(unittest.TestCase):
    """BulkUpdateRecurringTransactionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateRecurringTransactionResponse:
        """Test BulkUpdateRecurringTransactionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkUpdateRecurringTransactionResponse`
        """
        model = BulkUpdateRecurringTransactionResponse()
        if include_optional:
            return BulkUpdateRecurringTransactionResponse(
                transactions = [
    ...
    def testBulkUpdateRecurringTransactionResponse(self):
        """Test BulkUpdateRecurringTransactionResponse"""
