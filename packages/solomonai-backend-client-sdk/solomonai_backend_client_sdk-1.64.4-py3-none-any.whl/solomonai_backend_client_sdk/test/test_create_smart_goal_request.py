...
class TestCreateSmartGoalRequest(unittest.TestCase):
    """CreateSmartGoalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSmartGoalRequest:
        """Test CreateSmartGoalRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSmartGoalRequest`
        """
        model = CreateSmartGoalRequest()
        if include_optional:
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testCreateSmartGoalRequest(self):
        """Test CreateSmartGoalRequest"""
