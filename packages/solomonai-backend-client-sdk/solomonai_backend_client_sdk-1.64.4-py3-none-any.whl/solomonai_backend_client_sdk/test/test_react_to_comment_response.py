...
class TestReactToCommentResponse(unittest.TestCase):
    """ReactToCommentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReactToCommentResponse:
        """Test ReactToCommentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReactToCommentResponse`
        """
        model = ReactToCommentResponse()
        if include_optional:
            return ReactToCommentResponse(
...
intimate feedback protocol(
    ...
    def testReactToCommentResponse(self):
        """Test ReactToCommentResponse"""
