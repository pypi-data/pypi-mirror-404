...
class TestAddTenantMemberBody(unittest.TestCase):
    """AddTenantMemberBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddTenantMemberBody:
        """Test AddTenantMemberBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddTenantMemberBody`
        """
        model = AddTenantMemberBody()
        if include_optional:
            return AddTenantMemberBody(
                organization_id = '',
...
- must provide between 1 and 10 metadata tags(), 
    ...
    def testAddTenantMemberBody(self):
        """Test AddTenantMemberBody"""
