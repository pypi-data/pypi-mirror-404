...
class TestListTenantTeamMembersResponse(unittest.TestCase):
    """ListTenantTeamMembersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTenantTeamMembersResponse:
        """Test ListTenantTeamMembersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTenantTeamMembersResponse`
        """
        model = ListTenantTeamMembersResponse()
        if include_optional:
            return ListTenantTeamMembersResponse(
                team_members = [
...
- must provide between 1 and 10 metadata tags(), 
    ...
    def testListTenantTeamMembersResponse(self):
        """Test ListTenantTeamMembersResponse"""
