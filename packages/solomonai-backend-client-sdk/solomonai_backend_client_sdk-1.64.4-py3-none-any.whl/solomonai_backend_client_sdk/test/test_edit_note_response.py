...
class TestEditNoteResponse(unittest.TestCase):
    """EditNoteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditNoteResponse:
        """Test EditNoteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditNoteResponse`
        """
        model = EditNoteResponse()
        if include_optional:
