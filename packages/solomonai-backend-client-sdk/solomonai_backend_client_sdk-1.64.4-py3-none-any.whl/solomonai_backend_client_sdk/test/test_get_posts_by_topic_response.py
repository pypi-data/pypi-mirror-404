...
class TestGetPostsByTopicResponse(unittest.TestCase):
    """GetPostsByTopicResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPostsByTopicResponse:
        """Test GetPostsByTopicResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPostsByTopicResponse`
        """
        model = GetPostsByTopicResponse()
        if include_optional:
            return GetPostsByTopicResponse(
                posts = [
...
intimate feedback protocol(
    ...
    def testGetPostsByTopicResponse(self):
        """Test GetPostsByTopicResponse"""
