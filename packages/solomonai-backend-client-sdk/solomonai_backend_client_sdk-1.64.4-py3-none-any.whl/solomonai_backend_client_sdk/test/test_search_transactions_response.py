...
class TestSearchTransactionsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SearchTransactionsResponse:
        """Test SearchTransactionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchTransactionsResponse`
        """
        model = SearchTransactionsResponse()
        if include_optional:
