...
class TestCreateOrganizationApiKeyResponse(unittest.TestCase):
    """CreateOrganizationApiKeyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrganizationApiKeyResponse:
        """Test CreateOrganizationApiKeyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrganizationApiKeyResponse`
        """
        model = CreateOrganizationApiKeyResponse()
        if include_optional:
            return CreateOrganizationApiKeyResponse(
                api_key = solomonai_backend_client_sdk.models.org_api_key.OrgAPIKey(
                    id = '', 
                    key_name = '', 
                    description = '', 
                    key_id = '', 
...
@typedef {Object} Permission(
    ...
    def testCreateOrganizationApiKeyResponse(self):
        """Test CreateOrganizationApiKeyResponse"""
