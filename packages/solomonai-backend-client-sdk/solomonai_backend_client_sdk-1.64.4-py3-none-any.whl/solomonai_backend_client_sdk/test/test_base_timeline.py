...
class TestBaseTimeline(unittest.TestCase):
    """BaseTimeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseTimeline:
        """Test BaseTimeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseTimeline`
        """
        model = BaseTimeline()
        if include_optional:
            return BaseTimeline(
