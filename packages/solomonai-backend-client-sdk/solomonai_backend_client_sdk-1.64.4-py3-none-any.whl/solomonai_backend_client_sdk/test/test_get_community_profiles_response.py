...
class TestGetCommunityProfilesResponse(unittest.TestCase):
    """GetCommunityProfilesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommunityProfilesResponse:
        """Test GetCommunityProfilesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommunityProfilesResponse`
        """
        model = GetCommunityProfilesResponse()
        if include_optional:
            return GetCommunityProfilesResponse(
                next_page_number = 56,
                profiles = [
    ...
    def testGetCommunityProfilesResponse(self):
        """Test GetCommunityProfilesResponse"""
