...
class TestGetCommunitiesUserFollowsResponse(unittest.TestCase):
    """GetCommunitiesUserFollowsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommunitiesUserFollowsResponse:
        """Test GetCommunitiesUserFollowsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommunitiesUserFollowsResponse`
        """
        model = GetCommunitiesUserFollowsResponse()
        if include_optional:
            return GetCommunitiesUserFollowsResponse(
                communities = [
    ...
    def testGetCommunitiesUserFollowsResponse(self):
        """Test GetCommunitiesUserFollowsResponse"""
