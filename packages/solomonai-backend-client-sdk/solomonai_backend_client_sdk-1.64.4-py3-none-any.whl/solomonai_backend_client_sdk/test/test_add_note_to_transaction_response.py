...
class TestAddNoteToTransactionResponse(unittest.TestCase):
    """AddNoteToTransactionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddNoteToTransactionResponse:
        """Test AddNoteToTransactionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddNoteToTransactionResponse`
        """
        model = AddNoteToTransactionResponse()
        if include_optional:
    ...
    def testAddNoteToTransactionResponse(self):
        """Test AddNoteToTransactionResponse"""
