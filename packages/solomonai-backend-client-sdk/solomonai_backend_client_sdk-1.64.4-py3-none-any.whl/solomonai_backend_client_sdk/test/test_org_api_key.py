...
class TestOrgAPIKey(unittest.TestCase):
    """OrgAPIKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgAPIKey:
        """Test OrgAPIKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgAPIKey`
        """
        model = OrgAPIKey()
        if include_optional:
            return OrgAPIKey(
