...
class TestUpdateTenantTeamMemberRequest(unittest.TestCase):
    """UpdateTenantTeamMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTenantTeamMemberRequest:
        """Test UpdateTenantTeamMemberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTenantTeamMemberRequest`
        """
        model = UpdateTenantTeamMemberRequest()
        if include_optional:
            return UpdateTenantTeamMemberRequest(
...
- must provide between 1 and 10 metadata tags(), 
    ...
    def testUpdateTenantTeamMemberRequest(self):
        """Test UpdateTenantTeamMemberRequest"""
