...
class TestGetCommunityBlogPostsResponse(unittest.TestCase):
    """GetCommunityBlogPostsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommunityBlogPostsResponse:
        """Test GetCommunityBlogPostsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommunityBlogPostsResponse`
        """
        model = GetCommunityBlogPostsResponse()
        if include_optional:
            return GetCommunityBlogPostsResponse(
                posts = [
                    solomonai_backend_client_sdk.models.posts:_critical_to_activities_and_define_the_content_sent_over_by_users_and
...
intimate feedback protocol(
    ...
    def testGetCommunityBlogPostsResponse(self):
        """Test GetCommunityBlogPostsResponse"""
