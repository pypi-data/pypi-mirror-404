...
class TestGetBlogPostsByTagResponse(unittest.TestCase):
    """GetBlogPostsByTagResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBlogPostsByTagResponse:
        """Test GetBlogPostsByTagResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBlogPostsByTagResponse`
        """
        model = GetBlogPostsByTagResponse()
        if include_optional:
            return GetBlogPostsByTagResponse(
                posts = [
...
intimate feedback protocol(
    ...
    def testGetBlogPostsByTagResponse(self):
        """Test GetBlogPostsByTagResponse"""
