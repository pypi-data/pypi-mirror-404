...
class TestPlaidAccountRecurringTransaction(unittest.TestCase):
    """PlaidAccountRecurringTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaidAccountRecurringTransaction:
        """Test PlaidAccountRecurringTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaidAccountRecurringTransaction`
        """
        model = PlaidAccountRecurringTransaction()
        if include_optional:
            return PlaidAccountRecurringTransaction(
                account_id = '',
                stream_id = '',
                category_id = '',
                description = '',
    ...
    def testPlaidAccountRecurringTransaction(self):
        """Test PlaidAccountRecurringTransaction"""
