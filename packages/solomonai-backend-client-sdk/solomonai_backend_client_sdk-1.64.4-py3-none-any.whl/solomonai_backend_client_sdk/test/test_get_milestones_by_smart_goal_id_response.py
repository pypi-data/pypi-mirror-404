...
class TestGetMilestonesBySmartGoalIdResponse(unittest.TestCase):
    """GetMilestonesBySmartGoalIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMilestonesBySmartGoalIdResponse:
        """Test GetMilestonesBySmartGoalIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMilestonesBySmartGoalIdResponse`
        """
        model = GetMilestonesBySmartGoalIdResponse()
        if include_optional:
            return GetMilestonesBySmartGoalIdResponse(
                milestones = [
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testGetMilestonesBySmartGoalIdResponse(self):
        """Test GetMilestonesBySmartGoalIdResponse"""
