...
class TestGetPollsResponse(unittest.TestCase):
    """GetPollsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPollsResponse:
        """Test GetPollsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPollsResponse`
        """
        model = GetPollsResponse()
        if include_optional:
            return GetPollsResponse(
                polls = [
                    solomonai_backend_client_sdk.models.poll_post.PollPost(
                        id = '', 
                        created_at = '', 
