...
class TestRemoveBookmarkedPostResponse(unittest.TestCase):
    """RemoveBookmarkedPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveBookmarkedPostResponse:
        """Test RemoveBookmarkedPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveBookmarkedPostResponse`
        """
        model = RemoveBookmarkedPostResponse()
        if include_optional:
            return RemoveBookmarkedPostResponse(
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testRemoveBookmarkedPostResponse(self):
        """Test RemoveBookmarkedPostResponse"""
