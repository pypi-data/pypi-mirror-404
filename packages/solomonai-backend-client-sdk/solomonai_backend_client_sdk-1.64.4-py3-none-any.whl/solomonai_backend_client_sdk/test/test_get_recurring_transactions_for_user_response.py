...
class TestGetRecurringTransactionsForUserResponse(unittest.TestCase):
    """GetRecurringTransactionsForUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRecurringTransactionsForUserResponse:
        """Test GetRecurringTransactionsForUserResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRecurringTransactionsForUserResponse`
        """
        model = GetRecurringTransactionsForUserResponse()
        if include_optional:
            return GetRecurringTransactionsForUserResponse(
                transactions = [
    ...
    def testGetRecurringTransactionsForUserResponse(self):
        """Test GetRecurringTransactionsForUserResponse"""
