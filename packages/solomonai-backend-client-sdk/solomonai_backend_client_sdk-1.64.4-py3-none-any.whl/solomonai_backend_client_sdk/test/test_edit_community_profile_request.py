...
class TestEditCommunityProfileRequest(unittest.TestCase):
    """EditCommunityProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditCommunityProfileRequest:
        """Test EditCommunityProfileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditCommunityProfileRequest`
        """
        model = EditCommunityProfileRequest()
        if include_optional:
            return EditCommunityProfileRequest(
    ...
    def testEditCommunityProfileRequest(self):
        """Test EditCommunityProfileRequest"""
