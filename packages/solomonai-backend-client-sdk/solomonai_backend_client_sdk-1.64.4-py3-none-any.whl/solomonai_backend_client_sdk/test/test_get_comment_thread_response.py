...
class TestGetCommentThreadResponse(unittest.TestCase):
    """GetCommentThreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommentThreadResponse:
        """Test GetCommentThreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommentThreadResponse`
        """
        model = GetCommentThreadResponse()
        if include_optional:
            return GetCommentThreadResponse(
                thread = [
    ...
    def testGetCommentThreadResponse(self):
        """Test GetCommentThreadResponse"""
