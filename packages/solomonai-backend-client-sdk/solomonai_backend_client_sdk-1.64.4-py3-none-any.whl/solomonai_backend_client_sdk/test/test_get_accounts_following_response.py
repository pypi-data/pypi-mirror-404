...
class TestGetAccountsFollowingResponse(unittest.TestCase):
    """GetAccountsFollowingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAccountsFollowingResponse:
        """Test GetAccountsFollowingResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAccountsFollowingResponse`
        """
        model = GetAccountsFollowingResponse()
        if include_optional:
            return GetAccountsFollowingResponse(
                users = [
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testGetAccountsFollowingResponse(self):
        """Test GetAccountsFollowingResponse"""
