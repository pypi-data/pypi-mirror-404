...
class TestRotateOrgAPIKeyResponse(unittest.TestCase):
    """RotateOrgAPIKeyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RotateOrgAPIKeyResponse:
        """Test RotateOrgAPIKeyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RotateOrgAPIKeyResponse`
        """
        model = RotateOrgAPIKeyResponse()
        if include_optional:
            return RotateOrgAPIKeyResponse(
                new_api_key = solomonai_backend_client_sdk.models.org_api_key.OrgAPIKey(
                    id = '', 
                    key_name = '', 
                    description = '', 
                    key_id = '', 
...
@typedef {Object} Permission(
    ...
    def testRotateOrgAPIKeyResponse(self):
        """Test RotateOrgAPIKeyResponse"""
