...
class TestGetPostsByCategoryResponse(unittest.TestCase):
    """GetPostsByCategoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPostsByCategoryResponse:
        """Test GetPostsByCategoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPostsByCategoryResponse`
        """
        model = GetPostsByCategoryResponse()
        if include_optional:
...
intimate feedback protocol(
    ...
    def testGetPostsByCategoryResponse(self):
        """Test GetPostsByCategoryResponse"""
