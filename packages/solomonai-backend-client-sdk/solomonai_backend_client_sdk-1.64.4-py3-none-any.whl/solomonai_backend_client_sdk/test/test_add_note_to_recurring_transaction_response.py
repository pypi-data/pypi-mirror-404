...
class TestAddNoteToRecurringTransactionResponse(unittest.TestCase):
    """AddNoteToRecurringTransactionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddNoteToRecurringTransactionResponse:
        """Test AddNoteToRecurringTransactionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddNoteToRecurringTransactionResponse`
        """
        model = AddNoteToRecurringTransactionResponse()
        if include_optional:
            return AddNoteToRecurringTransactionResponse(
    ...
    def testAddNoteToRecurringTransactionResponse(self):
        """Test AddNoteToRecurringTransactionResponse"""
