...
class TestCreateCommentReplyResponse(unittest.TestCase):
    """CreateCommentReplyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCommentReplyResponse:
        """Test CreateCommentReplyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCommentReplyResponse`
        """
        model = CreateCommentReplyResponse()
        if include_optional:
...
intimate feedback protocol(
    ...
    def testCreateCommentReplyResponse(self):
        """Test CreateCommentReplyResponse"""
