...
class TestInvestmentAccount(unittest.TestCase):
    """InvestmentAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestmentAccount:
        """Test InvestmentAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestmentAccount`
        """
    ...
    def testInvestmentAccount(self):
        """Test InvestmentAccount"""
