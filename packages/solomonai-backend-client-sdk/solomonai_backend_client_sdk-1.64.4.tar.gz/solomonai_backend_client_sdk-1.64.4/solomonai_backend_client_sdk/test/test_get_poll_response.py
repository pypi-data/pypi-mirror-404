...
class TestGetPollResponse(unittest.TestCase):
    """GetPollResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPollResponse:
        """Test GetPollResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPollResponse`
        """
        model = GetPollResponse()
        if include_optional:
