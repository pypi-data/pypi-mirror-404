...
class TestEditCommunityProfileResponse(unittest.TestCase):
    """EditCommunityProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditCommunityProfileResponse:
        """Test EditCommunityProfileResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditCommunityProfileResponse`
        """
        model = EditCommunityProfileResponse()
        if include_optional:
            return EditCommunityProfileResponse(
    ...
    def testEditCommunityProfileResponse(self):
        """Test EditCommunityProfileResponse"""
