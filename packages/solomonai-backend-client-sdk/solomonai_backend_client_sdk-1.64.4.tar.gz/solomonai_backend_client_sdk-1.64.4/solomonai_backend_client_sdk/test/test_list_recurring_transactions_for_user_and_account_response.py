...
class TestListRecurringTransactionsForUserAndAccountResponse(unittest.TestCase):
    """ListRecurringTransactionsForUserAndAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRecurringTransactionsForUserAndAccountResponse:
        """Test ListRecurringTransactionsForUserAndAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRecurringTransactionsForUserAndAccountResponse`
        """
        model = ListRecurringTransactionsForUserAndAccountResponse()
        if include_optional:
            return ListRecurringTransactionsForUserAndAccountResponse(
                next_page = '',
                transactions = [
    ...
    def testListRecurringTransactionsForUserAndAccountResponse(self):
        """Test ListRecurringTransactionsForUserAndAccountResponse"""
