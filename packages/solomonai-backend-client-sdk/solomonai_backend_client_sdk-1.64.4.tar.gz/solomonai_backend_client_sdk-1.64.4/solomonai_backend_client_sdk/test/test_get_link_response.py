...
class TestGetLinkResponse(unittest.TestCase):
    """GetLinkResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLinkResponse:
        """Test GetLinkResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLinkResponse`
        """
        model = GetLinkResponse()
        if include_optional:
            return GetLinkResponse(
                link = solomonai_backend_client_sdk.models.link.Link(
                    id = '', 
