...
class TestReactToPostResponse(unittest.TestCase):
    """ReactToPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReactToPostResponse:
        """Test ReactToPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReactToPostResponse`
        """
        model = ReactToPostResponse()
        if include_optional:
            return ReactToPostResponse(
...
intimate feedback protocol(
    ...
    def testReactToPostResponse(self):
        """Test ReactToPostResponse"""
