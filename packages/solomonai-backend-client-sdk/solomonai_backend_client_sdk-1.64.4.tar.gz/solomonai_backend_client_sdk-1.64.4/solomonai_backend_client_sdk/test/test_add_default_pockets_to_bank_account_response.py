...
class TestAddDefaultPocketsToBankAccountResponse(unittest.TestCase):
    """AddDefaultPocketsToBankAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddDefaultPocketsToBankAccountResponse:
        """Test AddDefaultPocketsToBankAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddDefaultPocketsToBankAccountResponse`
        """
        model = AddDefaultPocketsToBankAccountResponse()
        if include_optional:
            return AddDefaultPocketsToBankAccountResponse(
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
                    ...
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    deleted_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                credit_account = solomonai_backend_client_sdk.models.credit_account.CreditAccount(
                    id = '', 
                    user_id = '', 
                    name = '', 
                    number = '', 
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testAddDefaultPocketsToBankAccountResponse(self):
        """Test AddDefaultPocketsToBankAccountResponse"""
