...
class TestUpdateRecurringTransactionResponse(unittest.TestCase):
    """UpdateRecurringTransactionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateRecurringTransactionResponse:
        """Test UpdateRecurringTransactionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateRecurringTransactionResponse`
        """
        model = UpdateRecurringTransactionResponse()
        if include_optional:
            return UpdateRecurringTransactionResponse(
    ...
    def testUpdateRecurringTransactionResponse(self):
        """Test UpdateRecurringTransactionResponse"""
