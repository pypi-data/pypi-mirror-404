...
class TestReportPostResponse(unittest.TestCase):
    """ReportPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportPostResponse:
        """Test ReportPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPostResponse`
        """
        model = ReportPostResponse()
        if include_optional:
...
intimate feedback protocol(
    ...
    def testReportPostResponse(self):
        """Test ReportPostResponse"""
