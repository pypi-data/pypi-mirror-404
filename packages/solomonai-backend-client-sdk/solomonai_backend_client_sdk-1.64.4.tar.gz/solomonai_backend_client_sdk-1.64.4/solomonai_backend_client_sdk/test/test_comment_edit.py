...
class TestCommentEdit(unittest.TestCase):
    """CommentEdit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommentEdit:
        """Test CommentEdit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommentEdit`
        """
        model = CommentEdit()
        if include_optional:
            return CommentEdit(
