...
class TestListTenantAuditLogsResponse(unittest.TestCase):
    """ListTenantAuditLogsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTenantAuditLogsResponse:
        """Test ListTenantAuditLogsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTenantAuditLogsResponse`
        """
        model = ListTenantAuditLogsResponse()
        if include_optional:
    ...
    def testListTenantAuditLogsResponse(self):
        """Test ListTenantAuditLogsResponse"""
