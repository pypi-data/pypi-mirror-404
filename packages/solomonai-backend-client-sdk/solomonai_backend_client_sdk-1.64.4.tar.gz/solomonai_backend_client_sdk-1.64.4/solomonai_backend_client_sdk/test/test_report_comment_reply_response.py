...
class TestReportCommentReplyResponse(unittest.TestCase):
    """ReportCommentReplyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReportCommentReplyResponse:
        """Test ReportCommentReplyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportCommentReplyResponse`
        """
        model = ReportCommentReplyResponse()
        if include_optional:
            return ReportCommentReplyResponse(
    ...
    def testReportCommentReplyResponse(self):
        """Test ReportCommentReplyResponse"""
