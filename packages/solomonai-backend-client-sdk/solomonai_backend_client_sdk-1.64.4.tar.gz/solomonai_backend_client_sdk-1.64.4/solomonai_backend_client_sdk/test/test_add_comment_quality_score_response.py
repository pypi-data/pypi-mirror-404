...
class TestAddCommentQualityScoreResponse(unittest.TestCase):
    """AddCommentQualityScoreResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddCommentQualityScoreResponse:
        """Test AddCommentQualityScoreResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddCommentQualityScoreResponse`
        """
        model = AddCommentQualityScoreResponse()
        if include_optional:
            return AddCommentQualityScoreResponse(
...
intimate feedback protocol(
    ...
    def testAddCommentQualityScoreResponse(self):
        """Test AddCommentQualityScoreResponse"""
