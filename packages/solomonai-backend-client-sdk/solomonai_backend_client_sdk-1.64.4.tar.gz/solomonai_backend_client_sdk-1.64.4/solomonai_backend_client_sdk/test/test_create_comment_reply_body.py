...
class TestCreateCommentReplyBody(unittest.TestCase):
    """CreateCommentReplyBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCommentReplyBody:
        """Test CreateCommentReplyBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCommentReplyBody`
        """
        model = CreateCommentReplyBody()
        if include_optional:
            return CreateCommentReplyBody(
    ...
    def testCreateCommentReplyBody(self):
        """Test CreateCommentReplyBody"""
