...
class TestEditCommentReplyResponse(unittest.TestCase):
    """EditCommentReplyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditCommentReplyResponse:
        """Test EditCommentReplyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditCommentReplyResponse`
        """
        model = EditCommentReplyResponse()
        if include_optional:
    ...
    def testEditCommentReplyResponse(self):
        """Test EditCommentReplyResponse"""
