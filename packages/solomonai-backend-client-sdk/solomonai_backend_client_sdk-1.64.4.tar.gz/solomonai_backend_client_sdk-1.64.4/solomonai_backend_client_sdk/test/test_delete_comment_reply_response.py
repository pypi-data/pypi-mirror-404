...
class TestDeleteCommentReplyResponse(unittest.TestCase):
    """DeleteCommentReplyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteCommentReplyResponse:
        """Test DeleteCommentReplyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteCommentReplyResponse`
        """
        model = DeleteCommentReplyResponse()
        if include_optional:
            return DeleteCommentReplyResponse(
...
intimate feedback protocol(
    ...
    def testDeleteCommentReplyResponse(self):
        """Test DeleteCommentReplyResponse"""
