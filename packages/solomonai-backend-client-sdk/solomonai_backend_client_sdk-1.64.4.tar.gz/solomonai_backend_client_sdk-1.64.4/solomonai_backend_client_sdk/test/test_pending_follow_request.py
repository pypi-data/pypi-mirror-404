...
class TestPendingFollowRequest(unittest.TestCase):
    """PendingFollowRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingFollowRequest:
        """Test PendingFollowRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingFollowRequest`
        """
        model = PendingFollowRequest()
        if include_optional:
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testPendingFollowRequest(self):
        """Test PendingFollowRequest"""
