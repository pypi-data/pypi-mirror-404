...
class TestAddNoteToSmartGoalResponse(unittest.TestCase):
    """AddNoteToSmartGoalResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddNoteToSmartGoalResponse:
        """Test AddNoteToSmartGoalResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddNoteToSmartGoalResponse`
        """
        model = AddNoteToSmartGoalResponse()
        if include_optional:
            return AddNoteToSmartGoalResponse(
                goal = solomonai_backend_client_sdk.models.smart_goal.SmartGoal(
                    id = '', 
                    user_id = '', 
                    name = '', 
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testAddNoteToSmartGoalResponse(self):
        """Test AddNoteToSmartGoalResponse"""
