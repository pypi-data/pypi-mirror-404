...
class TestCreateCommunityProfileResponse(unittest.TestCase):
    """CreateCommunityProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCommunityProfileResponse:
        """Test CreateCommunityProfileResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCommunityProfileResponse`
        """
        model = CreateCommunityProfileResponse()
        if include_optional:
            return CreateCommunityProfileResponse(
    ...
    def testCreateCommunityProfileResponse(self):
        """Test CreateCommunityProfileResponse"""
