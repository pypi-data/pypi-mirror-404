...
class TestActionableInsight(unittest.TestCase):
    """ActionableInsight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionableInsight:
        """Test ActionableInsight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionableInsight`
        """
    ...
    def testActionableInsight(self):
        """Test ActionableInsight"""
