...
class TestBookmarkPublicationResponse(unittest.TestCase):
    """BookmarkPublicationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookmarkPublicationResponse:
        """Test BookmarkPublicationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookmarkPublicationResponse`
        """
        model = BookmarkPublicationResponse()
        if include_optional:
            return BookmarkPublicationResponse(
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testBookmarkPublicationResponse(self):
        """Test BookmarkPublicationResponse"""
