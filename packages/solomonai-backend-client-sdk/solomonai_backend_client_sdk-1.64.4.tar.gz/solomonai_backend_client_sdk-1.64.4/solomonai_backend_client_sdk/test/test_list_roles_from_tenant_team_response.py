...
class TestListRolesFromTenantTeamResponse(unittest.TestCase):
    """ListRolesFromTenantTeamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListRolesFromTenantTeamResponse:
        """Test ListRolesFromTenantTeamResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListRolesFromTenantTeamResponse`
        """
        model = ListRolesFromTenantTeamResponse()
        if include_optional:
            return ListRolesFromTenantTeamResponse(
                roles = [
    ...
    def testListRolesFromTenantTeamResponse(self):
        """Test ListRolesFromTenantTeamResponse"""
