...
class TestAddUserToTeamResponse(unittest.TestCase):
    """AddUserToTeamResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddUserToTeamResponse:
        """Test AddUserToTeamResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddUserToTeamResponse`
        """
        model = AddUserToTeamResponse()
        if include_optional:
...
Metadata for additional flexibility(), 
    ...
    def testAddUserToTeamResponse(self):
        """Test AddUserToTeamResponse"""
