...
Metadata for additional flexibility(), 
                ...
                ownership = solomonai_backend_client_sdk.models.team_ownership_defines_the_ownership_structure_of_a_team.TeamOwnership defines the ownership structure of a team(
                    id = '', 
                    admin = solomonai_backend_client_sdk.models.business_account.BusinessAccount(
                        id = '', 
                        email = 'example@gmail.com', 
                        username = 'testuser9696', 
                        phone_number = '6513424124', 
...
@typedef {Object} Permission(
                        ...
                        deleted_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                    permissions = [
                        solomonai_backend_client_sdk.models.ownership_permission_defines_specific_permissions_granted_to_team_owners.OwnershipPermission defines specific permissions granted to team owners(
                            id = '', 
                            permission_name = '', 
