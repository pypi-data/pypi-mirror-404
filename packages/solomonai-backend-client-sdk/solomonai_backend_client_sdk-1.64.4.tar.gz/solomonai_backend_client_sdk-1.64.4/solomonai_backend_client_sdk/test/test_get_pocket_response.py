...
class TestGetPocketResponse(unittest.TestCase):
    """GetPocketResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPocketResponse:
        """Test GetPocketResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPocketResponse`
        """
        model = GetPocketResponse()
        if include_optional:
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testGetPocketResponse(self):
        """Test GetPocketResponse"""
