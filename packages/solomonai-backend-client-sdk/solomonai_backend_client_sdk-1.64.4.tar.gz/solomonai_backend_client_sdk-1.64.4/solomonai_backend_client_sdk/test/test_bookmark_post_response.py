...
class TestBookmarkPostResponse(unittest.TestCase):
    """BookmarkPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BookmarkPostResponse:
        """Test BookmarkPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BookmarkPostResponse`
        """
        model = BookmarkPostResponse()
        if include_optional:
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testBookmarkPostResponse(self):
        """Test BookmarkPostResponse"""
