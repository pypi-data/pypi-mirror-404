...
class TestGetUserFeedResponse(unittest.TestCase):
    """GetUserFeedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserFeedResponse:
        """Test GetUserFeedResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserFeedResponse`
        """
        model = GetUserFeedResponse()
        if include_optional:
...
TODO: need to expose api endpoints to interact with shared posts(
    ...
    def testGetUserFeedResponse(self):
        """Test GetUserFeedResponse"""
