...
class TestPollPost(unittest.TestCase):
    """PollPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PollPost:
        """Test PollPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PollPost`
        """
        model = PollPost()
        if include_optional:
            return PollPost(
