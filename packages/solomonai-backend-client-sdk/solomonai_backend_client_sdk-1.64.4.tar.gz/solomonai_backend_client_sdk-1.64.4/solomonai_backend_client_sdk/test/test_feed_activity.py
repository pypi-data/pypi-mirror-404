...
class TestFeedActivity(unittest.TestCase):
    """FeedActivity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedActivity:
        """Test FeedActivity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeedActivity`
        """
        model = FeedActivity()
        if include_optional:
            return FeedActivity(
