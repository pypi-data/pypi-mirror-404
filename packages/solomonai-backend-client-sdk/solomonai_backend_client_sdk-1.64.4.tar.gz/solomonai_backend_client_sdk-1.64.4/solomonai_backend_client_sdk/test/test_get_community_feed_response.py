...
class TestGetCommunityFeedResponse(unittest.TestCase):
    """GetCommunityFeedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCommunityFeedResponse:
        """Test GetCommunityFeedResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCommunityFeedResponse`
        """
        model = GetCommunityFeedResponse()
        if include_optional:
            return GetCommunityFeedResponse(
                base_timeline = solomonai_backend_client_sdk.models.base_timeline.BaseTimeline(
                    activities = [
                        solomonai_backend_client_sdk.models.feed_activity_references_an_actvitiy_present_in_a_given_user's_timeline.FeedActivity references an actvitiy present in a given user's timeline(
                            actor = solomonai_backend_client_sdk.models.actor_references_the_profile_performing_an_operation.Actor references the profile performing an operation(
                                user_profile = solomonai_backend_client_sdk.models.user_profile:_the_profile_object_tied_to_a_given_user.UserProfile: The profile object tied to a given user(
                                    id = '', 
                                    tags = [
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
                                    ...
                                    algolia_id = 'asndlkhaskhdhasgdahsf-feed-id', ), 
                                community = solomonai_backend_client_sdk.models.community_profile:_the_profile_object_tied_to_a_given_community.CommunityProfile: The profile object tied to a given community(
                                    id = '', 
                                    name = 'test-community', 
                                    ...
                                    profile_image_url = 'asndlkhaskhdhasgdahsf.jpg', 
                                    algolia_id = 'asndlkhaskhdhasgdahsf-feed-id', ), 
                                actor_type = 'ACCOUNT_TYPE_UNSPECIFIED', ), 
                            verb = 'POST_TYPE_UNSPECIFIED', 
...
TODO: need to expose api endpoints to interact with shared posts(
                ...
                notification_timeline = solomonai_backend_client_sdk.models.notification_timeline.NotificationTimeline(
                    activities = [
    ...
    def testGetCommunityFeedResponse(self):
        """Test GetCommunityFeedResponse"""
