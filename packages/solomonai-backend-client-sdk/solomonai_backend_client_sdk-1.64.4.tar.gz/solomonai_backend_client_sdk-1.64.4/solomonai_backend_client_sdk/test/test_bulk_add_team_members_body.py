...
class TestBulkAddTeamMembersBody(unittest.TestCase):
    """BulkAddTeamMembersBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkAddTeamMembersBody:
        """Test BulkAddTeamMembersBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkAddTeamMembersBody`
        """
        model = BulkAddTeamMembersBody()
        if include_optional:
            return BulkAddTeamMembersBody(
                organization_id = '',
                tenant_id = '',
                members = [
...
- must provide between 1 and 10 metadata tags(), 
    ...
    def testBulkAddTeamMembersBody(self):
        """Test BulkAddTeamMembersBody"""
