...
class TestUpdateSmartGoalRequest(unittest.TestCase):
    """UpdateSmartGoalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateSmartGoalRequest:
        """Test UpdateSmartGoalRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateSmartGoalRequest`
        """
        model = UpdateSmartGoalRequest()
        if include_optional:
            return UpdateSmartGoalRequest(
                smart_goal = solomonai_backend_client_sdk.models.smart_goal.SmartGoal(
                    id = '', 
                    user_id = '', 
                    name = '', 
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testUpdateSmartGoalRequest(self):
        """Test UpdateSmartGoalRequest"""
