...
class TestEditCommentReplyBody(unittest.TestCase):
    """EditCommentReplyBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditCommentReplyBody:
        """Test EditCommentReplyBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditCommentReplyBody`
        """
        model = EditCommentReplyBody()
        if include_optional:
            return EditCommentReplyBody(
    ...
    def testEditCommentReplyBody(self):
        """Test EditCommentReplyBody"""
