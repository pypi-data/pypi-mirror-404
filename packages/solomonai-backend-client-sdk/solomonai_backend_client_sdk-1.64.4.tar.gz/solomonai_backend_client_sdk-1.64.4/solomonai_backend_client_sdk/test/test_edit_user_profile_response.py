...
class TestEditUserProfileResponse(unittest.TestCase):
    """EditUserProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditUserProfileResponse:
        """Test EditUserProfileResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditUserProfileResponse`
        """
        model = EditUserProfileResponse()
        if include_optional:
            return EditUserProfileResponse(
                profile = solomonai_backend_client_sdk.models.user_profile:_the_profile_object_tied_to_a_given_user.UserProfile: The profile object tied to a given user(
                    id = '', 
                    tags = [
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testEditUserProfileResponse(self):
        """Test EditUserProfileResponse"""
