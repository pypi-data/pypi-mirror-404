...
class TestAddPublicationEditorResponse(unittest.TestCase):
    """AddPublicationEditorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddPublicationEditorResponse:
        """Test AddPublicationEditorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddPublicationEditorResponse`
        """
        model = AddPublicationEditorResponse()
        if include_optional:
            return AddPublicationEditorResponse(
                publication = solomonai_backend_client_sdk.models.a_publication_is_a_collections_of_stories_based_around_a_common_theme/_anyone_can_create_them
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testAddPublicationEditorResponse(self):
        """Test AddPublicationEditorResponse"""
