...
class TestGetPostThreadResponse(unittest.TestCase):
    """GetPostThreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPostThreadResponse:
        """Test GetPostThreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPostThreadResponse`
        """
        model = GetPostThreadResponse()
        if include_optional:
...
intimate feedback protocol(
    ...
    def testGetPostThreadResponse(self):
        """Test GetPostThreadResponse"""
