...
class TestGetPendingFollowsResponse(unittest.TestCase):
    """GetPendingFollowsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPendingFollowsResponse:
        """Test GetPendingFollowsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPendingFollowsResponse`
        """
        model = GetPendingFollowsResponse()
        if include_optional:
            return GetPendingFollowsResponse(
                requests = [
                    solomonai_backend_client_sdk.models.pending_follow_request_defines_the_record_describing_the_given_pending_follow
relationship.PendingFollowRequest defines the record describing the given pending follow
relationship(
                        follow_request_id = '', 
                        follower_requestion_to_follow = solomonai_backend_client_sdk.models.user_profile:_the_profile_object_tied_to_a_given_user.UserProfile: The profile object tied to a given user(
                            id = '', 
                            tags = [
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testGetPendingFollowsResponse(self):
        """Test GetPendingFollowsResponse"""
