...
class TestInviteTeamMemberBody(unittest.TestCase):
    """InviteTeamMemberBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteTeamMemberBody:
        """Test InviteTeamMemberBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteTeamMemberBody`
        """
        model = InviteTeamMemberBody()
        if include_optional:
            return InviteTeamMemberBody(
                organization_id = '',
                team_id = '',
...
- must provide between 1 and 10 metadata tags(), 
    ...
    def testInviteTeamMemberBody(self):
        """Test InviteTeamMemberBody"""
