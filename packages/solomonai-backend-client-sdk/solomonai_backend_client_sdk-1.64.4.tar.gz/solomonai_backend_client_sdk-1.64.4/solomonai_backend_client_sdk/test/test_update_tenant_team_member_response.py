...
class TestUpdateTenantTeamMemberResponse(unittest.TestCase):
    """UpdateTenantTeamMemberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateTenantTeamMemberResponse:
        """Test UpdateTenantTeamMemberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateTenantTeamMemberResponse`
        """
        model = UpdateTenantTeamMemberResponse()
        if include_optional:
            return UpdateTenantTeamMemberResponse(
                member = solomonai_backend_client_sdk.models.team_member.TeamMember(
                    id = '', 
...
- must provide between 1 and 10 metadata tags(), 
    ...
    def testUpdateTenantTeamMemberResponse(self):
        """Test UpdateTenantTeamMemberResponse"""
