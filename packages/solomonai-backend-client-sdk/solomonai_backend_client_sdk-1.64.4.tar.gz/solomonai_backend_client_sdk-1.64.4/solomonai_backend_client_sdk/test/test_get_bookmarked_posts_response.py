...
class TestGetBookmarkedPostsResponse(unittest.TestCase):
    """GetBookmarkedPostsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBookmarkedPostsResponse:
        """Test GetBookmarkedPostsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBookmarkedPostsResponse`
        """
        model = GetBookmarkedPostsResponse()
        if include_optional:
            return GetBookmarkedPostsResponse(
                posts = [
...
intimate feedback protocol(
    ...
    def testGetBookmarkedPostsResponse(self):
        """Test GetBookmarkedPostsResponse"""
