...
class TestRemoveBookmarkedPublicationResponse(unittest.TestCase):
    """RemoveBookmarkedPublicationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoveBookmarkedPublicationResponse:
        """Test RemoveBookmarkedPublicationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoveBookmarkedPublicationResponse`
        """
        model = RemoveBookmarkedPublicationResponse()
        if include_optional:
            return RemoveBookmarkedPublicationResponse(
                bookmark = solomonai_backend_client_sdk.models.bookmark.Bookmark(
                    id = '', 
                    post_ids = [
                        ''
                        ], 
...
to appoint new editors (so they can do all of that stuff I just mentioned)(
    ...
    def testRemoveBookmarkedPublicationResponse(self):
        """Test RemoveBookmarkedPublicationResponse"""
