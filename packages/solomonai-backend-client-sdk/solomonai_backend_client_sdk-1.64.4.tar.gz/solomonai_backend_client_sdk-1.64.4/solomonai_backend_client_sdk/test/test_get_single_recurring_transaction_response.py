...
class TestGetSingleRecurringTransactionResponse(unittest.TestCase):
    """GetSingleRecurringTransactionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSingleRecurringTransactionResponse:
        """Test GetSingleRecurringTransactionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSingleRecurringTransactionResponse`
        """
        model = GetSingleRecurringTransactionResponse()
        if include_optional:
            return GetSingleRecurringTransactionResponse(
    ...
    def testGetSingleRecurringTransactionResponse(self):
        """Test GetSingleRecurringTransactionResponse"""
