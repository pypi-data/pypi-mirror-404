...
class TestUpdatePocketRequest(unittest.TestCase):
    """UpdatePocketRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePocketRequest:
        """Test UpdatePocketRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePocketRequest`
        """
        model = UpdatePocketRequest()
        if include_optional:
            return UpdatePocketRequest(
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testUpdatePocketRequest(self):
        """Test UpdatePocketRequest"""
