...
class TestCreateCreditAccountRequest(unittest.TestCase):
    """CreateCreditAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCreditAccountRequest:
        """Test CreateCreditAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCreditAccountRequest`
        """
        model = CreateCreditAccountRequest()
        if include_optional:
            return CreateCreditAccountRequest(
                user_id = '',
...
and achievable. A milestone is a sub goal of a goal and is tied to a goal by the goal id(
    ...
    def testCreateCreditAccountRequest(self):
        """Test CreateCreditAccountRequest"""
