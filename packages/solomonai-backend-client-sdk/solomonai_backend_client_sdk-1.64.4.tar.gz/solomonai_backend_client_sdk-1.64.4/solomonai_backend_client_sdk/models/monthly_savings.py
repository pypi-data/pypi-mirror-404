...
class MonthlySavings(BaseModel):
    ...
    net_savings: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="netSavings")
    ...
    __properties: ClassVar[List[str]] = ["month", "netSavings", "userId", "profileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MonthlySavings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MonthlySavings from a dict"""
        if obj is None:
            return None
