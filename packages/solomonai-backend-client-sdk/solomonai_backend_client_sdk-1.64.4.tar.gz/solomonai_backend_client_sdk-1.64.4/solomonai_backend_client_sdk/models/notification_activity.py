...
class NotificationActivity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["actorName", "foreignId", "activityId", "verb", "time", "target", "origin", "object"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NotificationActivity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NotificationActivity from a dict"""
        if obj is None:
            return None
