...
class LocationFinancialSubProfile(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["locationCity", "transactionCount", "spentLastWeek", "spentLastTwoWeeks", "spentLastMonth", "spentLastSixMonths", "spentLastYear", "spentLastTwoYears", "userId", "month", "profileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LocationFinancialSubProfile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LocationFinancialSubProfile from a dict"""
        if obj is None:
            return None
