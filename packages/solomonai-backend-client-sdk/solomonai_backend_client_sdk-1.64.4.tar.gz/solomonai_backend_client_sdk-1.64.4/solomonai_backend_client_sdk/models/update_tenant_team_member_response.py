...
class UpdateTenantTeamMemberResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateTenantTeamMemberResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateTenantTeamMemberResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "member": TeamMember.from_dict(obj["member"]) if obj.get("member") is not None else None
        })
        return _obj
