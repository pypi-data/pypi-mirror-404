...
class TriggerSyncRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["userId", "profileType", "linkId", "financialAccountType", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TriggerSyncRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TriggerSyncRequest from a dict"""
        if obj is None:
            return None
