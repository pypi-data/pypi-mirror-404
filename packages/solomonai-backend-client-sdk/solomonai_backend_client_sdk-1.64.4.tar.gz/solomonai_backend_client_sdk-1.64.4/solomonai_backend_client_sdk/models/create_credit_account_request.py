...
class CreateCreditAccountRequest(BaseModel):
    ...
    credit_account: CreditAccount = Field(alias="creditAccount")
    ...
    __properties: ClassVar[List[str]] = ["userId", "creditAccount", "profileType", "linkId", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCreditAccountRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCreditAccountRequest from a dict"""
        if obj is None:
            return None
