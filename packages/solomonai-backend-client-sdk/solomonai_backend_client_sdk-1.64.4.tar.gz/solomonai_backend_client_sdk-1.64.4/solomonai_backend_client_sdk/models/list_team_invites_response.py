...
class ListTeamInvitesResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["teamInvites", "nextPage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTeamInvitesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTeamInvitesResponse from a dict"""
        if obj is None:
            return None
