...
class BulkUpdateTransactionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["transactions", "userId", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BulkUpdateTransactionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BulkUpdateTransactionRequest from a dict"""
        if obj is None:
            return None
