...
class AddNoteToTransactionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["transactionId", "userId", "profileType", "note", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddNoteToTransactionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddNoteToTransactionRequest from a dict"""
        if obj is None:
            return None
