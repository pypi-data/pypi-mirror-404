...
class AddTransactionsToManuallyLinkedAccountRequest(BaseModel):
    """
    Add transactions to an account.
    """ # noqa: E501
    account_id: StrictStr = Field(alias="accountId")
    transactions: List[PlaidAccountTransaction]
    profile_type: FinancialUserProfileType = Field(alias="profileType")
    financial_account_type: Optional[FinancialAccountType] = Field(default=FinancialAccountType.UNSPECIFIED, alias="financialAccountType")
    user_id: StrictStr = Field(alias="userId")
    link_id: StrictStr = Field(alias="linkId")
    ...
    __properties: ClassVar[List[str]] = ["accountId", "transactions", "profileType", "financialAccountType", "userId", "linkId", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddTransactionsToManuallyLinkedAccountRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddTransactionsToManuallyLinkedAccountRequest from a dict"""
        if obj is None:
            return None
