...
class ShareWorkspaceBody(BaseModel):
    ...
    shared_with_user_id: StrictStr = Field(alias="sharedWithUserId")
    permission_level: SharePermission = Field(alias="permissionLevel")
    expires_at: Optional[datetime] = Field(default=None, alias="expiresAt")
    org_id: StrictStr = Field(alias="orgId")
    tenant_id: StrictStr = Field(alias="tenantId")
    __properties: ClassVar[List[str]] = ["userId", "sharedWithUserId", "permissionLevel", "expiresAt", "orgId", "tenantId"]
