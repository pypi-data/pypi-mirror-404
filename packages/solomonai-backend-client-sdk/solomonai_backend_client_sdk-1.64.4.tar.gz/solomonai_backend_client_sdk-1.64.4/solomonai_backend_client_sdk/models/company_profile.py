...
class CompanyProfile(BaseModel):
    ...
    ein_numbers: Optional[List[StrictStr]] = Field(default=None, description="The company's tax number.", alias="einNumbers")
    ...
    __properties: ClassVar[List[str]] = ["id", "remoteId", "legalName", "displayName", "einNumbers", "remoteWasDeleted", "modifiedAt", "lastUpdatedAt", "mergeAccountId", "createdAt", "deletedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompanyProfile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompanyProfile from a dict"""
        if obj is None:
            return None
