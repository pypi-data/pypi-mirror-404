...
class CategoryMonthlyIncome(BaseModel):
    """
    CategoryMonthlyIncome This message is used to represent the monthly income of a category.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["month", "personalFinanceCategoryPrimary", "totalIncome", "userId", "profileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CategoryMonthlyIncome from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CategoryMonthlyIncome from a dict"""
        if obj is None:
            return None
