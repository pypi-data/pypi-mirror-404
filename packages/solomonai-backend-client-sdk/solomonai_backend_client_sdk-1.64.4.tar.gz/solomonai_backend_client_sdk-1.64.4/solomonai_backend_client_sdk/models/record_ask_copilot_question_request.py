...
class RecordAskCopilotQuestionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["userId", "profileType", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecordAskCopilotQuestionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecordAskCopilotQuestionRequest from a dict"""
        if obj is None:
            return None
