...
class IncomeMetrics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["month", "personalFinanceCategoryPrimary", "transactionCount", "totalIncome", "userId", "profileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IncomeMetrics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IncomeMetrics from a dict"""
        if obj is None:
            return None
