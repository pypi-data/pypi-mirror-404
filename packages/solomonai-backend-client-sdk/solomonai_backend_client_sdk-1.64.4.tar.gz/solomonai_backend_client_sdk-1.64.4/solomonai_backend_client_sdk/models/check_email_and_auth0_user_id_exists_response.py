...
class CheckEmailAndAuth0UserIdExistsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["userAccount", "businessAccount", "exists"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CheckEmailAndAuth0UserIdExistsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CheckEmailAndAuth0UserIdExistsResponse from a dict"""
        if obj is None:
            return None
