...
class InviteTeamMemberResponse(BaseModel):
    ...
    """ # noqa: E501
    invite: Optional[TeamInvites] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InviteTeamMemberResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InviteTeamMemberResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "invite": TeamInvites.from_dict(obj["invite"]) if obj.get("invite") is not None else None
        })
        return _obj
