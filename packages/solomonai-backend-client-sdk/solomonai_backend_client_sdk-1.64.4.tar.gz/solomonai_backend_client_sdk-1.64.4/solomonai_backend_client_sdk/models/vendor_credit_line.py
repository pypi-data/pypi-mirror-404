...
class VendorCreditLine(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["remoteId", "netAmount", "trackingCategory", "trackingCategories", "description", "account", "company", "exchangeRate", "modifiedAt", "id", "createdAt", "deletedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VendorCreditLine from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VendorCreditLine from a dict"""
        if obj is None:
            return None
