...
class UserAccount(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Email associated with the user account.")
    username: Optional[StrictStr] = Field(default=None, description="Username associated with the account, minimum of 10 characters.")
    firstname: Optional[StrictStr] = Field(default=None, description="User's first name.")
    lastname: Optional[StrictStr] = Field(default=None, description="User's last name.")
    bio: Optional[StrictStr] = Field(default=None, description="Brief description about the user, up to 200 characters.")
    headline: Optional[StrictStr] = Field(default=None, description="Short headline for the user's profile.")
    profile_image_url: Optional[StrictStr] = Field(default=None, description="Profile image associated with the user account.", alias="profileImageUrl")
    phone_number: Optional[StrictStr] = Field(default=None, description="Phone number associated with the account.", alias="phoneNumber")
    address: Optional[Address] = None
    is_active: Optional[StrictBool] = Field(default=None, description="Indicates if the account is currently active.", alias="isActive")
    is_private: Optional[StrictBool] = Field(default=None, description="Indicates if the account is set to private.", alias="isPrivate")
    is_email_verified: Optional[StrictBool] = Field(default=None, description="Indicates if the user's email has been verified.", alias="isEmailVerified")
    ...
    authn_account_id: Optional[StrictStr] = Field(default=None, description="ID for the authentication service linked to this account.", alias="authnAccountId")
    supabase_auth0_user_id: Optional[StrictStr] = Field(default=None, description="Auth0 user ID associated with the account.", alias="supabaseAuth0UserId")
    algolia_user_id: Optional[StrictStr] = Field(default=None, description="Algolia user ID.", alias="algoliaUserId")
    created_at: Optional[datetime] = Field(default=None, description="Timestamp for when the account was created.", alias="createdAt")
    verified_at: Optional[datetime] = Field(default=None, description="Timestamp for when the email was verified.", alias="verifiedAt")
    ...
    tags: Optional[List[Tags]] = Field(default=None, description="Tags associated with the user account, between 1 and 10.")
    settings: Optional[Settings] = None
    account_type: Optional[ProfileType] = Field(default=ProfileType.UNSPECIFIED, alias="accountType")
    addresses: Optional[List[Address]] = Field(default=None, description="Additional addresses associated with the user account.")
    audit_logs: Optional[List[AuditLog]] = Field(default=None, description="Audit logs associated with the user account.", alias="auditLogs")
    org_api_keys: Optional[List[OrgAPIKey]] = Field(default=None, description="Org API keys associated with the user account.", alias="orgApiKeys")
    deleted_at: Optional[datetime] = Field(default=None, alias="deletedAt")
    __properties: ClassVar[List[str]] = ["id", "email", "username", "firstname", "lastname", "bio", "headline", "profileImageUrl", "phoneNumber", "address", "isActive", "isPrivate", "isEmailVerified", "status", "metadata", "authnAccountId", "supabaseAuth0UserId", "algoliaUserId", "createdAt", "verifiedAt", "lastAccess", "baseDirectory", "bucketLocation", "bucketName", "region", "storageQuota", "usedStorage", "organization", "tenant", "tags", "settings", "accountType", "addresses", "auditLogs", "orgApiKeys", "deletedAt"]
...
UserAccount.model_rebuild(raise_errors=False)
