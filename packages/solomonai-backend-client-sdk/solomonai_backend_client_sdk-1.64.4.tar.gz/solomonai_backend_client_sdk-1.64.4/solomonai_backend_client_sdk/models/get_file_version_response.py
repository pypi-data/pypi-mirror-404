...
class GetFileVersionResponse(BaseModel):
    """
    GetFileVersionResponse
    """ # noqa: E501
    version: Optional[FileVersions] = None
    content: Optional[StrictStr] = None
    snapshot: Optional[DocumentSnapshot] = None
    __properties: ClassVar[List[str]] = ["version", "content", "snapshot"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetFileVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetFileVersionResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "version": FileVersions.from_dict(obj["version"]) if obj.get("version") is not None else None,
