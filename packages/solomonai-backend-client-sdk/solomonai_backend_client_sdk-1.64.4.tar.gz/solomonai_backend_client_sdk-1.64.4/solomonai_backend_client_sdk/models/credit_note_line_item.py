...
class CreditNoteLineItem(BaseModel):
    ...
    tax_rate: Optional[StrictStr] = Field(default=None, alias="taxRate")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "quantity", "unitPrice", "taxRate", "totalLineAmount", "trackingCategory", "trackingCategories", "account", "company", "remoteId", "item", "remoteWasDeleted", "memo", "createdAt", "deletedAt"]
