...
class PlaidExchangeTokenRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["userId", "publicToken", "institutionId", "institutionName", "profileType", "orgId", "tenantId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaidExchangeTokenRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaidExchangeTokenRequest from a dict"""
        if obj is None:
            return None
