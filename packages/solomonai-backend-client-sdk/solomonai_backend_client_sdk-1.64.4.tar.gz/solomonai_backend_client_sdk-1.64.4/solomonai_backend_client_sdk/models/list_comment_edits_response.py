...
class ListCommentEditsResponse(BaseModel):
    """
    ListCommentEditsResponse
    """ # noqa: E501
    edits: Optional[List[CommentEdit]] = None
    total_edits: Optional[StrictInt] = Field(default=None, alias="totalEdits")
    __properties: ClassVar[List[str]] = ["edits", "totalEdits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCommentEditsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCommentEditsResponse from a dict"""
        if obj is None:
            return None
