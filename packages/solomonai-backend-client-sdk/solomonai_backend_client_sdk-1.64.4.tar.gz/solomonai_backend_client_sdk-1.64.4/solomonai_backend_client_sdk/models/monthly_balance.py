...
class MonthlyBalance(BaseModel):
    ...
    net_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="netBalance")
    ...
    __properties: ClassVar[List[str]] = ["month", "netBalance", "userId", "profileType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MonthlyBalance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MonthlyBalance from a dict"""
        if obj is None:
            return None
