...
class PlaidLink(BaseModel):
    ...
    use_plaid_sync: Optional[StrictBool] = Field(default=None, alias="usePlaidSync")
    item_id: Optional[StrictStr] = Field(default=None, alias="itemId")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    deleted_at: Optional[datetime] = Field(default=None, alias="deletedAt")
    __properties: ClassVar[List[str]] = ["id", "products", "webhookUrl", "institutionId", "institutionName", "usePlaidSync", "itemId", "createdAt", "deletedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaidLink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaidLink from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "usePlaidSync": obj.get("usePlaidSync"),
