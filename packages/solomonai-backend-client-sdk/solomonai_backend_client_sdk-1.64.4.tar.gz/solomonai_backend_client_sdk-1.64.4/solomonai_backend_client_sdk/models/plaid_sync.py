...
class PlaidSync(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "timeStamp", "trigger", "nextCursor", "added", "removed", "modified", "createdAt", "deletedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlaidSync from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlaidSync from a dict"""
        if obj is None:
            return None
