...
class AsyncPxshot:
    """Asynchronous client for the Pxshot screenshot API.
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize the async Pxshot client.
    ...
    async def __aenter__(self) -> "AsyncPxshot":
    ...
    async def screenshot(
        ...
        *,
        ...
        if store:
            data = await self._request("POST", "/v1/screenshot", json=api_payload)
