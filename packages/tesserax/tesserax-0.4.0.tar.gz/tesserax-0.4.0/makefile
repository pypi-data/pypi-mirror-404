...
release:
	...
	@echo Replace version in src/tesserax/__init__.py
	@sed -i.bak "s/__version__ = \"$(CURRENT_VERSION)\"/__version__ = \"$(NEW_VERSION)\"/" src/tesserax/__init__.py
