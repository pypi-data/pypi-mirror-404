...
from utilities.click import ListStrs, Path, SecretStr, TimeDelta
...
sleep_option = option(
    "--sleep", type=TimeDelta(), default=None, help="Sleep after a successful run"
)
tag_option = option(
    "--tag",
    type=ListStrs(),
