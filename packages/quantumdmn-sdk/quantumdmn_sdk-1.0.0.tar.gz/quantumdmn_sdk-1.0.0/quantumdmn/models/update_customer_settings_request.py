...
class UpdateCustomerSettingsRequest(BaseModel):
    """
    UpdateCustomerSettingsRequest
    """ # noqa: E501
    allow_overage: Optional[StrictBool] = Field(default=None, alias="allowOverage")
    __properties: ClassVar[List[str]] = ["allowOverage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allowOverage": obj.get("allowOverage")
        })
        return _obj
