...
class BatchEvaluateDesignRequest(BaseModel):
    ...
    """ # noqa: E501
    xml: Optional[StrictStr] = Field(default=None, description="The DMN XML definition to evaluate")
    inputs: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of input contexts (rows) to evaluate")
