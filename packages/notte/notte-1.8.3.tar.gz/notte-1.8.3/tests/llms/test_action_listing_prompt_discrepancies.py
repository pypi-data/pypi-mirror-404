...
def prompt_contents() -> dict[str, str]:
    ...
    optim_path: Path = project_root / "packages/notte-llm/src/notte_llm/prompts/action-listing/optim/user.md"
    incr_path: Path = project_root / "packages/notte-llm/src/notte_llm/prompts/action-listing-incr/user.md"
