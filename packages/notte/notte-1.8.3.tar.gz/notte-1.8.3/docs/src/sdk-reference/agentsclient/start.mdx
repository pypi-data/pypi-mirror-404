---
title: "start"
description: "Start an agent with the specified request parameters"
---
...
[`AgentResponse`](/sdk-reference/misc/agentresponse): The response obtained from the agent run request.
