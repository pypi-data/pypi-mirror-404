...
class IssueOriginDto(BaseModel):
    """
    IssueOriginDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["originType", "originId", "originName", "isDeleted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueOriginDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueOriginDto from a dict"""
        if obj is None:
            return None
