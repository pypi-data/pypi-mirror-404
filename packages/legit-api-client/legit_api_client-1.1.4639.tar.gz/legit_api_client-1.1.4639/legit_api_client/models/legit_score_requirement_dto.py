...
class LegitScoreRequirementDto(BaseModel):
    """
    LegitScoreRequirementDto
    """ # noqa: E501
    type: Optional[LegitScoreRequirementType] = None
    ...
    __properties: ClassVar[List[str]] = ["type", "maxPoints", "title", "description", "gainedPoints"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LegitScoreRequirementDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LegitScoreRequirementDto from a dict"""
        if obj is None:
            return None
