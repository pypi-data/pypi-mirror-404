...
class IssueTagDto(BaseModel):
    """
    IssueTagDto
    """ # noqa: E501
    tag_id: Optional[StrictStr] = Field(default=None, alias="tagId")
    tag_name: Optional[StrictStr] = Field(default=None, alias="tagName")
    time_added: Optional[datetime] = Field(default=None, alias="timeAdded")
    __properties: ClassVar[List[str]] = ["tagId", "tagName", "timeAdded"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IssueTagDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IssueTagDto from a dict"""
        if obj is None:
            return None
