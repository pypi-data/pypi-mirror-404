...
class RepositoryGroupDto(BaseModel):
    """
    RepositoryGroupDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "integrationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepositoryGroupDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepositoryGroupDto from a dict"""
        if obj is None:
            return None
