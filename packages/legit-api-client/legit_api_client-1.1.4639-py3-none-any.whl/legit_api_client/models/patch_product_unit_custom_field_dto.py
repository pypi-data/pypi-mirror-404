...
class PatchProductUnitCustomFieldDto(BaseModel):
    """
    PatchProductUnitCustomFieldDto
    """ # noqa: E501
    id: Optional[StrictStr] = None
    text_value: Optional[StrictStr] = Field(default=None, alias="textValue")
    number_value: Optional[StrictInt] = Field(default=None, alias="numberValue")
    ...
    __properties: ClassVar[List[str]] = ["id", "textValue", "numberValue", "booleanValue", "dateValue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchProductUnitCustomFieldDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchProductUnitCustomFieldDto from a dict"""
        if obj is None:
            return None
