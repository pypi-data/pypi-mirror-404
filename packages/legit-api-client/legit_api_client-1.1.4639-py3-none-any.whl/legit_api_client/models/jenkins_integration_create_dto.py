...
class JenkinsIntegrationCreateDto(BaseModel):
    """
    ...
    integration_type: Optional[IntegrationType] = Field(default=None, alias="integrationType")
    ...
    __properties: ClassVar[List[str]] = ["name", "url", "username", "token", "brokerId", "integrationType", "workspaceId", "ignoreWarnings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JenkinsIntegrationCreateDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JenkinsIntegrationCreateDto from a dict"""
        if obj is None:
            return None
