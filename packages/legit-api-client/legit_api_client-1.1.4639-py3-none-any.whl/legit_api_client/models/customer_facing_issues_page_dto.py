...
class CustomerFacingIssuesPageDto(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomerFacingIssuesPageDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomerFacingIssuesPageDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [BasicIssue.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
