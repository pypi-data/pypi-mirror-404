...
class CustomerFacingIssueToCommentsDto(BaseModel):
    """
    CustomerFacingIssueToCommentsDto
    """ # noqa: E501
    issue_id: Optional[StrictStr] = Field(default=None, description="The id of the issue the comments belongs to", alias="issueId")
    comments: Optional[List[IssueCommentDto]] = Field(default=None, description="The issues comments. could be an empty list")
    __properties: ClassVar[List[str]] = ["issueId", "comments"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomerFacingIssueToCommentsDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomerFacingIssueToCommentsDto from a dict"""
        if obj is None:
            return None
