...
class IntegrationBadResponseDto(BaseModel):
    """
    IntegrationBadResponseDto
    """ # noqa: E501
    failing_reason: Optional[IntegrationFailingReason] = Field(default=None, alias="failingReason")
    ...
    __properties: ClassVar[List[str]] = ["failingReason", "integrationStatus", "integrationErrorMessage", "integrationError"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntegrationBadResponseDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntegrationBadResponseDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "failingReason": obj.get("failingReason"),
