...
class CollaboratorRepositoryPermission(BaseModel):
    """
    ...
    permission: Optional[PermissionMetaType] = None
    __properties: ClassVar[List[str]] = ["repositoryId", "repositoryName", "permission"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollaboratorRepositoryPermission from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.repository_name is None and "repository_name" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollaboratorRepositoryPermission from a dict"""
        if obj is None:
            return None
