...
.. _playbook_all_parms_schema_file_json_playbook:

Playbook playbook_all_parms_schema_file_json -- Test playbook with all input/output parameters with JSON schema files in JSON
=============================================================================================================================

Synopsis
--------

Test playbook with all input/output parameters with JSON schema files in JSON
