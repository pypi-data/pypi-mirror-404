...
from tensorflow_probability.substrates.jax.distributions import linear_gaussian_ssm
...
#   `tensorflow_probability/substrates/jax/sts/components/semilocal_linear_trend.py`
