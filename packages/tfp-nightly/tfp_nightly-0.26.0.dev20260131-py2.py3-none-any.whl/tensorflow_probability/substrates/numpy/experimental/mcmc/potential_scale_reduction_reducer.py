...
from tensorflow_probability.substrates.numpy.experimental.mcmc import reducer as reducer_base
...
#   `tensorflow_probability/substrates/numpy/experimental/mcmc/potential_scale_reduction_reducer.py`
