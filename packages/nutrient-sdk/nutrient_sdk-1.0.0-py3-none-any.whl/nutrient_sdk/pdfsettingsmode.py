...
class PdfSettingsMode(Enum):
    ...
    # Preserve annotations when saving PDF documents.
    
    
    @classmethod
    def from_value(cls, value: int) -> 'PdfSettingsMode':
        """
        ...
        Returns:
            The corresponding PdfSettingsMode instance
