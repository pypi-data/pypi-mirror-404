...
class PdfLineAnnotationError(Exception):
    """Exception raised by PdfLineAnnotation operations."""
    pass
...
_lib.BridgePdfLineAnnotationGetLastErrorCode.restype = ctypes.c_int
_lib.BridgePdfLineAnnotationGetLastErrorCode.argtypes = []

_lib.BridgePdfLineAnnotationGetLastErrorMessage.restype = ctypes.c_void_p
_lib.BridgePdfLineAnnotationGetLastErrorMessage.argtypes = []

_lib.BridgePdfLineAnnotationFreeErrorString.restype = None
_lib.BridgePdfLineAnnotationFreeErrorString.argtypes = [ctypes.c_void_p]

_lib.BridgePdfLineAnnotationGetStartPoint.restype = ctypes.c_void_p
_lib.BridgePdfLineAnnotationGetStartPoint.argtypes = [ctypes.c_void_p]

_lib.BridgePdfLineAnnotationSetStartPointNullablevec2f.restype = None
_lib.BridgePdfLineAnnotationSetStartPointNullablevec2f.argtypes = [ctypes.c_void_p, ctypes.c_float, ctypes.c_float, ctypes.c_bool]

_lib.BridgePdfLineAnnotationGetEndPoint.restype = ctypes.c_void_p
_lib.BridgePdfLineAnnotationGetEndPoint.argtypes = [ctypes.c_void_p]

_lib.BridgePdfLineAnnotationSetEndPointNullablevec2f.restype = None
_lib.BridgePdfLineAnnotationSetEndPointNullablevec2f.argtypes = [ctypes.c_void_p, ctypes.c_float, ctypes.c_float, ctypes.c_bool]

_lib.BridgePdfLineAnnotationGetStartCap.restype = ctypes.c_int32
_lib.BridgePdfLineAnnotationGetStartCap.argtypes = [ctypes.c_void_p]

_lib.BridgePdfLineAnnotationSetStartCapPdfLineEndingStyle.restype = None
_lib.BridgePdfLineAnnotationSetStartCapPdfLineEndingStyle.argtypes = [ctypes.c_void_p, ctypes.c_int32]

_lib.BridgePdfLineAnnotationGetEndCap.restype = ctypes.c_int32
_lib.BridgePdfLineAnnotationGetEndCap.argtypes = [ctypes.c_void_p]

_lib.BridgePdfLineAnnotationSetEndCapPdfLineEndingStyle.restype = None
_lib.BridgePdfLineAnnotationSetEndCapPdfLineEndingStyle.argtypes = [ctypes.c_void_p, ctypes.c_int32]
...
class PdfLineAnnotation:
    ...
    def __init__(self):
        """Cannot instantiate PdfLineAnnotation directly. Use static factory methods instead."""
        raise TypeError("PdfLineAnnotation cannot be instantiated directly. Use static factory methods to obtain instances.")

    def _check_error(self):
        error_code = _lib.BridgePdfLineAnnotationGetLastErrorCode()
        if error_code != 0:
            message_ptr = _lib.BridgePdfLineAnnotationGetLastErrorMessage()
            if message_ptr:
                message = ctypes.string_at(message_ptr).decode('utf-8')
                _lib.BridgePdfLineAnnotationFreeErrorString(message_ptr)
            else:
                message = "Unknown error"
            raise PdfLineAnnotationError(f"PdfLineAnnotation: {message} (code: {error_code})")
    
    def _ensure_not_closed(self):
        if self._closed:
            raise ValueError("PdfLineAnnotation instance has been closed")
    ...
    def _get_sub_type_from_handle(handle):
        ...
        """
        result = _lib.BridgePdfLineAnnotationGetSubType(handle)
        error_code = _lib.BridgePdfLineAnnotationGetLastErrorCode()
        if error_code != 0:
            return None
        return sdk_loader.convert_string_handle(result)

    def get_start_point(self) -> Optional[Any]:
        """
        Gets the start point of the line.

        Returns:
            Optional[Any]: The value of the StartPoint property.

        Raises:
            PdfLineAnnotationError: If the operation fails
        """
        self._ensure_not_closed()

        result = _lib.BridgePdfLineAnnotationGetStartPoint(self._handle)
        self._check_error()
        return result

    def set_start_point(self, value: Optional[Any]) -> None:
        """
        ...
        _lib.BridgePdfLineAnnotationSetStartPointNullablevec2f(self._handle, value.x if value is not None else 0.0, value.y if value is not None else 0.0, value is not None)
        self._check_error()

    def get_end_point(self) -> Optional[Any]:
        """
        Gets the end point of the line.

        Returns:
            Optional[Any]: The value of the EndPoint property.
        ...
        result = _lib.BridgePdfLineAnnotationGetEndPoint(self._handle)
        self._check_error()
        return result

    def set_end_point(self, value: Optional[Any]) -> None:
        """
        ...
        _lib.BridgePdfLineAnnotationSetEndPointNullablevec2f(self._handle, value.x if value is not None else 0.0, value.y if value is not None else 0.0, value is not None)
        self._check_error()

    def get_start_cap(self) -> Any:
        """
        Gets the line ending style at the start of the line.

        Returns:
            Any: The value of the StartCap property.
        ...
        result = _lib.BridgePdfLineAnnotationGetStartCap(self._handle)
        self._check_error()
        return result

    def set_start_cap(self, value: Any) -> None:
        """
        ...
        _lib.BridgePdfLineAnnotationSetStartCapPdfLineEndingStyle(self._handle, value.value if isinstance(value, Enum) else value)
        self._check_error()

    def get_end_cap(self) -> Any:
        """
        Gets the line ending style at the end of the line.

        Returns:
            Any: The value of the EndCap property.
        ...
        result = _lib.BridgePdfLineAnnotationGetEndCap(self._handle)
        self._check_error()
        return result

    def set_end_cap(self, value: Any) -> None:
        """
        ...
        _lib.BridgePdfLineAnnotationSetEndCapPdfLineEndingStyle(self._handle, value.value if isinstance(value, Enum) else value)
        self._check_error()
    ...
    @property
    def start_point(self) -> Optional[Any]:
        """
        Gets the start point of the line.
    ...
    @start_point.setter
    def start_point(self, value: Optional[Any]) -> None:
        """
        ...
        """
        self.set_start_point(value)

    @property
    def end_point(self) -> Optional[Any]:
        """
        Gets the end point of the line.
    ...
    @end_point.setter
    def end_point(self, value: Optional[Any]) -> None:
        """
        Sets the end point.
    ...
    def start_cap(self) -> Any:
        ...
        Returns:
            Any: The value of the StartCap property.
        """
        return self.get_start_cap()

    @start_cap.setter
    def start_cap(self, value: Any) -> None:
        """
        Sets the start cap.
    ...
    def end_cap(self) -> Any:
        ...
        Returns:
            Any: The value of the EndCap property.
        """
        return self.get_end_cap()

    @end_cap.setter
    def end_cap(self, value: Any) -> None:
        """
        Sets the end cap.
