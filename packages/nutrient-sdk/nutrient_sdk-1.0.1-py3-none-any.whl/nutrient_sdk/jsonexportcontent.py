...
class JsonExportContent(Enum):
    """Specifies which content elements to include in JSON export.."""
    
    UNSPECIFIED = 0
    # No specific content options.
    
    INCLUDE_WORDS = 1
    # Include word-level details with coordinates in the export.
    
    
    @classmethod
    def from_value(cls, value: int) -> 'JsonExportContent':
        """
        ...
        Returns:
            The corresponding JsonExportContent instance
