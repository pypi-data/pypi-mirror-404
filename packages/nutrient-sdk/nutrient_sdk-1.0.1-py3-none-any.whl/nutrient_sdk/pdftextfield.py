...
class PdfTextFieldError(Exception):
    """Exception raised by PdfTextField operations."""
    pass
...
_lib.BridgePdfTextFieldGetLastErrorCode.restype = ctypes.c_int
_lib.BridgePdfTextFieldGetLastErrorCode.argtypes = []

_lib.BridgePdfTextFieldGetLastErrorMessage.restype = ctypes.c_void_p
_lib.BridgePdfTextFieldGetLastErrorMessage.argtypes = []

_lib.BridgePdfTextFieldFreeErrorString.restype = None
_lib.BridgePdfTextFieldFreeErrorString.argtypes = [ctypes.c_void_p]

_lib.BridgePdfTextFieldGetText.restype = ctypes.c_void_p
_lib.BridgePdfTextFieldGetText.argtypes = [ctypes.c_void_p]

_lib.BridgePdfTextFieldSetTextString.restype = None
_lib.BridgePdfTextFieldSetTextString.argtypes = [ctypes.c_void_p, ctypes.c_void_p]

_lib.BridgePdfTextFieldGetFontName.restype = ctypes.c_void_p
_lib.BridgePdfTextFieldGetFontName.argtypes = [ctypes.c_void_p]

_lib.BridgePdfTextFieldSetFontNameString.restype = None
_lib.BridgePdfTextFieldSetFontNameString.argtypes = [ctypes.c_void_p, ctypes.c_void_p]

_lib.BridgePdfTextFieldGetFontSize.restype = ctypes.c_float
_lib.BridgePdfTextFieldGetFontSize.argtypes = [ctypes.c_void_p]

_lib.BridgePdfTextFieldSetFontSizeSingle.restype = None
_lib.BridgePdfTextFieldSetFontSizeSingle.argtypes = [ctypes.c_void_p, ctypes.c_float]

_lib.BridgePdfTextFieldGetFontColor.restype = ctypes.c_void_p
_lib.BridgePdfTextFieldGetFontColor.argtypes = [ctypes.c_void_p]

_lib.BridgePdfTextFieldSetFontColorColor.restype = None
_lib.BridgePdfTextFieldSetFontColorColor.argtypes = [ctypes.c_void_p, ctypes.c_void_p]

_lib.BridgePdfTextFieldGetBackgroundColor.restype = ctypes.c_void_p
_lib.BridgePdfTextFieldGetBackgroundColor.argtypes = [ctypes.c_void_p]

_lib.BridgePdfTextFieldSetBackgroundColorColor.restype = None
_lib.BridgePdfTextFieldSetBackgroundColorColor.argtypes = [ctypes.c_void_p, ctypes.c_void_p]

_lib.BridgePdfTextFieldGetBorderColor.restype = ctypes.c_void_p
_lib.BridgePdfTextFieldGetBorderColor.argtypes = [ctypes.c_void_p]

_lib.BridgePdfTextFieldSetBorderColorColor.restype = None
_lib.BridgePdfTextFieldSetBorderColorColor.argtypes = [ctypes.c_void_p, ctypes.c_void_p]
...
class PdfTextField:
    ...
    def __init__(self):
        """Cannot instantiate PdfTextField directly. Use static factory methods instead."""
        raise TypeError("PdfTextField cannot be instantiated directly. Use static factory methods to obtain instances.")

    def _check_error(self):
        error_code = _lib.BridgePdfTextFieldGetLastErrorCode()
        if error_code != 0:
            message_ptr = _lib.BridgePdfTextFieldGetLastErrorMessage()
            if message_ptr:
                message = ctypes.string_at(message_ptr).decode('utf-8')
                _lib.BridgePdfTextFieldFreeErrorString(message_ptr)
            else:
                message = "Unknown error"
            raise PdfTextFieldError(f"PdfTextField: {message} (code: {error_code})")
    
    def _ensure_not_closed(self):
        if self._closed:
            raise ValueError("PdfTextField instance has been closed")
    ...
    def _get_field_type_from_handle(handle):
        ...
        """
        result = _lib.BridgePdfTextFieldGetFieldType(handle)
        error_code = _lib.BridgePdfTextFieldGetLastErrorCode()
        if error_code != 0:
            return None
    ...
    def get_text(self) -> str:
        ...
        Raises:
            PdfTextFieldError: If the operation fails
        """
        self._ensure_not_closed()

        result = _lib.BridgePdfTextFieldGetText(self._handle)
        self._check_error()
    ...
    def set_text(self, value: str) -> None:
        ...
        _lib.BridgePdfTextFieldSetTextString(self._handle, value.encode('utf-8') if value else None)
        self._check_error()
    ...
    def get_font_name(self) -> str:
        ...
        result = _lib.BridgePdfTextFieldGetFontName(self._handle)
        self._check_error()
        return sdk_loader.convert_string_handle(result)
    ...
    def set_font_name(self, value: str) -> None:
        ...
        _lib.BridgePdfTextFieldSetFontNameString(self._handle, value.encode('utf-8') if value else None)
        self._check_error()
    ...
    def get_font_size(self) -> float:
        ...
        result = _lib.BridgePdfTextFieldGetFontSize(self._handle)
        self._check_error()
        return result
    ...
    def set_font_size(self, value: float) -> None:
        ...
        _lib.BridgePdfTextFieldSetFontSizeSingle(self._handle, value)
        self._check_error()
    ...
    def get_font_color(self) -> 'Color':
        ...
        result = _lib.BridgePdfTextFieldGetFontColor(self._handle)
        self._check_error()
    ...
    def set_font_color(self, value: 'Color') -> None:
        ...
        _lib.BridgePdfTextFieldSetFontColorColor(self._handle, value._handle if value else None)
        self._check_error()
    ...
    def get_background_color(self) -> 'Color':
        ...
        result = _lib.BridgePdfTextFieldGetBackgroundColor(self._handle)
        self._check_error()
        return import_module('.color', package=__package__).Color._from_handle(result)
    ...
    def set_background_color(self, value: 'Color') -> None:
        ...
        _lib.BridgePdfTextFieldSetBackgroundColorColor(self._handle, value._handle if value else None)
        self._check_error()
    ...
    def get_border_color(self) -> 'Color':
        ...
        result = _lib.BridgePdfTextFieldGetBorderColor(self._handle)
        self._check_error()
        return import_module('.color', package=__package__).Color._from_handle(result)
    ...
    def set_border_color(self, value: 'Color') -> None:
        ...
        _lib.BridgePdfTextFieldSetBorderColorColor(self._handle, value._handle if value else None)
        self._check_error()
