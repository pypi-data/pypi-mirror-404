...
TOPSIS-Dhruv-102303877 is a Python package that implements the **TOPSIS (Technique for Order of Preference by Similarity to Ideal Solution)** method for multi-criteria decision-making (MCDM).
...
pip install TOPSIS-Dhruv-102303877
