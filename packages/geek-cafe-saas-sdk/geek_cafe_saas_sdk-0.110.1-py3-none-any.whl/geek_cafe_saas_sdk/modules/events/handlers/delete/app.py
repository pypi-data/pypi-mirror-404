...
def lambda_handler(event: Dict[str, Any], context: Any, injected_service=None) -> Dict[str, Any]:
    return handler_wrapper.execute(event, context, delete_event_logic, injected_service)

def delete_event_logic(event: LambdaEvent, service: EventService) -> ServiceResult:
