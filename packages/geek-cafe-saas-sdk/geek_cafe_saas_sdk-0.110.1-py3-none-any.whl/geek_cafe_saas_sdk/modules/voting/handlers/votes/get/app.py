...
def lambda_handler(event: Dict[str, Any], context: Any, injected_service=None) -> Dict[str, Any]:
    ...
    """
    return handler_wrapper.execute(event, context, get_vote, injected_service)


def get_vote(event: LambdaEvent, service: VoteService) -> ServiceResult:
    """
    Business logic for getting a vote by ID.
    ...
    return service.get_by_id(vote_id=vote_id)
