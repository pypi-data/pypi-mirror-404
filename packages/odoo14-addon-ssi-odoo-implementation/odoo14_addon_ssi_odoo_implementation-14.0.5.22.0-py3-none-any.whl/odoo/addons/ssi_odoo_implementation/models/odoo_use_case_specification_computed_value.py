...
class OdooUseCaseSpecificationComputedValue(models.Model):
    _name = "odoo_use_case_specification.computed_value"
    _description = "Odoo Use Case Specification Computed Value"
