...
class OdooUseCaseSpecificationButton(models.Model):
    _name = "odoo_use_case_specification.button"
    _description = "Odoo Use Case Specification Button"
    ...
    system_response = fields.Text(string="System Response", required=True)
