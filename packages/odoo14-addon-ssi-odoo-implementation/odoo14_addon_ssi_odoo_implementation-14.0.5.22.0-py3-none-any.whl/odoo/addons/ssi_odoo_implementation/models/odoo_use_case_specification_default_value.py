...
class OdooUseCaseSpecificationDefaultValue(models.Model):
    _name = "odoo_use_case_specification.default_value"
    _description = "Odoo Use Case Specification Default Value"
