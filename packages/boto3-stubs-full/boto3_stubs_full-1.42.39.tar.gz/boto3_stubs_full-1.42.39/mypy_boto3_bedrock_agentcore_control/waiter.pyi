...
class PolicyActiveWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_agentcore_control/waiters/#policyactivewaiter)
    """
    def wait(  # type: ignore[override]
...
class PolicyDeletedWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_agentcore_control/waiters/#policydeletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class PolicyEngineActiveWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_agentcore_control/waiters/#policyengineactivewaiter)
    """
    def wait(  # type: ignore[override]
...
class PolicyEngineDeletedWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_agentcore_control/waiters/#policyenginedeletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class PolicyGenerationCompletedWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_bedrock_agentcore_control/waiters/#policygenerationcompletedwaiter)
    """
    def wait(  # type: ignore[override]
