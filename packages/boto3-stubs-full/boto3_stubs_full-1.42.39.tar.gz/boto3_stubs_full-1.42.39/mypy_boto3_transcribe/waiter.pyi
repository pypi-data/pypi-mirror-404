...
class CallAnalyticsJobCompletedWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_transcribe/waiters/#callanalyticsjobcompletedwaiter)
    """
...
class LanguageModelCompletedWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_transcribe/waiters/#languagemodelcompletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class MedicalScribeJobCompletedWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_transcribe/waiters/#medicalscribejobcompletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class MedicalTranscriptionJobCompletedWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_transcribe/waiters/#medicaltranscriptionjobcompletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class MedicalVocabularyReadyWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_transcribe/waiters/#medicalvocabularyreadywaiter)
    """
    def wait(  # type: ignore[override]
...
class TranscriptionJobCompletedWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_transcribe/waiters/#transcriptionjobcompletedwaiter)
    """
    def wait(  # type: ignore[override]
...
class VocabularyReadyWaiter(Waiter):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_transcribe/waiters/#vocabularyreadywaiter)
    """
    def wait(  # type: ignore[override]
