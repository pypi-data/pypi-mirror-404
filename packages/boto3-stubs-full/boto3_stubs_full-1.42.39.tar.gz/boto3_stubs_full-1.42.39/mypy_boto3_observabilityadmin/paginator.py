...
class ListS3TableIntegrationsPaginator(_ListS3TableIntegrationsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_observabilityadmin/paginators/#lists3tableintegrationspaginator)
    """
...
class ListTelemetryPipelinesPaginator(_ListTelemetryPipelinesPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_observabilityadmin/paginators/#listtelemetrypipelinespaginator)
    """
