...
class ListTaskInstancesPaginator(_ListTaskInstancesPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mwaa_serverless/paginators/#listtaskinstancespaginator)
    """
...
class ListWorkflowRunsPaginator(_ListWorkflowRunsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mwaa_serverless/paginators/#listworkflowrunspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListWorkflowVersionsPaginator(_ListWorkflowVersionsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mwaa_serverless/paginators/#listworkflowversionspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListWorkflowsPaginator(_ListWorkflowsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_mwaa_serverless/paginators/#listworkflowspaginator)
    """
    def paginate(  # type: ignore[override]
