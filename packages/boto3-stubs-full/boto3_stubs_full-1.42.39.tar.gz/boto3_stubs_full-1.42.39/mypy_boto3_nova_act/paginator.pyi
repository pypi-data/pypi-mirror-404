...
class ListActsPaginator(_ListActsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_nova_act/paginators/#listactspaginator)
    """
...
class ListSessionsPaginator(_ListSessionsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_nova_act/paginators/#listsessionspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListWorkflowDefinitionsPaginator(_ListWorkflowDefinitionsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_nova_act/paginators/#listworkflowdefinitionspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListWorkflowRunsPaginator(_ListWorkflowRunsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_nova_act/paginators/#listworkflowrunspaginator)
    """
    def paginate(  # type: ignore[override]
