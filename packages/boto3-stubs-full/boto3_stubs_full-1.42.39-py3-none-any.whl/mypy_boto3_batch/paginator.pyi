...
class DescribeServiceEnvironmentsPaginator(_DescribeServiceEnvironmentsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_batch/paginators/#describeserviceenvironmentspaginator)
    """
    def paginate(  # type: ignore[override]
...
class ListServiceJobsPaginator(_ListServiceJobsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_batch/paginators/#listservicejobspaginator)
    """
    def paginate(  # type: ignore[override]
