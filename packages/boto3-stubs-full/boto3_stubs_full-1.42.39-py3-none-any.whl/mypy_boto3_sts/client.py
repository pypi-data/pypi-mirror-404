...
class STSClient(BaseClient):
    ...
    def get_delegated_access_token(
        ...
        [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_sts/client/#get_delegated_access_token)
        """
    ...
    def get_web_identity_token(
        ...
        [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_sts/client/#get_web_identity_token)
        """
