...
class ListDeploymentPatternVersionsPaginator(_ListDeploymentPatternVersionsPaginatorBase):
    ...
    [Show boto3-stubs-full documentation](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_launch_wizard/paginators/#listdeploymentpatternversionspaginator)
    """
    def paginate(  # type: ignore[override]
