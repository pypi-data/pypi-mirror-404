...
class PythonNestedGraphNodeBuilder(PythonBaseNodeBuilder):
    ...
    def make_instance(self, owning_graph_id: tuple[int, ...], node_ndx: int) -> "PythonNestedGraphNodeImpl":
        from hgraph._impl._runtime._nested_graph_node import PythonNestedGraphNodeImpl

        node = PythonNestedGraphNodeImpl(
            node_ndx=node_ndx,
