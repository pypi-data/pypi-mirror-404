...
def to_frame_ts_scalar(
    ts: TS[SCALAR], _tp: type[COMPOUND_SCALAR] = AUTO_RESOLVE, _ts_tp: type[SCALAR] = AUTO_RESOLVE
...
@compute_node(overloads=to_frame)
def to_frame_tsd_tsd_ts(
    ts: TSD[SCALAR, TSD[SCALAR_1, TS[SCALAR]]], _tp: type[COMPOUND_SCALAR] = AUTO_RESOLVE
) -> TS[Frame[COMPOUND_SCALAR]]:
    keys_1 = []
    keys_2 = []
    values = []
