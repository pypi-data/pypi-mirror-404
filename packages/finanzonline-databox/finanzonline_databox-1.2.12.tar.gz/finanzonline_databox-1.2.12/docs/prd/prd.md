# PRD: finanzonline_databox - FinanzOnline Level 2 UID Verification
...
### 3.1 CLI Command: `finanzonline-databox check`
```bash
finanzonline-databox check <uid> [OPTIONS]
...
FINANZONLINE_DATABOX___FINANZONLINE__BENID=MYUSER
FINANZONLINE_DATABOX___FINANZONLINE__PIN=secret
FINANZONLINE_DATABOX___FINANZONLINE__UID_TN=ATU12345678
```
...
| File | Purpose |
|------|---------|
| `src/finanzonline_databox/domain/__init__.py` | Domain package |
| `src/finanzonline_databox/domain/models.py` | Immutable dataclasses |
| `src/finanzonline_databox/domain/errors.py` | Domain exceptions |
| `src/finanzonline_databox/domain/return_codes.py` | Return code enum |
| `src/finanzonline_databox/application/__init__.py` | Application package |
| `src/finanzonline_databox/application/ports.py` | Protocol definitions |
| `src/finanzonline_databox/application/use_cases.py` | CheckUidUseCase |
| `src/finanzonline_databox/adapters/__init__.py` | Adapters package |
| `src/finanzonline_databox/adapters/finanzonline/__init__.py` | FO package |
| `src/finanzonline_databox/adapters/finanzonline/session_client.py` | Session SOAP |
| `src/finanzonline_databox/adapters/finanzonline/uid_query_client.py` | Query SOAP |
| `src/finanzonline_databox/adapters/notification/__init__.py` | Notification pkg |
| `src/finanzonline_databox/adapters/notification/email_adapter.py` | Email adapter |
| `src/finanzonline_databox/adapters/output/__init__.py` | Output package |
| `src/finanzonline_databox/adapters/output/formatters.py` | Output formatters |
...
| File | Changes |
|------|---------|
| `src/finanzonline_databox/cli.py` | Add `check` command |
| `src/finanzonline_databox/config.py` | Add `load_finanzonline_config()` |
| `src/finanzonline_databox/defaultconfig.toml` | Add `[finanzonline]` section |
| `src/finanzonline_databox/__init__.py` | Export new public API |
