...
def readme():
    try:
        ...
        return "danubedata Pulumi Package - Development Version"


setup(name='pulumi_danubedata',
      python_requires='>=3.8',
      version=VERSION,
      description="A Pulumi provider for managing DanubeData cloud infrastructure resources.",
      long_description=readme(),
      long_description_content_type='text/markdown',
      keywords='pulumi danubedata category/cloud kind/native',
      url='https://danubedata.ro',
      project_urls={
