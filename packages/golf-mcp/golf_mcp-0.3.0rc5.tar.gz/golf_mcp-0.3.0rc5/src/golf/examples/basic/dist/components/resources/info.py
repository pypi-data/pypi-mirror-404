...
async def info() -> dict[str, Any]:
    ...
    """
    return {'project': '{{project_name}}', 'timestamp': datetime.now().isoformat(), 'platform': {'system': platform.system(), 'python_version': platform.python_version(), 'architecture': platform.machine()}}
export = info