from prisme.spec import Field, Model, Relationship, StackSpec
    ...
    models=[
        ...
        Model(
            ...
            fields=[
                ...
                Field(
                    ...
                    hidden=True,
                    label="Terrain Data",
                    description="Processed terrain mesh data (vertices, indices, colors)",
                ),
        ...
        Model(
            ...
            fields=[
                ...
                Field("download_path", type="string", max_length=500, label="Download Path"),
                Field("timeseries_file", type="string", max_length=500, label="Timeseries File"),
                Field("qc_flags", type="json", label="QC Flags"),
        ...
        Model(
            ...
            fields=[
                Field("code", type="integer", required=True, unique=True, label="Code"),
                Field(
                    "name",
                    type="string",
                    required=True,
            ...
            expose=True,
            operations=["read", "list"],  # read-only reference data
            overrides={
                "rest_tags": ["reference"],
                "nav_label": "Land Cover Types",
                "nav_icon": "tree-pine",
                "table_columns": ["code", "name", "z0", "color_hex"],
                "mcp_tool_prefix": "landcover",
            },
        ),
        # ──────────────────────────────────────────────
