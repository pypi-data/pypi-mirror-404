...
class TemplateRegistry:
    ...
    def _add_extension_stubs(
        self,
        template: ProjectTemplate,
        base: str = "src/{{ project_name_snake }}",
    ) -> None:
        """Add extension stub files to a template."""
        ext = f"{base}/extensions"
        template.add_file(
            f"{ext}/__init__.py",
    ...
    def _create_full_template(self) -> ProjectTemplate:
        ...
        # App extension stubs
        self._add_extension_stubs(template, base="packages/backend/src/{{ project_name_snake }}")
