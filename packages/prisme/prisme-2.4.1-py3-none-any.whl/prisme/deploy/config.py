...
class DeploymentConfig:
    ...
    # Application paths
    backend_path: str = "packages/backend"
    frontend_path: str = "packages/frontend"
    backend_module: str = ""  # defaults to project_name_snake in __post_init__
    ...
    def __post_init__(self) -> None:
        ...
        if not self.backend_module:
            self.backend_module = self.project_name.replace("-", "_")
