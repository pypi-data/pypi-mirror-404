...
class FrontendAdminGenerator(GeneratorBase):
    ...
    REQUIRED_TEMPLATES = [
        ...
        "frontend/admin/AdminRoles.tsx.jinja2",
        "frontend/admin/AdminPermissions.tsx.jinja2",
        "frontend/admin/AdminActivityLog.tsx.jinja2",
    ]
    ...
    def generate_files(self) -> list[GeneratedFile]:
        ...
        return [
            ...
            self._generate_file(
                "frontend/admin/AdminRoles.tsx.jinja2",
                self.pages_path / "admin" / "AdminRoles.tsx",
                FileStrategy.GENERATE_ONCE,
                "Admin roles page",
                ctx,
            ),
            self._generate_file(
                "frontend/admin/AdminPermissions.tsx.jinja2",
                self.pages_path / "admin" / "AdminPermissions.tsx",
                FileStrategy.GENERATE_ONCE,
            ...
            self._generate_file(
                "frontend/admin/AdminActivityLog.tsx.jinja2",
                self.pages_path / "admin" / "AdminActivityLog.tsx",
                FileStrategy.GENERATE_ONCE,
