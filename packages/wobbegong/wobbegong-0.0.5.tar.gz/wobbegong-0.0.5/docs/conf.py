...
module_dir = os.path.join(__location__, "../src/wobbegong")
try:
...
try:
    from wobbegong import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "wobbegong-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "wobbegong Documentation", "Jayaram Kancherla", "manual")
]
