...
Welcome to `wobbegong` contributor's guide.
...
If you experience bugs or general issues with `wobbegong`, please have a look
...
You can help improve `wobbegong` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`wobbegong` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `wobbegong`'s files. While this mechanism can
...
```
conda create -n wobbegong python=3 six virtualenv pytest pytest-cov
conda activate wobbegong
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/wobbegong.git
   cd wobbegong
   ```
...
5. Install [pre-commit]:
   ...
   `wobbegong` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/wobbegong
[issue tracker]: https://github.com/<USERNAME>/wobbegong/issues
