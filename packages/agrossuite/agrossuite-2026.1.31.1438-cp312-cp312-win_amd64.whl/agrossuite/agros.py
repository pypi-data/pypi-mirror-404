...
if platform.system() == 'Windows':
	...
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_python.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_3rdparty_triangle.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_3rdparty_dxflib.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_3rdparty_quazip.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_3rdparty_matio.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_3rdparty_nlopt2.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_3rdparty_bayesopt.dylib")
	# ctypes.cdll.LoadLibrary(path + "/lib/libagros_3rdparty_pagmo2.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_3rdparty_ctemplate.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libagros_library.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libdeal_II.9.7.1.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libgfortran.5.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libquadmath.0.dylib")
	ctypes.cdll.LoadLibrary(path + "/lib/libgcc_s.1.1.dylib")

	if os.path.isfile(path + "/lib/libsolver_plugin_MUMPS.dylib"):
		ctypes.cdll.LoadLibrary(path + "/lib/libsolver_plugin_MUMPS.dylib")
	if os.path.isfile(path + "/lib/libsolver_plugin_amgcl.dylib"):
		ctypes.cdll.LoadLibrary(path + "/lib/libsolver_plugin_amgcl.dylib")
else:
	...
	ctypes.cdll.LoadLibrary(path + "/lib/libdeal_II.so.9.7.1")
	...
	if os.path.isfile(path + "/lib/libsolver_plugin_amgcl.so"):
		ctypes.cdll.LoadLibrary(path + "/lib/libsolver_plugin_amgcl.so")
