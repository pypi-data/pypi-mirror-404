...
class FeatureEntitlementFragment(BaseModel):
    ...
    feature: Optional["FeatureEntitlementFragmentFeature"] = Field(default=None)
    credit_rate: Optional["FeatureEntitlementFragmentCreditRate"] = Field(
        alias="creditRate", default=None
    )
    valid_until: Optional[Any] = Field(alias="validUntil", default=None)


class FeatureEntitlementFragmentResetPeriodConfigurationMonthlyResetPeriodConfig(
    BaseModel
):
...
class FeatureEntitlementFragmentResetPeriodConfigurationWeeklyResetPeriodConfig(
    BaseModel
):
...
class FeatureEntitlementFragmentResetPeriodConfigurationYearlyResetPeriodConfig(
    BaseModel
):
...
class FeatureEntitlementFragmentFeature(FeatureFragment):
    pass


class FeatureEntitlementFragmentCreditRate(BaseModel):
    amount: float
    currency_id: str = Field(alias="currencyId")
...
class ApplySubscriptionFragment(BaseModel):
    ...
    ] = Field(alias="entitlementsV2", default=None)
...
class ApplySubscriptionFragmentEntitlementsV2CreditEntitlement(
    CreditEntitlementFragment
):
    typename__: Literal["CreditEntitlement"] = Field(alias="__typename")


class ApplySubscriptionFragmentEntitlementsV2FeatureEntitlement(
...
class CreditGrantFragment(BaseModel):
    ...
    voided_at: Optional[Any] = Field(alias="voidedAt", default=None)
    payment_collection: PaymentCollection = Field(alias="paymentCollection")
...
class EntitlementReferenceFragment(BaseModel):
    id: str
...
class EntitlementsUpdatedV2Payload(BaseModel):
    customer_id: str = Field(alias="customerId")
    resource_id: Optional[str] = Field(alias="resourceId", default=None)
    access_denied_reason: Optional[EntitlementsStateAccessDeniedReason] = Field(
        alias="accessDeniedReason", default=None
...
class EntitlementsUpdatedV2PayloadEntitlementsCreditEntitlement(
    CreditEntitlementFragment
):
    typename__: Literal["CreditEntitlement"] = Field(alias="__typename")


class EntitlementsUpdatedV2PayloadEntitlementsFeatureEntitlement(
    FeatureEntitlementFragment
):
    typename__: Literal["FeatureEntitlement"] = Field(alias="__typename")
...
class ProvisionCustomerFragmentEntitlementsV2CreditEntitlement(
    CreditEntitlementFragment
):
    typename__: Literal["CreditEntitlement"] = Field(alias="__typename")


class ProvisionCustomerFragmentEntitlementsV2FeatureEntitlement(
    FeatureEntitlementFragment
):
    typename__: Literal["FeatureEntitlement"] = Field(alias="__typename")
...
class ProvisionSubscriptionFragmentEntitlementsV2CreditEntitlement(
    CreditEntitlementFragment
):
    typename__: Literal["CreditEntitlement"] = Field(alias="__typename")


class ProvisionSubscriptionFragmentEntitlementsV2FeatureEntitlement(
    FeatureEntitlementFragment
):
    typename__: Literal["FeatureEntitlement"] = Field(alias="__typename")
...
class UsageV2Fragment(BaseModel):
    current_usage: float = Field(alias="currentUsage")
    usage_updated_at: Any = Field(alias="usageUpdatedAt")
    usage_period_start: Optional[Any] = Field(alias="usagePeriodStart", default=None)
    usage_period_end: Optional[Any] = Field(alias="usagePeriodEnd", default=None)


class UsageUpdatedV2Payload(BaseModel):
    customer_id: str = Field(alias="customerId")
    resource_id: Optional[str] = Field(alias="resourceId", default=None)
    entitlement_reference: "UsageUpdatedV2PayloadEntitlementReference" = Field(
        alias="entitlementReference"
    )
    usage: "UsageUpdatedV2PayloadUsage"


class UsageUpdatedV2PayloadEntitlementReference(EntitlementReferenceFragment):
    pass


class UsageUpdatedV2PayloadUsage(UsageV2Fragment):
    pass
...
UsageV2Fragment.model_rebuild()
UsageUpdatedV2Payload.model_rebuild()
