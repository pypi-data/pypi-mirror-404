...
if firstTime then (
     ...
     initlayout := () -> (
	  ...
	  t := hashTable {
	       ...
	       "emacs" => "${prefix}/share/emacs/site-lisp/macaulay2/",
	       "factory gftables" =>  "${prefix}/share/Macaulay2/Core/factory/",
	       "info" => "${prefix}/share/info/",
	       "lib" => "${exec_prefix}/lib/",
	       "libraries" => "${exec_prefix}/lib/Macaulay2/lib/",
	       "man" => "${prefix}/share/man/",
	       "package" => "${prefix}/share/Macaulay2/PKG/",
	       "packagecache" => "${exec_prefix}/lib/Macaulay2/PKG/cache/",
