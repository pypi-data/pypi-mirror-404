from kerbad.protocol.external.ndr import NDRSTRUCT, NDRUniConformantArray, NDRPOINTER, NDRUniFixedArray
from kerbad.protocol.external.dtypes import RPC_UNICODE_STRING, ULONG
