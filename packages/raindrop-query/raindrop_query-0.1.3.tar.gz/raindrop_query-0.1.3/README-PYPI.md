...
| `err.data`         |                  | Optional. Some errors may contain structured data. See Error Classes below. |
...
* `EventsSearchBadRequestError`: Invalid request (e.g., date range exceeds maximum). Status code `400`.
* `EventsFacetsBadRequestError`: Invalid field name. Status code `400`.
* `SignalsListUnauthorizedError`: Unauthorized. Status code `401`.
* `SignalGroupsListUnauthorizedError`: Unauthorized. Status code `401`.
* `EventsListUnauthorizedError`: Unauthorized. Status code `401`.
* `UsersListUnauthorizedError`: Unauthorized. Status code `401`.
* `ConversationsListUnauthorizedError`: Unauthorized. Status code `401`.
* `SignalsGetNotFoundError`: Signal not found. Status code `404`.
* `SignalGroupsGetNotFoundError`: Signal group not found. Status code `404`.
* `SignalGroupsListSignalsNotFoundError`: Signal group not found. Status code `404`.
* `EventsGetNotFoundError`: Event not found. Status code `404`.
* `UsersGetNotFoundError`: User not found. Status code `404`.
* `ConversationsGetNotFoundError`: Conversation not found. Status code `404`.
