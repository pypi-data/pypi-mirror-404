...
from .machines__api__machine_sharing import MachinesMachineSharingAPI
from .machines__api__machines import MachinesMachinesAPI
...
class APIClient:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.machines_machine_sharing = MachinesMachineSharingAPI(self._client)
        self.machines_machines = MachinesMachinesAPI(self._client)
