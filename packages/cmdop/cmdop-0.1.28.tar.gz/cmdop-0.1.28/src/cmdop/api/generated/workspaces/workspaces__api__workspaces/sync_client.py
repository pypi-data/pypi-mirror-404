...
class SyncWorkspacesWorkspacesAPI:
    """Synchronous API endpoints for Workspaces."""
    ...
    def invitations_create(self, data: WorkspaceInvitationCreateRequest) -> WorkspaceInvitation:
        """
        Create invitation
    ...
    def invitations_retrieve(self, id: str) -> WorkspaceInvitation:
        """
    ...
    def invitations_destroy(self, id: str) -> None:
        """
        Cancel invitation
    ...
    def invitations_accept_create(self, data: WorkspaceInvitationAcceptRequest) -> None:
        """
        Accept invitation
    ...
    def members_create(self, data: WorkspaceMemberRequest) -> WorkspaceMember:
        """
    ...
    def members_retrieve(self, id: str) -> WorkspaceMember:
        """
        ViewSet for WorkspaceMember operations. Manage workspace memberships and
        roles.
        """
    ...
    def members_update(self, id: str, data: WorkspaceMemberRequest) -> WorkspaceMember:
        """
        ViewSet for WorkspaceMember operations. Manage workspace memberships and
        roles.
        """
    ...
    def members_partial_update(self, id: str, data: PatchedWorkspaceMemberRequest | None = None) -> WorkspaceMember:
        """
        ViewSet for WorkspaceMember operations. Manage workspace memberships and
        roles.
        """
    ...
    def members_destroy(self, id: str) -> None:
        """
        ViewSet for WorkspaceMember operations. Manage workspace memberships and
        roles.
        """
    ...
    def workspaces_retrieve(self, id: str) -> Workspace:
        """
        ViewSet for Workspace operations. Provides CRUD operations for
        workspaces with team/personal modes.
        """
    ...
    def workspaces_update(self, id: str, data: WorkspaceRequest) -> Workspace:
        """
        ViewSet for Workspace operations. Provides CRUD operations for
        workspaces with team/personal modes.
        """
    ...
    def workspaces_partial_update(self, id: str, data: PatchedWorkspaceRequest | None = None) -> Workspace:
        """
        ViewSet for Workspace operations. Provides CRUD operations for
        workspaces with team/personal modes.
        """
    ...
    def workspaces_destroy(self, id: str) -> None:
        """
        ViewSet for Workspace operations. Provides CRUD operations for
        workspaces with team/personal modes.
        """
