...
# from .enums import Machine.os, Machine.status, MachineLog.level, MachinesMachinesUpdateMetricsCreateRequest.status, SharedMachine.permission
...
class API:
    ...
    @property
    def machines_machine_sharing(self) -> MachinesMachineSharingAPI:
        """Access Machine Sharing endpoints."""
        return self._client.machines_machine_sharing

    @property
    def machines_machines(self) -> MachinesMachinesAPI:
        """Access Machines endpoints."""
        return self._client.machines_machines
