...
def test_hilbert_system():
    ...
    test_filename = test_filename / Path("test_hilbert_system.txt")
    ...
    comps = {
        ...
        "HILBERT": FIRHilbertEnvelopeUnit(
            order=170,
            axis="time",
        ),
    ...
    conns = (
        (comps["SRC"].OUTPUT_SIGNAL, comps["HILBERT"].INPUT_SIGNAL),
        (comps["HILBERT"].OUTPUT_SIGNAL, comps["LOG"].INPUT_MESSAGE),
