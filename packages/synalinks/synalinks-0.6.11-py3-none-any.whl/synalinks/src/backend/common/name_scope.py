# Modified from: keras/src/backend/common/name_scope.py
...
class name_scope:
    ...
    Args:
        name (str): Name of the current scope (string).
        caller (Object): Optional ID of a caller object (e.g. class instance).
        deduplicate (bool) If `True`, if `caller` was passed,
        ...
        override_parent (str): Can be used to provide an absolute path
