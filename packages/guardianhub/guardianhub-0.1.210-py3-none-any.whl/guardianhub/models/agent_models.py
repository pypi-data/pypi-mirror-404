...
class AgentBase(BaseModel):
    ...
    title: str = Field(..., description="Display name (e.g., Infrastructure Guardian)")
    semantic_identity: str = Field(..., description="The key for the Agent's core DNA")
...
class RiskAnalysisReport(BaseModel):
    ...
    mitigation_suggested: Optional[str] = Field(
        None,
        description="Steps to reduce risk if decision is ADVISE or HALT"
    )
