...
def _parse_inputs_for_onnx_export(all_input_parameters, inputs, kwargs):
    # extracted from https://gh-proxy.org/https://github.com/microsoft/onnxruntime/blob/239c6ad3f021ff7cc2e6247eb074bd4208dc11e2/orttraining/orttraining/python/training/ortmodule/_io.py#L433
...
def _flatten_module_input(names, args, kwargs):
    ...
    # extracted from https://gh-proxy.org/https://github.com/microsoft/onnxruntime/blob/239c6ad3f021ff7cc2e6247eb074bd4208dc11e2/orttraining/orttraining/python/training/ortmodule/_io.py#L110
