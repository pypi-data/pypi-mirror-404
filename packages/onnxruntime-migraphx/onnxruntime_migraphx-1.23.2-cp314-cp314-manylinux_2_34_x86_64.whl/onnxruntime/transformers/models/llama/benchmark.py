...
def get_ort_model_inputs_len(args, model):
    ...
    if args.benchmark_type == "hf-ort":
        try:
            # New Optimum export (https://gh-proxy.org/https://github.com/huggingface/optimum/blob/888332364c2e0091da1fc974737c7e277af168bf/optimum/onnxruntime/modeling_ort.py#L268)
            return len(model.inputs_names)
        except Exception:
            # Old Optimum export (https://gh-proxy.org/https://github.com/huggingface/optimum/blob/c5ad7f971cb0a494eac03dc0909f146725f999c5/optimum/onnxruntime/base.py#L54)
...
def get_inputs(args: argparse.Namespace, ort_model_inputs_len: int):
    ...
    if args.benchmark_type in {"hf-pt-eager", "hf-pt-compile"}:
        ...
        # Microsoft export from https://gh-proxy.org/https://github.com/microsoft/Llama-2-Onnx
...
def get_model(args: argparse.Namespace):
    ...
    # 4) Benchmark LLaMA-2 from Microsoft (already optimized, available at https://gh-proxy.org/https://github.com/microsoft/Llama-2-Onnx)
    ...
    if args.benchmark_type in {"ort-msft", "ort-convert-to-onnx"}:
        # Ex: Microsoft export from https://gh-proxy.org/https://github.com/microsoft/Llama-2-Onnx
