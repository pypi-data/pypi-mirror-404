...
class FusionRelativePositionBiasBlock(Fusion):
    ...
    def fuse(self, node, input_name_to_nodes, output_name_to_node):
        ...
        # See https://gh-proxy.org/https://github.com/huggingface/transformers/blob/608e163b527eaee41e650ffb9eb4c422d2679902/src/transformers/models/t5/modeling_t5.py#L397.
