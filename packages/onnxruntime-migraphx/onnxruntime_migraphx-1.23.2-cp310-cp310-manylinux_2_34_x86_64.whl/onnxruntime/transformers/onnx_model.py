...
class OnnxModel:
    ...
    def convert_float_to_float16(self, use_symbolic_shape_infer=True, **kwargs):
        """Convert a model to half (default) or mixed precision.
           ...
           convert_float_to_float16 in float16.py (see https://gh-proxy.org/https://github.com/microsoft/onnxruntime/pull/15067) to
           avoid the 2GB limit.
        ...
        if use_symbolic_shape_infer:
            ...
            try:
                ...
                # auto_merge might cause issue (see https://gh-proxy.org/https://github.com/microsoft/onnxruntime/issues/15521)
                ...
                logger.warning(
                    "Failed to run symbolic shape inference. Please file an issue in https://gh-proxy.org/https://github.com/microsoft/onnxruntime."
                )
