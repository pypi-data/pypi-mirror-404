...
class HistogramCalibrater(CalibraterBase):
    ...
    def collect_data(self, data_reader: CalibrationDataReader):
        ...
        while True:
            ...
            # https://gh-proxy.org/https://github.com/microsoft/onnxruntime/issues/21922
            fixed_outputs = []
...
class HistogramCollector(CalibrationDataCollector):
    ...
    ref: https://gh-proxy.org/https://github.com//apache/incubator-mxnet/blob/master/python/mxnet/contrib/quantization.py
