...
Setup for Stable Fast (see https://gh-proxy.org/https://github.com/chengzeyi/stable-fast/blob/main/README.md for more info):
    git clone https://gh-proxy.org/https://github.com/chengzeyi/stable-fast.git
    cd stable-fast
