...
def compute_scale_zp_float8(element_type, std):
    ...
    <https://gh-proxy.org/https://github.com/microsoft/onnxruntime/blob/main/docs/python/notebooks/quantization_fp8.ipynb>`_.
    """
    zp_dtype = None
...
def quantize_onnx_initializer(
    ...
    if quant_type == onnx.TensorProto.FLOAT8E4M3FN:
        ...
        # We only use onnx.helper.make_tensor with raw data due to bug: https://gh-proxy.org/https://github.com/onnx/onnx/pull/6161
...
def attribute_to_kwarg(attribute):
    ...
    # definition in https://gh-proxy.org/https://github.com/onnx/onnx/blob/main/onnx/onnx.proto
    if attribute.type == 1:
        value = attribute.f
...
def smooth_distribution(p, eps=0.0001):
    ...
    Ref: http://web.engr.illinois.edu/~hanj/cs412/bk3/KL-divergence.pdf
         https://gh-proxy.org/https://github.com//apache/incubator-mxnet/blob/master/python/mxnet/contrib/quantization.py
    """
