...
* Searching through the fairyfly-therm material libraries.
"""
...
def get_attr_nested(obj_instance, attr_name, decimal_count=None, cast_to_str=True):
    ...
    Args:
        obj_instance: An instance of a Python object. Typically, this is a fairyfly
            object like a Model, Shape or Boundary.
        attr_name: A string of an attribute that the input obj_instance should have.
            ...
            For example, 'properties.therm.material'.
