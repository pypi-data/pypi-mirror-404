...
def check_duplicate_identifiers(
    ...
    Args:
        objects_to_check: A list of fairyfly objects across which duplicate
        ...
        obj_name: An optional name for the object to be included in the error
            message. For example, 'Shape', 'Boundary'.
        detailed: Boolean for whether the returned object is a detailed list of
            dicts with error info or a string with a message. (Default: False).
        code: Text for the error code. (Default: 0000).
        extension: Text for the name of the Fairyfly extension for which duplicate
