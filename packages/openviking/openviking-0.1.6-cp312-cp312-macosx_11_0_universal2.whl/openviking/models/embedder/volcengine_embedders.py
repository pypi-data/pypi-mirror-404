...
class VolcengineDenseEmbedder(DenseEmbedderBase):
    ...
    def __init__(
        ...
        self.api_key = api_key or os.getenv("OPENVIKING_EMBEDDING_API_KEY") or os.getenv("VOLC_API_KEY")
        self.api_base = api_base or os.getenv("OPENVIKING_EMBEDDING_API_BASE") or "https://ark.cn-beijing.volces.com/api/v3"
